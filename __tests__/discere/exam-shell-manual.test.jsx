...
describe('ExamShell manual result presentation', () => {
  it('does not present manual rubric points as a false final percentage', async () => {
    ...
    // This exam has no auto-gradable questions (autoPossiblePoints === 0), so
    // ExamShell correctly shows the manual-pending heading instead of an
    // "Automatski provjereno" section it would be wrong to claim exists.
