export const FAKULTETI = [
  ...
  // ── BODOVANJE MATURE (bez posebnog prijemnog) ───────────
  {
    ...
    opis:"Pravni nema prijemni ispit — boduju se maturalni rezultati + srednja škola. Matematika (B) ili strani jezik biraju se kao izborni. Konkurencija je visoka — prosječni prag oko 625–630 bodova.",
