  ...
  if(done){
    ...
    e("div",{className:"results"},
      ...
      e("div",{style:{marginTop:8,textAlign:"center",display:"flex",gap:10,justifyContent:"center",flexWrap:"wrap"}},
        ...
        wrongAutoQ.length>0&&isGameModeEnabled()&&e("button",{className:"btn btn-gold",onClick:()=>window.location.assign('/game?recipe=mistake_review')},"🎮 Ponovi pogreške u Game Modeu"),
