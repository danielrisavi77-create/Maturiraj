// Maturiraj MatB — P07 · Sustavi jednadžbi
// Auto-generated from Maturiraj_MatB_P07_FIXED.html
// Sadrži: cijeli HTML, CSS, JS runtime, sve podatke

export const P07_HTML = `<!DOCTYPE html>
<html lang="hr">
<head>
<meta charset="UTF-8">
...
<title>Maturiraj.hr — Mat B · P07 · Sustavi jednadžbi</title>
...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sb-item active"><span class="sb-dot"></span>07 · Sustavi jednadžbi<div class="sb-progress"><div class="sb-prog-track"><div class="sb-prog-fill" id="sb-prog-fill"></div></div><span class="sb-prog-pct" id="sb-prog-pct">0%</span></div></div>
...
<div class="topbar">
  <div class="topbar-L">
    <span class="ch-badge">P / 07</span>
    <h1 class="ch-title"><span class="acc">Sustavi</span> jednadžbi — supstitucija i eliminacija</h1>
  </div>
  <div class="topbar-R">
...
<div class="welcome" id="welcome">
  <div class="welcome-head">
    <h2 class="welcome-h">⚖ Sustavi jednadžbi — dvije nepoznanice, dva uvjeta</h2>
    <button class="welcome-x" onclick="closeWelcome()" aria-label="Zatvori">✕</button>
  </div>
  <p class="welcome-t">Sustavi jednadžbi daju <strong>5–9 bodova mature</strong>. Tri metode rješavanja: supstitucija, eliminacija (Gaussova), grafička. Dolaze u linij-linij, linij-parabola i linij-kružnica kombinacijama. <strong>Kalkulator sustava</strong>, 28 Drill pitanja i 9 primjera.</p>
</div>
...
<div class="hero">
  ...
  <div class="hero-top">
    <span class="hero-kb">P07 · SUPSTITUCIJA · ELIMINACIJA · GRAFIČKI</span>
    <span class="hero-prio">⭐⭐⭐⭐⭐</span>
  </div>
  <h2 class="hero-h"><span class="acc">Sustavi</span> jednadžbi — <span class="acc2">2 uvjeta, 2 nepoznanice</span></h2>
  <p class="hero-sub">Dva uvjeta, dvije nepoznanice. <strong>5–9 bodova mature</strong>. Metode: supstitucija, eliminacija, grafička. Veza s P05 (linearne) i P06 (kvadratne).</p>
  ...
  <div class="stat-grid">
    <div class="stat-card"><span class="sc-ico">⊥</span><div class="sc-h">Linearan sustav</div><div class="sc-t">2×2 sustav: ax+by=c, dx+ey=f. Rješava se supstitucijom ili eliminacijom.</div></div>
    <div class="stat-card"><span class="sc-ico">↔</span><div class="sc-h">Supstitucija</div><div class="sc-t">Iz jedne jednadžbe izrazi jednu varijablu, uvrsti u drugu.</div></div>
    <div class="stat-card"><span class="sc-ico">−</span><div class="sc-h">Eliminacija</div><div class="sc-t">Oduzmi/zbroji jednadžbe da eliminiraš jednu varijablu.</div></div>
    <div class="stat-card"><span class="sc-ico">∩</span><div class="sc-h">Grafičko rješenje</div><div class="sc-t">Rješenje = presjek grafova. Nema rješ. → paralelni pravci.</div></div>
    <div class="stat-card"><span class="sc-ico">⊙</span><div class="sc-h">Lin-kvadratni sustav</div><div class="sc-t">Supstitucijom dobiveš kvadratnu jednadžbu (0, 1 ili 2 rješenja).</div></div>
    <div class="stat-card"><span class="sc-ico">✓</span><div class="sc-h">Provjera</div><div class="sc-t">Uvijek uvrsti rješenje u <em>obje</em> jednadžbe.</div></div>
  </div>
</div>

<div class="box-grid">
  <div class="con" data-no="→"><span><strong>Linearni sustav 2×2:</strong> ax+by=c, dx+ey=f. Geometrijski: presjek dvaju pravaca. Može imati 0 (paralelni), 1 (presjek) ili ∞ (isti pravac) rješenja.</span></div>
  <div class="con" data-no="→"><span><strong>Supstitucija:</strong> iz jedne jednadžbe izrazi x ili y, uvrsti u drugu. Dobrog je kad je jedan koeficijent ±1.</span></div>
  <div class="con" data-no="→"><span><strong>Eliminacija (Gauss):</strong> pomnoži jednadžbe da koeficijenti jedne varijable postanu suprotni, zatim zbroji. Brže za simetričan sustav.</span></div>
  <div class="con" data-no="→"><span><strong>Grafička metoda:</strong> nacrtat oba pravca, pročitati presjek. Egzaktna samo za "lijepe" koordinate.</span></div>
  <div class="con" data-no="→"><span><strong>Lin-kvadratni sustav:</strong> jedan pravac, jedna parabola. Supstitucijom → kvadratna jednadžba → 0, 1 ili 2 rješenja (P06 veza).</span></div>
  <div class="con" data-no="→"><span><strong>Provjera:</strong> uvijek uvrsti (x,y) u <em>obje</em> polazne jednadžbe. Samo jedna provjera nije dovoljna!</span></div>
</div>

<div class="box-20">
  <div class="box-20-lbl">⚡ 20 sekundi — zapamti ovih 6</div>
  <ul class="box-20-list">
    <li><strong>Supstitucija:</strong> izrazi x (ili y) iz lakše jednadžbe, uvrsti u drugu → jednadžba s jednom nepoznanicom.</li>
    <li><strong>Eliminacija:</strong> pomnoži jednadžbe da koeficijenti jedne varijable budu suprotni, zbroji → eliminiraš je.</li>
    <li><strong>Grafički:</strong> rješenje = presjek pravaca. Bez presjeka = nema rješenja (paralelni). Beskonačno rješenja = isti pravac.</li>
    <li><strong>Lin-kvadratni:</strong> iz linearne izrazi y=..., uvrsti u kvadratnu → kvadratna jednadžba (P06). Bude 0, 1 ili 2 para.</li>
    <li><strong>Provjera:</strong> uvrsti u OBJE polazne jednadžbe. Jedna provjera nije dovoljna.</li>
    <li><strong>Homogeni sustav</strong> (slobodni koef. 0): uvijek ima trivijalno rješenje x=0, y=0.</li>
  </ul>
</div>
...
<div class="box-for">
  ...
  <div class="for-grid">
    <div class="for-item"><span class="lbl">Supstitucija</span><div class="val">y = ... iz J1, uvrsti u J2</div></div>
    <div class="for-item"><span class="lbl">Eliminacija</span><div class="val">k·J1 + m·J2 da nestane x ili y</div></div>
    <div class="for-item"><span class="lbl">Kramerova</span><div class="val">x = Dx/D, y = Dy/D (det.)</div></div>
    <div class="for-item"><span class="lbl">Provjera</span><div class="val">uvrsti (x,y) u J1 I J2</div></div>
  </div>
</div>
...
<div class="sec-head"><span class="sec-badge">1 / 12</span><h3 class="sec-h">Sustav 2×2 — supstitucija i eliminacija</h3></div>
<div class="sec-body">
  <p><strong>Sustav linearnih jednadžbi</strong> 2×2 ima dvije jednadžbe s dvjema nepoznanicama. Rješavamo supstitucijom ili eliminacijom.</p>
  <div class="callout key"><span class="callout-i">📌</span><div class="callout-t">
    <strong>Supstitucija:</strong> iz jedne jednadžbe izrazi x (ili y), uvrsti u drugu.<br>
    <strong>Eliminacija:</strong> množi jednadžbe da se jedan koeficijent poništi, zbrajaj/oduzimaj.<br><br>
    <strong>Tipovi rješenja:</strong><br>
    → Jedno rješenje: pravci se sijeku (D ≠ 0)<br>
    → Nema rješenja: pravci paralelni (D = 0, sustav proturječan)<br>
    → Beskonačno: isti pravac (D = 0, jednadžbe proporcionalne)
  </div></div>
  <div class="emph"><strong>Primjer (supstitucija):</strong> x+y=5 i 2x−y=4.<br>
  Iz prve: y=5−x. Uvrsti: 2x−(5−x)=4 → 3x=9 → x=3. y=5−3=2.<br>
  Rješenje: <em>(3, 2)</em>. Provjera: 3+2=5 ✓, 6−2=4 ✓</div>
</div>

<div class="sec-head"><span class="sec-badge">2 / 12</span><h3 class="sec-h">Cramerovo pravilo i determinante</h3></div>
<div class="sec-body">
  <div class="callout key"><span class="callout-i">📐</span><div class="callout-t">
    Sustav: a₁x+b₁y=c₁, a₂x+b₂y=c₂.<br>
    <strong>D = a₁b₂ − a₂b₁</strong> (determinanta)<br>
    <strong>x = Dₓ/D</strong> gdje Dₓ = c₁b₂ − c₂b₁<br>
    <strong>y = Dᵧ/D</strong> gdje Dᵧ = a₁c₂ − a₂c₁<br>
    → D=0: nema jedinstvenog rješenja
  </div></div>
  <div class="emph"><strong>Primjer:</strong> 2x+y=5, x−y=1. D=2·(−1)−1·1=−3. Dₓ=5·(−1)−1·1=−6. Dᵧ=2·1−1·5=−3.<br>
  x=−6/−3=2. y=−3/−3=1. Rješenje: <em>(2, 1)</em>.</div>
</div>

<div class="sec-head"><span class="sec-badge">3 / 12</span><h3 class="sec-h">Geometrijska interpretacija — pravci i presjeci</h3></div>
<div class="sec-body">
  <div class="callout key"><span class="callout-i">📌</span><div class="callout-t">
    Svaka jednadžba ax+by=c je pravac. Rješenje sustava = presjek tih pravaca.<br>
    → <strong>Jedno rješenje:</strong> različiti nagibi (k₁≠k₂) → sijeku se<br>
    → <strong>Nema rješenja:</strong> isti nagib, različit y-isječak → paralelni<br>
    → <strong>∞ rješenja:</strong> isti nagib, isti y-isječak → identični pravci
  </div></div>
  <div class="emph"><strong>Primjer bez rješenja:</strong> x+y=3 i x+y=5. Oba imaju nagib −1 ali y-isječke 3 i 5 → paralelni.</div>
</div>

<div class="sec-head"><span class="sec-badge">4 / 12</span><h3 class="sec-h">Sustav 3×3 — Gaussova eliminacija</h3></div>
<div class="sec-body">
  <div class="callout key"><span class="callout-i">📐</span><div class="callout-t">
    <strong>Gaussova eliminacija:</strong><br>
    1) Napiši proširenu matricu [A|b]<br>
    2) Elem. operacije: zamjena redova, množenje retka s ≠0, zbrajanje višekratnika redaka<br>
...
<div class="sec-body">
  <p>Lin-kvadratni sustav ima jednu linearnu i jednu kvadratnu jednadžbu. Rješavamo supstitucijom.</p>
  <div class="callout key"><span class="callout-i">📌</span><div class="callout-t">
    1) Iz linearne: izrazi jednu varijablu (npr. y=kx+l)<br>
    2) Uvrsti u kvadratnu → kvadratna jednadžba s jednom nepoznanicom<br>
    3) Riješi kvadratnu (P06) → dobij x, pa y<br>
    → 0, 1 ili 2 rješenja ovisno o D kvadratne
  </div></div>
  <div class="emph"><strong>Primjer:</strong> y=x+2 i y=x². Uvrsti: x²=x+2 → x²−x−2=0 → x=2 ili x=−1.<br>
  Rješenja: <em>(2,4)</em> i <em>(−1,1)</em>.</div>
</div><div class="pg-ai">
  <div class="pg-ai-hd">
    <div class="pg-ai-ico">🤖</div>
    <div style="flex:1;min-width:0">
      <div class="pg-ai-ttl">AI Profesor <span class="pg-ai-badge">PRO · 200 msg/dan</span></div>
      <div class="pg-ai-sub">Zaglavio si na sustavima jednadžbi? Pitaj me što god — objašnjenje po koracima, prilagođeno tebi.</div>
    </div>
  </div>
  <div class="pg-ai-chips">
    <span class="pg-ai-chip" onclick="openPaywall('ai')">💭 Metoda supstitucije?</span>
    <span class="pg-ai-chip" onclick="openPaywall('ai')">💭 Kada sustav nema rješenja?</span>
    <span class="pg-ai-chip" onclick="openPaywall('ai')">💭 Cramerova pravila?</span>
  </div>
  <div class="pg-ai-bubble">
    Sustavi 2 ili 3 jednadžbe? <strong>Supstitucija, eliminacija, Cramer</strong> — biram najbržu metodu za tvoj zadatak<span class="pg-ai-typing"><span></span><span></span><span></span></span>
  </div>
  <button class="pg-ai-cta" onclick="openPaywall('ai')">Otključaj AI profesora →</button>
</div>

<div class="sec-head"><span class="sec-badge">6 / 12</span><h3 class="sec-h">Primjene — modeliranje problematike</h3></div>
<div class="sec-body">
  <div class="callout key"><span class="callout-i">📐</span><div class="callout-t">
    <strong>Koraci:</strong><br>
    1) Uvedem varijable (što x i y predstavljaju?)<br>
    2) Postavljam sustav iz teksta<br>
    3) Riješim sustav<br>
    4) Provjerim odgovor u kontekstu zadatka
  </div></div>
  <div class="emph"><strong>Primjer:</strong> Dvije vrste karata: odrasli 10€, djeca 5€. Prodano 100 karata za 700€.<br>
  x+y=100, 10x+5y=700 → 5x=200 → x=40, y=60.</div>
</div>

<div class="sec-head"><span class="sec-badge">7 / 12</span><h3 class="sec-h">Veza s matricama i determinantama</h3></div>
<div class="sec-body">
  <div class="callout key"><span class="callout-i">📌</span><div class="callout-t">
    Sustav Ax=b u matričnom obliku: A je matrica koeficijenata, x i b su stupčani vektori.<br>
    <strong>det(A) = ad − bc</strong> za 2×2 matricu [[a,b],[c,d]]<br>
    → det(A)≠0: A je regularna, jedinstveno rješenje x=A⁻¹b<br>
    → det(A)=0: A je singularna, nema jedinstvenog rješenja
  </div></div>
</div>

<div class="sec-head"><span class="sec-badge">8 / 12</span><h3 class="sec-h">Veza s P05, P06 i P08</h3></div>
<div class="sec-body">
  <div class="callout key"><span class="callout-i">📐</span><div class="callout-t">
    → <strong>P05 (linearne jednadžbe):</strong> sustav 1×1 je poseban slučaj<br>
    → <strong>P06 (kvadratne):</strong> lin-kvadratni sustav → kvadratna jednadžba<br>
    → <strong>P08 (linearna funkcija):</strong> svaka jednadžba sustava je pravac; rješenje = presjek<br>
    → Geometrijski: rješenje 2×2 sustava = koordinate presjeka dvaju pravaca
  </div></div>
</div>

<div class="sec-head"><span class="sec-badge">9 / 12</span><h3 class="sec-h">📊 Interaktivni vizualizator — sustav 2×2</h3></div>
<div class="sec-body">
  <div class="pbx-wrap">
    <div class="pbx-head"><span class="pbx-title">2×2 system solver explorer</span><span class="pbx-badge">LIVE</span></div>
    <div class="pbx-mode-tabs">
      <button class="pbx-mode-tab on" onclick="pbxSetMode(0,this)">📐 Supstitucija</button>
      <button class="pbx-mode-tab" onclick="pbxSetMode(1,this)">⊞ Eliminacija</button>
    </div>
    <div class="pbx-canvas-wrap">
      <canvas class="pbx-canvas" id="pbx-canvas" width="640" height="360" aria-label="Sustav jednadžbi vizualizator"></canvas>
      <div class="pbx-zoom">
    ...
    <div class="pbx-controls" id="pbx-free-ctrl">
      <div class="pbx-ctrl" style="grid-column:span 2"><div class="pbx-ctrl-row"><span class="pbx-ctrl-lbl">Jednadžba 1: a₁x + b₁y = c₁</span></div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:4px">
          <span style="font-family:var(--mono);font-size:11px;color:var(--t2)">a₁=</span><input class="calc-in" id="p7-a1" type="number" value="1" style="width:55px" oninput="pbxUpdate()">
          <span style="font-family:var(--mono);font-size:11px;color:var(--t2)">b₁=</span><input class="calc-in" id="p7-b1" type="number" value="1" style="width:55px" oninput="pbxUpdate()">
          <span style="font-family:var(--mono);font-size:11px;color:var(--t2)">c₁=</span><input class="calc-in" id="p7-c1" type="number" value="5" style="width:55px" oninput="pbxUpdate()">
        </div>
      </div>
      <div class="pbx-ctrl" style="grid-column:span 2"><div class="pbx-ctrl-row"><span class="pbx-ctrl-lbl">Jednadžba 2: a₂x + b₂y = c₂</span></div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:4px">
          <span style="font-family:var(--mono);font-size:11px;color:var(--t2)">a₂=</span><input class="calc-in" id="p7-a2" type="number" value="2" style="width:55px" oninput="pbxUpdate()">
          <span style="font-family:var(--mono);font-size:11px;color:var(--t2)">b₂=</span><input class="calc-in" id="p7-b2" type="number" value="-1" style="width:55px" oninput="pbxUpdate()">
          <span style="font-family:var(--mono);font-size:11px;color:var(--t2)">c₂=</span><input class="calc-in" id="p7-c2" type="number" value="4" style="width:55px" oninput="pbxUpdate()">
        </div>
      </div>
      <div class="pbx-ctrl"><div class="pbx-ctrl-row"><span class="pbx-ctrl-lbl">Determinanta D</span><span class="pbx-ctrl-val" id="pbx-angles-val">−3</span></div></div>
      <div class="pbx-ctrl"><div class="pbx-ctrl-row"><span class="pbx-ctrl-lbl">Rješenje</span><span class="pbx-ctrl-val ok" id="pbx-peri-val">(3, 2)</span></div></div>
    </div>
    <div class="pbx-presets">
      <button class="pbx-preset" onclick="pbxPreset('basic',this)">Jedno rješenje</button>
      <button class="pbx-preset" onclick="pbxPreset('parallel',this)">Nema rješenja</button>
      <button class="pbx-preset" onclick="pbxPreset('same',this)">∞ rješenja</button>
      <button class="pbx-preset" onclick="pbxPreset('cramer',this)">Cramer primjer</button>
      <button class="pbx-preset" onclick="pbxPreset('karte',this)">Karte zadatak</button>
    </div>
...
<div class="sec-body">
  <div class="ncvvo-wrap">
    <div class="ncvvo-item"><div class="ncvvo-no">1</div><div class="ncvvo-content"><div style="font-family:var(--mono);font-size:9px;color:var(--amber);font-weight:700;margin-bottom:4px">MAT B 2024 LJETO · Zadatak 6 · 4 boda</div><div style="font-size:13.5px;color:var(--t1);font-weight:600;line-height:1.6">Rijesi sustav: x+2y=8, 3x−y=3.<br><span style="font-family:var(--mono);font-size:11px;color:var(--t2)">→ Eliminacija: 3(x+2y)−(3x−y)=24−3 → 7y=21 → y=3, x=2. <strong>(2,3)</strong>.</span></div></div></div>
    <div class="ncvvo-item"><div class="ncvvo-no">2</div><div class="ncvvo-content"><div style="font-family:var(--mono);font-size:9px;color:var(--amber);font-weight:700;margin-bottom:4px">MAT B 2023 JESEN · Zadatak 7 · 4 boda</div><div style="font-size:13.5px;color:var(--t1);font-weight:600;line-height:1.6">Rijesi sustav: 2x+y=7, x−y=2.<br><span style="font-family:var(--mono);font-size:11px;color:var(--t2)">→ Zbrajanje: 3x=9 → x=3, y=1. <strong>(3,1)</strong>.</span></div></div></div>
    <div class="ncvvo-item"><div class="ncvvo-no">3</div><div class="ncvvo-content"><div style="font-family:var(--mono);font-size:9px;color:var(--amber);font-weight:700;margin-bottom:4px">MAT B 2022 LJETO · Zadatak 8 · 5 bodova</div><div style="font-size:13.5px;color:var(--t1);font-weight:600;line-height:1.6">Presjeci y=x+2 i y=x².<br><span style="font-family:var(--mono);font-size:11px;color:var(--t2)">→ x²=x+2 → x=2 ili x=−1. Rješenja: <strong>(2,4)</strong> i <strong>(−1,1)</strong>.</span></div></div></div>
    <div class="ncvvo-item"><div class="ncvvo-no">4</div><div class="ncvvo-content"><div style="font-family:var(--mono);font-size:9px;color:var(--amber);font-weight:700;margin-bottom:4px">MAT B 2021 LJETO · Zadatak 6 · 4 boda</div><div style="font-size:13.5px;color:var(--t1);font-weight:600;line-height:1.6">Dvije vrste artikala, cijena A=3€, B=5€, ukupno 100 kom za 380€.<br><span style="font-family:var(--mono);font-size:11px;color:var(--t2)">→ x+y=100, 3x+5y=380 → 2y=80 → y=40, x=60. <strong>60 kom A, 40 kom B</strong>.</span></div></div></div>
  </div>
  <div class="bug-box"><div class="bug-head">🐛 Prepoznaj grešku — determinanta i tip rješenja</div><div class="bug-body"><div class="bug-quote">Sustav x+y=3, x−y=1. Student: <em>"D=1·(−1)−1·1=−2≠0 → beskonačno rješenja."</em></div><div class="bug-task">D≠0 → <span class="wrong">beskonačno rješenja</span></div><div class="bug-opts" id="bug1-opts">
      <div class="bug-opt" onclick="bugAns(1,0,this)">A) Točno — D≠0 znači beskonačno.</div>
      <div class="bug-opt" onclick="bugAns(1,1,this)">B) Greška — D≠0 znači JEDNO rješenje (pravci se sijeku).</div>
      <div class="bug-opt" onclick="bugAns(1,2,this)">C) Greška — D=−2 ne postoji.</div>
</div><div class="bug-expl" id="bug1-exp"></div></div></div>
<div class="bug-box"><div class="bug-head">🐛 Prepoznaj grešku #2 — eliminacija</div><div class="bug-body"><div class="bug-quote">Student: <em>"U eliminaciji množimo jednadžbe da dobimo iste koeficijente, pa ih izjednačimo."</em></div><div class="bug-task">Eliminacija: <span class="wrong">izjednačavanje koeficijenata</span></div><div class="bug-opts" id="bug2-opts">
      <div class="bug-opt" onclick="bugAns(2,0,this)">A) Točno — cilj je izjednačiti koeficijente.</div>
      <div class="bug-opt" onclick="bugAns(2,1,this)">B) Greška — cilj je PONIŠTITI jednu varijablu (koeficijent=0), zatim zbrajamo/oduzimamo jednadžbe.</div>
      <div class="bug-opt" onclick="bugAns(2,2,this)">C) Greška — kod eliminacije se dijeli s determinantom.</div>
</div><div class="bug-expl" id="bug2-exp"></div></div></div>
<div class="bug-box"><div class="bug-head">🐛 Prepoznaj grešku #3 — rješenje sustava geometrijski</div><div class="bug-body"><div class="bug-quote">Student: <em>"Rješenje sustava 2 pravaca je unija (∪) skupova točaka."</em></div><div class="bug-task">Rješenje = <span class="wrong">unija ∪ skupova</span></div><div class="bug-opts" id="bug3-opts">
      <div class="bug-opt" onclick="bugAns(3,0,this)">A) Točno — unija daje sve moguće točke.</div>
      <div class="bug-opt" onclick="bugAns(3,1,this)">B) Greška — rješenje je PRESJEK (∩), tj. jedina točka koja leži na OBA pravca (za D≠0).</div>
      <div class="bug-opt" onclick="bugAns(3,2,this)">C) Greška — D=0 znači nema rješenja.</div>
</div><div class="bug-expl" id="bug3-exp"></div></div></div>
<div class="bug-box"><div class="bug-head">🐛 Prepoznaj grešku #4 — Cramer Dₓ</div><div class="bug-body"><div class="bug-quote">Student: <em>"U Cramerovom pravilu Dₓ dobivamo zamjenom DRUGOG stupca matrice s desnim stranama."</em></div><div class="bug-task">Dₓ: zamjena <span class="wrong">drugog stupca</span></div><div class="bug-opts" id="bug4-opts">
      <div class="bug-opt" onclick="bugAns(4,0,this)">A) Točno — drugi stupac je za x.</div>
      <div class="bug-opt" onclick="bugAns(4,1,this)">B) Greška — Dₓ dobivamo zamjenom PRVOG stupca (koeficijenti x: a₁,a₂) s desnim stranama (c₁,c₂).</div>
      <div class="bug-opt" onclick="bugAns(4,2,this)">C) Greška — Dₓ=c₁·c₂ (produkt desnih strana).</div>
</div><div class="bug-expl" id="bug4-exp"></div></div></div>
<div class="match-wrap"><div class="match-head"><span class="match-title">🧩 Spoji pojam ↔ definiciju</span><span class="match-score">Riješeno: <strong id="match-score">0</strong>/5</span></div><div class="match-body"><div class="match-grid"><div class="match-col"><div class="match-col-lbl">Pojam</div><button class="match-btn" data-pair="a" data-side="L" onclick="matchClick(this)">D≠0</button><button class="match-btn" data-pair="b" data-side="L" onclick="matchClick(this)">D=0, Dₓ≠0</button><button class="match-btn" data-pair="c" data-side="L" onclick="matchClick(this)">D=Dₓ=Dᵧ=0</button><button class="match-btn" data-pair="d" data-side="L" onclick="matchClick(this)">Supstitucija</button><button class="match-btn" data-pair="e" data-side="L" onclick="matchClick(this)">D=a₁b₂−a₂b₁</button></div><div class="match-col"><div class="match-col-lbl">Značenje</div><button class="match-btn" data-pair="c" data-side="R" onclick="matchClick(this)">∞ rješenja</button><button class="match-btn" data-pair="e" data-side="R" onclick="matchClick(this)">Determinanta</button><button class="match-btn" data-pair="a" data-side="R" onclick="matchClick(this)">Jedno rješenje</button><button class="match-btn" data-pair="d" data-side="R" onclick="matchClick(this)">Izrazi varijablu, uvrsti</button><button class="match-btn" data-pair="b" data-side="R" onclick="matchClick(this)">Nema rješenja</button></div></div><div class="match-reset"><button class="match-reset-btn" onclick="matchReset()">↺ Reset</button></div></div></div>
<div class="fd-wrap"><div class="fd-head"><span class="fd-title">🔍 Formula Decoder — D, Dₓ, Dᵧ</span></div><div class="fd-body"><div class="fd-formula-big"><span class="fd-hot" onclick="decodeSym(this,0)" style="color:var(--green)">D</span>=a₁b₂−a₂b₁ | x=<span class="fd-hot" onclick="decodeSym(this,1)" style="color:var(--cyan)">Dₓ</span>/D | y=<span class="fd-hot" onclick="decodeSym(this,2)" style="color:var(--amber)">Dᵧ</span>/D → <span class="fd-hot" onclick="decodeSym(this,3)" style="color:var(--pink)">(x,y)</span></div><div class="fd-symbols"><div class="fd-sym" onclick="decodeSym(this.querySelector('.fd-sym-letter'),0,this)"><span class="fd-sym-letter" style="color:var(--green)">D</span><span class="fd-sym-name">determinanta</span></div><div class="fd-sym" onclick="decodeSym(this.querySelector('.fd-sym-letter'),1,this)"><span class="fd-sym-letter" style="color:var(--cyan)">Dₓ</span><span class="fd-sym-name">za varijablu x</span></div><div class="fd-sym" onclick="decodeSym(this.querySelector('.fd-sym-letter'),2,this)"><span class="fd-sym-letter" style="color:var(--amber)">Dᵧ</span><span class="fd-sym-name">za varijablu y</span></div><div class="fd-sym" onclick="decodeSym(this.querySelector('.fd-sym-letter'),3,this)"><span class="fd-sym-letter" style="color:var(--pink)">(x,y)</span><span class="fd-sym-name">rješenje sustava</span></div></div><div class="fd-explain" id="fd-exp">👆 Klikni simbol.</div></div></div>
<div class="fcard-wrap"><div class="fcard-head"><span class="fcard-title">⚙ Formule sustava jednadžbi</span></div><div class="fcard-body">
    <div class="fcard-item"><div class="fcard-formula">D=a₁b₂−a₂b₁</div><div class="fcard-desc">Determinanta 2×2 sustava.</div></div>
    <div class="fcard-item"><div class="fcard-formula">x=Dₓ/D, y=Dᵧ/D</div><div class="fcard-desc">Cramerovo pravilo.</div></div>
    <div class="fcard-item"><div class="fcard-formula">D≠0 → jedinstveno rj.</div><div class="fcard-desc">Pravci se sijeku.</div></div>
    <div class="fcard-item"><div class="fcard-formula">D=0, proturječno → ∅</div><div class="fcard-desc">Paralelni pravci.</div></div>
    <div class="fcard-item"><div class="fcard-formula">D=0, identitet → ∞ rj.</div><div class="fcard-desc">Identični pravci.</div></div>
    <div class="fcard-item"><div class="fcard-formula">Supstitucija: y=… uvrsti</div><div class="fcard-desc">Metoda supstitucije.</div></div>
    <div class="fcard-item"><div class="fcard-formula">Eliminacija: ×koef., zbraj.</div><div class="fcard-desc">Metoda eliminacije.</div></div>
    <div class="fcard-item"><div class="fcard-formula">Lin-kvadratni → kvadratna</div><div class="fcard-desc">Supstitucijom na P06.</div></div>
  </div></div>
</div><div class="pg-disc">
...
<div class="sec-head"><span class="sec-badge">11 / 12</span><h3 class="sec-h">🧮 Kalkulator sustava 2×2</h3></div>
<div class="sec-body">
  <div class="calc-wrap">
    <div class="calc-head"><span class="calc-title">// a₁x + b₁y = c₁ | a₂x + b₂y = c₂</span></div>
    <div class="calc-tabs" role="tablist">
      <button class="calc-tab on" onclick="p9SwitchMode(0,this)">Cramer / Eliminacija</button>
      <button class="calc-tab" onclick="p9SwitchMode(1,this)">Lin-kvadratni sustav</button>
    </div>
    <div class="calc-body">
      <div id="p9-mode-0">
        <div class="calc-row" style="flex-wrap:wrap;gap:8px;align-items:center">
          <span class="calc-lbl">a₁=</span><input class="calc-in" id="p9c-a" type="number" value="1" style="width:55px" step="any">
          <span class="calc-lbl">b₁=</span><input class="calc-in" id="p9c-b" type="number" value="1" style="width:55px" step="any">
          <span class="calc-lbl">c₁=</span><input class="calc-in" id="p9c-k" type="number" value="5" style="width:55px" step="any">
          <span class="calc-lbl">a₂=</span><input class="calc-in" id="p9cv-a" type="number" value="2" style="width:55px" step="any">
          <span class="calc-lbl">b₂=</span><input class="calc-in" id="p9cv-q" type="number" value="-1" style="width:55px" step="any">
          <span class="calc-lbl">c₂=</span><input class="calc-in" id="p9cft-n" type="number" value="4" style="width:55px" step="any">
          <button class="calc-go" onclick="p9calc()">Riješi →</button>
        </div>
      </div>
      <div id="p9-mode-1" style="display:none">
        <div class="calc-row" style="flex-wrap:wrap;gap:8px;align-items:center">
          <span class="calc-lbl" style="font-size:11px">y=kx+l i y=ax²+bx+c</span><br>
          <span class="calc-lbl">k=</span><input class="calc-in" id="p9cft-p" type="number" value="1" style="width:55px" step="any">
          <span class="calc-lbl">l=</span><input class="calc-in" id="p9cft-q" type="number" value="2" style="width:55px" step="any">
          <span class="calc-lbl">a=</span><input class="calc-in" id="p9c-k2" type="number" value="1" style="width:55px" step="any">
          <span class="calc-lbl">b=</span><input class="calc-in" id="p9cft-r" type="number" value="0" style="width:55px" step="any">
          <span class="calc-lbl">c=</span><input class="calc-in" id="p9cft-s" type="number" value="0" style="width:55px" step="any">
...
<div class="sec-body">
  <div class="sr" id="sr1"><div class="sr-head"><span class="sr-no">Primjer 1 · Supstitucija</span><span class="sr-pts">4 boda</span></div><div class="sr-q">x+y=5, 2x−y=4.</div><button class="sr-try" onclick="tryIt(1)">▶ Pokreni</button><div class="sr-steps" id="sr1-steps"><div class="sr-step" data-s="1">Iz prve: y=5−x.</div><div class="sr-step" data-s="2">Uvrsti: 2x−(5−x)=4 → 3x=9 → x=3.</div><div class="sr-step" data-s="3">y=5−3=2. <em>(3,2)</em>. Provjera: 3+2=5 ✓, 6−2=4 ✓.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(1)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(1)">Reset</button></div></div></div>
  <div class="sr" id="sr2"><div class="sr-head"><span class="sr-no">Primjer 2 · Eliminacija</span><span class="sr-pts">4 boda</span></div><div class="sr-q">2x+y=7, x−y=2.</div><button class="sr-try" onclick="tryIt(2)">▶ Pokreni</button><div class="sr-steps" id="sr2-steps"><div class="sr-step" data-s="1">Zbrajanje: 3x=9 → x=3.</div><div class="sr-step" data-s="2">y=7−2·3=1. <em>(3,1)</em>. Provjera: 6+1=7 ✓, 3−1=2 ✓.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(2)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(2)">Reset</button></div></div></div>
  <div class="sr" id="sr3"><div class="sr-head"><span class="sr-no">Primjer 3 · Cramer</span><span class="sr-pts">4 boda</span></div><div class="sr-q">2x+y=5, x−y=1.</div><button class="sr-try" onclick="tryIt(3)">▶ Pokreni</button><div class="sr-steps" id="sr3-steps"><div class="sr-step" data-s="1">D=2·(−1)−1·1=−3. Dₓ=5·(−1)−1·1=−6. Dᵧ=2·1−1·5=−3.</div><div class="sr-step" data-s="2">x=2, y=1. <em>(2,1)</em>.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(3)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(3)">Reset</button></div></div></div>
  <div class="sr" id="sr4"><div class="sr-head"><span class="sr-no">Primjer 4 · Nema rješenja</span><span class="sr-pts">3 boda</span></div><div class="sr-q">x+y=3, x+y=5.</div><button class="sr-try" onclick="tryIt(4)">▶ Pokreni</button><div class="sr-steps" id="sr4-steps"><div class="sr-step" data-s="1">D=1·1−1·1=0. Dₓ=3·1−5·1=−2≠0.</div><div class="sr-step" data-s="2">D=0, Dₓ≠0 → <em>nema rješenja</em>. Pravci paralelni.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(4)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(4)">Reset</button></div></div></div>
  <div class="sr" id="sr5"><div class="sr-head"><span class="sr-no">Primjer 5 · ∞ rješenja</span><span class="sr-pts">3 boda</span></div><div class="sr-q">2x+4y=6, x+2y=3.</div><button class="sr-try" onclick="tryIt(5)">▶ Pokreni</button><div class="sr-steps" id="sr5-steps"><div class="sr-step" data-s="1">Druga jednadžba ×2: 2x+4y=6. Identično prvoj!</div><div class="sr-step" data-s="2">D=0, Dₓ=0 → <em>beskonačno rješenja</em>. x+2y=3.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(5)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(5)">Reset</button></div></div></div>
  <div class="sr" id="sr6"><div class="sr-head"><span class="sr-no">Primjer 6 · Lin-kvadratni</span><span class="sr-pts">5 bodova</span></div><div class="sr-q">y=x+2, y=x².</div><button class="sr-try" onclick="tryIt(6)">▶ Pokreni</button><div class="sr-steps" id="sr6-steps"><div class="sr-step" data-s="1">Supstitucija: x²=x+2 → x²−x−2=0.</div><div class="sr-step" data-s="2">D=9. x=2 ili x=−1. <em>(2,4)</em> i <em>(−1,1)</em>.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(6)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(6)">Reset</button></div></div></div>
  <div class="sr" id="sr7"><div class="sr-head"><span class="sr-no">Primjer 7 · Word problem</span><span class="sr-pts">5 bodova</span></div><div class="sr-q">Odrasli 10€, djeca 5€, 100 posjetitelja, 700€ prihod.</div><button class="sr-try" onclick="tryIt(7)">▶ Pokreni</button><div class="sr-steps" id="sr7-steps"><div class="sr-step" data-s="1">x+y=100, 10x+5y=700 → 10x+5(100−x)=700 → 5x=200.</div><div class="sr-step" data-s="2">x=40, y=60. <em>40 odraslih, 60 djece</em>.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(7)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(7)">Reset</button></div></div></div>
  <div class="sr" id="sr8"><div class="sr-head"><span class="sr-no">Primjer 8 · Sustav s parametrom</span><span class="sr-pts">4 boda</span></div><div class="sr-q">mx+y=1, x+my=1. Za koje m nema jedinstvenog rješenja?</div><button class="sr-try" onclick="tryIt(8)">▶ Pokreni</button><div class="sr-steps" id="sr8-steps"><div class="sr-step" data-s="1">D=m²−1. Nema jedinstvenog za D=0: m=±1.</div><div class="sr-step" data-s="2">Za m=1: oba isti pravac (∞ rj.). Za m=−1: paralelni (0 rj.).</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(8)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(8)">Reset</button></div></div></div>
  <div class="sr" id="sr9"><div class="sr-head"><span class="sr-no">Primjer 9 · Brzine</span><span class="sr-pts">5 bodova</span></div><div class="sr-q">Brod uz struju plovi 40 km/h, uz vjetar 30 km/h. Brzina broda i struje?</div><button class="sr-try" onclick="tryIt(9)">▶ Pokreni</button><div class="sr-steps" id="sr9-steps"><div class="sr-step" data-s="1">v+s=40, v−s=30 (v=brzina broda, s=struja).</div><div class="sr-step" data-s="2">Zbrajanje: 2v=70 → v=35. s=5. <em>Brod 35 km/h, struja 5 km/h</em>.</div><div class="sr-steps-ctrl"><button class="sr-next" onclick="nxtStep(9)">Sljedeći →</button><button class="sr-rst" onclick="rstStep(9)">Reset</button></div></div></div>
<div class="sr" id="sr10"><div class="sr-head"><span class="sr-no">Primjer 10 · Gaussova eliminacija · 3×3</span><span class="sr-pts">6 bodova</span></div><div class="sr-q">Riješi sustav Gaussovim postupkom: x+y+z=6, 2x−y+z=3, x+2y−z=2.</div><button class="sr-try" onclick="tryIt(10)">▶ Pokreni</button><div class="sr-steps" id="sr10-steps">
  <div class="sr-step" data-s="1"><strong>Matrični zapis</strong> (proširena matrica):<br>[1&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;|&nbsp;6]<br>[2&nbsp;−1&nbsp;&nbsp;1&nbsp;|&nbsp;3]<br>[1&nbsp;&nbsp;2&nbsp;−1&nbsp;|&nbsp;2]</div>
  <div class="sr-step" data-s="2"><strong>Eliminacija 1. stupca</strong>: R2 → R2−2R1, R3 → R3−R1:<br>[1&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;|&nbsp;&nbsp;&nbsp;6]<br>[0&nbsp;−3&nbsp;−1&nbsp;|&nbsp;−9]<br>[0&nbsp;&nbsp;1&nbsp;−2&nbsp;|&nbsp;−4]</div>
  <div class="sr-step" data-s="3"><strong>Eliminacija 2. stupca u R3</strong>: R3 → 3R3+R2 (da se riješimo razlomka):<br>[0&nbsp;&nbsp;3&nbsp;−6&nbsp;|&nbsp;−12] + [0&nbsp;−3&nbsp;−1&nbsp;|&nbsp;−9] = [0&nbsp;&nbsp;0&nbsp;−7&nbsp;|&nbsp;−21]<br>Gornji trokutasti oblik: −7z = −21 → <strong>z = 3</strong>.</div>
  <div class="sr-step" data-s="4"><strong>Natrag-supstitucija</strong>: Iz R2: −3y − z = −9 → −3y − 3 = −9 → y = 2.<br>Iz R1: x + y + z = 6 → x + 2 + 3 = 6 → <strong>x = 1</strong>.</div>
  <div class="sr-step" data-s="5"><em>Rješenje: <strong>(1, 2, 3)</strong>. Provjera: 1+2+3=6 ✓, 2−2+3=3 ✓, 1+4−3=2 ✓.</em></div>
...
<div class="cp-wrap">
  ...
  <div class="cp-list" id="cp-list">
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Rješavam 2×2 sustav metodom supstitucije</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Rješavam 2×2 sustav metodom eliminacije</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Koristim Cramerovo pravilo s determinantama</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Prepoznajem tip rješenja: jedno/nema/beskonačno (D test)</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Rješavam lin-kvadratni sustav supstitucijom</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Modeliram word problems kao sustav jednadžbi</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Geometrijski interpretiram rješenje kao presjek pravaca</div></div>
    <div class="cp-item" onclick="toggleCP(this)" tabindex="0"><div class="cp-checkbox"></div><div class="cp-text">Provjerim rješenje uvrštavanjem u obje jednadžbe</div></div>
  </div>


  <div class="cp-msg-hint" id="cp-msg-hint">Označi sve što znaš. Kad budu svi — dobivaš Master achievement.</div>
  <div class="cp-ready" id="cp-ready">🏆 Spreman/na si za P08! Idemo dalje.</div>
...
<div class="cn-wrap">
  ...
  <div class="cn-grid">
    <div class="cn-card" onclick="navigateChapter('p08')" style="cursor:pointer"><div class="cn-h">Sljedeće · P08</div><div class="cn-t">Linearna funkcija</div></div>
    <div class="cn-card" onclick="navigateChapter('p06')" style="cursor:pointer"><div class="cn-h">Prethodno · P06</div><div class="cn-t">Kvadratne jednadžbe</div></div>
    <div class="cn-card" onclick="navigateChapter('p06')" style="cursor:pointer"><div class="cn-h">Povezano · P06</div><div class="cn-t">Kvadratne jednadžbe</div><div class="cn-s">lin-kvadratni sustavi</div></div>
    <div class="cn-card" onclick="navigateChapter('p05')" style="cursor:pointer"><div class="cn-h">Povezano · P05</div><div class="cn-t">Linearne jednadžbe</div><div class="cn-s">jedna jednadžba</div></div>
  </div>
</div>
...
<div class="nav-row">
  ...
  <button class="nb primary" onclick="navigateChapter('p08')">08 · Linearna funkcija →</button>
</div>
...
/* === P07 DATA === */
const GON_DATA=[
  {q:'Rješenje sustava x+y=5, x−y=1 je (3,2).',a:true,e:'x+y=5 i x−y=1 → 2x=6 → x=3, y=2 ✓.'},
  {q:'Determinanta D=0 znači da sustav nema rješenja.',a:false,e:'D=0 znači nema JEDINSTVENOG rješenja — može biti 0 ili ∞ rješenja.'},
  {q:'Sustav 2×2 uvijek ima točno jedno rješenje.',a:false,e:'Može imati 0 (paralelni), 1 (sijeku se) ili ∞ (identični).'},
  {q:'Cramerovo pravilo: x=Dₓ/D gdje Dₓ=c₁b₂−c₂b₁.',a:true,e:'Standardna Cramerova formula.'},
  {q:'Supstitucija: iz jedne jednadžbe izrazi jednu varijablu i uvrsti u drugu.',a:true,e:'Točna definicija metode supstitucije.'},
  {q:'Sustav x+y=3 i x+y=5 ima jedno rješenje.',a:false,e:'Isti lijevi član, različita desna → paralelni → nema rješenja.'},
  {q:'D=a₁b₂−a₂b₁ za sustav a₁x+b₁y=c₁, a₂x+b₂y=c₂.',a:true,e:'Definicija determinante 2×2 sustava.'},
  {q:'Lin-kvadratni sustav uvijek ima 2 rješenja.',a:false,e:'Može imati 0, 1 ili 2 rješenja (ovisi o D kvadratne jednadžbe).'},
  {q:'Sustav 2x+4y=6 i x+2y=3 ima beskonačno rješenja.',a:true,e:'Druga jednadžba ×2 daje prvu → identičan pravac.'},
  {q:'Rješenje y=x+1 i y=x² su točke (1,2) i... treba još.',a:false,e:'x²=x+1 → x²−x−1=0 → D=5 → x=(1±√5)/2. Nema lijepih rješenja.'},
  {q:'Eliminacija: množimo jednadžbe konstantama da se jedan koeficijent poništi.',a:true,e:'Točna definicija metode eliminacije.'},
  {q:'Rješenje sustava je presjek grafova jednadžbi.',a:true,e:'Svaka linearna jednadžba je pravac; presjek = rješenje sustava.'},
  {q:'Za D≠0 Cramerovo pravilo daje jedinstveno rješenje.',a:true,e:'D≠0 → matrica regularna → jedinstveno rješenje.'},
  {q:'Sustav mx+y=1, x+my=1 za m=1 nema rješenja.',a:false,e:'Za m=1: x+y=1 (identična jednadžba) → ∞ rješenja.'},
  {q:'Rješenje sustava x+2y=8, 3x−y=3 je (2,3).',a:true,e:'2+6=8 ✓, 6−3=3 ✓.'},
  {q:'Lin-kvadratni sustav rješavamo supstitucijom linearnog u kvadratno.',a:true,e:'Iz linearne: y=kx+l, uvrsti u kvadratnu → kvadratna u x.'},
  {q:'D=3·(−1)−2·1=−5 za sustav 3x+y=4, 2x−y=1.',a:true,e:'D=a₁b₂−a₂b₁=3·(−1)−2·1=−3−2=−5 ✓ (za 3x+y=4, 2x−y=1).'},
  {q:'Provjera rješenja: uvrsti (x,y) u OBJE jednadžbe.',a:true,e:'Mora zadovoljiti sve jednadžbe sustava.'},
  {q:'Paralelni pravci imaju isti nagib i različit y-isječak.',a:true,e:'Ključno svojstvo paralelnosti iz P08.'},
  {q:'Rješenje y=2x i y=x²: točke (0,0) i (2,4).',a:true,e:'x²=2x → x(x−2)=0 → x=0 ili x=2.'},
  {q:'Za sustav s 3 jednadžbe i 3 nepoznanice uvijek postoji jedinstveno rješenje.',a:false,e:'Može biti 0, 1 ili ∞ rješenja ovisno o determinanti i konzistentnosti.'},
  {q:'Dₓ dobivamo zamjenom stupca koeficijenata x s desnim stranama.',a:true,e:'Standardna Cramerova notacija: zamjena a₁,a₂ s c₁,c₂.'},
  {q:'Rješenje x+y=4 i 2x+2y=8 je beskonačno.',a:true,e:'Druga jednadžba = 2× prva. Identičan pravac.'},
  {q:'Metodom eliminacije za x+y=5, 2x+y=7: oduzimanjem prva−druga → −x=−2 → x=2.',a:true,e:'y=5−2=3. Provjera: 4+3=7 ✓.'},
  {q:'Za sustav bez rješenja (proturječan), Dₓ ili Dᵧ nije nula.',a:true,e:'D=0 ali Dₓ≠0 ili Dᵧ≠0 → proturječan sustav.'},
  {q:'Svaki 2×2 sustav može se riješiti Cramerovim pravilom.',a:false,e:'Samo za D≠0. Za D=0 Cramer ne vrijedi.'},
  {q:'Rješenje sustava je jedina točka koja leži na svim pravcima sustava.',a:true,e:'Za jedno rješenje: jedina točka presjeka.'},
  {q:'Lin-kvadratni sustav y=3x−1 i y=x²−2x+1: rješenje x=1 i x=2.',a:false,e:'Provjera: x=1 daje y=2 u pravcu, ali parabola daje 1−2+1=0≠2. Stvarna rješenja: x²−5x+2=0 → x=(5±√17)/2 (iracionalna).'}
];
const DRILL_DATA=[
  {q:'Rijesi: x+y=5, x−y=1.',opts:['(2,3)','(4,1)','(3,2)','(1,4)'],ok:2,diff:'easy',exp:'Zbrajanje: 2x=6→x=3, y=2.'},
  {q:'Determinanta D za a₁=2,b₁=1,a₂=1,b₂=−1?',opts:['3','1','−3','−1'],ok:2,diff:'easy',exp:'D=2·(−1)−1·1=−3.'},
  {q:'Rijesi: 2x+y=7, x−y=2.',opts:['(1,3)','(3,1)','(2,3)','(3,2)'],ok:1,diff:'easy',exp:'Zbrajanje: 3x=9→x=3, y=1.'},
  {q:'Sustav x+y=3 i x+y=5 ima:',opts:['(0,3)','beskonačno','(1,2)','nema rješenja'],ok:3,diff:'easy',exp:'Isti koeficijenti, različiti slobodni → paralelni.'},
  {q:'Metoda supstitucije: iz x+2y=6 → x=?',opts:['x=2y−6','x=6+2y','x=6/2y','x=6−2y'],ok:3,diff:'easy',exp:'x=6−2y.'},
  {q:'Cramer: x=Dₓ/D. Dₓ=c₁b₂−c₂b₁. c₁=3,b₂=−1,c₂=1,b₁=2: Dₓ=?',opts:['−5','5','−1','1'],ok:0,diff:'easy',exp:'Dₓ=3·(−1)−1·2=−5.'},
  {q:'Lin-kvadratni: y=x+2, y=x². Jednadžba za x?',opts:['x²−x−2=0','x²+x+2=0','x²−x+2=0','x²+2x=0'],ok:0,diff:'easy',exp:'x²=x+2 → x²−x−2=0.'},
  {q:'Rješenje y=x+2, y=x²?',opts:['(2,4)','(2,4) i (−1,1)','(−1,1)','(0,2)'],ok:1,diff:'easy',exp:'x=2 ili x=−1 (D=9).'},
  {q:'Rijesi: x+2y=8, 3x−y=3.',opts:['(3,2)','(1,4)','(2,3)','(4,2)'],ok:2,diff:'easy',exp:'3·(x+2y)−(3x−y)=24−3→7y=21→y=3, x=2.'},
  {q:'D=0 i Dₓ≠0 → sustav ima...?',opts:['jedno rješenje','nema rješenja','beskonačno','dva rješenja'],ok:1,diff:'easy',exp:'D=0,Dₓ≠0 → proturječan → nema.'},
  {q:'Rijesi: 3x+2y=12, x+y=5.',opts:['(3,2)','(4,0)','(1,4)','(2,3)'],ok:3,diff:'med',exp:'Supstitucija: x=5−y → 3(5−y)+2y=12 → 15−y=12 → y=3, x=2.'},
  {q:'D za: 2x+3y=7, x−y=1?',opts:['5','−5','−1','1'],ok:1,diff:'med',exp:'D=2·(−1)−1·3=−5.'},
  {q:'Cramer: 2x+y=5, x−y=1. x=?',opts:['3','1','2','4'],ok:2,diff:'med',exp:'D=−3, Dₓ=5·(−1)−1·1=−6, x=2.'},
  {q:'Lin-kvadratni: y=2x, y=x²+1. Broj rješenja?',opts:['2','0','1 (tangenta)','beskonačno'],ok:2,diff:'med',exp:'x²+1=2x → x²−2x+1=(x−1)²=0 → x=1 (dupli korijen). Jedno rješenje (1,2) — pravac je tangenta.'},
  {q:'Rijesi: 4x−y=5, 2x+y=7.',opts:['(3,2)','(1,3)','(2,1)','(2,3)'],ok:3,diff:'med',exp:'Zbrajanje: 6x=12→x=2, y=3.'},
  {q:'Sustav 2x+4y=6, x+2y=3 ima:',opts:['beskonačno','(1,1)','nema','(3,0)'],ok:0,diff:'med',exp:'Proporcionalnost → identičan pravac → ∞.'},
  {q:'Word problem: odrasli 10€, djeca 5€, 80 ulaznica, 650€. Koliko odraslih?',opts:['40','50','30','60'],ok:1,diff:'med',exp:'x+y=80, 10x+5y=650 → 5x=250 → x=50.'},
  {q:'Param sustav: mx+y=m, x+y=1. Za m=1: tip rješenja?',opts:['beskonačno','nema','(1,0)','(0,1)'],ok:0,diff:'med',exp:'m=1: x+y=1 (iste jednadžbe) → ∞.'},
  ...
  {q:'Lin-kvadratni: tangenta y=kx+5 na kružnicu x²+y²=5. k=?',opts:['±2','±1','±√5','±2/√5'],ok:0,diff:'hard',exp:'Substitucija: x²+(kx+5)²=5 → (1+k²)x²+10kx+20=0. Tangenta → D=0: 100k²−80(1+k²)=0 → 20k²=80 → k=±2.'},
  {q:'Broj rješenja: x²+y²=1 i y=x+2.',opts:['0','1','2','beskonačno'],ok:0,diff:'hard',exp:'x²+(x+2)²=1 → 2x²+4x+3=0 → D=16−24=−8<0 → nema realnih rješenja.'},
  {q:'Rijesi: 1/x+1/y=5/6, 1/x−1/y=1/6. (x,y≠0)',opts:['(3,2)','(1,6)','(2,3)','(6,1)'],ok:2,diff:'hard',exp:'u=1/x,v=1/y: u+v=5/6, u−v=1/6. 2u=1→u=1/2,v=1/3. x=2,y=3.'}

];
const HINTS=['2x=6→x=3.','D=2(−1)−1·1.','3x=9.','isti koef→paralel.','x=6−2y.','Dₓ=3(−1)−1·2.','x²−x−2=0.','D=9→x=2,−1.','7y=21.','D=0,Dₓ≠0.','x=5−y→3(5−y)+2y=12.','D=2(−1)−1·3.','D=−3,Dₓ=−6.','(x−1)²=0→D=0.','6x=12.','proporcija→isti pravac.','5x=250.','m=1→iste jedn.','x=y,4x=8.','x=y,3x=6.','D=2m−1=0.','x²−4x+2=0.','D=a²−b².','v+s=20,v−s=12.','z=2,x=1,y=3.','D=0 za tangentu.','2x²+4x+3=0.','u=1/x,v=1/y.'];
const QUIZ_DATA=[
  {q:'Rješenje sustava x+y=6, x−y=2:',opts:['(4,2)','(2,4)','(3,3)','(5,1)'],ok:0,e:'Zbrajanje: 2x=8→x=4, y=2.'},
  {q:'Rješenje sustava 2x+y=5, x+y=3:',opts:['(1,2)','(2,1)','(3,0)','(0,3)'],ok:1,e:'Oduzimanje: x=2, y=3−2=1.'},
  {q:'Determinanta D za sustav x+2y=5, 3x−y=4:',opts:['7','−5','−7','5'],ok:2,e:'D=1·(−1)−3·2=−1−6=−7.'},
  {q:'Lin-kvadratni: y=x, y=x²−2. Rješenja?',opts:['(1,1) i (−2,−2)','(2,2) i (−1,−1)','(0,0) i (2,2)','nema'],ok:1,e:'x²−2=x → x²−x−2=0 → (x−2)(x+1)=0 → x=2 ili x=−1.'},
  {q:'Sustav x+y=4, 2x+2y=10 ima:',opts:['jedno rješenje','beskonačno','dva','nema rješenja'],ok:3,e:'2x+2y=10 → x+y=5, ali prva jedn. kaže x+y=4 → proturječje.'},
  {q:'Za koje m sustav mx+y=3, x+y=1 nema rješenja?',opts:['m=0','m=1','m=−1','m=3'],ok:1,e:'Za m=1: x+y=3 i x+y=1 → proturječje. D=m−1=0 za m=1.'},
  {q:'Rješenje 3×3 sustava: x+y=5, y+z=7, x+z=6:',opts:['(2,3,4)','(1,4,3)','(3,2,5)','(2,4,3)'],ok:0,e:'Zbroj svih: 2(x+y+z)=18 → x+y+z=9. z=9−5=4, x=9−7=2, y=9−6=3.'},
  {q:'Simetrični sustav x+y=5, x²+y²=13. Rješenja?',opts:['(2,3) ili (3,2)','(1,4) ili (4,1)','(2,4) ili (4,2)','nema'],ok:0,e:'(x+y)²=x²+2xy+y² → 25=13+2xy → xy=6. Vieta: t²−5t+6=0 → t=2,3.'}
];
const CH_DATA=[
  {q:'Postavi sustav s jednim rješenjem (D≠0).',check:{"type": "unique"}},
  {q:'Postavi sustav bez rješenja (D=0, Dₓ≠0).',check:{"type": "no_sol"}},
  {q:'Postavi sustav s beskonačno rješenja (D=Dₓ=Dᵧ=0).',check:{"type": "infinite"}},
  {q:'Aktiviraj preset \\'Jedno rješenje\\'.',check:{"type": "preset", "name": "basic"}},
  {q:'Aktiviraj preset \\'Nema rješenja\\'.',check:{"type": "preset", "name": "parallel"}},
  {q:'Aktiviraj preset \\'∞ rješenja\\'.',check:{"type": "preset", "name": "same"}},
  {q:'Postavi rješenje (x,y)=(3,2).',check:{"type": "solution", "x": 3, "y": 2, "tol": 0.1}},
  {q:'Aktiviraj preset \\'Cramer primjer\\'.',check:{"type": "preset", "name": "cramer"}},
  {q:'Postavi rješenje (x,y)=(0,0).',check:{"type": "solution", "x": 0, "y": 0, "tol": 0.05}},
  {q:'Aktiviraj preset \\'Karte zadatak\\'.',check:{"type": "preset", "name": "karte"}},
  {q:'Postavi rješenje (x,y)=(1,1).',check:{"type": "solution", "x": 1, "y": 1, "tol": 0.1}},
  {q:'Postavi sustav s D=−3.',check:{"type": "det", "val": -3, "tol": 0.1}}
];
const BUG_ANSWERS={
  1:{correct:1,explain:{
    0:'✗ Krivo — D≠0 → JEDNO rješenje, ne beskonačno.',
    1:'✓ Točno! D=a₁b₂−a₂b₁=1·(−1)−1·1=−2≠0 → jedinstveno rješenje.',
    2:'✗ Krivo — proturječnost nastaje kad D=0 i Dₓ≠0.'
  }},
  2:{correct:1,explain:{
    0:'✗ Krivo — u eliminaciji množiš jednadžbe da PONIŠTIŠ jednu varijablu (koeficijent=0), ne da ih izjednačiš.',
    1:'✓ Točno! Eliminacija: množi jednadžbe konstantama da se koeficijent jedne varijable poništi, zatim zbrajaj/oduzimaj.',
    2:'✗ Krivo — supstitucija izražava jednu varijablu. Eliminacija radi s koeficijentima direktno.'
  }},
  3:{correct:1,explain:{
    0:'✗ Krivo — rješenje je presjek, ne unija. Unija bi bili SVI točke koji leže na BILO kojem od pravaca.',
    1:'✓ Točno! Rješenje 2×2 sustava je presjek (∩) skupova točaka, tj. jedina točka koja leži na OBA pravca.',
    2:'✗ Krivo — D=0 znači ili nema rješenja ILI beskonačno. Provjeri Dₓ i Dᵧ za konačni odgovor.'
  }},
  4:{correct:1,explain:{
    0:'✗ Krivo — u Cramerovom pravilu Dₓ dobivamo zamjenom PRVOG stupca (koeficijenti x) s desnim stranama.',
    1:'✓ Točno! Dₓ: u determinanti D zamijeni koeficijente a₁,a₂ s desnim stranama c₁,c₂. Dᵧ: zamijeni b₁,b₂ s c₁,c₂.',
    2:'✗ Krivo — Cramer uvijek koristi determinantu D u nazivniku, ali Dₓ i Dᵧ imaju odgovarajuće zamjene stupaca.'
  }}
};
const FD_EXPLANATIONS={
  "0":{"name":"D (determinanta)","desc":"D=a₁b₂−a₂b₁. D≠0→jedno rješenje. D=0→ili nema ili beskonačno rješenja."},
  "1":{"name":"Dₓ (Cramer za x)","desc":"Dₓ=c₁b₂−c₂b₁. Zamjena stupca x s desnim stranama. x=Dₓ/D (za D≠0)."},
  "2":{"name":"Dᵧ (Cramer za y)","desc":"Dᵧ=a₁c₂−a₂c₁. Zamjena stupca y s desnim stranama. y=Dᵧ/D (za D≠0)."},
  "3":{"name":"Rješenje (x,y)","desc":"Koordinate presjeka dvaju pravaca. Provjeri uvrštavanjem u OBJE jednadžbe!"}
};
...
const LS_KEY = 'matb_p07';
const FAV_KEY = 'matb_p07_favs';
const ACH_KEY = 'matb_p07_ach';
...
// ═══ P07 2x2 SYSTEM EXPLORER ═══
const pbx = { mode: 0, zoom: 1, lastPreset: null, challengeOn: false, chScore: 0, chTot: 0,
...
function getCoeffs() {
  ...
  return { a1:g('p7-a1'),b1:g('p7-b1'),c1:g('p7-c1'),a2:g('p7-a2'),b2:g('p7-b2'),c2:g('p7-c2') };
}
...
function solveSystem(a1,b1,c1,a2,b2,c2) {
  ...
  if (Math.abs(D) < 1e-10) {
    if (Math.abs(Dx) < 1e-10 && Math.abs(Dy) < 1e-10) return { type:'infinite', D, Dx, Dy };
    return { type:'none', D, Dx, Dy };
  }
  return { type:'unique', x:Dx/D, y:Dy/D, D, Dx, Dy };
}
...
function pbxPreset(name, btn) {
  ...
  pbx.lastPreset = name;
  const presets = {
    basic:    {a1:1,b1:1,c1:5,a2:2,b2:-1,c2:4},
    parallel: {a1:1,b1:1,c1:3,a2:1,b2:1,c2:5},
    same:     {a1:2,b1:4,c1:6,a2:1,b2:2,c2:3},
    cramer:   {a1:2,b1:1,c1:5,a2:1,b2:-1,c2:1},
    karte:    {a1:1,b1:1,c1:100,a2:10,b2:5,c2:700},
  };
  const p = presets[name]; if (!p) return;
  Object.assign(pbx, p);
  ['a1','b1','c1','a2','b2','c2'].forEach(k => {
    const el = document.getElementById('p7-'+k); if (el) el.value = p[k];
  });
  pbxUpdate();
}
...
function pbxUpdate() {
  const c = getCoeffs();
  Object.assign(pbx, c);
  const sol = solveSystem(c.a1,c.b1,c.c1,c.a2,c.b2,c.c2);

  const dEl = document.getElementById('pbx-angles-val');
  const sEl = document.getElementById('pbx-peri-val');
  if (dEl) { dEl.textContent = fmtN(sol.D); dEl.className='pbx-ctrl-val'+(Math.abs(sol.D)>0.001?' ok':''); }
  if (sEl) {
    sEl.textContent = sol.type==='unique' ? '('+fmtN(sol.x)+', '+fmtN(sol.y)+')' : sol.type==='none' ? '∅ (nema)' : '∞ rješenja';
    sEl.className = 'pbx-ctrl-val '+(sol.type==='unique'?'ok':sol.type==='none'?'ng':'');
  }

  const info = document.getElementById('pbx-info');
  if (info) {
    const det = 'D='+fmtN(sol.D);
    info.innerHTML = '<strong>'+fmtN(c.a1)+'x+'+fmtN(c.b1)+'y='+fmtN(c.c1)+' | '+fmtN(c.a2)+'x+'+fmtN(c.b2)+'y='+fmtN(c.c2)+'</strong> | '+det+' | '+(sol.type==='unique'?'Rj: ('+fmtN(sol.x)+','+fmtN(sol.y)+')':sol.type==='none'?'Nema rješenja':'∞ rješenja');
  }
  ...
  if (!ctx) return;
  drawSystem(ctx, canvas.width, canvas.height, c, sol);
}

function drawSystem(ctx, W, H, c, sol) {
  const pad = 44, range = 8 / pbx.zoom;
  const xMin = sol.type==='unique' ? sol.x - range : -range;
  const xMax = sol.type==='unique' ? sol.x + range : range;
  const yMin = sol.type==='unique' ? sol.y - range : -range;
  const yMax = sol.type==='unique' ? sol.y + range : range;
  ...
  for (let gx=Math.ceil(xMin/step)*step; gx<=xMax; gx+=step) {
    ...
    ctx.fillText(fmtN(gx), sx(gx), H-pad+14);
  }
  for (let gy=Math.ceil(yMin/step)*step; gy<=yMax; gy+=step) {
    ctx.beginPath(); ctx.moveTo(pad,sy(gy)); ctx.lineTo(W-pad,sy(gy)); ctx.stroke();
    if (Math.abs(gy)>0.001) { ctx.fillStyle='#4A5568'; ctx.textAlign='right'; ctx.fillText(fmtN(gy), pad-4, sy(gy)+3); }
  }

  // Axes
  if (xMin<0&&xMax>0) { ctx.strokeStyle='rgba(77,158,255,0.4)'; ctx.lineWidth=1; ctx.beginPath(); ctx.moveTo(sx(0),pad); ctx.lineTo(sx(0),H-pad); ctx.stroke(); }
  if (yMin<0&&yMax>0) { ctx.beginPath(); ctx.moveTo(pad,sy(0)); ctx.lineTo(W-pad,sy(0)); ctx.stroke(); }

  // Draw line: a*x + b*y = c → y = (c - a*x) / b
  function drawLine(a, b, cc, color, label) {
    ctx.strokeStyle=color; ctx.lineWidth=2.5; ctx.setLineDash([]);
    if (Math.abs(b) > 0.001) {
      const y0=(cc-a*xMin)/b, y1=(cc-a*xMax)/b;
      ctx.beginPath(); ctx.moveTo(sx(xMin),sy(y0)); ctx.lineTo(sx(xMax),sy(y1)); ctx.stroke();
      ctx.fillStyle=color; ctx.font='bold 11px JetBrains Mono'; ctx.textAlign='left';
      ctx.fillText(label, sx(xMin)+4, sy(y0)-6);
    } else if (Math.abs(a) > 0.001) {
      const x0=cc/a;
      ctx.beginPath(); ctx.moveTo(sx(x0),pad); ctx.lineTo(sx(x0),H-pad); ctx.stroke();
      ctx.fillStyle=color; ctx.font='bold 11px JetBrains Mono'; ctx.textAlign='left';
      ctx.fillText(label, sx(x0)+4, pad+16);
    }
  }

  drawLine(c.a1,c.b1,c.c1,'#4D9EFF',fmtN(c.a1)+'x+'+fmtN(c.b1)+'y='+fmtN(c.c1));
  ctx.setLineDash([6,3]);
  drawLine(c.a2,c.b2,c.c2,'#F59E0B',fmtN(c.a2)+'x+'+fmtN(c.b2)+'y='+fmtN(c.c2));
  ctx.setLineDash([]);

  if (sol.type==='unique') {
    const px=sx(sol.x), py=sy(sol.y);
    ctx.fillStyle='#34D399'; ctx.beginPath(); ctx.arc(px,py,8,0,Math.PI*2); ctx.fill();
    ctx.fillStyle='#34D399'; ctx.font='bold 12px JetBrains Mono'; ctx.textAlign='center';
    ctx.fillText('('+fmtN(sol.x)+','+fmtN(sol.y)+')', px, py-14);
  }

  const typeLabel = sol.type==='unique'?'Jedno rješenje':sol.type==='none'?'Nema rješenja (∅)':'∞ rješenja';
  const typeColor = sol.type==='unique'?'#34D399':sol.type==='none'?'#E05252':'#A78BFA';
  ctx.fillStyle=typeColor; ctx.font='bold 11px JetBrains Mono'; ctx.textAlign='right';
  ctx.fillText(typeLabel, W-pad-4, pad+14);
}
...
function pbxChallengeToggle() {
  ...
  else{wrap.classList.remove('show');btn.textContent='🎯 Pokreni izazov';}
}

function pbxChallengeNext() {
  if (!PBX_CH_DATA||!PBX_CH_DATA.length) return;
  const solved=(pbxCh&&pbxCh.solved)||[];
  const rem=PBX_CH_DATA.filter((_,i)=>!solved.includes(i));
  const pool=rem.length?rem:PBX_CH_DATA;
  const choice=pool[Math.floor(Math.random()*pool.length)];
  pbxCh={...choice,idx:PBX_CH_DATA.indexOf(choice),solved};
...
function pbxChallengeCheck() {
  ...
  let pass=false,msg='';
  switch(ch.type){
    case 'unique':pass=sol.type==='unique';msg=pass?'✓ Jedinstveno rješenje':'✗ Nije jedinstveno (D='+fmtN(sol.D)+')';break;
    case 'no_sol':pass=sol.type==='none';msg=pass?'✓ Nema rješenja':'✗ Nije bez rješenja';break;
    case 'infinite':pass=sol.type==='infinite';msg=pass?'✓ Beskonačno rješenja':'✗ Nije beskonačno';break;
    case 'preset':pass=pbx.lastPreset===ch.name;msg=pass?'✓ Preset ok':'✗ Klikni preset "'+ch.name+'"';break;
    case 'solution':pass=sol.type==='unique'&&Math.abs(sol.x-ch.x)<ch.tol&&Math.abs(sol.y-ch.y)<ch.tol;msg=pass?'✓ ('+fmtN(sol.x)+','+fmtN(sol.y)+')':'✗ Rješenje=('+fmtN(sol.x)+','+fmtN(sol.y)+'), treba ('+ch.x+','+ch.y+')';break;
    case 'det':pass=Math.abs(sol.D-ch.val)<ch.tol;msg=pass?'✓ D='+fmtN(sol.D):'✗ D='+fmtN(sol.D)+', treba '+ch.val;break;
  ...
  if(pass){
    ...
    pbx.chTot++;fb.classList.add('ng','show');fb.innerHTML=msg;
    document.getElementById('pbx-ch-tot').textContent=pbx.chTot;
  }
}
...
function p9calc() {
  const a1=parseFloat(document.getElementById('p9c-a').value)||0;
  const b1=parseFloat(document.getElementById('p9c-b').value)||0;
  const c1=parseFloat(document.getElementById('p9c-k').value)||0;
  const a2=parseFloat(document.getElementById('p9cv-a').value)||0;
  const b2=parseFloat(document.getElementById('p9cv-q').value)||0;
  const c2=parseFloat(document.getElementById('p9cft-n').value)||0;
  const r=document.getElementById('p9c-r');
  const sol=solveSystem(a1,b1,c1,a2,b2,c2);
  let html='<div><span class="calc-res-key">Sustav:</span> <span class="calc-res-val" style="color:var(--cyan)">'+fmtN(a1)+'x+'+fmtN(b1)+'y='+fmtN(c1)+' | '+fmtN(a2)+'x+'+fmtN(b2)+'y='+fmtN(c2)+'</span></div>';
  html+='<div><span class="calc-res-key">D:</span> <span class="calc-res-val">a₁b₂−a₂b₁ = '+fmtN(a1)+'·'+fmtN(b2)+'−'+fmtN(a2)+'·'+fmtN(b1)+' = <strong>'+fmtN(sol.D)+'</strong></span></div>';
  if(sol.type==='unique'){
    html+='<div><span class="calc-res-key">Dₓ:</span> <span class="calc-res-val">'+fmtN(sol.Dx)+'</span> <span class="calc-res-key">Dᵧ:</span> <span class="calc-res-val">'+fmtN(sol.Dy)+'</span></div>';
    html+='<div><span class="calc-res-key">Rješenje:</span> <span class="calc-res-val ok">x='+fmtN(sol.x)+', y='+fmtN(sol.y)+'</span></div>';
    const p1=Math.abs(a1*sol.x+b1*sol.y-c1)<0.01, p2=Math.abs(a2*sol.x+b2*sol.y-c2)<0.01;
    html+='<div><span class="calc-res-key">Provjera:</span> <span class="calc-res-val">'+(p1?'✓':'✗')+' jedn1 | '+(p2?'✓':'✗')+' jedn2</span></div>';
  } else {
    html+='<div><span class="calc-res-key">Zaključak:</span> <span class="calc-res-val '+(sol.type==='none'?'ng':'ok')+'">'+(sol.type==='none'?'Nema rješenja (proturječan)':'∞ rješenja (identični pravci)')+'</span></div>';
  }
  r.classList.add('show'); r.innerHTML=html;
}

function p9calcVertex() {
  const k=parseFloat(document.getElementById('p9cft-p').value)||0;
  const l=parseFloat(document.getElementById('p9cft-q').value)||0;
  const a=parseFloat(document.getElementById('p9c-k2').value)||1;
  const b=parseFloat(document.getElementById('p9cft-r').value)||0;
  const c=parseFloat(document.getElementById('p9cft-s').value)||0;
  const r=document.getElementById('p9c-r');
  // y=kx+l i y=ax²+bx+c → ax²+(b−k)x+(c−l)=0
  const A=a, B=b-k, C=c-l;
  const D=B*B-4*A*C;
  let html='<div><span class="calc-res-key">y='+fmtN(k)+'x+'+fmtN(l)+'</span> i <span class="calc-res-key">y='+fmtN(a)+'x²+'+fmtN(b)+'x+'+fmtN(c)+'</span></div>';
  html+='<div><span class="calc-res-key">Supstitucija:</span> <span class="calc-res-val">'+fmtN(A)+'x²+'+fmtN(B)+'x+'+fmtN(C)+'=0</span></div>';
  html+='<div><span class="calc-res-key">D:</span> <span class="calc-res-val">'+(Math.round(D*100)/100)+'</span></div>';
  if(D<0){html+='<div><span class="calc-res-key">Rješenje:</span> <span class="calc-res-val ng">Nema realnih rješenja (D&lt;0)</span></div>';}
  else if(Math.abs(D)<0.001){const x=-B/(2*A),y=k*x+l;html+='<div><span class="calc-res-key">Jedno rješenje:</span> <span class="calc-res-val ok">('+fmtN(x)+', '+fmtN(y)+')</span></div>';}
  else{const x1=(-B+Math.sqrt(D))/(2*A),x2=(-B-Math.sqrt(D))/(2*A);html+='<div><span class="calc-res-key">Rješenja:</span> <span class="calc-res-val ok">('+fmtN(x1)+', '+fmtN(k*x1+l)+') i ('+fmtN(x2)+', '+fmtN(k*x2+l)+')</span></div>';}
  r.classList.add('show'); r.innerHTML=html;
}
...
export const P07_META = {
  code: 'P07',
  title: 'Sustavi jednadžbi',
  filename: 'Maturiraj_MatB_P07_FIXED.html',
};

export default P07_HTML;