...
var ALL_QUESTIONS=[
  ...
  {id:'q7',topic:'adicijska',meta:'adicijska formula',text:'sin(π/4+π/4)=?',opts:[{t:'√2/2',ok:false},{t:'√3/2',ok:false},{t:'1',ok:true},{t:'√2',ok:false}],c:'✓ Točno. sin(π/2)=1. Ili: 2sin(π/4)cos(π/4)=2·(√2/2)²=1.',w:'✗ Netočno. sin(π/4+π/4)=sin(π/2)=1. Ili adicijskom: 1.',proof:['sin(π/4+π/4)=sin(π/2)=1','Ili: 2sin(π/4)cos(π/4)','=2·(√2/2)·(√2/2)=2·1/2=1']},
