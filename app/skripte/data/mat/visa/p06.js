/**
 * Maturiraj.hr — Mat A · P06
 * Maturiraj.hr — Mat A · P06 · Funkcija — Pojam i Svojstva
...
<nav class="sidebar" id="sidebar">
  ...
  <button class="sb-item active" style="background:transparent;border:none;cursor:default;text-align:left;width:100%"><span class="sb-dot"></span>06 · Funkcija — temelj mature</button>
...
<div class="bc">
  ...
  <span class="bc-cur">funkcija-pojam-svojstva-transformacije</span>
</div>
...
<div class="layer on" id="l0">
  <div class="hero">
    ...
    <div class="hero-eyebrow">poglavlje 06 od 21 · A razina · funkcije</div>
    <h1 class="hero-title">Funkcija —<br><span>Temelj Cijele Mature</span></h1>
    <p class="hero-sub">Pojam funkcije, domena, kodomena, svojstva i transformacije — jezik kojim govori svako poglavlje koje slijedi</p>
    <div class="hero-meta">
      <span class="hchip b">4 koncepta</span>
      <span class="hchip a">⭐ Ključno za sva poglavlja P07–P18</span>
      <span class="hchip c">~35 min</span>
    </div>
    <div class="pt"><div class="pb" style="width:29%"></div></div>
  </div>

  <div class="tags">
    <span class="pill p-b">Pojam funkcije</span>
    <span class="pill p-c">Domena i kodomena</span>
    <span class="pill p-i">Svojstva: mono., parna, neparna</span>
    <span class="pill p-a">Kompozicija i inverz</span>
    <span class="pill p-v">Transformacije grafa</span>
    <span class="pill p-r">Graf čitanje i analiza</span>
  </div>
  ...
  <div class="box-int">
    ...
    <div class="box-int-txt">
      Funkcija nije samo jedna tema — to je <em>jezik svake teme koja slijedi</em>. Kvadratna funkcija (P07), eksponencijalna (P08), trigonometrijske (P09), derivacije (P17), integrali (P18) — sve su to posebni tipovi funkcija.<br><br>
      Transformacije grafa (pomak, skaliranje, refleksija) vrijede za <em>svaku</em> funkciju — naučiš jednom, primjenjuješ svugdje.<br><br>
      <strong>Ako ne razumiješ pojam domene i što je "inverz funkcije", svaki zadatak s logaritmom ili trigonometrijom bit će misterija.</strong>
    </div>
  </div>

  <div class="slbl">// pregled u 30 sekundi</div>
  <div class="sg">
    <div class="sc"><div class="sc-ico si-b">f: A→B</div><div class="sc-name">Pojam funkcije</div><div class="sc-desc">Svaki element domene A preslikava se u točno jedan element kodomene B. "Stroj koji prima x, vraća y."</div></div>
    <div class="sc"><div class="sc-ico si-c">D(f)</div><div class="sc-name">Domena i kodomena</div><div class="sc-desc">Domena = skup mogućih ulaza. Skup vrijednosti = svi stvarni izlazi. Uvjeti: √≥0, <span class="frac"><span class="num">1</span><span class="den">x</span></span>≠0.</div></div>
    <div class="sc"><div class="sc-ico si-i">↗↘</div><div class="sc-name">Monotono raste/pada</div><div class="sc-desc">Funkcija raste ako x₁&lt;x₂ → f(x₁)&lt;f(x₂). Pada ako x₁&lt;x₂ → f(x₁)>f(x₂).</div></div>
    <div class="sc"><div class="sc-ico si-a">f(−x)</div><div class="sc-name">Parna i neparna</div><div class="sc-desc">Parna: f(−x)=f(x), simetrična na y-os. Neparna: f(−x)=−f(x), simetrična na ishodište.</div></div>
    <div class="sc"><div class="sc-ico si-v">f∘g</div><div class="sc-name">Kompozicija</div><div class="sc-desc">(f∘g)(x) = f(g(x)). Redoslijed je bitan! f∘g ≠ g∘f u općem slučaju.</div></div>
    <div class="sc"><div class="sc-ico si-r">f⁻¹</div><div class="sc-name">Inverz funkcije</div><div class="sc-desc">f⁻¹ "poništava" f. Postoji samo ako je f bijekcija. Graf f⁻¹ = refleksija grafa f po y=x.</div></div>
  </div>

  <div class="slbl">// ključni koncepti</div>
  <div class="con">
    <div class="cr"><div class="ck b">Def. funkcije</div><div class="cv">f: A → B, svaki x ∈ A ima <strong>točno jedan</strong> y ∈ B. Vertikalni test: svaki pravac x=c siječe graf max. jednom.</div></div>
    <div class="cr"><div class="ck b">Domena D(f)</div><div class="cv">Skup svih x za koje je f(x) definiran. Uvjeti: nazivnik ≠ 0, par. korijen ≥ 0, log > 0.</div></div>
    <div class="cr"><div class="ck c">Skup vrijednosti</div><div class="cv">Svi stvarni izlazi — <em>ne</em> kodomena! Sv(f) ⊆ kodomena. Čita se s grafa ili iz svojstava.</div></div>
    <div class="cr"><div class="ck i">Parna: f(−x)=f(x)</div><div class="cv">Graf simetričan na y-os. Primjeri: x², cos(x), |x|.</div></div>
    <div class="cr"><div class="ck i">Neparna: f(−x)=−f(x)</div><div class="cv">Graf simetričan na ishodište (0,0). Primjeri: x³, sin(x), x.</div></div>
    <div class="cr"><div class="ck a">Kompozicija f∘g</div><div class="cv">(f∘g)(x) = f(g(x)). Domena f∘g ⊆ D(g), i g(x) mora biti u D(f).</div></div>
    <div class="cr"><div class="ck v">Inverz f⁻¹</div><div class="cv">f⁻¹(f(x))=x. Graf: refleksija po y=x. D(f⁻¹)=Sv(f), Sv(f⁻¹)=D(f).</div></div>
    <div class="cr"><div class="ck r">Transformacije</div><div class="cv">f(x)+k: pomak gore/dolje · f(x+k): pomak lijevo/desno · −f(x): refleksija x-os · f(−x): refleksija y-os.</div></div>
  </div>

  <div class="nav-row">
    <button onclick="navigateChapter('p04')" class="nb">← P04 · Jednadžbe</button>
...
<div class="layer" id="l1">
  ...
  <!-- ══ 01 POJAM FUNKCIJE I DOMENA ══ -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">01 · POJAM FUNKCIJE I DOMENA</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>

  <div class="box-int">
    <div class="box-int-lbl">INTUITIVNO — stroj koji prima x, vraća y</div>
    <div class="box-int-txt">
      Funkcija je kao aparat za kavu: ubaciš kapsulu (x), dobiješ kavu (y). <em>Isti input uvijek daje isti output.</em> Ali jedan input ne može dati dvije različite kave — to bi bio "nedefiniran stroj".<br><br>
      <strong>Vertikalni test:</strong> nacrtaj graf i provuci vertikalni pravac. Ako pravac x=c sijece graf više od jednom, to nije funkcija.<br><br>
      Domena je "što smiješ ubaciti". Ne smiješ dijeliti s nulom, ne smiješ stavljati negativan broj pod paran korijen, ne smiješ stavljati ≤0 pod logaritam.
    </div>
  </div>

  <div class="box-for">
    <span class="box-for-lbl">UVJETI DOMENE — tri pravila</span>
    <span class="val">Razlomak:</span> nazivnik ≠ 0 <span class="cmt">→ isključi nultočke nazivnika</span><br>
    <span class="val">Par. korijen √:</span> argument ≥ 0 <span class="cmt">→ rješavaj nejednadžbu ≥ 0</span><br>
    <span class="val">1/√:</span> argument > 0 <span class="cmt">→ strogi uvjet (i razlomak i korijen!)</span><br>
    <span class="val">Logaritam log:</span> argument > 0 <span class="cmt">→ uvijek strogo pozitivan</span><br>
    <span class="cmt">Kombinacija uvjeta: presjek svih — svi moraju biti ispunjeni istovremeno</span>
  </div>

  <!-- DOMAIN EXPLORER — interaktivni alat -->
  <div class="disc-wrap">
    <div class="disc-head">
      <span class="disc-title">// Domain Explorer — klikni primjer, vidi uvjete</span>
    </div>
    <div class="disc-body">
      <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px">
        <button class="disc-btn on" id="dex-b1" onclick="setDex(1,this)">f₁: 1/x</button>
        <button class="disc-btn" id="dex-b2" onclick="setDex(2,this)">f₂: √(x−3)</button>
        <button class="disc-btn" id="dex-b3" onclick="setDex(3,this)">f₃: <span class="frac"><span class="num">1</span><span class="den">√</span></span>(x+2)</button>
        <button class="disc-btn" id="dex-b4" onclick="setDex(4,this)">f₄: √(x+1)/(x−2)</button>
        <button class="disc-btn" id="dex-b5" onclick="setDex(5,this)">f₅: x/(x²−1)</button>
      </div>
      <div class="eq-s-result" id="dex-expr" style="font-size:18px;font-weight:700;color:var(--cyan);margin-bottom:10px">f(x) = 1/x</div>
      <div id="dex-steps" style="font-family:var(--mono);font-size:12px;color:var(--t2);line-height:2;margin-bottom:10px"></div>
      <div id="dex-domain" style="font-family:var(--mono);font-size:13px;font-weight:700;color:var(--green)"></div>
    </div>
  </div>

  <div class="box-men">
    <div class="box-men-lbl">MENTALNI MODEL — domena kao "zabranjeni grad"</div>
    <div class="box-men-txt">
      Zamisli brojevni pravac kao cestu. Domena kaže: "ovuda možeš, onuda ne možeš".<br>
      Zabranjena mjesta su: gdje nazivnik postaje 0, gdje korijen postaje negativan.<br>
      <strong>Strategija: nađi sve zabranjene x-eve, isključi ih iz ℝ. Ostatak je domena.</strong>
    </div>
  </div>
  ...
  <div class="sr" id="sr1">
    <div class="sr-head">
      <div class="sr-title">Domena — korak po korak</div>
      <div class="sr-task">Nađi domenu: f(x) = √(x+4) / (x²−9)</div>
    </div>
    <div class="sr-steps">
      <div class="sr-step" id="sr1s1">
        <div class="sr-step-in"><div class="sr-num">1</div>
          <div class="sr-body"><div class="sr-stitle">Uvjet 1 — korijen u brojevniku</div>
            <div class="sr-txt">√(x+4) → x+4 ≥ 0 → <strong>x ≥ −4</strong></div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr1s2">
        <div class="sr-step-in"><div class="sr-num">2</div>
          <div class="sr-body"><div class="sr-stitle">Uvjet 2 — nazivnik ≠ 0</div>
            <div class="sr-txt">x²−9 = (x−3)(x+3) ≠ 0 → <strong>x ≠ 3 i x ≠ −3</strong></div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr1s3">
        <div class="sr-step-in"><div class="sr-num">3</div>
          <div class="sr-body"><div class="sr-stitle">Presjek uvjeta</div>
            <div class="sr-txt">x ≥ −4 I x ≠ 3 I x ≠ −3
              <div class="sr-tryit">
                <div class="sr-try-lbl">↳ Zapiši domenu kao uniju intervala</div>
                <div class="sr-try-row">
                  <input class="sr-try-in" id="try1" type="text" placeholder="⟨-4,...⟩ ∪ ..." autocomplete="off">
                  <button class="sr-try-btn" onclick="tryIt('try1','try1-fb','⟨-4,-3)∪(-3,3)∪(3,+∞)','dom1')">Provjeri</button>
                </div>
  ...
  <!-- BUG 1 -->
  <div class="box-bug">
    <div class="bug-head">🐛 prepoznaj grešku — domena</div>
    <div class="bug-body">
      <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">Učenik pronalazi domenu f(x) = √(x²−4):</p>
      <div class="bug-task">D = <span class="wrong">⟨−2, 2⟩</span></div>
      <div class="bug-opts">
        <div class="bug-opt" onclick="bug(this,'b1',false,'b1e')">A) Točno, −2 ≤ x ≤ 2</div>
        <div class="bug-opt" onclick="bug(this,'b1',true,'b1e')">B) Greška: x²−4 ≥ 0 → x ≤ −2 ili x ≥ 2 → (−∞,−2⟩ ∪ ⟨2,+∞)</div>
        <div class="bug-opt" onclick="bug(this,'b1',false,'b1e')">C) Greška: D = (−2, 2) bez rubova</div>
        <div class="bug-opt" onclick="bug(this,'b1',false,'b1e')">D) Greška: domena je ℝ jer x² uvijek ≥ 0</div>
      </div>
  ...
  <div class="box-20">
    <div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — domena</div>
    <ul class="b20-list">
      <li class="b20-item"><div class="b20-dot"></div>Razlomak: nazivnik ≠ 0 · Par. korijen: ≥ 0 · Logaritam: > 0</li>
      <li class="b20-item"><div class="b20-dot"></div>Kombinirani uvjeti = presjek (I, ne ILI)</li>
      <li class="b20-item"><div class="b20-dot"></div>Bez posebnih uvjeta → D = ℝ (npr. polinomi)</li>
    </ul>
  </div>
  ...
  <!-- RIJEŠENI PRIMJER -->
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — domena funkcije</div></div>
    <div class="combo-body">
      <div class="combo-task">Nađi domenu: f(x) = √(3x − 6) / (x − 5)</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">Uvjet 1 — korijen: 3x−6 ≥ 0 → x ≥ 2 → <strong>x ∈ [2, +∞)</strong></div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Uvjet 2 — nazivnik ≠ 0: x ≠ 5</div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">Presjeci uvjete: x ≥ 2 i x ≠ 5 → <strong>[2,5) ∪ (5,+∞)</strong></div></div>
        <div class="combo-step"><div class="combo-n">4</div><div class="combo-txt">Na maturi: uvijek oba uvjeta zajedno; piši kao uniju intervala</div></div>
      </div>
      <div class="combo-ans">D(f) = ⟨2, 5) ∪ (5, +∞) &nbsp;·&nbsp; Unija intervala — standardni maturalni zapis</div>
    </div>
  </div>
  ...
  <div class="inline-cp" id="icp1">
    <div class="icp-head">
      <span class="icp-title">Provjeri razumijevanje — domena</span>
      <span class="icp-score" id="icp1-sc">0 / 3</span>
    </div>
    <div class="icp-body">
      <div class="icp-q" id="icp1q1">
        <div class="icp-q-text">Domena f(x) = 1/(x−5) je:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp1','q1',this,false,'icp1q1fb')">ℝ</div>
          <div class="icp-opt" onclick="icp('icp1','q1',this,true,'icp1q1fb')">ℝ \\ {5}</div>
          <div class="icp-opt" onclick="icp('icp1','q1',this,false,'icp1q1fb')">x > 5</div>
          <div class="icp-opt" onclick="icp('icp1','q1',this,false,'icp1q1fb')">x < 5</div>
        </div>
        <div class="icp-fb" id="icp1q1fb"></div>
      </div>
      <div class="icp-q" id="icp1q2">
        <div class="icp-q-text">Je li f(x) = x² funkcija?</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp1','q2',this,true,'icp1q2fb')">Da — svaki x daje točno jedan y</div>
          <div class="icp-opt" onclick="icp('icp1','q2',this,false,'icp1q2fb')">Ne — npr. x=2 i x=−2 daju isti y=4</div>
          <div class="icp-opt" onclick="icp('icp1','q2',this,false,'icp1q2fb')">Ne — nije definirano za negativne x</div>
          <div class="icp-opt" onclick="icp('icp1','q2',this,false,'icp1q2fb')">Ovisi o domeni</div>
        </div>
        <div class="icp-fb" id="icp1q2fb"></div>
      </div>
      <div class="icp-q" id="icp1q3">
        <div class="icp-q-text">Domena f(x) = √(5−x) je:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp1','q3',this,false,'icp1q3fb')">x ≥ 5</div>
          <div class="icp-opt" onclick="icp('icp1','q3',this,true,'icp1q3fb')">x ≤ 5, tj. (−∞, 5⟩</div>
          <div class="icp-opt" onclick="icp('icp1','q3',this,false,'icp1q3fb')">x > 5</div>
          <div class="icp-opt" onclick="icp('icp1','q3',this,false,'icp1q3fb')">ℝ</div>
        </div>
        <div class="icp-fb" id="icp1q3fb"></div>
      </div>
      <div class="icp-done" id="icp1-done">✓ Odlično! Nastavi na svojstva funkcija →</div>
      <button class="icp-retry" id="icp1-retry" onclick="retryIcp('icp1')">↺ Pokušaj ponovo</button>
    </div>
  </div>

  <!-- ══ 02 SVOJSTVA: MONOTONOST, PARNOST ══ -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">02 · MONOTONOST, PARNOST I NEPÁRNOST</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>

  <div class="box-int">
    <div class="box-int-lbl">INTUITIVNO — "karakter" funkcije</div>
    <div class="box-int-txt">
      Svojstva funkcije opisuju njezino "ponašanje" — raste li, pada li, ima li simetriju.<br><br>
      <strong>Monotonost:</strong> funkcija je rastuća na intervalu ako se s povećanjem x-a povećava i y. Padajuća je obratno.<br><br>
      <strong>Parnost:</strong> f(−x) = f(x) znači da su vrijednosti za x i −x iste — graf je zrcaljen na y-os. Tipični primjeri: x², cos(x).<br>
      <strong>Neparnost:</strong> f(−x) = −f(x) znači da zrcaljenjem dobivamo negativnu vrijednost — simetrija na ishodište. Tipični primjeri: x³, sin(x), x.
    </div>
  </div>

  <div class="box-for">
    <span class="box-for-lbl">SVOJSTVA FUNKCIJA — definicije</span>
    <span class="val">Rastuća na I:</span> x₁&lt;x₂ ⟹ f(x₁)&lt;f(x₂) <span class="cmt">za sve x₁,x₂ ∈ I</span><br>
    <span class="val">Padajuća na I:</span> x₁&lt;x₂ ⟹ f(x₁)>f(x₂)<br>
    <span class="val">Parna:</span> D(f) simetričan na 0, f(−x)=f(x) za sve x ∈ D(f)<br>
    <span class="val">Neparna:</span> D(f) simetričan na 0, f(−x)=−f(x) za sve x ∈ D(f)<br>
    <span class="cmt">Niti parna niti neparna: npr. f(x) = x²+x (nesimetrična domena ili uvjet ne vrijedi)</span>
  </div>

  <div class="cmp" style="margin-bottom:16px">
    <div class="cmp-c">
      <div class="cmp-h i">Parna funkcija</div>
      <div class="cmp-body">
        <div class="cmp-row">f(−x) = f(x)</div>
        <div class="cmp-row">Graf sim. na <b>y-os</b></div>
        <div class="cmp-row">Primjeri: x², cos(x), |x|</div>
        <div class="cmp-row">Provjera: f(−x) − f(x) = 0?</div>
      </div>
    </div>
    <div class="cmp-c">
      <div class="cmp-h a">Neparna funkcija</div>
      <div class="cmp-body">
        <div class="cmp-row">f(−x) = −f(x)</div>
        <div class="cmp-row">Graf sim. na <b>ishodište</b></div>
        <div class="cmp-row">Primjeri: x³, sin(x), x</div>
        <div class="cmp-row">Provjera: f(−x) + f(x) = 0?</div>
      </div>
    </div>
  </div>
  ...
  <div class="box-men">
    <div class="box-men-lbl">MENTALNI MODEL — simetrija kao vizualni test</div>
    <div class="box-men-txt">
      Presavij papir s grafom po y-osi. Poklapaju li se dvije polovice? → Parna.<br>
      Zarotiraš li graf za 180° oko ishodišta, dobivamo isti graf? → Neparna.<br>
      <strong>Algebraiski: uvijek uvrstiti −x umjesto x i pogledati što se dobiva.</strong>
    </div>
  </div>
  ...
  <div class="sr" id="sr2">
    <div class="sr-head">
      <div class="sr-title">Parnost/neparnost — korak po korak</div>
      <div class="sr-task">Ispitaj je li f(x) = x³ − x parna, neparna ili nijedno</div>
    </div>
    <div class="sr-steps">
      <div class="sr-step" id="sr2s1">
        <div class="sr-step-in"><div class="sr-num">1</div>
          <div class="sr-body"><div class="sr-stitle">Provjeri domenu — mora biti simetrična na 0</div>
            <div class="sr-txt">D(f) = ℝ — simetrična ✓ (bez toga ne može biti ni parna ni neparna)</div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr2s2">
        <div class="sr-step-in"><div class="sr-num">2</div>
          <div class="sr-body"><div class="sr-stitle">Izračunaj f(−x)</div>
            <div class="sr-txt">f(−x) = (−x)³ − (−x) = −x³ + x = <strong>−(x³ − x) = −f(x)</strong></div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr2s3">
        <div class="sr-step-in"><div class="sr-num">3</div>
          <div class="sr-body"><div class="sr-stitle">Zaključak</div>
            <div class="sr-txt">f(−x) = −f(x) → <strong>neparna funkcija</strong>
              <div class="sr-tryit">
                <div class="sr-try-lbl">↳ Je li g(x) = x² + 1 parna ili neparna?</div>
                <div class="sr-try-row">
                  <input class="sr-try-in" id="try2" type="text" placeholder="parna/neparna/nijedno" autocomplete="off">
                  <button class="sr-try-btn" onclick="tryIt('try2','try2-fb','parna','par1')">Provjeri</button>
                </div>
  ...
  <!-- BUG 2 -->
  <div class="box-bug">
    <div class="bug-head">🐛 prepoznaj grešku — parnost</div>
    <div class="bug-body">
      <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">Učenik tvrdi za f(x) = x² + x:</p>
      <div class="bug-task">f(−x) = x²−x ≠ f(x), dakle <span class="wrong">f je neparna</span></div>
      <div class="bug-opts">
        <div class="bug-opt" onclick="bug(this,'b2',false,'b2e')">A) Točno, nije parna pa mora biti neparna</div>
        <div class="bug-opt" onclick="bug(this,'b2',true,'b2e')">B) Greška: f(−x)=−f(x) bi trebalo biti x²−x = −x²−x — nije! Niti parna niti neparna.</div>
        <div class="bug-opt" onclick="bug(this,'b2',false,'b2e')">C) Greška: f je parna jer ima x²</div>
        <div class="bug-opt" onclick="bug(this,'b2',false,'b2e')">D) Greška: funkcija s oba parna i neparna člana je uvijek neparna</div>
      </div>
  ...
  <div class="box-20">
    <div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — svojstva</div>
    <ul class="b20-list">
      <li class="b20-item"><div class="b20-dot"></div>Parna: f(−x)=f(x), simetrija na y-os. Neparna: f(−x)=−f(x), simetrija na ishodište.</li>
      <li class="b20-item"><div class="b20-dot"></div>Uvjet za parnost/neparnost: domena mora biti simetrična na 0!</li>
      <li class="b20-item"><div class="b20-dot"></div>Rastuća: veći x → veći f(x). Na grafu ide gore-desno.</li>
    </ul>
  </div>
  ...
  <!-- RIJEŠENI PRIMJER -->
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — parnost funkcije</div></div>
    <div class="combo-body">
      <div class="combo-task">Ispitaj je li f(x) = x⁴ − 3x² + 1 parna, neparna ili niti jedno</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">Izračunaj f(−x): f(−x) = (−x)⁴ − 3(−x)² + 1 = x⁴ − 3x² + 1</div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Usporedi s f(x): f(−x) = <strong>f(x)</strong></div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">Zaključak: f(−x) = f(x) → funkcija je <strong>PARNA</strong></div></div>
        <div class="combo-step"><div class="combo-n">4</div><div class="combo-txt">Maturalni obrazac: parna = simetrična na os y; uvek zamijeni x s −x i usporedi!</div></div>
      </div>
      <div class="combo-ans">f je parna &nbsp;·&nbsp; Parnost ↔ simetrija na os y; nepárnost ↔ centralna simetrija u O</div>
    </div>
  </div>
  ...
  <div class="inline-cp" id="icp2">
    <div class="icp-head">
      <span class="icp-title">Provjeri razumijevanje — svojstva</span>
      <span class="icp-score" id="icp2-sc">0 / 3</span>
    </div>
    <div class="icp-body">
      <div class="icp-q" id="icp2q1">
        <div class="icp-q-text">f(x) = x⁴ − 2x² je:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp2','q1',this,true,'icp2q1fb')">parna</div>
          <div class="icp-opt" onclick="icp('icp2','q1',this,false,'icp2q1fb')">neparna</div>
          <div class="icp-opt" onclick="icp('icp2','q1',this,false,'icp2q1fb')">niti parna niti neparna</div>
          <div class="icp-opt" onclick="icp('icp2','q1',this,false,'icp2q1fb')">ne može se odrediti</div>
        </div>
        <div class="icp-fb" id="icp2q1fb"></div>
      </div>
      <div class="icp-q" id="icp2q2">
        <div class="icp-q-text">f(x) = x³ + 1 je:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp2','q2',this,false,'icp2q2fb')">parna</div>
          <div class="icp-opt" onclick="icp('icp2','q2',this,false,'icp2q2fb')">neparna</div>
          <div class="icp-opt" onclick="icp('icp2','q2',this,true,'icp2q2fb')">niti parna niti neparna</div>
          <div class="icp-opt" onclick="icp('icp2','q2',this,false,'icp2q2fb')">rastuća</div>
        </div>
        <div class="icp-fb" id="icp2q2fb"></div>
      </div>
      <div class="icp-q" id="icp2q3">
        <div class="icp-q-text">Ako je f rastuća na ⟨0,3⟩ i f(1)=4, f(2)=?</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp2','q3',this,false,'icp2q3fb')">sigurno 5</div>
          <div class="icp-opt" onclick="icp('icp2','q3',this,false,'icp2q3fb')">sigurno manji od 4</div>
          <div class="icp-opt" onclick="icp('icp2','q3',this,true,'icp2q3fb')">sigurno veći od 4</div>
          <div class="icp-opt" onclick="icp('icp2','q3',this,false,'icp2q3fb')">ne može se odrediti</div>
        </div>
        <div class="icp-fb" id="icp2q3fb"></div>
      </div>
      <div class="icp-done" id="icp2-done">✓ Sjajno! Nastavi na kompoziciju i inverz →</div>
      <button class="icp-retry" id="icp2-retry" onclick="retryIcp('icp2')">↺ Pokušaj ponovo</button>
    </div>
  </div>

  <!-- ══ 03 KOMPOZICIJA I INVERZ ══ -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">03 · KOMPOZICIJA I INVERZ FUNKCIJE</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>

  <div class="box-int">
    <div class="box-int-lbl">INTUITIVNO — funkcija unutar funkcije</div>
    <div class="box-int-txt">
      Kompozicija (f∘g)(x) = f(g(x)) je kao dva stroja u nizu — izlaz prvog stroja ide u drugi. Redoslijed je bitan: g∘f nije isto što i f∘g.<br><br>
      Inverz f⁻¹ je stroj koji "poništava" f. Ako f uzima x i daje y, f⁻¹ uzima y i vraća x. Graf f⁻¹ je refleksija grafa f po pravcu y=x.<br><br>
      <strong>Bitno: inverz postoji samo ako je f bijekcija — svaki y ima točno jedan x (horizontalni test).</strong>
    </div>
  </div>

  <div class="box-for">
    <span class="box-for-lbl">KOMPOZICIJA I INVERZ</span>
    <span class="val">(f∘g)(x) = f(g(x))</span> <span class="cmt">— g se primijeni PRVO, pa f</span><br>
    <span class="val">D(f∘g)</span> = {x ∈ D(g) : g(x) ∈ D(f)} <span class="cmt">— domena kompozicije</span><br>
    <span class="val">f⁻¹(f(x)) = x</span> i <span class="val">f(f⁻¹(x)) = x</span><br>
    <span class="val">D(f⁻¹) = Sv(f)</span>, <span class="val">Sv(f⁻¹) = D(f)</span><br>
    <span class="cmt">Nađi f⁻¹: zapiši y=f(x), izrazi x iz jednadžbe, zamijeni x↔y</span>
  </div>

  <div class="cmp" style="margin-bottom:16px">
    <div class="cmp-c">
      <div class="cmp-h b">Kompozicija f∘g</div>
      <div class="cmp-body">
        <div class="cmp-row">(f∘g)(x) = f(g(x))</div>
        <div class="cmp-row"><b>g ide PRVA</b>, pa f</div>
        <div class="cmp-row">D(f∘g) ⊆ D(g)</div>
        <div class="cmp-row">f∘g ≠ g∘f (općenito)</div>
      </div>
    </div>
    <div class="cmp-c">
      <div class="cmp-h v">Inverz f⁻¹</div>
      <div class="cmp-body">
        <div class="cmp-row">f⁻¹(f(x)) = x</div>
        <div class="cmp-row"><b>Poništava</b> f</div>
        <div class="cmp-row">D(f⁻¹) = Sv(f)</div>
        <div class="cmp-row">Graf: refleksija po y=x</div>
      </div>
    </div>
  </div>

  <div class="box-men">
    <div class="box-men-lbl">MENTALNI MODEL — redoslijed u kompoziciji</div>
    <div class="box-men-txt">
      (f∘g)(x): čitaj desno prema lijevo — <em>g PRVO, pa f</em>.<br>
      Kao obući se: g = navuci čarape, f = obuj cipele. f∘g = čarape pa cipele ✓. g∘f = cipele pa čarape ✗.<br>
      <strong>Memorij: u f∘g, g je "unutarnja" — uvijek ide prva na red.</strong>
    </div>
  </div>
  ...
  <div class="sr" id="sr3">
    <div class="sr-head">
      <div class="sr-title">Inverz funkcije — korak po korak</div>
      <div class="sr-task">Nađi inverz od f(x) = 2x + 3</div>
    </div>
    <div class="sr-steps">
      <div class="sr-step" id="sr3s1">
        <div class="sr-step-in"><div class="sr-num">1</div>
          <div class="sr-body"><div class="sr-stitle">Zapiši y = f(x)</div>
            <div class="sr-txt">y = 2x + 3</div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr3s2">
        <div class="sr-step-in"><div class="sr-num">2</div>
          <div class="sr-body"><div class="sr-stitle">Izrazi x iz jednadžbe</div>
            <div class="sr-txt">2x = y − 3 → x = (y−3)/2</div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr3s3">
        <div class="sr-step-in"><div class="sr-num">3</div>
          <div class="sr-body"><div class="sr-stitle">Zamijeni x↔y (inverz)</div>
            <div class="sr-txt">f⁻¹(x) = (x−3)/2
              <div class="sr-tryit">
                <div class="sr-try-lbl">↳ Provjeri: f(f⁻¹(5)) = ?</div>
                <div class="sr-try-row">
                  <input class="sr-try-in" id="try3" type="text" placeholder="?" autocomplete="off">
                  <button class="sr-try-btn" onclick="tryIt('try3','try3-fb','5','inv1')">Provjeri</button>
                </div>
  ...
  <!-- BUG 3 -->
  <div class="box-bug">
    <div class="bug-head">🐛 prepoznaj grešku — kompozicija</div>
    <div class="bug-body">
      <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">f(x)=x+1, g(x)=x². Učenik računa (f∘g)(3):</p>
      <div class="bug-task">(f∘g)(3) = f(3)·g(3) = 4·9 = <span class="wrong">36</span></div>
      <div class="bug-opts">
        <div class="bug-opt" onclick="bug(this,'b3',false,'b3e')">A) Točno, kompozicija je množenje funkcija</div>
        <div class="bug-opt" onclick="bug(this,'b3',true,'b3e')">B) Greška: (f∘g)(3)=f(g(3))=f(9)=10, nije množenje!</div>
        <div class="bug-opt" onclick="bug(this,'b3',false,'b3e')">C) Greška: redoslijed je g(f(3))=g(4)=16</div>
        <div class="bug-opt" onclick="bug(this,'b3',false,'b3e')">D) Greška: (f∘g)(3)=f(3)+g(3)=4+9=13</div>
      </div>
  ...
  <div class="box-bug">
    <div class="bug-head">🐛 prepoznaj grešku — domena kompozicije</div>
    <div class="bug-body">
  ...
  <div class="box-20">
    <div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — kompozicija i inverz</div>
    <ul class="b20-list">
      <li class="b20-item"><div class="b20-dot"></div>(f∘g)(x) = f(g(x)) — g PRVO, pa f. Čitaj s desna na lijevo!</li>
      <li class="b20-item"><div class="b20-dot"></div>Inverz: y=f(x) → izrazi x → zamijeni x↔y → f⁻¹(x)</li>
      <li class="b20-item"><div class="b20-dot"></div>f(f⁻¹(x)) = x — uvijek. Brza provjera inverza!</li>
    </ul>
  </div>
  ...
  <!-- RIJEŠENI PRIMJER -->
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — kompozicija funkcija</div></div>
    <div class="combo-body">
      <div class="combo-task">f(x) = x + 2, g(x) = x². Nađi (f∘g)(x) i (g∘f)(x)</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">(f∘g)(x) = f(g(x)) = f(x²) = <strong>x² + 2</strong>  ← g najprije, pa f uvrstimo u f</div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">(g∘f)(x) = g(f(x)) = g(x+2) = <strong>(x+2)²</strong></div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">Zapazi: (f∘g) ≠ (g∘f) → kompozicija nije komutativna!</div></div>
        <div class="combo-step"><div class="combo-n">4</div><div class="combo-txt">Tip A razine: D(f∘g) — provjeri i da g(x) bude u D(f)</div></div>
      </div>
      <div class="combo-ans">(f∘g)(x) = x²+2 · (g∘f)(x) = (x+2)² &nbsp;·&nbsp; Redoslijed je bitan — matura to ispituje!</div>
    </div>
  </div>
  ...
  <div class="inline-cp" id="icp3">
    <div class="icp-head">
      <span class="icp-title">Provjeri razumijevanje — kompozicija i inverz</span>
      <span class="icp-score" id="icp3-sc">0 / 3</span>
    </div>
    <div class="icp-body">
      <div class="icp-q" id="icp3q1">
        <div class="icp-q-text">f(x)=2x, g(x)=x+3. Koliko je (f∘g)(1)?</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp3','q1',this,false,'icp3q1fb')">5</div>
          <div class="icp-opt" onclick="icp('icp3','q1',this,true,'icp3q1fb')">8</div>
          <div class="icp-opt" onclick="icp('icp3','q1',this,false,'icp3q1fb')">6</div>
          <div class="icp-opt" onclick="icp('icp3','q1',this,false,'icp3q1fb')">4</div>
        </div>
        <div class="icp-fb" id="icp3q1fb"></div>
      </div>
      <div class="icp-q" id="icp3q2">
        <div class="icp-q-text">Inverz od f(x) = <span class="frac"><span class="num">x</span><span class="den">3</span></span> je:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp3','q2',this,false,'icp3q2fb')">f⁻¹(x) = x/3</div>
          <div class="icp-opt" onclick="icp('icp3','q2',this,false,'icp3q2fb')">f⁻¹(x) = 1/(3x)</div>
          <div class="icp-opt" onclick="icp('icp3','q2',this,true,'icp3q2fb')">f⁻¹(x) = 3x</div>
          <div class="icp-opt" onclick="icp('icp3','q2',this,false,'icp3q2fb')">f⁻¹(x) = −x/3</div>
        </div>
        <div class="icp-fb" id="icp3q2fb"></div>
      </div>
      <div class="icp-q" id="icp3q3">
        <div class="icp-q-text">Graf f⁻¹ je refleksija grafa f po pravcu:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp3','q3',this,false,'icp3q3fb')">y = 0 (x-os)</div>
          <div class="icp-opt" onclick="icp('icp3','q3',this,false,'icp3q3fb')">x = 0 (y-os)</div>
          <div class="icp-opt" onclick="icp('icp3','q3',this,true,'icp3q3fb')">y = x</div>
          <div class="icp-opt" onclick="icp('icp3','q3',this,false,'icp3q3fb')">y = −x</div>
        </div>
        <div class="icp-fb" id="icp3q3fb"></div>
      </div>
      <div class="icp-done" id="icp3-done">✓ Izvrsno! Nastavi na transformacije grafa →</div>
      <button class="icp-retry" id="icp3-retry" onclick="retryIcp('icp3')">↺ Pokušaj ponovo</button>
    </div>
  </div>

  <!-- ══ 04 TRANSFORMACIJE GRAFA ══ -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">04 · TRANSFORMACIJE GRAFA FUNKCIJE</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>

  <div class="box-int">
    <div class="box-int-lbl">INTUITIVNO — pomakni, zrcali, skaliraj</div>
    <div class="box-int-txt">
      Svaka transformacija mijenja graf na predvidiv način. Naučiš ih jednom, primjenjuješ na sin(x), ex, log(x), x² — na sve.<br><br>
      Najintuitivnija: f(x)+2 pomiče cijeli graf za 2 gore. Kontraintuitivna: f(x+2) pomiče graf za 2 <em>lijevo</em> (ne desno!)<br><br>
      <strong>Trik za pomak po x-osi: f(x+k) ide u suprotnom smjeru od k. f(x+2) → pomak 2 lijevo.</strong>
    </div>
  </div>

  <div class="box-for">
    <span class="box-for-lbl">8 TRANSFORMACIJA — sve što trebaš znati</span>
    <span class="val">f(x) + k</span> <span class="cmt">→ pomak k gore (k>0) ili dolje (k&lt;0)</span><br>
    <span class="val">f(x + k)</span> <span class="cmt">→ pomak k lijevo (k>0) ili desno (k&lt;0) ← kontraintuitivno!</span><br>
    <span class="val">k · f(x)</span> <span class="cmt">→ vertikalno skaliranje (k>1 rastezanje, 0&lt;k&lt;1 skupljanje)</span><br>
    <span class="val">f(k · x)</span> <span class="cmt">→ horizontalno skaliranje (k>1 skupljanje, 0&lt;k&lt;1 rastezanje)</span><br>
    <span class="val">−f(x)</span> <span class="cmt">→ refleksija na x-os (gore-dolje)</span><br>
    <span class="val">f(−x)</span> <span class="cmt">→ refleksija na y-os (lijevo-desno)</span><br>
    <span class="val">|f(x)|</span> <span class="cmt">→ dio ispod x-osi "preklopi" gore</span><br>
    <span class="val">f(|x|)</span> <span class="cmt">→ desna strana zrcali na lijevu</span>
  </div>

  <!-- GRAPH TRANSFORMER — interaktivni alat -->
  <div class="disc-wrap">
    <div class="disc-head">
      <span class="disc-title">// Transformacije — klikni i vidi opis efekta</span>
    </div>
    <div class="disc-body">
      <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px">
        <button class="disc-btn on" id="tr-b1" onclick="setTr(1,this)">f(x)+2</button>
        <button class="disc-btn" id="tr-b2" onclick="setTr(2,this)">f(x+2)</button>
        <button class="disc-btn" id="tr-b3" onclick="setTr(3,this)">2·f(x)</button>
        <button class="disc-btn" id="tr-b4" onclick="setTr(4,this)">−f(x)</button>
        <button class="disc-btn" id="tr-b5" onclick="setTr(5,this)">f(−x)</button>
        <button class="disc-btn" id="tr-b6" onclick="setTr(6,this)">|f(x)|</button>
      </div>
      <div class="eq-s-result" id="tr-name" style="font-size:16px;font-weight:700;color:var(--cyan);margin-bottom:8px">f(x) + 2</div>
      <div id="tr-desc" style="font-family:var(--mono);font-size:12px;color:var(--t2);line-height:1.9"></div>
      <div id="tr-example" style="font-family:var(--mono);font-size:11px;color:var(--t3);margin-top:8px"></div>
    </div>
  </div>

  <div class="box-men">
    <div class="box-men-lbl">MENTALNI MODEL — unutarnje vs vanjske transformacije</div>
    <div class="box-men-txt">
      <strong>Vanjske</strong> (izvan zagrada): djeluju na y — intuitivne.<br>
      f(x)+2: dodaj 2 na svaki y → pomak gore. −f(x): negira svaki y → preklopi na x-os.<br>
      <strong>Unutarnje</strong> (unutar zagrada): djeluju na x — <em>kontraintuitivne, obratnog predznaka</em>.<br>
      f(x+2): traži x koji daje isti rezultat — mora se pomaknuti 2 lijevo. f(2x): skupi graf horizontalno.
    </div>
  </div>
  ...
  <div class="sr" id="sr4">
    <div class="sr-head">
      <div class="sr-title">Transformacije — korak po korak</div>
      <div class="sr-task">Opiši transformaciju: g(x) = −f(x+1) + 3 u odnosu na f</div>
    </div>
    <div class="sr-steps">
      <div class="sr-step" id="sr4s1">
        <div class="sr-step-in"><div class="sr-num">1</div>
          <div class="sr-body"><div class="sr-stitle">Prepoznaj svaki element</div>
            <div class="sr-txt">f(x+1): unutarnja transformacija — pomak 1 <strong>lijevo</strong><br>−f(...): vanjska — refleksija na x-os<br>...+3: vanjska — pomak 3 <strong>gore</strong></div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr4s2">
        <div class="sr-step-in"><div class="sr-num">2</div>
          <div class="sr-body"><div class="sr-stitle">Primijeni redoslijedom: unutarnje prvo</div>
            <div class="sr-txt">1. Graf f pomakni 1 lijevo → dobivamo f(x+1)<br>2. Reflektiraj na x-os → dobivamo −f(x+1)<br>3. Pomakni 3 gore → dobivamo −f(x+1)+3</div>
          </div>
        </div>
      </div>
      <div class="sr-step" id="sr4s3">
        <div class="sr-step-in"><div class="sr-num">3</div>
          <div class="sr-body"><div class="sr-stitle">Efekt na posebne točke</div>
            <div class="sr-txt">Ako je f(0)=2: g(−1) = −f(0)+3 = −2+3 = 1<br>
              <div class="sr-tryit">
                <div class="sr-try-lbl">↳ Koliko je g(x) = f(x−2)+1 pomak po y-osi?</div>
                <div class="sr-try-row">
                  <input class="sr-try-in" id="try4" type="text" placeholder="pomak = ?" autocomplete="off">
                  <button class="sr-try-btn" onclick="tryIt('try4','try4-fb','1','tr1')">Provjeri</button>
                </div>
  ...
  <!-- BUG 4 -->
  <div class="box-bug">
    <div class="bug-head">🐛 prepoznaj grešku — transformacije</div>
    <div class="bug-body">
      <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">Učenik opisuje g(x) = f(x+3):</p>
      <div class="bug-task">Graf f pomiče se <span class="wrong">3 jedinice desno</span></div>
      <div class="bug-opts">
        <div class="bug-opt" onclick="bug(this,'b4',false,'b4e')">A) Točno, +3 znači desno</div>
        <div class="bug-opt" onclick="bug(this,'b4',true,'b4e')">B) Greška: f(x+3) pomiče graf 3 lijevo — unutarnje transformacije su kontraintuitivne!</div>
        <div class="bug-opt" onclick="bug(this,'b4',false,'b4e')">C) Greška: pomiče se 3 gore, ne desno</div>
        <div class="bug-opt" onclick="bug(this,'b4',false,'b4e')">D) Greška: pomiče se <span class="frac"><span class="num">1</span><span class="den">3</span></span> desno</div>
      </div>
      <div class="bug-expl" id="b4e"></div>
    </div>
  </div>
  ...
  <div class="box-20">
    <div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — transformacije</div>
    <ul class="b20-list">
      <li class="b20-item"><div class="b20-dot"></div>f(x)+k: pomak gore/dolje (intuitivno) · f(x+k): pomak SUPROTNO od k (kontraintuitivno!)</li>
      <li class="b20-item"><div class="b20-dot"></div>−f(x): refleksija na x-os · f(−x): refleksija na y-os</li>
      <li class="b20-item"><div class="b20-dot"></div>Unutarnje transformacije (u zagradi) djeluju obratno od očekivanog</li>
    </ul>
  </div>
  ...
  <!-- RIJEŠENI PRIMJER -->
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — transformacije grafa</div></div>
    <div class="combo-body">
      <div class="combo-task">Opiši sve transformacije: g(x) = −2·f(x + 3) − 1</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">x + 3: pomak grafa <strong>3 mjesta lijevo</strong></div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Množenje s −2: <strong>rastezanje u smjeru y faktorom 2</strong> + <strong>refleksija na os x</strong></div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">− 1: pomak grafa <strong>1 mjesto dolje</strong></div></div>
        <div class="combo-step"><div class="combo-n">4</div><div class="combo-txt">Maturalni obrazac: čitaj izvana prema unutra — znakovi kod x: suprotno, kod y: isto</div></div>
      </div>
      <div class="combo-ans">Pomak (−3, −1), refleksija na x, rastezanje 2× &nbsp;·&nbsp; Uvijek redom: horizontalno → vertikalno</div>
    </div>
  </div>
  ...
  <div class="inline-cp" id="icp4">
    <div class="icp-head">
      <span class="icp-title">Provjeri razumijevanje — transformacije</span>
      <span class="icp-score" id="icp4-sc">0 / 3</span>
    </div>
    <div class="icp-body">
      <div class="icp-q" id="icp4q1">
        <div class="icp-q-text">g(x) = f(x) − 4 pomiče graf f:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp4','q1',this,false,'icp4q1fb')">4 lijevo</div>
          <div class="icp-opt" onclick="icp('icp4','q1',this,false,'icp4q1fb')">4 desno</div>
          <div class="icp-opt" onclick="icp('icp4','q1',this,true,'icp4q1fb')">4 dolje</div>
          <div class="icp-opt" onclick="icp('icp4','q1',this,false,'icp4q1fb')">4 gore</div>
        </div>
        <div class="icp-fb" id="icp4q1fb"></div>
      </div>
      <div class="icp-q" id="icp4q2">
        <div class="icp-q-text">g(x) = f(x − 2) pomiče graf f:</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp4','q2',this,false,'icp4q2fb')">2 lijevo</div>
          <div class="icp-opt" onclick="icp('icp4','q2',this,true,'icp4q2fb')">2 desno</div>
          <div class="icp-opt" onclick="icp('icp4','q2',this,false,'icp4q2fb')">2 gore</div>
          <div class="icp-opt" onclick="icp('icp4','q2',this,false,'icp4q2fb')">2 dolje</div>
        </div>
        <div class="icp-fb" id="icp4q2fb"></div>
      </div>
      <div class="icp-q" id="icp4q3">
        <div class="icp-q-text">Ako je f(2) = 5, koliko je g(2) gdje g(x) = −f(x) + 1?</div>
        <div class="icp-opts">
          <div class="icp-opt" onclick="icp('icp4','q3',this,false,'icp4q3fb')">6</div>
          <div class="icp-opt" onclick="icp('icp4','q3',this,false,'icp4q3fb')">−5</div>
          <div class="icp-opt" onclick="icp('icp4','q3',this,true,'icp4q3fb')">−4</div>
          <div class="icp-opt" onclick="icp('icp4','q3',this,false,'icp4q3fb')">4</div>
        </div>
        <div class="icp-fb" id="icp4q3fb"></div>
      </div>
      <div class="icp-done" id="icp4-done">✓ Odlično! Spreman si za Vježbaj →</div>
  ...
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">KOMBINIRANI · A1 — kompozicija i domena</div></div>
    <div class="combo-body">
      <div class="combo-task">f(x) = √x, g(x) = x−4. Nađi (f∘g)(x) i njenu domenu.</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">(f∘g)(x) = f(g(x)) = f(x−4) = √(x−4)</div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Domena: argument korijena ≥ 0 → x−4 ≥ 0 → x ≥ 4</div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">Provjera: D(g)=ℝ, treba g(x)∈D(f)=[0,+∞) → x−4≥0 ✓</div></div>
      </div>
      <div class="combo-ans">(f∘g)(x) = √(x−4), D = ⟨4, +∞)</div>
    </div>
  </div>

  <div class="combo" style="margin-top:10px">
    <div class="combo-head"><div class="combo-badge">KOMBINIRANI · A2 — inverz i transformacija</div></div>
    <div class="combo-body">
      <div class="combo-task">Nađi inverz od f(x) = (2x+1)/(x−3) i odredi D(f⁻¹).</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">y = (2x+1)/(x−3) → y(x−3) = 2x+1 → xy−3y = 2x+1</div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">xy−2x = 3y+1 → x(y−2) = 3y+1 → x = (3y+1)/(y−2)</div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">f⁻¹(x) = (3x+1)/(x−2). D(f⁻¹) = Sv(f) = ℝ\\{2}</div></div>
      </div>
      <div class="combo-ans">f⁻¹(x) = (3x+1)/(x−2), D(f⁻¹) = ℝ \\ {2}</div>
    </div>
  </div>

  <div class="combo" style="margin-top:10px">
    <div class="combo-head"><div class="combo-badge">KOMBINIRANI · A3 — parnost i transformacije</div></div>
    <div class="combo-body">
      <div class="combo-task">f je parna funkcija i f(3) = 7. Koliko je f(−3)? Je li g(x) = f(x) + x parna?</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">f parna → f(−3) = f(3) = 7 (definicija parnosti)</div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">g(−x) = f(−x) + (−x) = f(x) − x (jer f parna)</div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">g(−x) = f(x)−x ≠ f(x)+x = g(x) i ≠ −g(x) → niti parna niti neparna</div></div>
      </div>
      <div class="combo-ans">f(−3) = 7. g je niti parna niti neparna (zbroj parne i neparne funkcije)</div>
    </div>
  </div>
  ...
  <div class="drill">
    ...
    <div class="drill-body">
      ...
      <div class="drill-q" id="dr-q">f(x)=x² je parna funkcija</div>
  ...
  <div class="ncvvo-real">
    ...
    <div class="ncvvo-real-body">
      <div class="ncvvo-real-item">
        <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Domena · ~45% netočnih<span class="ncvvo-live-stat neutral" id="nlive-dom">domena</span></div>
        <div class="ncvvo-real-q">Nađi domenu: f(x) = √(x²−5x+6) / (x−1)</div>
        <div class="ncvvo-real-stat">Najčešća greška: <strong>rješavaju samo jedan uvjet, zaborave presjek</strong></div>
        <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
        <div class="ncvvo-real-ans">Uvjet 1 (√): x²−5x+6=(x−2)(x−3)≥0 → x≤2 ili x≥3 → (−∞,2⟩∪⟨3,+∞)<br>Uvjet 2: x−1≠0 → x≠1<br>Presjek: <strong>D = (−∞,1)∪(1,2⟩∪⟨3,+∞)</strong></div>
      </div>
      <div class="ncvvo-real-item">
        <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Kompozicija · ~50% netočnih<span class="ncvvo-live-stat neutral" id="nlive-komp">kompozicija</span></div>
        <div class="ncvvo-real-q">f(x)=x²+1, g(x)=√(x−1). Izračunaj (g∘f)(x) i nađi D(g∘f).</div>
        <div class="ncvvo-real-stat">Najčešća greška: <strong>miješaju redoslijed — računaju f(g(x)) umjesto g(f(x))</strong></div>
        <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
        <div class="ncvvo-real-ans">(g∘f)(x) = g(f(x)) = g(x²+1) = √(x²+1−1) = √(x²) = |x|<br>D: x²+1−1=x²≥0 → x²≥0 uvijek → <strong>D = ℝ</strong></div>
      </div>
      <div class="ncvvo-real-item">
        <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Transformacije · ~40% netočnih<span class="ncvvo-live-stat neutral" id="nlive-tr">transformacije</span></div>
        <div class="ncvvo-real-q">Graf f prolazi kroz (2, 5). Kroz koju točku prolazi graf g(x) = 2f(x+1) − 3?</div>
        <div class="ncvvo-real-stat">Najčešća greška: <strong>ne primjenjuju transformacije u ispravnom redoslijedu</strong></div>
        <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
        <div class="ncvvo-real-ans">f(2)=5. Trebamo g(x)=2f(x+1)−3 za koji x daje f(2).<br>x+1=2 → x=1. g(1)=2·f(2)−3=2·5−3=7.<br><strong>Graf g prolazi kroz (1, 7)</strong></div>
      </div>
      <div class="ncvvo-real-item">
        <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Inverz · ~55% netočnih<span class="ncvvo-live-stat neutral" id="nlive-inv">inverz</span></div>
        <div class="ncvvo-real-q">f(x) = 3x − 2. Nađi f⁻¹(4).</div>
        <div class="ncvvo-real-stat">Najčešća greška: <strong>računaju <span class="frac"><span class="num">1</span><span class="den">f</span></span>(4) umjesto inverza</strong></div>
        <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
        <div class="ncvvo-real-ans">f⁻¹(x) = (x+2)/3. f⁻¹(4) = (4+2)/3 = 2.<br>Provjera: f(2) = 3·2−2 = 4 ✓<br><strong>f⁻¹(4) = 2</strong></div>
      </div>
    </div>
  </div>
  ...
  <div class="checkpoint" id="cp">
    ...
    <ul class="cp-list">
      <li class="cp-item" id="cp1"><div class="cp-check" onclick="toggleCP(1)"></div>Domena: uvjeti razlomak≠0, korijen≥0, log>0, presjek uvjeta</li>
      <li class="cp-item" id="cp2"><div class="cp-check" onclick="toggleCP(2)"></div>Parna: f(−x)=f(x) sim. y-os · Neparna: f(−x)=−f(x) sim. ishodište</li>
      <li class="cp-item" id="cp3"><div class="cp-check" onclick="toggleCP(3)"></div>Kompozicija: (f∘g)(x)=f(g(x)) — g PRVO, čitaj desno prema lijevo</li>
      <li class="cp-item" id="cp4"><div class="cp-check" onclick="toggleCP(4)"></div>Inverz: y=f(x) → izrazi x → zamijeni x↔y → f⁻¹(x)</li>
      <li class="cp-item" id="cp5"><div class="cp-check" onclick="toggleCP(5)"></div>f(x+k): pomak suprotno od k (kontraintuitivno!) · −f(x): refleksija x-os</li>
    </ul>
    <div class="cp-footer">
      <span id="cp-txt">0 / 5 potvrđeno</span>
      <span class="cp-progress-txt" id="cp-ready" style="display:none">→ Spreman si za Poglavlje 07!</span>
    </div>
  </div>
  ...
  <div class="matura-block">
    ...
    <ul class="matura-list">
      <li class="mi"><div class="mi-dot"></div><span><b>Domena:</b> razlomak≠0, par.korijen≥0, log>0. Kombiniraj presjekom!</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>Parna: f(−x)=f(x).</b> Neparna: f(−x)=−f(x). Uvijek uvrstiti −x!</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>(f∘g)(x) = f(g(x))</b> — g ide PRVA. Kompozicija ≠ množenje!</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>Inverz:</b> y=f(x) → izrazi x → zamijeni x↔y. Provjeri: f(f⁻¹(x))=x.</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>f(x+k):</b> pomak k LIJEVO (k>0). Kontraintuitivno — unutarnje je obratno!</span></li>
    </ul>
  </div>
  ...
  <div class="cn-grid">
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge c">P07</span><span class="cn-item-title">Linearna i kvadratna f.</span></div><div class="cn-item-desc">Kvadratna funkcija je polinom 2. stupnja — sve transformacije iz P06.</div><div class="cn-item-arrow"><a href="Maturiraj_MatA_P07_FINAL.html?from=P06" style="color:inherit;text-decoration:none">→ transformacije grafa</a></div></div>
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge c">P08</span><span class="cn-item-title">Eksponencijalna i log.</span></div><div class="cn-item-desc">log = inverz eksponencijalne. Inverz funkcije iz P06 je temeljna veza.</div><div class="cn-item-arrow"><a href="Maturiraj_MatA_P08_FINAL.html?from=P06" style="color:inherit;text-decoration:none">→ inverz funkcije</a></div></div>
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge c">P09</span><span class="cn-item-title">Trigonometrija</span></div><div class="cn-item-desc">sin, cos su parne/neparne funkcije. Sve transformacije grafova iz P06.</div><div class="cn-item-arrow"><a href="Maturiraj_MatA_P09_FINAL.html?from=P06" style="color:inherit;text-decoration:none">→ svojstva trig. funkcija</a></div></div>
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge i">P16</span><span class="cn-item-title">Granice funkcija</span></div><div class="cn-item-desc">Neprekidnost i limes su svojstva funkcije — izravna nadogradnja P06.</div><div class="cn-item-arrow"><a href="Maturiraj_MatA_P16_FINAL.html?from=P06" style="color:inherit;text-decoration:none">→ neprekidnost</a></div></div>
  </div>
</div>
...
<div class="con" style="margin-bottom:20px">
  <div class="cr"><div class="ck b">Domena i kodomena</div><div class="cv">D(f): skup dopustivih x (bez dijeljenja s 0, bez &radic; negativnih). C(f): skup svih f(x) vrijednosti.</div></div>
  <div class="cr"><div class="ck c">Kompozicija</div><div class="cv">(f∘g)(x) = f(g(x)). D(f∘g): x&isin;D(g) <strong>i</strong> g(x)&isin;D(f) — obje tvrdnje!</div></div>
  <div class="cr"><div class="ck i">Inverz funkcije</div><div class="cv">f<sup>&minus;1</sup> postoji &harr; f injekcija (svaki y jednoznačan). Naci: zamijeni x&harr;y, rješavaj za y.</div></div>
  <div class="cr"><div class="ck a">Transformacije grafa</div><div class="cv">f(x+a): pomak lijevo za a. f(x)+b: pomak gore za b. &minus;f(x): zrcalni os x. f(&minus;x): zrcalni os y.</div></div>
  <div class="cr"><div class="ck r">Zamka</div><div class="cv">D(f∘g) &ne; D(f)&cap;D(g)! Uvijek provjeri koje x daju g(x) unutar D(f). Inverzna: postoji samo za bijektivne!</div></div>
</div>
  <div class="nav-row">
...
<div class="layer" id="l2">
  ...
  <div class="matura-block">
    ...
    <ul class="matura-list">
      <li class="mi"><div class="mi-dot"></div><span><b>Domena:</b> razlomak≠0, korijen≥0, log>0 — presjek uvjeta!</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>Parna: f(−x)=f(x) · Neparna: f(−x)=−f(x).</b> Uvrstiti −x i provjeriti.</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>(f∘g)(x) = f(g(x))</b> — g PRVA. Ne miješaj s množenjem!</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>f(x+k):</b> pomak k lijevo. f(x)+k: pomak k gore.</span></li>
      <li class="mi"><div class="mi-dot"></div><span><b>Inverz: y=f(x) → izrazi x → zamijeni.</b> Provjeri f(f⁻¹(x))=x.</span></li>
    </ul>
  </div>
  <div class="slbl" style="margin-top:28px">// bonus — popuni prazninu</div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">01 · domena</div><div class="fitb-sent">Domena f(x) = √(x−7) je x ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi1" type="text" placeholder="uvjet..." autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi1','f1f','≥7','dom2')">Provjeri</button></div><div class="fitb-fb" id="f1f"></div></div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">02 · parnost</div><div class="fitb-sent">f(x) = x⁵ − x³ je ___ funkcija</div></div><div class="fitb-row"><input class="fitb-in" id="fi2" type="text" placeholder="parna/neparna/nijedno" autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi2','f2f','neparna','par2')">Provjeri</button></div><div class="fitb-fb" id="f2f"></div></div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">03 · kompozicija</div><div class="fitb-sent">f(x)=x+2, g(x)=3x. (f∘g)(1) = ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi3" type="text" placeholder="broj..." autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi3','f3f','5','komp2')">Provjeri</button></div><div class="fitb-fb" id="f3f"></div></div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">04 · transformacija</div><div class="fitb-sent">g(x) = f(x+3) pomiče graf f za 3 ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi4" type="text" placeholder="lijevo/desno/gore/dolje" autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi4','f4f','lijevo','tr2')">Provjeri</button></div><div class="fitb-fb" id="f4f"></div></div>
  <div class="box-warn">
    <span class="bw-ico">⚡</span>
    <div class="bw-body">
      <div class="bw-title">MATURA LOGIKA — domena: stablo odluke</div>
      <div class="bw-txt">
        <strong>Kad vidiš √f(x)</strong> → uvjet: f(x) ≥ 0<br>
        <strong>Kad vidiš 1/f(x)</strong> → uvjet: f(x) ≠ 0<br>
        <strong>Kad vidiš log f(x)</strong> → uvjet: f(x) &gt; 0<br>
        <strong>Kombinacija</strong> → napiši sve uvjete i uzmi <em>presjek</em> rješenja.
      </div>
    </div>
  </div>
  <div class="nav-row">
    <span class="nb" onclick="sw(1)">← Uči</span>
    <button onclick="navigateChapter('p07')" class="nb primary">Sljedeće poglavlje →</button>
  </div>
</div>
...
function sw(i){
  ...
  try{sessionStorage.setItem('p06_tab',i);}catch(e){}
}


/* ── DOMAIN EXPLORER ── */
var dexData={
  1:{expr:'f(x) = 1/x',steps:['Uvjet: x ≠ 0 (nazivnik)'],domain:'D = ℝ \\\\ {0} = (−∞,0) ∪ (0,+∞)'},
  2:{expr:'f(x) = √(x−3)',steps:['Uvjet: x−3 ≥ 0','x ≥ 3'],domain:'D = ⟨3, +∞)'},
  3:{expr:'f(x) = 1/√(x+2)',steps:['Uvjet 1 (1/√): x+2 > 0 (strogo!)','x > −2'],domain:'D = (−2, +∞)'},
  4:{expr:'f(x) = √(x+1) / (x−2)',steps:['Uvjet 1 (√): x+1 ≥ 0 → x ≥ −1','Uvjet 2 (razlomak): x−2 ≠ 0 → x ≠ 2','Presjek: x ≥ −1 i x ≠ 2'],domain:'D = ⟨−1,2) ∪ (2,+∞)'},
  5:{expr:'f(x) = x / (x²−1)',steps:['Uvjet: x²−1 ≠ 0','(x−1)(x+1) ≠ 0 → x ≠ 1 i x ≠ −1'],domain:'D = ℝ \\\\ {−1, 1}'}
};
function setDex(k,btn){
  document.querySelectorAll('[id^="dex-b"]').forEach(function(b){b.classList.remove('on');});
  btn.classList.add('on');
  var d=dexData[k];
  document.getElementById('dex-expr').textContent=d.expr;
  document.getElementById('dex-steps').innerHTML=d.steps.map(function(s,i){
    return '<div style="display:flex;gap:8px"><span style="color:var(--blue);font-weight:700">'+(i+1)+'.</span><span>'+s+'</span></div>';
  }).join('');
  document.getElementById('dex-domain').innerHTML='<strong>D:</strong> '+d.domain;
}
setDex(1,document.getElementById('dex-b1'));

/* ── GRAPH TRANSFORMER ── */
var trData={
  1:{name:'f(x) + 2',desc:'Vanjska transformacija — dodaje 2 na svaki y.<br>Graf se pomiče <strong>2 gore</strong>.',example:'Primjer: sin(x)+2 pomiče sinusoidu 2 gore. Sve točke: y → y+2.'},
  2:{name:'f(x + 2)',desc:'Unutarnja transformacija — kontraintuitivna!<br>Graf se pomiče <strong>2 lijevo</strong> (suprotno od +2).',example:'Primjer: (x+2)² je parabola x² pomaknuta 2 lijevo. Vrh iz (0,0) ide u (−2,0).'},
  3:{name:'2 · f(x)',desc:'Vanjska transformacija — množi svaki y s 2.<br>Vertikalno <strong>rastezanje</strong> faktora 2.',example:'Primjer: 2·sin(x) ima amplitudu 2 (umjesto 1). Sve y-vrijednosti udvostručene.'},
  4:{name:'−f(x)',desc:'Vanjska transformacija — negira svaki y.<br><strong>Refleksija na x-os</strong> (gore-dolje).',example:'Primjer: −x² je parabola okrenuta prema dolje. Svaki y postaje −y.'},
  5:{name:'f(−x)',desc:'Unutarnja transformacija — zamijeni x s −x.<br><strong>Refleksija na y-os</strong> (lijevo-desno).',example:'Primjer: f(−x) za rastuću f daje padajuću g. Graf se "preklopi" po y-osi.'},
  6:{name:'|f(x)|',desc:'Dio grafa ispod x-osi "preklopi" se gore.<br>Negativne y-vrijednosti postaju pozitivne.',example:'Primjer: |sin(x)| — sve "dolove" sinusoide postaju "bregovi". Nema negativnih y.'}
};
function setTr(k,btn){
  document.querySelectorAll('[id^="tr-b"]').forEach(function(b){b.classList.remove('on');});
  btn.classList.add('on');
  var d=trData[k];
  document.getElementById('tr-name').textContent=d.name;
  document.getElementById('tr-desc').innerHTML=d.desc;
  document.getElementById('tr-example').textContent=d.example;
}
setTr(1,document.getElementById('tr-b1'));
...
/* ── TRY-IT ── */
var tryExp={
  dom1:'x≥−4, x≠3, x≠−3 → od −4 (uključeno) ali isključi −3 i 3: ⟨−4,−3)∪(−3,3)∪(3,+∞)',
  par1:'g(−x)=(−x)²+1=x²+1=g(x) → parna! Graf simetričan na y-os.',
  inv1:'f(f⁻¹(5)) = 5 uvijek — to je definicija inverza! f⁻¹(5)=(5−3)/2=1, f(1)=2+3=5 ✓',
  tr1:'g(x)=f(x−2)+1: unutarnja f(x−2) → pomak 2 desno. Vanjska +1 → pomak 1 gore.'
};
...
/* ── RAPID FIRE DRILL ── */
var drData=[
  {q:'f(x)=x² je parna funkcija',ans:true,tag:'parnost',exp:'Točno! f(−x)=(−x)²=x²=f(x) → parna. Graf simetričan na y-os ✓'},
  {q:'f(x)=x³ je parna funkcija',ans:false,tag:'parnost',exp:'Netočno! f(−x)=(−x)³=−x³=−f(x) → neparna. Simetrična na ishodište, ne y-os.'},
  {q:'Domena f(x)=√x je ℝ',ans:false,tag:'domena',exp:'Netočno! Korijen zahtijeva x≥0 → D=⟨0,+∞). Za negativne x nije definirana.'},
  {q:'(f∘g)(x) = f(g(x))',ans:true,tag:'kompozicija',exp:'Točno! g ide PRVA, pa f. Čitaj s desna na lijevo: ∘g znači g unutarnja. ✓'},
  {q:'f⁻¹(f(x)) = x uvijek vrijedi',ans:true,tag:'inverz',exp:'Točno! To je definicija inverza — "poništavanje". f⁻¹ vraća što je f uzelo ✓'},
  {q:'Graf f(x+2) je pomak grafa f za 2 desno',ans:false,tag:'transformacije',exp:'Netočno! f(x+2) pomiče 2 LIJEVO. Unutarnje transformacije su kontraintuitivne!'},
  {q:'Svaki polinom ima domenu D=ℝ',ans:true,tag:'domena',exp:'Točno! Polinomi su definirani za sve realne x — nema dijeljenja ni korijena ✓'},
  {q:'Zbroj dvije neparne funkcije je neparna',ans:true,tag:'parnost',exp:'Točno! Ako f(−x)=−f(x) i g(−x)=−g(x), tada (f+g)(−x)=−f(x)−g(x)=−(f+g)(x) ✓'},
  {q:'D(f⁻¹) = D(f)',ans:false,tag:'inverz',exp:'Netočno! D(f⁻¹) = Sv(f) — domena inverza je skup vrijednosti originalne funkcije.'},
  {q:'Graf −f(x) je refleksija grafa f na x-os',ans:true,tag:'transformacije',exp:'Točno! Negiranje f(x) zrcali svaki y → y postaje −y → refleksija na x-os ✓'},
  {q:'f(x)=x²+x je niti parna niti neparna',ans:true,tag:'parnost',exp:'Točno! f(−x)=x²−x ≠ f(x) i ≠ −f(x). Niti simetrično na y-os niti na ishodište.'},
  {q:'Kompozicija f∘g uvijek ima istu domenu kao g',ans:false,tag:'kompozicija',exp:'Netočno! D(f∘g) ⊆ D(g). Mora i g(x) biti u D(f) — može biti manja domena!'}
];
...
var bugDone={};
var bugExp={
  b1:'✓ Točno! x²−4≥0 → (x−2)(x+2)≥0 → x≤−2 ili x≥2. Parabola x²−4 je ≥0 IZVANA nultočaka!',
  b2:'✓ Točno! Nije parna (f(−x)≠f(x)) I nije neparna (f(−x)≠−f(x)). Treća opcija: nijedno od toga!',
  b3:'✓ Točno! (f∘g)(x)=f(g(x)) — nije množenje! g(3)=9, pa f(9)=10. Množenje bi bilo 4·9=36.',
  b4:'✓ Točno! f(x+k): pomak SUPROTNO od k. f(x+3) pomiče 3 LIJEVO. Unutarnje = kontraintuitivno!'
};
...
var icpFeedback={
  icp1:{
    q1:{ok:'✓ Točno! x≠5 → D=ℝ\\\\{5}=(−∞,5)∪(5,+∞)',ng:'✗ Netočno. x−5≠0 → x≠5 → D=ℝ\\\\{5}. Nije x>5!'},
    q2:{ok:'✓ Točno! Svaki x daje točno jedan y=x². Isti y za različite x ne narušava definiciju!',ng:'✗ Netočno. Funkcija: svaki x→točno jedan y. x² daje isti y za ±x, ali to je dozvoljeno!'},
    q3:{ok:'✓ Točno! 5−x≥0 → x≤5 → D=(−∞,5⟩',ng:'✗ Netočno. √(5−x): 5−x≥0 → x≤5. Uvjet je ≤, ne ≥!'}
  },
  icp2:{
    q1:{ok:'✓ Točno! f(−x)=(−x)⁴−2(−x)²=x⁴−2x²=f(x) → parna',ng:'✗ Netočno. f(−x)=(−x)⁴−2(−x)²=x⁴−2x²=f(x) → PARNA! Svi parni eksponenti.'},
    q2:{ok:'✓ Točno! f(−x)=(−x)³+1=−x³+1. Niti f(x)=x³+1 niti −f(x)=−x³−1. Nijedno!',ng:'✗ Netočno. f(−x)=−x³+1 ≠ f(x)=x³+1 i ≠ −f(x)=−x³−1 → niti parna niti neparna.'},
    q3:{ok:'✓ Točno! Rastuća: x₁<x₂ → f(x₁)<f(x₂). 1<2 → f(1)<f(2) → f(2)>4.',ng:'✗ Netočno. Rastuća znači: veći x → veći f(x). 2>1, pa f(2)>f(1)=4.'}
  },
  icp3:{
    q1:{ok:'✓ Točno! (f∘g)(1)=f(g(1))=f(1+3)=f(4)=2·4=8',ng:'✗ Netočno. g PRVO: g(1)=1+3=4. Pa f: f(4)=2·4=8.'},
    q2:{ok:'✓ Točno! y=x/3 → 3y=x → f⁻¹(x)=3x',ng:'✗ Netočno. y=x/3 → x=3y → zamijeni: f⁻¹(x)=3x. Inverz množenja je množenje s reciprokom!'},
    q3:{ok:'✓ Točno! Graf f⁻¹ je refleksija grafa f po pravcu y=x.',ng:'✗ Netočno. f⁻¹ zamjenjuje x i y — geometrijski to je refleksija po pravcu y=x.'}
  },
  icp4:{
    q1:{ok:'✓ Točno! f(x)−4: vanjska transformacija, oduzimanje 4 od y → pomak 4 dolje.',ng:'✗ Netočno. f(x)−4 je vanjska: svaki y ide za 4 dolje. Nije horizontalni pomak!'},
    q2:{ok:'✓ Točno! f(x−2): unutarnja, k=−2, pomak suprotno od −2 = 2 desno.',ng:'✗ Netočno. f(x−2): unutarnja transformacija. k=−2 → pomak suprotno od −2 = 2 DESNO.'},
    q3:{ok:'✓ Točno! g(2)=−f(2)+1=−5+1=−4.',ng:'✗ Netočno. g(2)=−f(2)+1=−5+1=−4. Prvo negiranje (−5), pa dodavanje 1.'}
  }
};
...
/* ── ADAPTIVE + NCVVO LIVE ── */
var topicErrors={domena:0,parnost:0,kompozicija:0,inverz:0,transformacije:0};
var topicHints={
  domena:'Greške s domenom! Provjeri sve uvjete: razlomak≠0, korijen≥0, log>0. Uzmi presjek!',
  parnost:'Greške s parnosti! Uvijek uvrstiti −x pa provjeri je li f(−x)=f(x) ili =−f(x).',
  kompozicija:'Greške s kompozicijom! (f∘g)(x)=f(g(x)) — g IDE PRVA. Nije množenje!',
  inverz:'Greške s inverzom! y=f(x) → izrazi x → zamijeni x↔y. Provjeri f(f⁻¹(x))=x.',
  transformacije:'Greške s transformacijama! Unutarnje (u zagradi) su kontraintuitivne — f(x+2) ide LIJEVO!'
};
var qTopics={q1:'domena',q2:'domena',q3:'parnost',q4:'parnost',q5:'kompozicija',q6:'kompozicija',q7:'inverz',q8:'inverz',q9:'transformacije',q10:'transformacije',q11:'domena',q12:'kompozicija'};
var ncvvoTopicMap={'nlive-dom':['q1','q2','q11'],'nlive-komp':['q5','q6','q12'],'nlive-tr':['q9','q10'],'nlive-inv':['q7','q8']};
...
function updateProgress(){
  ...
  var icpPts=0;
  ['icp1','icp2','icp3','icp4'].forEach(function(icp){
  ...
  tabProgress[1]=Math.min(29+drillPts+icpPts+cpPts,50);
  tabProgress[2]=Math.min(29+drillPts+icpPts+cpPts+quizPts,100);
  ...
  document.getElementById('prog-bar').style.width=p+'%';
  document.getElementById('prog-pct').textContent=p+'%';
  try{localStorage.setItem('maturiraj_p06_prog',p);}catch(e){}
}
...
var ALL_QUESTIONS=[
  {id:'q1',topic:'domena',meta:'domena funkcije',
   text:'Domena f(x) = 1/(x²−4) je:',
   opts:[{t:'ℝ',ok:false},{t:'ℝ \\\\ {2}',ok:false},{t:'ℝ \\\\ {−2, 2}',ok:true},{t:'x > 2',ok:false}],
   c:'✓ Točno. x²−4=(x−2)(x+2)=0 → x=±2. D=ℝ\\\\{−2,2}.',
   w:'✗ Netočno. x²−4=(x+2)(x−2)=0 daje x=2 i x=−2 — oba su isključena.',
   proof:['x²−4 ≠ 0','(x−2)(x+2) = 0 → x=2 ili x=−2','D = ℝ \\\\ {−2, 2}']},
  {id:'q2',topic:'domena',meta:'domena s korijenom',
   text:'Domena f(x) = √(3x − 6) je:',
   opts:[{t:'x > 2',ok:false},{t:'x ≥ 2',ok:true},{t:'x ≥ 6',ok:false},{t:'ℝ',ok:false}],
   c:'✓ Točno. 3x−6≥0 → 3x≥6 → x≥2 → D=⟨2,+∞).',
   w:'✗ Netočno. Korijen: 3x−6≥0 → x≥2. Rub je uključen (≥, ne >)!',
   proof:['3x−6 ≥ 0','3x ≥ 6','x ≥ 2 → ⟨2,+∞)']},
  {id:'q3',topic:'parnost',meta:'parna funkcija',
   text:'Koja od sljedećih funkcija je parna?',
   opts:[{t:'f(x) = x³',ok:false},{t:'f(x) = x²+3',ok:true},{t:'f(x) = x+1',ok:false},{t:'f(x) = x³+x',ok:false}],
   c:'✓ Točno. f(−x)=(−x)²+3=x²+3=f(x) → parna.',
   w:'✗ Netočno. Parna: f(−x)=f(x). Samo x²+3: f(−x)=(−x)²+3=x²+3=f(x) ✓',
   proof:['f(−x) = (−x)²+3 = x²+3','x²+3 = f(x)','f(−x)=f(x) → PARNA ✓']},
  {id:'q4',topic:'parnost',meta:'neparna funkcija — provjera',
   text:'Je li f(x) = x³ − x neparna?',
   opts:[{t:'Da',ok:true},{t:'Ne, parna je',ok:false},{t:'Ne, niti parna niti neparna',ok:false},{t:'Ovisi o domeni',ok:false}],
   c:'✓ Točno. f(−x)=(−x)³−(−x)=−x³+x=−(x³−x)=−f(x) → neparna.',
   w:'✗ Netočno. f(−x)=−x³+x=−(x³−x)=−f(x) → neparna!',
   proof:['f(−x) = (−x)³−(−x) = −x³+x','= −(x³−x) = −f(x)','f(−x)=−f(x) → NEPARNA ✓']},
  {id:'q5',topic:'kompozicija',meta:'kompozicija funkcija',
   text:'f(x)=x+2, g(x)=x². Koliko je (f∘g)(3)?',
   opts:[{t:'25',ok:false},{t:'11',ok:true},{t:'15',ok:false},{t:'9',ok:false}],
   c:'✓ Točno. (f∘g)(3)=f(g(3))=f(9)=9+2=11.',
   w:'✗ Netočno. (f∘g)(3)=f(g(3)). g(3)=9, pa f(9)=9+2=11.',
   proof:['g(3) = 3² = 9','f(g(3)) = f(9) = 9+2','= 11']},
  {id:'q6',topic:'kompozicija',meta:'redoslijed kompozicije',
   text:'f(x)=2x, g(x)=x+1. (f∘g)(x) = ?',
   opts:[{t:'2x+1',ok:false},{t:'2x+2',ok:true},{t:'2x²+2x',ok:false},{t:'x+2',ok:false}],
   c:'✓ Točno. (f∘g)(x)=f(g(x))=f(x+1)=2(x+1)=2x+2.',
   w:'✗ Netočno. g PRVO: g(x)=x+1. Pa f: f(x+1)=2(x+1)=2x+2.',
   proof:['g(x) = x+1 (g PRVA)','f(g(x)) = f(x+1) = 2(x+1)','= 2x+2']},
  {id:'q7',topic:'inverz',meta:'inverz funkcije',
   text:'Inverz od f(x) = 5x − 3 je:',
   opts:[{t:'f⁻¹(x) = (x+3)/5',ok:true},{t:'f⁻¹(x) = 5x+3',ok:false},{t:'f⁻¹(x) = 1/(5x−3)',ok:false},{t:'f⁻¹(x) = (x−3)/5',ok:false}],
   c:'✓ Točno. y=5x−3 → 5x=y+3 → x=(y+3)/5 → f⁻¹(x)=(x+3)/5.',
   w:'✗ Netočno. y=5x−3 → 5x=y+3 → x=(y+3)/5. Zamijeni: f⁻¹(x)=(x+3)/5.',
   proof:['y = 5x−3','5x = y+3 → x = (y+3)/5','Zamijeni: f⁻¹(x) = (x+3)/5']},
  {id:'q8',topic:'inverz',meta:'D i Sv inverza',
   text:'Ako je D(f) = ⟨2,+∞) i Sv(f) = ⟨0,+∞), tada D(f⁻¹) = ?',
   opts:[{t:'⟨2,+∞)',ok:false},{t:'⟨0,+∞)',ok:true},{t:'ℝ',ok:false},{t:'(0,+∞)',ok:false}],
   c:'✓ Točno. D(f⁻¹) = Sv(f) = ⟨0,+∞).',
   w:'✗ Netočno. D(f⁻¹) = Sv(f). Domena inverza je skup vrijednosti originalne funkcije.',
   proof:['D(f⁻¹) = Sv(f)','Sv(f) = ⟨0,+∞)','D(f⁻¹) = ⟨0,+∞)']},
  {id:'q9',topic:'transformacije',meta:'pomak grafa',
   text:'Graf g(x) = f(x−3) je pomak grafa f za:',
   opts:[{t:'3 lijevo',ok:false},{t:'3 desno',ok:true},{t:'3 gore',ok:false},{t:'3 dolje',ok:false}],
   c:'✓ Točno. f(x−3): unutarnja, k=−3 → pomak suprotno od −3 = 3 desno.',
   w:'✗ Netočno. f(x−3): unutarnja transformacija. k=−3 → pomak suprotno od −3 = 3 DESNO.',
   proof:['f(x−3): unutarnja transformacija','k = −3, pomak suprotno od k','pomak 3 desno']},
  {id:'q10',topic:'transformacije',meta:'refleksija grafa',
   text:'Koji zapis daje refleksiju grafa f na x-os?',
   opts:[{t:'f(−x)',ok:false},{t:'−f(x)',ok:true},{t:'f(x)+1',ok:false},{t:'|f(x)|',ok:false}],
   c:'✓ Točno. −f(x): negira sve y-vrijednosti → refleksija na x-os.',
   w:'✗ Netočno. −f(x) negira y → refleksija na x-os. f(−x) refleksija na y-os.',
  ...
  {id:'q12',topic:'kompozicija',meta:'A razina · domena kompozicije',
   text:'f(x)=√x, g(x)=x−4. Domena (f∘g)(x) je:',
   opts:[{t:'x ≥ 0',ok:false},{t:'x ≥ 4',ok:true},{t:'x > 4',ok:false},{t:'ℝ',ok:false}],
   c:'✓ Točno. (f∘g)(x)=√(x−4). Uvjet: x−4≥0→x≥4.',
   w:'✗ Netočno. (f∘g)(x)=f(g(x))=√(x−4). Korijen: x−4≥0→x≥4.',
   proof:['(f∘g)(x)=f(g(x))=√(x−4)','Uvjet korijena: x−4≥0','x≥4 → D=⟨4,+∞)']}
];

var FExp={
  dom2:'5−x≥0 → x≤5 ... ali ovdje je √(x−7)≥0 → x−7≥0 → x≥7.',
  par2:'f(−x)=(−x)⁵−(−x)³=−x⁵+x³=−(x⁵−x³)=−f(x) → neparna!',
  komp2:'(f∘g)(1)=f(g(1))=f(3·1)=f(3)=3+2=5. g PRVA: g(1)=3, pa f(3)=5.',
  tr2:'f(x+k): unutarnja transformacija — pomak suprotno od k. k=3 → pomak 3 LIJEVO.'
};
...
function qa(qid,idx,ok,eid){
  ...
  if(Object.keys(answered).length===total){
    ...
    document.getElementById('slbl').textContent=pct>=80?'Izvrsno! Spreman si za P07 →':pct>=60?'Dobro! Ponovi slabe točke.':'Ponovi gradivo P06 prije nastavka.';
    if(s)s.classList.add('show');
    soundComplete();
    tabProgress[2]=Math.min(29+Math.round(correct/total*71),100);
    updateProgress();
  }
  updateProgress();
}
...
/* ── RESTORE TAB ── */
(function(){try{var s=sessionStorage.getItem('p06_tab');if(s!==null){var i=parseInt(s);if(i>=0&&i<=2)sw(i);}}catch(e){}})();

/* ── RESTORE PROGRESS (localStorage) ── */
(function(){
  try{
    var saved=localStorage.getItem('maturiraj_p06_prog');
    if(saved!==null){
...
const meta = {id:'P06',pidLower:'p06',title:"Maturiraj.hr \u2014 Mat A \u00b7 P06 \u00b7 Funkcija \u2014 Pojam i Svojstva",subject:'matematika-a',lsKey:'maturiraj_p06_prog'};

let _styleEl=null,_mounted=false;
function mount(container,options={}){
  if(_mounted)unmount(container);
  _styleEl=document.createElement('style');
  _styleEl.setAttribute('data-chapter','p06');
  ...
  try{new Function(js)();}catch(e){console.error('[P06] Script error:',e);}
  _mounted=true;
}
function unmount(container){
  const ex=document.querySelector('style[data-chapter="p06"]');
  if(ex)ex.remove();
  _styleEl=null;
  if(container)container.innerHTML='';
  _mounted=false;
}
function getProgress(){try{return parseInt(localStorage.getItem('maturiraj_p06_prog')||'0');}catch(e){return 0;}}
function setProgress(pct){try{localStorage.setItem('maturiraj_p06_prog',String(pct));}catch(e){}}
