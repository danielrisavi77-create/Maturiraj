...
var demoData=[
  ...
  },
  {
    ...
    color:'var(--red)',
    html:'<div style="background:var(--ele);border:1px solid var(--bdm);border-radius:var(--r3);padding:16px;margin-bottom:12px"><div style="font-family:var(--mono);font-size:9px;color:var(--red);font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:10px">🐛 prepoznaj grešku — derivacije</div><div style="font-size:12.5px;color:var(--t2);margin-bottom:10px;font-family:var(--mono)">Učenik derivira f(x) = (x+1)³:</div><div style="padding:10px 14px;background:var(--dim-r);border:1px solid var(--bd-r);border-radius:var(--r2);font-family:var(--mono);font-size:13px;color:var(--t1);margin-bottom:10px">f\\'(x) = 3(x+1)² <span style="color:var(--red)">× (greška!)</span></div><div style="display:flex;flex-direction:column;gap:6px"><div style="padding:8px 12px;background:var(--dim-g);border:1px solid var(--bd-g);border-radius:var(--r2);font-size:12px;color:var(--green);font-family:var(--mono)">B) Greška — nedostaje pravilo lanca! f\\'(x) = 3(x+1)²·1 — ali u složenijem slučaju mora biti ·g\\'(x)</div></div></div><div style="font-size:11px;color:var(--t3);font-family:var(--mono);margin-top:10px">→ Svaka sekcija ima ovakav zadatak. Najefikasniji trening — puno grešaka na ispitu su točno ovakve!</div>'
  },
  {
