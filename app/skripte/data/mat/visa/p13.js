...
<nav class="sidebar" id="sidebar">
  ...
  <button class="sb-item active" style="background:transparent;border:none;cursor:default;text-align:left;width:100%"><span class="sb-dot"></span>13 · Planimetrija</button>
...
<div class="bc"><span>← poglavlja</span><span class="bc-sep">/</span><span>a-razina</span><span class="bc-sep">/</span><span class="bc-cur">planimetrija-trokut-kružnica-poučci</span></div>
<div class="tabs">
...
<div class="layer on" id="l0">
  <div class="hero"><div class="hero-orb"></div><div class="hero-orb2"></div>
    <div class="hero-eyebrow">poglavlje 13 · A razina · geometrija</div>
    <h1 class="hero-title">Planimetrija<br><span>likovi u ravnini</span></h1>
    <p class="hero-sub">Trokut, kružnica i poučci — kutovi, površine, sinusov i kosinusov poučak te obodni i središnji kut</p>
  ...
  <div class="tags">
    <span class="pill p-b">Kutovi u trokutu</span><span class="pill p-c">Površine</span>
    <span class="pill p-i">Pitagora</span><span class="pill p-a">Sinusov i kosinusov poučak</span>
    <span class="pill p-v">Kružnica</span><span class="pill p-r">Obodni i središnji kut</span>
  </div>
  <div class="slbl">// zašto je ovo kritično za A razinu</div>
  <div class="box-int"><div class="box-int-lbl">HOOK — pročitaj ovo prvo</div>
    <div class="box-int-txt">Planimetrija je geometrija ravnine — trokuti, kružnice i mnogokuti. Sve se vrti oko dva alata: <strong>poučci za stranice i kutove</strong> (Pitagora, sinusov, kosinusov) i <strong>formule za površinu</strong>.<br><br>Kružnica dodaje vezu obodnog i središnjeg kuta — obodni kut je polovica središnjeg nad istim lukom.<br><br><strong>Na maturi A razine: sinusov i kosinusov poučak, površina trokuta i obodni kut pojavljuju se redovito.</strong></div>
  </div>
  <div class="slbl">// pregled u 30 sekundi</div>
  <div class="sg">
    <div class="sc"><div class="sc-ico si-b">α+β+γ</div><div class="sc-name">Kutovi u trokutu</div><div class="sc-desc">Zbroj unutarnjih kutova je 180°. Vanjski kut = zbroj dvaju nesusjednih unutarnjih.</div></div>
    <div class="sc"><div class="sc-ico si-c">P=½·a·v</div><div class="sc-name">Površina trokuta</div><div class="sc-desc">½·a·vₐ = ½·a·b·sinγ = √(s(s−a)(s−b)(s−c)) (Heron). Opseg O=a+b+c.</div></div>
    <div class="sc"><div class="sc-ico si-i">a²+b²=c²</div><div class="sc-name">Pitagorin poučak</div><div class="sc-desc">U pravokutnom trokutu: hipotenuza² = zbroj kvadrata kateta.</div></div>
    <div class="sc"><div class="sc-ico si-a">a/sinα</div><div class="sc-name">Sinusov i kosinusov poučak</div><div class="sc-desc">a/sinα=b/sinβ=c/sinγ=2R · c²=a²+b²−2ab·cosγ.</div></div>
    <div class="sc"><div class="sc-ico si-v">O=2rπ</div><div class="sc-name">Kružnica</div><div class="sc-desc">Opseg O=2rπ, površina P=r²π. Duljina luka l=rφ (φ u radijanima).</div></div>
    <div class="sc"><div class="sc-ico si-r">obodni</div><div class="sc-name">Obodni i središnji kut</div><div class="sc-desc">Obodni kut = ½ središnjeg nad istim lukom. Kut nad promjerom = 90° (Tales).</div></div>
  </div>
  <div class="slbl">// ključni koncepti</div>
  <div class="con">
    <div class="cr"><div class="ck b">Kutovi u trokutu</div><div class="cv">α+β+γ=180°. Vanjski kut = zbroj dvaju nesusjednih unutarnjih. Jednakostranični: svi 60°.</div></div>
    <div class="cr"><div class="ck b">Površina trokuta</div><div class="cv">P=½·a·vₐ = ½·a·b·sinγ = √(s(s−a)(s−b)(s−c)), s=O/2 (Heron).</div></div>
    <div class="cr"><div class="ck c">Pitagorin poučak</div><div class="cv">Pravokutni trokut: a²+b²=c² (c hipotenuza). Obrat vrijedi: ako a²+b²=c², trokut je pravokutan.</div></div>
    <div class="cr"><div class="ck i">Sinusov poučak</div><div class="cv">a/sinα = b/sinβ = c/sinγ = 2R (R polumjer opisane kružnice).</div></div>
    <div class="cr"><div class="ck a">Kosinusov poučak</div><div class="cv">c²=a²+b²−2ab·cosγ. Poopćenje Pitagore (za γ=90° daje a²+b²=c²).</div></div>
    <div class="cr"><div class="ck v">Kružnica</div><div class="cv">Opseg O=2rπ · Površina P=r²π · duljina luka l=rφ · površina isječka P=½r²φ (φ u rad).</div></div>
    <div class="cr"><div class="ck r">Obodni i središnji kut</div><div class="cv">Obodni kut = ½ središnjeg nad istim lukom. Kut nad promjerom = 90° (Talesov poučak).</div></div>
    <div class="cr"><div class="ck r">Zamka</div><div class="cv">Opseg kružnice je 2rπ, a r²π je POVRŠINA. I: površina trokuta ima faktor ½ — ne zaboravi!</div></div>
  </div>
  <div class="nav-row"><button onclick="navigateChapter('p12')" class="nb">← P12 · Vektori</button><span class="nb primary" onclick="sw(1)">Uči detaljno →</span></div>
</div>
<!-- L1 -->
<div class="layer" id="l1">
  <!-- 01 -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">01 · TROKUT — KUTOVI, POVRŠINA, PITAGORA</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>
  <div class="box-int"><div class="box-int-lbl">INTUITIVNO — trokut je "atom" planimetrije</div>
    <div class="box-int-txt">Svaki mnogokut se može razrezati na trokute, pa trokut nosi sve. Zbroj kutova je uvijek 180°.<br><br>Površinu računamo na tri načina: ½·stranica·visina, ½·a·b·sinγ (kad znamo dvije stranice i kut među njima), te Heronovom formulom (kad znamo sve tri stranice).<br><br><strong>Pitagorin poučak vrijedi samo u pravokutnom trokutu: a²+b²=c², gdje je c hipotenuza (nasuprot pravom kutu).</strong></div>
  </div>
  <div class="box-for"><span class="box-for-lbl">TROKUT — KUTOVI I POVRŠINA</span>
    <span class="val">α + β + γ = 180°</span> <span class="cmt">— zbroj unutarnjih kutova</span><br>
    <span class="val">P = ½ · a · vₐ</span> <span class="cmt">— stranica puta pripadna visina</span><br>
    <span class="val">P = ½ · a · b · sinγ</span> <span class="cmt">— dvije stranice i kut među njima</span><br>
    <span class="val">P = √(s(s−a)(s−b)(s−c))</span> <span class="cmt">— Heron, s = O/2 (poluopseg)</span>
  </div>
  <div class="box-for"><span class="box-for-lbl">PRAVOKUTNI TROKUT</span>
    <span class="val">a² + b² = c²</span> <span class="cmt">— Pitagorin poučak (c hipotenuza)</span><br>
    <span class="val">sinα = a/c, &nbsp; cosα = b/c, &nbsp; tanα = a/b</span> <span class="cmt">— omjeri stranica</span><br>
    <span class="val">P = ½ · a · b</span> <span class="cmt">— katete su međusobno visine</span>
  </div>
  <div class="cmp" style="margin-bottom:16px">
    <div class="cmp-c"><div class="cmp-h b">Znamo stranicu i visinu</div><div class="cmp-body">
      <div class="cmp-row">P = ½·a·vₐ</div>
      <div class="cmp-row">Najjednostavnije</div>
      <div class="cmp-row">Treba okomita visina</div>
      <div class="cmp-row">na danu stranicu</div>
    </div></div>
    <div class="cmp-c"><div class="cmp-h c">Znamo sve tri stranice</div><div class="cmp-body">
      <div class="cmp-row">Heron: P=√(s(s−a)(s−b)(s−c))</div>
      <div class="cmp-row">s = O/2</div>
      <div class="cmp-row">Nije potrebna visina</div>
      <div class="cmp-row">Idealno za A razinu</div>
    </div></div>
  </div>
  <div class="disc-wrap"><div class="disc-head"><span class="disc-title">// Kalkulator trokuta (Heron) — upiši tri stranice</span></div>
    <div class="disc-body">
      <div class="disc-row" style="flex-wrap:wrap;gap:6px">
        <span class="disc-lbl">a =</span><input class="disc-in" id="tri-a" type="number" value="3" style="width:55px">
        <span class="disc-lbl">b =</span><input class="disc-in" id="tri-b" type="number" value="4" style="width:55px">
        <span class="disc-lbl">c =</span><input class="disc-in" id="tri-c" type="number" value="5" style="width:55px">
        <button class="disc-btn" onclick="calcTri()">Izračunaj →</button>
      </div>
      <div class="disc-result" id="tri-result">Upiši stranice pa klikni Izračunaj</div>
    </div>
  </div>
  <div class="box-men"><div class="box-men-lbl">MENTALNI MODEL — visina je okomica</div>
    <div class="box-men-txt">Visina vₐ je okomita udaljenost vrha A od stranice a (ili njezina pravca). Površina je "polovica pravokutnika" sa stranicama a i vₐ.<br>Za pravokutni trokut katete su jedna drugoj visine, pa je P=½·a·b.<br><strong>Kad nemaš visinu, a znaš dvije stranice i kut među njima — koristi P=½·a·b·sinγ.</strong></div>
  </div>
  <div class="sr" id="sr1">
    <div class="sr-head"><div class="sr-title">Površina i opseg trokuta — korak po korak</div><div class="sr-task">Trokut: a=5, b=6, c=7. Nađi opseg i površinu (Heron).</div></div>
    <div class="sr-steps">
      <div class="sr-step" id="sr1s1"><div class="sr-step-in"><div class="sr-num">1</div><div class="sr-body"><div class="sr-stitle">Opseg i poluopseg</div><div class="sr-txt">O = 5+6+7 = 18, &nbsp; s = O/2 = <strong>9</strong></div></div></div></div>
      <div class="sr-step" id="sr1s2"><div class="sr-step-in"><div class="sr-num">2</div><div class="sr-body"><div class="sr-stitle">Heronova formula</div><div class="sr-txt">P = √(9·(9−5)·(9−6)·(9−7)) = √(9·4·3·2) = √216</div></div></div></div>
      <div class="sr-step" id="sr1s3"><div class="sr-step-in"><div class="sr-num">3</div><div class="sr-body"><div class="sr-stitle">Sredi korijen</div><div class="sr-txt">P = √216 = √(36·6) = <strong>6√6 ≈ 14,7</strong>
        <div class="sr-tryit"><div class="sr-try-lbl">↳ Površina trokuta s a=8 i visinom vₐ=5?</div>
          <div class="sr-try-row"><input class="sr-try-in" id="try1" type="text" placeholder="P=?" autocomplete="off"><button class="sr-try-btn" onclick="tryIt('try1','try1-fb','20','ud1')">Provjeri</button></div>
  ...
  <div class="box-bug"><div class="bug-head">🐛 prepoznaj grešku — površina trokuta</div><div class="bug-body">
    <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">Učenik računa površinu trokuta s a=10, vₐ=6:</p>
    <div class="bug-task">P = <span class="wrong">10 · 6 = 60</span></div>
    <div class="bug-opts">
      <div class="bug-opt" onclick="bug(this,'b1',false,'b1e')">A) Točno, P = a · vₐ</div>
      <div class="bug-opt" onclick="bug(this,'b1',true,'b1e')">B) Greška: P = ½·a·vₐ = ½·10·6 = 30. Faktor ½ je obavezan!</div>
      <div class="bug-opt" onclick="bug(this,'b1',false,'b1e')">C) Greška: P = a + vₐ = 16</div>
      <div class="bug-opt" onclick="bug(this,'b1',false,'b1e')">D) Greška: P = 2·a·vₐ = 120</div>
    </div><div class="bug-expl" id="b1e"></div>
  </div></div>
  <div class="box-20"><div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — trokut</div><ul class="b20-list">
    <li class="b20-item"><div class="b20-dot"></div>α+β+γ = 180°. Površina P = ½·a·vₐ (faktor ½!).</li>
    <li class="b20-item"><div class="b20-dot"></div>Heron: P=√(s(s−a)(s−b)(s−c)), s=O/2.</li>
    <li class="b20-item"><div class="b20-dot"></div>Pitagora samo u pravokutnom: a²+b²=c² (c hipotenuza).</li>
  </ul></div>
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — Pitagora i površina</div></div>
    <div class="combo-body">
      <div class="combo-task">Pravokutni trokut ima katete 6 i 8. Nađi hipotenuzu, opseg i površinu.</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">Hipotenuza: c = √(6²+8²) = √100 = <strong>10</strong></div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Opseg: O = 6+8+10 = 24</div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">Površina: P = ½·6·8 = <strong>24</strong> (katete su visine)</div></div>
      </div>
      <div class="combo-ans">c=10, O=24, P=24. Trojka 6-8-10 je umnožak poznate 3-4-5.</div>
    </div>
  </div>
  <div class="inline-cp" id="icp1">
    <div class="icp-head"><span class="icp-title">Provjeri razumijevanje — trokut</span><span class="icp-score" id="icp1-sc">0 / 3</span></div>
    <div class="icp-body">
      <div class="icp-q" id="icp1q1"><div class="icp-q-text">Dva kuta trokuta su 70° i 60°. Treći je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp1','q1',this,true,'icp1q1fb')">50°</div>
        <div class="icp-opt" onclick="icp('icp1','q1',this,false,'icp1q1fb')">60°</div>
        <div class="icp-opt" onclick="icp('icp1','q1',this,false,'icp1q1fb')">130°</div>
        <div class="icp-opt" onclick="icp('icp1','q1',this,false,'icp1q1fb')">40°</div>
      </div><div class="icp-fb" id="icp1q1fb"></div></div>
      <div class="icp-q" id="icp1q2"><div class="icp-q-text">Površina trokuta s a=12, vₐ=5 je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp1','q2',this,false,'icp1q2fb')">60</div>
        <div class="icp-opt" onclick="icp('icp1','q2',this,true,'icp1q2fb')">30</div>
        <div class="icp-opt" onclick="icp('icp1','q2',this,false,'icp1q2fb')">17</div>
        <div class="icp-opt" onclick="icp('icp1','q2',this,false,'icp1q2fb')">120</div>
      </div><div class="icp-fb" id="icp1q2fb"></div></div>
      <div class="icp-q" id="icp1q3"><div class="icp-q-text">Katete su 5 i 12. Hipotenuza je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp1','q3',this,true,'icp1q3fb')">13</div>
        <div class="icp-opt" onclick="icp('icp1','q3',this,false,'icp1q3fb')">17</div>
        <div class="icp-opt" onclick="icp('icp1','q3',this,false,'icp1q3fb')">√17</div>
        <div class="icp-opt" onclick="icp('icp1','q3',this,false,'icp1q3fb')">7</div>
      </div><div class="icp-fb" id="icp1q3fb"></div></div>
      <div class="icp-done" id="icp1-done">✓ Odlično! Nastavi na poučke →</div>
      <button class="icp-retry" id="icp1-retry" onclick="retryIcp('icp1')">↺ Pokušaj ponovo</button>
    </div>
  </div>
  <!-- 02 -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">02 · SINUSOV I KOSINUSOV POUČAK</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>
  <div class="box-int"><div class="box-int-lbl">INTUITIVNO — poučci rješavaju "kosi" trokut</div>
    <div class="box-int-txt">Pitagora vrijedi samo za pravi kut. Za bilo koji trokut koriste se sinusov i kosinusov poučak.<br><br><strong>Sinusov</strong> poučak povezuje stranicu i nasuprotni kut: a/sinα = b/sinβ = c/sinγ = 2R. Koristi ga kad imaš par (stranica, nasuprotni kut).<br><br><strong>Kosinusov</strong> poučak c²=a²+b²−2ab·cosγ koristi se kad znaš dvije stranice i kut među njima, ili sve tri stranice (pa tražiš kut).</div>
  </div>
  <div class="box-for"><span class="box-for-lbl">SINUSOV I KOSINUSOV POUČAK</span>
    <span class="val">a/sinα = b/sinβ = c/sinγ = 2R</span> <span class="cmt">— sinusov poučak (R = polumjer opisane kružnice)</span><br>
    <span class="val">c² = a² + b² − 2ab·cosγ</span> <span class="cmt">— kosinusov poučak</span><br>
    <span class="val">cosγ = (a²+b²−c²)/(2ab)</span> <span class="cmt">— kosinusov, riješen po kutu</span><br>
    <span class="val">P = ½·a·b·sinγ</span> <span class="cmt">— površina iz dviju stranica i kuta</span>
  </div>
  <div class="cmp" style="margin-bottom:16px">
    <div class="cmp-c"><div class="cmp-h b">Sinusov poučak — kada?</div><div class="cmp-body">
      <div class="cmp-row">Stranica + nasuprotni kut</div>
      <div class="cmp-row">a/sinα = b/sinβ</div>
      <div class="cmp-row">Traži stranicu ili kut</div>
      <div class="cmp-row">2R = a/sinα (opisana)</div>
    </div></div>
    <div class="cmp-c"><div class="cmp-h c">Kosinusov poučak — kada?</div><div class="cmp-body">
      <div class="cmp-row">Dvije stranice + kut među njima</div>
      <div class="cmp-row">ili sve tri stranice</div>
      <div class="cmp-row">c²=a²+b²−2ab·cosγ</div>
      <div class="cmp-row">Poopćenje Pitagore</div>
    </div></div>
  </div>
  <div class="disc-wrap"><div class="disc-head"><span class="disc-title">// Kosinusov poučak — upiši a, b i kut γ</span></div>
    <div class="disc-body">
      <div class="disc-row" style="flex-wrap:wrap;gap:6px">
        <span class="disc-lbl">a =</span><input class="disc-in" id="law-a" type="number" value="5" style="width:50px">
        <span class="disc-lbl">b =</span><input class="disc-in" id="law-b" type="number" value="8" style="width:50px">
        <span class="disc-lbl">γ =</span><input class="disc-in" id="law-g" type="number" value="60" style="width:50px"><span class="disc-lbl">°</span>
        <button class="disc-btn" onclick="calcLaw()">Izračunaj →</button>
      </div>
      <div class="disc-result" id="law-result">Upiši dvije stranice i kut pa klikni Izračunaj</div>
    </div>
  </div>
  <div class="box-men"><div class="box-men-lbl">MENTALNI MODEL — kosinusov je "Pitagora s ispravkom"</div>
    <div class="box-men-txt">Za γ=90° je cos90°=0, pa c²=a²+b² — to je Pitagora. Za oštri kut (cosγ&gt;0) član −2ab·cosγ smanjuje c²; za tupi kut (cosγ&lt;0) ga povećava.<br><strong>Predznak člana −2ab·cosγ automatski "podešava" duljinu nasuprotne stranice prema kutu.</strong></div>
  </div>
  <div class="sr" id="sr2">
    <div class="sr-head"><div class="sr-title">Kosinusov poučak — korak po korak</div><div class="sr-task">Trokut: a=7, b=8, γ=60°. Nađi stranicu c.</div></div>
    <div class="sr-steps">
      <div class="sr-step" id="sr2s1"><div class="sr-step-in"><div class="sr-num">1</div><div class="sr-body"><div class="sr-stitle">Postavi kosinusov poučak</div><div class="sr-txt">c² = a² + b² − 2ab·cosγ = 7² + 8² − 2·7·8·cos60°</div></div></div></div>
      <div class="sr-step" id="sr2s2"><div class="sr-step-in"><div class="sr-num">2</div><div class="sr-body"><div class="sr-stitle">Uvrsti cos60° = ½</div><div class="sr-txt">c² = 49 + 64 − 112·½ = 113 − 56 = 57</div></div></div></div>
      <div class="sr-step" id="sr2s3"><div class="sr-step-in"><div class="sr-num">3</div><div class="sr-body"><div class="sr-stitle">Korjenuj</div><div class="sr-txt">c = √57 ≈ <strong>7,55</strong>
        <div class="sr-tryit"><div class="sr-try-lbl">↳ c² za a=5, b=3, γ=60°?</div>
          <div class="sr-try-row"><input class="sr-try-in" id="try2" type="text" placeholder="c²=?" autocomplete="off"><button class="sr-try-btn" onclick="tryIt('try2','try2-fb','19','kru1')">Provjeri</button></div>
  ...
  <div class="box-bug"><div class="bug-head">🐛 prepoznaj grešku — Pitagora vs hipotenuza</div><div class="bug-body">
    <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">Učenik računa hipotenuzu pravokutnog trokuta s katetama 6 i 8:</p>
    <div class="bug-task">c = <span class="wrong">6 + 8 = 14</span></div>
    <div class="bug-opts">
      <div class="bug-opt" onclick="bug(this,'b2',false,'b2e')">A) Točno, hipotenuza je zbroj kateta</div>
      <div class="bug-opt" onclick="bug(this,'b2',true,'b2e')">B) Greška: c² = a²+b² = 36+64 = 100 → c = 10, ne 14!</div>
      <div class="bug-opt" onclick="bug(this,'b2',false,'b2e')">C) Greška: c = √(6+8) = √14</div>
      <div class="bug-opt" onclick="bug(this,'b2',false,'b2e')">D) Greška: c = 6·8 = 48</div>
    </div><div class="bug-expl" id="b2e"></div>
  </div></div>
  <div class="box-20"><div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — poučci</div><ul class="b20-list">
    <li class="b20-item"><div class="b20-dot"></div>Sinusov: a/sinα = b/sinβ = c/sinγ = 2R (omjeri!).</li>
    <li class="b20-item"><div class="b20-dot"></div>Kosinusov: c²=a²+b²−2ab·cosγ (poopćena Pitagora).</li>
    <li class="b20-item"><div class="b20-dot"></div>Površina iz kuta: P=½·a·b·sinγ.</li>
  </ul></div>
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — sinusov poučak</div></div>
    <div class="combo-body">
      <div class="combo-task">U trokutu je a=12, α=30°, β=45°. Nađi stranicu b.</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">Sinusov poučak: a/sinα = b/sinβ</div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">b = a·sinβ/sinα = 12·sin45°/sin30° = 12·(√2/2)/(1/2)</div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">b = 12·√2 = <strong>12√2 ≈ 16,97</strong></div></div>
      </div>
      <div class="combo-ans">b = 12√2. Sinusov poučak povezuje stranicu i njoj nasuprotni kut.</div>
    </div>
  </div>
  <div class="inline-cp" id="icp2">
    <div class="icp-head"><span class="icp-title">Provjeri razumijevanje — poučci</span><span class="icp-score" id="icp2-sc">0 / 3</span></div>
    <div class="icp-body">
      <div class="icp-q" id="icp2q1"><div class="icp-q-text">Za a=4, b=3, γ=60° stranica c (kosinusov) je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp2','q1',this,true,'icp2q1fb')">√13</div>
        <div class="icp-opt" onclick="icp('icp2','q1',this,false,'icp2q1fb')">5</div>
        <div class="icp-opt" onclick="icp('icp2','q1',this,false,'icp2q1fb')">7</div>
        <div class="icp-opt" onclick="icp('icp2','q1',this,false,'icp2q1fb')">√37</div>
      </div><div class="icp-fb" id="icp2q1fb"></div></div>
      <div class="icp-q" id="icp2q2"><div class="icp-q-text">Koja formula je sinusov poučak?</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp2','q2',this,true,'icp2q2fb')">a/sinα = b/sinβ</div>
        <div class="icp-opt" onclick="icp('icp2','q2',this,false,'icp2q2fb')">a·sinα = b·sinβ</div>
        <div class="icp-opt" onclick="icp('icp2','q2',this,false,'icp2q2fb')">a²+b²=c²</div>
        <div class="icp-opt" onclick="icp('icp2','q2',this,false,'icp2q2fb')">sinα/a = b/sinβ</div>
      </div><div class="icp-fb" id="icp2q2fb"></div></div>
      <div class="icp-q" id="icp2q3"><div class="icp-q-text">Površina trokuta s a=6, b=10, γ=30° je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp2','q3',this,true,'icp2q3fb')">15</div>
        <div class="icp-opt" onclick="icp('icp2','q3',this,false,'icp2q3fb')">30</div>
        <div class="icp-opt" onclick="icp('icp2','q3',this,false,'icp2q3fb')">60</div>
        <div class="icp-opt" onclick="icp('icp2','q3',this,false,'icp2q3fb')">7,5</div>
      </div><div class="icp-fb" id="icp2q3fb"></div></div>
      <div class="icp-done" id="icp2-done">✓ Sjajno! Nastavi na kružnicu →</div>
      <button class="icp-retry" id="icp2-retry" onclick="retryIcp('icp2')">↺ Pokušaj ponovo</button>
    </div>
  </div>
  <!-- 03 -->
  <div class="sec-hdr"><div class="sec-line"></div><h2 class="sec-badge">03 · KRUŽNICA — OBODNI I SREDIŠNJI KUT</h2><span class="sec-time">~12 min</span><div class="sec-line"></div></div>
  <div class="box-int"><div class="box-int-lbl">INTUITIVNO — kut "izvana" je upola manji</div>
    <div class="box-int-txt">Kružnica polumjera r ima opseg O=2rπ i površinu P=r²π. Luk i isječak su "djelići" određeni kutom.<br><br>Ključna veza: obodni kut (vrh na kružnici) je uvijek polovica središnjeg kuta (vrh u središtu) nad istim lukom.<br><br><strong>Poseban slučaj: kut nad promjerom je 90° (Talesov poučak) — jer je središnji kut nad promjerom ispruženi, 180°.</strong></div>
  </div>
  <div class="box-for"><span class="box-for-lbl">KRUŽNICA — OPSEG, POVRŠINA, KUTOVI</span>
    <span class="val">O = 2rπ &nbsp;·&nbsp; P = r²π</span> <span class="cmt">— opseg i površina kruga</span><br>
    <span class="val">l = rφ &nbsp;·&nbsp; Pisječka = ½r²φ</span> <span class="cmt">— duljina luka i površina isječka (φ u radijanima)</span><br>
    <span class="val">obodni kut = ½ · središnji kut</span> <span class="cmt">— nad istim lukom</span><br>
    <span class="val">kut nad promjerom = 90°</span> <span class="cmt">— Talesov poučak</span>
  </div>
  <div class="cmp" style="margin-bottom:16px">
    <div class="cmp-c"><div class="cmp-h b">Središnji kut</div><div class="cmp-body">
      <div class="cmp-row">Vrh u SREDIŠTU</div>
      <div class="cmp-row">Nad lukom = mjera luka</div>
      <div class="cmp-row">Dvostruko veći</div>
      <div class="cmp-row">od obodnog</div>
    </div></div>
    <div class="cmp-c"><div class="cmp-h c">Obodni kut</div><div class="cmp-body">
      <div class="cmp-row">Vrh na KRUŽNICI</div>
      <div class="cmp-row">= ½ središnjeg</div>
      <div class="cmp-row">Svi obodni nad istim</div>
      <div class="cmp-row">lukom su jednaki</div>
    </div></div>
  </div>
  <div class="box-men"><div class="box-men-lbl">MENTALNI MODEL — opseg vs površina</div>
    <div class="box-men-txt">Opseg je "duljina ruba" (jedna potencija r): O=2rπ. Površina je "koliko stane unutra" (kvadrat od r): P=r²π.<br>Ako pomiješaš, dimenzije te odaju: opseg je u metrima, površina u m².<br><strong>Najčešća zamka: napisati r²π za opseg ili 2rπ za površinu.</strong></div>
  </div>
  <div class="sr" id="sr3">
    <div class="sr-head"><div class="sr-title">Obodni i središnji kut — korak po korak</div><div class="sr-task">Tetiva AB vidi se iz središta pod kutom 120°. Koliki je obodni kut nad AB?</div></div>
    <div class="sr-steps">
      <div class="sr-step" id="sr3s1"><div class="sr-step-in"><div class="sr-num">1</div><div class="sr-body"><div class="sr-stitle">Prepoznaj središnji kut</div><div class="sr-txt">Središnji kut nad lukom AB iznosi 120°.</div></div></div></div>
      <div class="sr-step" id="sr3s2"><div class="sr-step-in"><div class="sr-num">2</div><div class="sr-body"><div class="sr-stitle">Primijeni vezu</div><div class="sr-txt">Obodni kut = ½ · središnji = ½ · 120°</div></div></div></div>
      <div class="sr-step" id="sr3s3"><div class="sr-step-in"><div class="sr-num">3</div><div class="sr-body"><div class="sr-stitle">Rezultat</div><div class="sr-txt">Obodni kut = <strong>60°</strong>
        <div class="sr-tryit"><div class="sr-try-lbl">↳ Obodni kut ako je središnji 100°?</div>
          <div class="sr-try-row"><input class="sr-try-in" id="try3" type="text" placeholder="kut=?" autocomplete="off"><button class="sr-try-btn" onclick="tryIt('try3','try3-fb','50','tan1')">Provjeri</button></div>
  ...
  <div class="box-bug"><div class="bug-head">🐛 prepoznaj grešku — obodni kut</div><div class="bug-body">
    <p style="font-size:13px;color:var(--t2);margin-bottom:12px;font-family:var(--mono)">Središnji kut je 120°. Učenik računa obodni kut:</p>
    <div class="bug-task">Obodni = <span class="wrong">2 · 120° = 240°</span></div>
    <div class="bug-opts">
      <div class="bug-opt" onclick="bug(this,'b3',false,'b3e')">A) Točno, obodni je dvostruko veći</div>
      <div class="bug-opt" onclick="bug(this,'b3',true,'b3e')">B) Greška: obodni = ½ središnjeg = ½·120° = 60°, ne 240°!</div>
      <div class="bug-opt" onclick="bug(this,'b3',false,'b3e')">C) Greška: obodni = 120° (jednaki su)</div>
      <div class="bug-opt" onclick="bug(this,'b3',false,'b3e')">D) Greška: obodni = 180°−120° = 60°</div>
    </div><div class="bug-expl" id="b3e"></div>
  </div></div>
  <div class="box-20"><div class="b20-lbl">ZAPAMTI U 20 SEKUNDI — kružnica</div><ul class="b20-list">
    <li class="b20-item"><div class="b20-dot"></div>Opseg O=2rπ, površina P=r²π — ne pomiješaj!</li>
    <li class="b20-item"><div class="b20-dot"></div>Obodni kut = ½ središnjeg nad istim lukom.</li>
    <li class="b20-item"><div class="b20-dot"></div>Kut nad promjerom = 90° (Talesov poučak).</li>
  </ul></div>
  <div class="combo">
    <div class="combo-head"><div class="combo-badge">RIJEŠENI PRIMJER — kružni isječak</div></div>
    <div class="combo-body">
      <div class="combo-task">Kružnica ima r=6. Nađi duljinu luka i površinu isječka za središnji kut 60°.</div>
      <div class="combo-steps">
        <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">60° = π/3 rad. Duljina luka: l = rφ = 6·(π/3) = <strong>2π</strong></div></div>
        <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Površina isječka: P = ½r²φ = ½·36·(π/3) = <strong>6π</strong></div></div>
        <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">Provjera: isječak je 60/360 = 1/6 kruga; ⅙·36π = 6π ✓</div></div>
      </div>
      <div class="combo-ans">l = 2π, P = 6π. Isječak od 60° je šestina punog kruga.</div>
    </div>
  </div>
  <div class="inline-cp" id="icp3">
    <div class="icp-head"><span class="icp-title">Provjeri razumijevanje — kružnica</span><span class="icp-score" id="icp3-sc">0 / 3</span></div>
    <div class="icp-body">
      <div class="icp-q" id="icp3q1"><div class="icp-q-text">Opseg kružnice polumjera r=6 je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp3','q1',this,true,'icp3q1fb')">12π</div>
        <div class="icp-opt" onclick="icp('icp3','q1',this,false,'icp3q1fb')">36π</div>
        <div class="icp-opt" onclick="icp('icp3','q1',this,false,'icp3q1fb')">6π</div>
        <div class="icp-opt" onclick="icp('icp3','q1',this,false,'icp3q1fb')">3π</div>
      </div><div class="icp-fb" id="icp3q1fb"></div></div>
      <div class="icp-q" id="icp3q2"><div class="icp-q-text">Površina kruga polumjera r=4 je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp3','q2',this,false,'icp3q2fb')">8π</div>
        <div class="icp-opt" onclick="icp('icp3','q2',this,true,'icp3q2fb')">16π</div>
        <div class="icp-opt" onclick="icp('icp3','q2',this,false,'icp3q2fb')">4π</div>
        <div class="icp-opt" onclick="icp('icp3','q2',this,false,'icp3q2fb')">64π</div>
      </div><div class="icp-fb" id="icp3q2fb"></div></div>
      <div class="icp-q" id="icp3q3"><div class="icp-q-text">Središnji kut je 90°. Obodni kut nad istim lukom je:</div><div class="icp-opts">
        <div class="icp-opt" onclick="icp('icp3','q3',this,false,'icp3q3fb')">180°</div>
        <div class="icp-opt" onclick="icp('icp3','q3',this,true,'icp3q3fb')">45°</div>
        <div class="icp-opt" onclick="icp('icp3','q3',this,false,'icp3q3fb')">90°</div>
        <div class="icp-opt" onclick="icp('icp3','q3',this,false,'icp3q3fb')">135°</div>
  ...
  <div class="combo"><div class="combo-head"><div class="combo-badge">KOMBINIRANI · A1 — kosinusov poučak za kut</div></div><div class="combo-body">
    <div class="combo-task">Trokut ima stranice a=7, b=8, c=9. Nađi najveći kut (nasuprot c).</div>
    <div class="combo-steps">
      <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">Najveći kut je nasuprot najdulje stranice c: cosγ = (a²+b²−c²)/(2ab)</div></div>
      <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">cosγ = (49+64−81)/(2·7·8) = 32/112 = 2/7 ≈ 0,286</div></div>
      <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">γ = arccos(2/7) ≈ <strong>73,4°</strong></div></div>
    </div><div class="combo-ans">γ ≈ 73,4°. Kosinusov poučak riješen po kutu: cosγ=(a²+b²−c²)/(2ab).</div>
  </div></div>
  <div class="combo" style="margin-top:10px"><div class="combo-head"><div class="combo-badge">KOMBINIRANI · A2 — površina preko dviju stranica i kuta</div></div><div class="combo-body">
    <div class="combo-task">U trokutu je a=10, b=6 i kut među njima γ=150°. Nađi površinu.</div>
    <div class="combo-steps">
      <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">P = ½·a·b·sinγ = ½·10·6·sin150°</div></div>
      <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">sin150° = sin30° = ½</div></div>
      <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">P = ½·60·½ = <strong>15</strong></div></div>
    </div><div class="combo-ans">P = 15. sin tupog kuta = sin njegova suplementa (sin150°=sin30°).</div>
  </div></div>
  <div class="combo" style="margin-top:10px"><div class="combo-head"><div class="combo-badge">KOMBINIRANI · A3 — opisana kružnica</div></div><div class="combo-body">
    <div class="combo-task">U trokutu je a=10 i nasuprotni kut α=30°. Nađi polumjer opisane kružnice R.</div>
    <div class="combo-steps">
      <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">Sinusov poučak: a/sinα = 2R</div></div>
      <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">2R = 10/sin30° = 10/0,5 = 20</div></div>
      <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">R = <strong>10</strong></div></div>
    </div><div class="combo-ans">R = 10. Prošireni sinusov poučak: a/sinα = 2R daje polumjer opisane kružnice.</div>
  </div></div>
  <div class="combo" style="margin-top:10px"><div class="combo-head"><div class="combo-badge">KOMBINIRANI · A4 — tetivni četverokut</div></div><div class="combo-body">
    <div class="combo-task">Četverokut je tetivni (upisan u kružnicu). Jedan kut je 70°. Koliki je nasuprotni kut?</div>
    <div class="combo-steps">
      <div class="combo-step"><div class="combo-n">1</div><div class="combo-txt">U tetivnom četverokutu zbroj nasuprotnih kutova je 180°.</div></div>
      <div class="combo-step"><div class="combo-n">2</div><div class="combo-txt">Nasuprotni kut = 180° − 70°</div></div>
      <div class="combo-step"><div class="combo-n">3</div><div class="combo-txt">= <strong>110°</strong></div></div>
    </div><div class="combo-ans">110°. Tetivni četverokut: α+γ=180° i β+δ=180°.</div>
  </div></div>
  <!-- DRILL -->
  <div class="drill"><div class="drill-head"><span class="drill-title">// Brzi refleks — Točno ili Netočno?</span><span class="drill-score" id="dr-sc">0 / 0</span></div>
    <div class="drill-body">
      ...
      <div class="drill-q" id="dr-q">Zbroj unutarnjih kutova trokuta je 180°</div>
  ...
  <div class="ncvvo-real"><div class="ncvvo-real-hd">📊 stvarni NCVVO zadaci — gdje učenici gube bodove</div><div class="ncvvo-real-body">
    <div class="ncvvo-real-item">
      <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Površina trokuta · ~45% netočnih<span class="ncvvo-live-stat neutral" id="nlive-ud">trokut</span></div>
      <div class="ncvvo-real-q">Nađi površinu trokuta sa stranicama 5, 6, 7</div>
      <div class="ncvvo-real-stat">Najčešća greška: <strong>ne znaju Heronovu formulu ili krivo računaju poluopseg</strong></div>
      <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
      <div class="ncvvo-real-ans">s=(5+6+7)/2=9; P=√(9·4·3·2)=√216=<strong>6√6 ≈ 14,7</strong></div>
    </div>
    <div class="ncvvo-real-item">
      <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Pitagora · ~40% netočnih<span class="ncvvo-live-stat neutral" id="nlive-kru">pitagora</span></div>
      <div class="ncvvo-real-q">Dijagonala kvadrata stranice 5 je</div>
      <div class="ncvvo-real-stat">Najčešća greška: <strong>pišu d=5+5 umjesto d=5√2</strong></div>
      <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
      <div class="ncvvo-real-ans">d²=5²+5²=50 → d=√50=<strong>5√2 ≈ 7,07</strong></div>
    </div>
    <div class="ncvvo-real-item">
      <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Kosinusov poučak · ~55% netočnih<span class="ncvvo-live-stat neutral" id="nlive-tan">poučci</span></div>
      <div class="ncvvo-real-q">Za a=6, b=10, γ=120° nađi c</div>
      <div class="ncvvo-real-stat">Najčešća greška: <strong>zaborave da je cos120° negativan (−½)</strong></div>
      <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
      <div class="ncvvo-real-ans">c²=36+100−2·6·10·cos120°=136−120·(−½)=136+60=196 → c=<strong>14</strong></div>
    </div>
    <div class="ncvvo-real-item">
      <div class="ncvvo-real-meta"><span class="ncvvo-real-year">A razina · tipično</span>Obodni kut / kružnica · ~50% netočnih<span class="ncvvo-live-stat neutral" id="nlive-sj">kružnica</span></div>
      <div class="ncvvo-real-q">Obodni kut nad tetivom je 35°. Koliki je središnji kut nad istom tetivom?</div>
      <div class="ncvvo-real-stat">Najčešća greška: <strong>dijele umjesto da množe s 2</strong></div>
      <button class="ncvvo-real-show" onclick="showAns(this)">Prikaži rješenje ↓</button>
      <div class="ncvvo-real-ans">Središnji = 2 · obodni = 2·35° = <strong>70°</strong></div>
    </div>
  </div></div>
  <!-- CHECKPOINT -->
  <div class="checkpoint" id="cp"><div class="cp-head"><span class="cp-icon">✅</span><div><div class="cp-title">Checkpoint — jesi li spreman?</div><div class="cp-sub">Potvrdi što znaš</div></div></div>
    <ul class="cp-list">
      <li class="cp-item" id="cp1"><div class="cp-check" onclick="toggleCP(1)"></div>α+β+γ=180° · P=½·a·vₐ (faktor ½!)</li>
      <li class="cp-item" id="cp2"><div class="cp-check" onclick="toggleCP(2)"></div>Heron: P=√(s(s−a)(s−b)(s−c)), s=O/2</li>
      <li class="cp-item" id="cp3"><div class="cp-check" onclick="toggleCP(3)"></div>Pitagora a²+b²=c² · P=½·a·b·sinγ</li>
      <li class="cp-item" id="cp4"><div class="cp-check" onclick="toggleCP(4)"></div>Sinusov a/sinα=2R · kosinusov c²=a²+b²−2ab·cosγ</li>
      <li class="cp-item" id="cp5"><div class="cp-check" onclick="toggleCP(5)"></div>Kružnica O=2rπ, P=r²π · obodni=½ središnji</li>
    </ul>
  ...
  <div class="matura-block"><div class="matura-hd">⭐ matura fokus</div><ul class="matura-list">
    <li class="mi"><div class="mi-dot"></div><span><b>P=½·a·vₐ=½·a·b·sinγ</b> · Heron za tri stranice.</span></li>
    <li class="mi"><div class="mi-dot"></div><span><b>Kosinusov c²=a²+b²−2ab·cosγ</b> — pazi predznak cosγ za tupi kut!</span></li>
    <li class="mi"><div class="mi-dot"></div><span><b>Sinusov a/sinα=2R</b> — stranica i nasuprotni kut.</span></li>
    <li class="mi"><div class="mi-dot"></div><span><b>Obodni kut = ½ središnjeg</b> · kut nad promjerom 90°.</span></li>
  </ul></div>
  ...
  <div class="cn-grid">
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge c">P09</span><span class="cn-item-title">Trigonometrija</span></div><div class="cn-item-desc">sin, cos, tan u poučcima i površini trokuta.</div><div class="cn-item-arrow">→ sinusov i kosinusov poučak</div></div>
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge i">P10</span><span class="cn-item-title">Analitička geometrija</span></div><div class="cn-item-desc">Kružnica i pravac u koordinatama — algebarski pristup planimetriji.</div><div class="cn-item-arrow">→ jednadžba kružnice</div></div>
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge i">P11</span><span class="cn-item-title">Geometrija prostora</span></div><div class="cn-item-desc">Plohe tijela su ravninski likovi — površine se računaju planimetrijski.</div><div class="cn-item-arrow">→ oplošje tijela</div></div>
    <div class="cn-item"><div class="cn-item-head"><span class="cn-badge a">P12</span><span class="cn-item-title">Vektori</span></div><div class="cn-item-desc">Površina trokuta preko vektorskog produkta ½|AB×AC|.</div><div class="cn-item-arrow">→ vektorski pristup</div></div>
  </div>
  </div>
  <div class="slbl" style="margin-top:28px">// formule za kraj — brzi podsjetnik</div>
  <div class="con" style="margin-bottom:20px">
    <div class="cr"><div class="ck b">Trokut</div><div class="cv">α+β+γ=180°. P=½·a·vₐ=½·a·b·sinγ=√(s(s−a)(s−b)(s−c)), s=O/2.</div></div>
    <div class="cr"><div class="ck c">Pravokutni trokut</div><div class="cv">a²+b²=c² (c hipotenuza). sinα=a/c, cosα=b/c, tanα=a/b.</div></div>
    <div class="cr"><div class="ck i">Sinusov poučak</div><div class="cv">a/sinα=b/sinβ=c/sinγ=2R (R polumjer opisane kružnice).</div></div>
    <div class="cr"><div class="ck a">Kosinusov poučak</div><div class="cv">c²=a²+b²−2ab·cosγ → cosγ=(a²+b²−c²)/(2ab).</div></div>
    <div class="cr"><div class="ck r">Kružnica</div><div class="cv">O=2rπ, P=r²π, l=rφ, Pisječka=½r²φ. Obodni kut=½ središnji; nad promjerom 90°.</div></div>
  </div>
...
<div class="layer" id="l2">
  ...
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">01 · opseg kružnice</div><div class="fitb-sent">Opseg kružnice polumjera r=7 = ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi1" type="text" placeholder="O=?" autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi1','f1f','14π','ud2')">Provjeri</button></div><div class="fitb-fb" id="f1f"></div></div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">02 · površina trokuta</div><div class="fitb-sent">P trokuta s a=10, vₐ=6 = ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi2" type="text" placeholder="P=?" autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi2','f2f','30','kru2')">Provjeri</button></div><div class="fitb-fb" id="f2f"></div></div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">03 · Pitagora</div><div class="fitb-sent">Hipotenuza za katete 6 i 8 = ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi3" type="text" placeholder="c=?" autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi3','f3f','10','tan2')">Provjeri</button></div><div class="fitb-fb" id="f3f"></div></div>
  <div class="fitb"><div class="fitb-h"><div class="fitb-meta">04 · obodni kut</div><div class="fitb-sent">Obodni kut ako je središnji 120° = ___</div></div><div class="fitb-row"><input class="fitb-in" id="fi4" type="text" placeholder="kut=?" autocomplete="off" spellcheck="false"><button class="fitb-btn" onclick="chkf('fi4','f4f','60','ud3')">Provjeri</button></div><div class="fitb-fb" id="f4f"></div></div>
  <!-- sr4 — line-circle intersection -->
  <div class="sr" id="sr4" style="margin-top:11px">
    <div class="sr-head">
      <div class="sr-title">Riješeni primjer — površina i opisana kružnica</div>
      <div class="sr-task">U trokutu je b=8, c=6 i kut α=60° (između b i c). Nađi stranicu a i površinu.</div>
    </div>
    <div class="sr-steps">
      <div class="sr-step" id="sr4s1"><div class="sr-step-in"><div class="sr-num">1</div><div class="sr-body"><div class="sr-stitle">Kosinusov poučak za a</div><div class="sr-txt">a² = b²+c²−2bc·cosα = 64+36−2·8·6·cos60° = 100−96·½ = 100−48 = 52 → a = √52 = 2√13</div></div></div></div>
      <div class="sr-step" id="sr4s2"><div class="sr-step-in"><div class="sr-num">2</div><div class="sr-body"><div class="sr-stitle">Površina preko sinusa</div><div class="sr-txt">P = ½·b·c·sinα = ½·8·6·sin60° = 24·(√3/2) = 12√3</div></div></div></div>
      <div class="sr-step" id="sr4s3"><div class="sr-step-in"><div class="sr-num">3</div><div class="sr-body"><div class="sr-stitle">Rezultat</div><div class="sr-txt">a = 2√13 ≈ 7,21, &nbsp; P = 12√3 ≈ <strong>20,8</strong></div></div></div></div>
    </div>
    <div class="sr-foot">
...
function sw(i){
  ...
  try{sessionStorage.setItem('p13_tab',i);}catch(e){}
}
function calcTri(){var a=parseFloat(document.getElementById('tri-a').value),b=parseFloat(document.getElementById('tri-b').value),c=parseFloat(document.getElementById('tri-c').value);var r=document.getElementById('tri-result');if([a,b,c].some(isNaN)||a<=0||b<=0||c<=0){r.innerHTML='<span style="color:var(--red)">Upiši pozitivne stranice.</span>';return;}if(a+b<=c||a+c<=b||b+c<=a){r.innerHTML='<span style="color:var(--red)">Nejednakost trokuta nije zadovoljena — takav trokut ne postoji.</span>';return;}var fmt=function(v){return Math.round(v*1000)/1000;};var sp=(a+b+c)/2;var P=Math.sqrt(sp*(sp-a)*(sp-b)*(sp-c));r.innerHTML='Opseg O = '+fmt(a+b+c)+'<br>Poluopseg s = '+fmt(sp)+'<br>Površina (Heron) P = √('+fmt(sp)+'·'+fmt(sp-a)+'·'+fmt(sp-b)+'·'+fmt(sp-c)+') = <strong>'+fmt(P)+'</strong>';}
function calcLaw(){var a=parseFloat(document.getElementById('law-a').value),b=parseFloat(document.getElementById('law-b').value),g=parseFloat(document.getElementById('law-g').value);var r=document.getElementById('law-result');if([a,b,g].some(isNaN)){r.innerHTML='<span style="color:var(--red)">Upiši a, b i kut γ (°).</span>';return;}var fmt=function(v){return Math.round(v*1000)/1000;};var c2=a*a+b*b-2*a*b*Math.cos(g*Math.PI/180);var c=Math.sqrt(Math.max(0,c2));var P=0.5*a*b*Math.sin(g*Math.PI/180);r.innerHTML='c² = '+fmt(a*a)+'+'+fmt(b*b)+'−2·'+fmt(a)+'·'+fmt(b)+'·cos'+fmt(g)+'° = '+fmt(c2)+'<br>c = <strong>'+fmt(c)+'</strong><br>Površina P = ½·a·b·sinγ = <strong>'+fmt(P)+'</strong>';}
var stepSt={};
...
var tryExp={ud1:'P=½·a·vₐ=½·8·5=20. Ne zaboravi faktor ½!',kru1:'c²=a²+b²−2ab·cosγ=25+9−2·5·3·cos60°=34−15=19 → c=√19≈4,36.',tan1:'Obodni kut = ½ središnjeg = ½·100° = 50°.'};
...
var drData=[
  {q:'Zbroj unutarnjih kutova trokuta je 180°',ans:true,tag:'trokut',exp:'Točno! α+β+γ=180° u svakom trokutu ✓'},
  {q:'Površina trokuta je a·vₐ',ans:false,tag:'trokut',exp:'Netočno! P=½·a·vₐ — ne zaboravi faktor ½.'},
  {q:'U pravokutnom trokutu vrijedi a²+b²=c²',ans:true,tag:'pitagora',exp:'Točno! Pitagorin poučak, c je hipotenuza ✓'},
  {q:'Obodni kut je dvostruko veći od središnjeg',ans:false,tag:'obodni',exp:'Netočno! Obodni kut je POLOVICA središnjeg nad istim lukom.'},
  {q:'Kut nad promjerom kružnice je 90°',ans:true,tag:'obodni',exp:'Točno! Talesov poučak ✓'},
  {q:'Opseg kružnice je r²π',ans:false,tag:'kruznica',exp:'Netočno! Opseg je 2rπ; r²π je POVRŠINA kruga.'},
  {q:'Heronova formula: P=√(s(s−a)(s−b)(s−c))',ans:true,tag:'trokut',exp:'Točno! s=O/2 je poluopseg ✓'},
  {q:'Kosinusov poučak: c²=a²+b²−2ab·cosγ',ans:true,tag:'kosinusov',exp:'Točno! Za γ=90° daje Pitagoru ✓'},
  {q:'Sinusov poučak glasi a·sinα=b·sinβ',ans:false,tag:'sinusov',exp:'Netočno! Glasi a/sinα = b/sinβ (omjeri, ne umnošci).'},
  {q:'U jednakostraničnom trokutu svi kutovi su 60°',ans:true,tag:'trokut',exp:'Točno! 180°/3=60° ✓'},
  {q:'Površina kruga polumjera r je r²π',ans:true,tag:'kruznica',exp:'Točno! P=r²π ✓'},
  {q:'Dijagonale romba sijeku se pod pravim kutom',ans:true,tag:'trokut',exp:'Točno! Dijagonale romba su okomite i raspolavljaju se ✓'}
];
...
var bugDone={};var bugExp={b1:'✓ Točno! P=½·a·vₐ=½·10·6=30, ne 10·6=60. Faktor ½ je obavezan!',b2:'✓ Točno! c²=a²+b²=6²+8²=100 → c=10. Hipotenuza nije a+b=14!',b3:'✓ Točno! Obodni kut = ½ središnjeg. Za središnji 120° → obodni 60°, ne 240°.'};
...
var icpAnswered={};var icpFeedback={
  icp1:{q1:{ok:'✓ Točno! γ=180°−70°−60°=50°.',ng:'✗ Netočno. α+β+γ=180° → γ=180−70−60=50°.'},q2:{ok:'✓ Točno! P=½·a·vₐ=½·12·5=30.',ng:'✗ Netočno. P=½·12·5=30 (faktor ½!).'},q3:{ok:'✓ Točno! c=√(5²+12²)=√169=13.',ng:'✗ Netočno. c²=25+144=169 → c=13.'}},
  icp2:{q1:{ok:'✓ Točno! c²=a²+b²−2ab·cosγ=16+9−2·4·3·½=13 → c=√13.',ng:'✗ Netočno. c²=16+9−24·cos60°=25−12=13.'},q2:{ok:'✓ Točno! b=a·sinβ/sinα.',ng:'✗ Netočno. Sinusov poučak: a/sinα=b/sinβ → b=a·sinβ/sinα.'},q3:{ok:'✓ Točno! P=½·a·b·sinγ.',ng:'✗ Netočno. Površina preko sinusa: P=½·a·b·sinγ.'}},
  icp3:{q1:{ok:'✓ Točno! O=2rπ=2·6·π=12π.',ng:'✗ Netočno. Opseg je 2rπ=12π.'},q2:{ok:'✓ Točno! P=r²π=4²π=16π.',ng:'✗ Netočno. Površina kruga je r²π=16π.'},q3:{ok:'✓ Točno! Obodni = ½ središnjeg = 45°.',ng:'✗ Netočno. Obodni kut je polovica središnjeg: 90°/2=45°.'}}
};
...
var topicErrors={trokut:0,pitagora:0,poucci:0,kruznica:0};
var topicHints={trokut:'Greške s trokutom! Kutovi 180°, površina P=½·a·vₐ (faktor ½!), Heron P=√(s(s−a)(s−b)(s−c)).',pitagora:'Greške s Pitagorom! a²+b²=c², c je hipotenuza. Hipotenuza nije a+b!',poucci:'Greške s poučcima! Sinusov: a/sinα=b/sinβ. Kosinusov: c²=a²+b²−2ab·cosγ.',kruznica:'Greške s kružnicom! Opseg O=2rπ, površina P=r²π. Obodni kut = ½ središnjeg.'};
var qTopics={q1:'trokut',q2:'trokut',q3:'pitagora',q4:'trokut',q5:'poucci',q6:'poucci',q7:'kruznica',q8:'kruznica',q9:'kruznica',q10:'kruznica',q11:'trokut',q12:'poucci'};
var ncvvoTopicMap={'nlive-ud':['q1','q2','q4'],'nlive-kru':['q3','q11','q12'],'nlive-tan':['q5','q6'],'nlive-sj':['q7','q8','q9']};
...
var ALL_QUESTIONS=[
  {id:'q1',topic:'trokut',meta:'zbroj kutova u trokutu',text:'Dva kuta trokuta su 50° i 60°. Treći kut je:',opts:[{t:'70°',ok:true},{t:'80°',ok:false},{t:'110°',ok:false},{t:'60°',ok:false}],c:'✓ Točno. 180°−50°−60°=70°.',w:'✗ Netočno. Zbroj kutova je 180°: 180−50−60=70°.',proof:['α+β+γ=180°','γ=180−50−60','=70°']},
  {id:'q2',topic:'trokut',meta:'površina trokuta',text:'Površina trokuta s a=6 i pripadnom visinom vₐ=4 je:',opts:[{t:'12',ok:true},{t:'24',ok:false},{t:'10',ok:false},{t:'48',ok:false}],c:'✓ Točno. P=½·6·4=12.',w:'✗ Netočno. P=½·a·vₐ=½·6·4=12 (ne zaboravi ½!).',proof:['P=½·a·vₐ','=½·6·4','=12']},
  {id:'q3',topic:'pitagora',meta:'Pitagorin poučak',text:'Katete pravokutnog trokuta su 3 i 4. Hipotenuza je:',opts:[{t:'5',ok:true},{t:'7',ok:false},{t:'√7',ok:false},{t:'12',ok:false}],c:'✓ Točno. c=√(9+16)=√25=5.',w:'✗ Netočno. c²=a²+b²=9+16=25 → c=5.',proof:['c²=a²+b²=3²+4²','=9+16=25','c=5']},
  {id:'q4',topic:'trokut',meta:'A razina · Heronova formula',text:'Površina trokuta sa stranicama 3, 4, 5 je:',opts:[{t:'6',ok:true},{t:'12',ok:false},{t:'10',ok:false},{t:'7,5',ok:false}],c:'✓ Točno. s=6, P=√(6·3·2·1)=√36=6.',w:'✗ Netočno. s=(3+4+5)/2=6; P=√(6·3·2·1)=6.',proof:['s=(3+4+5)/2=6','P=√(6·3·2·1)=√36','=6']},
  {id:'q5',topic:'kosinusov',meta:'kosinusov poučak',text:'Za a=5, b=8, γ=60° stranica c je:',opts:[{t:'7',ok:true},{t:'√89',ok:false},{t:'13',ok:false},{t:'√39',ok:false}],c:'✓ Točno. c²=25+64−2·5·8·½=49 → c=7.',w:'✗ Netočno. c²=a²+b²−2ab·cosγ=89−40=49 → c=7.',proof:['c²=25+64−2·5·8·cos60°','=89−40=49','c=7']},
  {id:'q6',topic:'sinusov',meta:'sinusov poučak',text:'Za a=10, α=30°, β=90° stranica b je:',opts:[{t:'20',ok:true},{t:'10',ok:false},{t:'5',ok:false},{t:'10√3',ok:false}],c:'✓ Točno. b=a·sinβ/sinα=10·1/0,5=20.',w:'✗ Netočno. a/sinα=b/sinβ → b=10·sin90°/sin30°=10/0,5=20.',proof:['a/sinα=b/sinβ','b=10·sin90°/sin30°','=10/0,5=20']},
  {id:'q7',topic:'kruznica',meta:'opseg kružnice',text:'Opseg kružnice polumjera r=5 je:',opts:[{t:'10π',ok:true},{t:'25π',ok:false},{t:'5π',ok:false},{t:'2,5π',ok:false}],c:'✓ Točno. O=2rπ=10π.',w:'✗ Netočno. Opseg je O=2rπ=2·5·π=10π (r²π je površina!).',proof:['O=2rπ','=2·5·π','=10π']},
  {id:'q8',topic:'kruznica',meta:'površina kruga',text:'Površina kruga polumjera r=3 je:',opts:[{t:'9π',ok:true},{t:'6π',ok:false},{t:'3π',ok:false},{t:'18π',ok:false}],c:'✓ Točno. P=r²π=9π.',w:'✗ Netočno. P=r²π=3²π=9π (2rπ je opseg!).',proof:['P=r²π','=3²π','=9π']},
  {id:'q9',topic:'obodni',meta:'obodni i središnji kut',text:'Središnji kut nad lukom je 80°. Obodni kut nad istim lukom je:',opts:[{t:'40°',ok:true},{t:'160°',ok:false},{t:'80°',ok:false},{t:'20°',ok:false}],c:'✓ Točno. Obodni = ½ središnjeg = 40°.',w:'✗ Netočno. Obodni kut = ½ središnjeg = 80°/2 = 40°.',proof:['obodni = ½ · središnji','=½·80°','=40°']},
  {id:'q10',topic:'obodni',meta:'A razina · Talesov poučak',text:'Obodni kut nad promjerom kružnice iznosi:',opts:[{t:'90°',ok:true},{t:'180°',ok:false},{t:'45°',ok:false},{t:'60°',ok:false}],c:'✓ Točno. Talesov poučak: kut nad promjerom je pravi (90°).',w:'✗ Netočno. Promjer = središnji kut 180° → obodni = ½·180° = 90° (Tales).',proof:['Promjer ↔ središnji kut 180°','obodni = ½·180°','=90°']},
  {id:'q11',topic:'trokut',meta:'A razina · površina preko sinusa',text:'Površina trokuta s a=6, b=8, γ=30° je:',opts:[{t:'12',ok:true},{t:'24',ok:false},{t:'48',ok:false},{t:'6',ok:false}],c:'✓ Točno. P=½·a·b·sinγ=½·6·8·½=12.',w:'✗ Netočno. P=½·a·b·sinγ=½·6·8·sin30°=½·48·½=12.',proof:['P=½·a·b·sinγ','=½·6·8·sin30°','=24·½=12']},
  {id:'q12',topic:'kosinusov',meta:'A razina · najveći kut',text:'U trokutu a=7, b=8, c=9 kosinus kuta γ (nasuprot c) je:',opts:[{t:'2/7',ok:true},{t:'1/2',ok:false},{t:'0',ok:false},{t:'3/8',ok:false}],c:'✓ Točno. cosγ=(49+64−81)/(2·7·8)=32/112=2/7.',w:'✗ Netočno. cosγ=(a²+b²−c²)/(2ab)=(49+64−81)/112=32/112=2/7.',proof:['cosγ=(a²+b²−c²)/(2ab)','=(49+64−81)/(2·7·8)','=32/112=2/7']}
];
var FExp={ud2:'Opseg O=2rπ=2·7·π=14π.',kru2:'P=½·a·vₐ=½·10·6=30.',tan2:'c=√(6²+8²)=√100=10 — trojka 6-8-10.',ud3:'Obodni kut = ½ središnjeg = ½·120° = 60°.'};
...
(function(){try{var s=sessionStorage.getItem('p13_tab');if(s!==null){var i=parseInt(s);if(i>=0&&i<=2)sw(i);}}catch(e){}})();

/* ── RESTORE PROGRESS (localStorage) ── */
(function(){try{var saved=localStorage.getItem('maturiraj_p13_prog');if(saved!==null){var pct=parseInt(saved);if(pct>0){var bar=document.getElementById('prog-bar');var lbl=document.getElementById('prog-pct');if(bar)bar.style.width=pct+'%';if(lbl)lbl.textContent=pct+'%';}}}catch(e){}})(  );
...
const meta = {id:'P13',pidLower:'p13',title:"Maturiraj.hr \u2014 Mat A \u00b7 P13 \u00b7 Planimetrija",subject:'matematika-a',lsKey:'maturiraj_p13_prog'};
...
function mount(container,options={}){
  ...
  try{new Function(js)();}catch(e){console.error('[P13] Script error:',e);}
  _mounted=true;
}
function unmount(container){
  const ex=document.querySelector('style[data-chapter="p13"]');
  if(ex)ex.remove();
  _styleEl=null;
  if(container)container.innerHTML='';
  _mounted=false;
}
function getProgress(){try{return parseInt(localStorage.getItem('maturiraj_p13_prog')||'0');}catch(e){return 0;}}
function setProgress(pct){try{localStorage.setItem('maturiraj_p13_prog',String(pct));}catch(e){}}
