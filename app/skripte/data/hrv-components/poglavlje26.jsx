/**
 * H26 — H26 · Interpunkcija | Maturiraj.hr · zarez · crtica · navodnici
 * Auto-generated from Maturiraj_Hrvatski_H26.html
 * 
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item" aria-current="page" data-code="h26" href="/skripte/hrv/h26"><span class="sb-dot"></span>H26 · Interpunkcija</a>
  ...
  <div class="sb-footer" id="sb-footer">
    <span id="sb-footer-pos">26 / 28</span> · <span id="sb-footer-title">interpunkcija</span>
...
<div class="content-wrap">
  ...
  <div class="bc">
    ...
    <span class="bc-cur">H26 · Interpunkcija</span>
  ...
  <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:20px">
    ...
    <button type="button" class="fcb" onclick="navigator.share?navigator.share({title:'H26 · Interpunkcija',url:window.location.href}):navigator.clipboard.writeText(window.location.href)" style="font-size:10px" title="Podijeli">📤 Dijeli</button>
  ...
  <!-- HERO -->
  <header class="hero">
    <div class="hero-chapter">H26 &nbsp;·&nbsp; Jezikoslovlje &nbsp;·&nbsp; Interpunkcija</div>
    <h1 class="hero-title">Interpunkcija<br><span>zarez · crtica · navodnici · dvotočje</span></h1>
    <p class="hero-sub">
      <strong>Sustavni vodič kroz interpunkciju hrvatskoga standardnog jezika.</strong> <em>Zarez</em> — 8 pravila (ispred „a, ali, no, nego, jer, da, koji", vokativ, apozicija), <em>crtica vs spojnica</em>, <em>navodnici „..."</em>, <em>dvotočje, uskličnik, upitnik, točkica, zagrade</em>. <strong>20 najčešćih interpunkcijskih grešaka</strong>, <em>Brzi interpunkcija drill</em> — 200 pitanja, <em>Scanner rečenice</em>, <em>Referentna tablica</em>. <strong>Interpunkcija = dio pravopisa = 20% maturalnih bodova.</strong>
    </p>
    <div class="hero-chips">
        <span class="pill p-pa hchip">📖 Teorija</span>
        <span class="pill p-br hchip">⭐ Zarez (8 pravila)</span>
        <span class="pill p-pa hchip">— Crtica · spojnica</span>
        <span class="pill p-br hchip">„ Navodnici</span>
        <span class="pill p-pa hchip">🔧 Proofreading (20 rečenica)</span>
      </div>
  </header>
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button type="button" class="tab" id="tab1" onclick="sw(1)" role="tab" aria-selected="false" aria-controls="l1">⭐ Zarez (8 pravila)<span class="tab-done" id="td1"></span></button>
    <button type="button" class="tab" id="tab2" onclick="sw(2)" role="tab" aria-selected="false" aria-controls="l2">— Crtica vs -<span class="tab-done" id="td2"></span></button>
    <button type="button" class="tab" id="tab3" onclick="sw(3)" role="tab" aria-selected="false" aria-controls="l3">„ Navodnici<span class="tab-done" id="td3"></span></button>
    ...
    <button type="button" class="tab" id="tab5" onclick="sw(5)" role="tab" aria-selected="false" aria-controls="l5">🔧 Proofreading<span class="tab-done" id="td5"></span></button>
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div class="diag-wrap" id="diag0" data-state="intro">
      ...
      <div class="diag-intro">
        ...
        <div class="diag-intro-desc">10 pitanja · ~3 min · provjeri koliko znaš interpunkciju prije učenja.</div>
      ...
      <div class="diag-quiz">
        <div class="diag-header">
          <div class="diag-lbl">Interpunkcija — dijagnostika</div>
    ...
    <!-- ═══════════════════════════════════
         20 NAJČEŠĆIH NCVVO GREŠAKA · INTERPUNKCIJA
    ═══════════════════════════════════ -->
    ...
    <div style="padding:14px 16px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--red)">Interpunkcija je 20-25% pravopisnih bodova na NCVVO.</strong> Najčešće greške su zarez (suprotni veznici, apozicija, zavisne rečenice) i navodnici. Pogledaj prije mature.
      </div>
    </div>
    ...
    <div style="display:grid;gap:8px;margin:16px 0">
      ...
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">1.</span>Zarez ispred „a, ali, no, nego" ⭐</summary>
        <div class="ncvvo-body">Suprotni veznici UVIJEK imaju zarez prije: „Volim ga<strong>,</strong> ali se ljutim.", „Ne idem<strong>,</strong> nego ostajem.", „On je dobar<strong>,</strong> a ja loš." Pamti mnemotehniku: <strong>A-ALI-NO-NEGO = ZAREZ</strong>.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">2.</span>Apozicija odvaja zarezima s OBJE strane ⭐</summary>
        <div class="ncvvo-body">Apozicija (pojašnjenje uz imenicu): „Marko<strong>,</strong> moj prijatelj<strong>,</strong> došao je." Mora biti zarez ISPRED i IZA. Najčešća greška: studenti zaborave drugi zarez.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">3.</span>Zavisna rečenica na POČETKU — zarez nakon nje ⭐</summary>
        <div class="ncvvo-body">Kad zavisna rečenica (kad, ako, jer, dok) dolazi na početku: „Kad dođem<strong>,</strong> javit ću ti.„ Ali ako je iza glavne, NEMA zarez: „Javit ću ti kad dođem."</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">4.</span>Vokativ — zarez nakon imena ⭐</summary>
        <div class="ncvvo-body">Oslovljavanje: „Marko<strong>,</strong> dođi ovamo!", „Bože<strong>,</strong> pomozi mi!", „Dragi prijatelji<strong>,</strong> hvala vam." UVIJEK zarez nakon vokativa.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">5.</span>Umetnute riječi — zarez s obje strane</summary>
        <div class="ncvvo-body">„međutim, naime, dakle, primjerice, naprotiv" — odvajaju se zarezima: „On<strong>,</strong> međutim<strong>,</strong> nije došao." Iznimka: ako su na samom početku — samo iza („Međutim<strong>,</strong> on nije došao.").</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">6.</span>Direktan govor — DVOTOČJE, ne zarez ⭐</summary>
        <div class="ncvvo-body">„Marko reče<strong>:</strong> „Idem kući.“" — UVIJEK dvotočje prije citata. NE zarez. Često greška: studenti pišu zarez umjesto dvotočja.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">7.</span>Crtica „—„ vs spojnica „-" ⭐</summary>
        <div class="ncvvo-body"><strong>Crtica „—"</strong> (em-dash, dugačka) za umetanje, dijalog: „Marko — moj prijatelj — došao je." <strong>Spojnica „-"</strong> (hyphen, kratka) za složenice, brojeve: „crno-bijeli", „2-3 dana", „srpsko-hrvatski". RAZLIKA u dužini!</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">8.</span>Hrvatski navodnici „...„ (NE engleski "...") ⭐</summary>
        <div class="ncvvo-body">Hrvatski standard: <strong>„dolje gore"</strong> oblik. Engleski navodnici "..." nisu hrvatski standard. U hrvatskom: <strong>„Marko reče: 'Idem kući.'"</strong> — vanjski dvostruki, unutarnji jednostruki.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">9.</span>„i, pa, te" obično NEMAJU zarez ⭐</summary>
        <div class="ncvvo-body">Sastavni veznici „i, pa, te, ni, niti" obično NEMAJU zarez prije: „Idem kući i učim." Iznimka: u nabrajanju duljih cjelina ili kad slijedi umetnuta rečenica.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">10.</span>Nabrajanje — zarezi između elemenata ⭐</summary>
        <div class="ncvvo-body">„Kupio sam kruh<strong>,</strong> mlijeko<strong>,</strong> jaja i sir.„ — zarez između svakog elementa, ali NE prije zadnjeg „i" (Oxford zarez nije obavezan u hrvatskom).</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">11.</span>Dvotočje (:) za pojašnjenje, popis, citat</summary>
        <div class="ncvvo-body">„Razlog je jasan<strong>:</strong> nema vremena.", „Donijeti<strong>:</strong> kruh, jaja, mlijeko.", „Rekao je<strong>:</strong> „Idem.""</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">12.</span>Točka-zarez (;) — povezani, ali odvojeni dijelovi</summary>
        <div class="ncvvo-body">Jače od zareza, slabije od točke. „Volim ga<strong>;</strong> nije savršen, ali je moj." Često u dugim popisima ili u suprotstavljenim cjelinama.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">13.</span>Trotočje (...) — nedovršena misao</summary>
        <div class="ncvvo-body">Naznačuje izostavljanje, prekid misli, neizgovoreno: „Mislim...„ ili „I zatim... ništa." NE koristiti za dramske efekte u svakoj rečenici!</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">14.</span>Zarez ispred „što" — kompleksno</summary>
        <div class="ncvvo-body">„Što" kao odnosna zamjenica može imati ili nemati zarez. „Knjiga<strong>,</strong> koju sam pročitao<strong>,</strong> bila je odlična.„ (umetnuta — zarez). „Knjiga koju sam pročitao bila je odlična." (restriktivna — bez zareza).</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">15.</span>Zarez ispred „nego" — UVIJEK ⭐</summary>
        <div class="ncvvo-body">„Nego" je suprotni veznik — uvijek zarez prije: „Ne idem<strong>,</strong> nego ostajem.", „Bolje danas<strong>,</strong> nego sutra."</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">16.</span>Zarez ispred „kao" — NE ⭐</summary>
        <div class="ncvvo-body">„Kao" obično NE traži zarez: „Plavi kao nebo.„ Iznimka: kad je „kao" dio umetnute usporedbe ili apozicije: „Marko<strong>,</strong> kao moj prijatelj<strong>,</strong> uvijek pomaže."</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">17.</span>Zagrade () — umetnuta pojašnjenja</summary>
        <div class="ncvvo-body">„Zagreb (glavni grad RH) ima 800 000 stanovnika." Zagrade alternativa zarezima/crticama za umetanja. Mekša interpunkcija.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">18.</span>Skraćenice — točka iza, ne zarez</summary>
        <div class="ncvvo-body">„g.„ (gospodin), „dr." (doktor), „npr." (na primjer) — TOČKA iza skraćenice. Ne miješaj s drugim znakovima.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">19.</span>Zarez kod priloga vremena/mjesta</summary>
        <div class="ncvvo-body">Prilozi vremena/mjesta na početku obično NEMAJU zarez (kratki): „Sutra idem u školu." Ali duži prilozi: „Sljedećeg utorka<strong>,</strong> oko 14 sati<strong>,</strong> sastat ćemo se."</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">20.</span>SUVIŠNI zarezi — ne stavljaj „za svaki slučaj" ⭐</summary>
        <div class="ncvvo-body">Najveća greška: studenti stavljaju zarez gdje ne treba („Marko, je došao.„, „On, mi je rekao."). NE stavljaj zarez između subjekta i predikata. PRAVILO: zarez ima konkretnu funkciju — ako ne znaš zašto, izostavi.</div>
      </details>
      
    </div><div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🧠 Mnemotehnike · za brzo pamćenje</div><div class="sec-line"></div></div>
    ...
    <div style="padding:18px;background:linear-gradient(135deg,rgba(233,180,70,.06),transparent);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.7;color:var(--t2);font-family:var(--serif)">
        Interpunkcija ima 6 glavnih znakova — svaki s vlastitom funkcijom. Ovi trikovi ti uče najteže pravila u 5 minuta.
      </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:10px;margin:16px 0">
      ...
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">A-ALI-NO-NEGO ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Suprotni veznici</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Suprotni veznici UVIJEK imaju zarez prije.</strong> Pamti: A-ALI-NO-NEGO = zarez ide.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">I-PA-TE = NEMA</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Sastavni veznici</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Sastavni veznici (i, pa, te) NEMAJU zarez.</strong> „Idem kući i učim." (bez zareza).
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">SENDVIČ APOZICIJA ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Apozicija pravilo</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Apozicija = sendvič — zarez s OBJE strane. „Marko<strong>,</strong> moj prijatelj<strong>,</strong> ..." Pamti: bez drugog zareza je SAMO POLA SENDVIČA.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">ZAVISNA NA POČETKU = ZAREZ</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Pozicija zavisne</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          „Kad dođem<strong>,</strong> javit ću ti.„ (zavisna prva — zarez). „Javit ću ti kad dođem." (glavna prva — bez zareza).
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">DIREKTAN GOVOR = DVOTOČJE</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Citat pravilo</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          „Rekao je<strong>:</strong> „Idem."" — uvijek <strong>dvotočje</strong>, NIKAD zarez. NE „Rekao je, „Idem""!
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">CRTICA ≠ SPOJNICA ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">— vs -</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Crtica „—" duga</strong> = umetanje („Marko — prijatelj — ..."). <strong>Spojnica „-" kratka</strong> = složenice („crno-bijeli"). Razlika u DUŽINI.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">VOKATIV = ZAREZ</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Oslovljavanje</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          „Marko<strong>,</strong> dođi!", „Bože<strong>,</strong> pomozi!" — vokativ (oslovljavanje) UVIJEK ima zarez.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">HRVATSKI „...„ NE "..."</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Navodnici</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Hrvatski standard: „dolje gore" („...„). NE engleski "...". Pamti: dolje + gore.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">NABRAJANJE = ZAREZ</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Popisi</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          „kruh<strong>,</strong> mlijeko<strong>,</strong> jaja i sir.„ — zarez između, NE prije zadnjeg „i".
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">SUVIŠNI ≠ ISPRAVAN ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Pravilo sumnje</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Ako sumnjaš da treba zarez — VJEROJATNO NE TREBA. Bolje izostaviti nego dodati suvišni („Marko, je došao." je POGREŠNO).
        </div>
      </div>
    ...
    <div class="nav-row" style="justify-content:flex-end">
      <span class="nb-btn primary" onclick="sw(1)">⭐ Zarez (8 pravila) →</span>
    </div>
    ...
    <div class="cheat-card" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Tab 1 · Zarez — 8 pravila</div>
        </div>
      </div>
      <div class="cheat-grid">
        <div class="cheat-col cheat-col-wide" style="font-family:var(--serif,Fraunces,serif);font-size:13.5px;color:var(--t2,#c5b8aa);line-height:1.65">
          <p style="margin:0">Sad kad znaš pravila interpunkcije — <b>Tab 1</b> donosi najproblematičniju interpunkciju: zarez. 8 ključnih pravila s primjerima.</p>
        </div>
      </div>
    </div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">⭐ Zarez (8 pravila)</span>
      <span class="pill p-br hchip">📚 NCVVO TOP-tema</span>
      <span class="pill p-pa hchip">⚠️ Anti-pravila</span>
    </div>

    <!-- ─────────────── PREGLED ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">⭐ Zarez · 8 glavnih pravila</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">⭐ Zašto je zarez NAJTEŽI dio interpunkcije</div>
      <div class="box-int-txt">
        Zarez čini <strong>~80% interpunkcijskih grešaka</strong> na maturi. Ima <strong>8 glavnih pravila</strong> kad ide + nekoliko anti-pravila kad NE ide. Naučiš li ovih 8 + svjesno izbjegavaš suvišne — pravopisni dio mature je riješen.
      </div>
    </div>
    ...
    <div style="margin:18px 0;padding:14px 18px;background:linear-gradient(135deg,rgba(233,180,70,.08),rgba(74,144,217,.04));border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2);display:flex;align-items:center;gap:14px;flex-wrap:wrap">
      ...
      <div style="flex:1;min-width:200px">
        <div style="font-family:var(--display);font-size:14.5px;font-weight:700;color:var(--t1);margin-bottom:3px">Naučio teoriju? Vježbaj kao lektor.</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.5">U <strong style="color:var(--gold)">Proofreading mode</strong> dobiješ rečenice bez interpunkcije — klikni gdje misliš da treba zarez. Realnije od kviza.</div>
      </div>
      <button type="button" class="nb-btn primary" onclick="sw(6)" style="flex-shrink:0">Otvori Proofreading →</button>
    </div>

    <!-- ─────────────── SVAKO PRAVILO DUBOKO ─────────────── -->
    
    <!-- PRAVILO 1: NABRAJANJE -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">1. Nabrajanje</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo</div>
      <div class="pravilo-desc">
        Zarez odvaja <strong>elemente nabrajanja</strong> (riječi, izraze, rečenice). NE stavlja se prije zadnjeg „i" (Oxford zarez nije obavezan u hrvatskom).
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„Kupio sam <strong>kruh, mlijeko, jaja</strong> i sir."</li>
        <li>„Volim <strong>čitati, pisati i učiti</strong>."</li>
        <li>„Knjiga je <strong>poučna, zanimljiva, kratka</strong>."</li>
        <li>„Idem u <strong>Zagreb, Split, Rijeku</strong> i Osijek."</li>
        <li>„Crveno, plavo, zeleno — to su moje boje."</li>
      </ul>
      
      <div class="ex-label-no">❌ POGREŠNO</div>
      <ul class="list-mono-int">
        <li>„Kupio sam kruh mlijeko jaja i sir." (bez zareza)</li>
        <li>„Kupio sam kruh, mlijeko, jaja, i sir.„ (suvišni zarez prije zadnjeg „i")</li>
      </ul>
    </div>

    <!-- PRAVILO 2: SUPROTNI VEZNICI -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">2. Suprotni veznici (a, ali, no, nego, već) ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo · A-ALI-NO-NEGO</div>
      <div class="pravilo-desc">
        Suprotni veznici (<strong>a, ali, no, nego, već</strong>) <strong>UVIJEK</strong> imaju zarez prije sebe. Pamti: <strong>A-ALI-NO-NEGO = ZAREZ</strong>.
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„Volim ga<strong>,</strong> ali se ljutim."</li>
        <li>„Ne idem<strong>,</strong> nego ostajem."</li>
        <li>„Pričekaj<strong>,</strong> a onda kreni."</li>
        <li>„Bilo je teško<strong>,</strong> no uspio sam."</li>
        <li>„Nije ovo radio<strong>,</strong> već nešto drugo."</li>
      </ul>
      
      <div class="ex-label-no">❌ POGREŠNO</div>
      <ul class="list-mono-int">
        <li>„Volim ga ali se ljutim." (nema zareza)</li>
        <li>„Ne idem nego ostajem." (nema zareza)</li>
      </ul>
    </div>

    <!-- PRAVILO 3: APOZICIJA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">3. Apozicija — sendvič od zareza ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo · sendvič</div>
      <div class="pravilo-desc">
        Apozicija je <strong>pojašnjenje uz imenicu</strong>. Odvaja se zarezima s <strong>OBJE strane</strong> (sendvič). Najčešća greška: studenti zaborave drugi zarez.
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„Marko<strong>,</strong> moj prijatelj<strong>,</strong> došao je."</li>
        <li>„Zagreb<strong>,</strong> glavni grad RH<strong>,</strong> ima 800 000 stanovnika."</li>
        <li>„Rijeka Sava<strong>,</strong> najduža u Hrvatskoj<strong>,</strong> izvire u Sloveniji."</li>
        <li>„Krleža<strong>,</strong> hrvatski književnik<strong>,</strong> umro je 1981."</li>
        <li>„Pas<strong>,</strong> moj najbolji prijatelj<strong>,</strong> uvijek čeka kod vrata."</li>
      </ul>
      
      <div class="ex-label-no">❌ POGREŠNO (POLA SENDVIČA)</div>
      <ul class="list-mono-int">
        <li>„Marko, moj prijatelj došao je." (fali drugi zarez)</li>
        <li>„Zagreb glavni grad RH, ima..." (fali prvi zarez)</li>
      </ul>
    </div>

    <!-- PRAVILO 4: ZAVISNE REČENICE -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">4. Zavisne rečenice na POČETKU ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo · pozicija određuje zarez</div>
      <div class="pravilo-desc">
        Zavisne rečenice (počinju s <strong>kad, ako, jer, dok, premda, iako, dok</strong>) — kad su <strong>na POČETKU</strong>: zarez NAKON nje. Kad su <strong>iza glavne</strong>: BEZ zareza.
      </div>
      
      <div class="ex-label-ok">✅ ZAVISNA NA POČETKU = ZAREZ</div>
      <ul class="list-mono-int">
        <li>„<strong>Kad</strong> dođem<strong>,</strong> javit ću ti."</li>
        <li>„<strong>Ako</strong> budeš pošten<strong>,</strong> uspjet ćeš."</li>
        <li>„<strong>Jer</strong> nema vremena<strong>,</strong> idemo sutra." (rijetko)</li>
        <li>„<strong>Premda</strong> je teško<strong>,</strong> nastavit ću."</li>
      </ul>
      
      <div class="ex-label-blue">⚪ ZAVISNA IZA = NEMA ZAREZA</div>
      <ul class="list-mono-int">
        <li>„Javit ću ti kad dođem." (bez zareza)</li>
        <li>„Uspjet ćeš ako budeš pošten."</li>
        <li>„Idemo sutra jer nema vremena."</li>
      </ul>
    </div>

    <!-- PRAVILO 5: VOKATIV -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">5. Vokativ — oslovljavanje ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo</div>
      <div class="pravilo-desc">
        Vokativ (padež oslovljavanja) — <strong>UVIJEK ima zarez</strong>. Neovisno o poziciji u rečenici (početak, sredina, kraj).
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„Marko<strong>,</strong> dođi ovamo!"</li>
        <li>„Bože<strong>,</strong> pomozi mi!"</li>
        <li>„Dragi prijatelji<strong>,</strong> hvala vam."</li>
        <li>„Dođi<strong>,</strong> Ana<strong>,</strong> pomozi mi." (sredina rečenice — zarezi s obje strane)</li>
        <li>„Što radiš<strong>,</strong> Petre?" (kraj rečenice)</li>
      </ul>
      
      <div class="ex-label-no">❌ POGREŠNO</div>
      <ul class="list-mono-int">
        <li>„Marko dođi ovamo." (bez zareza)</li>
      </ul>
    </div>

    <!-- PRAVILO 6: UMETNUTE RIJEČI -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">6. Umetnute riječi (međutim, naime, dakle)</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo</div>
      <div class="pravilo-desc">
        Umetnute (modalne) riječi: <strong>međutim, naime, dakle, primjerice, naprotiv, doista, doduše, naravno, vjerojatno</strong>. Odvajaju se zarezima s obje strane (kao apozicija).
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„On<strong>,</strong> međutim<strong>,</strong> nije došao."</li>
        <li>„Marko<strong>,</strong> naime<strong>,</strong> uvijek kasni."</li>
        <li>„Vrijeme<strong>,</strong> dakle<strong>,</strong> ističe."</li>
        <li>„Sutra<strong>,</strong> primjerice<strong>,</strong> idem na fakultet."</li>
        <li>„<strong>Međutim<strong>,</strong></strong> on nije došao." (na početku — samo iza)</li>
      </ul>
    </div>

    <!-- PRAVILO 7: DIREKTAN GOVOR -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">7. Direktan govor — uvodi se DVOTOČJEM ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo</div>
      <div class="pravilo-desc">
        Citat ili direktan govor uvodi se <strong>DVOTOČJEM</strong>, ne zarezom. Ako nakon citata slijedi „rekao je" — onda ide zarez.
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„Marko reče<strong>:</strong> „Idem kući.""</li>
        <li>„Pitao je<strong>:</strong> „Što radiš?""</li>
        <li>„„Idem kući<strong>,</strong>„ reče Marko." (iza citata — zarez)</li>
        <li>„„Stani!„ povikne." (iza usklika — bez zareza)</li>
      </ul>
      
      <div class="ex-label-no">❌ POGREŠNO</div>
      <ul class="list-mono-int">
        <li>„Marko reče, „Idem kući."" (zarez umjesto dvotočja)</li>
      </ul>
    </div>

    <!-- PRAVILO 8: DATUM U SREDINI -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">8. Datum u sredini rečenice</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo</div>
      <div class="pravilo-desc">
        Kad datum stoji <strong>u sredini rečenice</strong> i slijedi suprotni veznik — zarez. Inače obično bez zareza.
      </div>
      
      <div class="ex-label-ok">✅ ISPRAVNO</div>
      <ul class="list-mono-int">
        <li>„Bio sam tamo 5. ožujka 2025.<strong>,</strong> a vratio se 10. ožujka."</li>
        <li>„Sastat ćemo se 15. svibnja u 14 sati." (bez zareza)</li>
        <li>„Datum je 25. travnja 2026.<strong>,</strong> petak."</li>
      </ul>
    </div>

    <!-- ─────────────── ANTI-PRAVILA ─────────────── -->
    <div class="sec-hdr" style="margin-top:48px"><div class="sec-line"></div><div class="sec-badge">⚠️ ANTI-pravila · kad NE staviti zarez ⭐</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--red)">Najveća greška:</strong> studenti stavljaju zarez „za svaki slučaj". Suvišni zarezi su <strong>jednako loši</strong> kao izostavljeni. Pravilo sumnje: <strong>ako ne znaš zašto, izostavi.</strong>
      </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:10px;margin:16px 0">
      ...
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:6px">❌ NIKAD</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:6px">Subjekt — predikat</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          „Marko<s>,</s> je došao." ❌<br>
          „Marko je došao." ✅<br>
          NIKAD zarez između subjekta i predikata.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:6px">❌ NE PRIJE „I, PA, TE"</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:6px">Sastavni veznici</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          „Idem kući<s>,</s> i učim." ❌<br>
          „Idem kući i učim." ✅<br>
          Iznimka: nabrajanje duljih cjelina.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:6px">❌ NE PRIJE „DA"</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:6px">„Da" iza glagola govora</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          „Rekao je<s>,</s> da dolazi." ❌<br>
          „Rekao je da dolazi." ✅<br>
          „Da" je sastavni, ne suprotni veznik.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:6px">❌ NE PRIJE „JER" IZA</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:6px">Glavna prije zavisne</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          „Volim ga<s>,</s> jer je dobar." ❌<br>
          „Volim ga jer je dobar." ✅<br>
          (Jer NA POČETKU = zarez nakon nje.)
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:6px">❌ NE PRIJE „KAO"</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:6px">Usporedba</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          „Plavi<s>,</s> kao nebo." ❌<br>
          „Plavi kao nebo." ✅<br>
          Iznimka: umetnuta usporedba (apozicija).
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:6px">❌ NE KOD KRATKIH PRILOGA</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:6px">Kratki prilozi vremena/mjesta</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          „Sutra<s>,</s> idem u školu." ❌<br>
          „Sutra idem u školu." ✅<br>
          (Kratki prilog na početku — bez zareza.)
        </div>
      </div>
    ...
    <!-- ─────────────── INLINE VJEŽBA ─────────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Vježba · 25 pitanja iz zareza</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Kompleksna vježba.</strong> Mješavina svih 8 pravila + anti-pravila. Cilj: pravopisni refleks koji prepoznaje suvišne zareze.
      </div>
    </div>

    <div id="zarez-exercise"></div>
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=interpunkcija+zarez+pravila+navodnici+crtica+matura+hrvatski" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Interpunkcija — zarez, navodnici, crtica</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=zarez+8+pravila+kada+staviti+zarez+matura+lektira" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Zarez — 8 pravila kad ide i kad ne ide</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Croatian+punctuation+comma+rules+explained" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Croatian punctuation — comma rules</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=punctuation+rules+comma+semicolon+dash+quotation+marks" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🎬</span> EN</div>
          <div class="yt-title">Punctuation rules — full guide</div>
        </div>
      </a>
    </div>
...
<div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      ...
      <button type="button" class="nb-btn primary" onclick="sw(2)">Crtica vs spojnica →</button>
    </div>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">— Crtica vs spojnica</span>
      <span class="pill p-br hchip">⭐ NCVVO TOP-zamka</span>
      <span class="pill p-pa hchip">📏 Razlika u dužini</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">— Crtica vs - spojnica · razlika</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">— Najveća zamka u interpunkciji</div>
      <div class="box-int-txt">
        <strong>Crtica „—" je dugačka</strong> (em-dash). <strong>Spojnica „-" je kratka</strong> (hyphen). Imaju RAZLIČITE funkcije: crtica za umetanje misli i dijalog, spojnica za složenice i brojeve. Razlika u DUŽINI = razlika u značenju.
      </div>
    </div>

    <!-- USPOREDNA TABLICA -->
    <div class="sec-hdr" style="margin-top:24px"><div class="sec-line"></div><div class="sec-badge">📊 Usporedba · jasna razlika</div><div class="sec-line"></div></div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:14px 0">
      ...
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2)">
        <div class="cap-mono-gold">CRTICA „—"</div>
        <div style="font-family:var(--display);font-size:22px;font-weight:800;color:var(--gold);margin-bottom:10px">DUGAČKA · em-dash</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6">
          <strong>Funkcije:</strong>
          <ul style="margin:6px 0 0;padding-left:18px;font-family:var(--mono);font-size:12px">
            <li>Umetanje misli</li>
            <li>Dijalog</li>
            <li>Raspon (str. 10—15)</li>
            <li>Dramski naglasak</li>
          </ul>
        </div>
      </div>
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2)">
        <div class="cap-mono-gold">SPOJNICA „-"</div>
        <div style="font-family:var(--display);font-size:22px;font-weight:800;color:var(--gold);margin-bottom:10px">KRATKA · hyphen</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6">
          <strong>Funkcije:</strong>
          <ul style="margin:6px 0 0;padding-left:18px;font-family:var(--mono);font-size:12px">
            <li>Složeni pridjevi</li>
            <li>Brojevi (2-3 dana)</li>
            <li>Države (hrvatsko-engleski)</li>
            <li>Spajanje (gore-dolje)</li>
          </ul>
        </div>
      </div>
    ...
    <!-- CRTICA — DETALJNO -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">— Crtica „—" · 4 funkcije</div><div class="sec-line"></div></div>

    <div class="scene-grid">
      
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">1</div>
          <div class="scene-ttl">
            <div class="scene-name">UMETANJE MISLI</div>
            <div class="scene-sub">„Marko — moj prijatelj — ..."</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Crtica jača od zareza za umetanje pojašnjenja:</p>
          <ul>
            <li>„Marko — moj najbolji prijatelj — došao je."</li>
            <li>„Knjiga — koju sam čitao prošle godine — bila je odlična."</li>
            <li>„Hrvatski jezik — službeni od 2013. — ima ISO kod hrv."</li>
          </ul>
          <p><strong>Razlika od zareza:</strong> crtica je „jača", izdvaja jače.</p>
        </div>
      </div>

      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">2</div>
          <div class="scene-ttl">
            <div class="scene-name">DIJALOG</div>
            <div class="scene-sub">— Što radiš? — Učim.</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>U dijalogu, crtica označava promjenu govornika:</p>
          <ul>
            <li>„— Što radiš? — pitao je Marko."</li>
            <li>„— Učim — odgovori Ana."</li>
            <li>„— Ne mogu sad. — Zašto? — Idem na sastanak."</li>
          </ul>
          <p><strong>Pravilo:</strong> crtica + razmak na početku reda. Alternativa za navodnike kod direktnog govora.</p>
        </div>
      </div>

      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">3</div>
          <div class="scene-ttl">
            <div class="scene-name">RASPON</div>
            <div class="scene-sub">str. 10—15, 1990—2000.</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Crtica označava raspon (od—do):</p>
          <ul>
            <li>„str. 10—15"</li>
            <li>„1990—2000."</li>
            <li>„Zagreb—Split (autocesta)"</li>
            <li>„18—24 godine"</li>
          </ul>
          <p><strong>Bez razmaka:</strong> 10—15, ne 10 — 15. (Iznimka: spojnica — bez razmaka uvijek: 10-15.)</p>
        </div>
      </div>

      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">4</div>
          <div class="scene-ttl">
            <div class="scene-name">DRAMSKI NAGLASAK</div>
            <div class="scene-sub">„I onda — tišina."</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>U književnosti, crtica može označavati pauzu, suspense:</p>
          <ul>
            <li>„I onda — tišina."</li>
            <li>„Pričekaj — što se dogodilo?"</li>
            <li>„Bilo je očito — nemam izbora."</li>
          </ul>
          <p><strong>Stilska upotreba:</strong> ne pretjerati u službenom tekstu.</p>
        </div>
      </div>
    ...
    <!-- SPOJNICA — DETALJNO -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">- Spojnica „-" · 4 funkcije</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">1</div>
          <div class="scene-ttl">
            <div class="scene-name">SLOŽENI PRIDJEVI · BOJE</div>
            <div class="scene-sub">crno-bijeli, plavo-zeleni</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Boje, smjerovi, opisni pridjevi sa SPOJNICOM:</p>
          <ul>
            <li>„crno-bijeli, plavo-zeleni, srebrno-zlatni"</li>
            <li>„crveno-bijelo-plavi" (više boja)</li>
          </ul>
          <p><strong>Razlika</strong>: bez spojnice = jedna riječ („tamnoplavi"); sa spojnicom = dvije ravnopravne („tamno-plavi" — različite nijanse).</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">2</div>
          <div class="scene-ttl">
            <div class="scene-name">SMJEROVI</div>
            <div class="scene-sub">gore-dolje, lijevo-desno</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Suprotnosti i smjerovi sa spojnicom:</p>
          <ul>
            <li>„gore-dolje, lijevo-desno, naprijed-natrag"</li>
            <li>„sjeverno-južno, istočno-zapadno"</li>
            <li>„malo-pomalo, jučer-danas"</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">3</div>
          <div class="scene-ttl">
            <div class="scene-name">DRŽAVE / JEZICI</div>
            <div class="scene-sub">hrvatsko-engleski rječnik</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Složeni pridjevi za odnose između država/jezika:</p>
          <ul>
            <li>„hrvatsko-engleski rječnik"</li>
            <li>„srpsko-hrvatski (politički termin)"</li>
            <li>„francusko-njemački sporazum"</li>
            <li>„angloamerička književnost" (bez spojnice — JEDNA riječ, asimilirano)</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">4</div>
          <div class="scene-ttl">
            <div class="scene-name">BROJEVI · RASPONI</div>
            <div class="scene-sub">2-3 dana, 5-6 metara</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Manji rasponi (alternativa crtici):</p>
          <ul>
            <li>„2-3 dana, 5-6 metara, 10-15 minuta"</li>
            <li>„str. 10-15" (alternativa: str. 10—15)</li>
          </ul>
          <p><strong>Praksa:</strong> u tipkanom tekstu spojnica se češće koristi (jer je em-dash teško utipkati).</p>
        </div>
      </div>
    ...
    <!-- INLINE VJEŽBA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Vježba · 20 pitanja iz crtice/spojnice</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Razlika u dužini = razlika u značenju.</strong> Vježbaj refleks za odabir ispravnog znaka.
      </div>
    </div>

    <div id="cs-exercise"></div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(1)">← Zarez</button>
      <button type="button" class="nb-btn primary" onclick="sw(3)">Navodnici →</button>
    </div>
    ...
    <div class="tags">
      <span class="pill p-pa hchip">„ Navodnici</span>
      <span class="pill p-br hchip">⭐ NCVVO TOP</span>
      <span class="pill p-pa hchip">📜 Citati · naslovi</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">„ Hrvatski navodnici · pravila</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">„ Hrvatski standard</div>
      <div class="box-int-txt">
        Hrvatski navodnici su <strong>„dolje gore"</strong> oblik (DOLJE otvaraju, GORE zatvaraju). Engleski "..." nisu hrvatski standard. Drugotni navodnici su <strong>'jednostruki'</strong> — za citat unutar citata.
      </div>
    </div>

    <!-- HRVATSKI vs ENGLESKI -->
    <div class="sec-hdr" style="margin-top:24px"><div class="sec-line"></div><div class="sec-badge">📊 Hrvatski vs engleski navodnici</div><div class="sec-line"></div></div>

    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:14px 0">
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--green);margin-bottom:6px">✅ HRVATSKI STANDARD</div>
        <div style="font-family:var(--display);font-size:32px;font-weight:800;color:var(--green);margin-bottom:10px">„..."</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          <strong>Otvarajući:</strong> „<br>
          <strong>Zatvarajući:</strong> "<br>
          <strong>Pozicija:</strong> dolje + gore<br><br>
          „Idem kući.„, „Glembajevi"
        </div>
      </div>
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--red);margin-bottom:6px">❌ ENGLESKI (NIJE HRVATSKI)</div>
        <div style="font-family:var(--display);font-size:32px;font-weight:800;color:var(--red);margin-bottom:10px">"..."</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6;font-family:var(--mono)">
          <strong>Otvarajući:</strong> "<br>
          <strong>Zatvarajući:</strong> "<br>
          <strong>Pozicija:</strong> oba gore<br><br>
          NE: „Idem kući.", „Glembajevi"
        </div>
      </div>
      
    </div>

    <!-- 4 FUNKCIJE NAVODNIKA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 4 funkcije navodnika</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">1</div>
          <div class="scene-ttl">
            <div class="scene-name">DIREKTAN GOVOR · CITATI</div>
            <div class="scene-sub">„Idem kući", reče Marko.</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Citati i direktan govor — uvodi se DVOTOČJEM:</p>
          <ul>
            <li>„Marko reče: „Idem kući.""</li>
            <li>„Pitao je: „Što radiš?""</li>
            <li>„„Stani!„ povikne." (na početku, bez dvotočja)</li>
            <li>„Knjiga kaže: „Vrijeme je relativno.""</li>
          </ul>
          <p><strong>Iza citata + glagol</strong>: zarez UNUTAR navodnika: „„Idem<strong>,</strong>„ reče."</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">2</div>
          <div class="scene-ttl">
            <div class="scene-name">NASLOVI</div>
            <div class="scene-sub">„Glembajevi", „Judita"</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Naslovi knjiga, filmova, pjesama, časopisa:</p>
          <ul>
            <li>„„Smrt Smail-age Čengića" — Mažuranić."</li>
            <li>„Roman „Glembajevi" napisao je Krleža."</li>
            <li>„Časopis „Forum" izlazi mjesečno."</li>
            <li>„„Hrvatska enciklopedija" je opsežno djelo."</li>
          </ul>
          <p><strong>Iznimka:</strong> u literarnim tekstovima naslov može biti i kosivim (italic) — bez navodnika.</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">3</div>
          <div class="scene-ttl">
            <div class="scene-name">IRONIJA · SARKAZAM</div>
            <div class="scene-sub">„genije" (sarkazam)</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Navodnici označavaju ironiju ili rezerve prema riječi:</p>
          <ul>
            <li>„On je pravi „genije" matematike." (sarkazam)</li>
            <li>„Naš „prijatelj" nas je izdao."</li>
            <li>„Tzv. „eksperti" tvrde drugačije."</li>
          </ul>
          <p><strong>Pažljivo:</strong> ne pretjerati u službenom tekstu.</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">4</div>
          <div class="scene-ttl">
            <div class="scene-name">CITAT UNUTAR CITATA</div>
            <div class="scene-sub">'jednostruki' navodnici</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Kad citat sadrži drugi citat — koriste se <strong>jednostruki</strong> ('...'):</p>
          <ul>
            <li>„Marko reče: „Pitao me je: 'Idem li?' i nisam znao odgovoriti.""</li>
            <li>„Naslov rada: „Analiza pjesme 'More' Antuna Branka Šimića"."</li>
            <li>„Učitelj kaže: „Ovo je termin 'jat refleksi'.""</li>
          </ul>
          <p><strong>Pravilo:</strong> vanjski = dvostruki („..."), unutarnji = jednostruki ('...').</p>
        </div>
      </div>
    ...
    <!-- INLINE VJEŽBA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Vježba · 20 pitanja iz navodnika</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Hrvatski navodnici „..." — uvijek dolje gore.</strong> Vježbaj prepoznavanje engleskih navodnika kao greški.
      </div>
    </div>

    <div id="nav-exercise"></div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(2)">← Crtica/spojnica</button>
      <button type="button" class="nb-btn primary" onclick="sw(4)">Završni znakovi →</button>
    </div>
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">. ? ! …</span>
      <span class="pill p-br hchip">📝 Završni znakovi</span>
      <span class="pill p-pa hchip">⏸ Trotočje</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">. ? ! … Završni znakovi · pregled</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">📝 4 završna znaka</div>
      <div class="box-int-txt">
        Hrvatski jezik koristi 4 znaka za <strong>kraj rečenice</strong>: točka (.), upitnik (?), uskličnik (!), trotočje (…). Svaki ima specifičnu funkciju + pravila o kombinaciji s drugim znakovima.
      </div>
    </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12.5px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:14px;width:60px">ZNAK</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:10.5px">FUNKCIJA</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:10.5px">PRIMJER</th>
          </tr>
        </thead>
        <tbody>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">.</td><td class="tbl-cell-bold">Tvrdnja, izjava</td><td class="tbl-cell">„Idem kući."</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">?</td><td class="tbl-cell-bold">Pitanje</td><td class="tbl-cell">„Što radiš?"</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">!</td><td class="tbl-cell-bold">Usklik, naredba</td><td class="tbl-cell">„Bravo!„, „Dođi!"</td></tr>
          <tr><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">…</td><td class="tbl-cell-bold">Nedovršena misao, izostavljanje</td><td class="tbl-cell">„Mislim..."</td></tr>
        </tbody>
      </table>
    </div>

    <!-- TOČKA — DETALJNO -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">. Točka · pravila</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">1</div>
          <div class="scene-ttl">
            <div class="scene-name">KRAJ TVRDNJE</div>
            <div class="scene-sub">Najčešća upotreba</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Točka označava kraj IZJAVNE rečenice:</p>
          <ul>
            <li>„Marko je došao."</li>
            <li>„Hrvatska je u EU od 2013."</li>
            <li>„Jučer sam učio."</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">2</div>
          <div class="scene-ttl">
            <div class="scene-name">SKRAĆENICE</div>
            <div class="scene-sub">g., dr., prof., npr.</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Točka iza skraćenica:</p>
          <ul>
            <li>„g., gđa, dr., prof., npr., itd., tj., br., str."</li>
            <li>„pr. Kr." (s razmakom)</li>
            <li>„n. e." (nove ere)</li>
          </ul>
          <p><strong>Iznimka — akronimi:</strong> HAZU, INA, EU, NATO — BEZ točaka.</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">3</div>
          <div class="scene-ttl">
            <div class="scene-name">REDNI BROJEVI</div>
            <div class="scene-sub">25. travnja, 1. svibnja</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Iza rednih brojeva — UVIJEK točka:</p>
          <ul>
            <li>„25. travnja 2026." (datum)</li>
            <li>„19. stoljeće, XX. stoljeće"</li>
            <li>„1. mjesto, 2. razred"</li>
            <li>„str. 10., poglavlje 5."</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">4</div>
          <div class="scene-ttl">
            <div class="scene-name">DECIMALA · TISUĆE</div>
            <div class="scene-sub">3,14 vs 1.000.000</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>U BROJEVIMA:</p>
          <ul>
            <li><strong>Decimalna oznaka</strong>: ZAREZ (3,14), NE točka.</li>
            <li><strong>Tisuće</strong>: razmak (1 250 000) ili točka (1.250.000).</li>
            <li>U engleskom: obrnuto (3.14 / 1,250,000).</li>
          </ul>
        </div>
      </div>
    ...
    <!-- UPITNIK + USKLIČNIK -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">❓ Upitnik · ❗ Uskličnik</div><div class="sec-line"></div></div>

    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:14px 0">
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2)">
        <div class="cap-mono-gold">❓ UPITNIK</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:10px">Pitanja</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6">
          <strong>Direktna pitanja:</strong>
          <ul style="margin:6px 0 0;padding-left:18px;font-family:var(--mono);font-size:12px">
            <li>„Što radiš?"</li>
            <li>„Kad dolaziš?"</li>
            <li>„Zašto si tužan?"</li>
            <li>„Ozbiljno?" (kratko)</li>
          </ul>
          <strong>NE u indirektnim:</strong> „Pitao je što radim." (bez ?).
        </div>
      </div>
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2)">
        <div class="cap-mono-gold">❗ USKLIČNIK</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:10px">Uskliči, naredbe</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6">
          <strong>Usklici, naredbe:</strong>
          <ul style="margin:6px 0 0;padding-left:18px;font-family:var(--mono);font-size:12px">
            <li>„Bravo!„, „Sjajno!"</li>
            <li>„Dođi ovamo!"</li>
            <li>„Stani!"</li>
          ...
          <strong>Pažljivo:</strong> ne pretjerati. Više od 1 uskličnika je amaterski.
        </div>
      </div>
    ...
    <!-- TROTOČJE -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">… Trotočje (…) · pravila</div><div class="sec-line"></div></div>

    <div class="pravilo-box">
      <div class="pravilo-header">📋 3 funkcije trotočja</div>
      <div style="font-size:13px;color:var(--t2);line-height:1.6">
        <strong>1. Nedovršena misao:</strong> „Mislim... ne znam što reći."<br>
        <strong>2. Izostavljanje teksta:</strong> „Tekst je pisan u stilu… (slijede primjeri)."<br>
        <strong>3. Suspense / pauza u književnosti:</strong> „I onda… tišina."
      </div>
      <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--bd);font-size:12px;color:var(--t3);font-family:var(--mono)">
        <strong>VAŽNO:</strong> trotočje je 3 točke (…), ne 4-5. Bez razmaka prije („Mislim...„, ne „Mislim ...").
      </div>
    </div>

    <!-- INLINE VJEŽBA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Vježba · 15 pitanja iz završnih znakova</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Završni znakovi su jednostavni</strong> ali suvišni uskličnici i krivo trotočje rade utisak nemarnog teksta.
      </div>
    </div>

    <div id="zz-exercise"></div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(3)">← Navodnici</button>
      <button type="button" class="nb-btn primary" onclick="sw(5)">Točka-zarez · dvotočje →</button>
    </div>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">; Točka-zarez</span>
      <span class="pill p-br hchip">: Dvotočje</span>
      <span class="pill p-pa hchip">📊 Hijerarhija</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">; : Točka-zarez i dvotočje · pregled</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">; : Najmanje vježbani znakovi</div>
      <div class="box-int-txt">
        Točka-zarez (;) i dvotočje (:) su <strong>najmanje vježbani</strong> znakovi. Točka-zarez je <strong>jača od zareza, slabija od točke</strong> — odvaja srodne, ali samostalne dijelove. Dvotočje uvodi <strong>pojašnjenje, popis ili citat</strong>.
      </div>
    </div>

    <!-- HIJERARHIJA INTERPUNKCIJE -->
    <div class="sec-hdr" style="margin-top:24px"><div class="sec-line"></div><div class="sec-badge">📊 Hijerarhija interpunkcijskih znakova</div><div class="sec-line"></div></div>
    
    <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <div style="font-family:var(--display);font-size:15px;font-weight:700;color:var(--t1);margin-bottom:14px">Od najslabijeg do najjačeg:</div>
      
      <div style="display:flex;flex-direction:column;gap:10px;font-family:var(--mono);font-size:12.5px;color:var(--t2)">
        
        <div style="display:flex;align-items:center;gap:14px;padding:8px 12px;background:rgba(255,255,255,.02);border-radius:var(--r1)">
          <span style="font-family:var(--display);font-size:24px;color:var(--gold);font-weight:800;width:30px;text-align:center">,</span>
          <span style="font-weight:700;color:var(--t1);width:80px">SLABA</span>
          <span style="flex:1">između riječi/dijelova rečenice (8 pravila)</span>
        </div>
        
        <div style="display:flex;align-items:center;gap:14px;padding:8px 12px;background:rgba(255,255,255,.02);border-radius:var(--r1)">
          <span style="font-family:var(--display);font-size:24px;color:var(--gold);font-weight:800;width:30px;text-align:center">;</span>
          <span style="font-weight:700;color:var(--t1);width:80px">SREDNJA</span>
          <span style="flex:1">između srodnih, ali odvojenih cjelina</span>
        </div>
        
        <div style="display:flex;align-items:center;gap:14px;padding:8px 12px;background:rgba(255,255,255,.02);border-radius:var(--r1)">
          <span style="font-family:var(--display);font-size:24px;color:var(--gold);font-weight:800;width:30px;text-align:center">:</span>
          <span style="font-weight:700;color:var(--t1);width:80px">UVOD</span>
          <span style="flex:1">prije pojašnjenja, popisa, citata</span>
        </div>
        
        <div style="display:flex;align-items:center;gap:14px;padding:8px 12px;background:rgba(255,255,255,.02);border-radius:var(--r1)">
          <span style="font-family:var(--display);font-size:24px;color:var(--gold);font-weight:800;width:30px;text-align:center">.</span>
          <span style="font-weight:700;color:var(--t1);width:80px">PUNA</span>
          <span style="flex:1">kraj izjavne rečenice</span>
        </div>
        
        <div style="display:flex;align-items:center;gap:14px;padding:8px 12px;background:rgba(255,255,255,.02);border-radius:var(--r1)">
          <span style="font-family:var(--display);font-size:24px;color:var(--gold);font-weight:800;width:30px;text-align:center">—</span>
          <span style="font-weight:700;color:var(--t1);width:80px">NAGLAŠENA</span>
          <span style="flex:1">umetanje, dramski naglasak</span>
        </div>
        
      </div>
    </div>

    <!-- TOČKA-ZAREZ DETALJNO -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">; Točka-zarez · 3 funkcije</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">1</div>
          <div class="scene-ttl">
            <div class="scene-name">SRODNE, ALI ODVOJENE REČENICE</div>
            <div class="scene-sub">Glavna upotreba</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Spaja dvije nezavisne rečenice koje su <strong>tematski povezane</strong>:</p>
          <ul>
            <li>„Volim ga; nije savršen, ali je moj."</li>
            <li>„Vrijeme je ograničeno; iskoristi ga."</li>
            <li>„Učio sam cijelu noć; prošao sam ispit."</li>
          </ul>
          <p><strong>Razlika od točke:</strong> točka-zarez naglašava VEZU; točka razdvaja potpuno.</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">2</div>
          <div class="scene-ttl">
            <div class="scene-name">DUGI POPISI</div>
            <div class="scene-sub">Kad zarez nije dovoljan</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Kad popis sadrži ZAREZE unutar elemenata — koristi točku-zarez:</p>
          <ul>
            <li>„Posjetio sam: Zagreb, glavni grad RH; Split, drugi po veličini; Rijeku, lučki grad."</li>
            <li>„Studije: Filozofski fakultet, Zagreb; FER, Zagreb; Ekonomski, Split."</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">3</div>
          <div class="scene-ttl">
            <div class="scene-name">SUPROTSTAVLJENE CJELINE</div>
            <div class="scene-sub">Naglašavanje suprotnosti</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Kad želimo naglasiti SUPROTNOST između cjelina:</p>
          <ul>
            <li>„Mladi sanjaju o budućnosti; stariji vide prošlost."</li>
            <li>„Knjige uče; iskustvo formira."</li>
          </ul>
          <p>Češće u književnom i akademskom stilu.</p>
        </div>
      </div>
    ...
    <!-- DVOTOČJE DETALJNO -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">: Dvotočje · 3 funkcije</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">1</div>
          <div class="scene-ttl">
            <div class="scene-name">POJAŠNJENJE</div>
            <div class="scene-sub">Razlog je jasan: ...</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Uvod u pojašnjenje glavne tvrdnje:</p>
          <ul>
            <li>„Razlog je jasan: nema vremena."</li>
            <li>„Postoji jedno pravilo: budi iskren."</li>
            <li>„Imam jedan zahtjev: stigni na vrijeme."</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">2</div>
          <div class="scene-ttl">
            <div class="scene-name">POPIS · NABRAJANJE</div>
            <div class="scene-sub">Donijeti: kruh, jaja, mlijeko.</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Uvod u popis ili nabrajanje:</p>
          <ul>
            <li>„Donijeti: kruh, jaja, mlijeko."</li>
            <li>„Predmeti: hrvatski, matematika, fizika."</li>
            <li>„Pravila su sljedeća: bez vrijeđanja, bez kašnjenja, bez izgovora."</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge pill-gold-dark">3</div>
          <div class="scene-ttl">
            <div class="scene-name">DIREKTAN GOVOR ⭐</div>
            <div class="scene-sub">Marko reče: „Idem."</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>UVIJEK dvotočje prije citata, nikad zarez:</p>
          <ul>
            <li>„Marko reče: „Idem kući.""</li>
            <li>„Pitao je: „Što radiš?""</li>
            <li>„Učitelj kaže: „Vrijeme je za ispit.""</li>
          </ul>
          <p><strong>NCVVO TOP zamka:</strong> mnogi pišu zarez umjesto dvotočja.</p>
        </div>
      </div>
    ...
    <!-- INLINE VJEŽBA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Vježba · 15 pitanja iz točke-zareza i dvotočja</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Manje frekventno na NCVVO,</strong> ali kad se pojavi — često diferencijator za visok score. Razumijevanje hijerarhije je ključno.
      </div>
    </div>

    <div id="td-exercise"></div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(4)">← Završni znakovi</button>
      <button type="button" class="nb-btn primary" onclick="sw(6)">🔧 Proofreading →</button>
    </div>
  ...
  <div class="layer" id="l6" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">🔧 Proofreading</span>
      <span class="pill p-br hchip">📝 20 rečenica</span>
      <span class="pill p-pa hchip">🎯 Klikni gdje treba zarez</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">🔧 Proofreading mode · trening korektora</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🔧 Glavni feature H26</div>
      <div class="box-int-txt">
        <strong>Drugačiji od Speed Drill-a</strong> (H25). Tu se ne bira između opcija — <strong>klikom označavaš pozicije gdje treba zarez</strong>. Realističnije od MC kviza, kao maturalna esejska zadaća. Idealno za trening čitanja kao lektor.
      </div>
    </div>
    ...
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📊 Tvoj napredak</div><div class="sec-line"></div></div>
    
    <div id="pr-history" style="padding:14px 16px;background:rgba(233,180,70,.04);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)" id="pr-history-content">
        Nema završenih sesija. Pokreni Proofreading da vidiš svoj napredak.
      </div>
    </div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(5)">← Točka-zarez · dvotočje</button>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">📚 Pojmovnik · 60 pojmova</span>
      <span class="pill p-br hchip">📋 Cheat sheet · za maturu</span>
    </div>

    <!-- ─────────────── POJMOVNIK ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📚 Pojmovnik · 60 interpunkcijskih pojmova</div><div class="sec-line"></div></div>
    ...
    <div class="pojm-controls" style="margin:18px 0">
      <div class="pojm-filters" style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:14px">
        ...
        <button type="button" class="pojm-filter" onclick="pojmFilter2('zarez', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Zarez</button>
        <button type="button" class="pojm-filter" onclick="pojmFilter2('crtica', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Crtica/spojnica</button>
        <button type="button" class="pojm-filter" onclick="pojmFilter2('navod', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Navodnici</button>
        <button type="button" class="pojm-filter" onclick="pojmFilter2('zavrs', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Završni znakovi</button>
        <button type="button" class="pojm-filter" onclick="pojmFilter2('tdvo', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Točka-zarez</button>
        ...
        <button type="button" class="pojm-filter" onclick="pojmFilter2('recen', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Pojmovi rečenice</button>
      </div>
    </div>
    ...
    <div style="padding:18px;background:linear-gradient(135deg,rgba(233,180,70,.04),transparent);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.7;color:var(--t2);font-family:var(--serif)">
        <strong>Sve interpunkcijske zamke za maturu na jednom mjestu.</strong> Koristi prije mature za brzu reviziju.
      </div>
    </div>

    <!-- HIJERARHIJA ZNAKOVA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📊 Hijerarhija interpunkcijskih znakova</div><div class="sec-line"></div></div>
    
    <div class="table-wrap">
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:14px;width:50px">ZNAK</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:10px">JAČINA</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:10px">FUNKCIJA</th>
          </tr>
        </thead>
        <tbody>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">,</td><td class="tbl-cell-bold">SLABA</td><td class="tbl-cell">između riječi/dijelova rečenice (8 pravila)</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">;</td><td class="tbl-cell-bold">SREDNJA</td><td class="tbl-cell">između srodnih, ali odvojenih cjelina</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">:</td><td class="tbl-cell-bold">UVOD</td><td class="tbl-cell">prije pojašnjenja, popisa, citata</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">.</td><td class="tbl-cell-bold">PUNA</td><td class="tbl-cell">kraj izjavne rečenice</td></tr>
          <tr><td class="tbl-cell-bold" style="font-size:18px;color:var(--gold)">—</td><td class="tbl-cell-bold">NAGLAŠENA</td><td class="tbl-cell">umetanje misli, dramski naglasak</td></tr>
        </tbody>
      </table>
    </div>

    <!-- 12 TOP NCVVO ZAREZ-ZAMKI -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">⚠️ 12 TOP NCVVO zarez-zamki — pamti pred maturom</div><div class="sec-line"></div></div>
    ...
    <div style="padding:18px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <ol style="margin:0;padding-left:20px;font-size:13px;line-height:1.8;color:var(--t2)">
        <li><strong style="color:var(--red)">Volim ga, ali se ljutim</strong> — suprotni veznici (a/ali/no/nego) UVIJEK zarez prije</li>
        <li><strong style="color:var(--red)">Marko, moj prijatelj, došao je</strong> — apozicija = SENDVIČ od zareza</li>
        <li><strong style="color:var(--red)">Marko, dođi!</strong> — vokativ uvijek ima zarez</li>
        <li><strong style="color:var(--red)">Kad dođem, javit ću ti</strong> — zavisna na početku → zarez nakon nje</li>
        <li><strong style="color:var(--red)">Javit ću ti kad dođem</strong> — zavisna iza glavne → BEZ zareza</li>
        <li><strong style="color:var(--red)">On, međutim, nije došao</strong> — umetnute riječi (međutim, naime) → zarezi s obje strane</li>
        <li><strong style="color:var(--red)">Marko reče: „Idem"</strong> — direktan govor → DVOTOČJE, ne zarez!</li>
        <li><strong style="color:var(--red)">Idem kući i učim</strong> — sastavni „i, pa, te" → BEZ zareza</li>
        <li><strong style="color:var(--red)">Marko je došao</strong> — NIKAD zarez između subjekta i predikata</li>
        <li><strong style="color:var(--red)">Volim ga jer je dobar</strong> — „jer" iza glavne → BEZ zareza</li>
        <li><strong style="color:var(--red)">Plavi kao nebo</strong> — „kao" za usporedbu → BEZ zareza</li>
        <li><strong style="color:var(--red)">Hrvatski „..."</strong> — ne engleski "..."</li>
      </ol>
    </div>

    <!-- CRTICA vs SPOJNICA QUICK -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">— vs - · kratka referenca</div><div class="sec-line"></div></div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:10px;margin:14px 0">
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">CRTICA „—" (DUGAČKA)</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6">
          Umetanje misli, dijalog, raspon. „Marko — moj prijatelj — došao je."
        </div>
      </div>
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">SPOJNICA „-" (KRATKA)</div>
        <div style="font-size:13px;color:var(--t2);line-height:1.6">
          Složenice, brojevi. „crno-bijeli", „2-3 dana", „hrvatsko-engleski"
        </div>
      </div>
    </div>

    <!-- NAVODNICI QUICK -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">„ Navodnici · kratka referenca</div><div class="sec-line"></div></div>
    ...
    <div style="padding:14px 18px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <ul style="margin:0;padding-left:20px;font-size:13px;line-height:1.8;color:var(--t2);font-family:var(--mono)">
        <li><strong>Vanjski citat:</strong> „..." (dolje gore)</li>
        <li><strong>Citat unutar citata:</strong> '...' (jednostruki)</li>
        <li><strong>Direktan govor:</strong> uvodi se DVOTOČJEM (NE zarezom!)</li>
        <li><strong>Naslov:</strong> u navodnicima ili kosivim (italic)</li>
        <li><strong>Ironija:</strong> „...„ s rezervnim značenjem („genije" sarkastično)</li>
        <li><strong>NIKAD:</strong> engleski "..." nije hrvatski standard</li>
      </ul>
    </div>
    ...
    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(6)">← Proofreading</button>
  ...
  <div class="chapter-nav-wrap">
    ...
    <div class="chapter-nav-grid">
      ...
      <a class="chapter-nav-card chapter-nav-prev" href="/skripte/hrv/h25">
        ...
        <div class="chapter-nav-meta">
          ...
          <div class="chapter-nav-desc">Veliko/malo, č/ć, đ/dž + Brzi pravopis drill</div>
        </div>
      </a>
      
      <a class="chapter-nav-card chapter-nav-next" href="/skripte/hrv/h27">
        <div class="chapter-nav-meta">
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H26 Pravopis II</div>
...
.pr-gap::before {
  ...
  height: 6px;
  border-radius: 50%;
  background: rgba(233,180,70,0.25);
  transition: all .15s ease;
}
...
.pr-gap.selected {
  background: rgba(233,180,70,0.15);
}


.pr-gap.selected::before {
  content: ',';
  background: transparent;
  color: var(--gold);
  font-size: 24px;
...
.pr-gap.correct-placed {
  color: var(--green) !important;
  background: rgba(80,200,120,0.15) !important;
  font-weight: 800;
}

.pr-gap.correct-placed::before { content: ''; }


.pr-gap.missed {
  color: var(--gold) !important;
  background: rgba(233,180,70,0.2) !important;
  font-weight: 800;
  animation: pr-pulse-missed 1.5s ease-in-out infinite;
}

.pr-gap.missed::before { content: ''; }


@keyframes pr-pulse-missed {
  0%, 100% { opacity: 1; }
  50% { opacity: 0.5; }
}
...
.pr-feedback-result .pr-feedback-ok {
  padding: 14px 16px;
  background: rgba(80,200,120,0.06);
  border-left: 3px solid var(--green);
  border-radius: var(--r1);
...
.pr-feedback-result .pr-feedback-no {
  padding: 14px 16px;
  background: rgba(224,82,82,0.06);
  border-left: 3px solid var(--red);
  border-radius: var(--r1);
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h26.tab') || '0') }catch(e){return 0} })(),
...
const DIAG0_Q=[
  {q:\`Volim ga ___ ali se ljutim.\`,o:[\`,\`,\`(bez znaka)\`],t:0,e:\`Suprotni veznici (a, ali, no, nego) UVIJEK imaju zarez prije.\`},
  {q:\`Marko ___ moj prijatelj ___ došao je.\`,o:[\`, ,\`,\`(bez znakova)\`],t:0,e:\`Apozicija (pojašnjenje uz imenicu) odvaja se zarezima s OBJE strane.\`},
  {q:\`Idem kući ___ i učim.\`,o:[\`,\`,\`(bez zareza)\`],t:1,e:\`„i, pa, te" obično NEMAJU zarez prije njih (osim u nabrajanju).\`},
  {q:\`Kad dođem ___ javit ću ti.\`,o:[\`,\`,\`(bez znaka)\`],t:0,e:\`Zavisna rečenica (kad/ako/jer) na POČETKU — zarez nakon nje.\`},
  {q:\`Rekao je ___ „Idem kući.“\`,o:[\`:\`,\`,\`],t:0,e:\`Direktan govor uvodi se DVOTOČJEM, ne zarezom.\`},
  {q:\`Crtica „—" koristi se za:\`,o:[\`umetanje misli, dijalog\`,\`složene pridjeve\`],t:0,e:\`Crtica (—, em-dash) za umetanje. Spojnica (-, hyphen) za složenice.\`},
  {q:\`Hrvatski navodnici:\`,o:[\`„dolje gore"\`,\`"engleski"\`],t:0,e:\`Hrvatski standard: „dolje gore" („..."). Engleski "..." nije hrvatski standard.\`},
  {q:\`Razlog je jasan ___ nema vremena.\`,o:[\`:\`,\`,\`],t:0,e:\`Dvotočje uvodi POJAŠNJENJE.\`},
  {q:\`Točka-zarez (;) koristi se za:\`,o:[\`razdvajanje srodnih dijelova\`,\`dijalog\`],t:0,e:\`Točka-zarez za razdvajanje povezanih, ali odvojenih dijelova rečenice.\`},
  {q:\`Bravo ___\`,o:[\`!\`,\`.\`],t:0,e:\`Usklik završava uskličnikom.\`},
  {q:\`On je rekao ___ da dolazi.\`,o:[\`(bez zareza)\`,\`,\`],t:0,e:\`„Da" iza glagola govora NEMA zarez (sastavni veznik, ne suprotni).\`},
  {q:\`Citat unutar citata:\`,o:[\`'jednostruki'\`,\`„dvostruki"\`],t:0,e:\`Vanjski citat: „...". Unutarnji: '...' (jednostruki).\`},
];
...
function sw(n){
  ...
  if(n===6 && typeof proofInit === 'function') proofInit();
  if(n===5){
...
const POJM_DATA2 = [
  // ZAREZ
  {kat:'zarez', term:\`Zarez (,)\`, def:\`Najslabiji interpunkcijski znak. Odvaja dijelove rečenice. Ima 8 glavnih pravila kad ide + anti-pravila kad NE ide. Najčešća pravopisna greška.\`, star:true},
  {kat:'zarez', term:\`Suprotni veznik\`, def:\`Veznici a, ali, no, nego, već — UVIJEK imaju zarez prije sebe. Mnemotehnika: A-ALI-NO-NEGO = ZAREZ.\`, star:true},
  {kat:'zarez', term:\`Sastavni veznik\`, def:\`Veznici i, pa, te, ni, niti — obično NEMAJU zarez prije. Iznimka: nabrajanje duljih cjelina.\`, star:true},
  {kat:'zarez', term:\`Apozicija\`, def:\`Pojašnjenje uz imenicu — odvaja se zarezima s OBJE strane (sendvič): „Marko, moj prijatelj, došao je."\`, star:true},
  {kat:'zarez', term:\`Vokativ\`, def:\`Padež oslovljavanja — UVIJEK ima zarez. „Marko, dođi!", „Bože, pomozi!"\`, star:true},
  {kat:'zarez', term:\`Zavisna rečenica na početku\`, def:\`Kad počinje s „kad, ako, jer, dok, premda" — zarez NAKON nje. „Kad dođem, javit ću ti."\`, star:true},
  {kat:'zarez', term:\`Zavisna iza glavne\`, def:\`Kad zavisna rečenica IDE iza glavne — NEMA zareza. „Javit ću ti kad dođem."\`, star:true},
  {kat:'zarez', term:\`Umetnuta riječ\`, def:\`Modalne riječi (međutim, naime, dakle, primjerice) — odvajaju zarezima s obje strane: „On, međutim, nije došao."\`, star:false},
  {kat:'zarez', term:\`Nabrajanje\`, def:\`Zarez odvaja elemente popisa. NE prije zadnjeg „i" (Oxford zarez nije obavezan u hrvatskom). „Kupio sam kruh, mlijeko, jaja i sir."\`, star:true},
  {kat:'zarez', term:\`Suvišni zarez\`, def:\`Najveća greška: stavljanje zareza gdje ne treba (između subjekta i predikata, prije „da" iza glagola govora, prije „kao"). Pravilo sumnje: ako ne znaš zašto, izostavi.\`, star:true},

  // CRTICA / SPOJNICA
  {kat:'crtica', term:\`Crtica (—)\`, def:\`Em-dash, dugačka. Funkcije: umetanje misli, dijalog, raspon, dramski naglasak. „Marko — moj prijatelj — došao je."\`, star:true},
  {kat:'crtica', term:\`Spojnica (-)\`, def:\`Hyphen, kratka. Za složenice (crno-bijeli), brojeve (2-3 dana), države (hrvatsko-engleski).\`, star:true},
  {kat:'crtica', term:\`Em-dash\`, def:\`Engleski naziv za crticu „—". U hrvatskom standardna oznaka za umetanje (jača od zareza).\`, star:false},
  {kat:'crtica', term:\`Hyphen\`, def:\`Engleski naziv za spojnicu „-". Najčešća upotreba u hrvatskom: složenice s dvije ravnopravne riječi.\`, star:false},
  {kat:'crtica', term:\`Raspon\`, def:\`Crtica označava raspon: „str. 10—15", „1990—2000.", „18—24 godine". Bez razmaka.\`, star:false},
  {kat:'crtica', term:\`Dijalog s crticom\`, def:\`U književnim tekstovima, crtica + razmak označava promjenu govornika u dijalogu, alternativa navodnicima.\`, star:false},

  // NAVODNICI
  {kat:'navod', term:\`Hrvatski navodnici („...")\`, def:\`Hrvatski standard: dolje gore. „Otvarajući" dolje, "zatvarajući" gore. NE engleski "...".\`, star:true},
  {kat:'navod', term:\`Drugotni navodnici ('...')\`, def:\`Jednostruki navodnici za citat unutar citata: „Marko reče: 'Idem!' i otišao."\`, star:true},
  {kat:'navod', term:\`Direktan govor\`, def:\`Citiranje tuđih riječi — uvodi se DVOTOČJEM, ne zarezom. „Reče: „Idem.""\`, star:true},
  {kat:'navod', term:\`Indirektni govor\`, def:\`Prepričavanje bez navodnika i dvotočja, sa veznikom „da": „Rekao je da dolazi." (bez zareza, bez navodnika).\`, star:false},
  {kat:'navod', term:\`Naslov\`, def:\`Naslovi knjiga, filmova, pjesama — pišu se u navodnicima ili kosivim (italic). „„Glembajevi" — Krleža."\`, star:false},
  {kat:'navod', term:\`Ironija u navodnicima\`, def:\`Navodnici označavaju ironiju ili rezerve prema riječi: „On je pravi „genije"." (sarkazam).\`, star:false},
  {kat:'navod', term:\`Engleski navodnici "..."\`, def:\`Stil "..." nije hrvatski standard. Često se vidi u tekstovima zbog interneta — pravopisno je greška.\`, star:true},

  // ZAVRŠNI ZNAKOVI
  {kat:'zavrs', term:\`Točka (.)\`, def:\`Označava kraj IZJAVNE rečenice. Također: skraćenice (g., dr.), redni brojevi (1., 25.), kraj decimalne (NE — u hrvatskom je zarez).\`, star:true},
  {kat:'zavrs', term:\`Upitnik (?)\`, def:\`Završava direktna pitanja: „Što radiš?" NE u indirektnima: „Pitao je što radim." (bez ?).\`, star:true},
  {kat:'zavrs', term:\`Uskličnik (!)\`, def:\`Završava usklike i naredbe: „Bravo!", „Stani!", „O, kako lijepo!" Ne pretjerati u službenom tekstu.\`, star:false},
  {kat:'zavrs', term:\`Trotočje (…)\`, def:\`3 točke za nedovršenu misao, izostavljanje, dramski efekt: „Mislim..." Bez razmaka prije.\`, star:false},
  {kat:'zavrs', term:\`Direktno pitanje\`, def:\`Pitanje izgovoreno doslovno — završava upitnikom. Razlikovati od indirektnog (bez upitnika).\`, star:false},
  {kat:'zavrs', term:\`Indirektno pitanje\`, def:\`Prepričano pitanje u izjavnoj rečenici — bez upitnika. „Pitao je što radim." (točka, ne ?).\`, star:false},

  // TOČKA-ZAREZ I DVOTOČJE
  {kat:'tdvo', term:\`Točka-zarez (;)\`, def:\`Jača od zareza, slabija od točke. Razdvaja srodne ali samostalne dijelove rečenice: „Volim ga; nije savršen."\`, star:true},
  {kat:'tdvo', term:\`Dvotočje (:)\`, def:\`Uvodi pojašnjenje, popis ili citat: „Razlog je jasan: nema vremena.", „Donijeti: kruh, jaja."\`, star:true},
  {kat:'tdvo', term:\`Hijerarhija interpunkcije\`, def:\`Od najslabijeg do najjačeg: zarez (,) → točka-zarez (;) → dvotočje (:) → točka (.) → crtica (—).\`, star:true},
  {kat:'tdvo', term:\`Dvotočje za pojašnjenje\`, def:\`Uvodi pojašnjenje glavne tvrdnje. Razlog što se najčešće koristi — jasno odvaja uvod od pojašnjenja.\`, star:false},
  {kat:'tdvo', term:\`Dvotočje za popis\`, def:\`Uvodi nabrajanje: „Predmeti: hrvatski, matematika, fizika." Često s vertikalnim popisom.\`, star:false},

  // ZAGRADE / TIPOGRAFIJA
  {kat:'tip', term:\`Zagrade ()\`, def:\`Za umetnuta pojašnjenja, alternative, dodatne informacije: „Zagreb (glavni grad RH) ima..." Mekša interpunkcija.\`, star:false},
  {kat:'tip', term:\`Uglate zagrade [ ]\`, def:\`Za umetanja unutar citata ili znanstvenih napomena: „Tekst kaže [Marko reče]: ..."\`, star:false},
  {kat:'tip', term:\`Razmak\`, def:\`Razmak nakon zareza, točke, dvotočja. NE prije njih. Engleski stil "..." ima drukčije razmake od hrvatskog „...".\`, star:false},
  {kat:'tip', term:\`Italic (kosivo)\`, def:\`Alternativa navodnicima za naslove: „Glembajevi" ili Glembajevi (kosivo). U digitalnim medijima češći italic.\`, star:false},
  {kat:'tip', term:\`Bold (podebljano)\`, def:\`Naglašavanje ključnih riječi u tekstu. Nije interpunkcijski znak, ali utječe na čitanje.\`, star:false},

  // POJMOVI REČENICE
  {kat:'recen', term:\`Glavna rečenica\`, def:\`Samostalna rečenica koja može stajati sama. „Volim ga." Zavisne rečenice je dopunjuju.\`, star:false},
  {kat:'recen', term:\`Zavisna rečenica\`, def:\`Ne može stajati sama, dopunjuje glavnu. Uvodi se veznicima: kad, ako, jer, dok, premda.\`, star:true},
  {kat:'recen', term:\`Subjekt\`, def:\`Vršitelj radnje. „Marko" u „Marko je došao." NIKAD se ne odvaja zarezom od predikata.\`, star:false},
  {kat:'recen', term:\`Predikat\`, def:\`Glagolski dio rečenice. „je došao" u „Marko je došao." Ne odvaja se zarezom od subjekta.\`, star:false},
  {kat:'recen', term:\`Apozicija\`, def:\`Pojašnjenje uz imenicu — odvaja zarezima s obje strane. Vidi pravilo 3 zareza.\`, star:true},
  {kat:'recen', term:\`Modalna riječ\`, def:\`Riječi koje izražavaju stav govornika: međutim, naime, dakle, primjerice. Odvajaju se zarezima.\`, star:false},
  {kat:'recen', term:\`Vokativ\`, def:\`Padež oslovljavanja: Marko (vokativ od „Marko"), Bože, kralju. UVIJEK ima zarez.\`, star:true},
  {kat:'recen', term:\`Suprotne rečenice\`, def:\`Povezane suprotnim veznikom (a, ali, no, nego). UVIJEK zarez prije veznika.\`, star:false},
  {kat:'recen', term:\`Sastavne rečenice\`, def:\`Povezane sastavnim veznikom (i, pa, te). Obično NEMAJU zarez.\`, star:false},

  // NORMA / INSTITUCIJE
  {kat:'norma', term:\`Hrvatski pravopis (2013)\`, def:\`Službeni pravopis Instituta za hrvatski jezik i jezikoslovlje (IHJJ). Slovo zakona za maturu.\`, star:true},
  {kat:'norma', term:\`IHJJ\`, def:\`Institut za hrvatski jezik i jezikoslovlje — službena hrvatska jezikoslovna ustanova (Zagreb).\`, star:false},
  {kat:'norma', term:\`NCVVO\`, def:\`Nacionalni centar za vanjsko vrednovanje obrazovanja — provodi maturu u Hrvatskoj. Definira testne sadržaje.\`, star:false},
  ...
  {kat:'mnemo', term:\`I-PA-TE = NEMA\`, def:\`Mnemotehnika: SASTAVNI veznici (i, pa, te) NEMAJU zarez. „Idem kući i učim." (bez zareza).\`, star:true},
  {kat:'mnemo', term:\`Sendvič apozicija\`, def:\`Mnemotehnika: apozicija = sendvič — zarez s OBJE strane. Bez drugog zareza je SAMO POLA SENDVIČA.\`, star:true},
  {kat:'mnemo', term:\`Crtica ≠ spojnica\`, def:\`Mnemotehnika: crtica „—" duga = umetanje. Spojnica „-" kratka = složenice. Razlika u DUŽINI.\`, star:true},
  {kat:'mnemo', term:\`Hrvatski „dolje gore"\`, def:\`Mnemotehnika: hrvatski navodnici otvaraju DOLJE, zatvaraju GORE. Engleski oba gore — to nije hrvatski.\`, star:true},

  // OSTALI POJMOVI
  {kat:'ostalo', term:\`Interpunkcija\`, def:\`Sustav interpunkcijskih znakova (pisanih oznaka) za organizaciju teksta. 8+ znakova u hrvatskom.\`, star:true},
  {kat:'ostalo', term:\`Punktuacija\`, def:\`Sinonim za interpunkciju (latinski: punctus = točka). Češće u stranim jezicima.\`, star:false},
  {kat:'ostalo', term:\`Korektor / lektor\`, def:\`Profesionalac koji čita tekst i ispravlja interpunkcijske/pravopisne greške. Proofreading mode te trenira.\`, star:false},
  {kat:'ostalo', term:\`Proofreading\`, def:\`Engleski termin za korekturu teksta. U H26 = glavna interakcija — kliknu pozicije gdje treba zarez.\`, star:false},
];let pojm2Active = 'all';
let pojm2Mode = 'grid';
let pj2Data = [];
let pj2Idx = 0;
...
function renderPojm2(){
  ...
  const KAT_LABELS = {
  zarez: 'Zarez',
  crtica: 'Crtica · spojnica',
  navod: 'Navodnici · citati',
  zavrs: 'Završni znakovi',
  tdvo: 'Točka-zarez · dvotočje',
  tip: 'Tipografija',
  recen: 'Rečenica · pojmovi',
  norma: 'Norma · institucije',
  mnemo: 'Mnemotehnike',
...
function declineNoun(){
  ...
  \`;
    ...
    // Save to history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h26.decl_hist')||'[]');
    if(!hist.some(h => h.word === word)){
      hist.push({word, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h26.decl_hist', JSON.stringify(hist.slice(-15)));
    }
  } catch(e){}
...
function morfoAnalyze(){
  ...
  // Save to history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h26.scanner_hist')||'[]');
    // Only save valid words (no special chars)
    if(/^[a-zčćđšžA-ZČĆĐŠŽ\\s]+$/.test(word) && word.length < 50){
      hist.push({word, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h26.scanner_hist', JSON.stringify(hist.slice(-20)));
    }
  } catch(e){}
}
...
function parserAnalyze(){
  ...
  if(/^[a-zA-ZčćđšžČĆĐŠŽ0-9\\s.,!?;:'-]+$/.test(text) && text.length < 200){
    try {
      const hist = JSON.parse(localStorage.getItem('mt.hrv.h26.parser_hist') || '[]');
      hist.push({text, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h26.parser_hist', JSON.stringify(hist.slice(-15)));
    } catch(e){}
  }
...
async function aiAsk(){
  ...
  try {
    ...
    // Save history
    try {
      const hist = JSON.parse(localStorage.getItem('mt.hrv.h26.ai_hist') || '[]');
      hist.push({q: question, a: text.slice(0, 500), date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h26.ai_hist', JSON.stringify(hist.slice(-10)));
    } catch(e){}
...
try { pojmStars = JSON.parse(localStorage.getItem('mt.hrv.h26.cit_stars') || '{}'); } catch(e){ pojmStars = {}; }
...
function pojmToggleStar(term, btn){
  ...
  try { localStorage.setItem('mt.hrv.h26.cit_stars', JSON.stringify(pojmStars)); } catch(e){}
}
...
function parserShowHistory(){
  let hist = [];
  try { hist = JSON.parse(localStorage.getItem('mt.hrv.h26.parser_hist') || '[]'); } catch(e){}
...
function parserClearHistory(){
  if(confirm('Obrisati svu povijest analiza?')){
    try { localStorage.removeItem('mt.hrv.h26.parser_hist'); } catch(e){}
    parserShowHistory();
  }
}
...
function diag0End(){
  ...
  if(pct>=80){
    msg='🌟 Odličan rezultat! Solidno znaš interpunkciju. Idi na <strong>Proofreading mode</strong> da uvježbaš pravopisno čitanje.';
    btnTxt='🔧 Proofreading →'; btnTab=6;
  } else if(pct>=60){
    msg='👍 Dobar temelj. Pojača Tab <strong>Zarez (8 pravila)</strong> — to je <strong>glavni izvor grešaka</strong> na maturi.';
    btnTxt='⭐ Zarez (8 pravila) →'; btnTab=1;
  } else if(pct>=40){
    msg='📚 Imaš osnovu, ali ima rupa. Krećemo s <strong>Zarez 8 pravila</strong> — najvažnija interpunkcija.';
    btnTxt='⭐ Zarez (8 pravila) →'; btnTab=1;
  } else {
    msg='💪 Nije panika — interpunkcija je sustav koji se brzo savlada. Krećemo s <strong>Teorijom (Tab 0)</strong>. Najbitnije: zarez = 80% grešaka.';
...
let citStars={};
try{citStars=JSON.parse(localStorage.getItem('mt.hrv.h26.cit_stars')||'{}')}catch(e){}
let citActive='sve';

function togStar(i,el){
  citStars[i]=!citStars[i];
  el.classList.toggle('starred',!!citStars[i]);
  try{localStorage.setItem('mt.hrv.h26.cit_stars',JSON.stringify(citStars))}catch(e){}
}
...
function scannerUpdate(){
  ...
  try{localStorage.setItem('mt.hrv.h26.wc_text',txt);}catch(e){}
}
(function(){
  const ta=document.getElementById('scanner-in');
  if(!ta)return;
  try{const sv=localStorage.getItem('mt.hrv.h26.wc_text');if(sv){ta.value=sv;scannerUpdate();}}catch(e){}
})();
...
═══════════════════════════════════ */
let CP_STATE={done:{}};
try{const s=localStorage.getItem('mt.hrv.h26.cp');if(s)CP_STATE=JSON.parse(s);}catch(e){}
...
function cpToggle(i){
  ...
  try{localStorage.setItem('mt.hrv.h26.cp',JSON.stringify(CP_STATE));}catch(e){}
  cpRender();
...
function cpReset(){
  CP_STATE={done:{}};
  try{localStorage.removeItem('mt.hrv.h26.cp');}catch(e){}
  cpRender();
}
cpRender();
...
═══════════════════════════════════ */
let TAB_DONE={};
try{TAB_DONE=JSON.parse(localStorage.getItem('mt.hrv.h26.tab_done')||'{}')}catch(e){}

function markTab(n){
  TAB_DONE[n]=true;
  try{localStorage.setItem('mt.hrv.h26.tab_done',JSON.stringify(TAB_DONE))}catch(e){}
...
const TIPS=[
  ...
  '💡 <strong>Tab 7 tip:</strong> Pojmovnik + cheat sheet za interpunkciju — koristi ga za brzu provjeru pravila prije mature.',
];
let tipShown={};
function showTip(n){
...
function loadScoreHistory(){
  try{
    const hist=JSON.parse(localStorage.getItem('mt.hrv.h26.kviz_hist')||'[]');
...
function saveScoreHistory(score,total){
  try{
    ...
    localStorage.setItem('mt.hrv.h26.kviz_hist',JSON.stringify(hist.slice(-10)));
    loadScoreHistory();
  }catch(e){}
}
...
function fsAddToHistory(text, count){
  try{
    let hist = JSON.parse(localStorage.getItem('mt.hrv.h26.fs_hist') || '[]');
    hist.push({text, count, date: Date.now()});
    if(hist.length > 20) hist = hist.slice(-20);
    localStorage.setItem('mt.hrv.h26.fs_hist', JSON.stringify(hist));
  } catch(e){}
}
...
if(document.readyState === 'loading'){
  document.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => { if(typeof proofInit === 'function') proofInit(); if(typeof interpInitInline === 'function') interpInitInline(); }, 200);
  });
} else {
  setTimeout(() => { if(typeof proofInit === 'function') proofInit(); if(typeof interpInitInline === 'function') interpInitInline(); }, 200);
}
...
const PROOF_SENTENCES = [
  ...
  {
    diff: 'easy',
    text: 'Marko moj prijatelj došao je jučer',
    correct: [1, 3], // razmaci 1 i 3 (između „Marko↔moj" i „prijatelj↔došao") — apozicija
    rule: 'Apozicija "moj prijatelj" odvaja se zarezima s obje strane.',
    sentence_with_commas: 'Marko, moj prijatelj, došao je jučer.'
  },
  {
    diff: 'easy',
    text: 'Volim ga ali se ljutim',
    correct: [2], // prije „ali"
    rule: 'Suprotni veznik „ali" — zarez prije.',
    sentence_with_commas: 'Volim ga, ali se ljutim.'
  },
  {
    diff: 'easy',
    text: 'Marko dođi ovamo',
    correct: [1], // poslije vokativa „Marko"
    rule: 'Vokativ (oslovljavanje) — zarez nakon imena.',
    sentence_with_commas: 'Marko, dođi ovamo!'
  },
  {
    diff: 'easy',
    text: 'Kupio sam kruh mlijeko jaja i sir',
    correct: [3, 4], // između „kruh↔mlijeko" i „mlijeko↔jaja", NE prije „i"
    rule: 'Nabrajanje — zarez između elemenata, NE prije zadnjeg „i".',
    sentence_with_commas: 'Kupio sam kruh, mlijeko, jaja i sir.'
  },
  {
    diff: 'easy',
    text: 'Kad dođem javit ću ti',
    correct: [2], // poslije „dođem"
    rule: 'Zavisna rečenica „kad" na početku — zarez nakon nje.',
    sentence_with_commas: 'Kad dođem, javit ću ti.'
  },
  
  // MEDIUM (10)
  {
    diff: 'mid',
    text: 'Zagreb glavni grad Hrvatske ima oko 800 000 stanovnika',
    correct: [1, 4], // apozicija „glavni grad Hrvatske"
    rule: 'Apozicija „glavni grad Hrvatske" odvaja zarezima s obje strane.',
    sentence_with_commas: 'Zagreb, glavni grad Hrvatske, ima oko 800 000 stanovnika.'
  },
  {
    diff: 'mid',
    text: 'On međutim nije došao na sastanak',
    correct: [1, 2], // umetnuta riječ „međutim"
    rule: 'Umetnuta riječ „međutim" odvaja zarezima s obje strane.',
    sentence_with_commas: 'On, međutim, nije došao na sastanak.'
  },
  {
    diff: 'mid',
    text: 'Volim čitati pisati i učiti hrvatski jezik',
    correct: [2, 3], // nabrajanje glagola
    rule: 'Nabrajanje — zarez između „čitati", „pisati" i „učiti", NE prije „i".',
    sentence_with_commas: 'Volim čitati, pisati i učiti hrvatski jezik.'
  },
  {
    diff: 'mid',
    text: 'Ako budeš pošten uspjet ćeš u životu',
    correct: [3], // zavisna „ako" na početku
    rule: 'Zavisna rečenica „ako" na početku — zarez nakon nje.',
    sentence_with_commas: 'Ako budeš pošten, uspjet ćeš u životu.'
  },
  {
    diff: 'mid',
    text: 'Marko reče Idem kući',
    correct: [], // ovdje treba DVOTOČJE, NE zarez (test studenta)
    rule: 'Direktan govor uvodi se DVOTOČJEM, ne zarezom! Ispravno: „Marko reče: „Idem kući.""',
    sentence_with_commas: 'Marko reče: „Idem kući."'
  },
  {
    diff: 'mid',
    text: 'Sutra ujutro idem u školu',
    correct: [], // kratki prilog vremena na početku — bez zareza
    rule: 'Kratki prilog vremena na početku NE zahtijeva zarez. „Sutra ujutro" je kratko.',
    sentence_with_commas: 'Sutra ujutro idem u školu.'
  },
  {
    diff: 'mid',
    text: 'Petar moj kolega s posla rekao mi je istinu',
    correct: [1, 5], // apozicija „moj kolega s posla"
    rule: 'Apozicija „moj kolega s posla" odvaja zarezima s obje strane.',
    sentence_with_commas: 'Petar, moj kolega s posla, rekao mi je istinu.'
  },
  {
    diff: 'mid',
    text: 'Volim ga jer je dobar prijatelj',
    correct: [], // glavna prije zavisne — NEMA zareza
    rule: 'Glavna rečenica prije zavisne („jer..."): NEMA zareza. Zarez bi bio greška.',
    sentence_with_commas: 'Volim ga jer je dobar prijatelj.'
  },
  {
    diff: 'mid',
    text: 'Sastat ćemo se 15 svibnja u 14 sati',
    correct: [], // datum + sat na kraju, sve OK bez zareza
    rule: 'Datum i vrijeme bez zareza kad slijede uobičajeno (na kraju).',
    sentence_with_commas: 'Sastat ćemo se 15. svibnja u 14 sati.'
  },
  {
    diff: 'mid',
    text: 'Idem kući i učim za maturu',
    correct: [], // sastavni veznik „i" — NEMA zarez
    rule: 'Sastavni veznik „i" — NEMA zarez. „Idem kući i učim" — bez zareza.',
    sentence_with_commas: 'Idem kući i učim za maturu.'
  },
  
  // HARD (5)
  {
    diff: 'hard',
    text: 'Iako sam bio umoran ipak sam završio zadaću jer sam obećao',
    correct: [3], // poslije „umoran" (zavisna „iako" na početku — zarez)
    rule: 'Zavisna „iako" na početku — zarez. „Jer" iza glavne — NEMA zarez.',
    sentence_with_commas: 'Iako sam bio umoran, ipak sam završio zadaću jer sam obećao.'
  },
  {
    diff: 'hard',
    text: 'Marko moj najbolji prijatelj rekao mi je da neće doći jer ima previše posla',
    correct: [1, 5], // samo apozicija
    rule: 'Apozicija „moj najbolji prijatelj" — zarezi. „Da" sastavni veznik — NEMA zarez. „Jer" iza glavne — NEMA zarez.',
    sentence_with_commas: 'Marko, moj najbolji prijatelj, rekao mi je da neće doći jer ima previše posla.'
  },
  {
    diff: 'hard',
    text: 'Kupio sam: jabuke kruške banane mlijeko jaja a zaboravio kruh',
    correct: [3, 4, 5, 6, 7], // nabrajanje + suprotni „a"
    rule: 'Nabrajanje voća/proizvoda + suprotni veznik „a" — zarez prije.',
    sentence_with_commas: 'Kupio sam: jabuke, kruške, banane, mlijeko, jaja, a zaboravio kruh.'
  },
  {
    diff: 'hard',
    text: 'On dakle nije razumio o čemu se radi i to je očito',
    correct: [1, 2], // umetnuto „dakle" (a sastavni „i" NEMA zarez)
    rule: 'Umetnuta riječ „dakle" — zarezi. Sastavni veznik „i" — NEMA zarez.',
    sentence_with_commas: 'On, dakle, nije razumio o čemu se radi i to je očito.'
  },
  {
    diff: 'hard',
    text: 'Ana koja je moja prijateljica iz srednje škole pitala me je za savjet',
    correct: [1, 6], // apozicija/odnosna umetnuta
    rule: 'Umetnuta odnosna rečenica „koja je moja prijateljica iz srednje škole" — zarezi s obje strane.',
    sentence_with_commas: 'Ana, koja je moja prijateljica iz srednje škole, pitala me je za savjet.'
  }
];
...
const PROOF_STORAGE_KEY = 'mt.hrv.h26.proof_history';
...
function proofShowIntro(){
  const wrap = document.getElementById('pr-wrap');
  if(!wrap) return;
  
  const easy = PROOF_SENTENCES.filter(s => s.diff === 'easy').length;
  const mid = PROOF_SENTENCES.filter(s => s.diff === 'mid').length;
  const hard = PROOF_SENTENCES.filter(s => s.diff === 'hard').length;
  
  wrap.innerHTML = \`
    <div class="pr-intro">
      <div class="pr-intro-icon">🔧</div>
      <div class="pr-intro-title">Proofreading mode</div>
      <div class="pr-intro-sub">Klikni gdje misliš da treba zarez · 20 rečenica</div>
      
      <div class="pr-intro-stats">
        <div class="sd-stat"><div class="sd-stat-num">\${easy}</div><div class="sd-stat-lbl">EASY</div></div>
        <div class="sd-stat"><div class="sd-stat-num">\${mid}</div><div class="sd-stat-lbl">MEDIUM</div></div>
        <div class="sd-stat"><div class="sd-stat-num">\${hard}</div><div class="sd-stat-lbl">HARD</div></div>
      </div>
      
      <div class="pr-intro-tips">
        <strong>Kako radi:</strong> svaka rečenica je <strong>bez interpunkcije</strong>. Klikni na <strong>razmake između riječi</strong> gdje misliš da treba zarez. Zelena ✓ = točno, crvena ✗ = krivo. Na kraju vidiš sva pravila.
        <br><br>
        <strong>💡 Trik:</strong> neke rečenice su <strong>zamke</strong> — NE trebaju zarez! Pazi na anti-pravila (ne pred „i", ne pred „jer" iza glavne, ne pred „kao").
        <br><br>
        <strong>⌨️ Tipke:</strong> <kbd>ENTER</kbd> za provjeriti, <kbd>H</kbd> za hint, <kbd>ESC</kbd> za prekid.
      </div>
      
      <div class="pr-level-select">
        <button type="button" class="pr-level-btn active" onclick="proofStart('all', this)">SVE (\${PROOF_SENTENCES.length})</button>
        <button type="button" class="pr-level-btn" onclick="proofStart('easy', this)">EASY (\${easy})</button>
        <button type="button" class="pr-level-btn" onclick="proofStart('mid', this)">MEDIUM (\${mid})</button>
        <button type="button" class="pr-level-btn" onclick="proofStart('hard', this)">HARD (\${hard})</button>
      </div>
    </div>
  \`;
}

function proofStart(level, btn){
  if(btn){
    document.querySelectorAll('.pr-level-btn').forEach(b => b.classList.remove('active'));
    btn.classList.add('active');
  }
  
  proofState.level = level;
  proofState.filtered = level === 'all' 
    ? [...PROOF_SENTENCES].sort(() => Math.random() - 0.5)
    : PROOF_SENTENCES.filter(s => s.diff === level).sort(() => Math.random() - 0.5);
  proofState.idx = 0;
  proofState.scoreCorrect = 0;
  proofState.scoreWrong = 0;
  proofState.totalSeen = 0;
  proofState.totalCorrect = 0;
  
  proofRenderSentence();
}

function proofRenderSentence(){
  if(proofState.idx >= proofState.filtered.length){
    return proofShowFinalResult();
  }
  
  const item = proofState.filtered[proofState.idx];
  proofState.userClicks = new Set();
  proofState.hintUsed = false;
  ...
  const diffEmoji = item.diff === 'easy' ? '🟢' : item.diff === 'mid' ? '🟡' : '🔴';
  const diffLabel = item.diff === 'easy' ? 'EASY' : item.diff === 'mid' ? 'MEDIUM' : 'HARD';
  
  // Build interactive sentence
  let sentenceHTML = '';
  for(let i = 0; i < words.length; i++){
    sentenceHTML += \`<span class="pr-word">\${words[i]}</span>\`;
    if(i < words.length - 1){
      // Click target between word i and i+1, indexed as i+1 (the space after word i)
      const idx = i + 1;
      sentenceHTML += \`<span class="pr-gap" onclick="proofClick(\${idx}, this)" data-idx="\${idx}"></span>\`;
    }
  }
  ...
  wrap.innerHTML = \`
    <div class="pr-game">
      <div class="pr-hud">
        <div class="pr-hud-progress">
          <span class="pr-hud-label">Rečenica</span>
          <span class="pr-hud-value">\${proofState.idx + 1} / \${proofState.filtered.length}</span>
        </div>
        <div class="pr-hud-diff">\${diffEmoji} \${diffLabel}</div>
        <div class="pr-hud-score">
          <span class="pr-hud-label">Točno</span>
          <span class="pr-hud-value">\${proofState.scoreCorrect}</span>
        </div>
        <button type="button" class="sd-hud-quit" onclick="proofQuit()" title="Prekini">✕</button>
      </div>
      
      <div class="pr-instr">Klikni razmake gdje treba zarez:</div>
      
      <div class="pr-sentence" id="pr-sentence">
        \${sentenceHTML}
      </div>
      
      <div class="pr-counter">
        Klikova: <strong id="pr-clicks">0</strong> · Treba zareza: <strong id="pr-needed">\${totalCorrect === 0 ? 'možda 0 (zamka!)' : totalCorrect}</strong>
      </div>
      
      <div class="pr-actions">
        <button type="button" class="nb-btn" onclick="proofHint()" id="pr-hint-btn">💡 Hint</button>
        <button type="button" class="nb-btn primary" onclick="proofCheck()">✓ Provjeri</button>
      </div>
...
function proofClick(idx, el){
  if(proofState.userClicks.has(idx)){
    proofState.userClicks.delete(idx);
    el.classList.remove('selected');
  } else {
    proofState.userClicks.add(idx);
    el.classList.add('selected');
  }
  // Update counter
  const counter = document.getElementById('pr-clicks');
  if(counter) counter.textContent = proofState.userClicks.size;
}

function proofHint(){
  const item = proofState.filtered[proofState.idx];
  if(!item) return;
  proofState.hintUsed = true;
  
  const fb = document.getElementById('pr-feedback');
  if(fb){
    const totalNeeded = item.correct.length;
    const hintText = totalNeeded === 0
      ? '💡 Hint: ova rečenica NE treba zarez! Pazi na anti-pravila.'
      : \`💡 Hint: trebaš \${totalNeeded} zarez\${totalNeeded === 1 ? '' : 'a'}. \${item.rule}\`;
    fb.innerHTML = \`<div class="pr-feedback-hint">\${hintText}</div>\`;
  }
...
function proofCheck(){
  ...
  const userPositions = Array.from(proofState.userClicks).sort((a,b) => a-b);
  const correctPositions = [...item.correct].sort((a,b) => a-b);
  
  // Compare
  const userSet = new Set(userPositions);
  const correctSet = new Set(correctPositions);
  
  const correctlyPlaced = correctPositions.filter(p => userSet.has(p));
  const missed = correctPositions.filter(p => !userSet.has(p));
  const extra = userPositions.filter(p => !correctSet.has(p));
  
  // Visual feedback on each gap
  const gaps = document.querySelectorAll('.pr-gap');
  gaps.forEach(gap => {
    const idx = parseInt(gap.dataset.idx, 10);
    gap.style.pointerEvents = 'none';
    
    if(correctSet.has(idx) && userSet.has(idx)){
      // Correctly placed
      gap.classList.add('correct-placed');
      gap.innerHTML = ',';
    } else if(correctSet.has(idx) && !userSet.has(idx)){
      // Missed
      gap.classList.add('missed');
      gap.innerHTML = ',';
    } else if(!correctSet.has(idx) && userSet.has(idx)){
      // Suvišni (extra)
      gap.classList.add('extra');
      gap.innerHTML = '✗';
    }
  });
  
  // Update score
  const isFullyCorrect = missed.length === 0 && extra.length === 0;
  if(isFullyCorrect){
    proofState.scoreCorrect++;
    proofState.totalCorrect++;
  } else {
    proofState.scoreWrong++;
  }
  proofState.totalSeen++;
  
  // Show detailed feedback
  const fb = document.getElementById('pr-feedback');
  if(fb){
    let html = '<div class="pr-feedback-result">';
    
    if(isFullyCorrect){
      html += \`<div class="pr-feedback-ok"><strong>✅ Točno!</strong> \${item.rule}</div>\`;
    } else {
      html += '<div class="pr-feedback-no">';
      html += '<strong>❌ Nije točno.</strong>';
      if(missed.length > 0) html += \` Propustio si \${missed.length} zarez\${missed.length === 1 ? '' : 'a'}.\`;
      if(extra.length > 0) html += \` Suvišnih: \${extra.length}.\`;
      html += \`<div class="pr-feedback-rule"><strong>Pravilo:</strong> \${item.rule}</div>\`;
      html += \`<div class="pr-feedback-correct"><strong>Ispravno:</strong> <span class="pr-correct-sentence">\${item.sentence_with_commas}</span></div>\`;
      html += '</div>';
    }
    
    html += '<button type="button" class="nb-btn primary pr-next-btn" onclick="proofNext()">Sljedeća →</button>';
    html += '</div>';
    fb.innerHTML = html;
  }
...
function proofQuit(){
  if(!confirm('Prekinuti Proofreading? Rezultat se neće spremiti.')) return;
  proofShowIntro();
}

function proofShowFinalResult(){
  const total = proofState.filtered.length;
  const correct = proofState.scoreCorrect;
  const accuracy = total > 0 ? Math.round(correct / total * 100) : 0;
  
  // Save to history
  proofSaveResult({
    level: proofState.level,
    correct: correct,
    total: total,
    accuracy: accuracy,
    ts: Date.now()
  ...
  let msg, color, emoji;
  if(accuracy >= 90){ msg = 'Pravopisni majstor!'; color = 'var(--gold)'; emoji = '🏆'; }
  else if(accuracy >= 75){ msg = 'Odličan rezultat!'; color = 'var(--green)'; emoji = '🌟'; }
  else if(accuracy >= 60){ msg = 'Solidan napredak.'; color = 'var(--blue)'; emoji = '💪'; }
  else if(accuracy >= 40){ msg = 'Treba još vježbe.'; color = 'var(--bronze)'; emoji = '📚'; }
  else { msg = 'Vrati se na teoriju i pokušaj opet.'; color = 'var(--red)'; emoji = '💡'; }
  ...
  wrap.innerHTML = \`
    <div class="sd-result">
      ...
      <div class="sd-result-stats">
        <div class="sd-result-stat">
          <div class="sd-result-stat-num" style="color:\${color}">\${correct}</div>
          <div class="sd-result-stat-lbl">točnih</div>
        </div>
        <div class="sd-result-stat">
          <div class="sd-result-stat-num">\${total}</div>
          <div class="sd-result-stat-lbl">ukupno</div>
        </div>
        <div class="sd-result-stat">
          <div class="sd-result-stat-num">\${accuracy}%</div>
          <div class="sd-result-stat-lbl">točnost</div>
        </div>
      </div>
      
      <div class="sd-result-actions">
        <button type="button" class="nb-btn primary" onclick="proofStart('\${proofState.level}')">🔁 Pokušaj opet</button>
        <button type="button" class="nb-btn" onclick="proofShowIntro()">📊 Statistika</button>
      </div>
    </div>
  \`;
...
function proofSaveResult(result){
  let history = [];
  try {
  ...
  try {
    localStorage.setItem(PROOF_STORAGE_KEY, JSON.stringify(history));
  } catch(e){}
}

function proofGetHistory(){
  try {
    const stored = localStorage.getItem(PROOF_STORAGE_KEY);
...
function proofRenderHistory(){
  const el = document.getElementById('pr-history-content');
  if(!el) return;
  
  const history = proofGetHistory();
  if(history.length === 0){
    el.innerHTML = 'Nema završenih sesija. Pokreni Proofreading da vidiš svoj napredak.';
    return;
  }
  
  const best = history.reduce((b, h) => h.accuracy > b.accuracy ? h : b, history[0]);
  
  el.innerHTML = \`
    <div class="sd-hist-best">
      <strong>🏆 Najbolji rezultat:</strong> \${best.correct}/\${best.total} (\${best.accuracy}%) na razini <strong>\${best.level.toUpperCase()}</strong>
    </div>
    <div class="sd-hist-recent">
      ...
      \${history.slice(0, 5).map(h => {
        ...
        return \`<div class="sd-hist-row">
          <span class="sd-hist-date">\${dateStr} · \${h.level}</span>
          <span class="sd-hist-score"><strong>\${h.correct}</strong>/\${h.total}</span>
...
// Keyboard shortcuts for Proofreading mode
document.addEventListener('keydown', function(e){
  // Only active when on Proofreading tab
  const proofTab = document.getElementById('l6');
  if(!proofTab || !proofTab.classList.contains('on')) return;
  // Don't trigger if user is typing in input
  if(document.activeElement && (document.activeElement.tagName === 'INPUT' || document.activeElement.tagName === 'TEXTAREA')) return;
  
  // ENTER = check (if available)
  if(e.key === 'Enter'){
    const checkBtn = document.querySelector('.pr-actions button.primary');
    if(checkBtn && !checkBtn.disabled){
      checkBtn.click();
      e.preventDefault();
    } else {
      // Maybe "next" button is shown
  ...
  // H = hint
  if(e.key === 'h' || e.key === 'H'){
    const hintBtn = document.getElementById('pr-hint-btn');
...
if(document.readyState === 'loading'){
  document.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => { if(typeof proofInit === 'function') proofInit(); }, 200);
  });
} else {
  setTimeout(() => { if(typeof proofInit === 'function') proofInit(); }, 200);
}
...
const INTERP_QS = [
  // ━━━ ZAREZ (25) ━━━
  {cat:'zarez', q:\`Volim ga ___ ali se ljutim.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Suprotni veznik „ali" — UVIJEK zarez prije.\`},
  {cat:'zarez', q:\`Marko ___ moj prijatelj ___ došao je.\`, opts:[\`, ,\`, \`(bez znakova)\`], correct:0, e:\`Apozicija = sendvič od zareza s OBJE strane.\`},
  {cat:'zarez', q:\`Idem kući ___ i učim.\`, opts:[\`,\`, \`(bez zareza)\`], correct:1, e:\`„i, pa, te" obično NEMAJU zarez.\`},
  {cat:'zarez', q:\`Marko ___ dođi ovamo.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Vokativ — zarez nakon imena.\`},
  {cat:'zarez', q:\`Kad dođem ___ javit ću ti.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Zavisna „kad" na početku — zarez nakon nje.\`},
  {cat:'zarez', q:\`Javit ću ti ___ kad dođem.\`, opts:[\`,\`, \`(bez znaka)\`], correct:1, e:\`Zavisna iza glavne — NEMA zareza.\`},
  {cat:'zarez', q:\`Volim ga ___ jer je dobar.\`, opts:[\`,\`, \`(bez znaka)\`], correct:1, e:\`„Jer" iza glavne — NEMA zareza. (Anti-pravilo!)\`},
  {cat:'zarez', q:\`On ___ međutim ___ nije došao.\`, opts:[\`, ,\`, \`(bez znakova)\`], correct:0, e:\`Umetnuta riječ „međutim" — zarezi s obje strane.\`},
  {cat:'zarez', q:\`Kupio sam kruh ___ mlijeko ___ jaja i sir.\`, opts:[\`, ,\`, \`(bez znakova)\`], correct:0, e:\`Nabrajanje — zarezi između, NE prije zadnjeg „i".\`},
  {cat:'zarez', q:\`Marko ___ je došao.\`, opts:[\`,\`, \`(bez znaka)\`], correct:1, e:\`NIKAD zarez između subjekta i predikata!\`},
  {cat:'zarez', q:\`Ne idem ___ nego ostajem.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Suprotni veznik „nego" — UVIJEK zarez prije.\`},
  {cat:'zarez', q:\`Plavi ___ kao nebo.\`, opts:[\`,\`, \`(bez znaka)\`], correct:1, e:\`„Kao" za usporedbu — NEMA zareza.\`},
  {cat:'zarez', q:\`Ako budeš pošten ___ uspjet ćeš.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Zavisna „ako" na početku — zarez.\`},
  {cat:'zarez', q:\`Bože ___ pomozi mi.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Vokativ „Bože" — zarez nakon.\`},
  {cat:'zarez', q:\`Sutra ___ idem u školu.\`, opts:[\`,\`, \`(bez znaka)\`], correct:1, e:\`Kratki prilog vremena — bez zareza.\`},
  {cat:'zarez', q:\`Iako je teško ___ nastavit ću.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Zavisna „iako" na početku — zarez.\`},
  {cat:'zarez', q:\`Rekao je ___ da dolazi.\`, opts:[\`,\`, \`(bez znaka)\`], correct:1, e:\`„Da" iza glagola govora — NEMA zareza. (Anti-pravilo!)\`},
  {cat:'zarez', q:\`Bio je 5. ožujka 2025. ___ a vratio se 10.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Datum + suprotni veznik „a" — zarez.\`},
  {cat:'zarez', q:\`O ___ kako lijepo.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Usklik „O" — zarez nakon.\`},
  {cat:'zarez', q:\`Što hoćeš ___ Petre?\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Vokativ na kraju — zarez prije.\`},
  {cat:'zarez', q:\`Volim ga ___ ne i Maru.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Implicitni „ali" — zarez označava suprotnost.\`},
  {cat:'zarez', q:\`Naime ___ Marko je već otišao.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Modalna riječ „naime" na početku — zarez nakon nje.\`},
  {cat:'zarez', q:\`Voltaire ___ francuski filozof ___ napisao je Candide.\`, opts:[\`, ,\`, \`(bez znakova)\`], correct:0, e:\`Apozicija „francuski filozof" — zarezi s obje strane.\`},
  {cat:'zarez', q:\`Naprijed ___ vojnici.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Vokativ „vojnici" — zarez prije.\`},
  {cat:'zarez', q:\`Zagreb je glavni grad ___ a Split nije.\`, opts:[\`,\`, \`(bez znaka)\`], correct:0, e:\`Suprotni veznik „a" — zarez prije.\`},

  // ━━━ CRTICA / SPOJNICA (20) ━━━
  {cat:'cs', q:\`Marko ___ moj prijatelj ___ došao je.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za umetanje misli (jača od zareza).\`},
  {cat:'cs', q:\`crno ___ bijeli\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za složenice s ravnopravnim dijelovima.\`},
  {cat:'cs', q:\`hrvatsko ___ engleski rječnik\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za jezike/države u složenicama.\`},
  {cat:'cs', q:\`str. 10 ___ 15\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za RASPON (od—do).\`},
  {cat:'cs', q:\`gore ___ dolje\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za smjerove/suprotnosti.\`},
  {cat:'cs', q:\`2 ___ 3 dana\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za manje raspone brojeva.\`},
  {cat:'cs', q:\`Dijalog: ___ Što radiš? ___ Učim.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za promjenu govornika u dijalogu.\`},
  {cat:'cs', q:\`malo ___ pomalo\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za reduplikaciju koja izražava postupnost.\`},
  {cat:'cs', q:\`1990 ___ 2000.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za vremenski raspon (godine).\`},
  {cat:'cs', q:\`crveno ___ bijelo ___ plavi\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za više boja u složenici.\`},
  {cat:'cs', q:\`Knjiga ___ koju sam čitao ___ bila je zanimljiva.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za umetanje misli (alternativa zarezu).\`},
  {cat:'cs', q:\`lijevo ___ desno\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za smjerove.\`},
  {cat:'cs', q:\`Zagreb ___ Split (autocesta)\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za prostorni raspon (gradovi).\`},
  {cat:'cs', q:\`srpsko ___ hrvatski\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za politički termin (dva ravnopravna jezika).\`},
  {cat:'cs', q:\`I onda ___ tišina.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za dramski naglasak (suspense).\`},
  {cat:'cs', q:\`naprijed ___ natrag\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za smjerove/suprotnosti.\`},
  {cat:'cs', q:\`5 ___ 6 metara\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za manje raspone.\`},
  {cat:'cs', q:\`Hrvatska ___ službeni od 2013. ___ ima ISO kod hrv.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za umetnuto pojašnjenje.\`},
  {cat:'cs', q:\`francusko ___ njemački sporazum\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:1, e:\`Spojnica „-" za odnos između država.\`},
  {cat:'cs', q:\`O ___ kakva tragedija.\`, opts:[\`crtica „—"\`, \`spojnica „-"\`], correct:0, e:\`Crtica „—" za usklik/dramski naglasak (alternativa zarezu).\`},

  // ━━━ NAVODNICI (20) ━━━
  {cat:'nav', q:\`Hrvatski navodnici:\`, opts:[\`„dolje gore"\`, \`"oba gore"\`], correct:0, e:\`Hrvatski standard: „dolje gore" („...").\`},
  {cat:'nav', q:\`Naslov knjige Glembajevi:\`, opts:[\`„Glembajevi"\`, \`"Glembajevi"\`], correct:0, e:\`Hrvatski navodnici „...", ne engleski.\`},
  {cat:'nav', q:\`Citat unutar citata:\`, opts:[\`'jednostruki'\`, \`„dvostruki"\`], correct:0, e:\`Vanjski: „...". Unutarnji: '...' (jednostruki).\`},
  {cat:'nav', q:\`Marko reče ___ Idem kući.\`, opts:[\`:\`, \`,\`], correct:0, e:\`Direktan govor uvodi se DVOTOČJEM, ne zarezom!\`},
  {cat:'nav', q:\`„Idem kući ___ reče Marko.\`, opts:[\`," \`, \`." \`], correct:0, e:\`Iza citata + glagol: zarez UNUTAR navodnika.\`},
  {cat:'nav', q:\`Engleski stil "Marko" je u hrvatskom:\`, opts:[\`pogrešan\`, \`ispravan\`], correct:0, e:\`Engleski "..." nije hrvatski standard.\`},
  {cat:'nav', q:\`Naslov filma „Tko je pjevao tamo?"\`, opts:[\`s upitnikom unutar\`, \`s upitnikom izvan\`], correct:0, e:\`Upitnik je dio NASLOVA — unutar navodnika.\`},
  {cat:'nav', q:\`„On je pravi ___ genije" matematike. (sarkazam)\`, opts:[\`„\`, \`(bez navodnika)\`], correct:0, e:\`Navodnici označavaju ironiju/sarkazam.\`},
  {cat:'nav', q:\`Knjiga kaže: ___ Vrijeme je relativno.\`, opts:[\`„\`, \`(bez navodnika)\`], correct:0, e:\`Citat se uvodi navodnicima.\`},
  {cat:'nav', q:\`Indirektni govor: „Rekao je da dolazi"\`, opts:[\`bez navodnika\`, \`s navodnicima\`], correct:0, e:\`Indirektni govor BEZ navodnika i bez dvotočja.\`},
  {cat:'nav', q:\`Tzv. „eksperti" tvrde:\`, opts:[\`s navodnicima (rezerve)\`, \`bez navodnika\`], correct:0, e:\`Navodnici za riječ s rezervom/ironijom.\`},
  {cat:'nav', q:\`„Stani!" povikne.\`, opts:[\`bez zareza prije povikne\`, \`sa zarezom prije povikne\`], correct:0, e:\`Iza usklika u navodnicima — bez zareza prije „povikne".\`},
  {cat:'nav', q:\`Hrvatska enciklopedija — naslov:\`, opts:[\`„Hrvatska enciklopedija"\`, \`"Hrvatska enciklopedija"\`], correct:0, e:\`Hrvatski navodnici za naslov.\`},
  {cat:'nav', q:\`Pitao je ___ Što radiš?\`, opts:[\`:\`, \`,\`], correct:0, e:\`Direktno pitanje uvodi se dvotočjem.\`},
  {cat:'nav', q:\`Marko reče: „Pitao me je: ___ Idem li?"\`, opts:[\`'\`, \`„\`], correct:0, e:\`Citat unutar citata = jednostruki navodnici '...'.\`},
  {cat:'nav', q:\`Naš ___ prijatelj" nas je izdao. (sarkazam)\`, opts:[\`„\`, \`(bez navodnika)\`], correct:0, e:\`Navodnici za sarkazam — označavaju ne-doslovno značenje.\`},
  {cat:'nav', q:\`Časopis ___ Forum" izlazi mjesečno.\`, opts:[\`„\`, \`'\`], correct:0, e:\`Naslov časopisa = dvostruki hrvatski navodnici.\`},
  {cat:'nav', q:\`Korištenje "..." u hrvatskom je:\`, opts:[\`pravopisna greška\`, \`ispravno (alternativa)\`], correct:0, e:\`Engleski "..." je pravopisna greška u hrvatskom.\`},
  {cat:'nav', q:\`„Idem kući", „rekao je Marko" — ovdje:\`, opts:[\`zarez UNUTAR navodnika\`, \`zarez IZVAN navodnika\`], correct:0, e:\`Iza citata + glagol — zarez ide UNUTAR navodnika.\`},
  {cat:'nav', q:\`Krleža „Glembajevi" — što je u navodnicima?\`, opts:[\`naslov djela\`, \`prezime autora\`], correct:0, e:\`Naslov knjige u navodnicima, autor bez navodnika.\`},

  // ━━━ ZAVRŠNI ZNAKOVI (15) ━━━
  {cat:'zz', q:\`Što radiš ___\`, opts:[\`?\`, \`.\`], correct:0, e:\`Direktno pitanje — upitnik.\`},
  {cat:'zz', q:\`Bravo ___\`, opts:[\`!\`, \`.\`], correct:0, e:\`Usklik — uskličnik.\`},
  {cat:'zz', q:\`Marko je došao ___\`, opts:[\`.\`, \`?\`], correct:0, e:\`Izjavna rečenica — točka.\`},
  {cat:'zz', q:\`Pitao je što radim ___\`, opts:[\`.\`, \`?\`], correct:0, e:\`Indirektno pitanje — TOČKA, ne upitnik!\`},
  {cat:'zz', q:\`Mislim ___ ne znam što reći.\`, opts:[\`...\`, \`,\`], correct:0, e:\`Trotočje — nedovršena misao.\`},
  {cat:'zz', q:\`Skraćenica „doktor":\`, opts:[\`dr.\`, \`dr\`], correct:0, e:\`Skraćenice imaju TOČKU iza.\`},
  {cat:'zz', q:\`Datum 25. travnja:\`, opts:[\`s točkom iza dana\`, \`bez točke\`], correct:0, e:\`Redni broj (dan) ima TOČKU.\`},
  {cat:'zz', q:\`Akronim HAZU:\`, opts:[\`bez točaka\`, \`s točkama (H.A.Z.U.)\`], correct:0, e:\`Akronimi BEZ točaka.\`},
  {cat:'zz', q:\`Decimalna brojka 3,14 ili 3.14?\`, opts:[\`3,14 (zarez)\`, \`3.14 (točka)\`], correct:0, e:\`Hrvatski: zarez kao decimalni separator.\`},
  {cat:'zz', q:\`Trotočje — broj točaka:\`, opts:[\`tri (...)\`, \`pet (.....)\`], correct:0, e:\`Trotočje je UVIJEK tri točke.\`},
  {cat:'zz', q:\`Naredba „Sjedni ___"\`, opts:[\`!\`, \`.\`], correct:0, e:\`Naredba — uskličnik.\`},
  {cat:'zz', q:\`Suvišni uskličnici (!!!) su:\`, opts:[\`amaterski stil\`, \`pojačanje\`], correct:0, e:\`Više od 1 uskličnika je amaterski.\`},
  {cat:'zz', q:\`Stoljeće — kako pisati?\`, opts:[\`19. stoljeće\`, \`19 stoljeće\`], correct:0, e:\`Redni broj (stoljeće) — točka iza.\`},
  {cat:'zz', q:\`Pitanje s vokativom: „Što radiš ___ Petre?"\`, opts:[\`,\`, \`(bez znaka prije Petre)\`], correct:0, e:\`Vokativ na kraju pitanja — zarez prije njega + upitnik na kraju.\`},
  {cat:'zz', q:\`Trotočje — razmak prije?\`, opts:[\`bez razmaka (Mislim...)\`, \`s razmakom (Mislim ...)\`], correct:0, e:\`Trotočje BEZ razmaka prije („Mislim...").\`},

  // ━━━ TOČKA-ZAREZ / DVOTOČJE (15) ━━━
  {cat:'td', q:\`Razlog je jasan ___ nema vremena.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje uvodi POJAŠNJENJE.\`},
  {cat:'td', q:\`Donijeti ___ kruh, jaja, mlijeko.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje uvodi POPIS.\`},
  {cat:'td', q:\`Volim ga ___ nije savršen, ali je moj.\`, opts:[\`;\`, \`:\`], correct:0, e:\`Točka-zarez za srodne, ali samostalne dijelove.\`},
  {cat:'td', q:\`Marko reče ___ „Idem kući."\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje za uvod u CITAT.\`},
  {cat:'td', q:\`Točka-zarez (;) je:\`, opts:[\`jača od zareza, slabija od točke\`, \`jača od točke\`], correct:0, e:\`Hijerarhija: , < ; < .\`},
  {cat:'td', q:\`Pravila su sljedeća ___ bez vrijeđanja, bez kašnjenja.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje uvodi popis pravila.\`},
  {cat:'td', q:\`Mladi sanjaju o budućnosti ___ stariji vide prošlost.\`, opts:[\`;\`, \`:\`], correct:0, e:\`Točka-zarez za suprotstavljene cjeline.\`},
  {cat:'td', q:\`Postoji jedno pravilo ___ budi iskren.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje za uvod u PRAVILO/POJAŠNJENJE.\`},
  {cat:'td', q:\`Knjige uče ___ iskustvo formira.\`, opts:[\`;\`, \`:\`], correct:0, e:\`Točka-zarez za naglašenu suprotnost srodnih cjelina.\`},
  {cat:'td', q:\`Hijerarhija najjača crtica?\`, opts:[\`— (em-dash)\`, \`, (zarez)\`], correct:0, e:\`Crtica „—" je najnaglašenija (umetanje, drama).\`},
  {cat:'td', q:\`Vrijeme je ograničeno ___ iskoristi ga.\`, opts:[\`;\`, \`:\`], correct:0, e:\`Točka-zarez spaja srodne, ali samostalne misli.\`},
  {cat:'td', q:\`Posjetio sam ___ Zagreb, glavni grad RH; Split, drugi grad.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje uvodi popis.\`},
  {cat:'td', q:\`Učio sam cijelu noć ___ prošao sam ispit.\`, opts:[\`;\`, \`,\`], correct:0, e:\`Točka-zarez za povezane samostalne rečenice.\`},
  {cat:'td', q:\`Imam jedan zahtjev ___ stigni na vrijeme.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje uvodi pojašnjenje zahtjeva.\`},
  {cat:'td', q:\`Studije ___ Filozofski fakultet, Zagreb; FER, Zagreb.\`, opts:[\`:\`, \`;\`], correct:0, e:\`Dvotočje za uvod u dugi popis (s točkama-zarezima unutar).\`},
];
...
function interpResultInline(containerId){
  ...
  // Save best score
  const storageKey = 'mt.hrv.h26.quiz_' + state.catKey + '_best';
  let prevBest = 0;
...
function interpInitInline(){
  ...
  interpStartInline('zarez', 'zarez-exercise');
  interpStartInline('cs', 'cs-exercise');
  interpStartInline('nav', 'nav-exercise');
  interpStartInline('zz', 'zz-exercise');
  interpStartInline('td', 'td-exercise');
}
...
function updateProgress(pct){
  ...
  try { localStorage.setItem('mt.hrv.h26.prog', p); } catch(e){}
}
/* ══ SIDEBAR ACTIVATION ══ */
...
export default function H26Chapter() {
  return (
    <ChapterWrapper
      chapterId="H26"
      bodyHtml={BODY_HTML}
...
export const HRV_POGAVLJE_26 = null
