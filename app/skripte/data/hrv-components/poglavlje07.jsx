...
import H07ZlocinTab from './H07_ZlocinTab';
import CitatnikH07 from './H07_CitatnikTab';
import H07PojmovnikTab from './H07_PojmovnikTab';
import {
  CompareRealizmRomantizam,
  TimelineRealizam,
  AuthorCardDostojevski,
  TimelineDostojevski,
  AuthorCardOstaliRealisti,
  PopKulturaDostojevski,
  AccordionEsejTezeH07,
} from './H07_Components';
...
<nav class="sidebar" id="sidebar">
  <div id="mt-tier-badge" class="mt-tier-badge mt-tier-badge-free">
    <div class="mt-tier-badge-label">FREE</div>
    <button type="button" class="mt-tier-badge-cta" onclick="MT.Tier.openPricing()">Upgrade &rarr;</button>
  </div>
  <div class="sb-brand">
    <div class="sb-logo">
  ...
  <a class="sb-item active" data-code="h07" href="/skripte/hrv/h07"><span class="sb-dot"></span>H07 · Realizam</a>
...
<div class="content-wrap">
  <div class="bc">
    <span>maturiraj.hr</span><span class="bc-sep">/</span>
    <span>hrvatski</span><span class="bc-sep">/</span>
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div id="h07c-compare"></div>
    <div id="h07c-tl-realizam"></div>
    ...
    <div id="h07c-author-dost"></div>
    <div id="h07c-tl-dost"></div>
    ...
    <div id="h07c-ostali-realisti"></div>
    ...
    <!-- SEC 06 — Dostojevski u suvremenoj kulturi -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">06 · Dostojevski u suvremenoj kulturi</div><div class="sec-line"></div></div>

    <div id="h07c-popkultura"></div>

    <!-- Navigation -->
    <div class="nav-row">
      <a class="nb" href="/skripte/hrv/h06">← H06 · Romantizam</a>
      <span class="nb primary" onclick="sw(1)">📖 Zločin i kazna — deep dive →</span>
    </div>
  </div>

  <!-- ════════════════════════
       TAB 1 · ZLOČIN I KAZNA — rendered by React component H07_ZlocinTab.jsx via portal
       ════════════════════════ -->
  <div class="layer" id="l1" role="tabpanel" tabindex="0"><!-- React portal target --></div>

  <div id="l1-old-html" style="display:none">
    <div class="tags">
...
.wc-hint b{color:var(--t1,#f4ede5)}
    </style>

    <div class="wc-box">
      <div class="wc-hdr">
        <div class="wc-ttl">📝 Vježbaj esej — brojač · min. 440 riječi (NCVVO)</div>
      </div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div class="minirev">
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Djelo i korpus</div><div class="minirev-card-val"><b>Dostojevski: Zločin i kazna</b> kao vrhunac psihološkog realizma i etičkog romana 19. stoljeća.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Kontekst</div><div class="minirev-card-val"><b>Realizam</b> analizira društvo, siromaštvo, institucije i unutarnje mehanizme ljudske savjesti.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Likovi</div><div class="minirev-card-val"><b>Raskoljnikov, Sonja, Porfirij, Svidrigajlov, Dunja</b> — sukob ideje, zakona i moralne obnove.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Središnji sukob</div><div class="minirev-card-val"><b>Teorija nadčovjeka vs savjest</b>; zločin otvara pitanje granica racionalizacije i odgovornosti.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Pojmovi</div><div class="minirev-card-val"><b>psihološki realizam, polifonija, unutarnji monolog, krivnja, iskupljenje</b>.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Simboli</div><div class="minirev-card-val"><b>žuta boja, broj 7, Lazar, križ, Peterburg/Sibir</b> — simbolički sustav romana.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Most</div><div class="minirev-card-val">› Prijelaz prema moderni: raspad stabilnog subjekta, kriza identiteta i fragmentirana svijest.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Najveća greška</div><div class="minirev-card-val">Roman svesti na kriminalističku priču. U središtu je <b>etičko-psihološki eksperiment</b>, ne zaplet sam po sebi.</div></div>
        </div>
        <div class="minirev-quotes"><b style="display:block;font-family:var(--mono);font-size:9.5px;color:var(--bronze-l);letter-spacing:1.5px;font-weight:700;text-transform:uppercase;margin-bottom:8px">3 citata napamet</b><ol><li>„Jesam li ja drhtava uš ili čovjek?” <b>(Raskoljnikov)</b></li><li>„Patnja je velika stvar.” <b>(Dostojevski)</b></li><li>„Nova priča počinje...” <b>(Epilog)</b></li></ol></div>
      </div>
    </div>

    <div class="exam-prompt"><div class="exam-prompt-ttl">📌 Kako se realizam i Zločin i kazna mogu pojaviti na ispitu</div><div class="exam-prompt-task">Analiziraj kako Dostojevski kroz lik Raskoljnikova prikazuje sukob ideje, društvene zbilje i savjesti. Objasni ulogu Sonje i Porfirija u procesu moralne transformacije te pokaži zašto je roman temelj modernog psihološkog pripovijedanja.</div><div class="exam-prompt-tips"><div class="exam-tip"><b>📌 Struktura eseja</b>Uvod (50-60 r.) · 3 razradna odlomka (~120 r. svaki: teorija zločina, psihološka kriza, iskupljenje) · zaključak (60-70 r.) = ~470 r.</div><div class="exam-tip"><b>📌 Citati</b>Koristi 2-3 citata: „Jesam li ja drhtava uš ili čovjek?”, ulomak o patnji, završni motiv epiloga.</div><div class="exam-tip"><b>📌 Povezivanje</b>Poveži H06 i H07: od romantičarske iznimke prema realističkoj analizi društva i psihe; naznači most prema moderni.</div><div class="exam-tip"><b>📚 Pojmovi</b>Psihološki realizam · polifonija · unutarnji monolog · krivnja · iskupljenje · etička odgovornost.</div></div></div>
    ...
    <div class="cp-final" id="cp-final">
      ...
      <div class="cp-actions">
        <button class="fcb primary" onclick="/* signup uklonjen */">H08 · Kafka Preobražaj →</button>
...
.yt-play{width:34px;height:34px;border-radius:50%;background:rgba(255,255,255,.95);color:#0F0605;font-size:13px;display:flex;align-items:center;justify-content:center;padding-left:3px;box-shadow:0 3px 10px rgba(0,0,0,.35);position:relative;z-index:2;transition:transform .2s}
    content:"Maturiraj.hr \xb7 H04 Barok i klasicizam \xb7 8 tabova \xb7 Svrha: priprema za državnu maturu iz Hrvatskog jezika 2025/2026";
/* ══════════════════════════════════════════════════
...
/* ══ WIDGET CSS (moved from inline) ══ */
      ...
      .porf-content-quote{margin-top:12px;padding:10px 14px;background:var(--card);border-left:2px solid var(--bronze);border-radius:0 var(--r2) var(--r2) 0;font-family:var(--serif);font-style:italic;color:var(--t1);font-size:14px;line-height:1.55}
...
function sw(i){
  ...
  if(i===4 && typeof window.initPojmovnikH07 === 'function') setTimeout(window.initPojmovnikH07,0);
...
function fcRender(){
  ...
  document.getElementById('fc-cat-f').textContent=c.cat||'PITANJE';
  document.getElementById('fc-cat-b').textContent='ODGOVOR';
  document.getElementById('fc-term').textContent=c.front||c.term||'';
  document.getElementById('fc-def').innerHTML=c.back||c.def||'';
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrv/h07';
...
(function(window) {
  ...
  function injectSidebarBadge() {
    ...
    let badge = document.getElementById('mt-tier-badge');
    if (!badge) {
...
export default function H07Chapter() {
  useEffect(() => {
    ...
    if (!l1) return;
    const root1 = createRoot(l1);
    root1.render(
      <H07ZlocinTab
        onPrev={() => typeof window.sw === 'function' && window.sw(0)}
        onNext={() => typeof window.sw === 'function' && window.sw(2)}
      />
    );
    ...
    if (l4) {
      root4 = createRoot(l4);
      root4.render(<H07PojmovnikTab />);
    }

    // L0 + L2 portals for H07_Components
    ...
    const rc01 = mountPortal('h07c-author-dost',      <AuthorCardDostojevski context="l0" />);
    const rc02 = mountPortal('h07c-tl-dost',          <TimelineDostojevski />);
    const rc03 = mountPortal('h07c-compare',          <CompareRealizmRomantizam />);
    const rc04 = mountPortal('h07c-tl-realizam',      <TimelineRealizam />);
    const rc05 = mountPortal('h07c-ostali-realisti',  <AuthorCardOstaliRealisti />);
    const rc06 = mountPortal('h07c-popkultura',       <PopKulturaDostojevski />);
    const rc16 = mountPortal('h07c-esej-teze',        <AccordionEsejTezeH07 />);
    ...
    return () => {
      setTimeout(() => {
        ...
        root3?.unmount();
        root4?.unmount();
        [rc01, rc02, rc03, rc04, rc05, rc06, rc16].forEach(r => r?.unmount());
      }, 0);
    };
  }, []);
