...
import CitatnikH14 from './H14_CitatnikTab';
import PojmovnikH14 from './H14_PojmovnikTab';
import {
  AccordionLikovi,
  AccordionPjevanja,
  AccordionStilskaSredstva,
  AccordionTemeIdeje,
  AuthorCardMazuranic,
  CompareBarokPreporod,
  CompareRomantiSmail,
  CompareSmailJudita,
  DiscereBannerPrimaryH14,
  HeroQuoteNocnik,
  HeroQuoteSmail,
  PopKulturaMazuranic,
  SVGTreRazine,
  ...
  TimelineMazuranic,
  VideoCardPrimaryH14,
  VideoCardQuaternaryH14,
  VideoCardSecondaryH14,
  VideoCardTertiaryH14,
} from './H14_Additions';
...
.cheat-col-wide{grid-column:1/-1}
    ...
    <div id="h14-react-author-preporod"></div>
    ...
    <div class="cheat-card cheat-card-printable" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Sve što moraš pamtiti — H14</div>
        </div>
      ...
      <div class="cheat-grid">
        <div class="cheat-col">
          ...
          <table class="cheat-tbl">
            <tr><td><b>Pokret</b></td><td>Hrvatski narodni preporod / ilirizam</td></tr>
            <tr><td><b>Razdoblje</b></td><td>1835.–1848.</td></tr>
            <tr><td><b>Autor</b></td><td>Ivan Mažuranić</td></tr>
            <tr><td><b>Djelo</b></td><td><em>Smrt Smail-age Čengića</em>, romantičarski spjev</td></tr>
            <tr><td><b>Struktura</b></td><td>Agovanje, Noćnik, Četa, Harač, Kob</td></tr>
          </table>
        </div>
        <div class="cheat-col">
          <div class="cheat-col-ttl">Što odmah povezati</div>
          <ul class="cheat-list">
            <li><b>Smail-aga</b> = nasilje, oholost, tiranija.</li>
            <li><b>Novica</b> = prijelaz, moralni izbor, obraćenje.</li>
            <li><b>Četa</b> = kolektivni ideal slobode i otpora.</li>
            <li><b>Kob</b> = moralni rasplet: oholost završava padom.</li>
          </ul>
        </div>
        <div class="cheat-col cheat-col-warn">
          <div class="cheat-col-ttl">Zamke</div>
          <ul class="cheat-list cheat-list-warn">
            <li>Ne čitaj djelo samo kao povijesni izvještaj.</li>
            <li>Ne zaboravi romantičarski kontrast: sloboda vs. tiranija.</li>
            <li>Ne preskoči kompoziciju od 5 pjevanja; često nosi bodove.</li>
          </ul>
        </div>
        <div class="cheat-col">
          <div class="cheat-col-ttl">Mini plan odgovora</div>
          <ol class="cheat-steps">
            <li><b>Lociraj pjevanje:</b> od Agovanja do Kobi.</li>
            <li><b>Odredi razinu:</b> povijesna, moralna, nacionalna.</li>
            <li><b>Dodaj stil:</b> kontrast, hiperbola, patos, deseterac.</li>
            <li><b>Zaključi ideju:</b> sloboda se brani žrtvom i moralnom snagom.</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <!-- DISCERE TOUCHPOINT -->
    <div id="h14-react-discere-banner-primary"></div>
    ...
    <div class="yt-grid">
      <div id="h14-react-video-card-primary"></div>

      <div id="h14-react-video-card-secondary"></div>

      <div id="h14-react-video-card-tertiary"></div>

      <div id="h14-react-video-card-quaternary"></div>
    </div>
...
<div class="nav-row">
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <style>
      .h14d-fc-wrap{display:flex;flex-direction:column;align-items:center;gap:18px;margin:16px 0 24px}
      .h14d-fc-counter{font-family:var(--mono);font-size:11px;color:var(--t3);letter-spacing:1.5px;text-transform:uppercase}
      .h14d-fc-counter b{color:var(--bronze-l)}
      .h14d-fc{width:100%;max-width:520px;min-height:220px;perspective:1500px;cursor:pointer}
      .h14d-fc-inner{position:relative;width:100%;height:100%;min-height:220px;transition:transform .6s cubic-bezier(.4,0,.2,1);transform-style:preserve-3d}
      .h14d-fc.flipped .h14d-fc-inner{transform:rotateY(180deg)}
      .h14d-fc-front,.h14d-fc-back{position:absolute;inset:0;min-height:220px;padding:40px 32px;border-radius:var(--r4);backface-visibility:hidden;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;border:1px solid var(--bdm)}
      .h14d-fc-front{background:linear-gradient(135deg,var(--card),var(--ele))}
      .h14d-fc-back{background:linear-gradient(135deg,rgba(220,50,47,.12),rgba(232,201,122,.05));border-color:var(--bd-br);transform:rotateY(180deg)}
      .h14d-fc-cat{font-family:var(--mono);font-size:9px;letter-spacing:2px;text-transform:uppercase;color:var(--bronze);margin-bottom:12px}
      .h14d-fc-term{font-family:var(--display);font-size:30px;font-weight:700;color:var(--t1);letter-spacing:1px}
      .h14d-fc-hint{font-family:var(--mono);font-size:10px;color:var(--t3);margin-top:22px;letter-spacing:1px}
      .h14d-fc-def{font-family:var(--serif);font-size:16px;line-height:1.65;color:var(--t1);max-width:420px}
      .h14d-fc-controls{display:flex;gap:10px;flex-wrap:wrap;justify-content:center}
      .h14d-fcb{padding:10px 20px;background:var(--card);border:1px solid var(--bdm);border-radius:var(--r2);color:var(--t2);font-family:var(--mono);font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;cursor:pointer;transition:all .2s}
      .h14d-fcb:hover{border-color:var(--bd-br);color:var(--bronze-l)}
      .h14d-fcb.primary{background:linear-gradient(135deg,var(--bronze-d),var(--bronze));color:#F5E6D3;border-color:var(--bronze)}
      .h14d-fcb.know{border-color:var(--bd-g);color:var(--green)}
      .h14d-fcb.know:hover{background:var(--dim-g)}
      .h14d-fcb.dont{border-color:var(--bd-r);color:var(--red)}
      .h14d-fcb.dont:hover{background:var(--dim-r)}
      .h14d-fc-stats{display:flex;gap:20px;margin-top:10px;font-family:var(--mono);font-size:11px}
      .h14d-fc-stats span{color:var(--t3)}
      .h14d-fc-stats b{color:var(--green)}
      .h14d-fc-stats i{color:var(--red);font-style:normal}
    </style>

    <div class="h14d-fc-wrap">
      <div class="h14d-fc-counter"><span id="h14d-fc-num"><b>1</b> / 20</span></div>
      <div class="h14d-fc" id="h14d-fc-card" onclick="h14DrillFcFlip()">
        <div class="h14d-fc-inner" id="h14d-fc-inner">
          <div class="h14d-fc-front">
            <div class="h14d-fc-cat" id="h14d-fc-cat-f">POJAM</div>
            <div class="h14d-fc-term" id="h14d-fc-term">—</div>
            <div class="h14d-fc-hint">Klikni za okretanje</div>
          </div>
          <div class="h14d-fc-back">
            <div class="h14d-fc-cat" id="h14d-fc-cat-b">DEFINICIJA</div>
            <div class="h14d-fc-def" id="h14d-fc-def">—</div>
          </div>
        </div>
      </div>
      <div class="h14d-fc-controls">
        <button class="h14d-fcb dont" onclick="h14DrillFcMark(0)">❌ Ne znam</button>
        <button class="h14d-fcb know" onclick="h14DrillFcMark(1)">✅ Znam</button>
        <button class="h14d-fcb" onclick="h14DrillFcSkip()">Preskoči ›</button>
        <button class="h14d-fcb" onclick="h14DrillFcShuffleAndRender()">📌 Promiješaj</button>
        <button class="h14d-fcb primary" onclick="h14DrillFcReset()">🔁 Reset</button>
      </div>
      <div class="h14d-fc-stats"><span>točno: <b id="h14d-fc-right">0</b></span><span>krivo: <i id="h14d-fc-wrong">0</i></span></div>
    </div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <p>Označi svaku tvrdnju koju <strong>stvarno znaš</strong> — ne samo prepoznaješ, nego možeš objasniti i primijeniti u eseju. Kada označiš svih 10, možeš prijeći na H15.</p>
    ...
    <div class="minirev">
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Djelo i korpus</div><div class="minirev-card-val"><b>Mažuranić: Smrt Smail-age Čengića</b> (5 pjevanja) kao središnje djelo preporodnog razdoblja.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Kontekst</div><div class="minirev-card-val"><b>Narodni preporod</b>: jezik, identitet i politička artikulacija nacije kroz književnost.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Likovi i osi</div><div class="minirev-card-val"><b>Smail-aga, Novica, svećenik, četa</b> — sukob tiranije, savjesti i zajedničkog otpora.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Središnji sukob</div><div class="minirev-card-val"><b>Sila vs pravda</b>; osobni preobražaj i kolektivna borba grade etičku okosnicu spjeva.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Pojmovi</div><div class="minirev-card-val"><b>spjev, romantizam, preporod, motiv preobrazbe, domoljubna ideja</b>.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Simboli</div><div class="minirev-card-val"><b>noć, krv, zakletva, osvetnički pohod</b> — motivi koji nose idejnu i emocionalnu tenziju.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Most</div><div class="minirev-card-val">› <b>H15 Šenoa i realizam</b>: od romantičarskog naboja prema društvenoj analizi stvarnosti.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Najveća greška</div><div class="minirev-card-val">Djelo svesti na „junačku priču”. Na maturi treba pokazati <b>idejnu i kompozicijsku funkciju pjevanja</b>.</div></div>
        </div>
        <div class="minirev-quotes">
          ...
          <ol>
            <li>„Smrt Smail-age Čengića je spjev u 5 pjevanja.” <b>(školska formulacija)</b></li>
            <li>„Novičina preobrazba ključ je etičke osi djela.” <b>(interpretacijska formulacija)</b></li>
            <li>„Djelo spaja romantičarski patos i preporodnu ideju.” <b>(interpretacijska formulacija)</b></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="exam-prompt">
      <div class="exam-prompt-ttl">📌 Kako se Smrt Smail-age Čengića može pojaviti na ispitu</div>
      <div class="exam-prompt-task">Objasni kako Mažuranić u spjevu prikazuje sukob tiranije i pravde te na koji način motiv preobrazbe daje djelu etičku dubinu. U argumentaciji poveži kompoziciju 5 pjevanja, preporodni kontekst i romantičarske postupke.</div>
      <div class="exam-prompt-tips">
        <div class="exam-tip"><b>📌 Struktura eseja</b>Uvod (50-60 r.) · 3 razradna odlomka (~120 r. svaki: kontekst, analiza motiva/likova, idejna poruka) · zaključak (60-70 r.) = ~470 r.</div>
        <div class="exam-tip"><b>📌 Citati</b>Koristi 2-3 citata/formulacije: jedan o kompoziciji, jedan o Novici, jedan o preporodnoj ideji.</div>
        <div class="exam-tip"><b>📌 Povezivanje</b>Poveži H14→H15: preporodni ideali prelaze u šenoinu društvenu i psihološku konkretnost.</div>
        <div class="exam-tip"><b>📚 Pojmovi</b>Spjev · romantizam · preporod · motiv preobrazbe · domoljubna ideja · kompozicija pjevanja.</div>
      </div>
    </div>
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H14 Avangarda — svjetska književnost</div>
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h14.tab') || '0') }catch(e){return 0} })(),
...
/* ═══════════════════════════════════
  FLASHCARDS — H11/H12/H13 style (H14 sadržaj)
═══════════════════════════════════ */
const FC_DATA=[
...
var H14_DRILL_FC_CARDS = FC_DATA.map(function(item){
  return {
...
var h14dFcIdx=0,h14dFcKnown=0,h14dFcUnknown=0,h14dFcOrder=[];
var H14_DRILL_SS_KEY='mt.hrv.h14.drill.fc';
var H14_DRILL_FC_FREE_LIMIT=5;

function h14DrillBeep(f,d,v,t){
  try{
...
function h14DrillSoundOk(){h14DrillBeep(660,.1,.08,'sine');setTimeout(function(){h14DrillBeep(880,.14,.07,'sine')},110)}
function h14DrillSoundNg(){h14DrillBeep(200,.18,.08,'sawtooth')}
function h14DrillSoundDone(){[440,550,660,880].forEach(function(f,i){setTimeout(function(){h14DrillBeep(f,.18,.07,'sine')},i*90)})}

function h14DrillSave(){
  try{sessionStorage.setItem(H14_DRILL_SS_KEY,JSON.stringify({idx:h14dFcIdx,known:h14dFcKnown,unknown:h14dFcUnknown,order:h14dFcOrder,ts:Date.now()}))}catch(e){}
}

function h14DrillRestore(){
  try{
    var raw=sessionStorage.getItem(H14_DRILL_SS_KEY);if(!raw)return false;
    var s=JSON.parse(raw);
    if(!s||!Array.isArray(s.order)||s.order.length!==H14_DRILL_FC_CARDS.length)return false;
    h14dFcIdx=s.idx||0;h14dFcKnown=s.known||0;h14dFcUnknown=s.unknown||0;h14dFcOrder=s.order;
    var r=document.getElementById('h14d-fc-right');if(r)r.textContent=h14dFcKnown;
    var w=document.getElementById('h14d-fc-wrong');if(w)w.textContent=h14dFcUnknown;
    return true;
  }catch(e){return false}
}

function h14DrillFcShuffle(){
  h14dFcOrder=H14_DRILL_FC_CARDS.map(function(_,i){return i});
  for(var i=h14dFcOrder.length-1;i>0;i--){var j=Math.floor(Math.random()*(i+1));var t=h14dFcOrder[i];h14dFcOrder[i]=h14dFcOrder[j];h14dFcOrder[j]=t}
}

function h14DrillFcIsPaid(){
...
function h14DrillFcShowPaywall(){
  var wrap=document.querySelector('.h14d-fc-wrap');
  if(!wrap)return;
  var existing=document.getElementById('h14d-fc-paywall');
  if(existing){if(existing.scrollIntoView)existing.scrollIntoView({behavior:'smooth',block:'center'});return;}
  var chapter=(typeof CURRENT_CHAPTER!=='undefined'&&CURRENT_CHAPTER.code)||'h14';
  var html='<div id="h14d-fc-paywall" class="drill-paywall" data-feature="drill-flashcards">'+
  ...
  if(typeof track==='function'){track('paywall_impression',{feature:'drill-flashcards',chapter:chapter,at_card:h14dFcIdx},'conversion');}
}

function h14DrillFcRender(){
  if(h14dFcOrder.length===0)h14DrillFcShuffle();

  if(!h14DrillFcIsPaid() && h14dFcIdx >= H14_DRILL_FC_FREE_LIMIT){
    var termL=document.getElementById('h14d-fc-term');
    var catFL=document.getElementById('h14d-fc-cat-f');
    var defL=document.getElementById('h14d-fc-def');
    var catBL=document.getElementById('h14d-fc-cat-b');
    var numL=document.getElementById('h14d-fc-num');
    ...
    if(numL)numL.innerHTML='<b>'+H14_DRILL_FC_FREE_LIMIT+'</b> / 20 · <span style="color:var(--gold)">Free limit</span>';
    h14DrillFcShowPaywall();
    return;
  }

  if(h14dFcIdx>=h14dFcOrder.length){
    var t=document.getElementById('h14d-fc-term');
    var d=document.getElementById('h14d-fc-def');
    var cf=document.getElementById('h14d-fc-cat-f');
    var cb=document.getElementById('h14d-fc-cat-b');
    var num=document.getElementById('h14d-fc-num');
    if(t)t.textContent='Gotovo! ✅';
    if(cf)cf.textContent='REZULTAT';
    if(d)d.textContent='Točno: '+h14dFcKnown+' / Krivo: '+h14dFcUnknown+'. Klikni Reset za novi krug.';
    if(cb)cb.textContent='REZULTAT';
    if(num)num.innerHTML='<b>'+h14dFcOrder.length+'</b> / '+h14dFcOrder.length;
    h14DrillSoundDone();
    return;
  }

  var c=H14_DRILL_FC_CARDS[h14dFcOrder[h14dFcIdx]];
  var card=document.getElementById('h14d-fc-card');if(card)card.classList.remove('flipped');
  var catf=document.getElementById('h14d-fc-cat-f');
  var catb=document.getElementById('h14d-fc-cat-b');
  var term=document.getElementById('h14d-fc-term');
  var def=document.getElementById('h14d-fc-def');
  var num2=document.getElementById('h14d-fc-num');
  ...
  if(num2)num2.innerHTML='<b>'+(h14dFcIdx+1)+'</b> / '+h14dFcOrder.length;
}

function h14DrillFcFlip(){var card=document.getElementById('h14d-fc-card');if(card)card.classList.toggle('flipped')}

function h14DrillFcMark(known){
  if(known){h14dFcKnown++;h14DrillSoundOk();}
  else{h14dFcUnknown++;h14DrillSoundNg();}
  var r=document.getElementById('h14d-fc-right');if(r)r.textContent=h14dFcKnown;
  var w=document.getElementById('h14d-fc-wrong');if(w)w.textContent=h14dFcUnknown;
  h14dFcIdx++;
  h14DrillSave();
  setTimeout(h14DrillFcRender,180);
}

function h14DrillFcSkip(){h14dFcIdx++;h14DrillSave();h14DrillFcRender()}

function h14DrillFcShuffleAndRender(){
  h14DrillFcShuffle();
  h14dFcIdx=0;
  h14DrillSave();
  h14DrillFcRender();
...
function h14DrillFcReset(){
  h14dFcIdx=0;h14dFcKnown=0;h14dFcUnknown=0;
  h14DrillFcShuffle();
  try{sessionStorage.removeItem(H14_DRILL_SS_KEY)}catch(e){}
  var r=document.getElementById('h14d-fc-right');if(r)r.textContent=0;
  var w=document.getElementById('h14d-fc-wrong');if(w)w.textContent=0;
  h14DrillFcRender();
}

function h14DrillInit(){if(!h14DrillRestore())h14DrillFcShuffle();h14DrillFcRender()}

function fcInit(){ h14DrillInit(); }
function fcRender(){ h14DrillFcRender(); }
function fcFlip(){ h14DrillFcFlip(); }
function fcNav(dir){
  if(dir>0){h14DrillFcSkip();return;}
  if(dir<0 && h14dFcIdx>0){h14dFcIdx--;h14DrillSave();h14DrillFcRender();}
}
...
export default function H14Chapter() {
  useEffect(() => {
    ...
    const ensureReplace = (id, oldNode) => {
    ...
    const findSecHdr = (root, startsWith) => {
      if (!root) return null;
      const badge = [...root.querySelectorAll('.sec-hdr .sec-badge')].find((el) => (el.textContent || '').includes(startsWith));
      return badge ? badge.closest('.sec-hdr') : null;
    };

    const firstBetween = (start, selector) => {
      if (!start) return null;
      let n = start.nextElementSibling;
      while (n && !n.classList.contains('sec-hdr')) {
    ...
    const removeBetween = (start, selector) => {
      const target = firstBetween(start, selector);
    ...
    const raf = requestAnimationFrame(() => {
      ...
      const l0Tags = l0?.querySelector('.tags');
      if (l0Tags) ensureAfter('h14-react-hero-quote-smail', l0Tags);

      const sec02 = findSecHdr(l0, '02 · Kronologija preporoda');
      const oldTimeline = firstBetween(sec02, '.timeline');
      if (oldTimeline) ensureReplace('h14-react-timeline-mazuranic', oldTimeline);

      const sec04 = findSecHdr(l0, '04 · Smrt Smail-age');
      if (sec04) ensureAfter('h14-react-statcards-smail', sec04);

      const sec06 = findSecHdr(l0, '06 · Glavni likovi');
      const sec06Tbl = firstBetween(sec06, '.tbl-wrap');
      if (sec06Tbl) ensureReplace('h14-react-accordion-likovi', sec06Tbl);

      const sec07 = findSecHdr(l0, '07 · Teme i ideja djela');
      const sec07Grid = firstBetween(sec07, '.sc-grid');
      if (sec07Grid) ensureReplace('h14-react-accordion-teme-ideje', sec07Grid);
      removeBetween(sec07, '.box-key');

      const sec09 = findSecHdr(l0, '09 · Romantizam');
      const sec09Grid = firstBetween(sec09, '.sc-grid');
      if (sec09Grid) ensureAfter('h14-react-compare-romanti-smail', sec09Grid);

      const sec10 = findSecHdr(l0, '10 · Stilska sredstva');
      const sec10Tbl = firstBetween(sec10, '.tbl-wrap');
      if (sec10Tbl) ensureReplace('h14-react-accordion-stilska', sec10Tbl);

      const sec11 = findSecHdr(l0, '11 · H14 i ostalo gradivo');
      if (sec11) {
        const cmp1Node = ensureAfter('h14-react-compare-smail-judita', sec11);
        if (cmp1Node) ensureAfter('h14-react-compare-barok-preporod', cmp1Node);
      }

      const sec12 = findSecHdr(l0, '12 · Ključni kontrasti');
      if (sec12) ensureAfter('h14-react-simboli-grid-smail', sec12);

      const l0Cheat = l0?.querySelector('.cheat-card');
      if (l0Cheat) ensureAfter('h14-react-pop-kultura-mazuranic', l0Cheat);

      const l1Tags = l1?.querySelector('.tags');
      const l1Intro = l1Tags?.nextElementSibling;
      if (l1Intro) ensureAfter('h14-react-svg-novica-arc', l1Intro);

      const l1Box = l1?.querySelector('.box-int');
      if (l1Box) ensureAfter('h14-react-accordion-pjevanja', l1Box);

      const sceneList = l1?.querySelector('.scene-list');
      const sceneCards = sceneList ? sceneList.querySelectorAll('.scene-card') : [];
      if (sceneCards.length > 1) ensureBefore('h14-react-hero-quote-nocnik', sceneCards[1]);

      const at1 = l2?.querySelector('#at1');
      const firstAt1Sc = at1?.querySelector('.sc');
      if (firstAt1Sc) ensureBefore('h14-react-svg-tre-razine', firstAt1Sc);

      mount('h14-react-hero-quote-smail', <HeroQuoteSmail />);
      mount('h14-react-timeline-mazuranic', <TimelineMazuranic />);
      mount('h14-react-author-preporod', <AuthorCardMazuranic context="l0" />);
      mount('h14-react-statcards-smail', <StatCardsSmail />);
      mount('h14-react-accordion-likovi', <AccordionLikovi />);
      mount('h14-react-accordion-teme-ideje', <AccordionTemeIdeje />);
      mount('h14-react-simboli-grid-smail', <SimboliGridSmail />);
      mount('h14-react-accordion-stilska', <AccordionStilskaSredstva />);
      mount('h14-react-compare-smail-judita', <CompareSmailJudita />);
      mount('h14-react-compare-barok-preporod', <CompareBarokPreporod />);
      mount('h14-react-compare-romanti-smail', <CompareRomantiSmail />);
      mount('h14-react-pop-kultura-mazuranic', <PopKulturaMazuranic />);
      mount('h14-react-svg-novica-arc', <SVGNovicaArc />);
      mount('h14-react-hero-quote-nocnik', <HeroQuoteNocnik />);
      mount('h14-react-accordion-pjevanja', <AccordionPjevanja />);
      mount('h14-react-svg-tre-razine', <SVGTreRazine />);

      mount('h14-react-discere-banner-primary', <DiscereBannerPrimaryH14 />);
      mount('h14-react-video-card-primary', <VideoCardPrimaryH14 />);
      mount('h14-react-video-card-secondary', <VideoCardSecondaryH14 />);
      mount('h14-react-video-card-tertiary', <VideoCardTertiaryH14 />);
      mount('h14-react-video-card-quaternary', <VideoCardQuaternaryH14 />);
      mount('l3', <CitatnikH14 />);
      mount('l4', <PojmovnikH14 />);
    });
