/**
 * H27 — H27 · Školski esej | Maturiraj.hr · matura · pisanje · workspace
 * Auto-generated from Maturiraj_Hrvatski_H27.html
 * 
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item" aria-current="page" data-code="h27" href="/skripte/hrv/h27"><span class="sb-dot"></span>H27 · Školski esej</a>
  ...
  <div class="sb-footer" id="sb-footer">
    <span id="sb-footer-pos">27 / 28</span> · <span id="sb-footer-title">školski esej</span>
...
<div class="content-wrap">
  ...
  <div class="bc">
    ...
    <span class="bc-cur">H27 · Školski esej</span>
  ...
  <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:20px">
    ...
    <button type="button" class="fcb" onclick="navigator.share?navigator.share({title:'H27 · Školski esej',url:window.location.href}):navigator.clipboard.writeText(window.location.href)" style="font-size:10px" title="Podijeli">📤 Dijeli</button>
  ...
  <!-- HERO -->
  <header class="hero">
    <div class="hero-chapter">H27 &nbsp;·&nbsp; Pisanje &nbsp;·&nbsp; Školski esej</div>
    <h1 class="hero-title">Školski esej<br><span>3 tipa · workspace · 30 tema · checklist</span></h1>
    <p class="hero-sub">
      <strong>Sustavni vodič kroz školski esej za maturu.</strong> <em>Interpretativni esej</em> (~50% ispita, analiza jednog književnog djela), <em>raspravljački esej</em> (argumentacija i obrana stava), <em>usporedna analiza</em> (dva ili više djela). <strong>UKR formula</strong>: Uvod (50-70r) · Razrada (250-300r) · Zaključak (80-100r). <strong>Zlatno pravilo: 350-450 riječi</strong>, teza u uvodu, 1 paragraf = 1 ideja, revizija = 1 sat. <em>20 najčešćih grešaka</em>, <em>9 modelnih eseja</em>, <em>Workspace s 30 tema</em>, <em>25-stavki checklist</em>. <strong>🤖 AI feedback eseja — analiza po 4 kriterija + ocjena 1–5 (PRO).</strong>
    </p>
    <div class="hero-chips">
        <span class="pill p-pa hchip">📖 Teorija + dijagnostika</span>
        <span class="pill p-br hchip">🤖 AI feedback ⭐ PRO</span>
        <span class="pill p-br hchip">📚 3 tipa eseja</span>
        <span class="pill p-pa hchip">📝 Workspace s 30 tema</span>
        <span class="pill p-br hchip">✓ 25-stavki checklist</span>
        <span class="pill p-pa hchip">📜 9 modelnih eseja</span>
      </div>
  </header>
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button type="button" class="tab" id="tab1" onclick="sw(1)" role="tab" aria-selected="false" aria-controls="l1">📚 Interpretativni<span class="tab-done" id="td1"></span></button>
    <button type="button" class="tab" id="tab2" onclick="sw(2)" role="tab" aria-selected="false" aria-controls="l2">⚖️ Raspravljački<span class="tab-done" id="td2"></span></button>
    <button type="button" class="tab" id="tab3" onclick="sw(3)" role="tab" aria-selected="false" aria-controls="l3">🔄 Usporedna analiza<span class="tab-done" id="td3"></span></button>
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div class="diag-wrap" id="diag0" data-state="intro">
      ...
      <div class="diag-intro">
        ...
        <div class="diag-intro-desc">10 pitanja · ~3 min · provjeri koliko znaš o pisanju eseja prije učenja.</div>
      ...
      <div class="diag-quiz">
        <div class="diag-header">
          <div class="diag-lbl">Školski esej — dijagnostika</div>
    ...
    <div style="margin:18px 0;padding:14px 18px;background:linear-gradient(135deg,rgba(233,180,70,.08),rgba(74,144,217,.04));border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2);display:flex;align-items:center;gap:14px;flex-wrap:wrap">
      ...
      <div style="flex:1;min-width:200px">
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--t1);margin-bottom:3px">Pro feature: AI feedback za tvoj esej ⭐</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.5">AI profesor analizira tvoj esej po 4 kriterija + daje procjenu ocjene 1-5 i konkretne preporuke.</div>
      </div>
      <button type="button" class="nb-btn primary" onclick="sw(6)" style="flex-shrink:0">Vidi više →</button>
    </div>

    <!-- ═══════════════════════════════════
         20 NAJČEŠĆIH GREŠAKA · ŠKOLSKI ESEJ
    ═══════════════════════════════════ -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">⚠️ 20 najčešćih grešaka u eseju</div><div class="sec-line"></div></div>
    ...
    <div style="padding:14px 16px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--red)">Esej je 40% maturalnih bodova.</strong> Najčešće greške nisu u sadržaju, nego u <strong>strukturi, koherenciji i stilu</strong>. Pogledaj prije pisanja prvog eseja.
      </div>
    </div>
    ...
    <div style="display:grid;gap:8px;margin:16px 0">
      ...
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">1.</span>Bez jasne teze u uvodu ⭐</summary>
        <div class="ncvvo-body">Najveća greška: uvod ne postavlja jasnu tvrdnju koju će razrada braniti. Esej ostaje nestrukturiran. <strong>Rješenje:</strong> 1-2 rečenice u uvodu eksplicitno iznose tezu („U eseju ću pokazati da...").</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">2.</span>Razrada bez jasnog slijeda ⭐</summary>
        <div class="ncvvo-body">Paragrafi ne idu logičnim redom. Misli se ponavljaju ili skaču. <strong>Rješenje:</strong> svaki paragraf ima 1 glavnu ideju + dokaz/primjer + tranziciju na sljedeći.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">3.</span>Zaključak donosi nove informacije ⭐</summary>
        <div class="ncvvo-body">Zaključak treba SINTETIZIRATI razradu, NE iznositi nove činjenice. <strong>Rješenje:</strong> u zaključku se vrati na tezu iz uvoda + sažme glavne argumente.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">4.</span>Premalo riječi (&lt;350) ⭐</summary>
        <div class="ncvvo-body">Esej kraći od 350 riječi automatski gubi bodove (najmanje -2). <strong>Rješenje:</strong> stalno provjeri word count tijekom pisanja. Idealno: 380-430.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">5.</span>Previše riječi (&gt;450) ⭐</summary>
        <div class="ncvvo-body">Esej dulji od 450 riječi gubi bodove (-1 do -3). <strong>Rješenje:</strong> ne dodavaj „za svaki slučaj" — bolje je kratko i koncizno nego predugo.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">6.</span>Nedostatak konkretnih primjera/citata ⭐</summary>
        <div class="ncvvo-body">Razrada ne potkrjepljuje tvrdnje. <strong>Rješenje:</strong> svaki argument prati primjer/citat iz djela. „Marulić piše: 'citat'...„ ili „U romanu Krleže..."</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">7.</span>Klišei i prazne fraze</summary>
        <div class="ncvvo-body">„Od pamtivijeka", „Svi znamo da", „U današnje doba"... <strong>Rješenje:</strong> izbjegavaj generičke uvodne fraze. Krenuti od konkretnog.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">8.</span>Pravopisne greške (vidi H25) ⭐</summary>
        <div class="ncvvo-body">Pravopis = 20% bodova. Najčešće: spojeno/odvojeno (neću, ne znam), č/ć, đ/dž, datumi (25. travnja 2026.). <strong>Rješenje:</strong> H25 + pažljiva revizija.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">9.</span>Interpunkcijske greške (vidi H26) ⭐</summary>
        <div class="ncvvo-body">Najčešće: zarez ispred „a, ali, no, nego", apozicija bez drugog zareza, vokativ bez zareza. <strong>Rješenje:</strong> H26 + Proofreading mode.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">10.</span>Engleski navodnici "..." umjesto „..." ⭐</summary>
        <div class="ncvvo-body">U eseju se koriste hrvatski navodnici „...„ (dolje gore), ne engleski "...". <strong>Rješenje:</strong> u Workspace tipke za pravilan format.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">11.</span>Bez tranzicija između paragrafa</summary>
        <div class="ncvvo-body">Paragrafi „nakon" - bez veze između njih. <strong>Rješenje:</strong> koristi „Nadalje", „S druge strane", „Konačno", „Slično tome", „U usporedbi".</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">12.</span>Siromašan rječnik (ponavljanje istih riječi)</summary>
        <div class="ncvvo-body">Riječ „dobar" 8 puta u eseju. <strong>Rješenje:</strong> sinonimi (kvalitetan, izvrstan, vrijedan, izniman, vrhunski). Bogat rječnik = +bodovi za stil.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">13.</span>Nedostatak stilskih figura</summary>
        <div class="ncvvo-body">Esej bez metafora, usporedbi, antiteza zvuči ravno. <strong>Rješenje:</strong> 2-3 stilske figure u eseju (umjereno, ne pretjerano).</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">14.</span>Subjektivnost u raspravljačkom eseju</summary>
        <div class="ncvvo-body">„Mislim da..." svake druge rečenice. <strong>Rješenje:</strong> u raspravljačkom eseju koristi argumente, ne dojmove. „Argumenti pokazuju da...„ je jače od „Mislim da...".</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">15.</span>Nemam stav (raspravljački) ⭐</summary>
        <div class="ncvvo-body">Esej koji „balansira" ali ne donosi zaključak. <strong>Rješenje:</strong> raspravljački esej MORA imati jasan stav i obraniti ga.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">16.</span>Pogrešan tip eseja (krivo razumijevanje teme)</summary>
        <div class="ncvvo-body">Tema traži interpretativni, student piše raspravljački. <strong>Rješenje:</strong> pažljivo pročitaj uputu — keyword-i: „analiziraj" = interpretativni, „raspravi" = raspravljački, „usporedi" = usporedna.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">17.</span>Bez konteksta (povijesni, kulturološki)</summary>
        <div class="ncvvo-body">Interpretativni esej bez smještanja djela u kontekst gubi bodove. <strong>Rješenje:</strong> u uvodu ili razradi — kratko situiraj djelo (godina, razdoblje, autor).</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">18.</span>Ostavlja vremena za reviziju (kritično!) ⭐</summary>
        <div class="ncvvo-body">Esej dovršiš 5 minuta prije kraja — nema vremena za reviziju. <strong>Rješenje:</strong> pisanje 3:00h, revizija 1:00h. Pri reviziji loviš pravopis, interpunkciju, ponavljanja.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">19.</span>Loš rukopis (neuredno)</summary>
        <div class="ncvvo-body">Esej se piše rukom — neurednost otežava ocjenjivanje. <strong>Rješenje:</strong> krzepi rukopis. Ako je esej teško čitljiv, ocjenjivač gubi strpljenje.</div>
      </details>
      
      <details class="ncvvo-detail">
        <summary class="ncvvo-summary"><span class="ncvvo-num">20.</span>Pogrešna struktura paragrafa ⭐</summary>
        <div class="ncvvo-body">Jedna ideja preko 3 paragrafa, ili 5 ideja u jednom paragrafu. <strong>Rješenje:</strong> 1 paragraf = 1 glavna ideja + dokazi/primjeri. Strukturiranje misli je ključno.</div>
      </details>
    ...
    <div style="padding:18px;background:linear-gradient(135deg,rgba(233,180,70,.06),transparent);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.7;color:var(--t2);font-family:var(--serif)">
        Esej se gradi po formuli. Ovi trikovi ti uče strukturu i izbjegavanje najvećih grešaka u 5 minuta.
      </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:10px;margin:16px 0">
      ...
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">UVOD-RAZRADA-ZAKLJUČAK ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">3-dijelna struktura</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Uvod (50r) → Razrada (250r) → Zaključak (100r)</strong>. UKR formula radi za sva 3 tipa eseja.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">350-450 RIJEČI ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Idealna duljina</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Manje od 350 = penalizacija. Više od 450 = penalizacija. <strong>Sweet spot: 380-430.</strong>
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">3:1 PRAVILO VREMENA ⭐</div>
        ...
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>3 sata pisanje + 1 sat revizija.</strong> Bez revizije gubiš pravopisne i interpunkcijske bodove.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">JEDAN PARAGRAF = JEDNA IDEJA ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Strukturiranje</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          1 paragraf = 1 glavna ideja + dokaz/primjer + tranzicija. Bez „prepunih" paragrafa.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">TEZA U UVODU ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Glavni cilj uvoda</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Uvod MORA postaviti tezu („U eseju ću pokazati da..."). Bez teze, esej je nestrukturiran.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">ANALIZIRAJ-RASPRAVI-USPOREDI ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Tri tipa eseja</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          „Analiziraj" = interpretativni. „Raspravi" = raspravljački. „Usporedi" = usporedna analiza. Pažljivo čitaj uputu!
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">CITAT KAO DOKAZ</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Sadržaj</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Svaki argument prati primjer ili citat („Marulić piše: 'citat'..."). Argumenti bez dokaza = slab esej.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">TRANZICIJE = KOHERENCIJA</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Slijed misli</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          „Nadalje", „S druge strane", „Konačno", „U usporedbi". Vežu paragrafe u logičan slijed.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">SINONIMI = STIL</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Bogat rječnik</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Ne ponavljaj iste riječi. „Dobar" → kvalitetan, izvrstan, vrijedan. Sinonimi = +bodovi za stil.
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div class="cap-mono-gold">ZAKLJUČAK ↻ UVOD ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Sintetiziranje</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Zaključak se VRAĆA na uvodnu tezu. Krug se zatvara. NIKAD ne donosi nove informacije.
        </div>
      </div>
    ...
    <div class="nav-row" style="justify-content:flex-end">
      <span class="nb-btn primary" onclick="sw(1)">📚 Interpretativni →</span>
    </div>
    ...
    <div class="cheat-card" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Tab 1 · Interpretativni esej</div>
        </div>
      </div>
      <div class="cheat-grid">
        <div class="cheat-col cheat-col-wide" style="font-family:var(--serif,Fraunces,serif);font-size:13.5px;color:var(--t2,#c5b8aa);line-height:1.65">
          <p style="margin:0">Sad kad znaš osnove eseja — <b>Tab 1</b> donosi prvi tip: interpretativni esej. Struktura, modeli, tipične greške.</p>
        </div>
      </div>
    </div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">📚 Interpretativni esej</span>
      <span class="pill p-br hchip">⭐ NAJČEŠĆI tip na maturi</span>
      <span class="pill p-pa hchip">📜 1 modelni primjer</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📚 Interpretativni esej · analiza djela</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">📚 Što je interpretativni esej</div>
      <div class="box-int-txt">
        <strong>Analiza jednog književnog djela.</strong> Najčešći tip eseja na maturi (~50% slučajeva). Bavi se: temom, likovima, stilom, jezikom, porukom djela. Cilj: pokazati razumijevanje djela kroz <strong>vlastitu interpretaciju</strong> (s argumentima i citatima).
      </div>
    </div>
    ...
    <div style="margin:18px 0;padding:14px 18px;background:linear-gradient(135deg,rgba(233,180,70,.08),rgba(74,144,217,.04));border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2);display:flex;align-items:center;gap:14px;flex-wrap:wrap">
      <div style="font-size:24px;flex-shrink:0">📝</div>
      <div style="flex:1;min-width:200px">
        <div style="font-family:var(--display);font-size:14.5px;font-weight:700;color:var(--t1);margin-bottom:3px">Naučio strukturu? Vježbaj u Workspaceu.</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.5">Workspace ima <strong style="color:var(--gold)">10 interpretativnih tema</strong> + word counter, timer i auto-save.</div>
      </div>
      <button type="button" class="nb-btn primary" onclick="sw(4)" style="flex-shrink:0">Otvori Workspace →</button>
    </div>

    <!-- STRUKTURA DETALJNO -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 Struktura · 3 dijela</div><div class="sec-line"></div></div>

    <div class="pravilo-box">
      <div class="pravilo-header">📋 UKR formula: Uvod → Razrada → Zaključak</div>
      <div class="pravilo-desc">
        Interpretativni esej ima 3 čvrsto definirana dijela. Svaki ima svoju funkciju i optimalnu dužinu.
      </div>
      
      <div class="ex-label-ok">✅ STRUKTURA</div>
      <ul class="list-mono-int">
        <li><strong>UVOD (50-70 riječi):</strong> kontekst djela + autor + teza interpretacije</li>
        <li><strong>RAZRADA (250-300 riječi):</strong> 3-4 paragrafa s analizom (tema, likovi, stil, poruka)</li>
        <li><strong>ZAKLJUČAK (80-100 riječi):</strong> sinteza + vraćanje na uvodnu tezu</li>
      </ul>
    </div>

    <!-- UVOD -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">1. UVOD · 50-70 riječi</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Što sadrži uvod</div>
      <div class="pravilo-desc">
        Uvod postavlja <strong>kontekst djela</strong> i <strong>tezu interpretacije</strong>. Ne smije biti generički ili klišejski.
      </div>
      
      <div class="ex-label-ok">✅ ŠTO TREBA UKLJUČITI</div>
      <ul class="list-mono-int">
        <li>Naslov djela + autor</li>
        <li>Razdoblje / kontekst (1 rečenica)</li>
        <li>Žanr (roman, drama, pjesma)</li>
        <li>Glavna teza koju ćeš braniti</li>
      </ul>
      
      <div class="ex-label-no">❌ ŠTO IZBJEGAVATI</div>
      <ul class="list-mono-int">
        <li>„Od pamtivijeka..." (klišej)</li>
        <li>„Svi znamo da..." (generika)</li>
        <li>Pričati životopis autora (nije relevantno)</li>
        <li>Otkrivati zaključak već u uvodu</li>
      </ul>
    </div>

    <!-- RAZRADA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">2. RAZRADA · 250-300 riječi (3-4 paragrafa) ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Struktura razrade</div>
      <div class="pravilo-desc">
        Razrada je <strong>središnji dio eseja</strong>. Svaki paragraf = 1 glavna ideja + dokaz/citat + poveznica na temu.
      </div>
      
      <div class="ex-label-ok">✅ TIPIČNI PARAGRAFI</div>
      <ul class="list-mono-int">
        <li><strong>P1 — Tema i kontekst:</strong> što je glavna tema djela, kontekst nastanka</li>
        <li><strong>P2 — Likovi:</strong> glavni likovi, njihova karakterizacija, motivacija</li>
        <li><strong>P3 — Stil i jezik:</strong> stilske figure, jezični postupci, ritam</li>
        <li><strong>P4 — Poruka:</strong> što djelo poručuje, univerzalnost</li>
      </ul>
      
      <div class="ex-label-blue">⚪ TRANZICIJE</div>
      <ul class="list-mono-int">
        <li>„Nadalje...„ / „Osim toga..." / „Također..."</li>
        <li>„S druge strane...„ / „Međutim..."</li>
        <li>„Konkretan primjer toga je..."</li>
        <li>„Sve to upućuje na..."</li>
      </ul>
    </div>

    <!-- ZAKLJUČAK -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">3. ZAKLJUČAK · 80-100 riječi</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Funkcija zaključka</div>
      <div class="pravilo-desc">
        Zaključak <strong>sintetizira</strong> sve iz razrade i <strong>vraća se na uvodnu tezu</strong>. Krug se zatvara.
      </div>
      
      <div class="ex-label-ok">✅ ŠTO TREBA</div>
      <ul class="list-mono-int">
        <li>Sažeti glavne argumente iz razrade (1-2 rečenice)</li>
        <li>Vratiti se na uvodnu tezu (potvrditi je dokazima)</li>
        <li>Univerzalna poruka (kako djelo govori i danas)</li>
        <li>Snažna završna rečenica</li>
      </ul>
      
      <div class="ex-label-no">❌ ŠTO NE</div>
      <ul class="list-mono-int">
        <li>Donositi NOVE informacije ili argumente</li>
        <li>Citirati prvi put u zaključku</li>
        <li>Završiti pitanjem (osim ako je retoričko)</li>
      </ul>
    </div>

    <!-- MODELNI ESEJ -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📜 Modelni esej · ocjena 5</div><div class="sec-line"></div></div>
    
    <div style="padding:18px 22px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin:14px 0">
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--green);margin-bottom:6px">📜 TEMA</div>
      <div style="font-family:var(--display);font-size:16px;font-weight:700;color:var(--t1);margin-bottom:14px;line-height:1.4">
        Interpretacija Marulićeve „Judite" — vjerska i nacionalna alegorija
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟢 UVOD (62 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(80,200,120,.04);border-radius:var(--r1)">
        Marko Marulić, otac hrvatske književnosti, 1501. godine napisao je „Juditu" — prvi hrvatski ep na narodnome jeziku. Djelo, nadahnuto starozavjetnom pričom o židovskoj junakinji koja je obranila svoj narod od Holoferna, više je od pukoga vjerskog spjeva. „Judita" je <strong>dvostruka alegorija</strong> — vjerska i nacionalna — i upravo to je ono što ću u ovom eseju pokazati.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟡 RAZRADA (~265 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(233,180,70,.04);border-radius:var(--r1)">
        Na vjerskoj razini, „Judita" prikazuje pobjedu vjere nad bezboštvom. Junakinja Judita ulazi u Holofernov tabor noseći jedino svoju vjeru u Boga i odlučnost. Marulić je opisuje kao ženu „lipote i mudrosti", čime ističe da je njezina snaga ne fizička, nego duhovna. „Boga uzdiše, ne čovika", piše Marulić, naglašavajući da je njezina pobjeda Božje djelo. Religiozna dimenzija djela ima jasnu funkciju: poticati čitatelja na vjeru u teškim vremenima.
        <br><br>
        Nadalje, na nacionalnoj razini „Judita" je alegorija hrvatskoga otpora Turcima. Početak 16. stoljeća bio je vrijeme stalnih turskih napada na hrvatske krajeve, a Marulić piše djelo upravo u Splitu, gradu koji je živio pod prijetnjom. Holoferno je očito metafora za turskog osvajača, dok je Judita simbol Hrvatske — slabe, ali odlučne. „Stahu mladi i stari, plačuć moljahu", opisuje Marulić strah Betulijanaca, što je istovremeno slika hrvatskoga naroda toga vremena.
        <br><br>
        Stilski, djelo se odlikuje epskim ritmom dvanaesterca, bogatim opisima i karakteristikom kroz dijalog. Marulić koristi <strong>stilske figure</strong> kao što su epiteti („slavna Judita", „okrutni Holoferno"), antiteza (vjera vs bezboštvo) i retorička pitanja, čime gradi snažnu emocionalnu napetost.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🔴 ZAKLJUČAK (~95 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:8px;padding:12px 16px;background:rgba(224,82,82,.04);border-radius:var(--r1)">
        „Judita" Marka Marulića tako je istovremeno duboko religiozno djelo i prva hrvatska nacionalna književna alegorija. Vjerska razina poručuje da vjera pokreće povijest, dok nacionalna razina Hrvatima 16. stoljeća daje nadu da se i mali narod može oduprijeti najjačemu osvajaču. Upravo zato „Judita" nije samo prvi hrvatski ep — ona je rodno mjesto hrvatske književnosti i hrvatskoga nacionalnog identiteta. Pet stoljeća kasnije, njezina poruka o snazi vjere i otporu nepravdi i dalje je univerzalna.
      </div>
      
      <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--bd);font-family:var(--mono);font-size:11px;color:var(--t3);letter-spacing:.8px">
        ✓ <strong>422 riječi</strong> · ✓ jasna teza · ✓ 3 paragrafa razrade · ✓ citati · ✓ kontekst · ✓ poruka
      </div>
    </div>

    <!-- INLINE QUIZ — Tab 1 specifično -->
    
    <!-- ─────────────── BIBLIOTEKA MODELNIH ESEJA ─────────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📚 Biblioteka · još 2 modelna eseja</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(80,200,120,.04);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--green)">3 modelna eseja na ocjenu 5</strong> za interpretativni tip. Klikni temu da otvoriš puni esej. Svaki esej je <strong>anotiran</strong> (uvod 🟢, razrada 🟡, zaključak 🔴) i ima <strong>checklist na dnu</strong>.
      </div>
    </div>

    <details class="esej-details">
      <summary class="esej-summary">
        <span class="esej-num">2.</span>
        <span class="esej-title">Krležini „Glembajevi" — propast hrvatskog plemstva</span>
        <span class="esej-meta">418 riječi</span>
      </summary>
      <div class="esej-body">
        <div class="esej-label esej-label-uvod">🟢 UVOD (60 riječi)</div>
        <div class="esej-text esej-text-uvod">
          Miroslav Krleža u dramskom ciklusu „Glembajevi", napisanom između 1929. i 1932. godine, prikazuje propast moćne plemićke obitelji. Kroz tri drame — „Gospoda Glembajevi", „U agoniji" i „Leda" — autor seže duboko u psihologiju jedne klase koja gubi svoj povijesni smisao. <strong>Glembajevi nisu samo obitelj; oni su simbol cijelog hrvatskog plemstva u zalazu</strong>, što je teza koju ću pokazati.
        </div>
        
        <div class="esej-label esej-label-razrada">🟡 RAZRADA (~268 riječi)</div>
        <div class="esej-text esej-text-razrada">
          Tematski, „Glembajevi" zahvaćaju moralni raspad obitelji povezan s gomilanjem bogatstva kroz korupciju i izdaju. Stari Glembay svoj je kapital stekao na sumnjive načine, a sva tri sina — Leone, Ignjat i Ivan — različito reagiraju na to nasljeđe: Leone bijegom u umjetnost, Ignjat cinizmom, Ivan razularenom potrošnjom. Svaki od njih simbolizira jedan od mogućih izlaza iz dekadentne klase, ali nijedan ne uspijeva.
          <br><br>
          Likovi su građeni s velikom psihološkom dubinom. Leone, glavni protagonist „Gospode Glembajevih", suočava se s ocem u <strong>vrhuncu drame</strong> i razotkriva istinu o smrti svoje majke — ubojstvu koje je obitelj prikrila desetljećima. Krleža kroz Leoneov lik artikulira sukob između estetske i moralne svijesti, sukob koji ostaje neriješen do kraja ciklusa. Likovi nisu jednoznačni: oni su istovremeno žrtve i počinitelji svoje propasti.
          <br><br>
          Stilski, Krleža gradi svoju dramu na <strong>dugim monolozima</strong>, baroknom rječniku i miješanju njemačkih izraza sa hrvatskim — što odražava jezik tadašnje habsburške aristokracije. Stilske figure poput antiteze („vjera vs licemjerje"), gradacije i ironije pojačavaju moralnu napetost. Krležin jezik nije realističan; on je <strong>poetski uzdignut</strong>, što ga čini bližim Wagnerovoj operi nego salonskoj drami.
          <br><br>
          Kontekstualno, ciklus nastaje u međuratnom razdoblju, kad hrvatska aristokracija doživljava svoj definitivan zalazak. Krleža taj proces ne samo da prikazuje, nego i kritički vrednuje.
        </div>
        
        <div class="esej-label esej-label-zaklj">🔴 ZAKLJUČAK (~90 riječi)</div>
        <div class="esej-text esej-text-zaklj">
          „Glembajevi" tako su više od obiteljske drame — oni su <strong>politički i moralni testament</strong> jednog razdoblja. Krleža kroz njih pokazuje da klasa koja je izgubila svoj povijesni smisao ne može sebe spasiti čak ni umjetnošću ili ljubavlju. Aktualnost djela nije tek povijesna: svako vrijeme ima svoje Glembajeve — pojedince ili klase koji žive na nasljeđu, ne stvarajući novo. Upravo zato „Glembajevi" ostaju jedno od ključnih djela hrvatske dramske književnosti, čije pitanje o moralu naslijeđenih privilegija nije nimalo izgubilo na težini.
        </div>
        
        <div class="esej-checklist">
          ✓ <strong>418 riječi</strong> · ✓ jasna teza · ✓ 4 paragrafa razrade · ✓ tema/likovi/stil/kontekst · ✓ aktualizacija
        </div>
      </div>
    </details>
    ...
    <details class="esej-details">
      <summary class="esej-summary">
        <span class="esej-num">3.</span>
        <span class="esej-title">Matošev „Notturno" — pejzažna lirika modernizma</span>
        <span class="esej-meta">395 riječi</span>
      </summary>
      <div class="esej-body">
        <div class="esej-label esej-label-uvod">🟢 UVOD (58 riječi)</div>
        <div class="esej-text esej-text-uvod">
          Antun Gustav Matoš, jedan od ključnih predstavnika hrvatske moderne, u pjesmi „Notturno" iz 1907. godine zaranja u atmosferu noćnog krajolika koji prerasta u <strong>ogledalo unutarnjeg stanja lirskog subjekta</strong>. „Notturno" nije puka pejzažna pjesma; to je psihološki autoportret prikazan kroz slikovni jezik prirode, što ću pokazati analizirajući temu, lirskog subjekta i Matoševu modernu poetiku.
        </div>
        
        <div class="esej-label esej-label-razrada">🟡 RAZRADA (~250 riječi)</div>
        <div class="esej-text esej-text-razrada">
          Tematski, pjesma slika noć — vrijeme tišine, samoće i kontemplacije. Slika prirode nije neutralna: ona je <strong>aktivni sudionik</strong> emocionalnog stanja. Matoš opisuje šum riječice, mjesečinu, drhtaj listova — sve elemente koji u tradicionalnoj lirici označavaju mir, ali kod Matoša dobivaju dodatnu, melankoličnu dimenziju. Noć nije bijeg od svijeta, nego <strong>intenzivirano postojanje</strong> u kojem subjekt postaje svjesniji sebe i svojeg mjesta u kozmosu.
          <br><br>
          Lirski subjekt nije izravno opisan, ali se njegova prisutnost osjeća kroz odabir slika i ritam pjesme. Matoš koristi <strong>impresionističke postupke</strong> — kratke, slikovite frazama prenosi trenutne dojmove, ne sustavnu pripovijest. Subjekt je usamljen, no njegova samoća nije očajna; ona je kontemplativna, gotovo stoička. Po tome se Matoš razlikuje od romantičarskog razumijevanja samoće kao patnje.
          <br><br>
          Stilski, „Notturno" obiluje <strong>stilskim figurama</strong>: epiteti („tihi pejzaž", „srebrna mjesečina"), personifikacija („priroda spava"), aliteracija (ponavljanje glasa „š" oponaša šum). Ritam je gibak, ali ne brz; rima i metar služe atmosferi, ne deklamaciji. Sve te postupke Matoš sintetizira u <strong>jedinstven moderni izraz</strong>, koji u hrvatsku poeziju donosi senzibilitet francuskih simbolista poput Verlainea.
        </div>
        
        <div class="esej-label esej-label-zaklj">🔴 ZAKLJUČAK (~87 riječi)</div>
        <div class="esej-text esej-text-zaklj">
          „Notturno" tako predstavlja Matošev modernistički proboj — pjesmu u kojoj je vanjski krajolik samo površina ispod koje pulsira unutarnji svijet. Matoš je u hrvatskoj književnosti otvorio prostor za <strong>impresionističku liriku</strong>, gdje pjesnik više ne opisuje stvarnost, nego svoj doživljaj stvarnosti. Po tome je „Notturno" prag prema cijeloj kasnijoj hrvatskoj poeziji — od Šimića do Cesarića, od Tadijanovića do Slamniga. Matoševa noć ostaje, više od stoljeća kasnije, <strong>univerzalan simbol</strong> kontemplativne samoće moderne osobe.
        </div>
        
        <div class="esej-checklist">
          ✓ <strong>395 riječi</strong> · ✓ jasna teza · ✓ 3 paragrafa razrade · ✓ stilske figure · ✓ kontekst moderne · ✓ univerzalna poruka
        </div>
      </div>
    </details>

    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Provjera razumijevanja · interpretativni esej</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">10 pitanja iz strukture i tehnike interpretativnog eseja.</strong>
      </div>
    </div>

    <div id="interp-exercise"></div>
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=kako+pisati+esej+matura+interpretativni+raspravljački+savjeti" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Kako pisati esej — savjeti za maturu</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=školski+esej+teza+uvod+razrada+zaključak+struktura" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Struktura eseja — uvod, razrada, zaključak</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=how+to+write+literary+essay+thesis+analysis+guide" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">How to write a literary essay — guide</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=essay+writing+tips+argumentative+comparative+5+paragraph" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🎬</span> EN</div>
          <div class="yt-title">Essay writing tips — argumentative</div>
        </div>
      </a>
    </div>
...
<div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      ...
      <button type="button" class="nb-btn primary" onclick="sw(2)">Raspravljački esej →</button>
    </div>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">⚖️ Raspravljački esej</span>
      <span class="pill p-br hchip">💬 Argumentacija</span>
      <span class="pill p-pa hchip">📜 1 modelni primjer</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">⚖️ Raspravljački esej · zauzmi stav</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">⚖️ Što je raspravljački esej</div>
      <div class="box-int-txt">
        <strong>Esej u kojem zauzimaš stav i braniš ga argumentima.</strong> Tema je obično društvena (mediji, klimatske promjene, tradicija). Cilj: <strong>logična, dokumentirana argumentacija</strong> (ne samo dojmovi). Najveća greška: ostati neutralan.
      </div>
    </div>
    ...
    <div style="margin:18px 0;padding:14px 18px;background:linear-gradient(135deg,rgba(233,180,70,.08),rgba(74,144,217,.04));border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2);display:flex;align-items:center;gap:14px;flex-wrap:wrap">
      <div style="font-size:24px;flex-shrink:0">📝</div>
      <div style="flex:1;min-width:200px">
        <div style="font-family:var(--display);font-size:14.5px;font-weight:700;color:var(--t1);margin-bottom:3px">Vježbaj raspravljanje u Workspaceu</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.5">Workspace ima <strong style="color:var(--gold)">10 raspravljačkih tema</strong> iz društva i kulture.</div>
      </div>
      <button type="button" class="nb-btn primary" onclick="sw(4)" style="flex-shrink:0">Otvori Workspace →</button>
    </div>

    <!-- STRUKTURA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 Struktura raspravljačkog eseja</div><div class="sec-line"></div></div>

    <div class="pravilo-box">
      <div class="pravilo-header">📋 4-dijelna struktura argumentacije</div>
      <div class="pravilo-desc">
        Raspravljački esej slijedi klasičnu logiku: <strong>teza → argumenti za → moguće protuargumente → zaključak</strong>.
      </div>
      
      <div class="ex-label-ok">✅ STRUKTURA</div>
      <ul class="list-mono-int">
        <li><strong>UVOD (50-70r):</strong> postavi pitanje + svoju TEZU (stav)</li>
        <li><strong>ARGUMENTI ZA (~150r):</strong> 2-3 argumenta s primjerima/dokazima</li>
        <li><strong>PROTUARGUMENTI (~100r):</strong> spomeni suprotne stavove, opovrgni ih</li>
        <li><strong>ZAKLJUČAK (~80r):</strong> potvrdi tezu + univerzalna poruka</li>
      </ul>
    </div>

    <!-- TEZA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">1. TEZA — najvažniji element ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Što je dobra teza</div>
      <div class="pravilo-desc">
        Teza je tvoj <strong>jasan, branjiv stav</strong>. Bez teze raspravljački esej ne postoji. Mora biti specifična, ne uopćena.
      </div>
      
      <div class="ex-label-ok">✅ DOBRA TEZA</div>
      <ul class="list-mono-int">
        <li>„Društvene mreže više štete nego koriste mladima jer..."</li>
        <li>„Tradicija je u 21. stoljeću relevantnija nego ikad jer..."</li>
        <li>„Klimatske promjene zahtijevaju radikalne mjere, a ne postupne..."</li>
      </ul>
      
      <div class="ex-label-no">❌ LOŠA TEZA</div>
      <ul class="list-mono-int">
        <li>„Mediji su zanimljivi." (preopćenito, nemaš što braniti)</li>
        <li>„Postoje različita mišljenja o ovome." (nemaš svoj stav)</li>
        <li>„Mislim da je to dobro i loše." (kontradikcija)</li>
      </ul>
    </div>

    <!-- ARGUMENTACIJA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">2. ARGUMENTI · uvjerljivi dokazi</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Tipovi dokaza</div>
      <div class="pravilo-desc">
        Argumenti moraju biti <strong>potkrijepljeni dokazima</strong>: činjenicama, primjerima, statistikama, citatima.
      </div>
      
      <div class="ex-label-ok">✅ TIPOVI DOKAZA</div>
      <ul class="list-mono-int">
        <li><strong>Činjenice:</strong> „Prema istraživanju...„ / „Statistike pokazuju..."</li>
        <li><strong>Primjeri:</strong> „Konkretan primjer je...„ / „Slučaj X dokazuje..."</li>
        <li><strong>Citati:</strong> „Kako je rekao Aristotel...„ / „Marulić je pisao..."</li>
        <li><strong>Logični lanac:</strong> „Ako A, onda B; B vodi k C..."</li>
      </ul>
      
      <div class="ex-label-no">❌ NIJE ARGUMENT</div>
      <ul class="list-mono-int">
        <li>„Mislim da...„ / „Osjećam da..." (subjektivni dojam)</li>
        <li>„Svi znaju...„ / „Općepoznato je..." (nedokazana tvrdnja)</li>
        <li>„X je glupost." (uvreda, ne argument)</li>
      </ul>
    </div>

    <!-- PROTUARGUMENTI -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">3. PROTUARGUMENTI · jača esej</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Zašto spomenuti protuargumente</div>
      <div class="pravilo-desc">
        Spomenom suprotnih stavova <strong>jačaš svoj esej</strong> — pokazuješ da poznaješ obje strane. Onda ih opovrgneš svojim dokazima.
      </div>
      
      <div class="ex-label-ok">✅ KAKO PISATI PROTUARGUMENTE</div>
      <ul class="list-mono-int">
        <li>„Neki će reći da...„ / „Postoje argumenti koji tvrde..."</li>
        <li>„No (taj argument) zanemaruje..."</li>
        <li>„Iako je to dijelom istina, glavni razlog je..."</li>
        <li>„Suprotno tome, dokazi pokazuju..."</li>
      </ul>
    </div>
    ...
    <div style="padding:18px 22px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin:14px 0">
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--green);margin-bottom:6px">📜 TEMA</div>
      <div style="font-family:var(--display);font-size:16px;font-weight:700;color:var(--t1);margin-bottom:14px;line-height:1.4">
        Društvene mreže — koriste li ili štete mladima?
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟢 UVOD (60 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(80,200,120,.04);border-radius:var(--r1)">
        Prosječan tinejdžer u Hrvatskoj danas provede preko četiri sata dnevno na društvenim mrežama. Instagram, TikTok i Snapchat oblikuju njegovu sliku svijeta, prijateljstva, pa i samopoimanje. Mnogi tvrde da te platforme povezuju i obrazuju — no <strong>argumenti pokazuju da društvene mreže više štete nego koriste mladima</strong>, ponajprije kroz mentalno zdravlje, pažnju i autentičnost.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟡 ARGUMENTI ZA TEZU (~155 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(233,180,70,.04);border-radius:var(--r1)">
        Prvo, istraživanja pokazuju jasnu vezu između prekomjerne upotrebe društvenih mreža i depresije. Studija sa Sveučilišta u Pennsylvaniji (2018.) pokazala je da ograničavanje upotrebe mreža na 30 minuta dnevno smanjuje simptome depresije za gotovo 40 %. Razlog je <strong>kultura usporedbe</strong> — mladi vide samo „najbolje" trenutke tuđih života i osjećaju vlastiti život manjkavim.
        <br><br>
        Drugo, kontinuirani ulazak na obavijesti razara sposobnost dubokog fokusa. Algoritmi su dizajnirani za <strong>maksimalnu vremensku potrošnju</strong>, ne za korist korisnika. Posljedica je da mladi sve teže čitaju cijele knjige, prate predavanja ili samostalno razmišljaju. Pažnja postaje rasuta.
        <br><br>
        Treće, autentičnost trpi. Mladi se uče izlagati „personu" umjesto sebe stvarnoga. Like-ovi i broj pratitelja postaju mjerilo vrijednosti, što gradi krhki identitet ovisan o tuđem mišljenju.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟠 PROTUARGUMENTI + OPOVRGAVANJE (~110 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(184,117,74,.04);border-radius:var(--r1)">
        Protivnici će reći da društvene mreže povezuju ljude i otvaraju nove obrazovne mogućnosti. To je dijelom istina — preko TikToka mlade osobe danas uče jezike, povijest, znanost. No taj „obrazovni" segment čini manje od 10 % vremena provedenog na mrežama; ostatak je beskonačno listanje. Također, „povezivanje" je često površno — broj pratitelja ne odgovara broju stvarnih prijatelja, što potvrđuje studija Roberta Putnama o socijalnom kapitalu.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🔴 ZAKLJUČAK (~85 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:8px;padding:12px 16px;background:rgba(224,82,82,.04);border-radius:var(--r1)">
        Društvene mreže nisu inherentno zle, no način na koji su dizajnirane — za maksimalno zadržavanje pažnje umjesto za korist korisnika — čini ih netom rizičnijima nego korisnijima za mlade. Mentalno zdravlje, sposobnost dubokog fokusa i autentičan identitet ozbiljno trpe. Rješenje nije u potpunoj zabrani, nego u <strong>svijesnoj uporabi</strong>: vremenska ograničenja, kuriranje sadržaja i obrazovanje o algoritmima. Generacija koja shvati alat može ga koristiti, a ne biti njegovim oruđem.
      </div>
      
      <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--bd);font-family:var(--mono);font-size:11px;color:var(--t3);letter-spacing:.8px">
        ✓ <strong>410 riječi</strong> · ✓ jasna teza · ✓ 3 argumenta · ✓ statistike · ✓ protuargumenti · ✓ rješenje
      </div>
    </div>
    ...
    <div style="padding:14px 16px;background:rgba(80,200,120,.04);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--green)">3 modelna eseja na ocjenu 5</strong> za raspravljački tip. Klikni temu da otvoriš puni esej.
      </div>
    </div>
    ...
    <details class="esej-details">
      <summary class="esej-summary">
        <span class="esej-num">2.</span>
        <span class="esej-title">Hrvatski jezik u doba globalizacije — opasnost ili prilika?</span>
        <span class="esej-meta">405 riječi</span>
      </summary>
      <div class="esej-body">
        <div class="esej-label esej-label-uvod">🟢 UVOD (62 riječi)</div>
        <div class="esej-text esej-text-uvod">
          U svakodnevnom govoru hrvatskih tinejdžera danas se često čuju riječi poput „cringe", „lajkati", „mejlati", „vajb", „checkirati". Engleski ulazi u hrvatski jezik brže nego ikad u povijesti. Postavlja se pitanje je li to <strong>opasnost</strong> (gubitak jezičnog identiteta) ili <strong>prilika</strong> (jezik se obogaćuje). Argumenti pokazuju da je riječ o <strong>kontroliranoj prilici</strong> — anglizmi obogaćuju hrvatski, ali samo uz svjestan pravopisni i obrazovni nadzor.
        </div>
        
        <div class="esej-label esej-label-razrada">🟡 ARGUMENTI ZA TEZU (~150 riječi)</div>
        <div class="esej-text esej-text-razrada">
          Prvo, jezici koji ne primaju nove riječi <strong>zamiru</strong>. Hrvatski je tijekom povijesti uvijek primao tuđice — turcizme („čaj", „rakija"), germanizme („pegla", „šnicla"), talijanizme („birokracija") — i nije zato izgubio svoj identitet. Anglizmi su samo nova faza istog procesa. Štoviše, novi termini iz tehnologije („algoritam", „aplikacija", „streamati") nemaju svoje hrvatske ekvivalente jer označavaju potpuno nove pojmove.
          <br><br>
          Drugo, anglizmi <strong>otvaraju globalne mogućnosti</strong> mladima. Mladi koji odrastaju u jezičnom kontaktu s engleskim lakše uče taj jezik, čime stječu prednost na međunarodnom tržištu rada. Studije pokazuju da hrvatski tinejdžeri imaju nadprosječno znanje engleskog upravo zbog medijske izloženosti.
          <br><br>
          Treće, hrvatski standard <strong>ima zaštitne mehanizme</strong>. Hrvatski pravopis (2013.) i Institut za hrvatski jezik aktivno rade na hrvatskim ekvivalentima („e-pošta" za „mail", „osvježi" za „refresh") koji se postupno usvajaju u službenoj komunikaciji.
        </div>
        
        <div class="esej-label esej-label-protu">🟠 PROTUARGUMENTI + OPOVRGAVANJE (~105 riječi)</div>
        <div class="esej-text esej-text-protu">
          Kritičari upozoravaju da prekomjerna upotreba anglizama <strong>razgrađuje hrvatski jezični identitet</strong> i da se gubi sposobnost finije ekspresije. Ta zabrinutost je legitimna, ali prenaglašena. Hrvatski je preživio puno teže izazove — habsburšku germanizaciju, jugoslavensko poticanje srpskohrvatskog, masovnu emigraciju. Ono što se danas događa nije <strong>ugrožavanje</strong>, nego prirodna evolucija. Ključ je u <strong>obrazovanju</strong>: ako škole inzistiraju na pismenom hrvatskom, govorne anglizme jezik može „probaviti" bez gubitka.
        </div>
        
        <div class="esej-label esej-label-zaklj">🔴 ZAKLJUČAK (~88 riječi)</div>
        <div class="esej-text esej-text-zaklj">
          Anglizmi u hrvatskom jeziku tako predstavljaju <strong>kontroliranu priliku</strong>, ne opasnost. Jezik koji prima nove riječi je živ; jezik koji to ne čini nestaje. No ta otvorenost mora biti <strong>uravnotežena</strong> — kroz školu, medije i službenu komunikaciju koji čuvaju hrvatski standard. Generacija koja zna kad reći „mejl", a kad „elektronička poruka", ne gubi identitet — naprotiv, postaje <strong>jezično bogatija</strong>. Hrvatski neće propasti zbog engleskog; propast će samo ako prestanemo o njemu razmišljati.
        </div>
        
        <div class="esej-checklist">
          ✓ <strong>405 riječi</strong> · ✓ jasna teza · ✓ 3 argumenta · ✓ povijesni primjeri · ✓ protuargumenti · ✓ rješenje
        </div>
      </div>
    </details>
    ...
    <details class="esej-details">
      <summary class="esej-summary">
        <span class="esej-num">3.</span>
        <span class="esej-title">Klimatske promjene — odgovornost generacija</span>
        <span class="esej-meta">425 riječi</span>
      </summary>
      <div class="esej-body">
        <div class="esej-label esej-label-uvod">🟢 UVOD (65 riječi)</div>
        <div class="esej-text esej-text-uvod">
          Klimatske promjene najveći su izazov 21. stoljeća — to je činjenica koju potvrđuje gotovo sva znanstvena zajednica. Pitanje koje se postavlja u javnom prostoru više nije <strong>postoje li</strong>, nego <strong>tko snosi odgovornost</strong>. Pojedinac, korporacije, ili države? Argumenti pokazuju da je odgovornost <strong>primarno sistemska</strong> (na korporacijama i državama), ali da individualni pritisak ostaje ključan kao pokretač sistemskih promjena.
        </div>
        
        <div class="esej-label esej-label-razrada">🟡 ARGUMENTI ZA TEZU (~170 riječi)</div>
        <div class="esej-text esej-text-razrada">
          Prvo, <strong>statistike pokazuju</strong> da samo 100 najvećih korporacija proizvodi preko 70 % globalnih emisija ugljičnog dioksida. Najveći proizvođači — naftne kompanije, tvrtke za prerade ugljena, kemijska industrija — već desetljećima znaju za klimatski utjecaj svojih aktivnosti, ali su sustavno odgađali transformaciju. Pojedinac koji recikllira plastiku ne može svojim ponašanjem nadoknaditi posljedice djelovanja jedne rafinerije.
          <br><br>
          Drugo, <strong>države imaju regulatornu moć</strong> koju pojedinci nemaju. Zelena tranzicija, oporezivanje emisija, ulaganja u obnovljive izvore — sve su to mehanizmi koji djeluju isključivo na razini politike. Zemlje koje su rano uvele takve mjere (Danska, Njemačka) već vide rezultate: smanjenje emisija uz ekonomski rast.
          <br><br>
          Treće, <strong>individualni pritisak ostaje ključan</strong> jer korporacije i države reagiraju na potražnju i izborni pritisak. Generacije koje glasaju za zelene politike, troše svjesno i protestiraju (Greta Thunberg, Fridays for Future) <strong>pomiču nadzorne ploče</strong> u smjeru sistemske promjene. Bez tog pritiska, sistem ostaje statičan.
        </div>
        
        <div class="esej-label esej-label-protu">🟠 PROTUARGUMENTI + OPOVRGAVANJE (~105 riječi)</div>
        <div class="esej-text esej-text-protu">
          Skeptici tvrde da je <strong>individualna odgovornost odlučujuća</strong> jer „svi mi zajedno činimo sustav". Tvrdnja zvuči etički privlačno, ali ekonomski je manjkava: bez sistemskih poluga (zakona, poreza, infrastrukture), individualne odluke ne mogu kompenzirati industrijski razmjer štete. Drugi protuargument — da klimatske promjene nisu „istinski" ljudski problem — ne vrijedi diskusije: znanstveni konsenzus je čvršći nego za većinu drugih medicinskih i prirodnih pojava koje uzimamo zdravo za gotovo.
        </div>
        
        <div class="esej-label esej-label-zaklj">🔴 ZAKLJUČAK (~85 riječi)</div>
        <div class="esej-text esej-text-zaklj">
          Klimatska kriza tako je primarno <strong>sistemski problem</strong> koji zahtijeva sistemska rješenja — politiku, regulaciju i tehnologiju. No taj sistem ne mijenja se sam: pokreću ga generacije koje glasaju, pritišću i biraju. Mladi danas, koji će klimatske posljedice osjetiti najviše, imaju <strong>moralni mandat</strong> tražiti više od institucija. Odgovornost nije ili-ili; ona je istovremeno strukturna i osobna. Generacija koja shvati taj dualitet može oblikovati budućnost — ne onu koja se događa, nego onu koju biraju.
        </div>
        
        <div class="esej-checklist">
          ✓ <strong>425 riječi</strong> · ✓ jasna teza · ✓ 3 argumenta · ✓ statistike · ✓ protuargumenti · ✓ moralni poziv
        </div>
      </div>
    </details>

    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Provjera razumijevanja · raspravljački esej</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">10 pitanja iz argumentacije i strukture raspravljačkog eseja.</strong>
      </div>
    </div>

    <div id="rasp-exercise"></div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(1)">← Interpretativni</button>
      <button type="button" class="nb-btn primary" onclick="sw(3)">Usporedna analiza →</button>
    </div>
    ...
    <div class="tags">
      <span class="pill p-pa hchip">🔄 Usporedna analiza</span>
      <span class="pill p-br hchip">📊 Komparacija</span>
      <span class="pill p-pa hchip">📜 1 modelni primjer</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">🔄 Usporedna analiza · komparacija djela</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🔄 Što je usporedna analiza</div>
      <div class="box-int-txt">
        <strong>Komparacija dvaju (rjeđe više) književnih djela</strong> po jasnom kriteriju: tema, lik, stil, poruka. Cilj: pokazati <strong>sličnosti i razlike</strong> + objasniti <strong>što ta usporedba znači</strong>. Najteži tip eseja jer zahtjeva temeljito poznavanje oba djela.
      </div>
    </div>
    ...
    <div style="margin:18px 0;padding:14px 18px;background:linear-gradient(135deg,rgba(233,180,70,.08),rgba(74,144,217,.04));border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2);display:flex;align-items:center;gap:14px;flex-wrap:wrap">
      <div style="font-size:24px;flex-shrink:0">📝</div>
      <div style="flex:1;min-width:200px">
        <div style="font-family:var(--display);font-size:14.5px;font-weight:700;color:var(--t1);margin-bottom:3px">Komparativne teme u Workspaceu</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.5">Workspace ima <strong style="color:var(--gold)">10 komparativnih tema</strong> iz hrvatske književnosti.</div>
      </div>
      <button type="button" class="nb-btn primary" onclick="sw(4)" style="flex-shrink:0">Otvori Workspace →</button>
    </div>

    <!-- DVIJE METODE -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 Dvije metode usporedbe</div><div class="sec-line"></div></div>

    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:14px 0">
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2)">
        <div class="cap-mono-gold">METODA 1: BLOK</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Djelo A → Djelo B</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.6">
          Prvo cijela analiza djela A, zatim cijela analiza djela B, na kraju usporedba u zaključku.<br><br>
          <strong>Plus:</strong> jednostavnije strukturirati.<br>
          <strong>Minus:</strong> usporedba je tek na kraju, esej može djelovati nepovezano.
        </div>
      </div>
      
      <div style="padding:18px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r2)">
        <div class="cap-mono-gold">METODA 2: PARALELNA ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Po kriteriju (preporučeno)</div>
        <div style="font-size:12.5px;color:var(--t2);line-height:1.6">
          Po svakom kriteriju (tema, lik, stil) usporedi A i B u istom paragrafu.<br><br>
          <strong>Plus:</strong> jasna usporedba kroz cijeli esej.<br>
          <strong>Minus:</strong> traži veće poznavanje djela.
        </div>
      </div>
    ...
    <!-- STRUKTURA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 Struktura paralelne metode (preporučeno)</div><div class="sec-line"></div></div>

    <div class="pravilo-box">
      <div class="pravilo-header">📋 4-dijelna struktura</div>
      <div class="pravilo-desc">
        Paralelna metoda usporedbe djela po kriterijima daje <strong>najbolju koherenciju</strong> i pokazuje dubinsko razumijevanje.
      </div>
      
      <div class="ex-label-ok">✅ STRUKTURA</div>
      <ul class="list-mono-int">
        <li><strong>UVOD (50-70r):</strong> oba djela + autora + KRITERIJI usporedbe + teza</li>
        <li><strong>P1 — TEMA (~80r):</strong> što obje djela tematiziraju, sličnosti/razlike</li>
        <li><strong>P2 — LIKOVI (~80r):</strong> komparacija glavnih likova</li>
        <li><strong>P3 — STIL (~80r):</strong> jezik, ritam, stilske figure</li>
        <li><strong>ZAKLJUČAK (~80r):</strong> što usporedba otkriva o oba djela</li>
      </ul>
    </div>

    <!-- TEZA U USPOREDBI -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 Teza komparativnog eseja ⭐</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Što je dobra teza</div>
      <div class="pravilo-desc">
        Teza komparativnog eseja MORA reći <strong>što usporedba znači</strong>, ne samo „A i B su slični/različiti".
      </div>
      
      <div class="ex-label-ok">✅ DOBRA TEZA</div>
      <ul class="list-mono-int">
        <li>„Iako Šimić i Cesarić obojica pišu o samoći, Šimić je vidi kao egzistencijalnu, a Cesarić kao socijalnu — razlika koja otkriva..."</li>
        <li>„Krleža i Marinković, oba majstori novele, prikazuju propast plemstva — ali Krleža iz unutrašnjosti, Marinković s distancom..."</li>
      </ul>
      
      <div class="ex-label-no">❌ LOŠA TEZA</div>
      <ul class="list-mono-int">
        <li>„Šimić i Cesarić su slični." (preopćenito)</li>
        <li>„U eseju ću usporediti A i B." (opisno, ne tezno)</li>
        <li>„A je bolji od B." (vrijednosno, ne analitično)</li>
      </ul>
    </div>
    ...
    <div style="padding:18px 22px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin:14px 0">
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--green);margin-bottom:6px">📜 TEMA</div>
      <div style="font-family:var(--display);font-size:16px;font-weight:700;color:var(--t1);margin-bottom:14px;line-height:1.4">
        Šimićev „More" i Cesarićeva „Tiha pjesma" — dva oblika modernističke samoće
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟢 UVOD (65 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(80,200,120,.04);border-radius:var(--r1)">
        Hrvatski moderni pjesnici Antun Branko Šimić i Dobriša Cesarić, iako gotovo suvremenici, samoću prikazuju iz radikalno različitih perspektiva. Šimićeva „More" iz 1920. godine i Cesarićeva „Tiha pjesma" iz 1931. godine pokazuju dva pogleda na izoliranost čovjeka — egzistencijalni i socijalni. <strong>Usporedba ovih pjesama otkriva širinu hrvatske modernističke poetike</strong> i različite filozofske odgovore na isto pitanje.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🟡 RAZRADA — TEMA + LIKOVI + STIL (~265 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:14px;padding:12px 16px;background:rgba(233,180,70,.04);border-radius:var(--r1)">
        Tematski, obje pjesme stoje pred zagonetkom samoće, no s različitim naglascima. U Šimićevoj „More" lirski subjekt promatra beskrajno more koje postaje <strong>simbol egzistencijalne praznine</strong> — pjesma se pita zašto čovjek postoji u svijetu koji ga ne primjećuje. Cesarićeva „Tiha pjesma", suprotno, smješta samoću u urbani prostor: čovjek u gradu okružen je ljudima, ali nepovezan. Razlika nije slučajna; ona reflektira različita filozofska polazišta — Šimićevu egzistencijalističku (čovjek pred kozmičkim ništavilom), Cesarićevu socijalnu (čovjek pred bezličnim društvom).
        <br><br>
        Likovi (lirski subjekti) također razlikuju oba pjesnika. Šimićev govornik je usamljen pred prirodom — usporediv s romantičarskim genijem, ali bez utjehe. Cesarićev govornik je usamljen u gomili — usporediv s likovima Kafkina Praga. Dok Šimić traži smisao u kontaktu s morem, Cesarić ne traži ništa — prihvaća tihu rezignaciju.
        <br><br>
        Stilski, Šimić koristi <strong>kratki, sažet izraz</strong>, slobodan stih, jake metafore („more bez kraja"). Cesarić piše rimovani stih, melankoličniji ritam, jednostavniji jezik. Šimić želi šokirati, Cesarić utjećiti. Oba postupka legitimna su moderna izraza.
      </div>
      
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--gold);margin-bottom:6px">🔴 ZAKLJUČAK (~90 riječi)</div>
      <div style="font-family:var(--serif);font-size:14px;line-height:1.7;color:var(--t2);margin-bottom:8px;padding:12px 16px;background:rgba(224,82,82,.04);border-radius:var(--r1)">
        Usporedba „More" i „Tihe pjesme" pokazuje da hrvatska moderna nije bila monolitna škola, nego <strong>polifonija glasova</strong> koji su isto pitanje samoće postavljali na različite načine. Šimić ide u egzistencijalne dubine, Cesarić u socijalne plitkine — i oba puta pjesma uspijeva. Upravo zato hrvatska moderna nije izgubila svoju aktualnost: pitanja koja postavlja, o smislu i izolaciji, ostaju ista i u 21. stoljeću, samo s drugačijim morima i gradovima.
      </div>
      
      <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--bd);font-family:var(--mono);font-size:11px;color:var(--t3);letter-spacing:.8px">
        ✓ <strong>420 riječi</strong> · ✓ tezna usporedba · ✓ paralelna metoda · ✓ 3 kriterija · ✓ kontekst · ✓ aktualizacija
      </div>
    </div>
    ...
    <div style="padding:14px 16px;background:rgba(80,200,120,.04);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--green)">3 modelna eseja na ocjenu 5</strong> za usporednu analizu. Klikni temu da otvoriš puni esej.
      </div>
    </div>
    ...
    <details class="esej-details">
      <summary class="esej-summary">
        <span class="esej-num">2.</span>
        <span class="esej-title">Mažuranićeva „Smrt Smail-age Čengića" vs „Hasanaginica"</span>
        <span class="esej-meta">412 riječi</span>
      </summary>
      <div class="esej-body">
        <div class="esej-label esej-label-uvod">🟢 UVOD (60 riječi)</div>
        <div class="esej-text esej-text-uvod">
          Ivan Mažuranić u epu „Smrt Smail-age Čengića" iz 1846. godine i nepoznati narodni pjesnik u baladi „Hasanaginica" obrađuju <strong>tragedije koje proizlaze iz tursko-kršćanskog kulturnog kontakta</strong>. Iako su djela odvojena gotovo stoljećem i različite poetike (umjetničko vs narodno), njihova usporedba otkriva sličnosti hrvatskog odnosa prema Istoku i razlike u tonu — ono što ću pokazati analizom teme, likova i stila.
        </div>
        
        <div class="esej-label esej-label-razrada">🟡 RAZRADA (~265 riječi)</div>
        <div class="esej-text esej-text-razrada">
          Tematski, oba djela polaze od <strong>žrtve i nepravde</strong>, ali idu u različite smjerove. „Smrt Smail-age Čengića" pripovijeda o tursko-kršćanskom sukobu kulminirajući u osveti — Mažuranić oblikuje Smail-agu kao tirana, a Crnogorce kao osvetnike pravde. „Hasanaginica" je intimna obiteljska tragedija — žena koja je prognana iz svog doma zbog navodne nečasti i koja na kraju umire od žalosti. Prvi je javni epos, drugi privatna balada — no oba postavljaju isto pitanje: <strong>tko ima pravo na pravdu i tko snosi posljedice</strong>?
          <br><br>
          Likovi pokazuju razlike u osvjetljavanju. Smail-aga je crno-bijelo zli lik (epska konvencija), dok Hasanaginica nije „kriva" niti „nevina" — ona je žrtva društvene konvencije koja je ne pita za njezino mišljenje. Mažuranić piše junake; narodna pjesma piše ljudska bića. Ta razlika otkriva svojevrsnu <strong>moralnu finoću narodne pjesme</strong> koja umjetnička književnost ponekad gubi u ideološkom plamenu.
          <br><br>
          Stilski, oba djela koriste deseterac — narodni stih hrvatske usmene tradicije. Mažuranić ga, međutim, klasicistički obrađuje, dodaje epitete, retoričke pasaže i alegorije. Narodni pjesnik koristi deseterac na <strong>sažet, gotovo škrt</strong> način, gdje svaka riječ nosi težinu. Mažuranićev tekst je književni, narodni je jezgrovit — i upravo zato „Hasanaginica" do danas djeluje univerzalnije.
        </div>
        
        <div class="esej-label esej-label-zaklj">🔴 ZAKLJUČAK (~87 riječi)</div>
        <div class="esej-text esej-text-zaklj">
          Usporedba „Smrt Smail-age Čengića" i „Hasanaginice" otkriva da je hrvatska književnost o tursko-kršćanskom kontaktu <strong>polifoničnija nego što se na prvi pogled čini</strong>. Dok Mažuranić piše javnu epopeju o pravdi i osveti, narodna pjesma šapuće o privatnoj boli koja prelazi sve kulturne granice. Obje su perspektive potrebne: jedna nas uči o povijesti, druga o čovjeku. <strong>Suvremeni čitatelj</strong> u njima može pronaći ono što povijest često zaboravlja — da iza svake epopeje stoji nečija osobna tragedija.
        </div>
        
        <div class="esej-checklist">
          ✓ <strong>412 riječi</strong> · ✓ tezna usporedba · ✓ paralelna metoda · ✓ 3 kriterija · ✓ moralna finoća · ✓ aktualizacija
        </div>
      </div>
    </details>
    ...
    <details class="esej-details">
      <summary class="esej-summary">
        <span class="esej-num">3.</span>
        <span class="esej-title">Krleža vs Marinković — moderna hrvatska novela</span>
        <span class="esej-meta">408 riječi</span>
      </summary>
      <div class="esej-body">
        <div class="esej-label esej-label-uvod">🟢 UVOD (62 riječi)</div>
        <div class="esej-text esej-text-uvod">
          Miroslav Krleža i Ranko Marinković, dva najveća majstora hrvatske novele 20. stoljeća, gradili su svoje pripovijetke iz različitih književnih i filozofskih perspektiva. Krležina „Cvrčak pod vodopadom" i Marinkovićeve „Ruke" oba su djela vrhunskog modernizma, ali njihov pristup čovjeku, jeziku i svijetu pokazuje <strong>dva različita lica hrvatskog modernizma</strong> — angažirano-društveno i egzistencijalističko.
        </div>
        
        <div class="esej-label esej-label-razrada">🟡 RAZRADA (~258 riječi)</div>
        <div class="esej-text esej-text-razrada">
          Tematski, Krleža u svojim novelama postavlja čovjeka pred <strong>društveno-povijesnu zbilju</strong> — rat, klasne sukobe, propadanje plemstva. Njegov junak je obično obični čovjek shrvan poviješću, no Krleža mu daje glas pun gorčine i kritičke svijesti. Marinković, suprotno, čovjeka stavlja pred <strong>egzistencijalna pitanja</strong> — otuđenje, identitet, smisao tijela i smrti. „Ruke" su tipičan primjer: Marinković drama lika prikazuje kroz dijalog ruku, čime se otvara filozofski problem otuđenosti čovjeka od vlastitog tijela.
          <br><br>
          Likovi pokazuju jasnu razliku. Krležin lik gotovo uvijek nosi <strong>društveni značaj</strong> — on je obrtnik, vojnik, propali plemić, simbol klase ili razdoblja. Marinkovićev lik je <strong>univerzalna ljudska figura</strong>, oslobođena povijesnog konteksta — mogao bi biti hrvatski, francuski ili njemački čovjek 20. stoljeća. Krleža ide u dubinu povijesti, Marinković u dubinu egzistencije.
          <br><br>
          Stilski, Krleža gradi rečenice kao <strong>Sjajni baroknom kompleksnošću</strong> — duge, gnjevne, pune metafora i ironije. Njegov jezik je politički nabijen. Marinkovićev stil je <strong>filozofski distanciran</strong> — kratki, gotovo aforistični izrazi koji upijaju cijeli filozofski svijet. Krleža bjesni; Marinković kontemplira. Oba pristupa legitimna su moderna izraza, ali idu u različite smjerove.
        </div>
        
        <div class="esej-label esej-label-zaklj">🔴 ZAKLJUČAK (~88 riječi)</div>
        <div class="esej-text esej-text-zaklj">
          Krleža i Marinković zajedno čine <strong>cjelinu hrvatske moderne novele</strong>, ali ne istom oštricom. Krleža gleda u povijest s gnjevom; Marinković gleda u čovjeka s tihom melankolijom. Krležini junaci su zarobljenici svoje epohe, Marinkovićevi vlastite svijesti. Usporedba ovih dvaju autora otkriva da hrvatski modernizam nije bio jedan glas, nego <strong>polifonija glasova</strong> — od socijalnog gnjeva do egzistencijalnog kontemplacije. Upravo zato hrvatska novela 20. stoljeća do danas djeluje <strong>univerzalno relevantno</strong>: u njoj je istovremeno povijest i čovjek.
        </div>
        
        <div class="esej-checklist">
          ✓ <strong>408 riječi</strong> · ✓ tezna usporedba · ✓ paralelna metoda · ✓ 3 kriterija · ✓ filozofska polazišta · ✓ aktualizacija
        </div>
      </div>
    </details>

    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Provjera razumijevanja · usporedna analiza</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">10 pitanja iz komparativne metode i strukture.</strong>
      </div>
    </div>

    <div id="usp-exercise"></div>

    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(2)">← Raspravljački</button>
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      ...
      <span class="pill p-br hchip">📚 30 maturalnih tema</span>
      <span class="pill p-pa hchip">⏱ Timer · Auto-save</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📝 Esej Workspace · maturalna simulacija</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">📝 Glavni feature H27</div>
      <div class="box-int-txt">
        <strong>Interaktivni urednik za pisanje eseja.</strong> 30 maturalnih tema (10 interpretativnih + 10 raspravljačkih + 10 usporednih). Word counter s color-coding, timer (4h/2h/1h), auto-save svakih 5 sekundi. Realna simulacija mature.
      </div>
    </div>
    ...
    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(3)">← Usporedna analiza</button>
      <button type="button" class="nb-btn primary" onclick="sw(5)">✨ Stil i jezik →</button>
    </div>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">✨ Stil i jezik</span>
      <span class="pill p-br hchip">🎭 15 stilskih figura</span>
      <span class="pill p-pa hchip">📖 Bogat rječnik</span>
    </div>

    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">✨ Stil i jezik · 40% bodova za stil</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">✨ Stil = 40% bodova</div>
      <div class="box-int-txt">
        Stil eseja je <strong>jednako važan kao sadržaj</strong> (40% bodova). Sastoji se od: <strong>bogatog rječnika</strong> (sinonimi, izbjegavanje ponavljanja), <strong>stilskih figura</strong> (metafora, usporedba, antiteza...), <strong>varijacije rečenice</strong> (kratke + duge) i <strong>izbjegavanja klišeja</strong>.
      </div>
    </div>

    <!-- ─────────── 15 STILSKIH FIGURA ─────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎭 15 stilskih figura · za maturalni esej</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Cilj: 2-3 stilske figure u eseju</strong> (umjereno, ne pretjerano). Najjače figure: <strong>metafora, usporedba, antiteza, gradacija</strong>. Detaljniju razradu svih figura imat će H28.
      </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;margin:16px 0">
      ...
      <div class="pravilo-box">
        <div class="cap-mono-gold">1. METAFORA ⭐</div>
        <div class="pravilo-header">Prenošenje značenja</div>
        <div class="pravilo-desc">Riječ se koristi u prenesenom značenju radi slikovitog izraza.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Život je <strong>more</strong> kojim plovimo."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">2. USPOREDBA ⭐</div>
        <div class="pravilo-header">Eksplicitno povezivanje</div>
        <div class="pravilo-desc">Povezuje dvije stvari riječima „kao", „poput", „nalik".</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Stoji <strong>kao stijena</strong> pred valovima."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">3. ANTITEZA ⭐</div>
        <div class="pravilo-header">Suprotstavljanje</div>
        <div class="pravilo-desc">Suprotstavljanje dvaju suprotnih pojmova radi kontrasta.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Ljubav i mržnja, <strong>život i smrt</strong>, idu zajedno."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">4. GRADACIJA ⭐</div>
        <div class="pravilo-header">Postupno pojačavanje</div>
        <div class="pravilo-desc">Niz pojmova s rastućim ili opadajućim intenzitetom.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Došao je, <strong>vidio, pobijedio</strong>."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">5. EPITET</div>
        <div class="pravilo-header">Slikoviti pridjev</div>
        <div class="pravilo-desc">Pridjev koji daje slikovitu, emocionalnu karakterizaciju.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>Slavna</strong> Judita, <strong>okrutni</strong> Holoferno."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">6. PERSONIFIKACIJA</div>
        <div class="pravilo-header">Oživljavanje neživog</div>
        <div class="pravilo-desc">Neživim stvarima ili apstrakcijama daje se ljudska osobina.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>Vjetar šapće</strong> kroz krošnje."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">7. HIPERBOLA</div>
        <div class="pravilo-header">Pretjerivanje</div>
        <div class="pravilo-desc">Namjerno pretjerivanje radi naglaska.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Čekao sam te <strong>cijelu vječnost</strong>."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">8. IRONIJA</div>
        <div class="pravilo-header">Suprotno značenje</div>
        <div class="pravilo-desc">Riječ ili rečenica koja znači suprotno od doslovnog značenja.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>Baš ti hvala</strong> na pomoći." (kad nije pomogao)</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">9. ASINDETON</div>
        <div class="pravilo-header">Bez veznika</div>
        <div class="pravilo-desc">Nabrajanje bez veznika radi dinamike.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Trčao je, <strong>padao, ustajao, nastavljao</strong>."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">10. POLISINDETON</div>
        <div class="pravilo-header">Mnogo veznika</div>
        <div class="pravilo-desc">Ponavljanje veznika („i") radi naglašavanja.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>I</strong> kiša, <strong>i</strong> vjetar, <strong>i</strong> hladnoća."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">11. ANAFORA</div>
        <div class="pravilo-header">Ponavljanje na početku</div>
        <div class="pravilo-desc">Ista riječ/fraza ponavlja se na početku rečenica.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>Volim</strong> tišinu. <strong>Volim</strong> noć. <strong>Volim</strong> samoću."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">12. EPIFORA</div>
        <div class="pravilo-header">Ponavljanje na kraju</div>
        <div class="pravilo-desc">Ista riječ/fraza ponavlja se na kraju rečenica.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Sve sam izgubio. Sebe nisam <strong>izgubio</strong>."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">13. RETORIČKO PITANJE</div>
        <div class="pravilo-header">Pitanje bez odgovora</div>
        <div class="pravilo-desc">Pitanje na koje se ne očekuje odgovor — služi za naglasak.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>Tko nas može razumjeti?</strong>"</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">14. PARALELIZAM</div>
        <div class="pravilo-header">Paralelna struktura</div>
        <div class="pravilo-desc">Slične rečenice ili fraze ponavljaju se s istom strukturom.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„Tko traži, nalazi. Tko kuca, otvara mu se."</div>
      </div>
      
      <div class="pravilo-box">
        <div class="cap-mono-gold">15. KONTRAST</div>
        <div class="pravilo-header">Naglašena razlika</div>
        <div class="pravilo-desc">Stavljanje suprotnih elemenata jedan do drugog.</div>
        <div class="ex-label-ok">PRIMJER</div>
        <div style="font-family:var(--serif);font-size:13px;color:var(--t2);font-style:italic;line-height:1.5">„<strong>Bogati</strong> u palačama, <strong>siromasi</strong> na ulicama."</div>
      </div>
      
    </div>

    <!-- ─────────── BOGAT RJEČNIK ─────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📖 Bogat rječnik · sinonimi koji ti spasiti esej</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Pravilo: ne ponavljaj iste riječi</div>
      <div class="pravilo-desc">
        Ako u eseju riječ „dobar" koristiš 8 puta, gubiš bodove za stil. Koristi <strong>sinonime</strong>.
      </div>
    </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:11px;width:120px">UOBIČAJENO</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:11px">SINONIMI ZA ESEJ</th>
          </tr>
        </thead>
        <tbody>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">dobar</td><td class="tbl-cell">kvalitetan, izvrstan, vrijedan, izniman, vrhunski, plemenit, vrhunski</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">loš</td><td class="tbl-cell">manjkav, problematičan, sporan, opasan, štetan, nedovoljan</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">mnogo</td><td class="tbl-cell">brojni, mnoštvo, niz, golem, znatan, izrazit</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">važno</td><td class="tbl-cell">presudno, ključno, neophodno, temeljno, bitno, esencijalno</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">mislim da</td><td class="tbl-cell">smatram, držim, vjerujem, uvjeren sam, čini mi se, držim za...</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">pokazuje</td><td class="tbl-cell">otkriva, dokazuje, ilustrira, demonstrira, svjedoči, potvrđuje</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">znači</td><td class="tbl-cell">predstavlja, simbolizira, označava, podrazumijeva, upućuje</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">kaže</td><td class="tbl-cell">tvrdi, ističe, naglašava, smatra, priznaje, izjavljuje</td></tr>
          <tr><td class="tbl-cell-bold">na kraju</td><td class="tbl-cell">u zaključku, naposljetku, konačno, sumirajući, zaokružujući</td></tr>
        </tbody>
      </table>
    </div>

    <!-- ─────────── TRANZICIJE ─────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🔗 Tranzicije · veze između paragrafa</div><div class="sec-line"></div></div>
    
    <div class="pravilo-box">
      <div class="pravilo-header">📋 Tranzicije = koherencija</div>
      <div class="pravilo-desc">
        Bez tranzicija paragrafi „padaju" jedan iza drugog bez logičnog slijeda. Tranzicije <strong>vežu misli u smislenu cjelinu</strong>.
      </div>
      
      <div class="ex-label-ok">✅ DODAVANJE</div>
      <ul class="list-mono-int">
        <li>Nadalje, Osim toga, Također, K tome, Pored toga, Štoviše</li>
      </ul>
      
      <div class="ex-label-blue">⚪ KONTRAST</div>
      <ul class="list-mono-int">
        <li>S druge strane, Međutim, Suprotno tome, No, Ipak, Premda</li>
      </ul>
      
      <div class="ex-label-no">❌ POSLJEDICA</div>
      <ul class="list-mono-int">
        <li>Stoga, Posljedično, Zbog toga, Prema tome, Iz toga slijedi</li>
      </ul>
      
      <div class="ex-label-ok">✅ PRIMJER</div>
      <ul class="list-mono-int">
        <li>Primjerice, Na primjer, Konkretan slučaj je, Ilustracija toga je</li>
      </ul>
      
      <div class="ex-label-blue">⚪ ZAKLJUČAK</div>
      <ul class="list-mono-int">
        <li>Dakle, U zaključku, Sumirajući, Konačno, Na kraju, Sve u svemu</li>
      </ul>
    </div>

    <!-- ─────────── KLIŠEJI ─────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">⚠️ Klišei koje treba izbjegavati</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--red);margin-bottom:8px">❌ NE U ESEJU</div>
      <ul class="list-mono-int">
        <li>„Od pamtivijeka..." (klišejski uvod)</li>
        <li>„Svi znamo da..." (generička tvrdnja)</li>
        <li>„U današnje doba..." (predobičan uvod)</li>
        <li>„Život je čudna stvar..." (banalnost)</li>
        <li>„Vrijeme će pokazati..." (klišej)</li>
        <li>„Riječima se ne može opisati..." (lijenost)</li>
        <li>„Posljednje, ali ne manje važno..." (anglizam)</li>
        <li>„Dame i gospodo..." (esej nije govor)</li>
      </ul>
    </div>

    <!-- ─────────── INLINE QUIZ ─────────── -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🎯 Provjera razumijevanja · stilske figure</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 16px;background:rgba(74,144,217,.04);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--blue)">Pitanja iz prepoznavanja stilskih figura.</strong> Detaljniji kviz na 80+ figura bit će u H28.
      </div>
    </div>

    <div id="stil-exercise"></div>
  ...
  <div class="layer" id="l6" role="tabpanel" tabindex="0">
    ...
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">✓ Esej Checklist · 25 stavki</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">✓ Glavni feature H27</div>
      <div class="box-int-txt">
        <strong>Provjeri esej prije predaje.</strong> 25 stavki organiziranih u 4 kategorije: <strong>Struktura, Sadržaj, Stil, Pismenost</strong>. Neke se provjeravaju automatski (word count, citati, paragrafi), većinu označavaš sam. ⭐ označava NCVVO-kritične stavke.
      </div>
    </div>
    ...
    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button type="button" class="nb-btn" onclick="sw(5)">← Stil i jezik</button>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div class="tags">
      <span class="pill p-pa hchip">📚 Pojmovnik · 50 pojmova</span>
      <span class="pill p-br hchip">📋 Cheat sheet · maturalni</span>
    </div>

    <!-- ─────────────── POJMOVNIK ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📚 Pojmovnik · 50 esej pojmova</div><div class="sec-line"></div></div>
    ...
    <div class="pojm-controls" style="margin:18px 0">
      <div class="pojm-filters" style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:14px">
        ...
        <button type="button" class="pojm-filter" onclick="pojmFilter2('tipovi', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Tipovi eseja</button>
        <button type="button" class="pojm-filter" onclick="pojmFilter2('sadrzaj', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Sadržaj</button>
        <button type="button" class="pojm-filter" onclick="pojmFilter2('stil', this)" style="padding:6px 12px;font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;border-radius:20px;cursor:pointer;border:1px solid var(--bd);background:transparent;color:var(--t3)">Stil</button>
    ...
    <div style="padding:18px;background:linear-gradient(135deg,rgba(233,180,70,.04),transparent);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.7;color:var(--t2);font-family:var(--serif)">
        <strong>Sve esej-ključno na jednom mjestu.</strong> Print prije mature za brzu reviziju.
      </div>
    </div>

    <!-- UKR FORMULA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">📋 UKR formula · brza referenca</div><div class="sec-line"></div></div>
    
    <div class="table-wrap">
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:11px;width:120px">DIO</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:11px;width:80px">RIJEČI</th>
            <th class="tbl-cell" style="text-align:left;color:var(--gold);font-size:11px">FUNKCIJA</th>
          </tr>
        </thead>
        <tbody>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">UVOD</td><td class="tbl-cell-bold">50-70</td><td class="tbl-cell">Kontekst djela + jasna teza koju ćeš braniti</td></tr>
          <tr class="tbl-row-bd"><td class="tbl-cell-bold">RAZRADA</td><td class="tbl-cell-bold">250-300</td><td class="tbl-cell">3-4 paragrafa: 1 ideja + dokaz + tranzicija</td></tr>
          <tr><td class="tbl-cell-bold">ZAKLJUČAK</td><td class="tbl-cell-bold">80-100</td><td class="tbl-cell">Sinteza + vraćanje na uvodnu tezu</td></tr>
        </tbody>
      </table>
    </div>

    <!-- TOP TRANZICIJE -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">🔗 Top tranzicije · brza referenca</div><div class="sec-line"></div></div>
    
    <div style="padding:14px 18px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <ul style="margin:0;padding-left:20px;font-size:13px;line-height:1.8;color:var(--t2);font-family:var(--mono)">
        <li><strong>Dodavanje:</strong> Nadalje · Osim toga · Također · K tome · Štoviše</li>
        <li><strong>Kontrast:</strong> S druge strane · Međutim · Suprotno tome · No · Ipak</li>
        <li><strong>Posljedica:</strong> Stoga · Posljedično · Zbog toga · Iz toga slijedi</li>
        <li><strong>Primjer:</strong> Primjerice · Konkretan slučaj je · Ilustracija toga je</li>
        <li><strong>Zaključak:</strong> Dakle · U zaključku · Sumirajući · Konačno · Sve u svemu</li>
      </ul>
    </div>

    <!-- 12 TOP PRAVILA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">⚠️ 12 TOP pravila — pamti pred maturom</div><div class="sec-line"></div></div>
    ...
    <div style="padding:18px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <ol style="margin:0;padding-left:20px;font-size:13px;line-height:1.8;color:var(--t2)">
        <li><strong style="color:var(--red)">Word count 350-450 riječi</strong> — izvan = penalizacija</li>
        <li><strong style="color:var(--red)">Jasna teza u uvodu</strong> — bez teze, esej je nestrukturiran</li>
        <li><strong style="color:var(--red)">UKR struktura</strong> — Uvod (50r) + Razrada (250r) + Zaključak (100r)</li>
        <li><strong style="color:var(--red)">3:1 vremenska podjela</strong> — 3h pisanje + 1h revizija</li>
        <li><strong style="color:var(--red)">Citati u navodnicima</strong> — hrvatski „...„ ne engleski "..."</li>
        <li><strong style="color:var(--red)">1 paragraf = 1 ideja</strong> + dokaz + tranzicija</li>
        <li><strong style="color:var(--red)">Tranzicije</strong> — Nadalje, S druge strane, Konačno...</li>
        <li><strong style="color:var(--red)">Bogat rječnik</strong> — sinonimi, izbjegavanje ponavljanja</li>
        <li><strong style="color:var(--red)">2-3 stilske figure</strong> — metafora, usporedba, antiteza</li>
        <li><strong style="color:var(--red)">Zaključak ≠ nove informacije</strong> — sintetizira, ne dodaje</li>
        <li><strong style="color:var(--red)">Bez klišeja</strong> — ne „od pamtivijeka", „svi znamo da"</li>
        <li><strong style="color:var(--red)">Lektura prije predaje</strong> — pravopis + interpunkcija</li>
      </ol>
    </div>

    <!-- VREMENSKA PODJELA -->
    <div class="sec-hdr mt-32"><div class="sec-line"></div><div class="sec-badge">⏱ Vremenska podjela · 4 sata</div><div class="sec-line"></div></div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px;margin:14px 0">
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r1)">
        <div class="cap-mono-gold">PRVI SAT</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--blue);margin-bottom:6px">Plan + Uvod</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.5">
          15min plan strukture (teza, paragrafi)<br>
          45min: uvod + prvi paragraf razrade
        </div>
      </div>
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--gold);border-radius:var(--r1)">
        <div class="cap-mono-gold">DRUGI + TREĆI SAT</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:6px">Razrada + Zaključak</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.5">
          1h: ostali paragrafi razrade<br>
          1h: dovrši razradu + napiši zaključak
        </div>
      </div>
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <div class="cap-mono-gold">ČETVRTI SAT ⭐</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--red);margin-bottom:6px">Revizija (1h)</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.5">
          Pravopis + interpunkcija<br>
          Word count provjera<br>
          Stilski popravci
        </div>
      </div>
    </div>
  ...
  <div class="chapter-nav-wrap">
    ...
    <div class="chapter-nav-grid">
      ...
      <a class="chapter-nav-card chapter-nav-prev" href="/skripte/hrv/h26">
        ...
        <div class="chapter-nav-meta">
          ...
          <div class="chapter-nav-desc">Zarez (8 pravila), crtica vs spojnica + Proofreading</div>
        </div>
      </a>
      
      <a class="chapter-nav-card chapter-nav-next" href="/skripte/hrv/h28">
        <div class="chapter-nav-meta">
          <div class="chapter-nav-pill chapter-nav-pill-next">SLJEDEĆE</div>
          <div class="chapter-nav-name">H28 · Sažetak</div>
          <div class="chapter-nav-desc">4 koraka + Workspace s 10 polaznih tekstova + plagijat detektor + Pro AI feedback</div>
        </div>
        <div class="chapter-nav-arrow">→</div>
      </a>
    ...
    <div class="chapter-nav-related">
      ...
      <div class="chapter-nav-related-grid">
        <a class="chapter-nav-mini" href="/skripte/hrv/h28">
          <span class="chapter-nav-mini-code">H28</span>
          <span class="chapter-nav-mini-name">Sažetak</span>
        </a>
        ...
        <a class="chapter-nav-mini" href="/skripte/hrv/h17">
          ...
          <span class="chapter-nav-mini-name">Stilistika</span>
        </a>
      </div>
    </div>
  </div>
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H27 kolski esej</div>
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h27.tab') || '0') }catch(e){return 0} })(),
...
const DIAG0_Q=[
  {q:\`Koliko vremena imaš za pisanje školskog eseja na maturi?\`,o:[\`4 sata\`,\`2 sata\`],t:0,e:\`Na državnoj maturi imaš 4 sata za pisanje školskog eseja.\`},
  {q:\`Koliko riječi mora imati esej?\`,o:[\`350-450 riječi\`,\`200-300 riječi\`],t:0,e:\`Standard za maturu: 350-450 riječi. Manje od 350 ili više od 450 vodi penalizaciji.\`},
  {q:\`Koliko tipova školskog eseja postoji?\`,o:[\`3 tipa\`,\`5 tipova\`],t:0,e:\`Tri tipa: interpretativni, raspravljački, usporedna analiza.\`},
  {q:\`Koji kriterij ima najveću težinu u ocjenjivanju?\`,o:[\`Sadržaj i stil su izjednačeni (40%+40%)\`,\`Pismenost (50%)\`],t:0,e:\`Sadržaj 40% + Stil 40% + Pismenost 20%. Sadržaj i stil su podjednako važni.\`},
  {q:\`Što je glavni cilj UVODA?\`,o:[\`Postaviti tezu i pripremiti čitatelja\`,\`Iznijeti zaključak\`],t:0,e:\`Uvod (~50 riječi) postavlja tezu i kontekst, ne iznosi zaključak.\`},
  {q:\`Koji esej zahtjeva analizu jednog djela?\`,o:[\`Interpretativni\`,\`Raspravljački\`],t:0,e:\`Interpretativni esej analizira jedno književno djelo (tema, likovi, stil, poruka).\`},
  {q:\`Koji esej traži zauzimanje stava i argumentaciju?\`,o:[\`Raspravljački\`,\`Usporedna analiza\`],t:0,e:\`Raspravljački esej traži stav (teza) + argumente za i protiv + zaključak.\`},
  {q:\`Što je usporedna analiza?\`,o:[\`Komparacija dvaju ili više djela\`,\`Analiza jednog autora\`],t:0,e:\`Usporedna analiza komparira dva ili više djela po kriteriju (tema, stil, lik, poruka).\`},
  {q:\`Koliko paragrafa minimum mora imati razrada?\`,o:[\`3 paragrafa\`,\`1 paragraf\`],t:0,e:\`Razrada (~250 riječi) treba imati minimum 3 paragrafa za logičan slijed misli.\`},
  {q:\`Koja je glavna funkcija ZAKLJUČKA?\`,o:[\`Sintetizirati i vratiti se na uvodnu tezu\`,\`Donijeti nove informacije\`],t:0,e:\`Zaključak (~100 riječi) sintetizira razradu i vraća se na uvodnu tezu — NE iznosi nove informacije.\`},
  {q:\`Što su tranzicije u eseju?\`,o:[\`Veze između paragrafa za logičan slijed\`,\`Završne rečenice paragrafa\`],t:0,e:\`Tranzicije su rečenice/fraze koje povezuju paragrafe (npr. „Nadalje", „S druge strane", „Konačno").\`},
  {q:\`Što je teza eseja?\`,o:[\`Glavna ideja koju esej brani\`,\`Naslov eseja\`],t:0,e:\`Teza je glavna tvrdnja/ideja eseja koju razrada brani argumentima i primjerima.\`},
];
...
const POJM_DATA2 = [
  // STRUKTURA (10)
  {kat:'struktura', term:\`Uvod\`, def:\`Prvi dio eseja (50-70 riječi). Postavlja kontekst i tezu. Klјučno: ne smije biti generički ili klišejski.\`, star:true},
  {kat:'struktura', term:\`Razrada\`, def:\`Središnji dio eseja (250-300 riječi, 3-4 paragrafa). Razvija tezu kroz argumente, primjere, citate.\`, star:true},
  {kat:'struktura', term:\`Zaključak\`, def:\`Zadnji dio eseja (80-100 riječi). Sintetizira razradu i vraća se na uvodnu tezu. NIKAD ne donosi nove informacije.\`, star:true},
  {kat:'struktura', term:\`Teza\`, def:\`Glavna tvrdnja eseja koju razrada brani argumentima i primjerima. Mora biti jasna, specifična, branjiva.\`, star:true},
  {kat:'struktura', term:\`Paragraf\`, def:\`Logička jedinica eseja. Pravilo: 1 paragraf = 1 glavna ideja + dokaz/primjer + tranzicija na sljedeći.\`, star:true},
  {kat:'struktura', term:\`Tranzicija\`, def:\`Veza između paragrafa za logičan slijed. Primjeri: „Nadalje", „S druge strane", „Konačno", „Slično tome".\`, star:true},
  {kat:'struktura', term:\`UKR formula\`, def:\`Mnemotehnika: Uvod + Razrada + Zaključak. 3-dijelna struktura koja vrijedi za sva 3 tipa eseja.\`, star:true},
  {kat:'struktura', term:\`Word count\`, def:\`Broj riječi u eseju. Ciljani raspon: 350-450. Izvan ovih granica = penalizacija. Idealno: 380-430.\`, star:true},
  {kat:'struktura', term:\`Naslov eseja\`, def:\`Često zadan, ali ako ne — formuliraj nakon pisanja. Mora odražavati glavnu tezu.\`, star:false},
  {kat:'struktura', term:\`Logičan slijed\`, def:\`Misli idu od jednostavnijih ka složenijima. Ne preskaču. Tranzicije ih vežu.\`, star:true},
  
  // TIPOVI ESEJA (8)
  {kat:'tipovi', term:\`Interpretativni esej\`, def:\`Analiza jednog književnog djela (tema, likovi, stil, poruka). Najčešći tip na maturi (~50%).\`, star:true},
  {kat:'tipovi', term:\`Raspravljački esej\`, def:\`Esej u kojem se zauzima stav i brani argumentima. Tema obično društvena. Mora imati jasnu tezu.\`, star:true},
  {kat:'tipovi', term:\`Usporedna analiza\`, def:\`Komparacija dvaju (ili više) djela po kriteriju: tema, lik, stil, poruka. Najteži tip.\`, star:true},
  {kat:'tipovi', term:\`Blok metoda\`, def:\`Metoda usporedbe: prvo cijela analiza A, zatim cijela analiza B, na kraju usporedba u zaključku.\`, star:false},
  {kat:'tipovi', term:\`Paralelna metoda\`, def:\`Metoda usporedbe: po svakom kriteriju usporedi A i B u istom paragrafu. Preporučeno za bolje koherencije.\`, star:true},
  {kat:'tipovi', term:\`„Analiziraj"\`, def:\`Keyword za interpretativni esej. Tema: analiza djela.\`, star:true},
  {kat:'tipovi', term:\`„Raspravi"\`, def:\`Keyword za raspravljački esej. Tema: zauzmi stav i brani ga.\`, star:true},
  {kat:'tipovi', term:\`„Usporedi"\`, def:\`Keyword za usporednu analizu. Tema: komparacija dvaju djela.\`, star:true},
  
  // SADRŽAJ (8)
  {kat:'sadrzaj', term:\`Argument\`, def:\`Logična tvrdnja koja se može potkrijepiti dokazima. NIJE „mislim da" ili „svi znaju".\`, star:true},
  {kat:'sadrzaj', term:\`Dokaz\`, def:\`Činjenica, primjer, citat ili statistika koja potkrjepljuje argument.\`, star:true},
  {kat:'sadrzaj', term:\`Citat\`, def:\`Doslovno preneseni dijelak iz djela u navodnicima „...". Esencijalan za interpretativni esej.\`, star:true},
  {kat:'sadrzaj', term:\`Kontekst\`, def:\`Povijesno, kulturološko ili biografsko okruženje djela. Bitno za interpretativni i usporednu analizu.\`, star:true},
  {kat:'sadrzaj', term:\`Protuargument\`, def:\`Suprotni stav, koji autor SPOMINJE i opovrgava. Jača raspravljački esej.\`, star:true},
  {kat:'sadrzaj', term:\`Karakterizacija\`, def:\`Opis i analiza lika (psihološka, socijalna, jezična). Ključna u interpretativnom eseju.\`, star:false},
  {kat:'sadrzaj', term:\`Tema djela\`, def:\`Glavna problemska preokupacija djela (samoća, ljubav, smrt, pravda...).\`, star:false},
  {kat:'sadrzaj', term:\`Poruka djela\`, def:\`Univerzalna ideja koju djelo prenosi čitatelju. Često se nalazi u zaključku eseja.\`, star:false},
  
  // STIL (10)
  {kat:'stil', term:\`Stilska figura\`, def:\`Posebno oblikovani izraz radi slikovitosti ili emocionalne snage. Najjače: metafora, usporedba, antiteza.\`, star:true},
  {kat:'stil', term:\`Metafora\`, def:\`Prenošenje značenja. „Život je more." Najmoćnija stilska figura.\`, star:true},
  {kat:'stil', term:\`Usporedba\`, def:\`Eksplicitno povezivanje dvaju pojmova s „kao", „poput". „Stoji kao stijena."\`, star:true},
  {kat:'stil', term:\`Antiteza\`, def:\`Suprotstavljanje pojmova radi kontrasta. „Život i smrt, ljubav i mržnja."\`, star:true},
  {kat:'stil', term:\`Gradacija\`, def:\`Niz s rastućim ili opadajućim intenzitetom. „Došao, vidio, pobijedio."\`, star:true},
  {kat:'stil', term:\`Sinonim\`, def:\`Riječ istog ili sličnog značenja. Kuhija u eseju jer izbjegava ponavljanja.\`, star:true},
  {kat:'stil', term:\`Epitet\`, def:\`Slikoviti pridjev. „Slavna Judita", „okrutni Holoferno".\`, star:false},
  {kat:'stil', term:\`Personifikacija\`, def:\`Davanje ljudskih osobina neživim stvarima. „Vjetar šapće."\`, star:false},
  {kat:'stil', term:\`Hiperbola\`, def:\`Pretjerivanje radi naglaska. „Čekao sam te cijelu vječnost."\`, star:false},
  {kat:'stil', term:\`Klišej\`, def:\`Banalna, izlizana fraza koja gubi bodove. „Od pamtivijeka", „Svi znamo da".\`, star:true},
  
  // PISMENOST (8)
  {kat:'pismenost', term:\`Pravopis\`, def:\`Pravila o pisanju riječi. 20% bodova eseja. Najčešće: spojeno/odvojeno, č/ć, đ/dž. Vidi H25.\`, star:true},
  {kat:'pismenost', term:\`Interpunkcija\`, def:\`Pravila o interpunkcijskim znakovima (zarez, točka, navodnici). Vidi H26.\`, star:true},
  {kat:'pismenost', term:\`Hrvatski navodnici\`, def:\`Standard: „..." (dolje gore). Engleski "..." je pravopisna greška.\`, star:true},
  {kat:'pismenost', term:\`Vokativ\`, def:\`Padež oslovljavanja. UVIJEK ima zarez. „Marko, dođi."\`, star:false},
  {kat:'pismenost', term:\`Apozicija\`, def:\`Pojašnjenje uz imenicu, odvojeno zarezima s obje strane. „Marko, moj prijatelj, došao je."\`, star:false},
  {kat:'pismenost', term:\`Lektura\`, def:\`Pažljiva revizija eseja prije predaje. Ključno: ostaviti vremena (1 sat).\`, star:true},
  {kat:'pismenost', term:\`Tipografska greška\`, def:\`Slučajna greška pri pisanju (pretipkala, dvostruka slova). Lektorirat će ih revizija.\`, star:false},
  {kat:'pismenost', term:\`Rukopis\`, def:\`Esej se piše rukom na maturi. Neuredan rukopis otežava ocjenjivanje — gubi bodove.\`, star:false},
  
  // OCJENJIVANJE (6)
  {kat:'ocjena', term:\`Sadržaj (40%)\`, def:\`Kriterij ocjenjivanja: kvaliteta argumenata, primjera, kontekstualizacije.\`, star:true},
  {kat:'ocjena', term:\`Stil (40%)\`, def:\`Kriterij ocjenjivanja: bogat rječnik, stilske figure, varijacija rečenica.\`, star:true},
  {kat:'ocjena', term:\`Pismenost (20%)\`, def:\`Kriterij ocjenjivanja: pravopis, interpunkcija, navodnici, formatiranje.\`, star:true},
  {kat:'ocjena', term:\`NCVVO\`, def:\`Nacionalni centar za vanjsko vrednovanje obrazovanja. Provodi maturu i postavlja kriterije.\`, star:false},
  {kat:'ocjena', term:\`Kriteriji ocjenjivanja\`, def:\`3 kriterija: sadržaj 40% + stil 40% + pismenost 20%.\`, star:true},
  {kat:'ocjena', term:\`Bodovi za esej\`, def:\`Esej čini ~40% ukupnih bodova mature iz hrvatskog. Najveći individualni element.\`, star:true},
];let pojm2Active = 'all';
let pojm2Mode = 'grid';
let pj2Data = [];
let pj2Idx = 0;
...
function renderPojm2(){
  ...
  struktura: 'Struktura',
  tipovi: 'Tipovi eseja',
  sadrzaj: 'Sadržaj · argumentacija',
  stil: 'Stil · figure · rječnik',
  pismenost: 'Pismenost',
  ocjena: 'Ocjenjivanje'
};
...
function declineNoun(){
  ...
  \`;
    ...
    // Save to history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h27.decl_hist')||'[]');
    if(!hist.some(h => h.word === word)){
      hist.push({word, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h27.decl_hist', JSON.stringify(hist.slice(-15)));
    }
  } catch(e){}
...
function morfoAnalyze(){
  ...
  // Save to history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h27.scanner_hist')||'[]');
    // Only save valid words (no special chars)
    if(/^[a-zčćđšžA-ZČĆĐŠŽ\\s]+$/.test(word) && word.length < 50){
      hist.push({word, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h27.scanner_hist', JSON.stringify(hist.slice(-20)));
    }
  } catch(e){}
}
...
function parserAnalyze(){
  ...
  if(/^[a-zA-ZčćđšžČĆĐŠŽ0-9\\s.,!?;:'-]+$/.test(text) && text.length < 200){
    try {
      const hist = JSON.parse(localStorage.getItem('mt.hrv.h27.parser_hist') || '[]');
      hist.push({text, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h27.parser_hist', JSON.stringify(hist.slice(-15)));
    } catch(e){}
  }
...
async function aiAsk(){
  ...
  try {
    ...
    // Save history
    try {
      const hist = JSON.parse(localStorage.getItem('mt.hrv.h27.ai_hist') || '[]');
      hist.push({q: question, a: text.slice(0, 500), date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h27.ai_hist', JSON.stringify(hist.slice(-10)));
    } catch(e){}
...
try { pojmStars = JSON.parse(localStorage.getItem('mt.hrv.h27.cit_stars') || '{}'); } catch(e){ pojmStars = {}; }
...
function pojmToggleStar(term, btn){
  ...
  try { localStorage.setItem('mt.hrv.h27.cit_stars', JSON.stringify(pojmStars)); } catch(e){}
}
...
function parserShowHistory(){
  let hist = [];
  try { hist = JSON.parse(localStorage.getItem('mt.hrv.h27.parser_hist') || '[]'); } catch(e){}
...
function parserClearHistory(){
  if(confirm('Obrisati svu povijest analiza?')){
    try { localStorage.removeItem('mt.hrv.h27.parser_hist'); } catch(e){}
    parserShowHistory();
  }
}
...
function diag0End(){
  ...
  if(pct>=80){
    msg='🌟 Odličan! Znaš teoriju eseja. Idi direktno na <strong>Workspace</strong> i počni vježbati pisanje.';
    btnTxt='📝 Workspace →'; btnTab=4;
  } else if(pct>=60){
    msg='👍 Solidan temelj. Pojača <strong>Interpretativni esej (Tab 1)</strong> — najčešći tip na maturi.';
    btnTxt='📚 Interpretativni esej →'; btnTab=1;
  } else if(pct>=40){
    msg='📚 Imaš osnovu, ali ima rupa. Krećemo s <strong>Interpretativnim esejom</strong> — najvažniji tip.';
    btnTxt='📚 Interpretativni esej →'; btnTab=1;
  } else {
    msg='💪 Esej je vještina koja se gradi vježbom. Krećemo s <strong>Teorijom (Tab 0)</strong> i osnovama strukture.';
...
let citStars={};
try{citStars=JSON.parse(localStorage.getItem('mt.hrv.h27.cit_stars')||'{}')}catch(e){}
let citActive='sve';

function togStar(i,el){
  citStars[i]=!citStars[i];
  el.classList.toggle('starred',!!citStars[i]);
  try{localStorage.setItem('mt.hrv.h27.cit_stars',JSON.stringify(citStars))}catch(e){}
}
...
function scannerUpdate(){
  ...
  try{localStorage.setItem('mt.hrv.h27.wc_text',txt);}catch(e){}
}
(function(){
  const ta=document.getElementById('scanner-in');
  if(!ta)return;
  try{const sv=localStorage.getItem('mt.hrv.h27.wc_text');if(sv){ta.value=sv;scannerUpdate();}}catch(e){}
})();
...
═══════════════════════════════════ */
let CP_STATE={done:{}};
try{const s=localStorage.getItem('mt.hrv.h27.cp');if(s)CP_STATE=JSON.parse(s);}catch(e){}
...
function cpToggle(i){
  ...
  try{localStorage.setItem('mt.hrv.h27.cp',JSON.stringify(CP_STATE));}catch(e){}
  cpRender();
...
function cpReset(){
  CP_STATE={done:{}};
  try{localStorage.removeItem('mt.hrv.h27.cp');}catch(e){}
  cpRender();
}
cpRender();
...
═══════════════════════════════════ */
let TAB_DONE={};
try{TAB_DONE=JSON.parse(localStorage.getItem('mt.hrv.h27.tab_done')||'{}')}catch(e){}

function markTab(n){
  TAB_DONE[n]=true;
  try{localStorage.setItem('mt.hrv.h27.tab_done',JSON.stringify(TAB_DONE))}catch(e){}
...
const TIPS=[
  ...
  '💡 <strong>Tab 7 tip:</strong> Pojmovnik + cheat sheet za esej — koristi ga za brzu reviziju strukture, stila i najčešćih pravila.',
];
let tipShown={};
function showTip(n){
...
function loadScoreHistory(){
  try{
    const hist=JSON.parse(localStorage.getItem('mt.hrv.h27.kviz_hist')||'[]');
...
function saveScoreHistory(score,total){
  try{
    ...
    localStorage.setItem('mt.hrv.h27.kviz_hist',JSON.stringify(hist.slice(-10)));
    loadScoreHistory();
  }catch(e){}
}
...
function fsAddToHistory(text, count){
  try{
    let hist = JSON.parse(localStorage.getItem('mt.hrv.h27.fs_hist') || '[]');
    hist.push({text, count, date: Date.now()});
    if(hist.length > 20) hist = hist.slice(-20);
    localStorage.setItem('mt.hrv.h27.fs_hist', JSON.stringify(hist));
  } catch(e){}
}
...
const INTERP_QS = [
  // ━━━ INTERPRETATIVNI (10) ━━━
  {cat:'interp', q:\`Što je glavni cilj uvoda u interpretativnom eseju?\`, opts:[\`Postaviti tezu i kontekst djela\`, \`Iznijeti zaključak\`], correct:0, e:\`Uvod (50-70 riječi) postavlja kontekst djela + tezu interpretacije.\`},
  {cat:'interp', q:\`Koja je idealna duljina razrade?\`, opts:[\`250-300 riječi (3-4 paragrafa)\`, \`400 riječi (1 paragraf)\`], correct:0, e:\`Razrada je središnji dio: 250-300 riječi + minimum 3 paragrafa.\`},
  {cat:'interp', q:\`Što čini DOBRU tezu interpretativnog eseja?\`, opts:[\`Specifična tvrdnja o djelu\`, \`Životopis autora\`], correct:0, e:\`Teza mora biti specifična i branjiva — ne biografski podaci.\`},
  {cat:'interp', q:\`Koji elementi se obrađuju u razradi?\`, opts:[\`Tema, likovi, stil, poruka\`, \`Životopis i nagrade autora\`], correct:0, e:\`Standardna razrada: P1 tema + kontekst, P2 likovi, P3 stil, P4 poruka.\`},
  {cat:'interp', q:\`Što je „kontekst djela"?\`, opts:[\`Povijesno-kulturološko okruženje\`, \`Naslov djela\`], correct:0, e:\`Kontekst = razdoblje, kulturni kontekst, biografski podaci relevantni za djelo.\`},
  {cat:'interp', q:\`Što NIJE u zaključku interpretativnog eseja?\`, opts:[\`Nove informacije ili argumenti\`, \`Vraćanje na uvodnu tezu\`], correct:0, e:\`Zaključak SINTETIZIRA, NE iznosi nove informacije.\`},
  {cat:'interp', q:\`Što je TIPIČNI pristup razradi karakterizacije lika?\`, opts:[\`Psihološka, socijalna, jezična analiza\`, \`Lista nagrada lika\`], correct:0, e:\`Karakterizacija obuhvaća više dimenzija lika.\`},
  {cat:'interp', q:\`Što je „stilska analiza" u interpretativnom eseju?\`, opts:[\`Pregled stilskih figura, jezičnih postupaka\`, \`Životopis autora\`], correct:0, e:\`Stilska analiza pokriva metafore, ritam, jezik djela.\`},
  {cat:'interp', q:\`Što treba uključiti uvod?\`, opts:[\`Naslov djela + autor + razdoblje + teza\`, \`Sažetak cijelog eseja\`], correct:0, e:\`Uvod postavlja temelje, ne iznosi cijelu razradu.\`},
  {cat:'interp', q:\`Koja stilska figura je NAJMOĆNIJA u interpretativnom eseju?\`, opts:[\`Metafora\`, \`Pleonazam\`], correct:0, e:\`Metafora je najčešća i najjača stilska figura u esejima.\`},

  // ━━━ RASPRAVLJAČKI (10) ━━━
  {cat:'rasp', q:\`Što je TEZA raspravljačkog eseja?\`, opts:[\`Jasan stav koji se brani argumentima\`, \`Naslov eseja\`], correct:0, e:\`Teza = stav koji ćeš braniti argumentima. Mora biti jasna i branjiva.\`},
  {cat:'rasp', q:\`Koja je 4-dijelna struktura raspravljačkog eseja?\`, opts:[\`Uvod → argumenti → protuargumenti → zaključak\`, \`Uvod → razrada → epilog → zaključak\`], correct:0, e:\`Klasična logika argumentacije: teza + dokazi + suprotni stavovi + sinteza.\`},
  {cat:'rasp', q:\`Koji je TIP DOKAZA jaki argument?\`, opts:[\`Statistike i konkretni primjeri\`, \`„Mislim da..."\`], correct:0, e:\`Dokazi: činjenice, statistike, citati, logični lanac. Ne subjektivni dojmovi.\`},
  {cat:'rasp', q:\`Zašto SPOMINJEŠ protuargumente?\`, opts:[\`Jača esej (pokazuje da poznaješ obje strane)\`, \`Da bi esej bio dulji\`], correct:0, e:\`Spomenom protuargumenata pokazuješ kompletnost — onda ih opovrgneš.\`},
  {cat:'rasp', q:\`Što je LOŠA teza raspravljačkog eseja?\`, opts:[\`„Mislim da je to dobro i loše."\`, \`„Argumenti pokazuju da..."\`], correct:0, e:\`Loša teza je preopćenita ili kontradiktorna.\`},
  {cat:'rasp', q:\`Koliko ARGUMENATA treba u razradi?\`, opts:[\`2-3 jaka argumenta s dokazima\`, \`1 argument detaljno objasnjen\`], correct:0, e:\`2-3 jaka argumenta + dokazi je optimalno za 350-450 riječi.\`},
  {cat:'rasp', q:\`Što treba reći o suprotnim stavovima?\`, opts:[\`Spomeni ih i opovrgni dokazima\`, \`Ignoriraj ih\`], correct:0, e:\`Spomeni („Neki će reći da...") + opovrgni („No taj argument zanemaruje...").\`},
  {cat:'rasp', q:\`Što je najvažnije u zaključku raspravljačkog eseja?\`, opts:[\`Potvrditi tezu + univerzalna poruka\`, \`Dodati novi argument\`], correct:0, e:\`Zaključak potvrđuje tezu nakon argumentacije + daje širu poruku.\`},
  {cat:'rasp', q:\`Koja je NAJVEĆA greška raspravljačkog eseja?\`, opts:[\`Nemati jasan stav (balansirati bez zaključka)\`, \`Imati previše argumenata\`], correct:0, e:\`Raspravljački esej MORA imati stav. Bez teze nema bodova.\`},
  {cat:'rasp', q:\`Što su DOBRE FRAZE za uvod argumenta?\`, opts:[\`„Prvo / Drugo / Treće..." + dokazi\`, \`„Mislim da..." + dojam\`], correct:0, e:\`Strukturirano nabrajanje + dokazi je profesionalno.\`},

  // ━━━ USPOREDNA ANALIZA (10) ━━━
  {cat:'usp', q:\`Što je glavni cilj usporedne analize?\`, opts:[\`Pokazati sličnosti i razlike + što usporedba znači\`, \`Opisati oba djela posebno\`], correct:0, e:\`Cilj nije samo nabrajanje — nego INTERPRETACIJA usporedbe.\`},
  {cat:'usp', q:\`Koja je preporučena metoda usporedbe?\`, opts:[\`Paralelna (po kriterijima)\`, \`Blok (prvo cijeli A, zatim cijeli B)\`], correct:0, e:\`Paralelna metoda daje bolju koherenciju — usporedba kroz cijeli esej.\`},
  {cat:'usp', q:\`Koji je TIPIČNI kriterij usporedbe?\`, opts:[\`Tema, likovi, stil, poruka\`, \`Naslov, godina, broj stranica\`], correct:0, e:\`Smisleni kriteriji: tema, lik, stil, poruka — književni elementi.\`},
  {cat:'usp', q:\`Što je DOBRA teza komparativnog eseja?\`, opts:[\`„Iako oba djela tematiziraju X, pristupi se razlikuju u..."\`, \`„A i B su slični."\`], correct:0, e:\`Dobra teza specificira što usporedba ZNAČI, ne samo da postoji.\`},
  {cat:'usp', q:\`Koliko paragrafa treba paralelna metoda?\`, opts:[\`3-4 paragrafa po kriterijima\`, \`2 paragrafa: jedan za A, jedan za B\`], correct:0, e:\`Paralelna metoda: P1 tema (A i B), P2 likovi (A i B), P3 stil (A i B).\`},
  {cat:'usp', q:\`Što je MANA blok metode?\`, opts:[\`Usporedba je tek u zaključku — esej djeluje nepovezano\`, \`Predugo je za 350-450 riječi\`], correct:0, e:\`Blok metoda razdvaja A i B do zaključka — slabija koherencija.\`},
  {cat:'usp', q:\`Što treba zaključak komparativnog eseja?\`, opts:[\`Što usporedba otkriva o oba djela\`, \`Listu svih sličnosti\`], correct:0, e:\`Zaključak interpretira ŠTO usporedba znači, ne samo nabraja.\`},
  {cat:'usp', q:\`Koji je „kriterij usporedbe"?\`, opts:[\`Aspekt po kojem se djela uspoređuju (npr. tema)\`, \`Naslov eseja\`], correct:0, e:\`Kriterij = aspekt: tema, lik, stil, poruka, kontekst.\`},
  {cat:'usp', q:\`Što je LOŠA teza komparativnog eseja?\`, opts:[\`„A je bolji od B." (vrijednosno)\`, \`„Oba djela tematiziraju X iz različitih kuteva..."\`], correct:0, e:\`Vrijednosni sudovi nisu cilj — analiza je.\`},
  {cat:'usp', q:\`Što treba uvod komparativnog eseja?\`, opts:[\`Oba djela + autor + kriteriji + teza\`, \`Samo prvo djelo\`], correct:0, e:\`Uvod predstavlja oba djela + jasno definira KRITERIJE usporedbe.\`},

  // ━━━ STIL (10) ━━━
  {cat:'stil', q:\`Koja stilska figura: „Život je more"?\`, opts:[\`Metafora\`, \`Usporedba\`], correct:0, e:\`Metafora = prenošenje značenja BEZ veznika „kao".\`},
  {cat:'stil', q:\`Koja stilska figura: „Stoji kao stijena"?\`, opts:[\`Usporedba\`, \`Metafora\`], correct:0, e:\`Usporedba uvijek ima „kao", „poput", „nalik".\`},
  {cat:'stil', q:\`Koja stilska figura: „Život i smrt, ljubav i mržnja"?\`, opts:[\`Antiteza\`, \`Asindeton\`], correct:0, e:\`Antiteza = suprotstavljanje suprotnosti.\`},
  {cat:'stil', q:\`Koja stilska figura: „Došao, vidio, pobijedio"?\`, opts:[\`Gradacija\`, \`Anafora\`], correct:0, e:\`Gradacija = niz s rastućim intenzitetom.\`},
  {cat:'stil', q:\`Koliko stilskih figura preporučeno u eseju?\`, opts:[\`2-3 figure (umjereno)\`, \`15+ figure (što više)\`], correct:0, e:\`Pretjerivanje u figurama čini esej lažnim. 2-3 jake figure su optimum.\`},
  {cat:'stil', q:\`Što je glavni problem klišeja u eseju?\`, opts:[\`Gubi bodove za stil (banalnost)\`, \`Olakšava pisanje\`], correct:0, e:\`„Od pamtivijeka", „Svi znamo da" su klišeji koji gube bodove.\`},
  {cat:'stil', q:\`Što je SINONIM za „važno"?\`, opts:[\`Presudno, ključno, neophodno\`, \`Veliko, debelo, široko\`], correct:0, e:\`Sinonimi su semantički bliske riječi, ne fizički atributi.\`},
  {cat:'stil', q:\`Koja je TRANZICIJA za POSLJEDICU?\`, opts:[\`Stoga, zbog toga, posljedično\`, \`Nadalje, također, k tome\`], correct:0, e:\`Posljedica = stoga / zbog toga. Dodavanje = nadalje / također.\`},
  {cat:'stil', q:\`Što je „bogat rječnik" u eseju?\`, opts:[\`Varijacija sinonima, izbjegavanje ponavljanja\`, \`Korištenje stranih riječi\`], correct:0, e:\`Bogat rječnik = sinonimi i izbjegavanje istih riječi 5+ puta.\`},
  {cat:'stil', q:\`Koji udio bodova nosi STIL na maturi?\`, opts:[\`40%\`, \`10%\`], correct:0, e:\`Sadržaj 40% + Stil 40% + Pismenost 20%. Stil je jednako važan kao sadržaj.\`},
];
...
function interpStartInlineMixed(containerId, count){
  if(typeof INTERP_QS === 'undefined') return;
  const cats = ['interp', 'rasp', 'usp', 'stil'];
...
function interpResultInline(containerId){
  ...
  // Save best score
  const storageKey = 'mt.hrv.h27.quiz_' + state.catKey + '_best';
  let prevBest = 0;
...
function interpInitInline(){
  ...
  interpStartInline('interp', 'interp-exercise');
  interpStartInline('rasp', 'rasp-exercise');
  interpStartInline('usp', 'usp-exercise');
  interpStartInline('stil', 'stil-exercise');
}
...
// ═══════════════════════════════════
// WORKSPACE — Tab 4
// 30 tema · 3 tipa · workspace s auto-save
// ═══════════════════════════════════
...
const ESSAY_TOPICS = [
  // ━━━ INTERPRETATIVNI (10) ━━━
  {
    id: 'int01',
    type: 'interp',
    title: 'Marulićeva „Judita" — vjerska i nacionalna alegorija',
    context: \`Marko Marulić, otac hrvatske književnosti, 1501. godine napisao je „Juditu" — prvi hrvatski ep na narodnome jeziku. Djelo prikazuje starozavjetnu junakinju koja brani svoj narod od Holoferna, ali ima i šire značenje.\`,
    guidelines: [
      'Što djelo predstavlja na vjerskoj razini?',
      'Što djelo predstavlja na nacionalnoj razini?',
      'Kontekst nastanka (16. stoljeće, turske prijetnje)',
      'Stilske karakteristike (epski ritam, dvanaesterac)',
      'Univerzalna poruka djela'
    ]
  },
  {
    id: 'int02',
    type: 'interp',
    title: 'Krležini „Glembajevi" — propast hrvatskog plemstva',
    context: \`Miroslav Krleža u dramskom ciklusu „Glembajevi" (1929-1932) prikazuje propast moćne plemićke obitelji koja simbolizira zalazak cijele klase u međuratnom razdoblju.\`,
    guidelines: [
      'Glavni likovi i njihova karakterizacija',
      'Tema novca, moći i moralnog raspada',
      'Kontekst međuraća (1920-1930-e)',
      'Stilske karakteristike Krležine drame',
      'Što djelo poručuje o suvremenoj Hrvatskoj?'
    ]
  },
  {
    id: 'int03',
    type: 'interp',
    title: 'Šenoina „Zlatarovo zlato" — prvi hrvatski povijesni roman',
    context: \`August Šenoa 1871. godine objavljuje „Zlatarovo zlato", roman smješten u 16. stoljeće. Djelo postavlja temelje hrvatskog povijesnog romana.\`,
    guidelines: [
  ...
  },
  {
    id: 'int04',
    type: 'interp',
    title: 'Matošev „Notturno" — pejzažna lirika',
    context: \`Antun Gustav Matoš u pjesmi „Notturno" (1907.) opisuje noćni krajolik koji postaje ogledalo unutarnjeg stanja lirskog subjekta.\`,
    guidelines: [
      'Slika noćnog krajolika',
      'Veza krajolika i unutarnjeg stanja',
      'Stilske figure (epiteti, personifikacija)',
      'Matoševa moderna poetika',
      'Univerzalnost teme samoće'
    ]
  },
  {
    id: 'int05',
    type: 'interp',
    title: 'Šimićeva „More" — egzistencijalna poetika',
    context: \`Antun Branko Šimić u pjesmi „More" (1920.) postavlja čovjeka pred beskrajno more koje postaje simbol egzistencijalne praznine.\`,
    guidelines: [
      'More kao simbol',
      'Lirski subjekt i njegov odnos prema svijetu',
      'Stilske karakteristike (slobodan stih, sažetost)',
      'Šimićeva moderna poetika',
      'Egzistencijalna pitanja djela'
    ]
  },
  {
    id: 'int06',
    type: 'interp',
    title: 'Mažuranićeva „Smrt Smail-age Čengića"',
    context: \`Ivan Mažuranić u epu „Smrt Smail-age Čengića" (1846.) opisuje tursko nasilje nad kršćanskim narodom i osvetu jedne grupe ratnika.\`,
    guidelines: [
      'Tematska struktura (osveta, pravda)',
      'Karakterizacija Smail-age',
      'Karakterizacija Crnogoraca',
      'Stilske karakteristike (klasicizam + romantizam)',
      'Univerzalna poruka o pravdi'
    ]
  },
  {
    id: 'int07',
    type: 'interp',
    title: 'Marinkovićev „Ruke" — egzistencijalna novela',
    context: \`Ranko Marinković u noveli „Ruke" (1953.) prikazuje čovjekovu otuđenost od vlastitog tijela kroz dijalog ruku.\`,
    guidelines: [
      'Glavni motiv (ruke kao simbol)',
      'Egzistencijalistička filozofija djela',
      'Karakterizacija lika',
      'Stilske karakteristike (unutarnji monolog)',
      'Veza s europskim modernizmom'
    ]
  },
  {
    id: 'int08',
    type: 'interp',
    title: 'Cesarićeva „Vagonaš" — socijalna lirika',
    context: \`Dobriša Cesarić u pjesmi „Vagonaš" (1932.) prikazuje umor i otuđenje radnika u industrijskom društvu.\`,
    guidelines: [
      'Lik vagonaša',
      'Socijalna kritika',
      'Stilske karakteristike (jednostavan jezik, ritam)',
      'Cesarićeva poetika empatije',
      'Aktualnost teme danas'
    ]
  },
  {
    id: 'int09',
    type: 'interp',
    title: 'Gjalski „Pod starim krovovima"',
    context: \`Ksaver Šandor Gjalski u zbirci „Pod starim krovovima" (1886.) prikazuje propadanje hrvatskog plemstva u Hrvatskom zagorju.\`,
    guidelines: [
      'Tema propadanja plemstva',
      'Atmosfera Zagorja',
      'Karakterizacija likova',
      'Realistička poetika',
      'Veza s Krležinim Glembajevima'
    ]
  },
  {
    id: 'int10',
    type: 'interp',
    title: 'Vidrićeva „Pejzaž" — impresionistička lirika',
    context: \`Vladimir Vidrić u pjesmi „Pejzaž" (1907.) slika prirodu kroz svjetlosne dojmove, otkrivajući impresionizam u hrvatskoj poeziji.\`,
    guidelines: [
      'Slika prirode',
      'Tehnika impresionizma',
      'Stilske karakteristike (boje, svjetlost)',
      'Veza s europskim impresionizmom',
      'Estetska poruka'
    ]
  },
  ...
  // ━━━ RASPRAVLJAČKI (10) ━━━
  {
    id: 'rasp01',
    type: 'rasp',
    title: 'Mladi i mediji u 21. stoljeću — koriste li ili štete?',
    context: \`Prosječan tinejdžer provede više od četiri sata dnevno na društvenim mrežama. Postoje argumenti za korist (povezivanje, edukacija) i protiv (mentalno zdravlje, otuđenje).\`,
    guidelines: [
      'Postavi jasnu tezu (za ili protiv)',
      'Argumenti uz statistike i primjere',
      'Spomeni protuargumente',
      'Opovrgni protuargumente',
      'Predloži rješenje u zaključku'
    ]
  },
  {
    id: 'rasp02',
    type: 'rasp',
    title: 'Hrvatski jezik u doba globalizacije — opasnost ili prilika?',
    context: \`Engleski jezik prodire u svakodnevni hrvatski govor. Postoje argumenti da to obogaćuje hrvatski (novi termini) i da ga ugrožava (gubitak identiteta).\`,
    guidelines: [
      'Tvoj stav o anglizmima u hrvatskom',
      'Konkretni primjeri (mejl, lajk, vajb)',
      'Uloga obrazovanja i medija',
      'Iskustva drugih jezika (njemački, francuski)',
      'Rješenje u zaključku'
    ]
  },
  {
    id: 'rasp03',
    type: 'rasp',
    title: 'Klimatske promjene — odgovornost generacija',
    context: \`Klimatske promjene su najveći globalni izazov. Pitanje je tko snosi odgovornost — pojedinac, korporacije ili države.\`,
    guidelines: [
      'Postavi tezu o odgovornosti',
      'Konkretni primjeri (CO2 emisije, plastika)',
      'Razlika između individualne i sistemske odgovornosti',
      'Uloga politike i ekonomije',
      'Što mladi mogu konkretno učiniti?'
    ]
  },
  {
    id: 'rasp04',
    type: 'rasp',
    title: 'Tradicija i suvremenost — sukob ili sklad?',
    context: \`Hrvatsko društvo balansira između tradicionalnih vrijednosti (obitelj, vjera) i suvremenih izazova (individualizam, globalizacija).\`,
    guidelines: [
      'Tvoj stav o odnosu tradicije i suvremenosti',
      'Konkretni primjeri (običaji, jezik, vrijednosti)',
      'Što treba sačuvati, što napustiti?',
      'Iskustva drugih kultura',
      'Vizija budućnosti u zaključku'
    ]
  },
  {
    id: 'rasp05',
    type: 'rasp',
    title: 'Slobodno vrijeme tinejdžera — kvalitetno ili izgubljeno?',
    context: \`Tinejdžeri imaju manje slobodnog vremena nego prije, a koriste ga drugačije (mobilni, igre, manje sport, manje čitanja).\`,
    guidelines: [
      'Stav o kvaliteti slobodnog vremena',
      'Statistike (vrijeme online, sport, čitanje)',
      'Razlozi promjene navika',
      'Posljedice za zdravlje i razvoj',
      'Preporuke za bolje korištenje vremena'
    ]
  },
  {
    id: 'rasp06',
    type: 'rasp',
    title: 'Umjetna inteligencija — prijetnja ili prilika za obrazovanje?',
    context: \`ChatGPT i druge AI alate koriste milijuni studenata. Postoje argumenti da pomaže učenju i da ga uništava (kopiranje, plagijati).\`,
    guidelines: [
      'Postavi stav o AI u obrazovanju',
      'Konkretni primjeri korisnih primjena',
      'Rizici (plagijati, površinsko znanje)',
      'Kako škole trebaju reagirati?',
      'Vizija u zaključku'
    ]
  },
  {
    id: 'rasp07',
    type: 'rasp',
    title: 'Putovanja — luksuz ili nužnost za mlade?',
    context: \`Mladi danas više putuju nego ikad, ali i klimatska kriza postavlja pitanje održivosti masovnog turizma.\`,
    guidelines: [
      'Stav o vrijednosti putovanja za mlade',
      'Konkretni benefiti (jezici, kulture, perspektive)',
      'Klimatski i etički troškovi',
      'Alternative (lokalni turizam, slow travel)',
      'Balans u zaključku'
    ]
  },
  {
    id: 'rasp08',
    type: 'rasp',
    title: 'Sport i mladi — odgoj karaktera ili stres?',
    context: \`Sport razvija discipline i timski rad, ali profesionalizacija može stvoriti stres i izgaranje već u mladoj dobi.\`,
    guidelines: [
      'Stav o ulozi sporta u odrastanju',
      'Pozitivni aspekti (zdravlje, karakter)',
      'Rizici prerane profesionalizacije',
  ...
  },
  {
    id: 'rasp09',
    type: 'rasp',
    title: 'Čitanje knjiga — relevantno u 21. stoljeću?',
    context: \`Pad u čitanju knjiga je globalan trend. Pitanje je vrijedi li uopće čuvati naviku čitanja ili je vrijeme za druge medije.\`,
    guidelines: [
      'Stav o vrijednosti čitanja danas',
      'Konkretni benefiti (vokabular, fokus, empatija)',
      'Konkurencija (video, podcasti, mreže)',
      'Što se gubi prestankom čitanja?',
      'Praktični savjeti za poticanje čitanja'
    ]
  },
  {
    id: 'rasp10',
    type: 'rasp',
    title: 'Hrvatska — emigriraju li mladi opravdano?',
    context: \`Tisuće mladih godišnje napuštaju Hrvatsku. Postoje argumenti da je to racionalna odluka i da je veliki gubitak za zemlju.\`,
    guidelines: [
      'Stav o emigraciji mladih',
      'Razlozi (ekonomski, profesionalni, osobni)',
      'Posljedice za Hrvatsku',
      'Što država može učiniti?',
      'Tvoja vizija osobne budućnosti'
    ]
  },
  ...
  // ━━━ USPOREDNA ANALIZA (10) ━━━
  {
    id: 'usp01',
    type: 'usp',
    title: '„Smrt Smail-age Čengića" vs „Hasanaginica"',
    context: \`Mažuranićeva „Smrt Smail-age Čengića" (1846.) i narodna „Hasanaginica" — oba djela bave se temom pravde i tragedije u kulturnom kontaktu Istoka i Zapada.\`,
    guidelines: [
      'Sličnosti tematike',
      'Razlike u perspektivi',
      'Karakterizacija glavnih likova',
      'Stilske različitosti (epska narodna pjesma vs umjetnička)',
      'Što usporedba otkriva o hrvatskom odnosu prema Istoku?'
    ]
  },
  {
    id: 'usp02',
    type: 'usp',
    title: 'Krleža vs Marinković — moderna hrvatska novela',
    context: \`Miroslav Krleža („Cvrčak pod vodopadom") i Ranko Marinković („Ruke") — dva majstora moderne hrvatske novele, ali s različitim pristupima.\`,
    guidelines: [
      'Tematske preokupacije obojice',
      'Karakterizacija likova',
      'Stilske različitosti',
      'Filozofska polazišta',
      'Doprinos hrvatskoj književnosti 20. st.'
    ]
  },
  {
    id: 'usp03',
    type: 'usp',
    title: 'Šimić vs Cesarić — moderna hrvatska poezija',
    context: \`Antun Branko Šimić („More") i Dobriša Cesarić („Tiha pjesma") predstavljaju dva pristupa modernističkoj samoći.\`,
    guidelines: [
      'Tematska sličnost (samoća)',
      'Različita perspektiva (egzistencijalna vs socijalna)',
      'Stilske karakteristike',
      'Lirski subjekt',
      'Što usporedba otkriva o hrvatskoj moderni?'
    ]
  },
  {
    id: 'usp04',
    type: 'usp',
    title: 'Šenoa vs Gjalski — povijesni roman',
    context: \`August Šenoa („Zlatarovo zlato") i Ksaver Šandor Gjalski („Pod starim krovovima") — dva pristupa povijesnom romanu u hrvatskoj književnosti 19. st.\`,
    guidelines: [
      'Različite epohe koje obrađuju',
      'Pristup povijesti (romantizam vs realizam)',
      'Karakterizacija likova',
      'Stilske različitosti',
      'Doprinos hrvatskoj prozi'
    ]
  },
  {
    id: 'usp05',
    type: 'usp',
    title: 'Marulić vs Kačić Miošić — narodna i učena poezija',
    context: \`Marko Marulić („Judita", 1501.) i Andrija Kačić Miošić („Razgovor ugodni naroda slovinskoga", 1756.) — dva pristupa hrvatskoj epskoj poeziji.\`,
    guidelines: [
      'Različite epohe i konteksti',
      'Učeni vs narodni stil',
      'Tematske preokupacije',
      'Funkcija djela u svom vremenu',
      'Trajna vrijednost obaju djela'
    ]
  },
  {
    id: 'usp06',
    type: 'usp',
    title: 'Matoš vs A. B. Šimić — hrvatska moderna lirika',
    context: \`Antun Gustav Matoš („Notturno") i Antun Branko Šimić („More") — dva pjesnika hrvatske moderne s različitim poetikama.\`,
    guidelines: [
      'Tematska različitost',
      'Stilske karakteristike (rimovani vs slobodan stih)',
      'Filozofska polazišta',
      'Različita generacija i utjecaji',
      'Doprinos hrvatskoj moderni'
    ]
  },
  {
    id: 'usp07',
    type: 'usp',
    title: 'Krleža vs Šenoa — pristup hrvatskoj povijesti',
    context: \`Krleža („Glembajevi") i Šenoa („Zlatarovo zlato") — dva pristupa hrvatskoj povijesnoj zbilji u književnosti.\`,
    guidelines: [
      'Različite epohe koje opisuju',
      'Pristup povijesti (kritičko-modernistički vs romantičarski)',
      'Karakterizacija likova',
      'Funkcija povijesti u djelima',
      'Što usporedba otkriva o hrvatskoj samosvijesti?'
    ]
  },
  {
    id: 'usp08',
    type: 'usp',
    title: 'Cesarić vs Tadijanović — lirika svakodnevice',
    context: \`Dobriša Cesarić („Vagonaš") i Dragutin Tadijanović („Dugo u noć, u zimsku bijelu noć") — dvije lirike usredotočene na svakodnevicu i emocije.\`,
    guidelines: [
      'Tematske sličnosti',
      'Različitost poetske perspektive',
      'Stilske karakteristike',
      'Lirski subjekt',
      'Univerzalnost emocija u oba pjesnika'
    ]
  },
  {
    id: 'usp09',
    type: 'usp',
    title: 'Marulić vs Mažuranić — hrvatski ep',
    context: \`Marko Marulić („Judita") i Ivan Mažuranić („Smrt Smail-age Čengića") — dva najveća hrvatska epa s različitim historijskim kontekstima.\`,
    guidelines: [
      'Različite epohe (renesansa vs ilirizam)',
      'Tematska sličnost (otpor osvajaču)',
      'Stilske karakteristike',
      'Funkcija oba djela u nacionalnoj svijesti',
      'Trajna vrijednost'
    ]
  },
  {
    id: 'usp10',
    type: 'usp',
    title: 'Šenoa vs Krleža — hrvatski roman',
    context: \`August Šenoa („Zlatarovo zlato") i Miroslav Krleža („Povratak Filipa Latinovicza") — dva temeljna djela hrvatskog romana s pola stoljeća razlike.\`,
    guidelines: [
      'Različite epohe (realizam vs modernizam)',
      'Pristup glavnom liku',
      'Stilske različitosti',
      'Tematske preokupacije',
      'Doprinos razvoju hrvatskog romana'
    ]
  },
];

// WORKSPACE STATE
const WS_STORAGE_PREFIX = 'mt.hrv.h27.essay_';
const WS_TIMER_KEY = 'mt.hrv.h27.timer_state';
const WS_CURRENT_KEY = 'mt.hrv.h27.current_essay';

let wsState = {
  currentTopicId: null,
  timerActive: false,
  timerStart: null,
  timerDuration: 14400, // 4 hours default
  timerInterval: null,
...
function wsInit(){
  ...
  // Restore last opened essay
  try {
    const last = localStorage.getItem(WS_CURRENT_KEY);
    if(last && ESSAY_TOPICS.find(t => t.id === last)){
...
function wsTierIndicator(){
  ...
  const limit = window.MT.Tier.getLimit('max_essays');
  ...
  if (limit === -1) {
    ...
    return \`<div class="ws-tier-indicator ws-tier-\${tier}">
      ...
      <span class="ws-tier-text"><strong>\${config.label}</strong> · Neograničeno eseja</span>
    </div>\`;
  }
  ...
  try {
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (key && key.startsWith('mt.hrv.h27.essay_')) {
  ...
  return \`<div class="ws-tier-indicator ws-tier-free \${usedClass}">
    ...
    <span class="ws-tier-text"><strong>Free</strong> · \${savedCount}/\${limit} eseja iskorišteno\${remaining === 0 ? ' — pretplati se za više' : ''}</span>
...
function wsRenderTopicBrowser(){
  ...
  const interp = ESSAY_TOPICS.filter(t => t.type === 'interp');
  const rasp = ESSAY_TOPICS.filter(t => t.type === 'rasp');
  const usp = ESSAY_TOPICS.filter(t => t.type === 'usp');
  
  // Get list of essays in progress
  ...
  wrap.innerHTML = \`
    <div class="ws-browser">
      <div class="ws-intro">
        ...
        <div class="ws-intro-title">Esej Workspace</div>
        <div class="ws-intro-sub">30 maturalnih tema · Auto-save · Timer · Word counter</div>
      </div>
      ...
      \${inProgress.length > 0 ? \`
        <div class="ws-section">
          ...
          <div class="ws-grid">
            \${inProgress.map(p => {
              const topic = ESSAY_TOPICS.find(t => t.id === p.id);
              if(!topic) return '';
              return \`
                <div class="ws-card ws-card-progress" onclick="wsOpenTopic('\${topic.id}')">
                  <div class="ws-card-pill ws-pill-\${topic.type}">\${wsTypeLabel(topic.type)}</div>
      ...
      <div class="ws-section">
        <div class="ws-section-title">📚 Interpretativni eseji (\${interp.length})</div>
        <div class="ws-grid">
          \${interp.map(t => \`
            <div class="ws-card" onclick="wsOpenTopic('\${t.id}')">
              <div class="ws-card-pill ws-pill-interp">📚 INTERPRETATIVNI</div>
              <div class="ws-card-title">\${t.title}</div>
              <div class="ws-card-meta">▶ Klikni za pisanje</div>
            </div>
          \`).join('')}
        </div>
      </div>
      ...
      <div class="ws-section">
        <div class="ws-section-title">⚖️ Raspravljački eseji (\${rasp.length})</div>
        <div class="ws-grid">
          \${rasp.map(t => \`
            <div class="ws-card" onclick="wsOpenTopic('\${t.id}')">
              <div class="ws-card-pill ws-pill-rasp">⚖️ RASPRAVLJAČKI</div>
              <div class="ws-card-title">\${t.title}</div>
              <div class="ws-card-meta">▶ Klikni za pisanje</div>
            </div>
          \`).join('')}
      ...
      <div class="ws-section">
        <div class="ws-section-title">🔄 Usporedna analiza (\${usp.length})</div>
        <div class="ws-grid">
          \${usp.map(t => \`
            <div class="ws-card" onclick="wsOpenTopic('\${t.id}')">
              <div class="ws-card-pill ws-pill-usp">🔄 USPOREDNA</div>
              <div class="ws-card-title">\${t.title}</div>
              <div class="ws-card-meta">▶ Klikni za pisanje</div>
            </div>
          \`).join('')}
...
function wsTypeLabel(type){
  const labels = {interp: '📚 INTERP', rasp: '⚖️ RASP', usp: '🔄 USP'};
        ...
        if(data){
          try {
            ...
            if(parsed.text && parsed.text.trim().length > 0){
              ...
              const status = wc < 350 ? \`\${350-wc}r premalo\` : (wc > 450 ? \`+\${wc-450}r previše\` : '✓ idealno');
...
function wsOpenTopic(topicId){
  // MT.Tier check — Free users limited to 1 esej max
  if (typeof window.MT !== 'undefined' && window.MT.Tier) {
    ...
    if (limit !== -1) {
      ...
      const alreadySaved = (() => {
        try {
          const data = localStorage.getItem('mt.hrv.h27.essay_' + topicId);
          if (data) {
            const parsed = JSON.parse(data);
      ...
      if (savedCount >= limit && !alreadySaved) {
        window.MT.Tier.showPaywall({
          feature: 'Više eseja u Workspaceu',
...
function wsRenderWorkspace(topicId){
  ...
  const topic = ESSAY_TOPICS.find(t => t.id === topicId);
  if(!topic){
    wsRenderTopicBrowser();
    return;
  }
    ...
    <div class="ws-editor">
      <div class="ws-editor-header">
        ...
        <div class="ws-editor-title">
          <span class="ws-editor-pill ws-pill-\${topic.type}">\${wsTypeLabel(topic.type)}</span>
          \${topic.title}
        </div>
      </div>
      
      <div class="ws-editor-grid">
        <!-- LEFT: Sidebar -->
        <div class="ws-sidebar">
          <div class="ws-sidebar-section">
            <div class="ws-sidebar-h">📜 Polazni tekst</div>
            <div class="ws-sidebar-text">\${topic.context}</div>
          </div>
          
          <div class="ws-sidebar-section">
            <div class="ws-sidebar-h">📋 Smjernice</div>
            <ul class="ws-guidelines">
              \${topic.guidelines.map(g => \`<li>\${g}</li>\`).join('')}
            </ul>
          </div>
          
          <div class="ws-sidebar-section">
            <div class="ws-sidebar-h">⏱ Timer</div>
            <div class="ws-timer-controls">
              <div class="ws-timer-display" id="ws-timer-display">00:00</div>
              <div class="ws-timer-buttons">
                <button type="button" class="ws-timer-btn" onclick="wsSetTimer(14400)">4h</button>
                <button type="button" class="ws-timer-btn" onclick="wsSetTimer(7200)">2h</button>
                <button type="button" class="ws-timer-btn" onclick="wsSetTimer(3600)">1h</button>
          ...
          <div class="ws-sidebar-section">
            <div class="ws-sidebar-h">📊 Struktura</div>
            <div class="ws-structure">
              <div class="ws-structure-row" id="ws-struct-uvod">
                <span class="ws-structure-name">Uvod</span>
                <span class="ws-structure-target">~50r</span>
              </div>
              <div class="ws-structure-row" id="ws-struct-razrada">
                <span class="ws-structure-name">Razrada</span>
                <span class="ws-structure-target">~250r</span>
              </div>
              <div class="ws-structure-row" id="ws-struct-zaklj">
                <span class="ws-structure-name">Zaključak</span>
                <span class="ws-structure-target">~100r</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="ws-main">
          ...
          <div class="ws-actions">
            ...
            <button type="button" class="nb-btn" onclick="wsClearEssay()">🗑 Briši esej</button>
            <button type="button" class="nb-btn" onclick="wsExportText()">📥 Izvezi</button>
            <button type="button" class="nb-btn primary" onclick="sw(6)">✓ Provjeri (Checklist) →</button>
          </div>
        </div>
      </div>
    </div>
...
function wsUpdateCounter(){
  ...
  const counterEl = document.getElementById('ws-counter');
  ...
  if(wc < 350){
    color = 'var(--red)';
    fillPct = (wc / 350) * 70; // 0-70% bar
  } else if(wc <= 450){
    color = 'var(--green)';
    fillPct = 70 + ((wc - 350) / 100) * 30; // 70-100% bar
  } else {
    color = 'var(--gold)';
    fillPct = 100;
  }
...
function wsStartAutoSave(){
  ...
  wsState.autoSaveInterval = setInterval(() => {
    wsAutoSave();
  }, 5000);
}
...
function wsAutoSave(){
  ...
  try {
    ...
    if(status){
      status.textContent = '✓ Spremljeno · ' + new Date().toLocaleTimeString('hr-HR', {hour: '2-digit', minute: '2-digit', second: '2-digit'});
      status.style.color = 'var(--green)';
    }
  } catch(e){
    const status = document.getElementById('ws-savestatus');
    if(status){
      status.textContent = '⚠ Greška pri spremanju';
      status.style.color = 'var(--red)';
    }
  }
}

function wsManualSave(){
  wsAutoSave();
}

function wsClearEssay(){
  if(!wsState.currentTopicId) return;
  if(!confirm('Obrisati cijeli esej? Ovo se ne može poništiti.')) return;
  try {
    localStorage.removeItem(WS_STORAGE_PREFIX + wsState.currentTopicId);
  } catch(e){}
  const ta = document.getElementById('ws-textarea');
  if(ta) ta.value = '';
  wsUpdateCounter();
...
function wsExportText(){
  const ta = document.getElementById('ws-textarea');
  if(!ta || !ta.value.trim()){
    alert('Esej je prazan.');
    return;
  }
  const topic = ESSAY_TOPICS.find(t => t.id === wsState.currentTopicId);
  const header = topic ? \`# \${topic.title}

\` : '';
  const fullText = header + ta.value;
  
  // Try clipboard
  if(navigator.clipboard && navigator.clipboard.writeText){
    navigator.clipboard.writeText(fullText).then(() => {
      alert('✓ Esej kopiran u clipboard! Možeš ga zalijepiti u Word, Google Docs ili poslati profesoru.');
    }).catch(() => {
      // Fallback
      wsExportFallback(fullText);
    });
  } else {
    wsExportFallback(fullText);
  }
...
function wsExportFallback(text){
  const blob = new Blob([text], {type: 'text/plain;charset=utf-8'});
  const url = URL.createObjectURL(blob);
  const a = document.createElement('a');
  a.href = url;
  const topic = ESSAY_TOPICS.find(t => t.id === wsState.currentTopicId);
  a.download = (topic ? topic.title.substring(0, 50).replace(/[^\\w]/g, '_') : 'esej') + '.txt';
  a.click();
  URL.revokeObjectURL(url);
}

// TIMER FUNCTIONS
function wsSetTimer(seconds){
  // Update timer duration buttons
...
function wsToggleTimer(){
  if(wsState.timerActive){
    ...
    const toggleBtn = document.getElementById('ws-timer-toggle');
...
function wsTickTimer(){
  ...
  if(remaining <= 0){
    ...
    const toggleBtn = document.getElementById('ws-timer-toggle');
    if(toggleBtn) toggleBtn.textContent = '▶ Start';
    alert('⏰ Vrijeme isteklo! Spremi esej i pripremi se za reviziju.');
    wsSaveTimerState();
  }
}
...
function wsUpdateTimerDisplay(seconds){
  ...
  else if(seconds <= 1800) display.style.color = 'var(--gold)';
...
function wsSaveTimerState(){
  try {
    ...
    localStorage.setItem(WS_TIMER_KEY, JSON.stringify(state));
  } catch(e){}
}
  ...
  try {
    ...
    if(stored){
      ...
      if(state.topicId === wsState.currentTopicId){
        wsState.timerDuration = state.duration || 14400;
...
const CHECKLIST_ITEMS = [
  // ━━━ STRUKTURA (5) ━━━
  {cat:'struktura', id:'s1', text:'Uvod ima jasnu tezu (rečenicu koja iznosi glavnu tvrdnju eseja)', auto:false, important:true},
  {cat:'struktura', id:'s2', text:'Razrada ima minimum 3 paragrafa', auto:true, autoCheck:'paragraphs>=3'},
  {cat:'struktura', id:'s3', text:'Zaključak se vraća na uvodnu tezu (krug se zatvara)', auto:false, important:true},
  {cat:'struktura', id:'s4', text:'Logičan slijed misli kroz cijeli esej', auto:false},
  {cat:'struktura', id:'s5', text:'Smislene tranzicije između paragrafa (Nadalje, S druge strane, Konačno...)', auto:false},
  
  // ━━━ SADRŽAJ (10) ━━━
  {cat:'sadrzaj', id:'sa1', text:'Tema je u potpunosti pokrivena (sve smjernice obrađene)', auto:false, important:true},
  {cat:'sadrzaj', id:'sa2', text:'Citati ili konkretni primjeri iz djela', auto:true, autoCheck:'hasQuotes'},
  {cat:'sadrzaj', id:'sa3', text:'Povijesni / kulturološki kontekst (interpretativni i usporedna)', auto:false},
  {cat:'sadrzaj', id:'sa4', text:'Vlastita interpretacija, ne samo prepričavanje', auto:false, important:true},
  {cat:'sadrzaj', id:'sa5', text:'Argumenti su dokumentirani (statistike, citati, primjeri)', auto:false, important:true},
  {cat:'sadrzaj', id:'sa6', text:'Konkretni primjeri (ne samo apstraktne tvrdnje)', auto:false},
  {cat:'sadrzaj', id:'sa7', text:'Balans subjektivnog i objektivnog (osobito raspravljački)', auto:false},
  {cat:'sadrzaj', id:'sa8', text:'Jasna i specifična teza (ne preopćenita)', auto:false, important:true},
  {cat:'sadrzaj', id:'sa9', text:'Neutralan, profesionalan ton (gdje je potrebno)', auto:false},
  {cat:'sadrzaj', id:'sa10', text:'Snažna završna rečenica (efektivan zaključak)', auto:false},
  
  // ━━━ STIL (5) ━━━
  {cat:'stil', id:'st1', text:'Bogat rječnik (varijacija, sinonimi, izbjegavanje ponavljanja)', auto:false, important:true},
  {cat:'stil', id:'st2', text:'Stilske figure korištene umjereno (2-3 figure: metafora, usporedba, antiteza)', auto:false},
  {cat:'stil', id:'st3', text:'Varijacija dužine rečenica (kratke + duge)', auto:false},
  {cat:'stil', id:'st4', text:'Izbjegnuti klišeji („Od pamtivijeka", „Svi znamo da...")', auto:false},
  {cat:'stil', id:'st5', text:'Snažan, prikladan ton za tip eseja', auto:false},
  
  // ━━━ PISMENOST (5) ━━━
  {cat:'pismenost', id:'p1', text:'Bez pravopisnih grešaka (vidi H25 Pravopis)', auto:false, important:true, link:'h25'},
  {cat:'pismenost', id:'p2', text:'Ispravna interpunkcija (vidi H26 Interpunkcija)', auto:false, important:true, link:'h26'},
  {cat:'pismenost', id:'p3', text:'Hrvatski navodnici „..." (ne engleski "...")', auto:true, autoCheck:'croatianQuotes'},
  {cat:'pismenost', id:'p4', text:'Word count u rasponu 350-450 riječi', auto:true, autoCheck:'wordCount'},
  {cat:'pismenost', id:'p5', text:'Esej je pažljivo lektoriran (revidiran prije predaje)', auto:false},
];

const CHECKLIST_STORAGE_KEY = 'mt.hrv.h27.checklist_state';
...
function chkGetEssayText(){
  // Try to get text from current essay in workspace
  try {
    const currentTopicId = localStorage.getItem('mt.hrv.h27.current_essay');
    if(currentTopicId){
      const stored = localStorage.getItem('mt.hrv.h27.essay_' + currentTopicId);
      if(stored){
        const parsed = JSON.parse(stored);
        if(parsed.text) return parsed.text;
      }
    }
    // Fallback: search any essay in localStorage
    for(let i = 0; i < localStorage.length; i++){
      const key = localStorage.key(i);
      if(key && key.startsWith('mt.hrv.h27.essay_')){
        const data = localStorage.getItem(key);
...
function chkRunAutoChecks(){
  ...
  CHECKLIST_ITEMS.forEach(item => {
    ...
    if(item.autoCheck === 'wordCount'){
      result = wc >= 350 && wc <= 450;
    } else if(item.autoCheck === 'paragraphs>=3'){
      result = paragraphs >= 3;
    } else if(item.autoCheck === 'hasQuotes'){
      result = /„[^"]+"/.test(text) || /"[^"]+"/.test(text);
    } else if(item.autoCheck === 'croatianQuotes'){
      const hr = (text.match(/„/g) || []).length;
      const en = (text.match(/(?<![\\w])"[^"]+"(?![\\w])/g) || []).length;
      result = hr >= en; // More Croatian than English
    }
...
function chkRender(){
  ...
  const cats = [
    {key:'struktura', label:'STRUKTURA', icon:'📋', count:5},
    {key:'sadrzaj', label:'SADRŽAJ', icon:'📚', count:10},
    {key:'stil', label:'STIL', icon:'✨', count:5},
  ...
  let html = \`
    <div id="chk-no-essay" style="padding:24px;background:rgba(74,144,217,.06);border:1px solid var(--bd);border-left:3px solid var(--blue);border-radius:var(--r2);margin-bottom:16px;text-align:center">
      ...
      <div style="font-family:var(--display);font-size:16px;font-weight:700;color:var(--t1);margin-bottom:6px">Nema spremljenog eseja</div>
      <div style="font-size:13px;color:var(--t2);margin-bottom:14px">Otvori Workspace, napiši esej i vrati se ovdje za provjeru.</div>
    ...
    <div id="chk-with-essay" style="display:none">
      <div style="padding:14px 16px;background:rgba(80,200,120,.04);border:1px solid var(--bd);border-left:3px solid var(--green);border-radius:var(--r2);margin-bottom:16px">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:1.5px;color:var(--green);margin-bottom:6px">📊 TVOJ ESEJ</div>
...
const AI_FEEDBACK_STORAGE_KEY = 'mt.hrv.h27.ai_feedback_history';
const PRO_MODE_KEY = 'mt.hrv.pro_mode';
const AI_DAILY_USAGE_KEY = 'mt.hrv.h27.ai_daily_usage';
  ...
  if(tier === 'free'){
    ...
    wrap.innerHTML = \`
      <div class="ai-cta">
        ...
        <div class="ai-cta-title">AI feedback za tvoj esej</div>
        <div class="ai-cta-desc">
          Naš AI profesor čita tvoj esej i daje strukturiran feedback po 4 kriterija (Struktura, Sadržaj, Stil, Pismenost) + konkretne preporuke za poboljšanje.
        </div>
        <div class="ai-cta-features">
          <div class="ai-cta-feature">✓ Detaljna analiza po 4 kategorije</div>
    ...
    for(let i = 0; i < localStorage.length; i++){
      ...
      if(key && key.startsWith('mt.hrv.h27.essay_')){
        ...
        if(data){
          const parsed = JSON.parse(data);
          if(parsed.text && parsed.text.trim().length > 50){
            return {text: parsed.text, topicId: key.replace('mt.hrv.h27.essay_', '')};
          }
        }
      }
    }
...
async function aiRunFeedback(){
  ...
  if(!essay){
    alert('Nema spremljenog eseja. Otvori Workspace, napiši esej, pa pokreni AI feedback.');
    return;
  }
  
  // Get topic info
  const topic = (typeof ESSAY_TOPICS !== 'undefined') ? ESSAY_TOPICS.find(t => t.id === essay.topicId) : null;
  ...
  resultEl.innerHTML = \`
    <div class="ai-loading">
      ...
      <div class="ai-loading-text">AI profesor analizira tvoj esej...</div>
  ...
  try {
    ...
    const topicType = topic ? (topic.type === 'interp' ? 'interpretativni' : (topic.type === 'rasp' ? 'raspravljački' : 'usporedna analiza')) : 'nepoznat';
    
    const systemPrompt = \`Ti si iskusan profesor hrvatskog jezika koji ocjenjuje školske eseje za državnu maturu.

Kriteriji ocjenjivanja:
- Sadržaj (40%): teza, argumentacija, primjeri/citati, kontekst, vlastita interpretacija
- Stil (40%): bogat rječnik, stilske figure, varijacija rečenica, izbjegavanje klišeja
- Pismenost (20%): pravopis, interpunkcija (hrvatski navodnici "..."), formatiranje, word count 350-450r

Pravila:
- Esej mora biti 350-450 riječi
- 3-dijelna struktura (Uvod 50-70r, Razrada 250-300r, Zaključak 80-100r)
- Tip eseja: \${topicType}

Daj strukturiran feedback u sljedećem JSON formatu (samo JSON, ništa drugo):
{
  ...
  "struktura": {
    ...
    "preporuka": "konkretna preporuka u 1 rečenici"
  },
  "sadrzaj": {
    "score": "broj 1-5",
    "snage": ["lista 1-2 snage"],
  ...
  resultEl.innerHTML = \`
    <div class="ai-result">
      ...
      <div class="ai-categories">
        \${renderCategory('struktura', 'Struktura', '📋')}
        \${renderCategory('sadrzaj', 'Sadržaj', '📚')}
        \${renderCategory('stil', 'Stil', '✨')}
        \${renderCategory('pismenost', 'Pismenost', '📝')}
      </div>
...
function updateProgress(pct){
  ...
  try { localStorage.setItem('mt.hrv.h27.prog', p); } catch(e){}
}
/* ══ SIDEBAR ACTIVATION ══ */
...
export default function H27Chapter() {
  return (
    <ChapterWrapper
      chapterId="H27"
      bodyHtml={BODY_HTML}
...
export const HRV_POGAVLJE_27 = null
