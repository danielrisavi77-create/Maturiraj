...
<div class="content-wrap">
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=versifikacija+stih+metrika+dvanaesterac+deseterac+matura" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Versifikacija — stihovi i metrika</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=sonet+tercina+strofa+rima+shema+hrvatska+književnost" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Sonet, tercina, strofa — objašnjenje</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=poetic+meter+iambic+pentameter+versification+guide" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Poetic meter — iambic pentameter</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=how+to+analyze+poetry+meter+rhyme+scheme+explained" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🎬</span> EN</div>
          <div class="yt-title">How to analyze poetry — meter &amp; rhyme</div>
        </div>
      </a>
    </div>
...
.cheat-col-wide{grid-column:1/-1}
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H18 Versifikacija</div>
...
const CHAPTER_CSS_DELTA = `.pov-sheet { background: var(--sur); color: var(--txt); border: 1px solid var(--bd); border-radius: var(--r2); padding: 22px; max-width: 100%; font-family: var(--fb, 'DM Sans', sans-serif); }
      .ps-header { text-align:center; padding-bottom:14px; border-bottom:2px solid var(--bd); margin-bottom:22px; }
      .ps-title { font-family: var(--fh, 'Fraunces', serif); font-size: 22px; font-weight:700; color:var(--txt); }
      .ps-subtitle { font-size:13px; color:var(--muted); margin-top:4px; }
      .ps-era { margin-bottom:20px; border:1px solid var(--bdm); border-radius: var(--r1); overflow:hidden; }
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h18.tab') || '0') }catch(e){return 0} })(),
