...
import {
  ...
  SVGAntigonaKreont, CompareAntigonaIsmena, CompareAntigonaKreont,
  SimboliGridAntigona, StatCardsAntigona, SVGBodoviMaturi,
  CrossChapterH01, PopKulturaAntika, QuickRefAntigona,
  AccordionEsejTezeH01, AccordionCitatiH01,
} from './H01_Components';
import H01CitatnikTab from './H01_CitatnikTab';
import H01PojmovnikTab from './H01_PojmovnikTab';
...
<div class="content-wrap">
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div id="h01-react-svg-bodovi"></div>
    ...
    <div id="h01-react-pop-kultura"></div>
    ...
    <div id="h01-react-cross-chapter"></div>

    <!-- SEC 06a: Grčko kazalište — arhitektura i izvedba -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">06a · Grčko kazalište — arhitektura i dramski oblici</div><div class="sec-line"></div></div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div id="h01-react-hero-quote"></div>
    <div id="h01-react-stat-cards"></div>
    ...
    <div id="h01-react-author-card"></div>
    ...
    <div id="h01-react-compare-ismena"></div>
    ...
    <div id="h01-react-svg-kreont"></div>
    <div id="h01-react-compare-kreont"></div>
    <div id="h01-react-simboli"></div>
    ...
    <div id="h01-react-quick-ref"></div>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div id="h01-react-esej-teze"></div>
    <div id="h01-react-citati"></div>
  ...
  <div class="layer" id="l3" role="tabpanel" tabindex="0">
    <div id="h01-react-citatnik"></div>
  </div>
  <!-- ========================
       TAB 4 · POJMOVNIK
       ======================== -->
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    <div id="h01-react-pojmovnik"></div>
  </div>
  <!-- ========================
       TAB 5 · DRILL
       ======================== -->
...
.wc-hint{margin-top:12px;padding:10px 12px;background:var(--inp,#0F0605);border-radius:8px;font-size:12px;color:var(--t2,#c5b8aa);line-height:1.5}
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card">
            ...
            <div class="minirev-card-val">Sofoklo <b>Antigona</b> (5. st. pr. Kr.) · <b>antička tragedija</b> · obvezatno gradivo za maturu.</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Kontekst</div>
            <div class="minirev-card-val"><b>Antika</b> kao temelj europske književnosti: Homer, grčka drama, Biblija, rimska književnost.</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Likovi</div>
            <div class="minirev-card-val"><b>Antigona, Kreont, Ismena, Hemon, Tiresija</b> — svaki lik nosi posebnu etičku poziciju i pogled na zakon.</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Središnji sukob</div>
            <div class="minirev-card-val"><b>Božanski zakon vs državni zakon</b>. Antigona bira pokop brata, Kreont brani poredak polisa.</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Pojmovi tragedije</div>
            <div class="minirev-card-val"><b>hybris, hamartia, peripetija, anagnoriza, katarza</b> — značenje i primjer na Antigoni.</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Simboli</div>
            <div class="minirev-card-val"><b>pokop, pećina/grob, sljepoća-vizionarskost, moć i odgovornost vladara</b>.</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Most</div>
            <div class="minirev-card-val">› <b>H02 Srednji vijek</b> (Bašćanska ploča, glagoljica, hrvatski književni početci).</div>
          </div>
          <div class="minirev-card">
            <div class="minirev-card-lbl">📌 Najveća greška</div>
            <div class="minirev-card-val">Svesti Antigonu na „tvrdoglavu junakinju". Tragedija je <b>sukob dviju legitimnih istina</b>, ne crno-bijela moralna bajka.</div>
          </div>
        </div>
        <div class="minirev-quotes">
          ...
          <ol>
            <li>„Nisam rođena da mrzim, nego da ljubim." <b>(Antigona)</b></li>
            <li>„Mnogo je čudesa, ali ništa čudesnije od čovjeka." <b>(zbor)</b></li>
            <li>„Nitko ne voli glasnika koji donosi zle vijesti." <b>(glasnik)</b></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="exam-prompt">
      <div class="exam-prompt-ttl">📌 Kako se Antigona može pojaviti na ispitu</div>
      <div class="exam-prompt-task">
        Analiziraj sukob božanskog i državnog zakona u Sofoklovoj <em>Antigoni</em>. Objasni kako se kroz likove Antigone i Kreonta oblikuje tragička napetost te pokaži na koji je način taj sukob i danas društveno aktualan. U argumentaciji koristi književnoteorijske pojmove antičke tragedije i najmanje dva citata iz djela.
      </div>
      <div class="exam-prompt-tips">
        <div class="exam-tip">
          <b>📌 Struktura eseja</b>
          Uvod (50 r.) · 3 odlomka razrade (sukob zakona · likovi i odgovornost · aktualnost), ~120 r. svaki · zaključak (60 r.) = ~470 r.
        </div>
        <div class="exam-tip">
          <b>📌 Citati</b>
          „Nisam rođena da mrzim, nego da ljubim" · „Mnogo je čudesa..." · odabrani dijalog Kreont–Hemon.
        </div>
        <div class="exam-tip">
          <b>📌 Povezivanje</b>
          Antigona ↔ suvremene rasprave o granicama poslušnosti i odgovornosti vlasti; most prema srednjem vijeku u H02.
        </div>
        <div class="exam-tip">
          <b>📚 Pojmovi</b>
          Hamartia · hybris · katarza · tragički sukob · antička tragedija · etika dužnosti.
        </div>
      </div>
    </div>
    ...
    <div class="pro-gate" data-feature="checkpoint-tracking">
      ...
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam tko je napisao <b>Antigonu</b> i kada (Sofoklo, 5. st. pr. Kr., vrhunac atičke tragedije)</div><span class="cp-hint">Antigona</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Mogu izložiti <b>kompoziciju i tijek radnje</b> (prolog, sukob s Kreontom, Tiresijino upozorenje, katastrofa i katarza)</div><span class="cp-hint">Kompozicija</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam ključne likove — <b>Antigona, Kreont, Ismena, Hemon, Tiresija</b> — i njihove etičke pozicije</div><span class="cp-hint">Likovi</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Razumijem <b>središnji sukob</b> (božanski zakon vs državni zakon) i mogu objasniti zašto je i danas aktualan</div><span class="cp-hint">Teme</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam pojmove <b>hybris, hamartia, peripetija, anagnoriza, katarza</b> i prepoznajem ih na primjerima iz Antigone</div><span class="cp-hint">Pojmovnik</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Mogu analizirati <b>simboliku</b> (pokop, pećina/grob, sljepoća-vizionarskost Tiresije, moć i odgovornost vladara)</div><span class="cp-hint">Simbolika</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Imam <b>barem 2 teze</b> za esej (odgovornost vlasti, granice poslušnosti, tragičnost izbora, ženski glas otpora)</div><span class="cp-hint">Esej</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam <b>3 citata</b> napamet (npr. „Nisam rođena da mrzim, nego da ljubim”, „Mnogo je čudesa, ali ništa čudesnije od čovjeka”)</div><span class="cp-hint">Citatnik</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Razumijem <b>širi antički kontekst</b> — Homer (epika), antička drama, biblijska i rimska baština kao temelj kasnije europske književnosti</div><span class="cp-hint">Kontekst</span></div>
    ...
    <div class="nav-row" style="margin-top:30px">
      ...
      <a class="nb primary" href="/skripte/hrv/h02">H02 · Srednji vijek ›</a>
    </div>
  </div>
  ...
  <div class="chapter-nav-wrap">
    ...
    <div class="chapter-nav-grid" style="grid-template-columns:1fr;max-width:560px;margin-left:auto;margin-right:auto">
      <a class="chapter-nav-card chapter-nav-next" href="/skripte/hrv/h02">
        <div class="chapter-nav-meta">
          ...
          <div class="chapter-nav-desc">Bašćanska ploča · glagoljica · trubaduri</div>
        </div>
...
function _citInit(){
  var inp = document.getElementById('cit-search');
  if(!inp || inp.dataset.citInitBound === '1') return;
  inp.dataset.citInitBound = '1';
  var timer = null;
...
function sw(i){
  ...
  if(i===4 && typeof window.initPojmovnik === 'function') setTimeout(window.initPojmovnik,0);
...
(function initPojmovnik(){
  ...
  function bindPojmovnik(){
    ...
    filterBtns.forEach(function(b){
      if(b.dataset.pojmInitBound === '1') return;
      b.dataset.pojmInitBound='1';
  ...
  window.initPojmovnik=bindPojmovnik;
  if(document.readyState==='loading') document.addEventListener('DOMContentLoaded',bindPojmovnik);
  else bindPojmovnik();
})();
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrv/h01';
...
function H01ReactLayers() {
  ...
  return (
    <>
      {anchors.svgBodovi     && createPortal(<SVGBodoviMaturi />,        anchors.svgBodovi)}
      {anchors.timeline      && createPortal(<TimelineAntika />,         anchors.timeline)}
      {anchors.popKultura    && createPortal(<PopKulturaAntika />,       anchors.popKultura)}
      {anchors.crossChapter  && createPortal(<CrossChapterH01 />,        anchors.crossChapter)}
      {anchors.heroQuote     && createPortal(<HeroQuoteAntigona />,      anchors.heroQuote)}
      {anchors.statCards     && createPortal(<StatCardsAntigona />,      anchors.statCards)}
      {anchors.authorCard    && createPortal(<AuthorCardSofoklo />,      anchors.authorCard)}
      {anchors.compareIsmena && createPortal(<CompareAntigonaIsmena />,  anchors.compareIsmena)}
      {anchors.svgKreont     && createPortal(<SVGAntigonaKreont />,      anchors.svgKreont)}
      {anchors.compareKreont && createPortal(<CompareAntigonaKreont />,  anchors.compareKreont)}
      {anchors.simboli       && createPortal(<SimboliGridAntigona />,    anchors.simboli)}
      {anchors.quickRef      && createPortal(<QuickRefAntigona />,       anchors.quickRef)}
      {anchors.esejTeze      && createPortal(<AccordionEsejTezeH01 />,   anchors.esejTeze)}
      {anchors.citati        && createPortal(<AccordionCitatiH01 />,     anchors.citati)}
      {anchors.citatnik      && createPortal(<H01CitatnikTab />,         anchors.citatnik)}
      {anchors.pojmovnik     && createPortal(<H01PojmovnikTab />,        anchors.pojmovnik)}
    </>
  );
}
