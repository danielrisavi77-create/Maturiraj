...
import H05ReactLayers from './H05_Components';
...
<div class="content-wrap">
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div class="prose">Prosvjetiteljstvo (fr. <em>Les Lumieres</em>, eng. <em>The Enlightenment</em>, njem. <em>Aufklärung</em>) je intelektualno razdoblje 18. stoljeća koje preoblikuje europsku misao. Ključne ideje:</div>
    ...
    <div id="h05-react-timeline-18st"></div>
    ...
    <div id="h05-react-author-goethe"></div>
    ...
    <div id="h05-react-timeline-goethe"></div>
    ...
    <div id="h05-react-compare-sd"></div>
    ...
    <div id="h05-react-author-voltaire-rousseau"></div>
    ...
    <div id="h05-react-author-kant-lessing"></div>
    ...
    <div id="h05-react-pop-kultura"></div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div id="h05-react-hero-quote"></div>
    ...
    <div id="h05-react-stat-cards"></div>
    ...
    <div id="h05-react-timeline-radnja"></div>
    ...
    <div id="h05-react-accordion-sukobi"></div>
    ...
    <div id="h05-react-usporedba"></div>
    ...
    <div id="h05-react-accordion-kljucne"></div>
    ...
    <div id="h05-react-verterizam"></div>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div id="h05-react-accordion-teze"></div>
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    <div id="h05-react-pojmovnik"></div>
  </div>
  <!-- ========================
       TAB 5 · DRILL
       ======================== -->
...
.wc-hint{margin-top:12px;padding:10px 12px;background:var(--inp,#0F0605);border-radius:8px;font-size:12px;color:var(--t2,#c5b8aa);line-height:1.5}
    ...
    <div class="minirev">
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Djelo i korpus</div><div class="minirev-card-val"><b>Goethe: Patnje mladog Werthera</b> kao ključni prijelaz iz prosvjetiteljskog prema predromantičkom senzibilitetu.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Kontekst</div><div class="minirev-card-val"><b>18. stoljeće</b>: razum, društveni poredak i građanska etika ulaze u napetost s kultom osjećaja.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Likovi</div><div class="minirev-card-val"><b>Werther, Lotte, Albert, Wilhelm</b> — trokut ljubavi i dužnosti te epistolarna introspekcija junaka.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Središnji sukob</div><div class="minirev-card-val"><b>Osjećaj vs norma</b>; pojedinac traži autentičnost, ali se sudara s društvenim granicama.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Pojmovi</div><div class="minirev-card-val"><b>Weltschmerz, Sturm und Drang, epistolarni roman, subjektivnost, verterizam</b>.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Simboli</div><div class="minirev-card-val"><b>pisma, priroda, oružje, Ossian</b> — simbolički sustav koji vodi prema tragediji junaka.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Most</div><div class="minirev-card-val">› <b>H06 Romantizam</b> — osjećaj i subjekt postaju dominantna književna logika 19. stoljeća.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Najveća greška</div><div class="minirev-card-val">Werthera čitati kao „romantičnu ljubavnu priču”. Djelo je prije svega <b>analiza krize subjekta</b>.</div></div>
        </div>
        <div class="minirev-quotes"><b style="display:block;font-family:var(--mono);font-size:9.5px;color:var(--bronze-l);letter-spacing:1.5px;font-weight:700;text-transform:uppercase;margin-bottom:8px">3 citata napamet</b><ol><li>„Poznajem se — osjećam previše.” <b>(Werther)</b></li><li>„Imaj hrabrosti služiti se vlastitim razumom.” <b>(Kant)</b></li><li>„Treba obrađivati vlastiti vrt.” <b>(Voltaire)</b></li></ol></div>
      </div>
    </div>

    <div class="exam-prompt"><div class="exam-prompt-ttl">📌 Kako se Werther može pojaviti na ispitu</div><div class="exam-prompt-task">Objasni kako se u <em>Patnjama mladog Werthera</em> oblikuje sukob osjećaja, društvenih normi i osobne odgovornosti. Pokaži zašto je roman prijelaz između prosvjetiteljstva i romantizma te argumentiraj na primjerima epistolarne forme.</div><div class="exam-prompt-tips"><div class="exam-tip"><b>📌 Struktura eseja</b>Uvod (50-60 r.) · 3 razradna odlomka (~120 r. svaki: svjetonazor, likovi/sukob, prijelaz epoha) · zaključak (60-70 r.) = ~470 r.</div><div class="exam-tip"><b>📌 Citati</b>Uključi 2-3 citata: Wertherove ispovjedne ulomke + jednu prosvjetiteljsku formulu (Kant/Voltaire) radi kontrasta.</div><div class="exam-tip"><b>📌 Povezivanje</b>Poveži H04→H05→H06: od reda i razuma, preko krize osjećaja, do pune romantičarske subjektivnosti.</div><div class="exam-tip"><b>📚 Pojmovi</b>Weltschmerz · Sturm und Drang · epistolarni roman · subjektivnost · verterizam · prijelaz epoha.</div></div></div>
  ...
  <div class="chapter-nav-wrap">
    ...
    <div class="chapter-nav-grid">
      <a class="chapter-nav-card chapter-nav-prev" href="/skripte/hrv/h04">
      ...
      <a class="chapter-nav-card chapter-nav-next" href="/skripte/hrv/h06">
        <div class="chapter-nav-meta">
          <div class="chapter-nav-pill chapter-nav-pill-next">SLJEDEĆE</div>
          <div class="chapter-nav-name">H06 · Romantizam</div>
          <div class="chapter-nav-desc">Byron · Hugo · Puškin · lirski junak</div>
        </div>
        <div class="chapter-nav-arrow">›</div>
      </a>
    </div>
    ...
    <div class="chapter-nav-related">
      ...
      <div class="chapter-nav-related-grid">
        <a class="chapter-nav-mini" href="/skripte/hrv/h14">
          ...
          <span class="chapter-nav-mini-name">Preporod · Mažuranić</span>
        </a>
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrv/h05';
