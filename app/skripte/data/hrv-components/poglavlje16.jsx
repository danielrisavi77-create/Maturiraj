...
import CitatnikH16 from './H16_CitatnikTab';
import PojmovnikH16 from './H16_PojmovnikTab';
import { AuthorProfileH16Krleza, DiscereBannerPrimaryH16, VideoCardPrimaryH16, VideoCardSecondaryH16, VideoCardTertiaryH16, VideoCardQuaternaryH16 } from './H16_Additions';
...
<div class="content-wrap">
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button class="tab" id="tab1" onclick="sw(1)" role="tab" aria-selected="false" aria-controls="l1">📖 3 čina</button>
...
.cheat-col-wide{grid-column:1/-1}
    ...
    <div id="h16-react-author-krleza"></div>
    ...
    <div class="cheat-card cheat-card-printable" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Sve što moraš pamtiti — H16</div>
        </div>
      ...
      <div class="cheat-grid">
        <div class="cheat-col">
          ...
          <table class="cheat-tbl">
            <tr><td><b>Autor</b></td><td>Miroslav Krleža</td></tr>
            <tr><td><b>Djelo</b></td><td><em>Gospoda Glembajevi</em>, psihološko-socijalna drama</td></tr>
            <tr><td><b>1928.</b></td><td>objava drame</td></tr>
            <tr><td><b>1929.</b></td><td>praizvedba u HNK Zagreb</td></tr>
            <tr><td><b>Forma</b></td><td>3 čina, jedna noć 1913., palača Glembay</td></tr>
          </table>
        </div>
        <div class="cheat-col">
          <div class="cheat-col-ttl">Likovi i osi sukoba</div>
          <ul class="cheat-list">
            <li><b>Leone</b> = intelektualac koji se bori protiv Glembaya u sebi.</li>
            <li><b>Ignjat</b> = kapital, moć, obiteljska maska.</li>
            <li><b>Barunica Castelli</b> = privid ljepote i društveni uspon.</li>
            <li><b>Angelika</b> = tišina, etički kontrast, nedostižni ideal.</li>
          </ul>
        </div>
        <div class="cheat-col cheat-col-warn">
          <div class="cheat-col-ttl">Zamke</div>
          <ul class="cheat-list cheat-list-warn">
            <li>Ne čitaj dramu samo kao obiteljsku svađu.</li>
            <li>Ne zaboravi ibsenovsko razotkrivanje prošlosti.</li>
            <li>Ne preskoči kontrast privid vs. istina; to je os analize.</li>
          </ul>
        </div>
        <div class="cheat-col">
          <div class="cheat-col-ttl">Mini plan odgovora</div>
          <ol class="cheat-steps">
            <li><b>Lociraj čin:</b> salon, razgovor, razotkrivanje, rasplet.</li>
            <li><b>Objasni glembajevštinu:</b> novac, laž, nasilje, nasljednost.</li>
            <li><b>Dodaj tehniku:</b> dijalog, retroaktivno otkrivanje, off-stage nasilje.</li>
            <li><b>Zaključi:</b> propast obitelji znači propast klase i maske.</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
      ...
      <div class="scene-card" onclick="togScene(this)">
        ...
        <div class="scene-body">
          <div class="scene-why">
            ...
            • <em>Srce koje pukne od istine</em> — Ignjat umire kad shvati da je živio u laži<br>
            • <em>Altmann kao nemoćni liječnik</em> — medicina ne može spasiti kad istina ubija<br><br>
            
            <b>Stil i tehnika II. čina:</b><br>
    ...
    <!-- DISCERE TOUCHPOINT -->
    <div id="h16-react-discere-banner-primary"></div>
    ...
    <div class="yt-grid">
      <div id="h16-react-video-card-primary"></div>

      <div id="h16-react-video-card-secondary"></div>

      <div id="h16-react-video-card-tertiary"></div>

      <div id="h16-react-video-card-quaternary"></div>
    </div>
...
<div class="nav-row">
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div class="alat-pane on" id="at0">
      ...
      <div class="sc" style="border-left:3px solid var(--gold)">
        ...
        <div class="sc-desc">
          <strong>Formulacija:</strong> „Dramu strukturira opozicija privida (bogatstvo, ljepota, moć, čast) i istine (laž, krađa, ubojstvo, preljub) — svaki čin razotkriva novi sloj fasade, a Krležin postupak je ibsenovski: polagano retroaktivno otkrivanje prošlosti kroz dijalog, bez vanjske akcije, sve psihološki."<br><br>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <style>
      .h16d-fc-wrap{display:flex;flex-direction:column;align-items:center;gap:18px;margin:16px 0 24px}
      .h16d-fc-counter{font-family:var(--mono);font-size:11px;color:var(--t3);letter-spacing:1.5px;text-transform:uppercase}
      .h16d-fc-counter b{color:var(--bronze-l)}
      .h16d-fc{width:100%;max-width:520px;min-height:220px;perspective:1500px;cursor:pointer}
      .h16d-fc-inner{position:relative;width:100%;height:100%;min-height:220px;transition:transform .6s cubic-bezier(.4,0,.2,1);transform-style:preserve-3d}
      .h16d-fc.flipped .h16d-fc-inner{transform:rotateY(180deg)}
      .h16d-fc-front,.h16d-fc-back{position:absolute;inset:0;min-height:220px;padding:40px 32px;border-radius:var(--r4);backface-visibility:hidden;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;border:1px solid var(--bdm)}
      .h16d-fc-front{background:linear-gradient(135deg,var(--card),var(--ele))}
      .h16d-fc-back{background:linear-gradient(135deg,rgba(220,50,47,.12),rgba(232,201,122,.05));border-color:var(--bd-br);transform:rotateY(180deg)}
      .h16d-fc-cat{font-family:var(--mono);font-size:9px;letter-spacing:2px;text-transform:uppercase;color:var(--bronze);margin-bottom:12px}
      .h16d-fc-term{font-family:var(--display);font-size:30px;font-weight:700;color:var(--t1);letter-spacing:1px}
      .h16d-fc-hint{font-family:var(--mono);font-size:10px;color:var(--t3);margin-top:22px;letter-spacing:1px}
      .h16d-fc-def{font-family:var(--serif);font-size:16px;line-height:1.65;color:var(--t1);max-width:420px}
      .h16d-fc-controls{display:flex;gap:10px;flex-wrap:wrap;justify-content:center}
      .h16d-fcb{padding:10px 20px;background:var(--card);border:1px solid var(--bdm);border-radius:var(--r2);color:var(--t2);font-family:var(--mono);font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;cursor:pointer;transition:all .2s}
      .h16d-fcb:hover{border-color:var(--bd-br);color:var(--bronze-l)}
      .h16d-fcb.primary{background:linear-gradient(135deg,var(--bronze-d),var(--bronze));color:#F5E6D3;border-color:var(--bronze)}
      .h16d-fcb.know{border-color:var(--bd-g);color:var(--green)}
      .h16d-fcb.know:hover{background:var(--dim-g)}
      .h16d-fcb.dont{border-color:var(--bd-r);color:var(--red)}
      .h16d-fcb.dont:hover{background:var(--dim-r)}
      .h16d-fc-stats{display:flex;gap:20px;margin-top:10px;font-family:var(--mono);font-size:11px}
      .h16d-fc-stats span{color:var(--t3)}
      .h16d-fc-stats b{color:var(--green)}
      .h16d-fc-stats i{color:var(--red);font-style:normal}
    </style>

    <div class="h16d-fc-wrap">
      <div class="h16d-fc-counter"><span id="h16d-fc-num"><b>1</b> / 20</span></div>
      <div class="h16d-fc" id="h16d-fc-card" onclick="h16DrillFcFlip()">
        <div class="h16d-fc-inner" id="h16d-fc-inner">
          <div class="h16d-fc-front">
            <div class="h16d-fc-cat" id="h16d-fc-cat-f">POJAM</div>
            <div class="h16d-fc-term" id="h16d-fc-term">—</div>
            <div class="h16d-fc-hint">Klikni za okretanje</div>
          </div>
          <div class="h16d-fc-back">
            <div class="h16d-fc-cat" id="h16d-fc-cat-b">DEFINICIJA</div>
            <div class="h16d-fc-def" id="h16d-fc-def">—</div>
          </div>
        </div>
      </div>
      <div class="h16d-fc-controls">
        <button class="h16d-fcb dont" onclick="h16DrillFcMark(0)">❌ Ne znam</button>
        <button class="h16d-fcb know" onclick="h16DrillFcMark(1)">✅ Znam</button>
        <button class="h16d-fcb" onclick="h16DrillFcSkip()">Preskoči ›</button>
        <button class="h16d-fcb" onclick="h16DrillFcShuffleAndRender()">📌 Promiješaj</button>
        <button class="h16d-fcb primary" onclick="h16DrillFcReset()">🔁 Reset</button>
      </div>
      <div class="h16d-fc-stats"><span>točno: <b id="h16d-fc-right">0</b></span><span>krivo: <i id="h16d-fc-wrong">0</i></span></div>
    </div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <p>Označi svaku tvrdnju koju <strong>stvarno znaš</strong> — ne samo prepoznaješ, nego možeš objasniti i primijeniti u eseju. Kada označiš svih 10, možeš prijeći na H17.</p>
    ...
    <div class="minirev">
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Djelo i korpus</div><div class="minirev-card-val"><b>Krleža: Gospoda Glembajevi</b> (3 čina) uz kontekst hrvatske moderne i avangarde.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Kontekst</div><div class="minirev-card-val"><b>Kraj građanskog svijeta</b>: raspad vrijednosti, klasna napetost i kriza identiteta pred modernim dobom.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Likovi i osi</div><div class="minirev-card-val"><b>Leone, barunica Castelli, Ignjat, sestra Angelika</b> — obiteljski sukob kao društvena dijagnoza.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Središnji sukob</div><div class="minirev-card-val"><b>Istina i savjest vs licemjerje elite</b>; psihološki slom otkriva mehanizme moći i nasljeđa.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Pojmovi</div><div class="minirev-card-val"><b>moderna drama, psihološka analiza, simbolizam, klasna kritika, dramski dijalog</b>.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Simboli</div><div class="minirev-card-val"><b>obiteljski salon, krv/nasljeđe, novac, noć</b> — simbolički ključ za čitanje raspada Glembajevih.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Most</div><div class="minirev-card-val">› <b>H17 Stilske figure</b>: prelazak s povijesno-poetološkog pregleda na jezičnu preciznost interpretacije.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Najveća greška</div><div class="minirev-card-val">Glembajeve svesti na „obiteljsku svađu”. Na maturi treba pokazati <b>društvenu i idejnu optiku drame</b>.</div></div>
        </div>
        <div class="minirev-quotes">
          ...
          <ol>
            <li>„Gospoda Glembajevi su drama u 3 čina.” <b>(školska formulacija)</b></li>
            <li>„Leone je simptom raspada glembajevskog svijeta.” <b>(interpretacijska formulacija)</b></li>
            <li>„Krleža razotkriva etički bankrot građanske elite.” <b>(interpretacijska formulacija)</b></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="exam-prompt">
      <div class="exam-prompt-ttl">📌 Kako se Glembajevi mogu pojaviti na ispitu</div>
      <div class="exam-prompt-task">Analiziraj kako Krleža u <em>Gospodi Glembajevima</em> prikazuje raspad građanske elite kroz obiteljski sukob i psihološku dramatiku. Objasni funkciju dijaloga, simboličkih motiva i društvenog konteksta te argumentiraj zašto je djelo ključno za hrvatsku modernu.</div>
      <div class="exam-prompt-tips">
        <div class="exam-tip"><b>📌 Struktura eseja</b>Uvod (50-60 r.) · 3 razradna odlomka (~120 r. svaki: kontekst, analiza likova/sukoba, poetička i društvena važnost) · zaključak (60-70 r.) = ~470 r.</div>
        <div class="exam-tip"><b>📌 Citati</b>Koristi 2-3 citata/formulacije: jedan vezan uz Leoneovu perspektivu, jedan uz obiteljsku hipokriziju, jedan o društvenoj kritici.</div>
        <div class="exam-tip"><b>📌 Povezivanje</b>Poveži H16→H17: sadržajna analiza treba biti praćena preciznim stilskim i jezičnim označavanjem u interpretaciji.</div>
        <div class="exam-tip"><b>📚 Pojmovi</b>Moderna drama · psihološka analiza · simbolizam · klasna kritika · dramski dijalog.</div>
      </div>
    </div>
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H16 Postmodernizam i suvremena književnost</div>
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h16.tab') || '0') }catch(e){return 0} })(),
...
/* ═══════════════════════════════════
  FLASHCARDS — H11-H15 style (H16 sadržaj)
═══════════════════════════════════ */
const FC_DATA=[
...
var H16_DRILL_FC_CARDS = FC_DATA.map(function(item){
  return {
...
var h16dFcIdx=0,h16dFcKnown=0,h16dFcUnknown=0,h16dFcOrder=[];
var H16_DRILL_SS_KEY='mt.hrv.h16.drill.fc';
var H16_DRILL_FC_FREE_LIMIT=5;

function h16DrillBeep(f,d,v,t){
  try{
...
function h16DrillSoundOk(){h16DrillBeep(660,.1,.08,'sine');setTimeout(function(){h16DrillBeep(880,.14,.07,'sine')},110)}
function h16DrillSoundNg(){h16DrillBeep(200,.18,.08,'sawtooth')}
function h16DrillSoundDone(){[440,550,660,880].forEach(function(f,i){setTimeout(function(){h16DrillBeep(f,.18,.07,'sine')},i*90)})}

function h16DrillSave(){
  try{sessionStorage.setItem(H16_DRILL_SS_KEY,JSON.stringify({idx:h16dFcIdx,known:h16dFcKnown,unknown:h16dFcUnknown,order:h16dFcOrder,ts:Date.now()}))}catch(e){}
}

function h16DrillRestore(){
  try{
    var raw=sessionStorage.getItem(H16_DRILL_SS_KEY);if(!raw)return false;
    var s=JSON.parse(raw);
    if(!s||!Array.isArray(s.order)||s.order.length!==H16_DRILL_FC_CARDS.length)return false;
    h16dFcIdx=s.idx||0;h16dFcKnown=s.known||0;h16dFcUnknown=s.unknown||0;h16dFcOrder=s.order;
    var r=document.getElementById('h16d-fc-right');if(r)r.textContent=h16dFcKnown;
    var w=document.getElementById('h16d-fc-wrong');if(w)w.textContent=h16dFcUnknown;
    return true;
  }catch(e){return false}
}

function h16DrillFcShuffle(){
  h16dFcOrder=H16_DRILL_FC_CARDS.map(function(_,i){return i});
  for(var i=h16dFcOrder.length-1;i>0;i--){var j=Math.floor(Math.random()*(i+1));var t=h16dFcOrder[i];h16dFcOrder[i]=h16dFcOrder[j];h16dFcOrder[j]=t}
}

function h16DrillFcIsPaid(){
...
function h16DrillFcShowPaywall(){
  var wrap=document.querySelector('.h16d-fc-wrap');
  if(!wrap)return;
  var existing=document.getElementById('h16d-fc-paywall');
  if(existing){if(existing.scrollIntoView)existing.scrollIntoView({behavior:'smooth',block:'center'});return;}
  var chapter=(typeof CURRENT_CHAPTER!=='undefined'&&CURRENT_CHAPTER.code)||'h16';
  var html='<div id="h16d-fc-paywall" class="drill-paywall" data-feature="drill-flashcards">'+
  ...
  if(typeof track==='function'){track('paywall_impression',{feature:'drill-flashcards',chapter:chapter,at_card:h16dFcIdx},'conversion');}
}

function h16DrillFcRender(){
  if(h16dFcOrder.length===0)h16DrillFcShuffle();

  if(!h16DrillFcIsPaid() && h16dFcIdx >= H16_DRILL_FC_FREE_LIMIT){
    var termL=document.getElementById('h16d-fc-term');
    var catFL=document.getElementById('h16d-fc-cat-f');
    var defL=document.getElementById('h16d-fc-def');
    var catBL=document.getElementById('h16d-fc-cat-b');
    var numL=document.getElementById('h16d-fc-num');
    ...
    if(numL)numL.innerHTML='<b>'+H16_DRILL_FC_FREE_LIMIT+'</b> / 20 · <span style="color:var(--gold)">Free limit</span>';
    h16DrillFcShowPaywall();
    return;
  }

  if(h16dFcIdx>=h16dFcOrder.length){
    var t=document.getElementById('h16d-fc-term');
    var d=document.getElementById('h16d-fc-def');
    var cf=document.getElementById('h16d-fc-cat-f');
    var cb=document.getElementById('h16d-fc-cat-b');
    var num=document.getElementById('h16d-fc-num');
    if(t)t.textContent='Gotovo! ✅';
    if(cf)cf.textContent='REZULTAT';
    if(d)d.textContent='Točno: '+h16dFcKnown+' / Krivo: '+h16dFcUnknown+'. Klikni Reset za novi krug.';
    if(cb)cb.textContent='REZULTAT';
    if(num)num.innerHTML='<b>'+h16dFcOrder.length+'</b> / '+h16dFcOrder.length;
    h16DrillSoundDone();
    return;
  }

  var c=H16_DRILL_FC_CARDS[h16dFcOrder[h16dFcIdx]];
  var card=document.getElementById('h16d-fc-card');if(card)card.classList.remove('flipped');
  var catf=document.getElementById('h16d-fc-cat-f');
  var catb=document.getElementById('h16d-fc-cat-b');
  var term=document.getElementById('h16d-fc-term');
  var def=document.getElementById('h16d-fc-def');
  var num2=document.getElementById('h16d-fc-num');
  ...
  if(num2)num2.innerHTML='<b>'+(h16dFcIdx+1)+'</b> / '+h16dFcOrder.length;
}

function h16DrillFcFlip(){var card=document.getElementById('h16d-fc-card');if(card)card.classList.toggle('flipped')}

function h16DrillFcMark(known){
  if(known){h16dFcKnown++;h16DrillSoundOk();}
  else{h16dFcUnknown++;h16DrillSoundNg();}
  var r=document.getElementById('h16d-fc-right');if(r)r.textContent=h16dFcKnown;
  var w=document.getElementById('h16d-fc-wrong');if(w)w.textContent=h16dFcUnknown;
  h16dFcIdx++;
  h16DrillSave();
  setTimeout(h16DrillFcRender,180);
}

function h16DrillFcSkip(){h16dFcIdx++;h16DrillSave();h16DrillFcRender()}

function h16DrillFcShuffleAndRender(){
  h16DrillFcShuffle();
  h16dFcIdx=0;
  h16DrillSave();
  h16DrillFcRender();
...
function h16DrillFcReset(){
  h16dFcIdx=0;h16dFcKnown=0;h16dFcUnknown=0;
  h16DrillFcShuffle();
  try{sessionStorage.removeItem(H16_DRILL_SS_KEY)}catch(e){}
  var r=document.getElementById('h16d-fc-right');if(r)r.textContent=0;
  var w=document.getElementById('h16d-fc-wrong');if(w)w.textContent=0;
  h16DrillFcRender();
}

function h16DrillInit(){if(!h16DrillRestore())h16DrillFcShuffle();h16DrillFcRender()}

function fcInit(){ h16DrillInit(); }
function fcRender(){ h16DrillFcRender(); }
function fcFlip(){ h16DrillFcFlip(); }
function fcNav(dir){
  if(dir>0){h16DrillFcSkip();return;}
  if(dir<0 && h16dFcIdx>0){h16dFcIdx--;h16DrillSave();h16DrillFcRender();}
}
...
export default function H16Chapter() {
  useEffect(() => {
    ...
    const raf = requestAnimationFrame(() => {
      mount('h16-react-discere-banner-primary', <DiscereBannerPrimaryH16 />);
      mount('h16-react-video-card-primary', <VideoCardPrimaryH16 />);
      mount('h16-react-video-card-secondary', <VideoCardSecondaryH16 />);
      mount('h16-react-video-card-tertiary', <VideoCardTertiaryH16 />);
      mount('h16-react-video-card-quaternary', <VideoCardQuaternaryH16 />);
      mount('h16-react-author-krleza', <AuthorProfileH16Krleza />);
      mount('l3', <CitatnikH16 />);
      mount('l4', <PojmovnikH16 />);
    });
