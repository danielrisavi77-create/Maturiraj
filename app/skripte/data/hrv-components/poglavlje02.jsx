...
import {
  ...
  AccordionKantike, DanteVsHomer, AuthorCardPretece,
  KrsniListQuote, StatCardsPloca, TimelineOtkrice,
  TablicaPisama, GlagoljicaPanel, GeografskaMapa,
  AccordionEsejTeze,
} from './H02_Components';
import Citatnik from './H02_CitatnikTab';
import H02PojmovnikTab from './H02_PojmovnikTab';
...
<div class="content-wrap">
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div id="h02-react-timeline-pismenost"></div>
    ...
    <div class="box-signal">
      ...
      <div class="box-signal-txt">
        U Njemačkoj trubadure nazivaju <strong>minnesingeri</strong> (od <em>Minne</em> = plemenita ljubav). U sjevernoj Francuskoj su <strong>trouveres</strong>. Svi pišu o istoj temi: <em>služenje dami kao duhovna askeza</em>. Najpoznatiji minnesinger: <b>Walther von der Vogelweide</b> (~1200).
      </div>
    </div>
    ...
    <div id="h02-react-author-dante"></div>
    ...
    <div id="h02-react-svg-dante"></div>
    <div id="h02-react-kantike"></div>
    ...
    <div id="h02-react-dante-vs-homer"></div>
    ...
    <div id="h02-react-author-pretece"></div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div id="h02-react-krsni-list"></div>
    ...
    <div id="h02-react-stat-cards"></div>
    ...
    <div id="h02-react-timeline-otkrice"></div>
    ...
    <div class="box-signal">
      <div class="box-signal-lbl">💡 Bašćanska ploča · 1. dio — Invokacija</div>
      <div class="box-signal-txt">
        <div class="bp-col-hdrs">
          <span class="bp-col-hdr orig">Starohrvatski (oko 1100.)</span>
          <span class="bp-col-hdr trans">Suvremeni prijevod</span>
        </div>
        <div class="bp-row">
          <div class="bp-orig">Az, v ime <strong>Otca i Sina i Svetago Duha</strong>.</div>
          <div class="bp-trans">Ja, u ime <strong>Oca i Sina i Svetoga Duha</strong>.</div>
        </div>
      </div>
    </div>

    <div class="box-signal">
      <div class="box-signal-lbl">💡 Bašćanska ploča · 2. dio — Darovnica i prokletstvo (Opat Držiha)</div>
      <div class="box-signal-txt">
        <div class="bp-col-hdrs">
          <span class="bp-col-hdr orig">Starohrvatski (oko 1100.)</span>
          <span class="bp-col-hdr trans">Suvremeni prijevod</span>
        ...
        <div class="bp-row">
          <div class="bp-orig">Az opat <strong>Držiha</strong> pisah se o ledine, juže da <strong>Zvanimir kralj hrvatskij</strong> v dni svoje v <strong>Svetuju Luciju</strong> — i svedomi: župan Desimira Krbave, Mratin v Lice, Pribineža posal Vinodole, Jakov v otoce.</div>
          <div class="bp-trans">Ja opat <strong>Držiha</strong> napisah ovo o ledini koju dade <strong>Zvonimir, kralj hrvatski</strong>, u svoje dane <strong>Svetoj Luciji</strong>, i svjedoci: župan Desimira iz Krbave, Mratin iz Like, Pribineža poslanik iz Vinodola, Jakov s otoka (Krka).</div>
        </div>
        <div class="bp-row">
          <div class="bp-orig">Da iže to poreče, klni j <strong>Bog</strong> i dvanadeste apostola i četiri evanjelisti i <strong>svetaja Lucija</strong>, amen. Da iže sde živet, moli za nje Boga.</div>
          <div class="bp-trans">Tko to porekne, neka ga prokune <strong>Bog</strong> i dvanaest apostola i četiri evanđelista i <strong>sveta Lucija</strong>, amen. Tko ovdje živi, neka moli za njih Boga.</div>
        </div>
      </div>
    </div>

    <div class="box-signal">
      <div class="box-signal-lbl">📍 Bašćanska ploča · 3. dio — Gradnja crkve (Opat Dobrovit)</div>
      <div class="box-signal-txt">
        <div class="bp-col-hdrs">
          <span class="bp-col-hdr orig">Starohrvatski (oko 1100.)</span>
          <span class="bp-col-hdr trans">Suvremeni prijevod</span>
        ...
        <div class="bp-row">
          <div class="bp-orig">Az opat <strong>Dobrovit</strong> zdah <strong>crekav siju</strong> i svojeju bratiju s devetiju v dni kneza <strong>Kosmata</strong> obladajućago vsu Krajinu. I beše v ti dni Mikula v Otočci s svetuju Luciju v jedino.</div>
          <div class="bp-trans">Ja opat <strong>Dobrovit</strong> sazidah <strong>ovu crkvu</strong> sa svojih devetero braće u dane kneza <strong>Kosmata</strong> koji je vladao cijelom Krajinom. I bijaše u te dane (samostan) sv. Mikule u Otočcu sa svetom Lucijom ujedinjeno.</div>
        </div>
      </div>
    </div>
    ...
    <div id="h02-react-tablica-pisama"></div>
    ...
    <div id="h02-react-glagoljica"></div>
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=Bašćanska+ploča+dokumentarac" target="_blank" rel="noopener noreferrer" onclick="track('yt_click',{topic:'bascanska_ploca_dok'},'engagement')">
        ...
        <div class="yt-body">
          ...
          <div class="yt-meta"><span>🇭🇷 HR sadržaj</span><span>⏱️ 15-30 min</span></div>
        </div>
      </a>
      ...
      <a class="yt-card" href="https://www.youtube.com/results?search_query=glagoljica+hrvatska+pismenost" target="_blank" rel="noopener noreferrer" onclick="track('yt_click',{topic:'glagoljica_objasnjenje'},'engagement')">
        ...
        <div class="yt-body">
          ...
          <div class="yt-meta"><span>🎓 Edukacijski</span><span>⏱️ 10-20 min</span></div>
        </div>
      </a>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div id="h02-react-esej-teze"></div>
    <!-- MODEL UVODA -->
    ...
    <div class="box-int">
      <div class="box-int-lbl">MODEL UVODA · tema: hrvatska pismenost u srednjem vijeku</div>
      <div class="box-int-txt">
    ...
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04 · Brojač eseja</div><div class="sec-line"></div></div>
  ...
  <div class="layer" id="l3" role="tabpanel" tabindex="0">
    <div id="h02-react-citatnik"></div>
  </div>
  <!-- ========================
       TAB 4 · POJMOVNIK
       ======================== -->
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    <div id="h02-react-pojmovnik"></div>
  </div>
  <!-- ========================
       TAB 5 · DRILL
       ======================== -->
...
.wc-hint{margin-top:12px;padding:10px 12px;background:var(--inp,#0F0605);border-radius:8px;font-size:12px;color:var(--t2,#c5b8aa);line-height:1.5}
    ...
    <div class="minirev">
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Djelo i korpus</div><div class="minirev-card-val"><b>Bašćanska ploča</b>, Danteova <b>Božanstvena komedija</b>, viteški ep i trubadurska lirika kao jezgra gradiva.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Kontekst</div><div class="minirev-card-val"><b>Teocentrizam</b>: književnost je usmjerena spasenju, moralnoj pouci i potvrdi kršćanskog poretka.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Ključne figure</div><div class="minirev-card-val"><b>Dante, anonimni glagoljaši, viteški junaci</b> — različiti modeli istog srednjovjekovnog vrijednosnog sustava.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Središnji obrazac</div><div class="minirev-card-val"><b>Put duše</b> (grijeh → kazna → očišćenje) i <b>služenje idealu</b> (Bogu, vladaru, dami).</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Pojmovi</div><div class="minirev-card-val"><b>alegorija, teocentrizam, hagiografija, viteški ideal, kurtoazna ljubav</b>.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Simboli</div><div class="minirev-card-val"><b>glagoljica, pokorni hodočasnik, put, svjetlo/tama</b> — ključne slike koje nose ideju djela.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Most</div><div class="minirev-card-val">› <b>H03 Renesansa</b>: od Boga u središtu prema čovjeku u središtu (teocentrizam → antropocentrizam).</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Najveća greška</div><div class="minirev-card-val">Srednji vijek svesti na „mračno doba”. Na maturi se traži <b>unutarnja logika epohe</b>, ne stereotip.</div></div>
        </div>
        <div class="minirev-quotes">
          ...
          <ol>
            <li>„Uđite, vi koji napuštate svaku nadu.” <b>(Dante, Pakao)</b></li>
            <li>„Bašćanska ploča je krsni list hrvatske pismenosti.” <b>(školska formulacija)</b></li>
            <li>„Ljubav koja pokreće sunce i druge zvijezde.” <b>(Dante, Raj)</b></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="exam-prompt">
      <div class="exam-prompt-ttl">📌 Kako se srednji vijek može pojaviti na ispitu</div>
      <div class="exam-prompt-task">Analiziraj kako srednjovjekovni svjetonazor oblikuje književne teme, likove i stil. U argumentaciji poveži <em>Bašćansku ploču</em>, Danteovu <em>Božanstvenu komediju</em> i viteški ideal te objasni prijelaz prema renesansnom poimanju čovjeka.</div>
      <div class="exam-prompt-tips">
        <div class="exam-tip"><b>📌 Struktura eseja</b>Uvod (50-60 r.) · 3 razradna odlomka (~120 r. svaki: teocentrizam, primjeri djela, prijelaz prema renesansi) · zaključak (60-70 r.) = ~470 r.</div>
        <div class="exam-tip"><b>📌 Citati</b>Koristi 2-3 citata/formulacije: Dante (Pakao/Raj) + Bašćanska ploča + jedna viteška/trubadurska formula.</div>
        <div class="exam-tip"><b>📌 Povezivanje</b>Usporedi srednjovjekovni model s H03 (renesansa): autoritet objave nasuprot autoritetu razuma i iskustva.</div>
        <div class="exam-tip"><b>📚 Pojmovi</b>Teocentrizam · alegorija · hagiografija · viteški kod · glagoljica · prijelaz epoha.</div>
      </div>
    </div>

    <div class="pro-gate" data-feature="checkpoint-tracking">
      <div class="cp-grid" id="cp-grid">
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam kada i gdje nastaje <b>Bašćanska ploča</b> (oko 1100., Jurandvor) i zašto je ključni spomenik hrvatske pismenosti</div><span class="cp-hint">Bašćanska ploča</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Mogu objasniti zašto se naziva <b>„krsnim listom hrvatske kulture”</b> (spomen kralja Zvonimira, jezik, pismo, kontinuitet državnosti)</div><span class="cp-hint">Hrv. pismenost</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Razumijem razliku između <b>oble i uglate glagoljice</b> te mogu razlikovati Bašćansku ploču i Povelju Kulina bana</div><span class="cp-hint">Pisma</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam glavne značajke srednjovjekovne književnosti — <b>teocentrizam, alegoričnost, didaktičnost, simbolizam</b></div><span class="cp-hint">Poetika</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam strukturu <b>Božanstvene komedije</b> (Pakao / Čistilište / Raj, 100 pjevanja) i mogu objasniti njezinu alegorijsku logiku</div><span class="cp-hint">Dante</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Prepoznajem srednjovjekovne žanrove — <b>hagiografiju, viteški ep, trubadursku liriku</b> — na konkretnim primjerima</div><span class="cp-hint">Žanrovi</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Imam <b>barem 2 teze</b> za esej (teocentrični pogled na svijet, književnost kao moralna pouka, prijelaz prema humanizmu)</div><span class="cp-hint">Esej</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam <b>3 citata</b> ili formulacije napamet (Bašćanska ploča, Dante, viteška/trubadurska tradicija)</div><span class="cp-hint">Citatnik</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">?</div><div>Znam tko su <b>Petrarca i Boccaccio</b> i mogu objasniti zašto su prijelaz iz srednjega vijeka prema renesansi</div><span class="cp-hint">Prijelaz epoha</span></div>
  ...
  <div class="chapter-nav-wrap">
    ...
    <div class="chapter-nav-grid">
      <a class="chapter-nav-card chapter-nav-prev" href="/skripte/hrv/h01">
        <div class="chapter-nav-arrow">‹</div>
        <div class="chapter-nav-meta">
          <div class="chapter-nav-pill">PRETHODNO</div>
          <div class="chapter-nav-name">H01 · Antika i civilizacije</div>
          <div class="chapter-nav-desc">Homer, Sofoklo, Biblija · rimska lirika</div>
        </div>
      </a>

      <a class="chapter-nav-card chapter-nav-next" href="/skripte/hrv/h03">
        <div class="chapter-nav-meta">
          <div class="chapter-nav-pill chapter-nav-pill-next">SLJEDEĆE</div>
          <div class="chapter-nav-name">H03 · Renesansa</div>
          <div class="chapter-nav-desc">Petrarca · Shakespeare · Dante · humanizam</div>
        </div>
        <div class="chapter-nav-arrow">›</div>
      </a>
    </div>
    ...
    <div class="chapter-nav-related">
      ...
      <div class="chapter-nav-related-grid">
        ...
        <a class="chapter-nav-mini" href="/skripte/hrv/h24">
          ...
          <span class="chapter-nav-mini-name">Narječja i govori</span>
        </a>
      </div>
    </div>
  </div>
...
const CHAPTER_CSS_DELTA = `background-size:80px 80px;pointer-events:none;z-index:0;
  pointer-events:none;z-index:0;
/* == BAŠĆANSKA PLOČA — paralelni tekst == */
...
.cit-txt{font-family:var(--serif,'EB Garamond',Georgia,serif);font-size:16px;font-weight:400;font-style:italic;color:var(--t1);line-height:1.55;margin:12px 0 14px;padding:0;letter-spacing:.15px;position:relative}
/* Thesis tags row */
...
.cit-hidden{display:none}
/* Search row */
.cit-search-row{margin:14px 0 16px;display:flex;gap:8px;align-items:center}
.cit-search{flex:1;padding:10px 14px;background:var(--inp,#0F0605);border:1px solid var(--bdl,#2c1f1f);border-radius:10px;color:var(--t1,#f4ede5);font-family:var(--mono,monospace);font-size:13px;outline:none;transition:border-color .2s}
.cit-search:focus{border-color:var(--gold,#e8c97a)}
.cit-clear{display:block;position:static;transform:none;width:auto;height:auto;padding:8px 12px;background:var(--inp,#0F0605);border:1px solid var(--bdl,#2c1f1f);border-radius:8px;color:var(--t2,#c5b8aa);cursor:pointer;font-size:14px;transition:all .15s}
.cit-clear:hover{color:var(--t1);border-color:var(--bd-br)}
@media print{
...
.bp-col-hdrs{display:flex;margin:0 0 10px;padding-bottom:6px;border-bottom:1px solid rgba(232,201,122,.2)}
.bp-col-hdr{flex:1;font-family:var(--mono);font-size:8px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase}
.bp-col-hdr.orig{color:var(--bronze-l)}
.bp-col-hdr.trans{color:var(--t3)}
.bp-row{display:flex;margin-top:12px}
.bp-orig{flex:1;color:var(--t1);padding-right:18px;border-right:1px solid rgba(232,201,122,.18)}
.bp-trans{flex:1;font-style:italic;padding-left:18px}
@media(max-width:640px){.bp-row{flex-direction:column}.bp-orig{border-right:none;border-bottom:1px solid rgba(232,201,122,.15);padding-right:0;padding-bottom:8px;margin-bottom:8px}.bp-trans{padding-left:0}}
.stat-badge{animation:count-up .4s ease-out}
}`;
/* == BAANSKA PLOA — paralelni tekst == */
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrv/h02';
  var text='Prošao/la sam kviz iz H01 · Temelji civilizacije i antika na maturiraj.hr — '+score+'/'+QUIZ.length+' ('+pct+'%) 🎓';
...
function H02ReactLayers() {
  ...
  return (
    <>
      {anchors.timelinePismenost && createPortal(<TimelinePismenost />, anchors.timelinePismenost)}
      {anchors.authorDante       && createPortal(<AuthorCardDante />,   anchors.authorDante)}
      {anchors.svgDante          && createPortal(<SVGDanteStruktura />, anchors.svgDante)}
      {anchors.kantike           && createPortal(<AccordionKantike />,  anchors.kantike)}
      {anchors.danteVsHomer      && createPortal(<DanteVsHomer />,      anchors.danteVsHomer)}
      {anchors.authorPretece     && createPortal(<AuthorCardPretece />, anchors.authorPretece)}
      {anchors.krsniList         && createPortal(<KrsniListQuote />,    anchors.krsniList)}
      {anchors.statCards         && createPortal(<StatCardsPloca />,    anchors.statCards)}
      {anchors.timelineOtkrice   && createPortal(<TimelineOtkrice />,   anchors.timelineOtkrice)}
      {anchors.tablicaPisama     && createPortal(<TablicaPisama />,     anchors.tablicaPisama)}
      {anchors.glagoljica        && createPortal(<GlagoljicaPanel />,   anchors.glagoljica)}
      {anchors.geoMapa           && createPortal(<GeografskaMapa />,    anchors.geoMapa)}
      {anchors.esejTeze          && createPortal(<AccordionEsejTeze />, anchors.esejTeze)}
      ...
      {anchors.pojmovnik         && createPortal(<H02PojmovnikTab />, anchors.pojmovnik)}
    </>
  );
}
