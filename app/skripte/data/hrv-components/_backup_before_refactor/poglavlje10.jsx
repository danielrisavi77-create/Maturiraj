...
export const metadata = {
  code: 'H10',
  title: 'Maturiraj.hr — Hrvatski H10 · Postmoderna',
  description: 'Interaktivna skripta za maturu — Postmoderna: metafikcija, intertekstualnost, pastiš, parodija, fragmentacija.',
  canonical: 'https://maturiraj.hr/skripte/hrvatski/h10',
  ogImage: 'https://maturiraj.hr/og/hrvatski-h10.png',
};
...
<div class="modal-backdrop" id="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="modal-title" onclick="if(event.target===this)closeModal()">
  <div class="modal" role="document">
    ...
    <div class="modal-title" id="modal-title">Sljedeće poglavlje — uskoro!</div>
    ...
    <div class="modal-preview" id="modal-preview">
      <strong>Nadolazeća poglavlja</strong>
      Hrvatska književnost 20. st. · svjetska moderna i postmoderna · teorija književnosti · hrvatski jezik (jezični sustav, leksikologija, povijest) · školski esej — sve prema NCVVO ispitnom katalogu 2024/2025.
    </div>
...
<div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div class="sc-grid">
      <div class="sc">
        ...
        <div class="sc-name">Intertekstualnost kao ključ tumačenja</div>
        <div class="sc-desc"><em>„Autor X gradi tekst na mreži referenci — svako čitanje pretpostavlja prepoznavanje."</em></div>
      </div>
      <div class="sc">
        <span class="sc-ico hchip go">TEZA 2</span>
        <div class="sc-name">Metafikcija — razotkrivanje konstrukcije</div>
        <div class="sc-desc"><em>„Djelo X ne skriva da je konstrukt — pokazuje vlastiti mehanizam nastanka."</em></div>
      </div>
      <div class="sc">
        <span class="sc-ico hchip t">TEZA 3</span>
        <div class="sc-name">Fragmentacija kao odraz modernog subjekta</div>
        <div class="sc-desc"><em>„Strukturna fragmentacija teksta odražava ontološku fragmentaciju modernog subjekta."</em></div>
      </div>
      <div class="sc">
        <span class="sc-ico hchip pa">TEZA 4</span>
        <div class="sc-name">Nepouzdani pripovjedač kao znak epohe</div>
        <div class="sc-desc"><em>„Pripovjedač u djelu X ne jamči istinu — njegov pogled je subjektivan, fragmentaran, možda lažan."</em></div>
      </div>
      <div class="sc">
        <span class="sc-ico hchip re">TEZA 5</span>
        <div class="sc-name">Ironija — nemogućnost jednoznačnog čitanja</div>
        <div class="sc-desc"><em>„Djelo X koristi ironiju ne da ismije, nego da pokaže nemogućnost jednoznačnog tumačenja."</em></div>
      </div>
      <div class="sc">
        <span class="sc-ico hchip br">TEZA 6</span>
        <div class="sc-name">Miješanje žanrova kao svjesna strategija</div>
        <div class="sc-desc"><em>„Djelo X krši granice žanrova — to nije slabost nego namjerna postmoderna strategija."</em></div>
      </div>
      <div class="sc">
        <span class="sc-ico hchip go">TEZA 7</span>
        <div class="sc-name">Otvoreni kraj — odbijanje konačne istine</div>
        <div class="sc-desc"><em>„Djelo X ne zatvara se jednoznačnim razrješenjem — otvoreni kraj je dio poruke."</em></div>
      </div>
    </div>
    ...
    <div class="cp-final" id="cp-final">
      ...
      <div class="pdf-export">
        ...
        <div class="pdf-export-body">
          ...
          <div class="pdf-export-txt">Sve što si prošao — Teorija, Djela (Eco + Pavličić), Esej alat, Citatnik, Pojmovnik, Drill, Kviz — u jednom dokumentu. <strong>Idealno za ponavljanje pred ispit</strong> ili ispis na papir.</div>
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrvatski/h10';
...
@media print{
  ...
  *, *::before, *::after{
  ...
  body::before{
    content:"Maturiraj.hr · H10 Postmoderna · 8 tabova · Svrha: priprema za državnu maturu iz Hrvatskog jezika 2024/2025";
    display:block;
...
@media print{
  ...
  body.print-cheat-only::before{
    content:"Maturiraj.hr · H10 · Postmoderna — pred-ispit ponavljanje";
...
/* ══ H10 EXTRA CSS — sc-ttl, sc-grid, diag-bar, cit-eyebrow ══ */
.sc-ttl{font-family:var(--display);font-size:14px;font-weight:700;color:var(--bronze-l);letter-spacing:.5px;margin-bottom:8px;line-height:1.3}
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H10] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H10`);
