...
export const metadata = {
  ...
  description: 'Kompletan leksikon hrvatskih stilskih figura — 45 figura u 4 kategorije (tropi, figure riječi, figure rečenice, figure zvuka) s primjerima iz hrv.',
  canonical: 'https://maturiraj.hr/hrvatski/h17',
  ogImage: '',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" data-code="h17" href="/skripte/hrv/h17"><span class="sb-dot"></span>H17 · Stilske figure</a>
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H17] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H17`);
