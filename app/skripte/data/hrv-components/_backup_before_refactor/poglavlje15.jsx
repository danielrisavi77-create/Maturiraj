...
export const metadata = {
  ...
  description: 'Interaktivna skripta za maturu — August Šenoa i Prijan Lovro: dubinska analiza pripovijetke, 5 dijelova, obvezatno djelo za čitanje 2026, kontekst hrv.',
  canonical: 'https://maturiraj.hr/hrvatski/h15',
  ogImage: '',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" data-code="h15" href="/skripte/hrv/h15"><span class="sb-dot"></span>H15 · Šenoa i realizam</a>
    ...
    <div class="cheat-card" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Tab 1 · Šenoa — Prijan Lovro (5 pjevanja)</div>
        </div>
      </div>
      <div class="cheat-grid">
        <div class="cheat-col cheat-col-wide" style="font-family:var(--serif,Fraunces,serif);font-size:13.5px;color:var(--t2,#c5b8aa);line-height:1.65">
          <p style="margin:0">Sad imaš pregled hrvatskog realizma — <b>Tab 1</b> donosi <em>Prijana Lovre</em>. 5 pjevanja, povijesna podloga i analiza likova.</p>
        </div>
      </div>
    </div>
...
<div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">★ Napamet — 8 glavnih citata iz Prijana Lovre</div><div class="sec-line"></div></div>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <div class="fc-cat-label">H15 · ŠENOA · PRIJAN LOVRO — Pojmovnik</div>
    <div class="fc-wrap">
      <div class="fc-inner" id="fc-card-dyn" onclick="fcFlip()">
        <div class="fc-front">
          <div class="fc-label">POJAM · klikni za definiciju</div>
          <div class="fc-term">Uokvirena pripovijetka</div>
          <div class="fc-cat">tehnika · klikni za definiciju</div>
        </div>
        <div class="fc-back">
          <div class="fc-label">DEFINICIJA</div>
          <div class="fc-def">Priča u priči — vanjski pripovjedač uvodi unutarnju pripovijest. U Prijanu Lovri: Šenoa (okvir, berba) priča udovici o Lovri (unutarnja priča).</div>
...
const KVIZ_Q=[
  ...
  {q:'Zašto se djelo zove „Werther hrvatske književnosti"?',o:['Paralela s Goetheovim Wertherom — samoubojstvo mladog intelektualca iz ljubavi','Šenoa je preveo Wertherа','Lovro čita Wertherа','Werther je Lovrov uzor'],t:0,e:'Werther (Goethe, 1774.) — mladi intelektualac se ubija zbog ljubavi prema Lotte. Razlika: Werther = individualna; Lovro = socijalna tragedija.'},
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H15] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H15`);
