...
export const metadata = {
  code: 'H22',
  title: 'H22 · Leksikologija — Maturiraj.hr · matura iz hrvatskog',
  description: 'H22 Leksikologija — sustavni prikaz značenja riječi, sinonima, antonima, homonima, frazema, slojeva leksika i tvorbe značenja. Maturiraj.hr matura iz hrvatskog.',
  canonical: 'https://maturiraj.hr/hrvatski/h22-leksikologija',
  ogImage: 'https://maturiraj.hr/og/h22-leksikologija.png',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" aria-current="page" data-code="h22" href="/skripte/hrv/h22"><span class="sb-dot"></span>H22 · Leksikologija</a>
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H22] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H22`);
