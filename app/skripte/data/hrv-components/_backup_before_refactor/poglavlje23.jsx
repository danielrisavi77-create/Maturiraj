...
export const metadata = {
  code: 'H23',
  title: 'H23 · Povijest hrvatskoga jezika — Maturiraj.hr · matura iz hrvatskog',
  description: 'H23 Povijest hrvatskoga jezika — razdoblja, pisma (glagoljica, ćirilica, latinica), najstariji spomenici, standardizacija. Maturiraj.hr matura iz hrvatskog.',
  canonical: 'https://maturiraj.hr/hrvatski/h23-povijest-jezika',
  ogImage: 'https://maturiraj.hr/og/h23-povijest-jezika.png',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" aria-current="page" data-code="h23" href="/skripte/hrv/h23"><span class="sb-dot"></span>H23 · Povijest hrv. jezika</a>
...
<div class="content-wrap">
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button class="tab" id="tab2" onclick="sw(2)" role="tab" aria-selected="false" aria-controls="l2">✍ Pisma<span class="tab-done" id="td2"></span></button>
        ...
        <div class="abc-svg-wrap">
          <svg viewBox="0 0 360 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block">
            ...
            <g transform="translate(60,140)">
              <text style="font-family:'Times New Roman',serif;font-size:14px;fill:#a0a8b4;font-style:italic">+ još 22 znaka u izvornoj abecedi</text>
            </g>
          </svg>
        </div>
        <div class="abc-meta">
      ...
      <div class="abc-card" onclick="abcZoom(this)">
        ...
        <div class="abc-svg-wrap">
          <svg viewBox="0 0 360 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block">
            ...
            <g transform="translate(60,140)">
              <text style="font-family:'Times New Roman',serif;font-size:14px;fill:#a0a8b4;font-style:italic">+ С,Т,У,Ф,Х,Ц,Ч,Ш и dr. (43 ukupno)</text>
            </g>
          </svg>
        </div>
        <div class="abc-meta">
...
.cheat-col-wide{grid-column:1/-1}
            ...
            <g transform="translate(60,140)">
              <text style="font-family:'Times New Roman',serif;font-size:13px;fill:#a0a8b4;font-style:italic">⭐ = dijakritički znakovi · Gaj 1830.</text>
            </g>
          </svg>
        </div>
        <div class="abc-meta">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:18px;align-items:center">
        ...
        <div>
          <svg viewBox="0 0 300 160" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block;border-radius:var(--r1);background:linear-gradient(135deg, #2a2520, #1a1614)">
            ...
            <text x="150" y="156" font-family="Courier New,monospace" font-size="9" fill="#e9b446" text-anchor="middle">↑ „Zъvъnimirъ kralъ hrъvatъskъi"</text>
          </svg>
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H23] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H23`);
