...
export const metadata = {
  code: 'H09',
  title: 'Maturiraj.hr — Hrvatski H09 · Egzistencijalizam + Camus Stranac',
  description: 'Interaktivna skripta za maturu — Egzistencijalizam i Albert Camus: Stranac (obvezatno 2026). Meursault, alžirsko sunce, ubojstvo Arapina, suđenje, apsurd, Mit o Sizifu. Kviz, flashcards, esej alat.',
  canonical: 'https://maturiraj.hr/skripte/hrvatski/h09',
  ogImage: 'https://maturiraj.hr/og/hrvatski-h09.png',
};
...
<div class="modal-backdrop" id="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="modal-title" onclick="if(event.target===this)closeModal()">
  <div class="modal" role="document">
    ...
    <div class="modal-title" id="modal-title">H10 · Sofoklo Antigona — uskoro!</div>
    ...
    <div class="modal-preview" id="modal-preview">
      <strong>Sadržaj H10</strong>
      Sofoklo · <em>Antigona</em> (oko 442. pr. Kr.) · grčka tragedija · sukob obiteljskog prava i državnog zakona · etika neposluha · Kreont · Hemon · Tireziaz · katarza · obvezatno čitanje 2026.
    </div>
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div class="sc-grid">
      <div class="sc">
        ...
        <div class="sc-name">Søren Kierkegaard (1813.–1855.)</div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="sc-grid">
      ...
      <div class="sc">
        ...
        <div class="sc-name">Raymond Sintès</div>
    ...
    <div class="sc-grid">
      <div class="sc">
        <span class="sc-ico hchip re">SUNCE</span>
        <div class="sec-name"></div>
        <div class="sc-name">Sunce — aktivan akter</div>
        <div class="sc-desc"><b>Sunce je drugi protagonist romana.</b> Žari, peče, pritišće. Na sahrani majke, na plaži, u sudnici. Meursault govori da je <em>„zbog sunca"</em> ubio Arapina. <b>Sud to odbija prihvatiti</b>. Sunce nije izgovor — ono je <em>fizička realnost koja oblikuje doživljaj</em>. Camusova <b>mediteranska poetika</b>: priroda nije pozadina, ona <em>djeluje</em>.</div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip t">MORE</span>
        <div class="sc-name">More — sloboda</div>
        <div class="sc-desc">More je <em>jedino mjesto gdje je Meursault potpuno smiren</em>. Plivanje s Marie, plaže, voda na koži. <b>More je prirodno utočište</b> — bez društvenih očekivanja, bez jezika. Kad je u zatvoru, pamti more. <em>More predstavlja iskonsku slobodu pred-društvenog stanja.</em> Suprotstavlja se sudnici, ćeliji, govoru.</div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip pa">JEZIK</span>
        <div class="sc-name">Jezik — laž društva</div>
        <div class="sc-desc">Meursault <b>ne laže</b>. Ne kaže ono što se očekuje. Kad ga pitaju je li tugovao za majkom — kaže: „<em>nisam htio reći da nisam, ali mi se činilo da nisam imao razloga.</em>" Suđenje pretvara njegovu jezičnu iskrenost u <b>moralni zločin</b>. <em>Jezik konvencije = laž; Meursaultov jezik = istina koja ne spasava</em>.</div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip br">GILJOTINA</span>
        <div class="sc-name">Giljotina — društvena osveta</div>
        <div class="sc-desc">Camus je cijeli život bio protivnik smrtne kazne (esej <em>Razmišljanja o giljotini</em>, 1957.). Giljotina u Strancu nije pravda — <b>ona je obred očinjenja društva</b>. Tužitelj traži najteži kazneni postupak ne za zločin, nego za Meursaultov <em>način postojanja</em>. <b>Giljotina je posljednja maska koja se stavlja na apsurd.</b></div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip go">MAJKA</span>
        <div class="sc-name">Majka — smrt + tabu</div>
        <div class="sc-desc">Majka umire <em>na samom početku</em>. Roman počinje: „<em>Danas mi je umrla majka. Možda i jučer, ne znam.</em>" <b>Tabu majke</b> — društvo očekuje plač, ritual, pijetet. Meursault ne pruža ništa. <em>To je njegov prvi „grijeh" pred društvom</em>. Suđenje će se vratiti na to ponovno i ponovno. <b>Sahrana majke = pravi razlog osude.</b></div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip t">ZVIJEZDE</span>
        <div class="sc-name">„Nježna ravnodušnost svijeta"</div>
        <div class="sc-desc">U <b>posljednjem poglavlju</b>, nakon sukoba sa svećenikom, Meursault gleda zvijezde kroz prozor ćelije. <em>„Pred tom noći punom znakova i zvijezda, otvarao sam se prvi put nježnoj ravnodušnosti svijeta."</em> <b>Trenutak prosvjetljenja apsurda</b>. Svijet ne brine — i to je oslobađajuće. Meursault <em>prihvaća apsurd</em>. To je njegova pobuna.</div>
      </div>
    </div>
    ...
    <div class="scenes">
      ...
      <details class="scene">
        ...
        <div class="scene-body">
          ...
          <div class="scene-why"><b>Zašto važno:</b> Sutradan nakon sahrane Meursault plivа s Marie. Ide u kino na komediju s Fernandelom. Vode ljubav. <em>Ono što društvo zove „neukus" Meursault zove „život"</em>. <b>Iskrenost koja vrijeđa.</b></div>
        </div>
      </details>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div class="sc-grid">
      <div class="sc">
        ...
        <div class="sc-name">Apsurd kao filozofska pozicija</div>
        <div class="sc-desc">Stranac je <em>literarni izraz Camusove filozofije apsurda</em>. Apsurd je <b>razilazak između čovjekove potrebe za smislom i šutnje svijeta</b>. Meursault je prvi „apsurdni junak" — onaj koji <em>vidi besmisao i ne pretvara se</em>. Roman radi paralelno s <em>Mitom o Sizifu</em> (isti ciklus, 1942.). <em>Citati:</em> „Nježna ravnodušnost svijeta", „Otvarao sam se prvi put…".</div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip go">TEZA 2</span>
        <div class="sc-name">Meursault — lik koji ne laže</div>
        <div class="sc-desc">Meursault <b>odbija društvene konvencije jezika i ponašanja</b>. Ne kaže ono što se očekuje, čak ni radi svog spasa. Kad tužitelj pita zašto nije plakao — odgovara istinito. <b>Iskrenost kao moralni zločin</b>. Društvo kažnjava ne zločin, nego <em>tuđost</em>. Paralela s Dostojevskim (H07) — i kod Raskoljnikova iskrenost je put do iskupljenja, ali u obratnom smjeru.</div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip t">TEZA 3</span>
        <div class="sc-name">Sunce kao aktivan akter</div>
        <div class="sc-desc">Priroda u Strancu <b>nije pozadina, ona djeluje</b>. Žarko alžirsko sunce pritišće, otežava misao, odlučuje. Meursault ubija Arapina „zbog sunca". <em>Mediteranska estetika</em> — Camus se svjesno odvaja od pariškog egzistencijalizma i vraća antičkoj grčkoj misli gdje je priroda <b>ethopoetska</b> (stvara karakter). <em>Priroda kao zamjena za Boga.</em></div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip re">TEZA 4</span>
        <div class="sc-name">Kritika pravosuđa i društvenog licemjerja</div>
        <div class="sc-desc">Suđenje u II. dijelu je <em>klasičan primjer kako pravda postaje predstava</em>. Sude mu <b>ne za ubojstvo — nego za to kako se ponašao na majčinu pogrebu</b>. Tužitelj gradi sliku „čudovišta bez duše" iz Meursaultove hladnoće. <em>Camusov anti-totalitarian impuls</em> — svako društvo koje kažnjava tuđost kreće na klizavu liniju prema totalitarizmu. <b>Pravni sustav = teatar morala.</b></div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip pa">TEZA 5</span>
        <div class="sc-name">„Bijela proza" kao filozofski izraz</div>
        <div class="sc-desc">Camus razvija <b>écriture blanche</b> — kratke rečenice, konkretni glagoli, minimum metafora, prvo lice u prošlom nesvršenom. <em>Stil prati sadržaj</em>: Meursaultov jezik je doživljajan, bilježeći, bez hijerarhije važnosti. <b>Tek u finalu stil eksplodira</b> — duge retoričke periode. <em>Stilska promjena = filozofska promjena.</em> Posljedica za čitatelja: <b>mora sam „osjećati" ono što pripovjedač ne pruža</b>.</div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip br">TEZA 6</span>
        <div class="sc-name">Dva dijela — prije i poslije pucnja</div>
        <div class="sc-desc">Kompozicijski rez je eksplicitan: <b>I. dio</b> (6 poglavlja) prati Meursaulta u životu — <em>doživljajno, opisno</em>. <b>II. dio</b> (5 poglavlja) prati suđenje i čekanje smrti — <em>refleksivno, dijaloški</em>. Granica: <b>4 pucnja na plaži</b>. Drugi pucnji nose filozofsku težinu — Meursault prelazi iz čovjeka-doživljavatelja u čovjeka-optuženika. <em>„Četiri kratka kucanja na vrata nesreće."</em></div>
      </div>

      <div class="sc">
        <span class="sc-ico hchip go">TEZA 7</span>
        <div class="sc-name">Pobuna kao oslobođenje</div>
        <div class="sc-desc">Meursault <b>pronalazi slobodu tek kad se suočava sa smrću</b>. Sukob sa svećenikom u posljednjem poglavlju je prva i jedina prava emocionalna scena. <em>„Otvarao sam se prvi put nježnoj ravnodušnosti svijeta."</em> Apsurd postaje <b>prihvaćen, ne poražavajući</b>. „Krikovi mržnje" na pogubljenju — paradoksalno željeni — potvrda su da je živio iskreno. <em>Ovo je Camusova odgovor Kafki</em>: apsurd se ne podnosi pasivno, nego se transformira u pobunu.</div>
      </div>
    </div>
    ...
    <div class="tbl">
      ...
      <div class="cr"><div class="ck go">ALITERACIJA / ZVUČNE FIGURE</div><div class="cv">Camus gradi ritam suglasnicima. „<em>Ce soleil sur ma tête</em>" — <b>s/s/s</b> kao šištanje sunca. U hrvatskom prijevodu nešto od toga nestaje.</div></div>
...
<div class="cit-grid">
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    ...
    <div class="pojm-grid" id="pojm-grid">
      ...
      <div class="pojm" data-cat="egzist" data-kw="kierkegaard preteča vjera angst"><span class="pojm-cat">egzist</span><div class="pojm-word">Søren Kierkegaard (1813.–1855.)</div><div class="pojm-def">Danski teolog, filozof. <b>Otac modernog egzistencijalizma</b>. „<em>Tjeskoba (Angst) je vrtoglavica slobode</em>." <em>Vjerski skok</em> — vjera nije logična, ona je strastveni izbor. Utjecao na sve egzistencijaliste. <b>Camus s njim raspravlja u Mitu o Sizifu</b>.</div></div>
...
@media (max-width: 720px) {
  ...
  .mt-tier-badge-cta {
    ...
    <div class="pro-gate" data-feature="checkpoint-tracking">
      ...
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Znam ključne likove — <b>Meursault, Marie Cardona, Raymond Sintès, Salamano, Tužitelj, Svećenik, pokojna Majka, bezimeni Arapin</b></div><span class="cp-hint">Likovi</span></div>
    ...
    <div class="cp-final" id="cp-final">
      ...
      <div class="cp-actions">
        <button class="fcb primary" onclick="openChapterModal('h10','Sofoklo — Antigona','Svjetska · grčka tragedija, obvezatno 2026','Sofoklo — Antigona (oko 442. pr. Kr.). Antigona protiv Kreonta, sahrana Polinika, pravo nebesa protiv države, Hemon, Tireziaz, katarza. Klasična grčka tragedija — obvezatno čitanje NCVVO 2026.')">H10 · Sofoklo Antigona →</button>
      ...
      <div class="pdf-export">
        ...
        <div class="pdf-export-body">
          ...
          <div class="pdf-export-txt">Sve što si prošao — Teorija, Stranac, Esej alat, Citatnik, Pojmovnik, Drill, Kviz — u jednom dokumentu. <strong>Idealno za ponavljanje pred ispit</strong> ili ispis na papir.</div>
...
var FC_CARDS=[
  ...
  {cat:'LIK',term:'Raymond Sintès',def:'Susjed, nasilnik prema mauretanskoj djevojci. Meursault mu pomaže napisati pismo (iz ravnodušnosti, ne prijateljstva). Sukob s Arapima (bratom djevojke) na plaži — direktan povod ubojstva. Simbol slučajnosti i apsurdnog lanca uzroka.'},
...
var MG_PAIRS=[
  ...
  {l:'Raymond Sintès',d:'susjed-nasilnik, Meursault mu pomaže napisati pismo'},
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrvatski/h09';
...
.b20-list{list-style:none;display:flex;flex-direction:column;gap:10px;margin:16px 0 20px;padding:0;counter-reset:b20}
...
@media print{
  ...
  *, *::before, *::after{
  ...
  body::before{
    content:"Maturiraj.hr · H09 Egzistencijalizam + Camus Stranac · 8 tabova · Svrha: priprema za državnu maturu iz Hrvatskog jezika 2025/2026";
    display:block;
...
@media print{
  ...
  body.print-cheat-only::before{
    content:"Maturiraj.hr · H09 · Egzistencijalizam + Camus Stranac — pred-ispit ponavljanje";
...
/* ══ SC-GRID — grid wrapper za .sc kartice ══ */
.sc-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px;margin:16px 0 22px}
@media(max-width:600px){.sc-grid{grid-template-columns:1fr;gap:10px}}
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H09] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H09`);
