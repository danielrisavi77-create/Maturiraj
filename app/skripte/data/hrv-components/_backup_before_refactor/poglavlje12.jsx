...
export const metadata = {
  code: 'H12',
  title: 'Maturiraj.hr — Hrvatski H12 · Marulić i Judita · Hrvatska renesansa',
  description: 'Interaktivna skripta za maturu — Marko Marulić i Judita: dubinska analiza, 6 pjevanja, dvanaesterac, alegorija, humanizam. 8 interaktivnih tabova, kviz, flashcards, esej alat.',
  canonical: 'https://maturiraj.hr/hrvatski/h12',
  ogImage: '',
};
...
<div class="content-wrap">
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div class="discere-banner" onclick="window.location.href='#discere'">
    ...
    <div class="sc-grid">
      ...
      <div class="sc">
        <span class="sc-ico hchip r">ŽAN.</span>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    <div class="tags">
      ...
      <span class="pill p-te">Usporedbe</span>
...
<div class="pojm-filters" id="cit-filters">
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-go">69 pojmova</span>
    ...
    <div class="fc-wrap" id="fc-wrap2" style="display:none;flex-direction:column;align-items:center;gap:16px;margin:16px 0">
      <div class="fc-counter" id="fc-counter2">1 / 69</div>
    ...
    <div id="grid-wrap2">
      <div class="pojm-filters">
        <button class="pojm-filter on" data-cat="all" onclick="pojmFilter2('all',this)">Sve</button>
        <button class="pojm-filter" data-cat="stih" onclick="pojmFilter2('stih',this)">Stih/forma</button>
        <button class="pojm-filter" data-cat="ep" onclick="pojmFilter2('ep',this)">Epika</button>
        <button class="pojm-filter" data-cat="stil" onclick="pojmFilter2('stil',this)">Stilska sredstva</button>
        <button class="pojm-filter" data-cat="hum" onclick="pojmFilter2('hum',this)">Humanizam</button>
        <button class="pojm-filter" data-cat="aleg" onclick="pojmFilter2('aleg',this)">Alegorija</button>
        <button class="pojm-filter" data-cat="kontekst" onclick="pojmFilter2('kontekst',this)">Kontekst</button>
      </div>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <div class="fc-cat-label">H12 · JUDITA I MARULIĆ — Pojmovnik</div>
    <div class="fc-wrap">
      <div class="fc-inner" id="fc-card-dyn" onclick="fcFlip()">
        <div class="fc-front">
          <div class="fc-label">POJAM · klikni za definiciju</div>
          <div class="fc-term">Dvanaesterac</div>
          <div class="fc-cat">stih · klikni za definiciju</div>
        </div>
        <div class="fc-back">
          <div class="fc-label">DEFINICIJA</div>
          <div class="fc-def">Stih od 12 slogova s obvezatnom cezurom iza 6. sloga (6+6). Osnovna metarska forma Judite.</div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div class="cp-final" id="cp-final">
      ...
      <div class="cp-final-msg">Izvrsno! Savladao/la si Marulića i Juditu — alegoriju, dvanaesterac, 6 pjevanja i kontekstualne argumente za esej.<br>Sljedeće: <strong>H13 · Barok · Ivan Gundulić i Osman</strong>.</div>
      <a href="Maturiraj_Hrvatski_H13.html?from=H12" class="reveal-lock-btn" style="text-decoration:none;display:inline-flex;align-items:center;gap:8px">→ H13 Barok · Gundulić</a>
      <br><br>
      <button class="nb-btn" onclick="cpReset()">↩ Resetiraj</button>
    </div>

    <!-- Writing practice widget -->
    <div class="sec-hdr" style="margin-top:28px"><div class="sec-line"></div><div class="sec-badge">Vježba pisanja — rečenica o Juditi</div><div class="sec-line"></div></div>

    <div class="box-int">
      <div class="box-int-lbl">✍ Napiši jednu rečenicu o Juditi koja bi mogla ući u esej</div>
    ...
    <div class="wc-wrap">
      ...
      <div class="wc-body">
        <textarea id="cp-writer" class="wc-ta" style="min-height:100px" placeholder="Npr: Marulić u Juditi (1501.) gradi ep u dvanaestercu koji — kombinacijom biblijske fabule i domoljubne alegorije — postaje prvi veliki politički manifest hrv. književnosti..." rows="4" oninput="cpWriterUpdate()"></textarea>
    ...
    <div class="box-signal" style="margin-top:24px">
      <div class="box-signal-lbl">📎 Poveznice između tabova H12</div>
      <div class="box-signal-txt">
        <b>Teorija (0)</b> → kontekst i pojmovi → <b>6 pjevanja (1)</b> → detaljna analiza → <b>Esej alat (2)</b> → primjena u eseju → <b>Citatnik (3)</b> → gotovi citati → <b>Pojmovnik (4)</b> → precizni pojmovi → <b>Kviz (6)</b> → provjera → <b>Checkpoint (7)</b> → potvrda. <strong>Za ispit: počni s Kvizom (brza dijagnoza), zatim nadopuni slabe točke.</strong>
      </div>
    </div>
  </div>
...
const CP_ITEMS=[
  'Znam godinu nastanka i tiskanja Judite (1501. / 1521.) i mogu objasniti razliku.',
  'Mogu opisati dvanaesterac: 12 slogova, cezura iza 6., dvostruka rima — uz primjer stiha.',
  'Znam alegorijsku shemu: Judita = Hrvatska/vjera, Holofern = Turci, Betulija = hrv. gradovi.',
  'Mogu nabrojati 6 pjevanja Judite i za svako reći ključni sadržaj i dramsku funkciju.',
  'Razumijem termin "kršćanski humanist" i znam primijeniti ga na Marulića.',
  'Znam što je "in medias res" i mogu pokazati gdje ga Marulić koristi u Juditi.',
  'Mogu objasniti vezu između Krbavske bitke (1493.) i nastanka Judite (1501.).',
  'Znam razliku između Judite (renesansa, dvanaesterac) i Osmana (barok, osmerac).',
  'Mogu napisati rečenicu koja objašnjava zašto je Judita korisna u eseju o Petrarci.',
  'Razumijem zašto Judita nije ispitno djelo 2026., ali znam je koristiti kao kontekst.',
];
...
═══════════════════════════════════ */
let CP_STATE={done:{}};
try{const s=localStorage.getItem('mt.hrv.h12.cp');if(s)CP_STATE=JSON.parse(s);}catch(e){}

const CP_HINTS=['Tab 0','Tab 0','Tab 1','Tab 1','Tab 0','Tab 0','Tab 0','Tab 0','Tab 2','Tab 0'];
function cpRender(){
...
function cpUpdateProgress(){
  ...
  if(sumBox&&done>0){
    ...
    else if(pct>=40)msg='<strong>Napredak!</strong> Nastavak: provjeri 6 pjevanja i Esej alat za neoznačene stavke.';
...
═══════════════════════════════════ */
let TAB_DONE={};
try{TAB_DONE=JSON.parse(localStorage.getItem('mt.hrv.h12.tab_done')||'{}')}catch(e){}

function markTab(n){
  TAB_DONE[n]=true;
  try{localStorage.setItem('mt.hrv.h12.tab_done',JSON.stringify(TAB_DONE))}catch(e){}
...
const MATCH_DATA={
  easy:[
    {a:'Judita',b:'Hrvatska / vjera'},
    {a:'Holofern',b:'Turci / bezbožništvo'},
    {a:'Betulija',b:'Hrv. gradovi'},
    {a:'Dvanaesterac',b:'Stih 6+6'},
  ],
  medium:[
    {a:'Judita',b:'Hrvatska / vjera'},
    {a:'Holofern',b:'Turci / bezbožništvo'},
    {a:'Betulija',b:'Hrv. gradovi'},
    {a:'Dvanaesterac',b:'Stih 6+6'},
    {a:'In medias res',b:'Početi usred radnje'},
    {a:'Invokacija',b:'Uvodni zaziv epa'},
  ],
  hard:[
    {a:'Judita',b:'Hrvatska / vjera'},
    {a:'Holofern',b:'Turci / bezbožništvo'},
    ...
    {a:'In medias res',b:'Početi usred radnje'},
    {a:'Invokacija',b:'Uvodni zaziv epa'},
    {a:'Ekfraza',b:'Detaljan opis tijela'},
    {a:'Hybris',b:'Oholost → propast'},
  ],
};
...
function mgInit(level){
  ...
  if(!el)return;
  el.innerHTML=\`
    <div class="mg-status" id="mg-status">\${mgPairs.length} parova · \${mgLevel==='easy'?'Lagano':mgLevel==='medium'?'Srednje':'Teško'}</div>
    <div class="mg-grid">
      <div class="mg-col" id="mg-left">
        \${mgPairs.map(p=>\`<div class="mg-item" data-id="\${p.id}" data-side="left" onclick="mgClick(this)">\${p.a}</div>\`).join('')}
      </div>
    ...
    <div style="text-align:center;margin-top:10px">
      <button class="fcb" onclick="mgInit('easy')" style="margin:3px">Lagano (4)</button>
      <button class="fcb" onclick="mgInit('medium')" style="margin:3px">Srednje (6)</button>
      <button class="fcb" onclick="mgInit('hard')" style="margin:3px">Teško (8)</button>
    </div>
  \`;
}
...
═══════════════════════════════════ */
const FC_DATA=[
  {t:'Dvanaesterac',d:'Stih od 12 slogova, cezura iza 6. sloga (6+6). Osnovna metarska forma Judite.',kat:'stih'},
  {t:'In medias res',d:'Epska tehnika — početi usred radnje. Judita počinje s Holofernivim pohodom.',kat:'ep'},
  {t:'Alegorija',d:'Dvojno značenje: Judita = Hrvatska, Holofern = Turci, Betulija = hrv. gradovi.',kat:'aleg'},
  {t:'Invokacija',d:'Uvodni zaziv čitatelja/Boga na početku epa. „Ki hoće slišati čudesa Božja starim..."',kat:'ep'},
  {t:'Ekfraza',d:'Detaljan opis tijela ili predmeta. U Juditi: opis Juditine ljepote (III. pjev.).',kat:'stil'},
  {t:'Hybris',d:'Gr. oholost koja vodi u propast. Holofernova oholost = uzrok njegova pada.',kat:'aleg'},
  {t:'Kršćanski humanist',d:'Spoj humanizma i kršćanske vjere. Čovjek je velik, ali samo uz Boga. = Marulić.',kat:'hum'},
  {t:'Antemurale Christianitatis',d:'Predziđe kršćanstva. Hrv. naziv za granicu prema osmanskom prodoru.',kat:'hum'},
  {t:'Dvostih (distih)',d:'Strofa od dva stiha koja se rimuju (AA). Osnovna strofa Judite.',kat:'stih'},
  {t:'Peripetija',d:'Dramatski preokret. Judita s Holofernivom glavom = totalna promjena situacije.',kat:'ep'},
  {t:'Psihologizacija',d:'Prikazivanje unutarnjeg života lika. Juditina molitva = humanistička inovacija.',kat:'hum'},
  {t:'Antiturski apel',d:'Direktni poziv Hrvat. čitatelju na otpor osmanskom osvajanju. U VI. pjev.',kat:'hum'},
  {t:'Biblijski predložak',d:'Marulić preuzima fabulu iz Knjige o Juditi (Stari zavjet, Vulgata).',kat:'ep'},
  {t:'Cezura',d:'Obvezatna pauza unutar stiha. U dvanaestercu iza 6. sloga: | .',kat:'stih'},
  {t:'Pjevanje',d:'Strukturna jedinica epa. Judita ima 6 pjevanja.',kat:'ep'},
  {t:'Simbol',d:'Predmet/lik s prenesenim značenjem. Holofernova glava = simbol poraza oholosti.',kat:'aleg'},
  {t:'Digresija',d:'Odmicanje od glavne radnje radi opisa ili moralne pouke. Epska tehnika.',kat:'ep'},
  {t:'Katalog (vojske)',d:'Nabrajanje junaka, naroda ili brodova. Epska konvencija od Homera.',kat:'ep'},
  {t:'Petrarkizam',d:'Ljubavno-lirski pokret po uzoru na Petrarcu. Marulić ga SVJESNO odbija.',kat:'hum'},
  {t:'Krbavska bitka',d:'1493. — poraz hrv. vojske pred Turcima. Neposredni povod nastanka Judite.',kat:'hum'},
];
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H12] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H12`);
