...
export const metadata = {
  code: 'H26',
  title: 'H26 · Interpunkcija | Maturiraj.hr · zarez · crtica · navodnici',
  description: 'H26 Interpunkcija — zarez (8 pravila), crtica vs spojnica, hrvatski navodnici „...',
  canonical: 'https://maturiraj.hr/hrvatski/h26-interpunkcija',
  ogImage: 'https://maturiraj.hr/og/h26-interpunkcija.png',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" aria-current="page" data-code="h26" href="/skripte/hrv/h26"><span class="sb-dot"></span>H26 · Interpunkcija</a>
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H26] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H26`);
