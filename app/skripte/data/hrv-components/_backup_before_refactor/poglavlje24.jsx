...
export const metadata = {
  code: 'H24',
  title: 'H24 — Hrvatska narječja | Maturiraj.hr',
  description: 'Hrvatska narječja — kajkavsko, čakavsko, štokavsko. Refleksi jat, dijalekti, izoglose, identifikacija narječja. Cjelovit vodič za maturu.',
  canonical: 'https://maturiraj.hr/hrvatski/h24-narjecja',
  ogImage: 'https://maturiraj.hr/og/h24-narjecja.png',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" aria-current="page" data-code="h24" href="/skripte/hrv/h24"><span class="sb-dot"></span>H24 · Hrv. narječja</a>
...
<div class="content-wrap">
  ...
  <header class="hero">
    ...
    <div class="hero-chips">
        ...
        <span class="pill p-br hchip">📊 Cheat-sheet</span>
    </div>
  </header>
...
<div class="map-wrap">
      <svg viewBox="0 0 600 400" xmlns="http://www.w3.org/2000/svg" class="hr-map" aria-label="Karta Hrvatske — narječja">
        <style>
        ...
        <path class="hr-region active" d="M180,90 L260,80 L340,95 L370,140 L350,180 L300,200 L240,195 L200,175 L180,140 Z"/>
        <text class="hr-label active" x="265" y="145">KAJKAVSKO</text>
        <text class="hr-label active" x="265" y="160" style="font-size:8px">Zagreb · Varaždin · Krapina</text>
        <path class="hr-region" d="M120,180 L180,175 L210,205 L200,245 L155,275 L100,290 L80,260 L100,210 Z"/>
        <text class="hr-label" x="140" y="225">ČAKAVSKO</text>
        
        <ellipse class="hr-region" cx="155" cy="305" rx="14" ry="6"/>
        <ellipse class="hr-region" cx="195" cy="320" rx="18" ry="6"/>
        <ellipse class="hr-region" cx="240" cy="335" rx="22" ry="7"/>
        <ellipse class="hr-region" cx="290" cy="355" rx="20" ry="6"/>
        <text class="hr-label" x="220" y="380" style="font-size:8px">otoci</text>
        <path class="hr-region" d="M340,95 L450,100 L520,130 L540,180 L500,260 L420,290 L350,280 L320,240 L300,200 L350,180 L370,140 Z"/>
        <text class="hr-label" x="430" y="200">ŠTOKAVSKO</text>
        <text class="hr-label" x="430" y="215" style="font-size:8px">Slavonija · Lika · Hercegovina</text>
        
        <path class="hr-coast" d="M50,320 Q150,310 250,340 Q350,360 450,310"/>
        <g transform="translate(540,330)">
          <circle cx="0" cy="0" r="20" fill="none" stroke="#5a4a3e" stroke-width="1"/>
          <text x="0" y="-8" font-family="serif" font-size="9" fill="#a89478" text-anchor="middle">N</text>
          <line x1="0" y1="-15" x2="0" y2="-5" stroke="#e9b446" stroke-width="1.5"/>
        </g>
      </svg>
...
<div class="map-wrap">
      <svg viewBox="0 0 600 400" xmlns="http://www.w3.org/2000/svg" class="hr-map" aria-label="Karta Hrvatske — narječja">
        ...
        <rect x="0" y="0" width="600" height="400" fill="#0a0d12"/>
        <path class="hr-region" d="M180,90 L260,80 L340,95 L370,140 L350,180 L300,200 L240,195 L200,175 L180,140 Z"/>
        <text class="hr-label" x="265" y="145">KAJKAVSKO</text>
        
        <path class="hr-region active-cak" d="M120,180 L180,175 L210,205 L200,245 L155,275 L100,290 L80,260 L100,210 Z"/>
        <text class="hr-label active-cak" x="140" y="225">ČAKAVSKO</text>
        <text class="hr-label active-cak" x="140" y="240" style="font-size:8px">Istra · Primorje · Dalmacija</text>
        <ellipse class="hr-region active-cak" cx="155" cy="305" rx="14" ry="6"/>
        <text class="hr-label active-cak" x="155" y="308" style="font-size:7px">KRK</text>
        <ellipse class="hr-region active-cak" cx="195" cy="320" rx="18" ry="6"/>
        <text class="hr-label active-cak" x="195" y="323" style="font-size:7px">RAB</text>
        <ellipse class="hr-region active-cak" cx="240" cy="335" rx="22" ry="7"/>
        <text class="hr-label active-cak" x="240" y="339" style="font-size:7px">BRAČ</text>
        <ellipse class="hr-region active-cak" cx="290" cy="355" rx="20" ry="6"/>
        <text class="hr-label active-cak" x="290" y="359" style="font-size:7px">HVAR</text>
        <path class="hr-region" d="M340,95 L450,100 L520,130 L540,180 L500,260 L420,290 L350,280 L320,240 L300,200 L350,180 L370,140 Z"/>
        <text class="hr-label" x="430" y="200">ŠTOKAVSKO</text>
        <text class="hr-label" x="430" y="215" style="font-size:8px">Slavonija · Lika · Hercegovina</text>
...
.cheat-col-wide{grid-column:1/-1}
        ...
        <ellipse class="hr-region" cx="290" cy="355" rx="20" ry="6"/>
        <text class="hr-label" x="220" y="380" style="font-size:8px">otoci</text>
        <path class="hr-region active-stk" d="M340,95 L450,100 L520,130 L540,180 L500,260 L420,290 L350,280 L320,240 L300,200 L350,180 L370,140 Z"/>
        <text class="hr-label active-stk" x="430" y="195">ŠTOKAVSKO ⭐</text>
        <text class="hr-label active-stk" x="430" y="210" style="font-size:8px">Slavonija · Lika · Hercegovina</text>
        <text class="hr-label active-stk" x="430" y="225" style="font-size:8px">STANDARD HRV. JEZIKA</text>
        <path class="hr-coast" d="M50,320 Q150,310 250,340 Q350,360 450,310"/>
        <g transform="translate(540,330)">
          <circle cx="0" cy="0" r="20" fill="none" stroke="#5a4a3e" stroke-width="1"/>
          <text x="0" y="-8" font-family="serif" font-size="9" fill="#a89478" text-anchor="middle">N</text>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-pa hchip">📋 Cheat-sheet</span>
...
function qzEnd(el){
  ...
  el.innerHTML=\`<div class="qz-result" style="text-align:center;padding:40px 24px;background:var(--card);border:1px solid var(--bdm);border-radius:var(--r4)">
    ...
    <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
      ...
      <button class="nb-btn" onclick="sw(4)">📚 Pojmovnik</button>
      <button class="nb-btn" onclick="sw(7)">📋 Cheat-sheet</button>
    </div>
    \${wrongHtml}
  </div>\`;
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H24] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H24`);
