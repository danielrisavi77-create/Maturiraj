...
export const metadata = {
  ...
  description: 'Interaktivna skripta za maturu — Ivan Gundulić i Dubravka: dubinska analiza, 3 činjenja, pastorala, alegorija Dubrovnika, hrv. barok. ispitno djelo 2026.',
  canonical: 'https://maturiraj.hr/hrvatski/h13',
  ogImage: '',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" data-code="h13" href="/skripte/hrv/h13"><span class="sb-dot"></span>H13 · Hrv. barok — Gundulić</a>
...
<div class="content-wrap">
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button class="tab" id="tab1" onclick="sw(1)" role="tab" aria-selected="false" aria-controls="l1">📖 3 činjenja<span class="tab-done" id="td1"></span></button>
...
.cheat-col-wide{grid-column:1/-1}
    ...
    <div class="author-card">
      <div class="ac-header">
        <div class="ac-monogram">IG</div>
        <div class="ac-meta">
          <div class="ac-name">Ivan Gundulić</div>
          <div class="ac-dates">Dubrovnik · 1589. – 1638.</div>
          <div class="ac-tags" style="margin-top:6px">
            <span class="hchip br" style="font-size:8px">„najveći hrv. barokni pjesnik"</span>
            <span class="hchip go" style="font-size:8px">Dubrovačka aristokracija</span>
            <span class="hchip pa" style="font-size:8px">nadimak „Mačica"</span>
          </div>
        </div>
      </div>
      <div class="ac-body">
        <p>Rođen u Dubrovniku <strong>1589.</strong> u plemićkoj obitelji (otac Frano Gundulić, majka Dživa Gradić). Obrazovao se u Dubrovniku kod jezuita. <strong>1608.</strong> postaje član Velikog vijeća. Dva puta knez Konavala (1615., 1619.). Pravnik i političar. <strong>1628.</strong> oženio se Nikom Sorkočević — za vjenčanje piše <em>Dubravku</em>. Umro 1638. u 49. god., od upale porebrice.</p>
        <p>Dobio nadimak „<em>Mačica</em>" — živio povučeno i mirno. Kasnije proglašen <strong>kanonskim piscem starije hrv. književnosti</strong>. Svoja rana dramska i lirska djela označio je kao „<b>porod od tmine</b>" — 10 drama i pjesama od kojih je sačuvana samo Arijadna, Prozerpina ugrabljena i par fragmenata.</p>
        <div class="ac-works">
          <div class="ac-works-lbl">Ključna djela</div>
          <div class="ac-work-item">
            <div class="ac-badge">🎭</div>
            <div>
              <div class="ac-work-title">Dubravka</div>
              <div class="ac-work-meta">Izvedena 1628. · Pastorala · 3 činjenja · 28 skazanja · 1696 stihova</div>
              <div class="ac-work-desc">Alegorijska pastorala, napisana za Gundulićevu svadbu. Glavni likovi: pastir Miljenko i pastirica Dubravka, njih sprječava zli bogataš Grdan. <strong>Alegorija:</strong> Dubravka = sloboda Dubrovnika, Miljenko = plemstvo, Grdan = bogati pučani koji prijete vlasti. Pisana u dvostruko rim. dvanaestercima i osmercima. Završava himnom slobodi.</div>
            </div>
          </div>
          <div class="ac-work-item">
            <div class="ac-badge">📖</div>
            <div>
              <div class="ac-work-title">Osman</div>
              <div class="ac-work-meta">Nedovršen, 1621.–1638. · Viteško-junački ep · 20 pjevanja (bez 14. i 15.)</div>
              <div class="ac-work-desc">Najveći hrv. barokni ep, po uzoru na Tassov <em>Oslobođeni Jeruzalem</em>. Tema: bitka kod Hoćima (1621.) i pad sultana Osmana II. Ep o slavenskoj pobjedi nad Turcima — paralelno s Juditom (Marulić) i Smrti Smail-age (Mažuranić). <strong>14. i 15. pjevanje izgubljeni</strong> — dopunjeno kasnije (Mažuranić, Sorkočević).</div>
            </div>
          </div>
          <div class="ac-work-item">
            <div class="ac-badge">✝</div>
            <div>
              <div class="ac-work-title">Suze sina razmetnoga</div>
              <div class="ac-work-meta">1622., Venecija · Religiozna poema · 3 „plača" (sagrješenje, spoznanje, skrušenje)</div>
              <div class="ac-work-desc">Meditativna poema po biblijskoj paraboli o izgubljenom sinu (Luka 15). Barokni izraz: kontrast grijeha i milosti, prolaznosti i vječnosti. <em>Memento mori</em> spojen s kršćanskom pokorom. Poruka dubrovačkoj mladosti: tko troši, slabi Republiku.</div>
            </div>
          </div>
          <div class="ac-work-item">
            <div class="ac-badge">📜</div>
            <div>
              <div class="ac-work-title">„Porod od tmine" (rana djela)</div>
              <div class="ac-work-meta">~1610.–1620. · 10 drama + pjesme · Većina izgubljena</div>
              <div class="ac-work-desc">Sam ih Gundulić označava kao „porod od tmine" — sačuvane: Arijadna, Prozerpina ugrabljena, Ljubovnik sramežljiv, fragment Dijane i Armide. Pokazuju italijansku pastoralnu i mitološku tradiciju prije njegova zrelog doba.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="timeline">
      <div class="tl-event"><div class="tl-year">1570.</div><div class="tl-title">Lepanto — pobjeda kršćanske Europe</div><div class="tl-desc">Pomorska bitka, poraz Turaka. Inspiracija za antitursku književnost 17. st.</div></div>
      <div class="tl-event milestone"><div class="tl-year">1589.</div><div class="tl-title">Ivan Gundulić rođen</div><div class="tl-desc">U Dubrovniku, u plemićkoj obitelji. Obrazovan kod jezuita — baroki, katolički duh.</div></div>
      <div class="tl-event"><div class="tl-year">1608.</div><div class="tl-title">Gundulić član Velikog vijeća</div><div class="tl-desc">Ulazi u dubrovačku političku aristokraciju. Pravnički poslovi i državne službe.</div></div>
      <div class="tl-event"><div class="tl-year">1615./1619.</div><div class="tl-title">Knez Konavala</div><div class="tl-desc">Dva puta obavlja funkciju kneza — visoka upravna služba Dubrovačke Republike.</div></div>
      <div class="tl-event milestone"><div class="tl-year">1621.</div><div class="tl-title">Bitka kod Hoćima · pad sultana Osmana II.</div><div class="tl-desc"><em>Poljaci pobjeđuju Turke.</em> Sultan Osman II. ubijen u pobuni janjičara. Inspiracija za Gundulićev ep Osman (piše ga do smrti).</div></div>
      <div class="tl-event"><div class="tl-year">1622.</div><div class="tl-title">Suze sina razmetnoga (Venecija)</div><div class="tl-desc">Religiozna poema, 3 „plača". Prvi zreli rad — spoj katoličke duhovnosti i baroknog stila.</div></div>
      <div class="tl-event milestone"><div class="tl-year">1628.</div><div class="tl-title">★ DUBRAVKA izvedena</div><div class="tl-desc"><em>Na Gundulićevu svadbu s Nikom Sorkočević.</em> Prva izvedba „pred Dvorom" u Dubrovniku. Od tada svake godine na dan sv. Vlaha (3.2.).</div></div>
      <div class="tl-event"><div class="tl-year">1628.–1638.</div><div class="tl-title">Osman — rad na epu</div><div class="tl-desc">Nedovršen viteško-junački ep. 14. i 15. pjevanje izgubljeni. Glavno djelo hrv. baroka.</div></div>
      <div class="tl-event"><div class="tl-year">1638.</div><div class="tl-title">Gundulić umire</div><div class="tl-desc">U 49. godini, od upale porebrice. Osman ostaje nedovršen. Sinovi (Frano, Matija, Šiško) kasnije objavljuju djela.</div></div>
      <div class="tl-event"><div class="tl-year">1888.</div><div class="tl-title">Moderna izvedba Dubravke — HNK</div><div class="tl-desc">300. obljetnica Gundulićeva rođenja. Od tada stalna u nacionalnom repertoaru.</div></div>
    </div>
    ...
    <div class="cheat-card" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Tab 1 · Gundulić — Osman (3 činjenja)</div>
        </div>
      </div>
      <div class="cheat-grid">
        <div class="cheat-col cheat-col-wide" style="font-family:var(--serif,Fraunces,serif);font-size:13.5px;color:var(--t2,#c5b8aa);line-height:1.65">
          <p style="margin:0">Sad si savladao kontekst baroka — <b>Tab 1</b> donosi strukturalnu analizu <em>Osmana</em>. 3 činjenja, antiteze, barokne figure i ključni citati.</p>
        </div>
      </div>
    </div>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    <div class="tags">
      ...
      <span class="pill p-te">Struktura eseja</span>
...
<div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">★ Napamet — 8 glavnih citata iz Dubravke</div><div class="sec-line"></div></div>
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    ...
    <div id="grid-wrap2">
      <div class="pojm-filters">
        ...
        <button class="pojm-filter" data-cat="drama" onclick="pojmFilter2('drama',this)">Drama/pastorala</button>
        <button class="pojm-filter" data-cat="stil" onclick="pojmFilter2('stil',this)">Stilska sredstva</button>
        <button class="pojm-filter" data-cat="aleg" onclick="pojmFilter2('aleg',this)">Alegorija/likovi</button>
        <button class="pojm-filter" data-cat="barok" onclick="pojmFilter2('barok',this)">Barok/kontekst</button>
        <button class="pojm-filter" data-cat="djelo" onclick="pojmFilter2('djelo',this)">Djelo/struktura</button>
      </div>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <div class="fc-cat-label">H13 · DUBRAVKA I GUNDULIĆ — Pojmovnik</div>
    <div class="fc-wrap">
      <div class="fc-inner" id="fc-card-dyn" onclick="fcFlip()">
        <div class="fc-front">
          <div class="fc-label">POJAM · klikni za definiciju</div>
          <div class="fc-term">Pastorala</div>
          <div class="fc-cat">drama · klikni za definiciju</div>
        </div>
        <div class="fc-back">
          <div class="fc-label">DEFINICIJA</div>
          <div class="fc-def">Dramski oblik o idiličnom životu pastira u prirodi. Europska tradicija iz 16. st. (Italija). Dubravka je primjer alegorijske pastorale.</div>
          <div class="fc-cat">drama</div>
        </div>
      </div>
    </div>
    <div class="fc-nav">
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H13] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H13`);
