...
export const metadata = {
  code: 'H11',
  title: 'Maturiraj.hr — Hrvatski H11 · Stari hrv. pisci · Renesansa',
  description: 'Interaktivna skripta za maturu — Stari hrvatski pisci: Marulić (Judita), Hektorović (Ribanje), Zoranić (Planine), petrarkisti, Marin Držić (Novela od Stanca,...',
  canonical: 'https://maturiraj.hr/hrvatski/h11',
  ogImage: '',
};
...
<button class="sb-hamburger" id="hamburger" onclick="openSb()" aria-label="Otvori izbornik">
  <span></span><span></span><span></span>
</button>

<div class="shell">
  <!-- SIDEBAR -->
  <nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija skripta">
    <div class="sb-brand">
      <div class="sb-logo"><svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2L3 7v10l9 5 9-5V7L12 2z" stroke="#E8C97A" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 2v20M3 7l9 5 9-5" stroke="#E8C97A" stroke-width="1.5"/></svg></div>
      <div>
        <div class="sb-name">Maturiraj.hr</div>
        <div class="sb-sub">Hrvatski · Skripte</div>
      </div>
    </div>
    <div class="sb-prog-wrap">
      <div class="sb-prog-label"><span>Napredak H11</span><span id="sb-prog-pct">0%</span></div>
      <div class="sb-prog-track"><div class="sb-prog-bar" id="sb-prog-bar" style="width:0%"></div></div>
    </div>

    <div class="sb-era">Teorija književnosti</div>
    ...
    <div class="sb-era">Stari hrv. pisci</div>
    <a class="sb-item active" data-code="h11" href="/skripte/hrv/h11"><span class="sb-dot"></span>H11 · Stari hrv. pisci</a>
    ...
    <div class="sb-era">Obvezatna djela</div>
    <a class="sb-item sb-d" data-code="d11" data-star="2026" href="/skripte/hrv"><span class="sb-dot"></span>D11 · Držić · Novela od Stanca</a>
    <a class="sb-item sb-d" data-code="d12" href="/skripte/hrv"><span class="sb-dot"></span>D12 · Gundulić · Dubravka</a>
    ...
    <div class="sb-footer">
      <span id="sb-footer-pos">11 / 28</span> · <span id="sb-footer-title">stari hrv. pisci</span><br>
      © 2025 maturiraj.hr
    </div>
  </nav>
  ...
  <main class="main" id="main">
    <div class="content-wrap">
      ...
      <header class="hero">
        ...
        <div class="countdown" style="margin-bottom:12px">
          <span style="letter-spacing:.5px">📅 Do mature ostaje</span>
          <strong id="cd-days">?</strong>
          <span>dana</span>
          <strong id="cd-hrs">?</strong>
          <span>sati</span>
        </div>
      ...
      <div class="layer on" id="l0" role="tabpanel" tabindex="0">
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02b · Europski kontekst — što se događalo u Europi</div><div class="sec-line"></div></div>
        ...
        <div class="sc-grid">
          ...
          <div class="sc">
            ...
            <div class="sc-desc"><em>Novela od Stanca</em> — <strong>farsa/pokladna igra</strong> (1 čin, 7 prizora). <em>Dundo Maroje</em> — prvna hrv. prozna komedija (5 činova). <em>Skup</em> — plautovska komedija.</div>
          </div>
          <div class="sc">
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04b · Epika vs. drama — ključni kontrast</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">09b · Ključni kontrasti hrv. renesanse</div><div class="sec-line"></div></div>
        ...
        <div class="tbl">
          ...
          <div class="cr"><div class="ck pa" style="min-width:100px">Skup</div><div class="cv">Držić, <em>Skup</em></div><div class="cv">Stari škrtac — čuva blago, želi udati kćer za bogatog</div><div class="cv">Po Plautovom Euklion; kritika pohlepe kao drušv. vrijednosti</div></div>
        </div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">17 · H11 i ostalo gradivo — kako se spaja</div><div class="sec-line"></div></div>
        ...
        <!-- SEC 16 — Samoprocjena -->
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">16 · Samoprocjena — jesi li spreman/a?</div><div class="sec-line"></div></div>
    ...
    <div class="cheat-card" style="margin-top:24px">
      ...
      <div class="layer" id="l1" role="tabpanel" tabindex="0">
        ...
        <div class="soft-hint"><div class="soft-hint-ico">💡</div><div class="soft-hint-body">Judita je pisana u <b>dvanaestercima</b> (12-slogovni stih) i ima <b>6 pjevanja</b> — upravo ta formalana obilježja pitaju na ispitu. Alegorija: Betulija = Hrvatska, Holoferno = Turci.</div></div>
        ...
        <div class="sc-grid">
          <div class="sc">
            ...
            <div class="sc-desc"><strong>Udovica</strong> (kontekst: muž preminuo). Plemenita, lijepa, pobožna, hrabra. <em>Marulić ju oblikuje kao kršćanski ideal</em> — žena koja djeluje samo s Božjom pomoći. Njezina ljepota nije profanа, nego sredstvo Božjeg plana.</div>
          </div>
          <div class="sc">
        ...
        <div class="box-int">
          ...
          <div class="box-int-txt">
            Na površini, Ribanje je <em>trodnevna ribarska izlaska s prijateljem</em>. Ali Hektorović je humanist — svaki detalj nosi refleksiju. <strong>Tri filozofska sloja Ribanja:</strong>
          </div>
        </div>
        ...
        <div class="sc-grid">
          ...
          <div class="sc">
            ...
            <div class="sc-desc">Hektorović bilježi bugarštice jer zna da će se izgubiti — <b>pisanje kao čin spašavanja</b>. To je moderni kulturnopovijesni instikt u 16. st. tijelu humanista. Bez Ribanja, bugarštice o Marku Kraljeviću bile bi zauvijek izgubljene.</div>
          </div>
          <div class="sc">
            <span class="sc-ico hchip pa">SLOJ 4</span>
            <div class="sc-name">Krajoliz kao filozofski prostor</div>
        ...
        <div class="soft-hint"><div class="soft-hint-ico">💡</div><div class="soft-hint-body">Planine Petra Zoranića (1536.) — prvi hrv. roman i ujedno <b>žanrovski hibrid</b>: pastoralni roman + putopis + alegorija + lirika. Na ispitu pazi na <b>lik Zorana</b> i <b>Perivoj od Slave</b> kao alegoriju hrv. knjievnosti.</div></div>
        ...
        <div class="soft-hint"><div class="soft-hint-ico">💡</div><div class="soft-hint-body">Petrarkisti: <b>Menečtić i Džore Držić</b> su začetnici — pišu na štokavskom s toskanskim uzorima. Ključne figure: <b>oksimoron</b> (slatka bol), <b>antiteza</b>, <b>hiperbola</b>. Gospoja je nedostižna i idealizirana — nikad individua.</div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">★ Dundo Maroje · prvna hrv. prozna drama</div><div class="sec-line"></div></div>
        ...
        <div class="tbl">
          ...
          <div class="cr"><div class="ck pa">Plautovska komed.</div><div class="cv">Marin Držić</div><div class="cv"><em>Skup</em> (1556.)</div><div class="cv">Po Aululariji. Pohlepa kao drušv. vrijednost. Škrtac Skup vs. zaljubljenici.</div></div>
        </div>
        ...
        <div class="box-key">
          ...
          <div class="box-key-txt">
            <b>Marulić</b>: Judita (ep, 1501., alegorija, 6 pjev., 2126 dvanaest.) · Institucija (lat., prevede.) · Davidijada (lat. ep)<br>
            ...
            <b>Lucić</b>: Robinja (1530., prva hrv. drama s razrađenom radnjom) · Jur nijedna na svit vila (osmerci) · II. gen.<br>
            <b>Lucić</b>: Robinja (1530., prva hrv. drama s razrađenom radnjom, 3 čina, tema ropstva, moral: ljubav pobjeđuje pohlepu) · Jur nijedna na svit vila (osmesterci, neoplatonizam, II. gen.)<br>
      ...
      <div class="layer" id="l2" role="tabpanel" tabindex="0">
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">01c · Teze 7–9 za napredni esej</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02b · Model eseja za Zoranića i Hektorovića</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02c · Puni model eseja — Teza 2</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02d · Puni model eseja — Zoranić (ako dođe)</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02e · Model eseja — Hektorović i demokratizacija humanizma</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02f · Uvod za 3 tipa</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">03c · TIPS formula — razrada argumenta</div><div class="sec-line"></div></div>
        ...
        <div class="box-key">
          ...
          <div class="box-key-txt">
            <em>„Konačno, da bismo razumjeli Novelu od Stanca, moramo razumjeti što je <b>farsa kao žanr</b>. Farsa ne traži moralnu pouku — to je komedija situacije, ne karaktera. Stanec nije moralno loš čovjek koji zaslužuje kaznu; on je samo naivan u pogrešnom trenutku na pogrešnom mjestu. Mladići nisu moralno dobri ni loši — oni su tipovi koji iskorištavaju trenutak. <em>Držić ne sudi — prikazuje.</em> I upravo ta <b>moralna otvorenost</b> razlikuje Novelu od Stanca od Marulićeve Judite (eksplicitan kršćanski moral) i Zoranićevih Planina (patriotski apel). Držić je, od svih hrv. renesansnih pisaca, najsloboднiji od didaktike — i upravo zato najbliži modernom kazalištu."</em>
          </div>
        </div>
        ...
        <!-- SEC 04b — Česta esejska pitanja -->
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04b · H11 u eseju o drugom djelu</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04 · Checklist prije predaje</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04c · 3 tipa ispitnih pitanja</div><div class="sec-line"></div></div>

        <div class="box-int">
          <div class="box-int-lbl">📋 3 tipa pitanja koja se pojavljuju na maturi</div>
          <div class="box-int-txt">
        ...
        <div class="scenes">
          <details class="scene">
            <summary class="scene-sum">
              <div class="scene-num">TIP 1</div>
              <div class="scene-ttl">Analiza konkretnog ulomka — <em>čitanje s razumijevanjem</em></div>
              <div class="scene-meta">ULOMAK</div>
            </summary>
            <div class="scene-body">
              <div class="scene-quote">Dobiješ ulomak iz Novele od Stanca (ili Judite, ili Planina) i 5 pitanja višestrukoga izbora. Pitat će: tko govori, kojeg je prizora, što znači određena rečenica, koje stilsko sredstvo je upotrijebljeno, što lik osjeća.</div>
              <div class="scene-why"><b>Taktika:</b> (1) Identificiraj tko govori i u kom kontekstu. (2) Provjeri stilska sredstva: anafora, metafora, irony, dvanaesterac. (3) Poveži ulomak s cjelinom — kojeg je prizora, koja opreka je aktivna. (4) Nikad ne gubiš bod na višestrukome izboru ako pažljivo čitaš. <b>H11 = Novela od Stanca je obvezatno čitanje 2026.</b></div>
            </div>
          </details>

          <details class="scene">
            <summary class="scene-sum">
              <div class="scene-num">TIP 2</div>
              <div class="scene-ttl">Teorijsko pitanje — <em>definicija pojma ili žanra</em></div>
              <div class="scene-meta">TEORIJA</div>
            </summary>
            <div class="scene-body">
              <div class="scene-quote">Pitanje kao: „Što je petrarkizam?", „Definiraj bugaršticu", „Koji su žanrovi hrv. renesansne drame?", „Što je dvostruko rimovani dvanaesterac?". Kratki odgovori ili višestruki izbor.</div>
              <div class="scene-why"><b>Taktika:</b> (1) Definicija + primjer = potpun odgovor. (2) Nikad samo definicija bez primjera. (3) Primjer iz konkretnog hrv. teksta je bolji od apstraktnog opisa. Npr.: „Petrarkizam je ljubavna lirika po uzoru na Petrarcu — hrv. primjer: Menčetić (<em>Blažen čas i hip</em>), koji preuzima petrarkistički repertoar ali piše dvanaesterce umjesto soneta."</div>
            </div>
          </details>

          <details class="scene">
            <summary class="scene-sum">
              <div class="scene-num">TIP 3</div>
              <div class="scene-ttl">Kontekstualni esejski argument — <em>H11 unutar eseja o drugom djelu</em></div>
              <div class="scene-meta">ESEJ</div>
            </summary>
            <div class="scene-body">
              <div class="scene-quote">Pišeš esej o Petrarci, Calderónu, Goetheu ili Krleži — i hoćeš ubaciti H11 kao kontekstualni argument. Npr. u eseju o Petrarci možeš pokazati kako hrv. petrarkisti preuzimaju tematiku ali mijenjaju formu.</div>
              <div class="scene-why"><b>Taktika:</b> (1) Formula: „Za razliku od [autor s popisa], hrv. pisac [Menčetić/Marulić/Držić] [sličnost/razlika]." (2) Jedan do dva paragrafa konteksta je dovoljno — ne pišeš esej o Marulić, pišeš o Petrarci. (3) Interdisciplinarni kontekst = viša ocjena jer pokazuješ šire poznavanje.</div>
            </div>
          </details>
        </div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">08 · Usporedi — Marulić, Držić, Zoranić</div><div class="sec-line"></div></div>
        ...
        <!-- SEC 06 — Stilska sredstva u renesansnoj književnosti -->
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">09 · Stilska sredstva u hrv. renesansi</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">11 · Konektori i prijelazne rečenice</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">09b · Analiza stilskog sredstva</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">13 · Zašto je hrv. renesansa važna danas</div><div class="sec-line"></div></div>
        ...
        <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">10 · Piši esej ovdje</div><div class="sec-line"></div></div>

        <div class="wc-wrap">
          <div class="wc-header">
            <div class="wc-lbl">Esej — Novela od Stanca</div>
            <div class="wc-stats">
              <div class="wc-stat" id="wc-words"><span class="wc-stat-num">0</span><span class="wc-stat-lbl">Riječi</span></div>
              <div class="wc-stat" id="wc-chars"><span class="wc-stat-num">0</span><span class="wc-stat-lbl">Znakovi</span></div>
              <div class="wc-stat" id="wc-para"><span class="wc-stat-num">0</span><span class="wc-stat-lbl">Odlomci</span></div>
              <div class="wc-stat" id="wc-read"><span class="wc-stat-num">0 min</span><span class="wc-stat-lbl">Čit. vrij.</span></div>
            </div>
          </div>
          <div class="wc-body">
            <textarea id="wc-ta" class="wc-ta" placeholder="Ovdje piši esej o Noveli od Stanca. Tekst se automatski sprema. Cilj: 440+ riječi." oninput="wcUpdate()"></textarea>
            <div class="wc-prog" id="wc-prog">
              <div class="wc-prog-bar" id="wc-bar"></div>
            </div>
            <div class="wc-prog-lbl" id="wc-lbl">CILJ 440 · 0 / 440</div>
            <div class="wc-actions">
              <button class="wc-btn" onclick="wcCopy()">⎘ Kopiraj</button>
              <button class="wc-btn" onclick="wcClear()">✕ Obriši</button>
            </div>
          </div>
        </div>
      ...
      <div class="layer" id="l3" role="tabpanel" tabindex="0">
        <div class="tags">
          ...
          <span class="pill p-go">Hektorović</span>
          <span class="pill p-br">Držić</span>
          <span class="pill p-t">petrarkisti · Zoranić</span>
        </div>
    ...
    <div class="cit-search-row" style="margin:14px 0 16px;display:flex;gap:8px;align-items:center">
      ...
      <input type="search" id="cit-search" class="cit-search" placeholder="Pretraži citate (npr. Marulić, Držić, petrarkizam, renesansa)…" aria-label="Pretraži citate" autocomplete="off"
...
<div class="pojm-filters" id="cit-filters">
          <button class="pojm-filter on" onclick="citFilter('all',this)">Sve</button>
          <button class="pojm-filter" onclick="citFilter('marulić',this)">Marulić</button>
          <button class="pojm-filter" onclick="citFilter('judita',this)">Judita</button>
          <button class="pojm-filter" onclick="citFilter('držić',this)">Držić</button>
          <button class="pojm-filter" onclick="citFilter('novela',this)">Novela</button>
          <button class="pojm-filter" onclick="citFilter('petrark',this)">Petrarkisti</button>
          <button class="pojm-filter" onclick="citFilter('zoranić',this)">Zoranić</button>
          <button class="pojm-filter" onclick="citFilter('hektorović',this)">Hektorović</button>
          <button class="pojm-filter" onclick="citFilter('kontekst',this)">Kontekst</button>
        </div>

        <div class="box-key">
          <div class="box-key-lbl">🎯 Citati → Teze — Brza veza</div>
          <div class="box-key-txt">
            <b>Teza 1 (pokladni kontekst):</b> filtriraj <em>Novela</em> — kontekst poklada, legitimacija prevare.<br>
            <b>Teza 2 (mlado–staro):</b> filtriraj <em>Novela</em> — Stanac kao tip, mladost pobjeđuje lukavošću.<br>
            <b>Teza 3 (komentar društva):</b> filtriraj <em>Držić</em> — Dubrovnik kao kazalište stvarnosti.<br>
            <b>Teza 4 (alegorija u Juditi):</b> filtriraj <em>Judita</em> — Oloferno = Turci, Judita = Hrvatska.<br>
            <b>Teza 5 (rasuta bašćina):</b> filtriraj <em>Zoranić</em> — Planine, Perivoj od Slave.<br>
            <b>Teza 6 (realizam Hektorovića):</b> filtriraj <em>Hektorović</em> — stvarnost kao književni predmet.
          </div>
        </div>

        <div id="cit-grid" style="display:flex;flex-direction:column;gap:14px;margin:16px 0">
          ...
          <div class="featured-quote" data-cit-cat="marulić">
            ...
            <div class="fq-body">
              <div class="fq-text">Historiju tuj svedoh na versih, po običaju naših začinjavac i jošće po zakonu onih starih poet.</div>
              <div class="fq-meta">— Marko Marulić, <em>Judita</em> (posveta), 1501. · ★ Napamet · Marulić o tradiciji začinjavaca i antičkih pjesnika</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="judita">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Judita nije samo biblijska heroina — ona je alegorija hrvatskog naroda koji uz Božju pomoć može pobijediti i najvećeg neprijatelja.</div>
              <div class="fq-meta">— interpretacijska parafraza, Marko Marulić, <em>Judita</em> (1501./1521.) · ★ Napamet · alegorija kao temeljna tehnika Judite</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="judita">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">2126 dvostruko rimovanih dvanaesteraca — Marulić u Juditi spaja začinjavačku rimu, antičku epsku formu i biblijsku tematiku u jedinstveni hrv. humanistički sintez.</div>
              <div class="fq-meta">— sintetska tvrdnja · forma Judite kao dokaz humanizma · za argument o Marulićevom stilu</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="judita">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Holofernova slabost — žudnja — postaje oruđem Božje pravednosti; Judita koristi ljepotu ne za pohotnost, nego za spasenje naroda.</div>
              <div class="fq-meta">— interpretacija lika, Marko Marulić, <em>Judita</em> · za argument o Holofernovu liku i alegoriji moći</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>

          <div class="featured-quote" data-cit-cat="novela">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Bez poklada nema Novele od Stanca — karnevalske slobode su dramski uvjet koji prevaru čini mogućom, legitimnom i komičnom.</div>
              <div class="fq-meta">— sintetska tvrdnja · Marin Držić, <em>Novela od Stanca</em> (1550.) · ★ Napamet · Teza 1 — pokladni kontekst</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="novela">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Stanac gubi jer je star i naivan — mladost u Noveli od Stanca pobjeđuje ne snagom, nego lukavošću i poznavanjem gradskog koda.</div>
              <div class="fq-meta">— interpretacija lika · Marin Držić, <em>Novela od Stanca</em> (1550.) · ★ Napamet · Teza 2 — mlado vs. staro</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="novela">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Farsa ne pita za moral — pita za smijeh. Držić ne sudi tko je u pravu; prikazuje što se događa kad naivnost sretne lukavost u pokladnoj noći Dubrovnika.</div>
              <div class="fq-meta">— sintetska tvrdnja · Marin Držić, <em>Novela od Stanca</em> · Teza 4 — farsa kao žanr bez moralne osude</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="novela">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Dubrovački mladići — vlastela. Stanac — seljak iz Trebinja. Klasna nadmoć se iskazuje intelektualnom prijevarom. Dubrovnik 16. st. nagrađuje pamet i poznanstvo.</div>
              <div class="fq-meta">— interpretacija društvenih odnosa · Marin Držić, <em>Novela od Stanca</em> · Teza 3 — komentar dubrovačkog društva</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>

          <div class="featured-quote" data-cit-cat="držić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Dundo Maroje — najstarija je poznata hrvatska prozna drama, kronika dubrovačke pohlepe i obiteljskog rasapa smještena u Rim.</div>
              <div class="fq-meta">— sintetska karakterizacija · Marin Držić, <em>Dundo Maroje</em> (1551.) · za esej o Držićevu opusu</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>

          <div class="featured-quote" data-cit-cat="petrark">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Blažen čas i hip ki te rodi i mati, blažena kolipka ka te povi u sviti...</div>
              <div class="fq-meta">— Šiško Menčetić, <em>Blažen čas i hip</em> · ★ Napamet · tipičan petrarkistički početak — veličanje gospoje, I. generacija</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="petrark">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Jur nijedna na svit vila, ljuvenim me ognjem gori, ka bi meni povoljna bila, da mi srce sav dan gori.</div>
              <div class="fq-meta">— Hanibal Lucić, <em>Jur nijedna na svit vila</em> · II. gen. petrarkizma — osmerci, neoplatonizacija</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="petrark">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Dok Menčetić opisuje sve stadije ljubavne strasti — od prvog pogleda do razočaranja — Džore Držić idealizira ljubav kao apstraktni fenomen bez senzualnosti.</div>
              <div class="fq-meta">— sintetska tvrdnja · razlika između Menčetića i Džore Držića · za argument o I. generaciji petrarkizma</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>

          <div class="featured-quote" data-cit-cat="zoranić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Rasuta bašćina — rascjepkana domovina kojoj prijete Turci, koja plače za svojom slobodom i cjelovitošću.</div>
              <div class="fq-meta">— Petar Zoranić, <em>Planine</em> (~1543./1569.) · ★ Napamet · temeljni patriotski motiv hrv. renesanse</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="zoranić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hrvatska vila stoji sramežljiva i tužna, gledajući jabuke svojih sestara — Latinke, Grkinju, Kaldejku — koje su bujnije i ljepše.</div>
              <div class="fq-meta">— parafrazirano iz <em>Perivoja od Slave</em>, Petar Zoranić, <em>Planine</em> · ★ Napamet · alegorija lošeg stanja hrv. književnosti</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="zoranić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Zoranić je u Perivoju od Slave napisao prvi eksplicitni književni manifest na hrvatskom — 300 godina prije Preporoda poziva na gradnju vlastite nacionalne književnosti.</div>
              <div class="fq-meta">— sintetska interpretacijska tvrdnja · Petar Zoranić, <em>Planine</em> · za argument o značaju Planina</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>

          <div class="featured-quote" data-cit-cat="hektorović">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hektorović ne alegorijizira — bilježi. U Ribanju je more stvarno, ribari stvarni, bugarštice stvarne. To je renesansna novost: stvarnost kao dovoljan književni predmet.</div>
              <div class="fq-meta">— sintetska karakterizacija · Petar Hektorović, <em>Ribanje</em> (1556.) · Hektorovićev realizam nasuprot alegoriji</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="hektorović">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Bilježenjem bugarštica i narodnih pjesama ribarâ, Hektorović je sačuvao segment hrv. usmene tradicije koji bi inače bio izgubljen — književnost kao arhiv pamćenja.</div>
              <div class="fq-meta">— sintetska tvrdnja · Petar Hektorović, <em>Ribanje</em> (1556.) · za argument o kulturnoj vrijednosti Ribanja</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Renesansa na hrvatskim područjima je doba „prvoga" — prvog epa (Judita), prvog romana (Planine), prve svjetovne drame (Robinja), prvog hrv. pisca poznatog u Europi (Marulić).</div>
              <div class="fq-meta">— sintetska tvrdnja za uvod eseja · hrv. renesansa kao epoha „prvoga" · za argument o značaju čitavog razdoblja</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Turska opasnost nije dekor hrv. renesanse — ona je njena jezgra. Svaki pisac od Marulića do Zoranića piše s tim pritiskom, pa tako i Robinja Lucića koja govori o ropstvu i trgovini ljudima.</div>
              <div class="fq-meta">— sintetska tvrdnja · lokalna specifičnost hrv. renesanse nasuprot talijanskoj · za esej o kontekstu</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Dok talijanski petrarkisti pišu sonete, hrv. petrarkisti pišu dvostruko rimovane dvanaesterce — manje formalne strogosti, više melodioznosti i lokalne specifičnosti.</div>
              <div class="fq-meta">— sintetska tvrdnja · razlika hrv. i tal. renesanse · ★ Napamet · najčešća matuirana tema usporedbe</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Humanizam nije odbacivanje Boga — on je premještanje fokusa s Boga na čovjeka kao Božje stvorenje, sposobno razumom i voljom ostvariti svoju svrhu.</div>
              <div class="fq-meta">— sintetska definicija humanizma · za teorijsko pitanje o renesansi i humanizmu · razlika od pogrešnog tumačenja humanizma kao ateizma</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Dvostruko rimovani dvanaesterac nije samo stih — on je identitet hrv. renesanse, veza s tradicijom začinjavaca i signal da hrv. književnost može nositi visoke forme.</div>
              <div class="fq-meta">— sintetska tvrdnja o stihu · za teorijsko pitanje o versifikaciji hrv. renesanse · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Marin Držić nije samo komediograf — on je i politički mislilac koji tajno piše Medicijima tražeći prevrat, i moralni kritičar koji u prolozima Dunda Maroja razlikuje „nazbiljske" od „nahvao" ljudi.</div>
              <div class="fq-meta">— sintetska karakterizacija Marina Držića · kompleksnost pisca · za esej koji zahtijeva višedimenzionalni portret</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="marulić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Marulić piše dvama jezicima za dvije publike — latinskim za europske humaniste, hrvatskim za sunarodnjake. Oba pisca su jednako Marulić: jedan govori Europi, drugi govori domovini.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · bilingvalnost Marulića · za argument o europskom dosegu hrv. renesansne književnosti</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="judita">
            ...
            <div class="fq-body">
              <div class="fq-text">Libar Marka Marula Splićanina u kom se uzdarži istorija svete udovice Judit u versih harvacki složena, kako ona ubi vojvodu Oloferna posridu vojske njegove i oslobodi puk israelski od velike pogibili.</div>
              <div class="fq-meta">— originalni naslov Judite iz posvete, 1501. · ★ Napamet · naslov sam po sebi sadrži: autora, žanr (versi = stihovi), jezik (harvacki), radnju i alegorijsku poruku</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="hektorović">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hektorović u Ribanju pokazuje što humanizam znači u praksi: nije samo imitacija antičkih uzora — to je i zapisivanje živoga, i razgovor s ribarima kao jednakima, i ljubav prema svakodnevici.</div>
              <div class="fq-meta">— sintetska tvrdnja o Hektorovićevu humanizmu · za usporedni argument: Marulić (učeni humanizam) vs. Hektorović (praktični humanizam)</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="petrark">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Lucić ne traži gospoju od krvi i mesa — traži savršenu dušu kakvu zemlja ne može ponuditi. To je neoplatonizam u praksi: ljubav kao put prema Bogu, ne prema ženi.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Hanibal Lucić, <em>Jur nijedna na svit vila</em> · razlika II. generacije petrarkizma od I.</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hrvatska je krajem 16. st. bila „reliquiae reliquiarum" — ostaci ostataka. Tu tugu nosi svaki hrv. renesansni pisac: Marulić alegorijom, Zoranić elegijom, Hektorović šutnjom opustjelih otoka.</div>
              <div class="fq-meta">— sintetska tvrdnja · turska opasnost kao zajednički kontekst hrv. renesanse · za argument o lokalnoj specifičnosti</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="držić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Skup pohlepi posvećuje sve — blago, zdravlje, kćerinu sreću. Držić nam pokazuje kako novac postaje bog kada nestanu svi ostali bogovi.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Marin Držić, <em>Skup</em> (1556.) · za argument o kritici dubrovačke merkantilne kulture</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Robinja Hanibala Lucića jedina je hrv. renesansna drama koja tematizira tursko ropstvo direktno, bez alegorije — time je politički angažiranija od Judite, ali manje poetski ambiciozna.</div>
              <div class="fq-meta">— usporedna tvrdnja · Hanibal Lucić, <em>Robinja</em> (1530.) vs. Marulić, <em>Judita</em> · za usporedni esej o hrv. renesansnoj književnosti</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="zoranić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">U Planinama ljubav i domoljublje nisu odvojene teme — Zoranova tuga za Jagom i tuga za rasutom bašćinom su ista tuga: nešto vrijedno se izgubilo, i ne znaš kako vratiti.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Petar Zoranić, <em>Planine</em> · za argument o spajanju ljubavne i patriotske tematike</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Otium nije lijenost — to je humanistički ideal slobodnog vremena posvećenog kulturi, razgovoru i misli. Hektorovićevo Ribanje je otium u čistoj formi: bijeg od vlastelinske svakodnevice prema slobodnom moru i ribarcima koji znaju stvari koje knjige ne mogu naučiti.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Petar Hektorović, <em>Ribanje</em> (1556.) · za argument o humanističkom idealu otituma i demokratizaciji spoznaje</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="marulić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Marulić je paradoks hrv. renesanse: poznatiji je u Europi po latinskim djelima nego po Juditi, a u hrv. književnopovijesnoj tradiciji — poznat isključivo po Juditi. Isti čovjek, dva književna identiteta, dvije publike, dva jezika.</div>
              <div class="fq-meta">— sintetska tvrdnja o bilingvalnosti Marulića · za usporedni argument ili za argument o europskom dosegu hrv. renesanse · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="novela">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Stanec ne gubi jer je loš čovjek — gubi jer je naivan u gradu koji ne prašta naivnost. I upravo ta rečenica — bez moralne osude, bez sućuti — pokazuje Držićevu dramatičarsku zrelost: prikazati zakone društva bez komentara.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Marin Držić, <em>Novela od Stanca</em> · za napredni esejski argument o Držićevoj dramatičarskoj poetici · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hrv. renesansa nema renesansnog optimizma — dok Italija slavi čovjeka kao mjeru svih stvari, Hrvatska ga oplakuje pod turskim mačem. Ta razlika od europskog prosjeka jest hrv. renesansna specifičnost.</div>
              <div class="fq-meta">— sintetska tvrdnja · ključna razlika hrv. i tal. renesanse · za usporedni esej ili uvod koji smješta hrv. renesansu u europski kontekst · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="hektorović">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hektorovićevo Ribanje je jedini hrv. renesansni tekst koji se ne pita što zemlja znači za naciju — koji jednostavno prikazuje kako zemlja izgleda, miriše i zvuči. Ta neumornost prema stvarnom je Hektorovićeva veličina.</div>
              <div class="fq-meta">— sintetska tvrdnja · Petar Hektorović, <em>Ribanje</em> · za argument o Hektorovićevom dokumentarnom realizmu i važnosti arhiviranja stvarnosti</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="novela">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Dramska ironija Novele od Stanca nije slučajna — publika zna da nema vode od mladosti; Stanec ne zna. Taj jaz između publicinog i Stančeva znanja jest mehanizam komike, ali i mehanizam empatije: smijemo se, ali i žalimo.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Marin Držić, <em>Novela od Stanca</em> · za argument o dramskoj ironiji kao ključnom alatu farse · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="judita">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Judita pobjeđuje Holoferna ne mačem nego pameću i vjerom — to je Marulićeva poruka: slabiji može pobijediti jačeg uz Božju pomoć. I upravo ta poruka čini Juditu prvim hrv. književnim manifestom nade.</div>
              <div class="fq-meta">— sintetska interpretacija · Marko Marulić, <em>Judita</em> (1501./1521.) · za argument o teološko-humanističkoj dimenziji Judite · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="petrark">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Gospoja hrv. petrarkizma je paradoks: žuđena i nedostupna, opisivana i neznana, veličana i ravnodušna. Ona nije osoba — ona je funkcija lirske subjectivnosti. I upravo ta apstrakcija čini je neumoljivim simbolom.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · hrv. petrarkizam općenito · za argument o ulozi gospoje u lirici · tipično ispitno pitanje</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">83 godine hrv. renesansne književnosti — od Judite (1501.) do Vazetja Sigeta (1584.) — je putovanje od nade do komemoracije: od alegorije koja poziva na otpor do epa koji slavi žrtvovanu borbu.</div>
              <div class="fq-meta">— sintetska tvrdnja o hrv. renesansi kao cjelini · za uvod ili zaključak eseja koji govori o razvoju epohe · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="zoranić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Perivoj od Slave nije tužna slika — to je hrabra rečenica. Zoranić kaže što nitko drugi nije rekao: naša književnost zaostaje i to se mora promijeniti. Da je Perivoj od Slave bio pisan na latinskom, nitko bi ga danas znao.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Petar Zoranić, <em>Planine</em> · za argument o Zoranićevoj ulozi u hrv. književnoj svijesti · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
        ...
        <div class="box-warn">
          ...
          <div class="featured-quote" data-cit-cat="kontekst">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Hrv. renesansa nije imala Medície ni stabilne mecene — imala je Dubrovačku Republiku, hvarske plemiće i zadarsku vlastelu koji su iz osobne ljubavi prema kulturi financirali književnost. To je manje stabilno, ali autentičnije od dvorske kulture.</div>
              <div class="fq-meta">— sintetska tvrdnja · za usporedbu s talijanskim mecenatstvom · za argument o originalnosti hrv. renesanse bez institucionalnih potpora</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="marulić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Judita nije pobožna priča — to je politički traktat u biblijskom ogrtaču: Bog je na strani Hrvata, i to je jedini argument koji oslabljenu naciju može mobilizirati.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Marko Marulić, <em>Judita</em> · za napredni argument o Marulićevoj političkoj teologiji · za A ocjenu</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="držić">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Marin Držić je pisac koji je znao previše — previše o Dubrovniku, o društvu, o moći. I upravo zbog toga je napisao Kosmografsku poslanicu: tko vidi previše jasno, ne može šutjeti.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Marin Držić, Kosmografska poslanica (1566.) · za argument o Držiću kao politički angažiranom intelektualcu · ★ Napamet</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
          ...
          <div class="featured-quote" data-cit-cat="hektorović">
            <div class="fq-mark">«</div>
            <div class="fq-body">
              <div class="fq-text">Tvrdalj nije samo kuća — to je filozofija pretvorena u kamen: da ljepota, mir i razgovor imaju pravo na trajanje. Dok Dubrovnik trguje, Hektorović gradi. I to je humanistički izbor.</div>
              <div class="fq-meta">— interpretacijska tvrdnja · Petar Hektorović, Tvrdalj i Ribanje · za argument o humanizmu kao životnom, ne samo literarnom programu</div>
            </div>
            <button type="button" class="fq-copy" onclick="fqCopy(this)">⎘</button>
          </div>
      ...
      <div class="box-warn">
          <div class="bw-ico">⭐</div>
          <div class="bw-body">
            <div class="bw-title">TOP 10 citata — ★ Napamet za maturu</div>
            <div class="bw-txt" style="line-height:1.9">
              <b>1.</b> <em>„Bez poklada nema Novele od Stanca — karnevalske slobode su dramski uvjet..."</em>
              &nbsp;&nbsp;<b>2.</b> <em>„Stanec gubi jer je star i naivan — mladost pobjeđuje lukavošću..."</em>
              &nbsp;&nbsp;<b>3.</b> <em>„Judita nije samo biblijska heroina — alegorija hrv. naroda koji pobjeđuje..."</em>
              &nbsp;&nbsp;<b>4.</b> <em>„Historiju tuj svedoh na versih, po običaju naših začinjavac..."</em>
              &nbsp;&nbsp;<b>5.</b> <em>„Rasuta bašćina — rascjepkana domovina kojoj prijete Turci..."</em>
              &nbsp;&nbsp;<b>6.</b> <em>„Hrvatska vila stoji sramežljiva i tužna, gledajući jabuke svojih sestara..."</em>
              &nbsp;&nbsp;<b>7.</b> <em>„Hektorović ne alegorijizira — bilježi. U Ribanju je more stvarno..."</em>
              &nbsp;&nbsp;<b>8.</b> <em>„Hrv. petrarkisti pišu dvostruke dvanaesterce, ne sonete..."</em>
              &nbsp;&nbsp;<b>9.</b> <em>„Renesansa na hrv. područjima je doba 'prvoga' — prvog epa, prvog romana..."</em>
              &nbsp;&nbsp;<b>10.</b> <em>„83 godine hrv. renesanse: od Judite (1501.) do Vazetja Sigeta (1584.) — od nade do komemoracije."</em>
            </div>
          </div>
        </div>
        ...
        <div class="box-int">
          <div class="box-int-lbl">📖 Kako koristiti Top 10 citata na ispitu</div>
          <div class="box-int-txt">
            Citati su formulirani kao <strong>gotove esejske tvrdnje</strong> — možeš ih koristiti direktno u eseju. Svaki je dovoljno kratak da ga zapamtiš, dovoljno specifičan da pokaže znanje.<br><br>
            <b>Za uvod:</b> Citati 9 i 10 — kontekstualiziraju hrv. renesansu kao epohu.<br>
            <b>Za razradu o Noveli:</b> Citati 1 i 2 — poklade kao uvjet i mlado vs. staro.<br>
            <b>Za razradu o Juditi:</b> Citati 3 i 4 — alegorija i Marulićev originalni naslov.<br>
            <b>Za razradu o Planinama:</b> Citati 5 i 6 — rasuta bašćina i Perivoj od Slave.<br>
            <b>Za usporedbu:</b> Citati 7 i 8 — Hektorovićev realizam i petrarkistička zamka.
          </div>
        </div>
      ...
      <div class="layer" id="l4" role="tabpanel" tabindex="0">
        <div class="tags">
          <span class="pill p-go">70 pojmova</span>
          <span class="pill p-br">grid + flashcard mode</span>
          <span class="pill p-t">filtriraj po kategoriji</span>
        </div>

        <div class="pojm-mode-row">
          <button class="pojm-mode-btn on" id="mode-grid" onclick="setPojmMode('grid')">⊞ Grid</button>
          <button class="pojm-mode-btn" id="mode-fc" onclick="setPojmMode('fc')">🃏 Flashcard</button>
          <span style="font-family:var(--mono);font-size:10px;color:var(--t3);margin-left:6px">← → za navigaciju, klik za okret</span>
        </div>

        <div class="fc-wrap" id="fc-wrap">
          <div class="fc-counter" id="fc-counter">1 / 35</div>
          ...
          <div class="fc-nav">
            <button class="fc-btn" id="fc-prev" onclick="fcPrev()" disabled>← Prethodni</button>
            <button class="fc-btn primary" onclick="fcFlip()">↩ Okreni</button>
            <button class="fc-btn" id="fc-next" onclick="fcNext()">Sljedeći →</button>
          </div>
        ...
        <div id="grid-wrap">
          <div class="pojm-filters">
            <button class="pojm-filter on" data-cat="all" onclick="pojmFilter('all',this)">Sve</button>
            <button class="pojm-filter" data-cat="knjiz" onclick="pojmFilter('knjiz',this)">Književnost</button>
            <button class="pojm-filter" data-cat="stih" onclick="pojmFilter('stih',this)">Stihovi</button>
            <button class="pojm-filter" data-cat="kontekst" onclick="pojmFilter('kontekst',this)">Kontekst</button>
            <button class="pojm-filter" data-cat="djelo" onclick="pojmFilter('djelo',this)">Djela</button>
            <button class="pojm-filter" data-cat="lik" onclick="pojmFilter('lik',this)">Likovi</button>
          </div>
          <div class="pojm-grid" id="pojm-grid">
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Humanizam</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def"><strong>Intelektualni pokret</strong> — čovjek (ne Bog) u centru znanja. Interes za antiku, latinski i grčki. Pisci uče u Italiji, citiraju Vergilija i Petrarcu.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Petrarkizam</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Ljubavna lirika po uzoru na Petrarcu. Motivi: idealizirana „gospoja", nesretna ljubav. <strong>Hrv. petrarkisti ne pišu sonete — pišu dvanaesterce.</strong> I. gen. Menčetić/Džore Držić + II. gen. Lucić.</div></div></div>
            <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Dvostruko rim. dvanaesterac</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def"><strong>Standardni stih hrv. renesanse.</strong> 12 slogova, cesura po 6. slogu. Rimovanje AA BB ili AB AB. Koriste ga Marulić, Hektorović, Menčetić, Držić (Novela).</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Pastorala</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Književna vrsta s idilično-pastoralnim ambijentem — pastiri razgovaraju o ljubavi. <strong>Prva hrv. pastoralna drama:</strong> <em>Radmio i Ljubmir</em> (Džore Držić, kraj 15. st.).</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Začinjavci</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def"><strong>Hrv. srednjovjekovni pjesnici-svećenici.</strong> Marulić ih navodi u posveti Juditi — od njih preuzima dvostruko rimovani dvanaesterac s prijenosnom rimom.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Rasuta bašćina</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Motiv iz Zoranićevih <em>Planina</em>. Alegorija za <strong>razdrobljenu hrv. domovinu</strong> pod pritiskom Turaka. Patriotski apel — domovina koja ne može zaštititi samu sebe.</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Judita</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Ep Marka Marulića. Dovršena <strong>1501.</strong>, tiskana 1521. 6 pjevanja, 2126 dvanaesteraca, splitska čakavština. Alegorija: Judita = Hrvatska; Oloferno = Turci.</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Novela od Stanca</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Marin Držić, <strong>1550.</strong> Farsa / pokladna igra. 1 čin, 7 prizora, dvanaesterci. Mladi nasamare Stanca. Opreke: mlado–staro, vlastela–seljak. <strong>★ OBVEZATNO 2026.</strong></div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Planine (Zoranić)</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def"><strong>Prvi hrv. roman.</strong> Mješavina proze i stihova, 24 poglavlja. Zoran putuje Dalmacijom. <em>Perivoj od Slave</em>: 4 vile = 4 nac. književnosti; Hrvatica = loše stanje hrv. knj.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Farsa</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Kratka komična dramska vrsta — preuveličani tipski likovi, situacijska komika, bez psihologizacije. Novela od Stanca: 1 čin, komika situacije, ne karaktera.</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Ribanje (Hektorović)</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Petar Hektorović, <strong>1556.</strong> Višestruko određenje: ep + putopis + ribarska ekloga + poslanica. Put Hvar–Brač–Šolta. Zapisuje bugarštice — dragocjen dokument usmene tradicije.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Bugarštica</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def"><strong>Vrsta hrv. narodne epske pjesme</strong> u dugom stihu (15–16 slogova), starija od deseteračkih. Hektorović bilježi: <em>Kraljević Marko i brat mu Andrijaš</em>.</div></div></div>
            <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Sonet</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">14-stihna pjesma (2 katrena + 2 tercine). Petrarca ga idealizira. <strong>Hrv. petrarkisti NE pišu sonete</strong> — pišu dvanaesterce. Najčešća maturana zamka!</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Ranjinin zbornik</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Rukopisna zbirka 820 pjesama, prikupljao <strong>Nikša Ranjina od 1507.</strong> Autori: Menčetić, Džore Držić, Vetranović. Temeljni izvor za dubrovačku liriku 15.–16. st.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Plautovska komedija</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Komedija po uzoru na Plauta. <em>Skup</em> preuzima radnju iz <em>Aulularije</em>. Tipični likovi: škrtac, mladi zaljubljenac, stari otac, lukavi sluga.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Alegorija</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Tekst ima <strong>doslovno i preneseno (skriveno) značenje.</strong> Judita: Oloferno = Turci, Judita = Hrvatska. Planine-Perivoj od Slave: Hrvatica = hrv. književnost.</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Robinja (Lucić)</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Hanibal Lucić, praizvedena <strong>1530.</strong>, tisk. 1638. Prva hrv. drama s razrađenom radnjom i individualnim likovima. Tema: turska opasnost. 3 čina, dvanaesterci.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Poklade / Karneval</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Karnevalsko razdoblje <strong>slobode i preokretanja društvenih uloga</strong> prije Korizme. Kontekst Novele od Stanca: pokladne slobode legitimiraju prevaru mladića.</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Dundo Maroje</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Marin Držić, <strong>1551.</strong> Najstarija hrv. prozna drama. 2 prologa + 5 činova. Radnja u Rimu. Kraj nedostaje — dopunio Mihovil Kombol.</div></div></div>
            <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Neoplatonizam</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Filozofija: ljubav je <strong>duhovna sila</strong> koja uzdiže dušu prema Bogu (Ljepoti). U II. gen. petrarkista (Lucić): ljubav nije samo strast — put prema savršenstvu.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Dubrovačka Republika</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def"><strong>Slobodna grad-država</strong> (992.–1808.) s ekonomskim viškom koji financira književnost i kazalište. Vlastela kao mecene. Dubrovački idiom — književni jezik hrv. renesansne drame.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Pokladna igra</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Kratka dramska vrsta za <strong>karnevalske svečanosti.</strong> Novela od Stanca je pokladna igra: kratka, komična, namijenjena konkretnoj prigodi. Zabava je cilj.</div></div></div>
            <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Vazetje Sigeta grada</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Brne Krnarutić, <strong>1584.</strong> <strong>Prvi hrv. povijesni ep.</strong> 4 pjevanja, 1056 dvanaesteraca. Opjeva opsadu Sigeta (1566.) i žrtvu Nikole Šubića Zrinskog.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Kosmografska poslanica</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Tajno pismo Marina Držića Cosimu de' Mediciju (1566.) — traži vojnu pomoć za <strong>rušenje dubrovačke oligarhije.</strong> Držić kao politički angažirani intelektualac.</div></div></div>
            <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Prijenosna rima</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Vrsta rime u hrv. dvanaestercu — rim se prenosi AB AB. Marulić je preuzima od <em>začinjavaca.</em> Razlika od parne rime AA BB.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Ep (epos)</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Dugi narativni stih s herojskom tematikom. Uzori: Homer, Vergilije. Hrv. renesansa: <strong>Judita</strong> (biblijsko-kršćanski), <strong>Vazetje Sigeta</strong> (povijesni). Struktura: pjevanja, invokacija muze.</div></div></div>
            <div class="pojm-card" data-cat="lik" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Stanac — tipski lik</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Lik „<strong>glupog seljaka</strong>" iz kazalištne tradicije. Nije individua — <em>tip.</em> Stanac = naivnost, starost, seoska neprilagođenost gradu. Žrtva komičnog zapleta u Noveli.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Perivoj od Slave</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Epizoda iz Zoranićevih <em>Planina</em>. Alegorijski vrt: 4 vile = 4 nac. književnosti. <strong>Hrvatica</strong> ima loše jabuke = loše stanje hrv. knj. <em>First hrv. književni manifest.</em></div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Čakavica</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Jedno od triju hrv. narječja. <strong>Dominantno u hrv. renesansi</strong> — Marulić piše Juditu u splitskoj čakavštini. Hektorović piše hvarski čakavski. Nije normiran — svaki grad govori svoju varijantu.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Ribarska ekloga</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Podovrsta pastoralne poezije — idilični opis ribarskog/seoskog života. Hektorovićevo <em>Ribanje</em> je ribarska ekloga: trodnevni put s ribarima, razgovori i pjesme.</div></div></div>
            <div class="pojm-card" data-cat="lik" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Judita — lik heroine</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Udovica iz Betulije. Marulić je oblikuje kao kršćanski ideal: <strong>plemenita, hrabra, pobožna.</strong> Alegorički: Hrvatska uz Božju pomoć. Njezina ljepota = sredstvo Božjeg plana.</div></div></div>
            <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Commedia dell'arte</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Talijanska improvizacijska komedija s <strong>fiksnim tipskim likovima</strong>: Pantalone (škrtac), Arlecchino (lukavi sluga). Utjecaj na Držića — Stanac i mladići odgovaraju ovim tipovima.</div></div></div>
            <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Poslanica (epistola)</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Književna forma — <strong>pismo upućeno konkretnoj osobi</strong>, ali namijenjeno široj publici. Hektorovićevo <em>Ribanje</em> je poslanica Jeronimu Bartučeviću. Marulićeva <em>Poslanica papi Hadrijanu VI.</em></div></div></div>
            <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Gospoja</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Ključni motiv petrarkizma — <strong>idealizirana voljena žena</strong> koja odbija pjesnika. Nije stvarna osoba — književna projekcija savršenstva. Menčetić: izvor ljubavne boli. Lucić: put prema duhovnom savršenstvu.</div></div></div>
            <div class="pojm-card" data-cat="lik" onclick="this.classList.toggle('flip')"><div class="pojm-front"><div class="pojm-term">Holoferno — alegorija</div><div class="pojm-hint">→ klikni</div></div><div class="pojm-back"><div class="pojm-def">Asirski vojvoda u <em>Juditi</em>. Alegorički = <strong>turska vojska / sultan.</strong> Karakterizacija: okrutan, ohol, pohotljiv. Žudnja prema Juditi postaje njegova propast — sila poražena pameti i vjeri.</div></div></div>
          </div>
        </div>


          <!-- ══ DODATNIH 10 POJMOVA — ukupno ~45 ══ -->

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Reliquiae reliquiarum</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Latinska sintagma: <strong>„ostaci ostataka"</strong> — opis položaja Hrvatske nakon Mohača (1526.) i turskih osvajanja. Hrvatska je izgubila veći dio teritorija — ostao je samo uski pojas. Termin koji se koristi u hrv. historiografiji i kulturi 16. st.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Commedia erudita</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">„Učena komedija" — renesansna komedija pisana po uzoru na antičke autore (Plaut, Terencije), namijenjena obrazovanoj publici. <em>Skup</em> i <em>Dundo Maroje</em> su primjeri hrv. commedia erudita. Razlika od commedia dell'arte (improvizirana, tipski likovi).</div></div>
          </div>

          <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Anafora</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Stilsko sredstvo: <strong>ponavljanje iste riječi/sintagme na početku stihova/rečenica</strong>. Menčetić: <em>„Blažen čas... blažena kolipka... blažena ti ženska..."</em> — anafora pojačava euforiju. Česta u petrarkizmu i epskoj tradiciji.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Katarza</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Aristotel: „<strong>pročišćenje</strong>" koje gledatelj doživljava kroz tragediju — suosjećanjem i strahom. Pojam Aristotelove <em>Poetike</em>. U hrv. kontekstu: nema klasične tragedije — ali Robinja i Judita imaju elemente koji provociraju suosjećanje bez katarze.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Curiositas</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Lat. — <strong>znatiželja, istraživački duh</strong>. Temeljni humanistički ideal: čovjek je slobodan i sposoban spoznati svijet vlastitim razumom. Odjek u Hektorovićevom putopisu (opisuje sve što vidi), Zoranićevom putovanju, Marulićevoj latinskoj prozi.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Poslanica (epistola)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Književna forma — <strong>pismo upućeno poznatoj osobi</strong>, s književnim pretenzijama. Hektorovićevo <em>Ribanje</em> je poslanica Jeronimu Bartučeviću. Marulićeva <em>Poslanica papi Hadrijanu VI.</em>. Humanistički žanr koji kombinira osobno i javno.</div></div>
          </div>

          <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Skup (Držić)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Marin Držić, praizvedena <strong>1556.</strong> 5 činova, proza. Plautovska komedija po uzoru na <em>Aululariju</em>. Stari škrtac Skup želi udati kćer Adrianu za Zlatikuma, ali je ona zaručena za mladog Kamila. <strong>Kritika pohlepe</strong> kao dubrovačke društvene vrijednosti.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Tvrdalj (Hektorović)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Utvrda-palača u Starom Gradu na Hvaru, koju je dao sagraditi Petar Hektorović. Danas UNESCO-vina baština. <strong>Kulturno središte hvarske renesanse</strong> — Hektorović je u njemu primao posjetitelje, pisao i sakupljao knjige. Simbol humanističkog mecenatstva.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Didaskalija</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def"><strong>Scenska uputa u dramskom tekstu</strong> — opis scenografije, kretnje likova, tona govora. U hrv. renesansnoj drami još nisu razvijene. <em>Dundo Maroje</em>: Negromant govori o sebi u prologu (forma monologa, ne didaskalije). Razlika od moderne drame.</div></div>
          </div>

          <div class="pojm-card" data-cat="lik" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Negromant (lik)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Lik u prologu <em>Dunda Maroja</em>. Čarobnjak koji uvodi filozofski okvir drame: razlika između <strong>„nazbiljnih"</strong> (razumnih, poštenih) i <strong>„nahvao"</strong> (pohlepnih, nerazumnih) ljudi. Negromant nije dio radnje — on je autorski glas koji uokvire dramu.</div></div>
          </div>
          ...
          <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Cesura</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def"><strong>Pauza u stihu</strong> — u hrv. dvanaestercu cesura je po 6. slogu: stih se dijeli na dva polastica po 6 slogova. Npr. <em>„Blažen čas i hip | ki te rodi i mati"</em> — pauza između „hip" i „ki". Važan element ritma hrv. renesansnog stiha.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Invokacija muze</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Epska konvencija: pjesnik na početku epa <strong>zaziva muzu</strong> ili Boga da mu pomogne pisati. Marulić u Juditi zaziva Boga: <em>„Tko mi da vrist razum, er se nać' ne ufam / u trudih ke tvorju, da tko sluša zaufam?"</em> Nasljeduje antičku epsku tradiciju (Homer, Vergilije).</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">In medias res</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Latinski — <strong>„u sredinu stvari"</strong>. Epska tehnika: priča počinje u sredini radnje, a prethodne događaje saznajemo retrogradno. Vergilije, Homer. U hrv. renesansi manje izraženo nego u klasičnom epu, ali prisutno u strukturi Judite.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Otium</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Latinski humanistički ideal: <strong>slobodno vrijeme</strong> posvećeno razmišljanju, čitanju, razgovoru i kulturi. Suprotnost <em>negotiumu</em> (poslu, obvezama). Hektorovićevo Ribanje je savršeni otium — bijeg od poslova u slobodan prostor mora i razgovora s ribarima.</div></div>
          </div>

          <div class="pojm-card" data-cat="lik" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Ozija (lik)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Židovski starješina u Marulićevoj <em>Juditi</em>. Predstavlja <strong>kolebljivost vodstva</strong> — spreman je predati grad Betuliju. Judita ga kritizira zbog gubitka vjere. Kontrast Juditi: dok je on neodlučan, ona djeluje. <em>Simbol slabog ali ne zlog vođe koji treba snažnu osobu uz sebe.</em></div></div>
          </div>

          <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Dundo Maroje</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Marin Držić, praizvedena <strong>1551.</strong> 2 prologa + 5 činova, proza, dubrovački idiom. Radnja u Rimu. Dundo traži sina Mara koji troši novac s Laurom. <strong>Najstarija hrv. prozna drama.</strong> Kraj nedostaje — Kombol dopunio u 20. st. Filozofski okvir: Negromant (nazbilji vs. nahvao).</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Ilirski preporod</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Hrv. nacionalni kulturni pokret 19. st. (1835.–1850.) — standardizacija hrv. jezika, buđenje nacionalne svijesti. Vođa: Ljudevit Gaj. Zoranićeve Planine (1543.) anticipiraju Preporod za 300 godina — poziv na gradnju hrv. književne tradicije u <em>Perivoju od Slave</em>.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Dramska ironija</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Situacija kada <strong>publika zna nešto što lik ne zna</strong>. U Noveli od Stanca: publika zna da nema „vode od mladosti" — Stanec ne zna. Ovaj jaz između publicinog i likova znanja pojačava komički efekt. Ključni alat farse i komedije.</div></div>
          </div>

          <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Obgrljena rima</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Shema rime <strong>ABBA</strong> — prvi i četvrti stih rimuju, drugi i treći rimuju. Lucić u <em>Jur nijedna na svit vila</em> koristi obgrljenu rimu u drugoj četvorci svake strofe. Razlika od ukrštene rime (ABAB) koja se koristi u prvoj četvorci.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Dijalog (kao dramski instrument)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">U drami: <strong>jedino sredstvo karakterizacije i razvoja radnje</strong> — nema pripovijedača. Stanec se karakterizira kroz ono što govori i kako govori (čakavski, sporije, tužno); mladići kroz brzinu i lukavost dijaloga. Lik jest onako kako govori — to je dramski aksiom.</div></div>
          </div>
          ...
          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Pastoralna drama</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Drama s likovima pastira u idiličnom pejzažu — ljubavni razgovori, pjevanje, filozofske refleksije. Uzor: Sannazarova <em>L'Arcadia</em>. Hrv. primjeri: Džore Držić <em>Radmio i Ljubmir</em> (prva hrv. pastoralna drama) i <em>Tirena</em> mladog Marina Držića.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Mecenatstvo</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Pokroviteljstvo moćnih osoba nad književnicima i umjetnicima. Talijanski uzor: Mediciji u Firenci. U hrv. renesansi: <strong>Dubrovačka vlastela</strong> financira kazalište; Hektorović gradi Tvrdalj. Bez mecenatstva nema organizirane kulturne produkcije.</div></div>
          </div>

          <div class="pojm-card" data-cat="lik" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Pomet (lik)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Lukavi sluga u <em>Dundu Maroju</em> Marina Držića — <strong>najinteligentniji lik drame</strong>. Nasljeđuje tradiciju commedia dell'arte (Arlecchino). Pobjeđuje svakog lukavošću, živi od tuđe naivnosti. Simbol praktičnog razuma koji se snalazi u svim situacijama.</div></div>
          </div>

          <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Ribanje i ribarsko prigovaranje</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Petar Hektorović, <strong>1556.</strong> Ep/putopis/ekloga/poslanica. Trodnevno putovanje Hvar→Brač→Šolta s ribarima Nikolom Zetom i Paskojem Debelim. Bilježi bugarštice — <em>najstariji zapis</em>. Realizam nasuprot alegoriji. Posvećeno Jeronimu Bartučeviću.</div></div>
          </div>

          <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Robinja (Lucić)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Hanibal Lucić, praizvedena <strong>1530.</strong>, tiskana 1638. 3 čina, dvostruki dvanaesterci. <strong>Prva hrv. drama s razrađenim zapletom i individualnim likovima</strong>. Tema: tursko ropstvo — Derenčin otkupljuje Robinju (kćer bana Vlaska) od turskog vlasnika. Eksplicitan moral: ljubav pobjeđuje pohlepu.</div></div>
          </div>

          <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Heksametar</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Šestostopni daktilski stih antičkih epova (Homer, Vergilije). <strong>Nije prisutan u hrv. renesansi</strong> — Marulić piše dvanaesterce, ne heksametar. Ali Marulić ga poznaje jer je čitao Vergilija na latinskom. Razlika: antički ep = heksametar; hrv. ep = dvostruki dvanaesterac.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Kosmografska poslanica</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Tajna politička poslanica Marina Držića <strong>Cosimu de' Mediciju</strong> (1566.) — tražio vojnu pomoć za prevrat u Dubrovniku protiv oligarhije. Otkriva Držića kao politički angažiranog intelektualca. Prevrat se nikad nije zbio; Držić umire 1567. u Veneciji.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Apostrofa</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Stilsko sredstvo: <strong>direktno obraćanje osobi, predmetu ili apstraktnoj ideji</strong> koja nije prisutna ili nije živa. Primjer u petrarkizmu: lirski subjekt se direktno obraća gospoji, Amoru, Bogu ili Sudbini. Apostrofa je emocionalno intenzivna — čini lirski monolog živim.</div></div>
          </div>

          <div class="pojm-card" data-cat="djelo" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Vazetje Sigeta grada</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Brne Krnarutić, tiskano <strong>1584.</strong> (posmrtno). Dvostruki dvanaesterci. <strong>Prvi hrv. povijesni ep</strong> — opisuje opsadu Sigeta 1566. i junaštvo Nikole Šubića Zrinskog. Razlika od Judite: nema alegorije — to je <em>direktni opis stvarnog, nedavnog događaja</em>.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Pokladna sloboda (karnevalska)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">U pokladnom (karnevalskom) periodu prije korizme — <strong>hijerarhija se privremeno preokreće</strong>, dopušteno je ono što inače nije. Ključni kontekst Novele od Stanca: bez pokladnih sloboda nema farse, nema prevare Stanca, nema komičnog učinka. Karneval legitimira komiku.</div></div>
          </div>
          ...
          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Kanconijer</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Zbirka lirskih pjesama organizirana kao <strong>narativ ljubavnog iskustva</strong> — po uzoru na Petrarkin <em>Kanconijer</em> (posvećen Lauri). Hrv. analogija: <em>Ranjinin zbornik</em> (1507.) s 820 pjesama. Razlika: Petrarca piše za jednu ženu (Laura), Ranjinin zbornik je antologija više autora.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Negotium</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Latinski: <strong>posao, obveze, poslovni i javni život</strong>. Suprotnost <em>otitumu</em> (slobodnom vremenu za kulturu). U Hektorovićevom Ribanju: Hektorović napušta negotium (vlastelinski poslovi u Hvaru) i odlazi u otium (ribarska izlaska). To nije lijenost — to je humanistički program.</div></div>
          </div>

          <div class="pojm-card" data-cat="knjiz" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Renesansni individualizam</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Humanistički ideal: individua je vrijedna sama po sebi, može se razvijati i spoznavati. U hrv. renesansi: <em>ograničen</em> — Marulić je individualan ali u kršćanskom okviru; Zoranić piše o Zoranu kao alter egu; Hektorović bilježi svoje putovanje. <strong>Individualizam nije sekularizam</strong> — hrv. pisci ostaju duboko kršćanski.</div></div>
          </div>

          <div class="pojm-card" data-cat="stih" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Parna rima</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Shema rime <strong>AA BB CC...</strong> — susjedni stihovi rimuju. Jedna od varijanti rime u hrv. dvanaestercu. Razlikuj: parna (AA BB), ukrštena (AB AB) i obgrljena (ABBA). U hrv. renesansi se koristi kombinacija, ali <em>prijenosna rima</em> je najkarakterističnija.</div></div>
          </div>

          <div class="pojm-card" data-cat="kontekst" onclick="this.classList.toggle('flip')">
            <div class="pojm-front"><div class="pojm-term">Barok (kao slijednik)</div><div class="pojm-hint">→ klikni za def.</div></div>
            <div class="pojm-back"><div class="pojm-def">Epoha koja slijedi renesansu (17. st.). U hrv. književnosti: <strong>Gundulićev Osman</strong> (1626.) nastavlja epsku tradiciju Judite i Vazetja. Ivan Gundulić je dubrovački pisac — most između Držićeve dubrovačke tradicije i baroknog epskog zamaha. Hrv. renesansa nije završila — ona je pretvorena u barok.</div></div>
          </div>
        ...
        <div class="box-warn">
          <div class="bw-ico">⚠️</div>
          <div class="bw-body">
            <div class="bw-title">Pojmovi koji se najčešće miješaju — pažljivo!</div>
            <div class="bw-txt">
              <b>Sonet vs. dvanaesterac:</b> Sonet = 14 stihova, talijanski (Petrarca). Dvanaesterac = hrv. stih, 12 slogova. Hrv. petrarkisti NIKAD ne pišu sonete.<br>
              <b>Alegorija vs. metafora:</b> Metafora = jedna zamjena (jabuke = književnost). Alegorija = dosljedna zamjenska priča (cijela Judita = hrv. borba). Alegorija je produžena metafora.<br>
              <b>Farsa vs. komedija:</b> Farsa = kratka, tipski likovi, bez morala, situacijska komika. Komedija = razrađena radnja, psihološki likovi, sretan kraj.<br>
              <b>Bugarštica vs. deseterac:</b> Bugarštica = 15–16 slogova, stariji oblik, elegičan ton. Deseterac = 10 slogova, kasniji (Vuk, 19. st.).<br>
              <b>Džore Držić vs. Marin Držić:</b> Džore = †1501., petrarkist + prva pastoralna drama. Marin = †1567., komediograf. NIKADA ih ne miješati!
            </div>
          </div>
        </div>
      ...
      <div class="layer" id="l5" role="tabpanel" tabindex="0">
        <div class="reveal-lock">
          ...
          <div class="reveal-lock-title">⚡ Drill — H11 Stari hrv. pisci</div>
          <div class="reveal-lock-desc">Pojmovi, datumi i ključne informacije u interaktivnom drill modu. Vježbaj pod vremenskim pritiskom — kao na stvarnom ispitu.</div>
          <div class="rli-list">
            <div class="rli"><div class="rli-ico">📚</div><div><div class="rli-title">30 drill pitanja — pojmovi + datumi + citati</div><div class="rli-desc">Petrarkizam, Judita, Novela od Stanca, bugarštica, pastorale, žanrovi, kronologija</div></div></div>
            <div class="rli"><div class="rli-ico">⏱️</div><div><div class="rli-title">Vremenski pritisak — simulacija ispita</div><div class="rli-desc">Odgovori u 20 sekundi — kao na pravom ispitu</div></div></div>
            <div class="rli"><div class="rli-ico">📊</div><div><div class="rli-title">Praćenje slabih točaka</div><div class="rli-desc">Vidiš koje pojmove i datume trebaš ponoviti</div></div></div>
            <div class="rli"><div class="rli-ico">🔁</div><div><div class="rli-title">Adaptivno ponavljanje</div><div class="rli-desc">Pogrešno odgovorena pitanja vraćaju se češće</div></div></div>
          </div>
          <a href="https://maturiraj.hr/cijene" class="reveal-lock-btn">🔓 Aktiviraj PRO</a>
        </div>
      ...
      <div class="layer" id="l7" role="tabpanel" tabindex="0">
        <div class="tags">
          ...
          <span class="pill p-br">10 stavki</span>
        </div>
        ...
        <div class="cp-summary">
          <div class="cp-sum-txt">Označeno: <b id="cp-done">0</b> / 10 stavki</div>
          <div class="cp-sum-pct" id="cp-pct">0%</div>
        </div>

        <div class="cp-grid" id="cp-grid">
          <div class="cp-item" onclick="cpToggle(this,0)">
...
/* ══ COUNTDOWN ══ */
(function(){
  var matura=new Date('2026-06-02T08:00:00');
  function tick(){
    var diff=matura-new Date();
    if(diff<=0)return;
    var el=document.getElementById('cd-days');
    var eh=document.getElementById('cd-hrs');
    if(el)el.textContent=Math.floor(diff/86400000);
    if(eh)eh.textContent=Math.floor((diff%86400000)/3600000);
  }
...
/* ══ MOBILE SIDEBAR ══ */
function openSb(){document.getElementById('sidebar').classList.add('mobile-open');document.getElementById('sb-overlay').classList.add('show');}
function closeSb(){document.getElementById('sidebar').classList.remove('mobile-open');document.getElementById('sb-overlay').classList.remove('show');}
...
var qzIdx=0,qzScore=0,qzAnswered=[];
function qzRender(){
  var q=QZ_DATA[qzIdx];
  document.getElementById('qz-q').textContent=q.q;
  var opts=document.getElementById('qz-opts');opts.innerHTML='';
  q.opts.forEach(function(o,i){
    var btn=document.createElement('button');btn.className='qz-opt';btn.textContent=o;
    btn.onclick=function(){qzAnswer(i,btn,q)};opts.appendChild(btn);
  });
  document.getElementById('qz-fb').className='qz-fb';document.getElementById('qz-fb').textContent='';
  document.getElementById('qz-score').textContent=qzScore+' / '+QZ_DATA.length;
  document.getElementById('qz-idx-lbl').textContent=(qzIdx+1)+'/'+QZ_DATA.length;
  document.getElementById('qz-prog').style.width=(((qzIdx+1)/QZ_DATA.length)*100)+'%';
...
function qzAnswer(i,btn,q){
  if(qzAnswered[qzIdx]!==undefined)return;
  qzAnswered[qzIdx]=i;
  var correct=i===q.ans;if(correct)qzScore++;
...
function qzNext(){if(qzIdx<QZ_DATA.length-1){qzIdx++;qzRender();}else{qzShowEnd();}}
function qzPrev(){if(qzIdx>0){qzIdx--;qzRender();}}
function qzShowEnd(){
  document.getElementById('qz-body').style.display='none';
  var end=document.getElementById('qz-end');end.style.display='block';
  var pct=Math.round(qzScore/QZ_DATA.length*100);
  var data=[
  ...
  document.getElementById('qz-end-score').textContent=qzScore+'/'+QZ_DATA.length+' ('+pct+'%)';
...
function cpUpdateSummary(){
  ...
  var f=document.getElementById('cp-final');if(f)f.classList.toggle('show',done===10);
...
function cpReset(){
  CP_STATE=new Array(10).fill(false);
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H11] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H11`);
