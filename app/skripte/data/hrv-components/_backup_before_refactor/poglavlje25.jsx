...
export const metadata = {
  code: 'H25',
  title: 'H25 · Pravopis | Maturiraj.hr · matura iz hrvatskog',
  description: 'H25 Pravopis — veliko/malo slovo, č/ć, đ/dž, interpunkcija, spojeno/odvojeno, kratice. Brzi pravopis drill 200 pitanja. Maturiraj.hr matura iz hrvatskog.',
  canonical: 'https://maturiraj.hr/hrvatski/h25-pravopis',
  ogImage: 'https://maturiraj.hr/og/h25-pravopis.png',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" aria-current="page" data-code="h25" href="/skripte/hrv/h25"><span class="sb-dot"></span>H25 · Pravopisna pravila</a>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div style="margin-top:32px;padding:16px 20px;background:linear-gradient(135deg,rgba(233,180,70,.06),transparent);border:1px solid var(--bd);border-radius:var(--r2);text-align:center">
      ...
      <div style="font-size:13px;color:var(--t2);line-height:1.6;margin-bottom:14px">
        Print ovaj cheat-sheet kao A4 referentnu tablicu. Ponesi sa sobom u zadnjim tjednima učenja.
      </div>
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H25] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H25`);
