/**
 * H05 — Maturiraj.hr — Hrvatski · H05 · Prosvjetiteljstvo i predromantizam
 * Auto-generated from Maturiraj_Hrvatski_H05.html
 * 
...
export const metadata = {
  code: 'H05',
  title: 'Maturiraj.hr — Hrvatski · H05 · Prosvjetiteljstvo i predromantizam',
  description: 'Interaktivna skripta za maturu iz Hrvatskog jezika — Prosvjetiteljstvo i predromantizam. Goethe Patnje mladog Werthera (ispitno djelo 2026), Voltaire Candide,...',
  canonical: 'https://maturiraj.hr/hrvatski/h05',
  ogImage: '',
};
...
<nav class="sidebar" id="sidebar">
  ...
  <div class="sb-footer" id="sb-footer">
    <span id="sb-footer-pos">05 / 28</span> · <span id="sb-footer-title">prosvjetiteljstvo</span>
...
<div class="content-wrap">
  <div class="bc">
    ...
    <span class="bc-cur">H05 · Prosvjetiteljstvo i predromantizam</span>
  ...
  <div class="hero">
    ...
    <div class="hero-chapter">H05 &nbsp;·&nbsp; Svjetska književnost &nbsp;·&nbsp; Prosvjetiteljstvo i predromantizam</div>
    <div class="hero-title">Od razuma<br><span>do osjećaja</span></div>
    <div class="hero-sub">Od <strong>Voltaireovog Candida</strong> do <strong>Goetheovih Patnji mladog Werthera</strong>. 18. stoljeće počinje kao <em>doba razuma</em> i završava <em>pobunom osjećaja</em> — Sturm und Drang uvodi emociju, prirodu i pojedinca kao vrhunac književne vrijednosti. <b>Werther (1774.) je ispitno djelo za esej 2026.</b></div>
    <div class="hero-meta">
      <span class="hchip br">⏱ 60 min</span>
      <span class="hchip go">💔 Fokus: Werther (Goethe)</span>
      <span class="hchip te">▶ H05 prosvjetiteljstvo · predromantizam</span>
    </div>
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button class="tab" onclick="sw(1)" role="tab" aria-selected="false" aria-controls="l1">💔 Werther</button>
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-br">prosvjetiteljstvo</span>
      <span class="pill p-go">werther</span>
      <span class="pill p-t">sturm und drang</span>
      <span class="pill p-r">goethe</span>
      <span class="pill p-pa">predromantizam</span>
    </div>

    <div class="slbl">01 · Zašto uopće ovo učimo</div>

    <div class="box-int">
      <div class="box-int-lbl">💔 Prosvjetiteljstvo i predromantizam — od razuma do osjećaja</div>
      <div class="box-int-txt">
        18. stoljeće ima <em>dvije strane medalje</em>. <strong>Prvi dio</strong> je <b>prosvjetiteljstvo</b> — razum kao mjerilo svega (Voltaire, Rousseau, Diderot, Enciklopedija). <strong>Drugi dio</strong> je <b>predromantizam</b> — reakcija protiv hladnog razuma koja postavlja osjećaj, prirodu i pojedinca u središte (Goethe, Sturm und Drang). <em>Goetheov Werther (1774.)</em> je <strong>kulminacija predromantizma i obavezno ispitno djelo za esej 2026.</strong>
      </div>
    </div>
    ...
    <div class="box-warn">
      ...
      <div class="bw-body">
        ...
        <div class="bw-txt"><strong>Goetheov <em>Werther</em></strong> je <b>ispitno djelo za esej 2026.</b> (30 bodova, 27%). Može dobiti i u čitanju književnog teksta kao ulomak. U <b>teoriji književnosti</b> (12 bodova) traže se pojmovi: racionalizam, empirizam, filozofski roman, Enciklopedija, <em>Sturm und Drang</em>, <em>predromantizam</em>, epistolarni roman, Weltschmerz, verterizam.</div>
      </div>
    </div>
    ...
    <div class="soft-hint">
      ...
      <div class="soft-hint-body">
        Tema <b>Werther i Sturm und Drang</b> te pojam <b>predromantizam</b> pojavljuju se na većini matura iz hrvatskog — Werther je jedno od 6 obveznih esejskih djela 2026.
      </div>
      <a href="/discere?q=werther&ctx=h05_soft_hint" class="soft-hint-link" onclick="track('upsell_click',{ctx:'soft_hint_werther',target:'discere'},'conversion')">Pogledaj u Discere →</a>
    </div>
    ...
    <div class="diag" id="diag" data-state="intro">
      ...
      <div class="diag-intro">
        ...
        <div class="diag-desc">5 brzih pitanja iz H05. Saznaj <strong>gdje stojiš prije nego što počneš učiti</strong> — fokusiraj se samo na ono što ti zaista treba.</div>
    ...
    <div class="prose">Ukupno <strong>110 bodova</strong>. <b>Goetheov Werther</b> je ispitno djelo za <em>školski esej (30 bodova, 27%)</em> i može doći kao ulomak u čitanju književnog teksta. Prosvjetiteljstvo i predromantizam pojavljuju se i u teoriji književnosti te čitanju neknjiževnog teksta.</div>

    <div class="tbl">
      <table>
        <thead><tr><th>Cjelina</th><th>Bodovi</th><th>%</th><th>Gdje ulazi ovo poglavlje</th></tr></thead>
        <tbody>
          <tr><td><b>Školski esej</b></td><td>30</td><td>27%</td><td><strong>Werther (Goethe) — ispitno djelo 2026</strong></td></tr>
          <tr><td><b>Čitanje knjiž. teksta</b></td><td>20</td><td>18%</td><td>Ulomci iz Werthera, Voltaireova Candida</td></tr>
          <tr><td>Sažetak</td><td>18</td><td>16%</td><td>—</td></tr>
          <tr><td>Ustroj hrv. jezika</td><td>15</td><td>14%</td><td>—</td></tr>
          <tr><td><b>Teorija i povijest knjiž.</b></td><td>12</td><td>11%</td><td>Prosvjetiteljstvo, predromantizam, Sturm und Drang, epistolarni roman, Weltschmerz</td></tr>
          <tr><td><b>Čitanje neknj. teksta</b></td><td>10</td><td>9%</td><td>Ulomci o Francuskoj revoluciji, Rousseauovom društvenom ugovoru, Sturm und Drangu</td></tr>
          <tr><td>Primjena ustroja</td><td>5</td><td>5%</td><td>—</td></tr>
        </tbody>
      </table>
    </div>

    <!-- SEKCIJA 03: KONTEKST PROSVJETITELJSTVA -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">03 · Kontekst — 18. stoljeće kao doba razuma</div><div class="sec-line"></div></div>

    <div class="prose">Prosvjetiteljstvo (fr. <em>Les Lumières</em>, eng. <em>The Enlightenment</em>, njem. <em>Aufklärung</em>) je intelektualno razdoblje 18. stoljeća koje preoblikuje europsku misao. Ključne ideje:</div>

    <div class="con">
      <div class="cr"><div class="ck br">18. ST.</div><div class="cv"><b>Vremenski okvir.</b> Od kraja 17. st. (Locke, 1689. <em>Esej o ljudskom razumijevanju</em>) do kraja 18. st. Središte: Francuska (1715.–1789.), Engleska (1680.–1750.), njemačko govorno područje (Kant, 1780-ih). Završetak: <strong>Francuska revolucija (1789.)</strong> — prosvjetiteljske ideje postaju politika.</div></div>
      <div class="cr"><div class="ck go">RAZUM</div><div class="cv"><b>Razum kao mjerilo svega.</b> Prosvjetitelji vjeruju da se sva pitanja — religijska, moralna, politička, znanstvena — mogu rješiti <em>razumom i iskustvom</em>. Nasljeđuju Descartesa (racionalizam) i Lockea (empirizam). Pitanje koje postavlja Kant 1784.: <b>„Sapere aude!”</b> — „Usudi se znati!”</div></div>
      <div class="cr"><div class="ck pa">KRITIKA</div><div class="cv"><b>Kritika svega postojećeg.</b> Crkva (kao izvor dogme), monarhija (kao apsolutna vlast), aristokracija (kao privilegirani sloj), predrasude, ropstvo. Voltaireova parola: <em>„Écrasez l'infâme!”</em> — „Satrite tog zloduha!” (misli se na Crkvu). Kritika nije negacija, nego <b>reformatorska energija</b>.</div></div>
      <div class="cr"><div class="ck t">ENCIKLOPEDIJA</div><div class="cv"><b>1751.–1772.</b> <em>Encyclopédie</em> — 17 tomova teksta + 11 tomova ilustracija. Urednici: <strong>Denis Diderot</strong> i <strong>Jean le Rond d'Alembert</strong>. Suradnici: Voltaire, Rousseau, Montesquieu, Holbach. <em>Cilj: cijelo ljudsko znanje u jednoj zbirci, pristupno obrazovanom građaninu.</em> Najveći izdavački projekt 18. st.</div></div>
      <div class="cr"><div class="ck re">REVOLUCIJE</div><div class="cv"><b>Američka (1776.) i francuska (1789.).</b> Prosvjetiteljske ideje — društveni ugovor, razdioba vlasti, ljudska prava — postaju politička stvarnost. <em>Deklaracija nezavisnosti SAD</em> i <em>Deklaracija o pravima čovjeka i građanina</em> (Francuska) direktno proizlaze iz Rousseaua, Lockea i Montesquieua.</div></div>
    </div>

    <div class="box-key">
      <div class="box-key-lbl">💎 Ključna razlika — klasicizam vs prosvjetiteljstvo vs predromantizam</div>
      <div class="box-key-txt">
        <strong>Klasicizam (17. st., H04):</strong> razum disciplinira umjetnost, 3 jedinstva, forma iznad emocije.<br>
        <strong>Prosvjetiteljstvo (18. st., H05):</strong> razum kritizira društvo, književnost kao <em>oružje reforme</em>, filozofski roman.<br>
        <strong>Predromantizam (kraj 18. st. → H06):</strong> reakcija protiv hladnog razuma — <em>osjećaj, priroda, pojedinac</em>. Goetheov <em>Werther</em>, Sturm und Drang.<br>
        Prosvjetiteljstvo je <b>intelektualan</b> — predromantizam je <b>emocionalan</b>. Oboje su prigovori različitim dijelovima klasicizma.
      </div>
    </div>

    <!-- SEKCIJA 04: GOETHE KAO AUTOR -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04 · Goethe — autor Werthera i središnji lik epohe</div><div class="sec-line"></div></div>

    <div class="prose"><strong>Johann Wolfgang von Goethe (1749.–1832.)</strong> je najveći njemački pjesnik svih vremena. Razdoblje njegovog djelovanja zove se <em>„Goetheovo doba”</em>. S 24 godine piše <strong>Patnje mladog Werthera (1774.)</strong> i preko noći postaje europska književna zvijezda. Werther je <strong>obavezno ispitno djelo za esej na maturi 2026.</strong></div>

    <div class="sg">
      <div class="sc"><span class="sc-ico si-br">ŽIVOT</span><div class="sc-name">83 godine svjestranosti</div><div class="sc-desc">Rođen u Frankfurtu 1749. u bogatoj građanskoj obitelji. Studirao pravo u Leipzigu i Strasbourgu. 1772. ljeto u Wetzlaru — zaljubi se u Charlotte Buff → izvor Werthera. 1775. seli u Weimar na poziv vojvode Karla Augusta, postaje ministar. 1786.–88. putovanje u Italiju — <em>prekretnica iz Sturm und Drang u Weimarsku klasiku</em>. Druguje sa Schillerom 1794.–1805. Umire 1832.</div></div>
      <div class="sc"><span class="sc-ico si-go">STURM UND DRANG</span><div class="sc-name">Rana faza (~1770.–1786.)</div><div class="sc-desc">Goethe je <em>centralna figura pokreta Sturm und Drang</em>. U ovoj fazi piše: <em>Götz von Berlichingen</em> (1773., drama iz njemačke povijesti), <em>Patnje mladog Werthera</em> (1774.), lirska zbirka u Strasbourgu (<em>Sesenheimer pjesme</em>). <b>Odbija klasicističku formu</b>, zagovara genija i slobodu stvaranja.</div></div>
      <div class="sc"><span class="sc-ico si-r">WEIMARSKA KLASIKA</span><div class="sc-name">Srednja faza (~1786.–1805.)</div><div class="sc-desc">Nakon Italije Goethe mijenja stil — <em>povratak klasičnoj harmoniji, uravnoteženosti, antičkim uzorima</em>. U ovoj fazi piše: <em>Ifigenija na Tauridi</em> (1787.), <em>Egmont</em> (1788.), <em>Torquato Tasso</em> (1790.), <em>Rimske elegije</em> (1795.), <em>Naukovanje Wilhelma Meistera</em> (1796.), <em>Herman i Dorothea</em> (1797.).</div></div>
      <div class="sc"><span class="sc-ico si-t">FAUST</span><div class="sc-name">Životno djelo (1808., 1832.)</div><div class="sc-desc"><em>Faust I dio</em> (1808.) i <em>Faust II dio</em> (1832., posmrtno). Radio na njemu gotovo 60 godina. Kozmička drama o sukobu dobra i zla, čovjekovoj težnji za spoznajom. <b>Jedno od najvažnijih djela svjetske književnosti.</b> <em>Obrađuje se u H06 Romantizam.</em></div></div>
    </div>

    <div class="box-20">
      <div class="b20-lbl">📚 Goetheova najvažnija djela — sažetak</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>GÖTZ VON BERLICHINGEN (1773.).</b> Drama o njemačkom vitezu iz 16. st. Manifest Sturm und Drang pokreta — junak se bori protiv apsolutizma. Pisana u nehomogenom stilu, krši klasicistička pravila.</div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>PATNJE MLADOG WERTHERA (1774.).</b> <em>Najpoznatije rano Goetheovo djelo.</em> Epistolarni roman o tragičnoj ljubavi mladog umjetnika. Detaljno obrađeno u Tabu 1. <b>Ispitno djelo za esej 2026.</b></div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>IFIGENIJA NA TAURIDI (1787.).</b> Drama u stihovima — Weimarska klasika. Preuzeto iz Euripida. Tema: moralna čistoća Ifigenije pobjeđuje barbarske običaje. Antiteza Wertheru — klasicistička harmonija.</div></li>
        <li class="b20-item"><span class="b20-num">4</span><div class="b20-txt"><b>NAUKOVANJE WILHELMA MEISTERA (1796.).</b> <em>Bildungsroman</em> — roman o sazrijevanju. Mladi Wilhelm Meister putuje svijetom, sazrijeva kroz iskustvo. Tip romana koji postaje standard njemačke književnosti.</div></li>
        <li class="b20-item"><span class="b20-num">5</span><div class="b20-txt"><b>FAUST I/II (1808./1832.).</b> Životno djelo. Učenjak Faust, razočaran jalovošću znanja, sklapa pogodbu s Mefistom. <em>Obrađuje se u H06.</em></div></li>
      </ol>
    </div>

    <div class="box-tip">
      <div class="bt-title">💡 GOETHEOVA EVOLUCIJA — od Werthera do Fausta</div>
      <div class="bt-txt">
        Goethe nije statičan autor. <em>S 24 godine piše impulzivan Werther</em> (Sturm und Drang). <em>S 38 ide u Italiju i mijenja stil</em> u klasicističku harmoniju. <em>Do kraja života radi na Faustu</em> koji spaja oba — Mefistov cinizam i Faustovu težnju. <b>Goethe je prošao kroz sve epohe</b> svoje ere: Sturm und Drang → Weimarska klasika → elementi romantizma. Na eseju: ako te pitaju o Goetheu, spomeni da je Werther <em>samo prva od četiri faze</em> njegovog djelovanja.
      </div>
    </div>

    <!-- SEKCIJA 05: STURM UND DRANG I PREDROMANTIZAM -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">05 · Sturm und Drang — pokret koji je rodio Werthera</div><div class="sec-line"></div></div>

    <div class="prose"><strong>Sturm und Drang</strong> (njem. „Oluja i nalet”) je njemački književni pokret 1770-ih koji je <em>reakcija protiv prosvjetiteljskog racionalizma</em>. Postaje osnova <b>predromantizma</b> i uvod u europski romantizam (H06). Werther je njegovo kulminacijsko djelo.</div>

    <div class="con">
      <div class="cr"><div class="ck br">VRIJEME</div><div class="cv"><b>~1765.–1785.</b> Njemačka, posebno Frankfurt, Strasbourg, Göttingen. Pokret mladih autora (20-30 godina) koji se bune protiv klasicističkih konvencija. Naziv po drami Friedricha Maximiliana Klingera <em>Sturm und Drang</em> (1776.).</div></div>
      <div class="cr"><div class="ck go">IDEJE</div><div class="cv"><b>Osjećaj iznad razuma.</b> Umjetnost kao izraz genija, ne discipliniranog zanata. <em>Priroda, ljubav, smrt, sloboda, pojedinac</em> — centralne teme. Odbacuju se tri jedinstva, aleksandrinac, dvorska retorika. Umjesto toga: spontanost, osobni ton, lirska proza.</div></div>
      <div class="cr"><div class="ck pa">AUTORI</div><div class="cv"><b>Goethe i Schiller</b> kao glavni predstavnici. Goethe: <em>Götz von Berlichingen</em> (1773.), <em>Werther</em> (1774.). Schiller: <em>Razbojnici</em> (1782.). Mladi Goethe je <b>vođa pokreta</b> — Werther postaje njegov manifest.</div></div>
      <div class="cr"><div class="ck t">UZORI</div><div class="cv"><b>Rousseau</b> (priroda, osjećaj, prirodno dobar čovjek). <b>Shakespeare</b> (slobodna dramska forma, psihološki kompleksni likovi). <b>Homer i Ossian</b> (epska dubina, emocija). <em>Odbacivanje francuskog klasicizma</em> (Boileau, Racine, Corneille).</div></div>
      <div class="cr"><div class="ck re">ISHOD</div><div class="cv"><b>Predromantizam = kraj prosvjetiteljstva, početak romantizma.</b> Ideje Sturm und Drang-a evoluirati će u europski romantizam (H06): Byron, Shelley, Puškin, Heine — svi se napajaju iz ovog izvora. Goethe je do kraja života obožavao i odbacivao tu fazu.</div></div>
    </div>

    <div class="box-key">
      <div class="box-key-lbl">💎 Prosvjetiteljstvo vs predromantizam — tabela razlika</div>
      <div class="box-key-txt">
        <strong>Prosvjetiteljstvo (1680.–1770.):</strong> razum, kritika religije, Enciklopedija, filozofski roman, ironija, jasnoća.<br>
        <strong>Predromantizam / Sturm und Drang (~1770.–1785.):</strong> osjećaj, priroda, pojedinac-genij, epistolarni roman, lirska proza, Weltschmerz.<br>
        <strong>Romantizam (~1800.–1850., H06):</strong> emocija, nacionalni identitet, srednjovjekovna fascinacija, demonski junak, fantazija.<br>
        <em>Werther je </em>most<em> između prosvjetiteljstva i romantizma</em> — odbacuje razum, uvodi osjećaj, ali još nije romantizam u punom smislu.
      </div>
    </div>

    <!-- SEKCIJA 06: OSTALI FRANCUSKI PROSVJETITELJI -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">06 · Francuski prosvjetitelji — Voltaire, Rousseau, Diderot, Montesquieu</div><div class="sec-line"></div></div>

    <div class="prose">Iako je deep-dive Werther, <b>prosvjetitelji čine drugu polovicu ovog poglavlja</b> — pojavljuju se u teoriji književnosti i čitanju neknjiževnog teksta. Moraš ih znati.</div>

    <div class="con">
      <div class="cr"><div class="ck br">VOLTAIRE</div><div class="cv"><b>François-Marie Arouet (1694.–1778.)</b> — najsnažnija figura prosvjetiteljstva. <em>Candide ili Optimizam</em> (1759.) — filozofski roman, satira Leibnizova optimizma. <em>Filozofska pisma</em> (1734.), <em>Filozofski rječnik</em> (1764.). Parola: <b>„Écrasez l'infâme!”</b> — napad na vjerski fanatizam. <em>Deist</em> (ne ateist).</div></div>
      <div class="cr"><div class="ck go">ROUSSEAU</div><div class="cv"><b>Jean-Jacques Rousseau (1712.–1778.)</b> — najkontroverznija figura. <em>Društveni ugovor</em> (1762.) — „Čovjek je rođen slobodan, a posvuda je u okovima.” <em>Emil ili o odgoju</em> (1762.). <em>Ispovijesti</em> (1782., posmrtno) — prva moderna autobiografija. <b>Rousseau je ujedno preteča Sturm und Drang</b> — njegov kult prirode i osjećaja utjecao je na Goethea.</div></div>
      <div class="cr"><div class="ck pa">DIDEROT</div><div class="cv"><b>Denis Diderot (1713.–1784.)</b> — glavni urednik <em>Enciklopedije</em> (1751.–1772.), 28 godina rada. 17 tomova teksta + 11 tomova ilustracija. <em>Ramoova sinovica</em>, <em>Jacques fatalist</em>. Preteča moderne proze.</div></div>
      <div class="cr"><div class="ck t">MONTESQUIEU</div><div class="cv"><b>Charles de Montesquieu (1689.–1755.)</b> — pravni teoretičar. <em>Perzijska pisma</em> (1721.) — epistolarni roman. <em>O duhu zakona</em> (1748.) — teorija razdvajanja vlasti (zakonodavna, izvršna, sudska). <b>Temelj moderne demokracije</b>, preuzet u američki Ustav 1787.</div></div>
    </div>

    <div class="box-signal">
      <div class="box-signal-lbl">📚 PROSVJETITELJSKI ŽANROVI — što je novo u 18. stoljeću</div>
      <div class="box-signal-txt">
        <b>1. Filozofski roman</b> (Voltaire <em>Candide</em>, Diderot <em>Ramoova sinovica</em>) — roman kao argument<br>
        <b>2. Epistolarni roman</b> (Montesquieu <em>Perzijska pisma</em>, Rousseau <em>Nova Heloisa</em>, <b>Goethe <em>Werther</em></b>) — priča kroz pisma<br>
        <b>3. Moderna autobiografija</b> (Rousseau <em>Ispovijesti</em>) — iskren prikaz osobnog života<br>
        <b>4. Enciklopedija</b> (Diderot, d'Alembert) — organizirano ljudsko znanje<br>
        <b>5. Bildungsroman / roman odgoja</b> (Rousseau <em>Emil</em>, Goethe <em>Wilhelm Meister</em>) — obrazovanje kao tema romana
      </div>
    </div>

    <!-- SEKCIJA 07: NJEMAČKO I ENGLESKO PROSVJETITELJSTVO -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">07 · Lessing, Kant, Defoe — prosvjetiteljstvo izvan Francuske</div><div class="sec-line"></div></div>

    <div class="prose">Francuska je središte, ali prosvjetiteljstvo je europski fenomen. Ključni autori izvan Francuske:</div>

    <div class="sg">
      <div class="sc"><span class="sc-ico si-br">LESSING</span><div class="sc-name">Nathan Mudri (1779.)</div><div class="sc-desc"><b>Gotthold Ephraim Lessing (1729.–1781.)</b> — njemački prosvjetitelj. <em>Nathan der Weise</em> — drama o vjerskoj toleranciji. Tri religije (kršćanstvo, judaizam, islam) simbolizirane kroz tri prstena. <em>Ljudski karakter važniji od vjerske pripadnosti.</em> Prva velika drama njemačkog prosvjetiteljstva. <b>Werther drži otvoren Lessingov <em>Emilia Galotti</em> u trenutku smrti</b> — simbolička povezanost!</div></div>
      <div class="sc"><span class="sc-ico si-go">KANT</span><div class="sc-name">Što je prosvjetiteljstvo? (1784.)</div><div class="sc-desc"><b>Immanuel Kant (1724.–1804.)</b> — njemački filozof. Esej <em>„Što je prosvjetiteljstvo?”</em> (1784.) — <b>kanonska definicija:</b> „<em>Prosvjetiteljstvo je izlazak čovjeka iz stanja maloljetnosti u koje je sam kriv… Sapere aude! Imaj hrabrosti koristiti svoj razum!</em>” Kantov filozofski sustav (<em>Kritika čistog uma</em>, 1781.) zatvara prosvjetiteljsku epohu.</div></div>
      <div class="sc"><span class="sc-ico si-r">DEFOE</span><div class="sc-name">Robinson Crusoe (1719.)</div><div class="sc-desc"><b>Daniel Defoe (1660.–1731.)</b> — engleski prosvjetiteljski pisac. <em>Robinson Crusoe</em> — tipičan prosvjetiteljski roman: <em>čovjek na pustom otoku koji razumom uspostavlja civilizaciju</em>. Preteča modernog romana, manifest buržoaskog individualizma.</div></div>
      <div class="sc"><span class="sc-ico si-t">SWIFT</span><div class="sc-name">Gulliverova putovanja (1726.)</div><div class="sc-desc"><b>Jonathan Swift (1667.–1745.)</b> — irsko-engleski satiričar. <em>Gulliver's Travels</em> — satira društva kroz fantastična putovanja (Liliput, Brobdingnag, Laputa). <b>Preteča Candida</b> — Voltaire čitao Swifta.</div></div>
    </div>
    ...
    <div class="cheat-card">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Sve što moraš pamtiti — H05</div>
        </div>
      ...
      <div class="cheat-grid">
        ...
        <div class="cheat-col">
          ...
          <table class="cheat-tbl">
            <tr><td><b>1689.–1755.</b></td><td>Montesquieu</td></tr>
            <tr><td><b>1694.–1778.</b></td><td>Voltaire · François-Marie Arouet</td></tr>
            <tr><td><b>1712.–1778.</b></td><td>Jean-Jacques Rousseau</td></tr>
            <tr><td><b>1713.–1784.</b></td><td>Denis Diderot</td></tr>
            <tr><td><b>1719.</b></td><td>Defoe · <em>Robinson Crusoe</em></td></tr>
            <tr><td><b>1748.</b></td><td>Montesquieu · <em>O duhu zakona</em></td></tr>
            <tr><td><b>1751.–1772.</b></td><td>Diderot/d'Alembert · <em>Enciklopedija</em></td></tr>
            <tr><td><b>1755.</b></td><td>Lisabonski potres</td></tr>
            <tr><td><b>1759.</b></td><td>Voltaire · <em>Candide</em></td></tr>
            <tr><td><b>1762.</b></td><td>Rousseau · <em>Društveni ugovor</em></td></tr>
            <tr><td><b>1774.</b></td><td><b>Goethe · <em>Werther</em> (ispitno djelo)</b></td></tr>
            <tr><td><b>1789.</b></td><td>Francuska revolucija</td></tr>
          </table>
        </div>
        ...
        <div class="cheat-col">
          ...
          <ul class="cheat-list">
            <li><b>Prosvjetiteljstvo</b> = razum kao mjerilo svega, 18. st.</li>
            <li><b>Predromantizam / Sturm und Drang</b> = reakcija na razum, osjećaj + priroda (~1770.–1785.)</li>
            <li><b>Weltschmerz</b> = „svjetska bol” — nesklad ideala i stvarnosti (Werther)</li>
            <li><b>Verterizam</b> = kulturni fenomen oponašanja Werthera u Europi</li>
            <li><b>Werther efekt</b> = val samoubojstava po uzoru na Werthera</li>
            <li><b>Epistolarni roman</b> = roman u pismima (Werther, Perzijska pisma)</li>
            <li><b>Filozofski roman</b> = roman kao argument (Candide)</li>
            <li><b>Racionalizam</b> = razum izvor spoznaje (Descartes)</li>
            <li><b>Empirizam</b> = iskustvo izvor spoznaje (Locke)</li>
            <li><b>Društveni ugovor</b> = Rousseauov koncept političke legitimacije</li>
            <li><b>Razdvajanje vlasti</b> = Montesquieu (zakonodavna/izvršna/sudska)</li>
            <li><b>„Sapere aude!”</b> = Kantova parola „Usudi se znati!”</li>
          </ul>
        </div>

        <!-- Werther — esencijalno -->
        <div class="cheat-col cheat-col-wide">
          <div class="cheat-col-ttl">💔 Werther — esencijalno za esej</div>
          <div class="cheat-grid-inner">
            <div>
              <div class="cheat-mini-ttl">Autor · godina · vrsta</div>
              <div class="cheat-mini-txt"><b>Goethe, 1774.</b> Epistolarni roman — 98 Wertherovih pisama Wilhelmu + dnevnički zapisi + „Izdavač čitatelju”. Pisan u 4 tjedna. Sturm und Drang / predromantizam.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Povod · tema</div>
              <div class="cheat-mini-txt"><b>Povod:</b> Goetheova ljubav prema Charlotti Buff + samoubojstvo prijatelja Jerusalema. <b>Tema:</b> neuzvraćena ljubav, Weltschmerz, sukob pojedinca i društva.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">4 centralna sukoba</div>
              <div class="cheat-mini-txt">
                1. <em>Osjećaj</em> (Werther) vs <em>razum</em> (Albert)<br>
                2. <em>Pojedinac</em> vs <em>društvo</em> (grof, birokracija)<br>
                3. <em>Ljubav</em> vs <em>dužnost</em> (Lotte)<br>
                4. <em>Priroda</em> vs <em>civilizacija</em>
              </div>
            </div>
            <div>
              <div class="cheat-mini-ttl">5 ključnih scena</div>
              <div class="cheat-mini-txt">
                1. 16.6.1771. Kruh + ladanjski bal<br>
                2. Rasprava s Albertom o samoubojstvu<br>
                3. Poniženje kod grofa<br>
                4. Studeni 1772. Ossian zamjenjuje Homera<br>
                5. 22.12.1772. Samoubojstvo s Albertovim pištoljima
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Goethe — esencijalno -->
        <div class="cheat-col cheat-col-wide">
          <div class="cheat-col-ttl">✍ Goethe — 4 faze djelovanja</div>
          <div class="cheat-grid-inner">
            <div>
              <div class="cheat-mini-ttl">Sturm und Drang (~1770.–1786.)</div>
              <div class="cheat-mini-txt"><em>Götz von Berlichingen</em> (1773.), <b>Werther (1774.)</b>. Osjećaj, pobuna protiv klasicizma.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Weimarska klasika (~1786.–1805.)</div>
              <div class="cheat-mini-txt">Nakon Italije — <em>Ifigenija na Tauridi</em> (1787.), <em>Torquato Tasso</em> (1790.). Povratak klasičnoj harmoniji.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Wilhelm Meister</div>
              <div class="cheat-mini-txt"><em>Naukovanje Wilhelma Meistera</em> (1796.) — arhetipski Bildungsroman. Postavlja standard njemačkog romana.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Faust (1808./1832.)</div>
              <div class="cheat-mini-txt">Životno djelo. <em>Faust I</em> i <em>Faust II</em>. 60 godina rada. <b>Obrađuje se u H06 Romantizam.</b></div>
            </div>
          </div>
        </div>

        <!-- Prosvjetitelji — esencijalno -->
        <div class="cheat-col cheat-col-wide">
          <div class="cheat-col-ttl">📚 Voltaire · Rousseau · Diderot · Montesquieu</div>
          <div class="cheat-grid-inner">
            <div>
              <div class="cheat-mini-ttl">Voltaire (1694.–1778.)</div>
              <div class="cheat-mini-txt"><em>Candide</em> (1759.), <em>Filozofska pisma</em>. <b>„Écrasez l'infâme!”</b> Deist, kritičar fanatizma.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Rousseau (1712.–1778.)</div>
              <div class="cheat-mini-txt"><em>Društveni ugovor</em> (1762.), <em>Emil</em>. <b>„Čovjek je rođen slobodan, a posvuda je u okovima.”</b> Preteča Sturm und Drang.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Diderot (1713.–1784.)</div>
              <div class="cheat-mini-txt">Glavni urednik <em>Enciklopedije</em>. 28 godina rada, 17+11 tomova.</div>
            </div>
            <div>
              <div class="cheat-mini-ttl">Montesquieu (1689.–1755.)</div>
              <div class="cheat-mini-txt"><em>O duhu zakona</em> (1748.). <b>Razdvajanje vlasti</b> — temelj moderne demokracije.</div>
            </div>
          </div>
        </div>
        ...
        <div class="cheat-col cheat-col-wide">
          ...
          <ol class="cheat-steps">
            ...
            <li><b>Razrada 1</b> — povijesni kontekst (Sturm und Drang, 1774.) + povezivanje s tezom</li>
            <li><b>Razrada 2</b> — centralni sukob ili scena (Werther/Lotte/Albert, bal, Ossian, samoubojstvo) + citat</li>
            <li><b>Razrada 3</b> — povezivanje s drugim djelom ili razdobljem (Rousseau, prosvjetiteljstvo, romantizam)</li>
        ...
        <div class="cheat-col cheat-col-wide cheat-col-warn">
          ...
          <ul class="cheat-list cheat-list-warn">
            <li><b>NE tvrdi da je Werther prosvjetiteljsko djelo</b> — Werther je <em>predromantizam</em> (Sturm und Drang), antiteza prosvjetiteljskom razumu</li>
            <li><b>NE tretiraj Wertherovo samoubojstvo kao Goetheov ideal</b> — Goethe dodaje uvod 1787. koji upozorava: „I ti budi čovjek i ne slijedi njegov primjer”</li>
            <li>Ne tretiraj <b>Alberta kao zlikovca</b> — on je pozitivan lik, predstavlja razum. Tragedija je sistemska, ne personalna</li>
            <li>Reći da Voltaire napada „religiju uopće” — napada <em>fanatizam i inkviziciju</em>. On je <b>deist</b>, ne ateist</li>
            <li>Zamijeniti <b>Enciklopediju</b> (Diderot, 1751.) s <b>Encyclopaedia Britannica</b> (1768.) — Francuska je prva</li>
            <li>Brkati Voltairea i Rousseaua — oni su <b>intelektualni rivali</b>. Voltaire je urbani racionalist, Rousseau emocionalni pobornik „prirode”</li>
    ...
    <div class="nav-row">
      ...
      <span class="nb primary" onclick="sw(1)">💔 Werther deep-dive →</span>
    </div>
  </div>
  <!-- ════════════════════════
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-br">1774. godina</span>
      <span class="pill p-go">epistolarni roman</span>
      <span class="pill p-r">Sturm und Drang</span>
      <span class="pill p-t">predromantizam</span>
      <span class="pill p-pa">Goethe</span>
    </div>

    <div class="box-int">
      <div class="box-int-lbl">💔 Zašto Werther zaslužuje poseban tab</div>
      <div class="box-int-txt">
        <strong>Patnje mladog Werthera</strong> (1774.) je <strong>obavezno ispitno djelo za esej na maturi 2026.</strong> Napisan u četiri tjedna od 24-godišnjeg Goethea, epistolarni roman o tragičnoj ljubavi mladog umjetnika prema zaručenoj Lotte pokrenuo je <em>Sturm und Drang</em>, izazvao europsku „Werther groznicu” i val samoubojstava (<b>verterizam</b>). Roman je <b>antiteza prosvjetiteljskom razumu</b> — pobjedonosno postavlja osjećaj, prirodu i pojedinca iznad društvenih konvencija. Ako postoji jedno djelo koje moraš znati u dubinu iz ovog poglavlja — <strong>neka to bude ovo</strong>.
      </div>
    </div>
    ...
    <div class="sg">
      <div class="sc"><span class="sc-ico si-br">AUTOR</span><div class="sc-name">Johann Wolfgang von Goethe</div><div class="sc-desc">(1749.–1832.) Najveći njemački pjesnik svih vremena. Werther napisao s <em>24 godine</em>. Kasnije plemstvo, ministar u Weimaru, znanstvenik. Cijelo razdoblje njegovog djelovanja zove se <b>„Goetheovo doba”</b>. Druga kapitalna djela: <em>Faust I/II</em>, <em>Naukovanje Wilhelma Meistera</em>, <em>Ifigenija na Tauridi</em>.</div></div>
      <div class="sc"><span class="sc-ico si-go">NAPISANO</span><div class="sc-name">1774.</div><div class="sc-desc">Napisano za samo <em>4 tjedna</em> u zanosu. Goethe preraditi će 1787. (verzija iz 1774. je „originalna” i obično se čita). Prevoden na sve europske jezike, izazvao europsku <b>„Werther groznicu”</b> — prvi književni bestseller moderne Europe.</div></div>
      <div class="sc"><span class="sc-ico si-r">VRSTA</span><div class="sc-name">Epistolarni roman</div><div class="sc-desc">Roman u formi pisama — <em>98 Wertherovih pisama</em> upućenih prijatelju Wilhelmu, plus dnevnički zapisi i „Izdavačeva” bilješka na kraju. Sentimentalni roman s psihološkom dubinom. Uzor: Richardsonova <em>Pamela</em> (1740.) i <em>Clarissa</em> (1748.).</div></div>
      <div class="sc"><span class="sc-ico si-t">STRUKTURA</span><div class="sc-name">Dva dijela + „Izdavač čitatelju”</div><div class="sc-desc"><b>Knjiga prva</b> — svibanj 1771. do rujna 1771. (Werther upoznaje Lottu, nada). <b>Knjiga druga</b> — listopad 1771. do prosinca 1772. (očaj, povratak, samoubojstvo). <b>Izdavač čitatelju</b> — narativni okvir, opisuje Wertherov kraj iz trećeg lica jer Werther više ne može pisati.</div></div>
      <div class="sc"><span class="sc-ico si-pa">MJESTO RADNJE</span><div class="sc-name">Wahlheim (izmišljeni)</div><div class="sc-desc">Malo njemačko mjesto kraj kojega Werther boravi. Prototip: <b>Wetzlar</b>, gdje je Goethe stvarno proveo ljeto 1772. i zaljubio se u Charlotte Buff. Wahlheim je simbol idilične prirode nasuprot nerazumijevajućem gradu-društvu.</div></div>
      <div class="sc"><span class="sc-ico si-re">FORMA I STIL</span><div class="sc-name">Subjektivan, osjećajan, eliptičan</div><div class="sc-desc">Pisan u <em>prvom licu</em> — intimna ispovijest. Mnogo uskličnika, inverzija, pokazuje <b>preplavljenost osjećajima</b>. Lirski odjeli o prirodi. Izravno se suprotstavlja klasicističkoj retorici i objektivnosti.</div></div>
    </div>

    <div class="box-signal">
      <div class="box-signal-lbl">⚡ AUTOBIOGRAFSKI POVOD — Goethe i Charlotte Buff</div>
      <div class="box-signal-txt">
        Ljeto 1772. Goethe je u Wetzlaru na pravnoj praksi. Upoznaje <strong>Charlotte („Lotte”) Buff</strong>, 19-godišnju zaručnicu njegovog prijatelja <strong>Johanna Kestnera</strong>. Zaljubi se. Nakon mjeseci agonije, <em>bježi iz Wetzlara</em>. Listopad 1772. — njegov prijatelj <strong>Karl Wilhelm Jerusalem</strong> počini samoubojstvo zbog neuzvraćene ljubavi prema udatoj ženi. Goethe kombinira vlastitu zaljubljenost s Jerusalemovim tragičnim krajem i <b>u 4 tjedna 1774. piše Werther</b>. <em>„Pisao sam Wertherom da se spasim samoubojstva.”</em>
      </div>
    </div>

    <!-- SEKCIJA 02: RADNJA U 10 REČENICA -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">02 · Radnja — u 10 etapa</div><div class="sec-line"></div></div>

    <div class="prose">Roman nema klasičnu dramsku strukturu — pratimo Wertherov <em>unutarnji put</em> kroz njegova pisma prijatelju Wilhelmu. Evo 10 ključnih etapa:</div>

    <div class="box-20">
      <div class="b20-lbl">💔 Kompletna radnja u 10 etapa</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>DOLAZAK U WAHLHEIM (svibanj 1771.).</b> Werther, mladi umjetnik plemenitog građanskog podrijetla, dolazi u malo mjesto Wahlheim. Bježi od neuzvraćene ljubavi i majčinskih obveza. Uživa u prirodi, slikanju, jednostavnom seoskom životu. Prva pisma prijatelju <b>Wilhelmu</b> su euforična.</div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>SUSRET S LOTTOM — LADANJSKI BAL (16. lipnja 1771.).</b> Werther prvi put vidi Charlotte („Lottu”) kako njezinih 8 mlađe braće i sestara hrani kruhom nakon majčine smrti. <em>Slika materinske brižnosti.</em> Odlaze na bal. Za vrijeme oluje plešu, otkrivaju da vole iste pisce (Homer, Klopstock). Werther ju pogleda — <b>zaljubljuje se do smrti</b>. <em>Problem:</em> Lotte je zaručena za <b>Alberta</b>.</div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>LJETO PROVEDENO S LOTTOM.</b> Dok je Albert odsutan po poslovnim obvezama, Werther provodi sve više vremena u Lottinoj kući. Pomaže joj s braćom i sestrama, šeta, razgovara o književnosti. <em>Platoničan, ali eskalirajući odnos</em> — Lotte ga voli kao prijatelja, Werther u njoj vidi idealnu ženu. Pisma Wilhelmu postaju zanosna.</div></li>
        <li class="b20-item"><span class="b20-num">4</span><div class="b20-txt"><b>ALBERTOV POVRATAK.</b> Albert se vraća, sprijatelji se s Wertherom. Njih dvojica su potpune suprotnosti — <em>Werther (osjećajan, impulzivan) vs Albert (razuman, staložen)</em>. Imaju filozofsku raspravu o samoubojstvu: Albert ga osuđuje kao slabost, Werther brani kao legitiman čin slobode. <em>Nagovještaj kraja.</em></div></li>
        <li class="b20-item"><span class="b20-num">5</span><div class="b20-txt"><b>BIJEG IZ WAHLHEIMA (rujan 1771.).</b> Werther shvaća da ne može živjeti u istom mjestu s Lottom i Albertom. Prijatelj Wilhelm ga zamoli da se vrati u grad i preuzme posao pri poslaničkom dvoru. <em>Werther pristane iz razuma, iako srce krvari.</em></div></li>
        <li class="b20-item"><span class="b20-num">6</span><div class="b20-txt"><b>POSAO PRI POSLANIKU (jesen 1771. – proljeće 1772.).</b> Werther radi u birokraciji, ne pripada tamo. <em>Sukob s aristokratskim društvom</em> — na večeri kod grofa, plemići ga zahtijevaju da napusti jer je samo građanin. <b>Ponižavajuće iskustvo</b>. Werther daje ostavku.</div></li>
        <li class="b20-item"><span class="b20-num">7</span><div class="b20-txt"><b>POVRATAK U WAHLHEIM (srpanj 1772.).</b> Werther se vraća, ali zatiče <em>Lottu i Alberta već vjenčane</em>. Njegovo je stanje duboko izmijenjeno. Više ne piše Wilhelmu s euforijom — pisma su mračna, nestabilna. Priroda koja ga je prije veselila sad ga deprimira.</div></li>
        <li class="b20-item"><span class="b20-num">8</span><div class="b20-txt"><b>OSSIAN I EMOCIONALNI POTRES (studeni 1772.).</b> Werther počinje čitati Ossianove pjesme (škotske epske pjesme punih melanholije). Homer (klasicistički ideal) zamjenjen je Ossianom (predromantičarska tamna elegija). <em>Umjesto Homerove jasnoće, Werther traži Ossianovu maglu i smrt.</em> Simbolička promjena u Wertherovom duhu.</div></li>
        <li class="b20-item"><span class="b20-num">9</span><div class="b20-txt"><b>POSLJEDNJI SUSRET (20. prosinca 1772.).</b> Albert je otputovao. Werther posjeti Lottu. Čitaju zajedno ulomke Ossiana — <em>„Jadi Selme”</em>. Oboje plaču. U trenutku nekontrolirane strasti, <b>Werther zagrli i poljubi Lottu</b>. Ona je zgrožena, odbije ga, pobjegne u drugu sobu. Werther odlazi — znajući da je to <em>kraj</em>.</div></li>
        <li class="b20-item"><span class="b20-num">10</span><div class="b20-txt"><b>SAMOUBOJSTVO (22. prosinca 1772.).</b> Werther piše oproštajno pismo Lotti. Pošalje slugu da zatraži od Alberta njegove pištolje — kao da ide na put. <em>Lotte ih vlastoručno daje sluzi, drhtava od lošeg predosjećaja.</em> Werther u ponoć ispaljuje metak u glavu. Umire tek sljedećeg jutra. Ostavlja otvoren Lessingov <em>Emilia Galotti</em>. <b>Pokopan bez svećenika, između dvije lipe, ispratili ga samo obrtnici.</b></div></li>
      </ol>
    </div>

    <!-- SEKCIJA 03: DRAMATIS PERSONAE -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">03 · Likovi — ljubavni trokut i okolina</div><div class="sec-line"></div></div>

    <div class="prose">Werther ima malo likova, ali svaki je <em>psihološki razrađen</em> (barem u Wertherovoj percepciji). Epistolarna forma znači da sve vidimo kroz jedan — Wertherov — subjektivan pogled.</div>

    <div class="tbl">
      <table>
        <thead><tr><th>Lik</th><th>Uloga</th><th>Karakterizacija</th></tr></thead>
        <tbody>
          <tr><td><b>Werther</b></td><td>Protagonist, pripovjedač</td><td><em>Mladi umjetnik, građansko podrijetlo</em>. Preosjetljiv, strastven, nekonformist. Voli Homera, Klopstocka, prirodu, slikanje. Odbija društvene konvencije. <b>Sturm und Drang heroj</b> — genij kojeg sputava okolina. Tragična mana: <em>apsolutizam osjećaja</em>.</td></tr>
          <tr><td><b>Lotte (Charlotte)</b></td><td>Predmet Wertherove ljubavi</td><td><em>Zaručena/udata za Alberta, brine se o 8 mlađe braće i sestara</em> (majka umrla). Lijepa, brižna, „majčinska”. Voli Werthera iskreno — <em>kao prijatelja</em>. Razdvojena između dužnosti i osjećaja. Plakala je kada je dala sluzi Albertove pištolje.</td></tr>
          <tr><td><b>Albert</b></td><td>Lottin zaručnik/suprug</td><td><em>Racionalan, staložen, buržoaski pouzdan</em>. Prava antiteza Wertheru. Nije zlikovac — voli Lottu, poštuje Werthera, ali ne razumije njegovu ekstremnu osjećajnost. Debatira s Wertherom o samoubojstvu. <b>Predstavnik prosvjetiteljskog razuma.</b></td></tr>
          <tr><td><b>Wilhelm</b></td><td>Wertherov prijatelj, primatelj pisama</td><td><em>Nikada se ne pojavljuje „u kadru”</em> — saznajemo za njega samo kroz Wertherova pisma. Glas razuma, pokušava Werthera urazumjeti. <b>Njegova uloga je pasivni slušatelj</b> — preko njega čitatelj dobija pristup Wertherovoj psihi.</td></tr>
          <tr><td><b>Izdavač</b></td><td>Narativni okvir</td><td>Pojavljuje se u zadnjem dijelu kao pripovjedač u trećem licu — <em>jer Werther više ne može pisati</em>. Opisuje posljednje dane i samoubojstvo. <b>Metanarativna tehnika</b> — čitatelj shvaća da cijelu knjigu drži u ruci „izdavač”, ne sam Werther.</td></tr>
          <tr><td><b>Lottin otac (sudac S.)</b></td><td>Patrijarh obitelji</td><td>Udovac s 8 djece. Lotte ga pomaže zamijeniti kao roditelj. Simbol patrijarhalnog poretka i obiteljske dužnosti — <em>razloga zbog kojeg Lotte ne može slijediti srce</em>.</td></tr>
          <tr><td><b>Lottina braća i sestre</b></td><td>Simbol Lottine „majčinske” uloge</td><td>Osam djece koju Lotte hrani, odgaja, brine o njima. <b>Werther ih voli kao da su njegova</b>. Njihov kruh (prva scena) — Wertherovo prvo „upisivanje” Lotte u srce.</td></tr>
          <tr><td><b>Seljak zaljubljen u udovicu</b></td><td>Paralelna priča, upozorenje</td><td>Werther upoznaje seljaka koji radi kod udovice. Seljak je zaljubljen u nju. <em>Na kraju seljak ubija drugog muškarca zbog ljubomore</em>. <b>Werther u njemu vidi sebe</b> — alarm koji mu se ne dopire.</td></tr>
        </tbody>
      </table>
    </div>

    <div class="box-tip">
      <div class="bt-title">💡 ZAŠTO ALBERT NIJE ZLIKOVAC? Ključ razumijevanja romana</div>
      <div class="bt-txt">Površno čitanje tretira Alberta kao „suparnika” koji stoji između Werthera i Lotte. <strong>Ali Goethe ga namjerno čini pozitivnim likom</strong> — brižnim, poštenim, razumnim. Zašto? Jer je poruka: <em>Wertherov poraz nije zbog loše sreće ili zlog suparnika — poraz je sistemski</em>. Ako i Lotte odgovori na njegovu ljubav, i Albert je dobar čovjek — onda <b>tragedija leži u samoj strukturi društva i Wertherovoj nemogućnosti da se uklopi</b>. Na eseju: <em>„Albert nije antagonist, nego zrcalo: on je sve ono što Werther ne može biti — i zato je Wertherov pad neizbježan.”</em></div>
    </div>

    <!-- SEKCIJA 04: CENTRALNI SUKOBI -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">04 · Centralni sukobi — sloj po sloj</div><div class="sec-line"></div></div>

    <div class="prose">Werther nije roman s jednim sukobom — to je roman u kojem se pojedinac sudara s nizom barijera. Evo 4 razine:</div>

    <div class="con">
      <div class="cr"><div class="ck br">SUKOB 1</div><div class="cv"><b>Osjećaj vs razum.</b> Centralni sukob cijelog djela — i cijelog Sturm und Drang pokreta. Werther vjeruje da je <em>osjećaj jedini izvor istine</em>. Albert vjeruje da razum kontrolira osjećaj. Scena u II/(kraj kolovoza 1771.): <em>filozofska rasprava o samoubojstvu</em> — Albert ga osuđuje, Werther brani. <b>Goethe je namjerno postavio taj razgovor — kao anticipaciju kraja.</b></div></div>
      <div class="cr"><div class="ck go">SUKOB 2</div><div class="cv"><b>Pojedinac vs društvo.</b> Werther se ne uklapa nigdje. Kao građanin odbačen je od plemića (scena kod grofa). Kao umjetnik odbačen je od birokracije. Kao ljubavnik odbačen je od braka. <em>„Ja sam jedinstven, svijet ne zna za mene.”</em> <b>Rani izraz moderne otuđenosti</b> — preteča egzistencijalističkih romana.</div></div>
      <div class="cr"><div class="ck pa">SUKOB 3</div><div class="cv"><b>Ljubav vs dužnost.</b> Lottin sukob. Voli Werthera kao prijatelja, ali dužna je Albertu. Goethe ne romantizira <em>bijeg zbog ljubavi</em> — Lotte ostaje vjerna zaručniku/suprugu. <b>Dužnost pobjeđuje, ali cijena je Wertherova smrt.</b> Dvojna tragedija — njen brak nakon njegove smrti neće biti sretan.</div></div>
      <div class="cr"><div class="ck t">SUKOB 4</div><div class="cv"><b>Priroda vs civilizacija.</b> Werther se osjeća živim u prirodi (prvi dio romana — bujna ljetna idila) i mrtvim u gradu (drugi dio — birokracija, hladnoća). <em>Rousseauovski motiv</em>. Ali Goethe ga razvija dalje: <b>čak i priroda se u drugoj knjizi mijenja</b> — zimska pustoš odgovara Wertherovom unutarnjem krajoliku. <em>Priroda postaje ogledalo duše.</em></div></div>
    </div>

    <div class="box-warn">
      <div class="bw-ico">⚠</div>
      <div class="bw-body">
        <div class="bw-title">Goethe NE hvali Wertherovo samoubojstvo — i uvijek to zapamti</div>
        <div class="bw-txt">Površna čitanja tretiraju roman kao <em>glorifikaciju samoubojstva</em>. Nije. Goethe je kasnije (1787.) <b>dodao uvod</b> koji izričito upozorava: <em>„I ti budi čovjek i ne slijedi njegov primjer.”</em> Posljedica Wertherovog efekta na mlade (val samoubojstava) bila mu je <em>užasavajuća</em>. <b>Goethe istražuje, ne propagira.</b> Werther je <em>klinički prikaz</em> emocionalne bolesti koja vodi u smrt — ne recept.</div>
      </div>
    </div>

    <!-- SEKCIJA 05: WERTHER KAO STURM UND DRANG HEROJ -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">05 · Werther kao Sturm und Drang heroj</div><div class="sec-line"></div></div>

    <div class="prose">Da bi se razumio Werther, moraš znati <strong>što je Sturm und Drang</strong> i kako se Werther razlikuje od prethodnih junaka. To je centralno za razumijevanje predromantizma kao epohe.</div>

    <div class="cmp-tbl-wrap">
      <div class="cmp-tbl-hint">Comparison — klasicistički junak vs Sturm und Drang junak</div>
      <table class="cmp-tbl">
        <thead>
          <tr><th class="cmp-cat">Dimenzija</th><th>Klasicistički junak (Cid, Fedra)</th><th>Sturm und Drang junak (Werther)</th></tr>
        </thead>
        <tbody>
          <tr>
            <td class="cmp-cat">Primarni pogon</td>
            <td>Dužnost, čast, razum</td>
            <td>Osjećaj, strast, subjektivnost</td>
          </tr>
          <tr>
            <td class="cmp-cat">Odnos prema društvu</td>
            <td>Slijedi norme (čak i uz cijenu ljubavi)</td>
            <td>Odbacuje norme koje ga guše</td>
          </tr>
          <tr>
            <td class="cmp-cat">Način izražavanja</td>
            <td>Aleksandrinac, retorička jasnoća</td>
            <td>Proza, inverzija, uskličnici, fragmentaran</td>
          </tr>
          <tr>
            <td class="cmp-cat">Odnos prema prirodi</td>
            <td>Priroda je kulisa</td>
            <td>Priroda je ogledalo duše</td>
          </tr>
          <tr>
            <td class="cmp-cat">Kraj</td>
            <td>Plemenita smrt za čast</td>
            <td>Samoubojstvo kao bijeg iz nepodnošljivog</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="box-key">
      <div class="box-key-lbl">⭐ Pojam „Weltschmerz” — nauči napamet</div>
      <div class="box-key-txt">
        <strong>Weltschmerz</strong> (njem.) — <em>„svjetska bol”</em>. Pojam koji ulazi u europsku kulturu preko Werthera. Označava <em>osjećaj da svijet ne može zadovoljiti duboke čežnje pojedinca</em> — melankolija pred nesavršenošću stvarnosti. <b>Werther je prvi književni junak koji pati od Weltschmerza.</b> Ovaj pojam postaje centralan za romantizam (H06) — Byron, Leopardi, naši vlastiti romantičari će ga preuzeti.<br>
        Na eseju: <em>„Werther utjelovljuje pojam Weltschmerza — svjetske boli mladih koji osjećaju nesklad između svojih ideala i stvarnosti.”</em>
      </div>
    </div>
    ...
    <div class="prose">Ako imaš samo 10 minuta pred maturu, ponovi ovih pet scena. Iz njih se može argumentirati bilo koja teza.</div>

    <div class="sg">
      <div class="sc"><span class="sc-ico si-br">16. lipnja 1771.</span><div class="sc-name">Scena kruha i susret na balu</div><div class="sc-desc">Werther prvi put vidi Lottu kako reže kruh za 8 male braće i sestara, nakon smrti majke. <em>Slika materinske brižnosti</em> — simbol zašto je voli. Zatim zajedno odlaze na ladanjski ples. Oluja razbije zabavu, Lotte spasi atmosferu predlaganjem igre. Werther se zaljubljuje. <b>Zašto važno:</b> uspostavlja Lottin kompleksan lik — <em>ona nije samo ljubavnica, ona je „majka” svijeta koji Werther želi</em>.</div></div>
      <div class="sc"><span class="sc-ico si-go">kraj kolovoza 1771.</span><div class="sc-name">Rasprava s Albertom o samoubojstvu</div><div class="sc-desc">Werther i Albert debatiraju. <em>Albert:</em> „Samoubojstvo je slabost, bijeg od dužnosti.” <em>Werther:</em> „Samoubojstvo je legitimno kad je bol apsolutna, kao groznica — čovjek ne može nadvladati prirodu.” <b>Zašto važno:</b> Wertherov apsolutizam osjećaja. Goethe namjerno postavlja raspravu kao <em>nagovještaj kraja</em> — Werther će upravo tako umrijeti.</div></div>
      <div class="sc"><span class="sc-ico si-r">veljača 1772.</span><div class="sc-name">Poniženje kod grofa (dvorsko društvo)</div><div class="sc-desc">Werther je pozvan na večeru kod grofa C. Kad su stigli plemići, pogledom traže da Werther (građanin) ode. Grof ga mora pristojno otpustiti. <em>Javno poniženje</em>. Werther daje ostavku iz službe, vraća se u Wahlheim. <b>Zašto važno:</b> <em>sukob klasa u 18. stoljeću</em>. Ovdje Werther postaje jasan: društvo ga nikada neće prihvatiti. Prosvjetiteljska teza o jednakosti — <em>ostaje teza</em>, praksa je drugačija.</div></div>
      <div class="sc"><span class="sc-ico si-t">studeni 1772.</span><div class="sc-name">Ossian zamjenjuje Homera</div><div class="sc-desc">U prvoj knjizi Werther čita <em>Homera</em> — klasicističkog pjesnika jasnoće, svjetlosti, radosti života. U drugoj knjizi počinje čitati <em>Ossiana</em> (škotski epski pjesnik tamne melankolije). <em>„Ossian je istisnuo Homera iz mog srca.”</em> <b>Zašto važno:</b> simbolički prikaz Wertherovog psihičkog putovanja od života prema smrti. <b>Ossian = Weltschmerz, predromantizam.</b></div></div>
      <div class="sc"><span class="sc-ico si-pa">22. prosinca 1772.</span><div class="sc-name">Samoubojstvo — scena s pištoljima</div><div class="sc-desc">Werther piše oproštajno pismo. Šalje slugu da zatraži Albertove pištolje pod izlikom putovanja. <em>Lotte ih vlastoručno daje, drhtava — „naslućujući loše”.</em> Werther ih prima, ispaljuje metak u glavu u ponoć. Umire sljedeće jutro. <b>Pokopan bez svećenika, između dvije lipe, ispratili ga samo obrtnici.</b> <b>Zašto važno:</b> scena pištolja (Lotte vlastoručno daje oružje ubojstva ljubljenog) ima <em>tragičku ironiju</em>. Pogreb bez svećenika — Werther odbačen i od crkve. Apsolutna izolacija.</div></div>
    </div>

    <div class="box-signal">
      <div class="box-signal-lbl">📚 WERTHEROVI SIMBOLI — čitaj kao šifru</div>
      <div class="box-signal-txt">
        <b>Plavi frak i žuti prsluk</b> — Wertherova odjeća na balu. Postaje <em>uniforma verterizma</em> — mladići diljem Europe oponašaju. Simbol buntovne mladosti.<br>
        <b>Kruh</b> — prva scena s Lottom. Simbol majčinstva, hranjenja, zajednice.<br>
        <b>Pištolji</b> — Albertovi. Ironija: Albert (razum) posuđuje instrument Wertherove smrti (osjećaj).<br>
        <b>Dvije lipe</b> — gdje je pokopan. Mjesto koje je sam odabrao u prvoj knjizi kao idilično odmaralište. <em>Idila postaje grob.</em><br>
        <b>Lessingov <em>Emilia Galotti</em></b> — otvorena knjiga na njegovom stolu. Tragedija o ženi koja se prije smrti od vlastitog oca no što ostane neudata za nevoljenog. <em>Aluzija na čast i smrt.</em>
      </div>
    </div>
    ...
    <div class="prose">Ako esej pita o temi ili motivu, Werther ti daje pet sigurnih pravaca.</div>

    <div class="con">
      <div class="cr"><div class="ck br">NEUZVRAĆENA LJUBAV</div><div class="cv"><b>Centralna tema.</b> Werther voli, Lotte ga prijateljski voli natrag, ali je zaručena/udata. <em>Tragedija nije u neljubavi, nego u nemogućnosti sjedinjenja</em>. Ljubav kao <b>apsolutno</b>, ne relativno iskustvo — nema „druge Lotte”, nema „nekad ćeš preboljeti”. Moderna romantička koncepcija ljubavi počinje ovdje.</div></div>
      <div class="cr"><div class="ck go">WELTSCHMERZ</div><div class="cv"><b>Svjetska bol.</b> Pojam koji Werther uvodi u europsku književnost. <em>Nesklad između ideala pojedinca i stvarnosti svijeta</em>. Osjećaj da je svijet premalen, društvo pretjesno, ljudi nerazumljivi. Prva psihološka slika modernog otuđenja.</div></div>
      <div class="cr"><div class="ck pa">PRIRODA</div><div class="cv"><b>Rousseauovski motiv.</b> Priroda kao zrcalo i utočište. Prvi dio: ljetna idila, cvijeće, potoci = Wertherova sreća. Drugi dio: zimski krajolik, gole grane = Wertherova propast. <em>Priroda prati psihu — anticipacija romantizma.</em></div></div>
      <div class="cr"><div class="ck t">SUKOB KLASA</div><div class="cv"><b>Buržoaska kritika.</b> Werther (građanin) odbačen od plemića na grofovoj večeri. <em>Prosvjetiteljska teza o jednakosti ostaje teorija.</em> Werther kao lik anticipira Francusku revoluciju (1789.) — 15 godina kasnije.</div></div>
      <div class="cr"><div class="ck re">SAMOUBOJSTVO</div><div class="cv"><b>Kao filozofski problem.</b> Rasprava s Albertom postavlja pitanje: <em>je li samoubojstvo čin slabosti ili legitimna sloboda?</em> Werther brani kao slobodu, Goethe ostavlja otvoreno. Nakon Werthera slijedi <b>val samoubojstava</b> u Europi — <em>Werther efekt</em> — što Goethea duboko uznemiruje.</div></div>
    </div>

    <!-- SEKCIJA 08: VERTERIZAM + VIDEO RESURSI -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">08 · Verterizam, Werther efekt i video resursi</div><div class="sec-line"></div></div>

    <div class="prose">Werther nije samo knjiga — to je <strong>kulturni fenomen</strong> koji je promijenio Europu. Dva pojma koja moraš znati:</div>

    <div class="box-key">
      <div class="box-key-lbl">⭐ Verterizam i Werther efekt — moraš razlikovati</div>
      <div class="box-key-txt">
        <strong>Verterizam</strong> (Werther-izam) — <em>modni i kulturni fenomen</em>. Mladići Europe oponašaju Werthera: oblače plavi frak i žuti prsluk, čitaju Ossiana i Homera, pišu ispovjedna pisma prijateljima, kultiviraju melankoliju. <em>Pojavljuje se čak parfem „Eau de Werther” i motivi na kineskom porculanu.</em> Roman postaje <b>prvi pop-kulturni globalni hit</b>.<br><br>
        <strong>Werther efekt</strong> (pojam moderne psihologije, ~1974.) — <em>statistički dokumentirani val samoubojstava u Europi nakon 1774.</em> Mladići oponašaju Werthera doslovno, čak i u smrti. Neke njemačke države (Leipzig, Kopenhagen) <b>zabranjuju roman</b>. Goethe je užasnut. Moderna psihologija koristi „Werther efekt” za fenomen <em>imitacijskih samoubojstava</em> nakon medijske prezentacije.
      </div>
    </div>

    <div class="prose">Werther je dostupan online i kao audioknjiga. Evo resursa za kontekst:</div>

    <div class="yt-grid">
      <a href="https://www.lektire.hr/patnje-mladog-werthera/" target="_blank" rel="noopener noreferrer" class="yt-card" onclick="track('ext_link_click',{target:'lektire_werther'},'engagement')">
        <div class="yt-thumb">📖</div>
        <div class="yt-body">
          <div class="yt-title">Lektire.hr — Patnje mladog Werthera</div>
      ...
      <a href="https://lektire.skole.hr/wp-content/uploads/2020/01/goethe_patnje-mladoga-wertherae.pdf" target="_blank" rel="noopener noreferrer" class="yt-card" onclick="track('ext_link_click',{target:'skole_werther_pdf'},'engagement')">
        <div class="yt-thumb">📄</div>
        <div class="yt-body">
          <div class="yt-title">Werther — cijeli tekst (PDF)</div>
          <div class="yt-desc">Puni tekst romana u hrvatskom prijevodu (PDF, službeni lektira.skole.hr). Pročitaj, ne prepričavaj.</div>
          <div class="yt-meta"><span>📑 PDF</span><span>🇭🇷 Hrvatski</span></div>
        </div>
      </a>
      <a href="https://www.youtube.com/results?search_query=patnje+mladog+werthera+analiza" target="_blank" rel="noopener noreferrer" class="yt-card" onclick="track('ext_link_click',{target:'yt_werther_hr'},'engagement')">
        <div class="yt-thumb">🎬</div>
        <div class="yt-body">
          <div class="yt-title">YouTube analize na hrvatskom</div>
          <div class="yt-desc">Video analize i pregledi Werthera. Korisno za dopunu čitanja ili brzo ponavljanje pred maturu.</div>
          <div class="yt-meta"><span>🎬 Video</span><span>🇭🇷 Hrvatski</span></div>
        </div>
      </a>
      <a href="https://www.youtube.com/results?search_query=sturm+und+drang+goethe+german+romanticism" target="_blank" rel="noopener noreferrer" class="yt-card" onclick="track('ext_link_click',{target:'yt_sturm_und_drang'},'engagement')">
        <div class="yt-thumb">⚡</div>
        <div class="yt-body">
          <div class="yt-title">Sturm und Drang — kontekst</div>
          <div class="yt-desc">Video dokumentarci o pokretu Sturm und Drang. Potrebno za razumijevanje predromantizma kao tranzicije.</div>
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div class="box-int">
      <div class="box-int-lbl">✍ Kako se piše esej o Wertheru</div>
      <div class="box-int-txt">
        <strong>Werther je ispitno djelo za esej 2026 (30 bodova, 27%).</strong> Ovdje imaš <em>5 provjerenih teza</em> koje pokrivaju gotovo sve tipove zadataka, <em>model uvoda</em> koji možeš adaptirati, i <em>5 tipičnih grešaka</em> koje gube bodove. Esej mora imati <strong>minimum 440 riječi</strong>, trodijelnu strukturu (uvod-razrada-zaključak) i jasno razrađenu središnju tvrdnju.
      </div>
    </div>
    ...
    <div class="box-20">
      <div class="b20-lbl">💡 TEZA 1 — Werther kao utjelovljenje Weltschmerza</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">T</span><div class="b20-txt"><b>Središnja tvrdnja:</b> <em>Werther je prvi književni junak koji utjelovljuje pojam Weltschmerza — svjetske boli pojedinca koji osjeća nepremostiv jaz između svojih ideala i stvarnosti društva.</em></div></li>
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>Arg 1:</b> Wertherova osjetljivost nije patološka — ona je <em>prozor u stvarnost</em> koju drugi ne vide. Njegova pisma Wilhelmu otkrivaju um koji osjeća <b>previše</b>, ne premalo.</div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>Arg 2:</b> Scena poniženja kod grofa (veljača 1772.) pokazuje <em>sistematsku prirodu njegove boli</em> — kao građanin, ne može ući u plemićko društvo usprkos talentu. Weltschmerz nije samoobjikovan, društveno je nametnut.</div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>Arg 3:</b> Prelazak s Homera na Ossiana simbolički prati Wertherov psihološki put — <em>od klasicističke svijetline u predromantičarsku maglu</em>. Ossian postaje književni izraz Weltschmerza.</div></li>
        <li class="b20-item"><span class="b20-num">S</span><div class="b20-txt"><b>Ključna scena:</b> Posljednji susret s Lottom (20.12.1772.) — čitaju <em>Ossianove „Jadi Selme”</em>, plaču, Werther ju poljubi. <em>Weltschmerz dostiže vrhunac</em> — stvarnost više ne može zadržati osjećaje.</div></li>
      </ol>
    </div>

    <div class="box-20">
      <div class="b20-lbl">💡 TEZA 2 — Werther kao Sturm und Drang heroj (sukob pojedinca i društva)</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">T</span><div class="b20-txt"><b>Središnja tvrdnja:</b> <em>Werther je arhetipski Sturm und Drang heroj — genij kojeg sputavaju društvene konvencije, a čija tragedija proizlazi iz fundamentalnog sukoba između pojedinca i poretka.</em></div></li>
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>Arg 1:</b> Werther odbacuje <em>sve tri institucije</em> koje pokušavaju ograničiti pojedinca: <b>crkvu</b> (pokopan bez svećenika), <b>državu</b> (daje ostavku iz službe), <b>brak</b> (ne može prihvatiti Lotte-Albert vezu). Svi klasicistički i prosvjetiteljski autoriteti ruše se.</div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>Arg 2:</b> Albert je namjerno <em>pozitivan lik</em> — brižan, pošten, razuman. Goethe ga ne čini zlikovcem jer bi to banaliziralo sukob. <b>Tragedija je sistemska, ne personalna</b> — nema zlikovca, ali pojedinac ipak pada.</div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>Arg 3:</b> Epistolarni oblik romana je <em>formalni izraz ove teze</em> — daje nam pristup samo Wertherovoj subjektivnosti. <b>Društvo je uvijek izvan, nečujno</b>, dok Wertherov glas ispunjava roman.</div></li>
        <li class="b20-item"><span class="b20-num">S</span><div class="b20-txt"><b>Ključna scena:</b> Rasprava s Albertom o samoubojstvu (kraj kolovoza 1771.). Albert: „slabost, bijeg od dužnosti”. Werther: „legitiman čin slobode kad je bol apsolutna”. <em>Dva svjetonazora sudaraju se — Werther će svoju tezu dokazati vlastitom smrću.</em></div></li>
      </ol>
    </div>

    <div class="box-20">
      <div class="b20-lbl">💡 TEZA 3 — Ljubav vs dužnost: Lottina šutnja</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">T</span><div class="b20-txt"><b>Središnja tvrdnja:</b> <em>Tragedija Werthera nije samo njegova — Lotte je jednako zarobljena u sukobu između ljubavi i dužnosti, a njezina tiha patnja predstavlja srž moralnog problema romana.</em></div></li>
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>Arg 1:</b> Lotte nije pasivna — ona <em>voli Werthera</em>, ali bira dužnost. Scena u kojoj mu daje Albertove pištolje, drhtava, naslućujući smrt, pokazuje da <b>razumije što će se dogoditi, a ipak ne može drugačije</b>.</div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>Arg 2:</b> Njezina uloga „majke” 8 mlađe braće i sestara nakon majčine smrti vezuje je za obiteljski poredak. <em>Lotte ne bira između dvojice muškaraca — bira između pojedinačne sreće i dužnosti prema drugima.</em></div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>Arg 3:</b> Goethe nikad ne daje Lotte vlastita pisma — čujemo je samo kroz Wertherovu perspektivu. <b>Njezina šutnja je dio tragedije.</b> Epistolarna forma podvlači asimetriju — on govori, ona trpi.</div></li>
        <li class="b20-item"><span class="b20-num">S</span><div class="b20-txt"><b>Ključna scena:</b> Scena kruha (16.6.1771.) — Werther vidi Lotte kako reže kruh za 8 braće i sestara. <em>Ta slika ju istovremeno čini predmetom ljubavi i obilježava njezinu dužnost</em>. Zaljubiti se u Lotte znači zaljubiti se u nekoga tko ne može biti slobodan.</div></li>
      </ol>
    </div>

    <div class="box-20">
      <div class="b20-lbl">💡 TEZA 4 — Priroda kao zrcalo duše</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">T</span><div class="b20-txt"><b>Središnja tvrdnja:</b> <em>Priroda u Wertheru nije samo kulisa — ona je psihološki instrument, zrcalo u kojem se Wertherovo unutarnje stanje ogleda i razvija.</em></div></li>
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>Arg 1:</b> U <b>prvoj knjizi</b> (ljeto 1771.) priroda je <em>bujna, topla, plodna</em> — ljetna idila Wahlheima. Werther opisuje cvijeće, potoke, šume s ushitom. <em>Priroda odraža njegovu sreću i nadu.</em></div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>Arg 2:</b> U <b>drugoj knjizi</b> (zima 1772.) priroda postaje <em>pusta, hladna, prijeteća</em>. Jesenska magla i zimska tama odgovaraju Wertherovom očaju. <b>Ista priroda, drugi emocionalni krajolik.</b></div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>Arg 3:</b> Rousseauov utjecaj — priroda kao antiteza civilizaciji. Werther živi u prirodi (Wahlheim), umire kad ga prisile u grad (dvor). <b>Bijeg u grad je bijeg od samog sebe</b>, priroda je jedini prostor autentičnosti.</div></li>
        <li class="b20-item"><span class="b20-num">S</span><div class="b20-txt"><b>Ključna scena:</b> Wertherov posljednji počinak <em>između dvije lipe</em> na mjestu koje je sam izabrao kao idiličnu točku u prvoj knjizi. <b>Idila postaje grob</b> — priroda koja ga je hranila postaje priroda koja ga prima.</div></li>
      </ol>
    </div>

    <div class="box-20">
      <div class="b20-lbl">💡 TEZA 5 — Werther kao most između prosvjetiteljstva i romantizma</div>
      <ol class="b20-list b20-numbered">
        <li class="b20-item"><span class="b20-num">T</span><div class="b20-txt"><b>Središnja tvrdnja:</b> <em>Werther predstavlja prijelomnu točku u europskoj književnosti — odbacuje prosvjetiteljski razum kao mjerilo svega, a istovremeno priprema teren za romantizam koji će dominirati sljedećih 50 godina.</em></div></li>
        <li class="b20-item"><span class="b20-num">1</span><div class="b20-txt"><b>Arg 1:</b> Albert utjelovljuje <em>prosvjetiteljski razum</em>. On čita knjige, drži se konvencija, smatra samoubojstvo slabošću. Werther utjelovljuje <em>predromantičarski osjećaj</em>. <b>Albertov razum gubi — ne intelektualno, nego emotivno.</b></div></li>
        <li class="b20-item"><span class="b20-num">2</span><div class="b20-txt"><b>Arg 2:</b> Roman preuzima <em>prosvjetiteljsku formu</em> (epistolarni roman poput Montesquieuovih <em>Perzijskih pisama</em> i Rousseauove <em>Nove Heloise</em>), ali je ispunjava <em>antiprosvjetiteljskim sadržajem</em> — iracionalnošću, strašću, mistikom smrti.</div></li>
        <li class="b20-item"><span class="b20-num">3</span><div class="b20-txt"><b>Arg 3:</b> <b>Verterizam</b> dokazuje kulturnu prijelomnost — mladi diljem Europe oponašaju Wertherovo ponašanje, odjeću, čak i smrt. Prosvjetiteljska publika 1770-ih okreće se pojedinačnom osjećaju — pripremljena je za Byrona, Puškina, Heinea (H06).</div></li>
        <li class="b20-item"><span class="b20-num">S</span><div class="b20-txt"><b>Ključna scena:</b> Raskid Homera i Ossiana. <b>Homer</b> je Voltaireov i klasicistički ideal — jasnoća, heroizam, svjetlo. <b>Ossian</b> je sturmundrang ideal — magla, melankolija, smrt. <em>Werther izabire Ossiana — i s njim cijelu Europu odvlači u romantizam.</em></div></li>
      </ol>
    </div>
    ...
    <div class="box-key">
      <div class="box-key-lbl">📝 MODEL UVODA · tema: Werther kao utjelovljenje Weltschmerza</div>
      <div class="box-key-txt">
        <em>Johann Wolfgang von Goethe, 24-godišnji njemački pjesnik, u četiri je tjedna 1774. godine napisao epistolarni roman „Patnje mladog Werthera” koji će zauvijek promijeniti europsku književnost. Djelo je nastalo u okviru pokreta Sturm und Drang — predromantičarskog pokreta koji je odbacio prosvjetiteljski racionalizam i uzvisio osjećaj, prirodu i pojedinca kao najviše vrijednosti. Kroz 98 pisama glavnog junaka Werthera upućenih prijatelju Wilhelmu, Goethe je stvorio prvu modernu književnu sliku onoga što će kasnije biti nazvano Weltschmerzom — svjetskom bolju pojedinca koji osjeća nepremostiv jaz između svojih ideala i stvarnosti društva. <strong>U ovom ću eseju pokazati da Wertherova tragedija nije puki rezultat nesretne ljubavi prema Lotte, već da njegov lom predstavlja arhetipski izraz Weltschmerza — osjećaja koji čini most između individualnog iskustva i cijele epohe koja je slijedila.</strong></em>
      </div>
    </div>
    ...
    <div class="box-tip">
      ...
      <div class="bt-txt">
        ...
        <b>(a) Autor+djelo</b> — Goethe, 1774., epistolarni roman, 98 pisama, 24 god.<br>
        <b>(b) Kontekst</b> — Sturm und Drang, predromantizam, reakcija na prosvjetiteljski razum, uzori Rousseau/Shakespeare/Homer/Ossian<br>
        <b>(c) Teza</b> — adaptiraj prema pitanju. Ako pitaju o ljubavi → Teza 3. Ako pitaju o prirodi → Teza 4. Ako pitaju o epohi → Teza 5.
      </div>
    </div>
    ...
    <div class="con">
      <div class="cr"><div class="ck r">GREŠKA 1</div><div class="cv"><b>Tvrdnja da je Werther prosvjetiteljsko djelo.</b> <em>Werther je predromantizam (Sturm und Drang) — antiteza prosvjetiteljskom razumu.</em> Goethe namjerno piše protiv Voltairea i Albertove racionalnosti. Werther stoji na prijelazu — izrasta iz prosvjetiteljske forme, ali ispunjava je antiprosvjetiteljskim sadržajem.</div></div>
      <div class="cr"><div class="ck r">GREŠKA 2</div><div class="cv"><b>Tvrdnja da Goethe slavi samoubojstvo.</b> <em>Goethe eksplicitno upozorava — u predgovoru drugog izdanja (1787.) piše: „I ti budi čovjek i ne slijedi njegov primjer.”</em> Goethe je užasnut Werther efektom i imitacijskim samoubojstvima. Roman istražuje psihološki kolaps, ne propagira ga.</div></div>
      <div class="cr"><div class="ck r">GREŠKA 3</div><div class="cv"><b>Tretiranje Alberta kao zlikovca.</b> <em>Albert je pozitivan lik — brižan, pošten, razuman.</em> Goethe ga namjerno čini simpatičnim da podvuče: tragedija nije zbog zlog suparnika, nego zbog sistemskog sukoba svjetonazora. Ako tretiraš Alberta kao negativca, promašuješ centralnu Goetheovu poantu.</div></div>
      <div class="cr"><div class="ck r">GREŠKA 4</div><div class="cv"><b>Svođenje romana na „priču o neuzvraćenoj ljubavi”.</b> <em>Werther je psihološki, filozofski i društveni roman.</em> Neuzvraćena ljubav je motor, ne tema. Tema je sukob pojedinca i društva, osjećaja i razuma, prirode i civilizacije. Ako pišeš samo o ljubavi, gubiš dubinu.</div></div>
      <div class="cr"><div class="ck r">GREŠKA 5</div><div class="cv"><b>Prepričavanje radnje umjesto interpretacije.</b> <em>Ocjenjivač zna radnju.</em> Scene navedi sažeto (1-2 rečenice), ali glavni posao je <b>interpretacija</b> — što scena znači za centralnu tvrdnju. Citiraj (kratko!), parafraziraj, povezi s tezom. Esej od 440+ riječi koji samo prepričava radnju dobije maksimalno ocjenu <em>dovoljan</em>.</div></div>
    </div>
    ...
    <div class="box-signal">
      ...
      <div class="box-signal-txt">
        ...
        ☐ Tekst koristi <b>književnopovijesne pojmove</b> (Sturm und Drang, Weltschmerz, epistolarni roman, predromantizam)<br>
        ☐ <b>Kontekst epohe</b> (18. st., prosvjetiteljstvo, Francuska revolucija) — barem spomenut
      </div>
    </div>

    <div class="nav-row">
      <span class="nb" onclick="sw(1)">← 💔 Werther</span>
  ...
  <div class="layer" id="l3" role="tabpanel" tabindex="0">
    <div class="tags">
      ...
      <span class="pill p-r">10 napamet</span>
      <span class="pill p-t">tez + razina + random</span>
    </div>

    <div class="box-int">
      <div class="box-int-lbl">💬 Citati — arsenal za esej o Wertheru i prosvjetiteljstvu</div>
      <div class="box-int-txt">
        <em>Citat u pravom trenutku vrijedi 1–2 boda</em> u argumentaciji eseja. <b>18 probranih citata</b>: <em>Patnje mladog Werthera</em> (8 — Goethe), Goethe ostali Faust/Mignon (3), Voltaire (3), Rousseau · Kant · Diderot (4). <strong>Filtriraj po tezi</strong> (T1–T7), <strong>po razini</strong> (osnovno/napredno), ili pokreni <em>🎲 Random</em>. <b>10 must-know citata</b> označeno je <em>★ Napamet</em> — počni s njima.
      </div>
    </div>

            <div class="cit-filters">
      <button class="cit-fbtn active" data-filter="all" onclick="citFilter('all', this)">Svi (18)</button>
      <button class="cit-fbtn fspec" data-filter="must" onclick="citFilter('must', this)">★ Napamet (10)</button>
      <button class="cit-fbtn" data-filter="werther" onclick="citFilter('werther', this)">💔 Werther (8)</button>
      <button class="cit-fbtn" data-filter="goethe" onclick="citFilter('goethe', this)">📜 Goethe ostali (3)</button>
      <button class="cit-fbtn" data-filter="voltaire" onclick="citFilter('voltaire', this)">🌅 Voltaire (3)</button>
      <button class="cit-fbtn" data-filter="ostali" onclick="citFilter('ostali', this)">🎓 Rousseau · Kant · Diderot (4)</button>
    </div>
    ...
    <div class="cit-search-row" style="margin:14px 0 16px;display:flex;gap:8px;align-items:center">
      ...
      <input type="search" id="cit-search" class="cit-search" placeholder="Pretraži citate (npr. Werther, Goethe, ljubav, samoubojstvo)…" aria-label="Pretraži citate" autocomplete="off"
...
<div class="cit-grid">
      <!-- WERTHER — Goethe, obvezatno 2026 -->
      <div class="cit-card must-know" data-cat="werther" data-cit-id="h05c01" data-diff="basic" data-tez="2,4,5">
        ...
        <div class="cit-meta">
          <span class="cit-eye">WERTHER</span>
          <span class="cit-must">Napamet</span>
          
        </div>
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga I (16.6.1771.)</span>
        </div>
        <div class="cit-txt">„Mlada je djevojka za mene kao glazba — ne mogu živjeti bez te melodije.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(2, this)">T2</button><button type="button" class="cit-tez" onclick="citFilterByTez(4, this)">T4</button><button type="button" class="cit-tez" onclick="citFilterByTez(5, this)">T5</button></div>
        <div class="cit-use"><b>Kada koristiti</b> esej o Wertherovoj idealizaciji Lotte. Prvi susret. Pokazuje da je od početka Lotte za njega <em>simbol</em>, ne osoba.</div>
      </div>

      <div class="cit-card must-know" data-cat="werther" data-cit-id="h05c03" data-diff="basic" data-tez="2">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga I (kraj kolovoza 1771.) — rasprava s Albertom</span>
        </div>
        <div class="cit-txt">„Ljudska priroda ima svoje granice; može podnijeti radost, bol, patnju do stanovite mjere — i nestaje čim se ta granica prijeđe.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(2, this)">T2</button></div>
        <div class="cit-use"><b>Kada koristiti</b> Wertherova obrana samoubojstva. Centralna za Tezu 2 (Sturm und Drang heroj) — argumentira da osjećaj ima svoju fizičku logiku poput groznice.</div>
      </div>

      <div class="cit-card must-know" data-cat="werther" data-cit-id="h05c04" data-diff="basic" data-tez="1,2">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga II (20.1.1772.)</span>
        </div>
        <div class="cit-txt">„Jedinstven sam; usred svijeta, a ipak sam potpuno sam.”</div>
        ...
        <div class="cit-use"><b>Kada koristiti</b> esej o otuđenju i pojedincu. Werther se osjeća <em>jedinstvenim</em>, pa i usamljenim. Rana slika moderne alienacije.</div>
      </div>

      <div class="cit-card must-know" data-cat="werther" data-cit-id="h05c06" data-diff="basic" data-tez="2">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga II (22.12.1772.) — posljednje pismo Lotti</span>
        </div>
        <div class="cit-txt">„Odlazim na put, Lotte. Put bez povratka. Ali ne zauvijek — mi ćemo se opet vidjeti.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(2, this)">T2</button></div>
        <div class="cit-use"><b>Kada koristiti</b> esej o smrti i nadi u zagrobnom životu. Werther racionalizira samoubojstvo kao putovanje. Paradoks — osjećaj maskiran kao razumska odluka.</div>
      </div>

      <div class="cit-card must-know" data-cat="werther" data-cit-id="h05c07" data-diff="basic" data-tez="2">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga II — Izdavačeva bilješka</span>
        </div>
        <div class="cit-txt">„U dvanaest sati odjeknuo je pucanj.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(2, this)">T2</button></div>
        <div class="cit-use"><b>Kada koristiti</b> kraj romana — prijelaz s Wertherovog prvog lica na objektivnu priču izdavača. Goethe namjerno čini scenu <em>klinički hladnom</em>. Pokazuje strukturalnu namjeru — Werther više ne može pisati.</div>
      </div>

      <div class="cit-card must-know" data-cat="werther" data-cit-id="h05c08" data-diff="advanced" data-tez="1,2">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Goethe u predgovoru 2. izdanja (1787.)</span>
        </div>
        <div class="cit-txt">„I ti budi čovjek i ne slijedi njegov primjer.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(1, this)">T1</button><button type="button" class="cit-tez" onclick="citFilterByTez(2, this)">T2</button></div>
        <div class="cit-use"><b>Kada koristiti</b> <b>kritično za argumentaciju</b> da Goethe NE slavi samoubojstvo. Eksplicitno upozorenje autora koje diskvalificira tezu da je Werther „glorifikacija samoubojstva”.</div>
      </div>

      <div class="cit-card" data-cat="werther" data-cit-id="h05c02" data-diff="basic" data-tez="2,5">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga I (svibanj 1771.)</span>
        </div>
        <div class="cit-txt">„Živim tako sretne dane kao što ih Bog čuva za svoje svece.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(2, this)">T2</button><button type="button" class="cit-tez" onclick="citFilterByTez(5, this)">T5</button></div>
        <div class="cit-use"><b>Kada koristiti</b> kontrast prvog i drugog dijela romana. Početni zanos — prije Albertova povratka. Za tezu o ciklusu radosti i očaja.</div>
      </div>

      <div class="cit-card" data-cat="werther" data-cit-id="h05c05" data-diff="advanced" data-tez="5">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Werther</span>
          <span class="cit-src-work">Knjiga II (studeni 1772.) — Ossian vs Homer</span>
        </div>
        <div class="cit-txt">„Ossian je istisnuo Homera iz mog srca.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(5, this)">T5</button></div>
        <div class="cit-use"><b>Kada koristiti</b> <b>kritična rečenica.</b> Znakom ove rečenice Werther prestaje biti prosvjetiteljski (Homer = svjetlo, razum) i postaje predromantičarski (Ossian = magla, osjećaj). Prijelaz epoha u jednoj rečenici.</div>
      </div>


      <!-- GOETHE — ostali (Faust I, Mignon) -->
      <div class="cit-card must-know" data-cat="goethe" data-cit-id="h05c11" data-diff="advanced" data-tez="1">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        <div class="cit-meta">
          <span class="cit-eye">GOETHE</span>
          <span class="cit-must">Napamet</span>
          <span class="cit-diff adv">NAPREDNI</span>
        </div>
        <div class="cit-src">
          <span class="cit-src-author">Goethe o Wertheru (u autobiografiji Pjesništvo i istina)</span>
          <span class="cit-src-work"></span>
        </div>
        <div class="cit-txt">„Pisao sam Wertherom da se spasim samoubojstva.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(1, this)">T1</button></div>
        <div class="cit-use"><b>Kada koristiti</b> esej o autobiografskoj pozadini romana. Goethe je Wertherove osjećaje preusmjerio u pisanje — <em>umjetnost kao oslobađanje od patnje</em>.</div>
      </div>

      <div class="cit-card" data-cat="goethe" data-cit-id="h05c09" data-diff="basic" data-tez="3">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          ...
          <span class="cit-src-work">Faust I (1808.) — Faustov monolog</span>
        </div>
        <div class="cit-txt">„Sada stojim, jadan luđak, i nisam mudriji nego prije.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(3, this)">T3</button></div>
        <div class="cit-use"><b>Kada koristiti</b> povezivanje Werthera s Faustom kao Goetheove dvije centralne figure. Oba junaka traže <em>apsolutno</em> — Werther u ljubavi, Faust u spoznaji. <em>H06 povezivanje.</em></div>
      </div>

      <div class="cit-card" data-cat="goethe" data-cit-id="h05c10" data-diff="advanced" data-tez="5">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Goethe</span>
          <span class="cit-src-work">Naukovanje Wilhelma Meistera (1796.)</span>
        </div>
        <div class="cit-txt">„Znaš li zemlju gdje cvjetaju limunovi?” (Mignon)</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(5, this)">T5</button></div>
        <div class="cit-use"><b>Kada koristiti</b> kontrastiranje Wertherove Sturm und Drang faze s kasnijom weimarskom klasikom. Pokazuje Goetheovu evoluciju kao autora.</div>
      </div>


      <!-- VOLTAIRE -->
      <div class="cit-card must-know" data-cat="voltaire" data-cit-id="h05c12" data-diff="basic" data-tez="3,6">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        <div class="cit-meta">
          <span class="cit-eye">VOLTAIRE</span>
          <span class="cit-must">Napamet</span>
          
        </div>
        <div class="cit-src">
          <span class="cit-src-author">Voltaire</span>
          <span class="cit-src-work">Candide (1759.) — kraj romana</span>
        </div>
        <div class="cit-txt">„Il faut cultiver notre jardin.” („Moramo obrađivati svoj vrt.”)</div>
        ...
        <div class="cit-use"><b>Kada koristiti</b> usporedba s Wertherom. Voltaire predlaže <em>pragmatični povratak radu</em>, Werther odabire <em>bijeg u smrt</em>. Dvije suprotne strategije 18. stoljeća.</div>
      </div>

      <div class="cit-card" data-cat="voltaire" data-cit-id="h05c13" data-diff="advanced" data-tez="6">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Voltaire — pismo prijatelju</span>
          <span class="cit-src-work"></span>
        </div>
        <div class="cit-txt">„Écrasez l'infâme!” („Zatrite tog nitkova!” — fanatizam, inkviziciju)</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(6, this)">T6</button></div>
        <div class="cit-use"><b>Kada koristiti</b> kontekst prosvjetiteljstva. Voltaireov borbeni stav protiv vjerskog fanatizma. <em>Suprotnost Wertherovoj pasivnoj patnji.</em></div>
      </div>

      <div class="cit-card" data-cat="voltaire" data-cit-id="h05c14" data-diff="advanced" data-tez="6,7">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Voltaire</span>
          <span class="cit-src-work">Traktat o toleranciji (1763.)</span>
        </div>
        <div class="cit-txt">„Neslaganje je temelj slobode; bez prava na drugačije mišljenje nema civilizacije.”</div>
        ...
        <div class="cit-use"><b>Kada koristiti</b> prosvjetiteljski ideal tolerancije. <em>Kontekstualni citat</em> za esej o prosvjetiteljstvu kao epohi.</div>
      </div>


      <!-- ROUSSEAU · KANT · DIDEROT -->
      <div class="cit-card must-know" data-cat="ostali" data-cit-id="h05c15" data-diff="basic" data-tez="7">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        <div class="cit-meta">
          <span class="cit-eye">FILOZOFI</span>
          <span class="cit-must">Napamet</span>
          
        </div>
        <div class="cit-src">
          <span class="cit-src-author">Rousseau</span>
          <span class="cit-src-work">Društveni ugovor (1762.) — prva rečenica</span>
        </div>
        <div class="cit-txt">„Čovjek je rođen slobodan, a posvuda je u okovima.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(7, this)">T7</button></div>
        <div class="cit-use"><b>Kada koristiti</b> povezivanje s Wertherom kao junakom koji <em>ne može podnijeti okove društva</em>. Rousseau je direktni preteča Sturm und Drang — svaki student Werthera mora znati ovaj citat.</div>
      </div>

      <div class="cit-card must-know" data-cat="ostali" data-cit-id="h05c17" data-diff="basic" data-tez="3,7">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Kant</span>
          <span class="cit-src-work">Što je prosvjetiteljstvo? (1784.)</span>
        </div>
        <div class="cit-txt">„Sapere aude! Imaj hrabrosti koristiti vlastiti razum!”</div>
        ...
        <div class="cit-use"><b>Kada koristiti</b> <b>kanonska definicija prosvjetiteljstva.</b> Kontrast Wertheru: Kant hvali razum, Werther odbacuje razum za osjećaj. Dva pola epohe u dvije rečenice.</div>
      </div>

      <div class="cit-card" data-cat="ostali" data-cit-id="h05c16" data-diff="advanced" data-tez="5,7">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Rousseau</span>
          <span class="cit-src-work">Emil ili o odgoju (1762.)</span>
        </div>
        <div class="cit-txt">„Sve je dobro kad izlazi iz ruku tvorca svih stvari; sve se kvari pod ljudskim rukama.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(5, this)">T5</button><button type="button" class="cit-tez" onclick="citFilterByTez(7, this)">T7</button></div>
        <div class="cit-use"><b>Kada koristiti</b> Rousseauova teza o prirodi kao dobroj i civilizaciji kao kvarljivcu. <em>Direktni intelektualni temelj Wertherove idealizacije prirode.</em></div>
      </div>

      <div class="cit-card" data-cat="ostali" data-cit-id="h05c18" data-diff="advanced" data-tez="3,6">
        <div class="cit-actions">
          <button type="button" class="cit-btn fav" onclick="citToggleFav(this)" aria-label="Dodaj u favorite" title="Dodaj u favorite">☆</button>
          <button type="button" class="cit-btn copy" data-count="0" onclick="citCopy(this)" aria-label="Kopiraj citat" title="Kopiraj citat">📋</button>
        </div>
        ...
        <div class="cit-src">
          <span class="cit-src-author">Diderot</span>
          <span class="cit-src-work">Enciklopedija (članak „Prosvjetiteljstvo”)</span>
        </div>
        <div class="cit-txt">„Cilj enciklopedije je okupiti sve znanje rasuto po zemaljskoj kugli.”</div>
        <div class="cit-tez-row"><button type="button" class="cit-tez" onclick="citFilterByTez(3, this)">T3</button><button type="button" class="cit-tez" onclick="citFilterByTez(6, this)">T6</button></div>
        <div class="cit-use"><b>Kada koristiti</b> prosvjetiteljska ambicija — sustavno ljudsko znanje. Pokazuje povijesni kontekst u kojem se Werther pojavljuje <em>kao suprotstavljajući glas</em>.</div>
      </div>
    ...
    <div class="fc-wrap">
      ...
      <div class="fc" id="fc-card" onclick="fcFlip()">
        <div class="fc-inner" id="fc-inner">
          <div class="fc-front">
            <div class="fc-cat" id="fc-cat-f">WERTHER</div>
            <div class="fc-term" id="fc-term">Werther</div>
            <div class="fc-hint">Klikni za okretanje ↻</div>
          </div>
          <div class="fc-back">
            <div class="fc-cat" id="fc-cat-b">DEFINICIJA</div>
            <div class="fc-def" id="fc-def">Glavni lik Goetheova romana (1774.). Mladi umjetnik, preosjetljiv, strastven. Arhetipski Sturm und Drang heroj. Završava samoubojstvom zbog neuzvraćene ljubavi prema Lotte.</div>
          </div>
        </div>
      </div>
    ...
    <div class="mg-stats"><span>spareno: <b id="mg-score">0</b> / <span id="mg-total">7</span></span></div>
      <div class="pro-gate-overlay">
        ...
        <div class="pro-gate-cta">
          ...
          <a class="pro-gate-btn" href="/pricing?ctx=drill_matching_h05">Otključaj — 9,99€/mj</a>
  ...
  <div class="layer" id="l6" role="tabpanel" tabindex="0">
    ...
    <div class="box-int">
      ...
      <div class="box-int-txt">
        Format identičan maturi — zadaci višestrukog izbora s 4 odgovora. Pokriva sve dijelove: Werther (Goethe, ispitno djelo 2026), Sturm und Drang i predromantizam, Weltschmerz i verterizam, prosvjetiteljski kontekst (Voltaire, Rousseau, Diderot, Kant, Enciklopedija). Na kraju dobivaš ocjenu + pregled promašenih pitanja.
      </div>
    </div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div class="box-int">
      ...
      <div class="box-int-txt">
        Označi stavke koje si <em>stvarno</em> usvojio. Ne žuri — ako nešto nisi siguran, vrati se na odgovarajući tab. <strong>Cilj: svih 10 označeno prije prelaska na H06 — Romantizam.</strong>
      </div>
    </div>
...
.wc-hint{margin-top:12px;padding:10px 12px;background:var(--inp,#0F0605);border-radius:8px;font-size:12px;color:var(--t2,#c5b8aa);line-height:1.5}
    ...
    <div class="pro-gate" data-feature="checkpoint-tracking">
      ...
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Znam tko je napisao <b>Werther</b> i kada (Goethe, 1774., epistolarni roman)</div><span class="cp-hint">Werther</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Mogu ispričati <b>radnju Werthera u 10 etapa</b> (od dolaska u Wahlheim do samoubojstva)</div><span class="cp-hint">Werther</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Znam ključne likove — <b>Werther, Lotte, Albert, Wilhelm</b> — i njihove uloge</div><span class="cp-hint">Werther</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Razumijem <b>4 centralna sukoba</b> (osjećaj vs razum, pojedinac vs društvo, ljubav vs dužnost, priroda vs civilizacija)</div><span class="cp-hint">Werther</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Znam što je <b>Weltschmerz</b>, <b>verterizam</b> i <b>Werther efekt</b></div><span class="cp-hint">Pojmovnik</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Razumijem <b>Sturm und Drang</b> kao pokret i Werther kao njegovu kulminaciju</div><span class="cp-hint">Teorija</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Imam <b>barem 2 teze</b> za esej o Wertheru (Weltschmerz, SuD heroj, ljubav vs dužnost, priroda, most)</div><span class="cp-hint">Esej</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Znam <b>3 citata</b> napamet (npr. „Ossian je istisnuo Homera”, „I ti budi čovjek i ne slijedi njegov primjer”)</div><span class="cp-hint">Citatnik</span></div>
      <div class="cp-item" onclick="cpToggle(this)"><div class="cp-box">✓</div><div>Razlikujem <b>prosvjetiteljstvo i predromantizam</b> — znam zašto je Werther predromantizam, a Candide prosvjetiteljstvo</div><span class="cp-hint">Pojmovnik</span></div>
      ...
      <div class="pro-gate-overlay">
        ...
        <div class="pro-gate-cta">
          ...
          <a class="pro-gate-btn" href="/pricing?ctx=checkpoint_h05">Otključaj — 9,99€/mj</a>
          <div class="pro-gate-meta">Otkaži bilo kad · Free trial 7 dana</div>
        </div>
      </div>
    </div>
    ...
    <div class="cp-final" id="cp-final">
      ...
      <div class="cp-final-title">H05 ZAVRŠENO!</div>
      <div class="cp-final-msg">
        Savladao si prosvjetiteljstvo i predromantizam. <strong>Werther — ispitno djelo za esej 2026 — u džepu.</strong> Spreman si za H06 — romantizam, razdoblje u kojem se osjećaj, priroda i pojedinac bore protiv hladnog razuma. Goethe <em>(Faust)</em>, Byron, Shelley, Puškin, Heine — europska književnost ulazi u svoju najemotivniju fazu.
      </div>
      <div class="cp-actions">
        <button class="fcb primary">H06 · Romantizam →</button>
        <button class="fcb" onclick="sw(0)">🔁 Ponovi H05</button>
      </div>
      ...
      <div class="pdf-export">
        ...
        <div class="pdf-export-body">
          ...
          <div class="pdf-export-txt">Sve što si prošao — Teorija, Werther, Pojmovnik, Kviz — u jednom dokumentu. <strong>Idealno za ponavljanje pred ispit</strong> ili ispis na papir.</div>
      ...
      <div class="upsell" style="margin-top:24px;text-align:left" data-upsell-ctx="checkpoint_finale" data-upsell-target="discere" data-upsell-id="cp_discere">
        ...
        <div class="upsell-body">
          ...
          <div class="upsell-desc"><strong>Završio si H05 — sada testiraj u stvarnim uvjetima.</strong> Werther, Sturm und Drang i prosvjetiteljski pojmovi pojavljuju se u školskom eseju (<em>Werther je obavezno ispitno djelo 2026</em>), teoriji književnosti i čitanju književnog teksta. Riješi ih s timerom i automatskim ocjenjivanjem.</div>
        </div>
        <a href="/discere?subject=hrvatski&topic=werther&ctx=h05_checkpoint" class="upsell-cta" onclick="track('upsell_click',{ctx:'checkpoint_finale',target:'discere'},'conversion')">Isprobaj →</a>
      </div>
    </div>

    <div class="nav-row" style="margin-top:30px">
      <span class="nb" onclick="sw(6)">← Kviz</span>
      <span class="nb off">H06 (uskoro) →</span>
    </div>
  </div>
...
var CURRENT_CHAPTER = {
  subject: 'hrvatski',
  code: 'h05',
  title: 'Prosvjetiteljstvo i predromantizam'
};
...
var DIAG_QUESTIONS = [
  {
    q: "Tko je autor Patnji mladog Werthera?",
    opts: ["Friedrich Schiller", "Johann Wolfgang von Goethe", "Voltaire", "Jean-Jacques Rousseau"],
    correct: 1,
    topic: "Goethe — autor"
  },
  {
    q: "U kojoj je epohi napisan Werther (1774.)?",
    opts: [
      "Klasicizmu",
      "Realizmu",
      "Predromantizmu / Sturm und Drang",
      "Modernizmu"
    ],
    correct: 2,
  ...
  {
    q: "Što je epistolarni roman?",
    opts: [
      "Roman o svećenicima",
      "Roman u obliku pisama",
      "Roman s fantastičnim elementima",
      "Roman pisan u stihu"
    ],
    correct: 1,
    topic: "Epistolarni roman"
  },
  {
    q: "Koji pojam opisuje Wertherov osjećaj nesklada između ideala i stvarnosti?",
    opts: [
      "Katarza",
      "Weltschmerz (svjetska bol)",
      "Anagnorisis",
      "Sapere aude"
    ],
    correct: 1,
  ...
  {
    q: "Što je Enciklopedija (1751.–1772.)?",
    opts: [
      "Rousseauov autobiografski spis",
      "Velika prosvjetiteljska enciklopedija (Diderot i d'Alembert)",
      "Voltaireov filozofski rječnik",
      "Goetheovo životno djelo"
    ],
    correct: 1,
    topic: "Enciklopedija"
  }
...
function diagSkip(){
  ...
  try{ sessionStorage.setItem('mt.hrv.h05.diag', 'skipped') }catch(e){}
...
function diagDismiss(){
  document.getElementById('diag').setAttribute('data-state', 'dismissed');
  try{
    sessionStorage.setItem('mt.hrv.h05.diag', JSON.stringify({
      done: true,
...
function diagFinish(){
  ...
  if(n === 5){
    ...
    rec = 'Imaš većinu, ali jedan rupica. Preporučujemo: <b>Werther deep-dive</b> + <b>Pojmovnik</b> kao revizija. Preskoči duga čitanja, idi direktno na <b>Citatnik</b> i <b>Drill</b>.';
  } else if(n === 3){
    msg = '👍 Dobre osnove — treba malo više rada.';
    rec = 'Imaš osnovni pregled, ali ti fali sigurnost u detaljima. Plan: <b>(1)</b> proradi cijelu Teoriju, <b>(2)</b> Werther deep-dive, <b>(3)</b> Drill flashcards 2× prije Kviza.';
  } else if(n === 2){
    msg = '📚 Tu smo da ti pomognemo — krenimo od početka.';
    rec = 'Ne brini — zato si tu. Idi <b>tab po tab redom</b> (Teorija → Škrtac → Esej alat). Ne preskači. Završi s <b>Drillom i Kvizom</b> kao provjera.';
  } else {
    msg = '🌱 Početna točka — sve je pred tobom.';
    rec = 'Prosvjetiteljstvo i predromantizam je velika epoha — Goethe, Voltaire, Rousseau, Diderot, Kant. Prati redoslijed tabova, ne žuri. <b>Cilj #1:</b> razumjeti Werthera — centralne sukobe i ključne scene (sekcija 04 i 06 u Werther tabu). Kad to imaš, sve ostalo dolazi prirodno.';
  }
...
function _diagRestore(){
  try{
    var s = sessionStorage.getItem('mt.hrv.h05.diag');
    if(s){
      document.getElementById('diag').setAttribute('data-state', 'dismissed');
    }
  }catch(e){}
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_subject: CURRENT_CHAPTER.subject,
    p_chapter_code: CURRENT_CHAPTER.code,
    p_tab_index: lsLoad('mt.hrv.h05.tab', 0),
    p_url: window.location.href,
    p_viewport_width: window.innerWidth,
    p_viewport_height: window.innerHeight
  };
...
var TAB_LABELS = ['Teorija','Werther','Esej alat','Citatnik','Pojmovnik','Drill','Kviz','Checkpoint'];
...
function sw(i){
  ...
  var prevTab = lsLoad('mt.hrv.h05.tab', null);
  ...
  lsSave('mt.hrv.h05.tab',i);

  VISITED_TABS[i]=true;
  lsSave('mt.hrv.h05.visited',VISITED_TABS);
  recomputeProgress();
  updateTabBadges();
...
function updateProgress(pct){
  ...
  lsSave('mt.hrv.h05.prog',p);
}

/* ══ RESTORE BANNER ══ */
function checkRestore(){
  var prog=lsLoad('mt.hrv.h05.prog',null);
  var tab=lsLoad('mt.hrv.h05.tab',null);
  var cp=lsLoad('mt.hrv.h05.cp',null);
  var visited=lsLoad('mt.hrv.h05.visited',null);
...
function restoreProgress(){
  ...
  var tab=lsLoad('mt.hrv.h05.tab',0);
  var prog=lsLoad('mt.hrv.h05.prog',5);
  var visited=lsLoad('mt.hrv.h05.visited',{});
...
function dismissRestore(){
  document.getElementById('restore-banner').classList.remove('show');
  ['mt.hrv.h05.prog','mt.hrv.h05.tab','mt.hrv.h05.cp','mt.hrv.h05.visited','mt.hrv.h05.quiz_passed'].forEach(function(k){try{localStorage.removeItem(k)}catch(e){}});
  VISITED_TABS={0:true};
  QUIZ_PASSED=false;
...
function _citLoadFavs(){
  try {
    var raw = localStorage.getItem('mt.hrv.h05.cit_favs');
...
function _citSaveFavs(){
  try {
    localStorage.setItem('mt.hrv.h05.cit_favs', JSON.stringify(CIT_STATE.favs));
  } catch(e){}
}

function _citLoadCopyCount(){
  try {
    var raw = localStorage.getItem('mt.hrv.h05.cit_copy');
...
function _citSaveCopyCount(){
  try {
    localStorage.setItem('mt.hrv.h05.cit_copy', JSON.stringify(CIT_STATE.copyCount));
  } catch(e){}
}
...
/* ═══════════════════════════════════════════
   ...
   ═══════════════════════════════════════════ */
var FC_CARDS=[
  {cat:'WERTHER',term:'Werther',def:'Glavni lik Goetheova romana (1774.). Mladi umjetnik, preosjetljiv, strastven. Arhetipski Sturm und Drang heroj. Završava samoubojstvom zbog neuzvraćene ljubavi.'},
  {cat:'WERTHER',term:'Lotte (Charlotte)',def:'Predmet Wertherove ljubavi. Zaručena/udata za Alberta. Brine se o 8 mlađe braće i sestara. Voli Werthera prijateljski, bira dužnost prema Albertu.'},
  {cat:'WERTHER',term:'Albert',def:'Lottin zaručnik/suprug. Racionalan, staložen, buržoaski pouzdan. Nije zlikovac — pozitivan lik koji predstavlja prosvjetiteljski razum. Debatira s Wertherom o samoubojstvu.'},
  {cat:'WERTHER',term:'Wilhelm',def:'Wertherov prijatelj, primatelj 98 pisama. Nikad se ne pojavljuje „u kadru”. Pasivni slušatelj — omogućuje čitatelju pristup Wertherovoj psihi.'},
  {cat:'WERTHER',term:'Wahlheim',def:'Izmišljeno njemačko mjesto radnje. Prototip Wetzlar (gdje je Goethe boravio 1772.). Simbol idilične prirode nasuprot gradu-društvu.'},
  {cat:'WERTHER',term:'Verterizam',def:'Kulturni fenomen — mladići Europe oponašaju Werthera: plavi frak, žuti prsluk, Ossian i Homer. Prvi globalni književni pop-fenomen.'},
  {cat:'WERTHER',term:'Werther efekt',def:'Val imitacijskih samoubojstava po uzoru na Werthera. Neke njemačke države zabranjuju roman. Goethe 1787. dodaje upozorenje.'},
  {cat:'WERTHER',term:'Weltschmerz',def:'„Svjetska bol” — osjećaj da svijet ne zadovoljava čežnje pojedinca. Werther je prvi književni junak koji pati od Weltschmerza.'},
  {cat:'WERTHER',term:'Ossian zamjenjuje Homera',def:'Ključna rečenica u II knjizi — Werther prestaje čitati Homera (klasicizam, svjetlost) i okreće se Ossianu (melankolija, magla). Prijelaz iz prosvjetiteljstva u predromantizam.'},
  {cat:'WERTHER',term:'Scena kruha',def:'16.6.1771. — Werther vidi Lotte kako reže kruh za 8 mlađe braće i sestara. Slika materinske brižnosti. Od tog trenutka zaljubljen.'},
  {cat:'STIL',term:'Sturm und Drang',def:'Njemački književni pokret ~1765.–1785. Reakcija na prosvjetiteljski racionalizam. Osjećaj iznad razuma, priroda, pojedinac-genij. Kulminacija: Werther.'},
  {cat:'STIL',term:'Predromantizam',def:'Kraj 18. st. — reakcija protiv hladnog razuma. Osjećaj, priroda, pojedinac. Werther, Sturm und Drang, Rousseauov utjecaj. Preteča romantizma.'},
  {cat:'STIL',term:'Bildungsroman',def:'Roman odgoja — junak sazrijeva kroz iskustvo. Njemačka tradicija. Goethe: Wilhelm Meister (1796.). Werther je „anti-Bildungsroman” — junak NE sazrijeva, nego propada.'},
  {cat:'STIL',term:'Epistolarni roman',def:'Roman u obliku pisama. Montesquieu Perzijska pisma (1721.), Rousseau Nova Heloisa, Goetheov Werther (1774.) — 98 pisama Wilhelmu.'},
  {cat:'AUTOR',term:'Johann Wolfgang von Goethe',def:'(1749.–1832.) Najveći njemački pjesnik. Werther (1774., 24. god.), Faust I/II (1808./1832.). Tvorac pojma „svjetska književnost”. Razdoblje = „Goetheovo doba”.'},
  {cat:'EPOHA',term:'Prosvjetiteljstvo',def:'Intelektualno razdoblje 18. st. Razum kao mjerilo svega, kritika religije i vlasti. Enciklopedija kao projekt. Francuska revolucija 1789.'},
  {cat:'EPOHA',term:'Enciklopedija',def:'Diderot i d\\u2019Alembert, 1751.\\u20131772. 17 tomova teksta + 11 tomova ilustracija. Manifest prosvjetiteljstva.'},
  {cat:'FILOZ',term:'Sapere aude!',def:'„Usudi se znati!” (Horacije). Kantova definicija prosvjetiteljstva (1784.). Intelektualna autonomija. Kontrast Wertheru (osjećaj iznad razuma).'},
  {cat:'CANDIDE',term:'Candide',def:'Voltaireov glavni lik (1759.). Kroz iskustvo prelazi od Panglossova optimizma do pragmatičnog zaključka: „Il faut cultiver notre jardin.”'},
  {cat:'CANDIDE',term:'Pangloss',def:'Candidov učitelj, karikatura Leibniza. Ime = „sve-jezik”. Ponavlja „sve je u najboljem redu” unatoč svemu. Voltaireov satirički fokus.'}
];
...
═════════════════════════════════════════════ */
var DRILL_SS_KEY = 'mt.hrv.h05.drill';
...
/* ═══════════════════════════════════════════
   ...
   ═══════════════════════════════════════════ */
var MG_PAIRS=[
  {l:'Werther',r:'1774. · Goethe · epistolarni roman'},
  {l:'Götz von Berlichingen',r:'1773. · Goethe · Sturm und Drang'},
  {l:'Faust I',r:'1808. · Goethe · romantizam'},
  {l:'Candide',r:'1759. · Voltaire · filozofski roman'},
  {l:'Društveni ugovor',r:'1762. · Rousseau'},
  {l:'Enciklopedija',r:'1751.\\u20131772. · Diderot · d\\u2019Alembert'},
  {l:'O duhu zakona',r:'1748. · Montesquieu · razdvajanje vlasti'},
  {l:'Robinson Crusoe',r:'1719. · Defoe'},
  {l:'Nathan Mudri',r:'1779. · Lessing · tolerancija'}
];
...
/* ═══════════════════════════════════════════
   ...
   ═══════════════════════════════════════════ */
var QUIZ=[
  {q:\`Tko je autor romana Patnje mladog Werthera?\`,opts:[\`Friedrich Schiller\`,\`Johann Wolfgang von Goethe\`,\`Voltaire\`,\`Jean-Jacques Rousseau\`],correct:1,exp:\`Johann Wolfgang von Goethe (1749.–1832.) je autor Werthera. Roman je napisao s 24 godine, u samo četiri tjedna, a objavljen je 1774. godine. Preko noći ga je učinio europskom književnom zvijezdom.\`},
  {q:\`Kada je objavljen Werther?\`,opts:[\`1759. godine\`,\`1768. godine\`,\`1774. godine\`,\`1789. godine\`],correct:2,exp:\`Patnje mladog Werthera objavljene su 1774. godine. Napisane u zanosu nakon Goetheove ljubavi prema Charlotti Buff i samoubojstva prijatelja Jerusalema. Goethe ga je 1787. preradio i dodao upozoravajući uvod.\`},
  {q:\`Koja je književna forma Werthera?\`,opts:[\`Klasični roman u trećem licu\`,\`Epistolarni roman (u obliku pisama)\`,\`Dramatska poema\`,\`Pikareskni roman\`],correct:1,exp:\`Werther je epistolarni roman — sastoji se od 98 Wertherovih pisama upućenih prijatelju Wilhelmu, plus dnevničkih zapisa i „Izdavačeve bilješke” na kraju. Uzori: Montesquieuova Perzijska pisma i Rousseauova Nova Heloisa.\`},
  {q:\`Kojem književnom pokretu pripada Werther?\`,opts:[\`Klasicizmu\`,\`Prosvjetiteljstvu\`,\`Sturm und Drang / predromantizmu\`,\`Romantizmu\`],correct:2,exp:\`Werther pripada pokretu Sturm und Drang („Oluja i nalet”) — njemačkom predromantičarskom pokretu ~1765.–1785. Pokret je reakcija na prosvjetiteljski racionalizam — uzvisuje osjećaj, prirodu i pojedinca iznad razuma.\`},
  {q:\`Tko je Lotte u romanu?\`,opts:[\`Wertherova sestra\`,\`Zaručena/udata žena koju Werther voli\`,\`Wertherova prva supruga\`,\`Albertova sestra\`],correct:1,exp:\`Lotte (Charlotte) je predmet Wertherove ljubavi. Zaručena je za Alberta (poslije se udaje), brine se o 8 mlađe braće i sestara nakon majčine smrti. Voli Werthera prijateljski, ali bira dužnost prema Albertu.\`},
  {q:\`Što radi Albert u romanu?\`,opts:[\`Svećenik je koji osuđuje Werthera\`,\`Lottin zaručnik, poslije suprug — Wertherova antiteza\`,\`Wertherov otac\`,\`Urednik Wertherovih pisama\`],correct:1,exp:\`Albert je Lottin zaručnik, poslije suprug. Racionalan, staložen, buržoaski pouzdan — Wertherova potpuna antiteza. Goethe ga namjerno ne čini zlikovcem — pozitivan je lik koji predstavlja prosvjetiteljski razum.\`},
  {q:\`Gdje se odvija radnja Werthera?\`,opts:[\`Berlinu\`,\`Wahlheimu — izmišljenom mjestu po uzoru na Wetzlar\`,\`Parizu\`,\`Frankfurtu\`],correct:1,exp:\`Radnja se odvija u izmišljenom mjestu Wahlheim. Prototip je Wetzlar, gdje je Goethe stvarno boravio u ljeto 1772. i zaljubio se u Charlotte Buff. Wahlheim simbolizira idiličnu prirodu nasuprot nerazumijevajućem gradu-društvu.\`},
  {q:\`Što znači pojam „Weltschmerz”?\`,opts:[\`Sreća pojedinca u prirodi\`,\`Svjetska bol — osjećaj nesklada između ideala i stvarnosti\`,\`Prosvjetiteljski optimizam\`,\`Klasicistička harmonija\`],correct:1,exp:\`Weltschmerz (njem. „svjetska bol”) — osjećaj da svijet ne može zadovoljiti duboke čežnje pojedinca. Werther je prvi književni junak koji pati od Weltschmerza. Centralan pojam za romantizam koji dolazi.\`},
  {q:\`Što je „verterizam”?\`,opts:[\`Filozofski pravac koji zagovara razum\`,\`Kulturni fenomen oponašanja Werthera — moda i ponašanje\`,\`Goetheov kasniji roman\`,\`Vrsta njemačke lirike\`],correct:1,exp:\`Verterizam je kulturni fenomen nakon 1774. — mladići diljem Europe oponašaju Wertherovu odjeću (plavi frak, žuti prsluk), čitaju Ossiana i Homera, pišu ispovjedna pisma. Prvi globalni književni pop-fenomen.\`},
  {q:\`Što je „Werther efekt”?\`,opts:[\`Val imitacijskih samoubojstava po uzoru na Werthera\`,\`Goetheov stilski postupak u romanima\`,\`Njemački književni pokret\`,\`Povijesna kriza tržišta knjiga 1774.\`],correct:0,exp:\`Werther efekt je pojam moderne psihologije — val imitacijskih samoubojstava po uzoru na Werthera. Neke njemačke države (Leipzig, Kopenhagen) zabranile su roman. Goethe je 1787. dodao upozorenje: „I ti budi čovjek i ne slijedi njegov primjer.”\`},
  {q:\`Kojeg pjesnika Werther čita u drugoj knjizi, umjesto Homera?\`,opts:[\`Vergilija\`,\`Ossiana\`,\`Dantea\`,\`Petrarcu\`],correct:1,exp:\`„Ossian je istisnuo Homera iz mog srca” — ključna rečenica u drugoj knjizi. Homer (klasicističko svjetlo, razum) zamijenjen je Ossianom (melankolija, magla, smrt). Simbolički prikaz Wertherova psihološkog puta od života prema smrti.\`},
  {q:\`Kako umire Werther?\`,opts:[\`Od tuberkuloze\`,\`U dvoboju s Albertom\`,\`Samoubojstvom — hitcom iz Albertova pištolja\`,\`Utopijem u Weimaru\`],correct:2,exp:\`Werther izvrši samoubojstvo 22. prosinca 1772. Posudi Albertove pištolje pod izlikom putovanja. Lotte mu ih vlastoručno predaje, drhtava, naslućujući loše. Werther ispaljuje metak u glavu u ponoć. Pokopan bez svećenika, između dvije lipe.\`},
  {q:\`Koji je neposredni poticaj Goetheu za pisanje Werthera?\`,opts:[\`Lisabonski potres 1755.\`,\`Goetheova ljubav prema Charlotti Buff + samoubojstvo prijatelja Jerusalema\`,\`Francuska revolucija 1789.\`,\`Schillerova drama Razbojnici\`],correct:1,exp:\`Goethe je 1772. u Wetzlaru zaljubljen u Charlotte Buff, zaručnicu prijatelja Kestnera. Iste godine njegov prijatelj Karl Wilhelm Jerusalem počini samoubojstvo zbog neuzvraćene ljubavi prema udatoj ženi. Goethe u 4 tjedna 1774. spaja oba iskustva u Werthera.\`},
  {q:\`Tko je autor Candida?\`,opts:[\`Jean-Jacques Rousseau\`,\`Denis Diderot\`,\`Voltaire (François-Marie Arouet)\`,\`Charles de Montesquieu\`],correct:2,exp:\`Voltaire, pravim imenom François-Marie Arouet (1694.–1778.), napisao je Candide 1759. Voltaire je najutjecajnija figura europskog prosvjetiteljstva — kontrast Goetheu i Wertheru, kojeg predstavlja u drugom taboru (razum vs osjećaj).\`},
  {q:\`Što je Enciklopedija (1751.–1772.)?\`,opts:[\`Rousseauova autobiografija\`,\`Velika prosvjetiteljska enciklopedija Diderota i d'Alemberta\`,\`Voltaireov filozofski rječnik\`,\`Goetheovo znanstveno djelo\`],correct:1,exp:\`Enciklopedija (Encyclopédie, 1751.–1772.) — 17 tomova teksta + 11 tomova ilustracija. Urednici Denis Diderot i Jean le Rond d'Alembert. 140 suradnika uključujući Voltairea, Rousseaua, Montesquieua. Manifest prosvjetiteljstva.\`},
  {q:\`Tko je autor Društvenog ugovora (Du contrat social, 1762.)?\`,opts:[\`Voltaire\`,\`Jean-Jacques Rousseau\`,\`Denis Diderot\`,\`Charles de Montesquieu\`],correct:1,exp:\`Jean-Jacques Rousseau (1712.–1778.) — švicarsko-francuski filozof. Društveni ugovor počinje slavnom rečenicom: „Čovjek je rođen slobodan, a posvuda je u okovima.” Rousseau je ujedno idejni preteča Sturm und Drang — njegov kult prirode utječe na Goethea.\`},
  {q:\`Koja je Kantova definicija prosvjetiteljstva iz 1784.?\`,opts:[\`„Razum je Božja svjetlost”\`,\`„Sapere aude! Imaj hrabrosti koristiti svoj razum!”\`,\`„Sve je za najbolje u najboljem od svjetova”\`,\`„Čovjek je mjerilo svega”\`],correct:1,exp:\`Immanuel Kant u eseju „Što je prosvjetiteljstvo?” (1784.) definira epohu: „Prosvjetiteljstvo je izlazak čovjeka iz stanja maloljetnosti u koje je sam kriv… Sapere aude!” Kanonska definicija. Potpun kontrast Wertherovom odbacivanju razuma.\`},
  {q:\`Što je Sturm und Drang?\`,opts:[\`Francuski prosvjetiteljski pokret\`,\`Njemački predromantičarski pokret ~1765.–1785.\`,\`Talijanski barokni stil\`,\`Španjolska dramska škola\`],correct:1,exp:\`Sturm und Drang („Oluja i nalet”) je njemački književni pokret ~1765.–1785. Reakcija na prosvjetiteljski racionalizam — osjećaj iznad razuma, priroda, pojedinac-genij. Centralne figure: Goethe i Schiller. Kulminacija pokreta: Werther (1774.) i Razbojnici (Schiller, 1782.).\`},
  {q:\`Koja su dva Goetheova kapitalna djela?\`,opts:[\`Werther i Faust\`,\`Werther i Hamlet\`,\`Faust i Candide\`,\`Ifigenija i Don Juan\`],correct:0,exp:\`Werther (1774.) — roman koji pokreće Sturm und Drang. Faust (I dio 1808., II dio 1832. posmrtno) — Goetheovo životno djelo na kojem je radio 60 godina. Kozmička drama o sukobu dobra i zla. Faust se obrađuje u H06 Romantizam.\`},
  {q:\`Zašto Albert u Wertheru NIJE zlikovac?\`,opts:[\`Jer ga Goethe ne opisuje detaljno\`,\`Jer Goethe namjerno podvlači da je tragedija sistemska, ne personalna\`,\`Jer umire prije Werthera\`,\`Jer nije Wertherov suparnik\`],correct:1,exp:\`Albert je pozitivan lik — brižan, pošten, razuman. Goethe ga namjerno čini simpatičnim da podvuče: tragedija nije zbog zlog suparnika, nego zbog sistemskog sukoba svjetonazora (osjećaj vs razum, pojedinac vs društvo). Ako tretiraš Alberta kao negativca na eseju, promašuješ centralnu poantu.\`}
];
...
function renderQuizIntro(){
  ...
  el.innerHTML=\`
    <div class="qz-start">
      ...
      <p>Pitanja pokrivaju cijelo poglavlje: Werther (Goethe), Sturm und Drang, Weltschmerz, verterizam, te prosvjetiteljski kontekst (Voltaire, Rousseau, Diderot, Kant). Na kraju dobivaš ocjenu i objašnjenja.</p>
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrvatski/h05';
  var text='Prošao/la sam kviz iz H05 · Prosvjetiteljstvo i predromantizam na maturiraj.hr — '+score+'/'+QUIZ.length+' ('+pct+'%) 💡';
  var fb=document.getElementById('qz-share-fb');

  // Try Web Share API (mobile)
  if(navigator.share){
    navigator.share({title:'Maturiraj.hr · H05 Kviz',text:text,url:url})
...
function qzResult(){
  ...
  if(pct>=90){grade='ODLIČAN';msg='Spreman si za Werther esej na maturi.';ico='🏆';scoreBand='great'}
  else if(pct>=75){grade='VRLO DOBAR';msg='Solidno poznaješ gradivo. Doradi par tema.';ico='💪';scoreBand='good'}
  else if(pct>=60){grade='DOBAR';msg='Dobra osnova. Ponovi pojmovnik i Werther deep-dive.';ico='📚';scoreBand='good'}
  ...
  var html=\`
    <div class="qz-result">
      ...
      <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
        ...
        <button class="fcb" onclick="sw(1)">← Werther</button>
  ...
  if(qzState.score>=QUIZ.length*0.6){QUIZ_PASSED=true;lsSave('mt.hrv.h05.quiz_passed',true)}
  recomputeProgress();
  document.getElementById('qz-app').innerHTML=html;
}
...
function cpSave(){
  ...
  lsSave('mt.hrv.h05.cp',states);
}
function cpLoad(){
  var states=lsLoad('mt.hrv.h05.cp',null);
  if(!states)return;
...
document.addEventListener('DOMContentLoaded',function(){
  ...
  QUIZ_PASSED=lsLoad('mt.hrv.h05.quiz_passed',false);
  VISITED_TABS[0]=true;
  updateTabBadges();
  recomputeProgress();

  // Breadcrumb: reflect current tab (v3.6)
  var currentTab = lsLoad('mt.hrv.h05.tab', 0);
  var bcTab = document.getElementById('bc-tab');
  ...
  document.addEventListener('keydown',function(e){
    ...
    if(e.target.classList&&e.target.classList.contains('tab')){
      if(e.key==='ArrowRight'||e.key==='ArrowLeft'){
        e.preventDefault();
        var curr=parseInt(lsLoad('mt.hrv.h05.tab',0));
  ...
  if(!lsLoad('mt.hrv.h05.hinted',false)){
    setTimeout(function(){lsSave('mt.hrv.h05.hinted',true)},3000);
  }
});
...
function cpReset(){
  ...
  try { localStorage.removeItem('mt.hrv.h05.cp'); } catch(e){}
  // Update counter
...
@media print{
  ...
  *, *::before, *::after{
  ...
  body::before{
    content:"Maturiraj.hr · H05 Prosvjetiteljstvo i predromantizam · 8 tabova · Svrha: priprema za državnu maturu iz Hrvatskog jezika 2025/2026";
    display:block;
...
.cit-card[data-cat="werther"]::before{background:var(--red)}
.cit-card[data-cat="goethe"]::before{background:var(--gold)}
.cit-card[data-cat="voltaire"]::before{background:var(--teal)}
.cit-card[data-cat="ostali"]::before{background:#c5a1d9}
...
.cit-card[data-cat="werther"] .cit-eye{color:var(--red-l);background:var(--dim-r);border-color:var(--bd-r)}
.cit-card[data-cat="goethe"] .cit-eye{color:var(--gold);background:var(--dim-go);border-color:var(--bd-go)}
.cit-card[data-cat="voltaire"] .cit-eye{color:var(--teal);background:var(--dim-t);border-color:var(--bd-t)}
.cit-card[data-cat="ostali"] .cit-eye{color:#c5a1d9;background:rgba(197,161,217,.12);border-color:rgba(197,161,217,.25)}
...
export default function H05Chapter() {
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H05] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H05`);
  ...
  return (
    <div
      ref={containerRef}
      className="chapter-h05"
      suppressHydrationWarning
      dangerouslySetInnerHTML={{ __html: BODY_HTML }}
    />
  );
}
export const HRV_POGAVLJE_05 = null
