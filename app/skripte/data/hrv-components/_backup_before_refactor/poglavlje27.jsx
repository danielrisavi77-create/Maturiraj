...
export const metadata = {
  code: 'H27',
  title: 'H27 · Školski esej | Maturiraj.hr · matura · pisanje · workspace',
  description: 'H26 Interpunkcija — zarez (8 pravila), crtica vs spojnica, hrvatski navodnici „...',
  canonical: 'https://maturiraj.hr/hrvatski/h27-skolski-esej',
  ogImage: 'https://maturiraj.hr/og/h27-skolski-esej.png',
};
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item active" aria-current="page" data-code="h27" href="/skripte/hrv/h27"><span class="sb-dot"></span>H27 · Školski esej</a>
...
<div class="content-wrap">
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button type="button" class="tab" id="tab7" onclick="sw(7)" role="tab" aria-selected="false" aria-controls="l7">📊 Referentna tablica</button>
  </div>
  ...
  <div class="layer" id="l6" role="tabpanel" tabindex="0">
    ...
    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      ...
      <button type="button" class="nb-btn primary" onclick="sw(7)">📚 Pojmovnik →</button>
    </div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <div style="margin-top:32px;padding:16px 20px;background:linear-gradient(135deg,rgba(233,180,70,.06),transparent);border:1px solid var(--bd);border-radius:var(--r2);text-align:center">
      ...
      <div style="font-size:13px;color:var(--t2);line-height:1.6;margin-bottom:14px">
        Print ovaj cheat-sheet kao A4 referentnu tablicu.
      </div>
      <button type="button" class="nb-btn primary" onclick="window.print()" style="padding:10px 24px">🖨 Print Cheat-sheet</button>
    </div>
...
.diag-opt.correct{
  ...
  animation:diagCorrect .4s ease;
}
.diag-opt.wrong{
  border-color:var(--red) !important;
  background:rgba(224,82,82,.08) !important;
  animation:diagWrong .35s ease;
}
  ...
  useEffect(() => {
    ...
    if (!scriptsExecutedRef.current && SCRIPTS_JS) {
      try {
        ...
        console.error(`[H27] Script execution error:`, err);
      }
    }

    return () => {
      // Cleanup on unmount
      const styleEl = document.getElementById(`chapter-styles-H27`);
