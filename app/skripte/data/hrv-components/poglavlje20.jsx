...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item" aria-current="page" data-code="h20" href="/skripte/hrv/h20"><span class="sb-dot"></span>H20 · Morfologija</a>
...
<div class="content-wrap">
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=morfologija+vrste+riječi+deklinacija+konjugacija+matura" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Morfologija — vrste riječi i deklinacija</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=glagolski+vid+aspekt+padeži+sklonidba+hrvatski+jezik" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Glagolski vid i padeži — objašnjenje</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Croatian+grammar+morphology+nouns+verbs+cases" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Croatian morphology — nouns &amp; verbs</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Slavic+language+morphology+cases+aspect+explained" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🎬</span> EN</div>
          <div class="yt-title">Slavic morphology — cases &amp; aspect</div>
        </div>
      </a>
    </div>
...
<!-- VJEŽBE PLACEHOLDERI -->
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H20 Morfologija I — imenice, zamjenice, pridjevi, brojevi</div>
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h20.tab') || '0') }catch(e){return 0} })(),
...
function aiShare(){
  ...
  if(navigator.share){
    navigator.share({
      ...
      text: text,
      url: 'https://maturiraj.hr/skripte/hrv/h20'
    }).catch(() => {
