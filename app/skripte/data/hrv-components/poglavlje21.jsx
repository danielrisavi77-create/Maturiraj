...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item" aria-current="page" data-code="h21" href="/skripte/hrv/h21"><span class="sb-dot"></span>H21 · Sintaksa</a>
...
<div class="content-wrap">
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=sintaksa+rečenica+zavisna+nezavisna+analiza+matura" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Sintaksa — zavisne i nezavisne rečenice</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=rečenični+članovi+subjekt+predikat+objekt+atribut+apozicija" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Rečenični članovi — subjekt, predikat...</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Croatian+syntax+sentence+structure+subordinate+clauses" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Croatian syntax — sentence structure</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=syntax+tree+diagram+sentence+parsing+linguistics" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🎬</span> EN</div>
          <div class="yt-title">Syntax tree — sentence parsing</div>
        </div>
      </a>
    </div>
...
<div class="nav-row">
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H21 Morfologija II — glagoli i nepromjenjive vrste riječi</div>
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h21.tab') || '0') }catch(e){return 0} })(),
