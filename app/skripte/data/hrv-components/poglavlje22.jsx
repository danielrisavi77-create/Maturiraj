/**
 * H22 — H22 · Leksikologija — Maturiraj.hr · matura iz hrvatskog
 * Auto-generated from Maturiraj_Hrvatski_H22.html
 * 
...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Navigacija poglavlja">
  ...
  <a class="sb-item" aria-current="page" data-code="h22" href="/skripte/hrv/h22"><span class="sb-dot"></span>H22 · Leksikologija</a>
  ...
  <div class="sb-footer" id="sb-footer">
    <span id="sb-footer-pos">22 / 28</span> · <span id="sb-footer-title">leksikologija</span>
...
<div class="content-wrap">
  ...
  <div class="bc">
    ...
    <span class="bc-cur">H22 · Leksikologija</span>
  ...
  <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:20px">
    ...
    <button class="fcb" onclick="navigator.share?navigator.share({title:'H22 · Leksikologija',url:window.location.href}):navigator.clipboard.writeText(window.location.href)" style="font-size:10px" title="Podijeli">📤 Dijeli</button>
  ...
  <!-- HERO -->
  <header class="hero">
    <div class="hero-chapter">H22 &nbsp;·&nbsp; Jezikoslovlje &nbsp;·&nbsp; Leksikologija</div>
    <h1 class="hero-title">Leksikologija<br><span>značenje riječi i frazemi</span></h1>
    <p class="hero-sub">
      <strong>Sustavni prikaz leksikologije — znanosti o riječima i rječniku.</strong> <em>Leksičko značenje</em> (sinonimi, antonimi, homonimi, polisemija, paronimi), <em>slojevi leksika</em> (standardni, regionalni, sociolektalni), <em>frazemi</em>. <strong>Frazem Scanner</strong> za prepoznavanje frazema, <em>70 pojmova</em>, <em>30 kviz pitanja</em>, <strong>A4 referentna tablica</strong>.
    </p>
    <div class="hero-chips">
        <span class="pill p-pa hchip">📖 Teorija</span>
        <span class="pill p-br hchip">🔤 Značenje riječi</span>
        <span class="pill p-pa hchip">🌐 Slojevi leksika</span>
        <span class="pill p-br hchip">💬 Frazemi (NCVVO ⭐)</span>
        <span class="pill p-pa hchip">🔬 Frazem Scanner</span>
      </div>
  </header>
  ...
  <div class="tabs" role="tablist" aria-label="Dijelovi poglavlja">
    ...
    <button class="tab" id="tab1" onclick="sw(1)" role="tab" aria-selected="false" aria-controls="l1">🔤 Značenje<span class="tab-done" id="td1"></span></button>
    <button class="tab" id="tab2" onclick="sw(2)" role="tab" aria-selected="false" aria-controls="l2">🌐 Slojevi<span class="tab-done" id="td2"></span></button>
    <button class="tab" id="tab3" onclick="sw(3)" role="tab" aria-selected="false" aria-controls="l3">💬 Frazemi<span class="tab-done" id="td3"></span></button>
    ...
    <button class="tab" id="tab5" onclick="sw(5)" role="tab" aria-selected="false" aria-controls="l5">🔬 Frazem Scanner<span class="tab-done" id="td5"></span></button>
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div class="diag-wrap" id="diag0" data-state="intro">
      ...
      <div class="diag-intro">
        ...
        <div class="diag-intro-desc">10 pitanja · ~3 min · provjeri koliko znaš leksikologije prije učenja.</div>
      ...
      <div class="diag-quiz">
        <div class="diag-header">
          <div class="diag-lbl">Leksikologija — dijagnostika</div>
    ...
    <!-- ═══════════════════════════════════
         20 NAJČEŠĆIH NCVVO GREŠAKA · LEKSIKOLOGIJA
    ═══════════════════════════════════ -->
    ...
    <div style="padding:14px 16px;background:rgba(224,82,82,.04);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.6;color:var(--t2)">
        <strong style="color:var(--red)">Sustavni popis leksikoloških grešaka iz prošlih NCVVO mature.</strong> Pogledaj prije mature i izbjegavaj ih svjesno.
      </div>
    </div>
    ...
    <div style="display:grid;gap:8px;margin:16px 0">
      ...
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">1.</span>Sinonim ≠ ista riječ — postoji nijansa značenja</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)">Pravi sinonimi su rijetki (potpuno ista značenja). Većina su <strong>bliskoznačnice</strong> s nijansama. „Kuća" (objekt) i „dom" (emocionalna toplina) su bliskoznačnice. NCVVO traži bliskoznačnice.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">2.</span>Polisemija vs. homonimija</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Polisemija</strong> = ISTA riječ, više POVEZANIH značenja (vrijeme: trajanje + atmosfera). <strong>Homonimi</strong> = RAZLIČITE riječi sa istim oblikom (graditi: bauen / iznositi mišljenje). U rječniku polisemija ima jednu odrednicu, homonimi više.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">3.</span>Paronimi — najčešća zamka</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)">Paronimi = sličan oblik, RAZLIČITO značenje. Najčešći greški: <em>efektan</em> (dojmljiv) ≠ <em>efektivan</em> (djelotvoran). <em>Verbalan</em> ≠ <em>vjerski</em>. Trik: provjeri značenje u rječniku.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">4.</span>Antonim — što je suprotno?</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Antonimi</strong> = parovi sa SUPROTNIM značenjem. 3 tipa: <em>komplementarni</em> (živ × mrtav), <em>graduelni</em> (dobar × loš — postoji nijansa), <em>relativni</em> (učitelj × učenik — odnos).</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">5.</span>Hiperonim ≠ vrsta</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Hiperonim</strong> = nadređen pojam (cvijet → ruža, ljiljan, tulipan). <strong>Hiponim</strong> = podređen (ruža je hiponim cvijeta). <strong>Kohiponim</strong> = na istoj razini (ruža i ljiljan su međusobno kohiponimi).</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">6.</span>Frazem ≠ poslovica ≠ izreka ⭐</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Frazem</strong> = ustaljen izraz čije značenje NIJE zbroj značenja riječi (pasti s kruške). <strong>Poslovica</strong> = cjelovita rečenica s poukom (Tko rano rani, dvije sreće grabi). NCVVO traži frazem!</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">7.</span>Arhaizam vs. historizam</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Arhaizam</strong> = stara riječ za pojam koji JOŠ POSTOJI (jur → već). <strong>Historizam</strong> = riječ za pojam koji više NE POSTOJI (kmet, latifundija). Razlika: postoji li pojam u suvremenom svijetu?</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">8.</span>Posuđenice vs. tuđice</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Posuđenica</strong> = preuzeta riječ koja se PRILAGODILA hrvatskoj fonetici (škola < lat. schola). <strong>Tuđica</strong> = riječ koja zadržava strani oblik (computer, jazz, foyer). Tuđice se pišu kurzivom.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">9.</span>Internacionalizmi — gdje pripadaju?</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Internacionalizmi</strong> = riječi prisutne u više jezika sa istim značenjem (telefon, demokracija, atom). Tehnička i znanstvena terminologija je pretežno internacionalizirana.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">10.</span>Dijalektizam vs. regionalizam ⭐</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Dijalektizam</strong> = riječ iz pojedinog narječja (kaj, ča, što). <strong>Regionalizam</strong> = riječ ograničena na područje, ali ne obvezno iz narječja (gemišt, šank, špajza — slavonski). Trik: ako je iz narječja → dijalektizam.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">11.</span>Žargon vs. argo vs. sleng</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Žargon</strong> = stručni/profesionalni jezik (medicinski, pravni). <strong>Argo</strong> = tajni jezik određene grupe (zatvorenički). <strong>Sleng</strong> = razgovorni mladenački jezik (faca, kupac). NCVVO se najčešće pita žargon.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">12.</span>Metafora vs. metonimija vs. sinegdoha</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Metafora</strong> = sličnost (glava obitelji = vodilac). <strong>Metonimija</strong> = blizina (popiti čašu = popiti sadržaj). <strong>Sinegdoha</strong> = dio za cjelinu (krov = kuća). Sve su <em>tropi</em>.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">13.</span>Denotacija ≠ konotacija</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Denotacija</strong> = osnovno, doslovno, neutralno značenje (zmija = reptil bez nogu). <strong>Konotacija</strong> = dodatno emocionalno/vrednovano značenje (zmija = lukav, podmukao čovjek).</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">14.</span>Termin (stručni naziv) — pripada slojevima</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Termin</strong> = stručni naziv specifičan za područje (matematika: integral, kemija: oksidacija). Termini su jednoznačni unutar struke. <strong>Terminologija</strong> = skup termina jedne struke.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">15.</span>Onomastika — antroponim, toponim, etnonim</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Onomastika</strong> = znanost o vlastitim imenima. <strong>Antroponim</strong> = osobno ime (Ivan). <strong>Toponim</strong> = ime mjesta (Zagreb). <strong>Etnonim</strong> = ime naroda (Hrvati). Hidronim = ime vode, oronim = ime gore.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">16.</span>Frazem ≠ doslovno značenje</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)">Frazem ima značenje koje NIJE zbroj značenja riječi. „Pao mi je kamen sa srca" — doslovno apsurdno, frazemski znači „olakšalo mi je". Trik: ako rečenica zvuči apsurdno doslovno → frazem.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">17.</span>Leksem vs. riječ</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Leksem</strong> = riječ kao apstraktna jedinica značenja, obuhvaća sve oblike (pisati / pišem / pisao = svi oblici jednog leksema PISATI). <strong>Riječ</strong> = pojavni oblik u tekstu.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">18.</span>Eufemizam i hiperbola</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Eufemizam</strong> = ublažen izraz za neugodan pojam (preminuti < umrijeti). <strong>Hiperbola</strong> = pretjerivanje (umirem od gladi, milijun puta sam ti rekao). Oba su sredstva stilskog izražavanja.</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">19.</span>Neologizam — nova riječ ili novo značenje?</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Neologizam</strong> = nova riječ ILI novo značenje postojeće. Tipovi: <em>strukturni</em> (selfie, lockdown), <em>semantički</em> (miš = računalna naprava — staro značenje + novo).</div>
      </details>
      
      <details style="padding:12px 14px;background:var(--ele);border:1px solid var(--bd);border-left:3px solid var(--red);border-radius:var(--r1)">
        <summary style="cursor:pointer;font-family:var(--display);font-weight:700;color:var(--t1);font-size:13.5px"><span style="color:var(--red);margin-right:8px">20.</span>Rječnik — vrste i njihove specifičnosti</summary>
        <div style="margin-top:8px;font-size:12.5px;line-height:1.6;color:var(--t2)"><strong>Jednojezični</strong> (Anićev, HJP). <strong>Dvojezični</strong> (hr-en). <strong>Terminološki</strong>. <strong>Etimološki</strong> (porijeklo riječi). <strong>Frazeološki</strong>. <strong>Pravopisni</strong>. Različiti za različite svrhe.</div>
      </details>
      
    </div>

    <!-- UPGRADE: MNEMOTEHNIKE (LEKSIKOLOGIJA) -->
    ...
    <div style="padding:18px;background:linear-gradient(135deg,rgba(233,180,70,.06),transparent);border:1px solid var(--bd);border-radius:var(--r2);margin:14px 0">
      <div style="font-size:13px;line-height:1.7;color:var(--t2);font-family:var(--serif)">
        Glavne razlike koje TI najčešće zbune — zapamti ih ovim trikovima.
      </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:10px;margin:16px 0">
      ...
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--blue);margin-bottom:6px">POLI = MNOGO</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Polisemija</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Poli</strong> = mnogo (grč.). Polisemija = ista riječ ima MNOGO povezanih značenja.<br>
          <em style="font-size:11px;color:var(--t3)">vrijeme: trajanje + atmosfera + pristup</em>
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--green);margin-bottom:6px">HOMO = ISTO</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Homonimi</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Homo</strong> = isto (grč.). Homonimi = isti oblik, RAZLIČITE riječi (etimološki nepovezane).<br>
          <em style="font-size:11px;color:var(--t3)">kosa (vlas) ≠ kosa (oruđe)</em>
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--bronze);margin-bottom:6px">PARA = UZ</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Paronimi</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Para</strong> = uz, blizu (grč.). Paronimi = riječi UZ jedna drugu po obliku, ali različita značenja.<br>
          <em style="font-size:11px;color:var(--t3)">efektan ≠ efektivan</em>
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:#9b59b6;margin-bottom:6px">HYPER vs HYPO</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Hiperonim / Hiponim</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Hyper</strong> = iznad (cvijet je iznad ruže). <strong>Hypo</strong> = ispod (ruža je ispod cvijeta).<br>
          <em style="font-size:11px;color:var(--t3)">cvijet → ruža, ljiljan, tulipan</em>
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--red);margin-bottom:6px">ARH ≠ HIST</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Arhaizam vs. historizam</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          <strong>Pojam postoji</strong> → arhaizam (jur = već).<br>
          <strong>Pojam ne postoji</strong> → historizam (kmet — feudalna kategorija nestala).
        </div>
      </div>
      
      <div style="padding:14px;background:var(--ele);border:1px solid var(--bd);border-radius:var(--r1)">
        <div style="font-family:var(--mono);font-size:10px;letter-spacing:2px;color:var(--gold);margin-bottom:6px">KAMEN SA SRCA</div>
        <div style="font-family:var(--display);font-size:14px;font-weight:700;color:var(--gold);margin-bottom:8px">Frazem ⭐</div>
        <div style="font-size:12px;color:var(--t2);line-height:1.6">
          Ako rečenica zvuči <strong>apsurdno doslovno</strong> (kamen ne može biti na srcu) — to je frazem.<br>
          <em style="font-size:11px;color:var(--t3)">Frazemsko značenje ≠ zbroj značenja riječi</em>
        </div>
      </div>
    ...
    <div class="nav-row" style="justify-content:flex-end">
      <span class="nb-btn primary" onclick="sw(1)">🔤 Značenje →</span>
    </div>
    ...
    <div class="cheat-card" style="margin-top:24px">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Tab 1 · Značenje riječi</div>
        </div>
      </div>
      <div class="cheat-grid">
        <div class="cheat-col cheat-col-wide" style="font-family:var(--serif,Fraunces,serif);font-size:13.5px;color:var(--t2,#c5b8aa);line-height:1.65">
          <p style="margin:0">Teorija leksikologije te postavlja — <b>Tab 1</b> donosi semantiku: denotacija, konotacija, sinonimi, antonimi, polisemija, homonimija. Svaki tip s primjerima.</p>
        </div>
      </div>
    </div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-pa hchip">🔤 Značenje riječi</span>
      <span class="pill p-br hchip">🤝 Sinonimi · Antonimi · Homonimi</span>
      <span class="pill p-pa hchip">🌳 Hiperonim · Hiponim</span>
      <span class="pill p-br hchip">🎮 Drag-drop vježba</span>
    </div>

    <!-- ─────────────── PREGLED ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📋 Pregled · 5 leksičkih odnosa</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🔑 Što ćeš naučiti</div>
      <div class="box-int-txt">
        Riječi nisu izolirane — povezane su mrežom <strong>značenjskih odnosa</strong>. Razlikovanje sinonima, antonima, homonima, paronima i hijerarhijskih odnosa (hiperonim/hiponim) je <strong>top NCVVO tema</strong>. Naučit ćeš ih razlikovati u sekundi.
      </div>
    </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12.5px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th style="padding:10px;text-align:left;color:var(--gold);font-size:10.5px;letter-spacing:1px">ODNOS</th>
            <th style="padding:10px;text-align:left;color:var(--gold);font-size:10.5px;letter-spacing:1px">DEFINICIJA</th>
            <th style="padding:10px;text-align:left;color:var(--gold);font-size:10.5px;letter-spacing:1px">PRIMJER</th>
            <th style="padding:10px;text-align:center;color:var(--gold);font-size:10.5px;letter-spacing:1px">⭐</th>
          </tr>
        </thead>
        <tbody>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--green);font-weight:700">Sinonimi</td><td style="padding:8px 10px">isto/slično značenje</td><td style="padding:8px 10px;font-style:italic">kuća = dom · brz = hitar</td><td style="padding:8px 10px;text-align:center">★★★</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--red);font-weight:700">Antonimi</td><td style="padding:8px 10px">suprotno značenje</td><td style="padding:8px 10px;font-style:italic">dobar × loš · živ × mrtav</td><td style="padding:8px 10px;text-align:center">★★★</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--blue);font-weight:700">Homonimi</td><td style="padding:8px 10px">isti oblik, različito značenje</td><td style="padding:8px 10px;font-style:italic">kosa (vlas / oruđe)</td><td style="padding:8px 10px;text-align:center">★★★</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--bronze);font-weight:700">Paronimi</td><td style="padding:8px 10px">sličan oblik, različito značenje</td><td style="padding:8px 10px;font-style:italic">efektan ≠ efektivan</td><td style="padding:8px 10px;text-align:center">★★</td></tr>
          <tr><td style="padding:8px 10px;color:#9b59b6;font-weight:700">Hiperonim/Hiponim</td><td style="padding:8px 10px">nadređen / podređen pojam</td><td style="padding:8px 10px;font-style:italic">cvijet → ruža (hiponim)</td><td style="padding:8px 10px;text-align:center">★★</td></tr>
        </tbody>
      </table>
    </div>

    <!-- ─────────────── DETALJI ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">🔍 Detalji svakog odnosa · klikni karticu</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">SINONIMI</div>
            <div class="scene-sub">Isto ili vrlo slično značenje · bliskoznačnice</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi različitog oblika ali istog/sličnog značenja. Pravi sinonimi su rijetki — najčešće su <strong>bliskoznačnice</strong> s nijansama u značenju, stilu ili kontekstu.</p>
          <p><strong>🔑 Tipovi sinonima:</strong></p>
          <ul>
            <li><strong>Apsolutni:</strong> potpuno zamjenjivi (rijetko) — <em>jezikoslovac = lingvist</em></li>
            <li><strong>Stilski:</strong> razlikuju se po stilu — <em>umrijeti (neutralno) / preminuti (uzvišeno) / krepati (vulgarno)</em></li>
            <li><strong>Kontekstni:</strong> sinonimi samo u određenom kontekstu — <em>dobar / kvalitetan</em> (u kontekstu proizvoda)</li>
          </ul>
          <p><strong>📝 Primjeri:</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li><em>kuća = dom = obitavalište</em></li>
            <li><em>brz = hitar = ekspeditivan</em></li>
            <li><em>lijep = krasan = naočit</em></li>
            <li><em>radost = veselje = sreća</em></li>
          </ul>
          <p><strong>💡 Trik:</strong> u rječniku sinonimi imaju iste/slične definicije i mogu se zamijeniti u rečenici bez gubitka osnovnog značenja.</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">ANTONIMI</div>
            <div class="scene-sub">Suprotno značenje · 3 vrste</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> parovi riječi sa SUPROTNIM značenjem. Pripadaju istoj vrsti riječi i istom semantičkom polju.</p>
          <p><strong>🔑 3 tipa antonima:</strong></p>
          <ul>
            <li><strong>Komplementarni</strong> (binarni) — apsolutna suprotnost, nema sredine: <em>živ × mrtav, paran × neparan, prisutan × odsutan</em></li>
            <li><strong>Graduelni</strong> (stupnjeviti) — postoji sredina: <em>dobar × loš (= prosječan), velik × mali (= srednji), vruć × hladan (= mlak)</em></li>
            <li><strong>Relativni</strong> (konverzni) — odnos uloga: <em>učitelj × učenik, prodavač × kupac, roditelj × dijete</em></li>
          </ul>
          <p><strong>📝 Tvorba antonima:</strong></p>
          <ul>
            <li><strong>Različite osnove:</strong> <em>dobar × loš</em></li>
            <li><strong>Prefiksom „ne-":</strong> <em>moguć × nemoguć, sretan × nesretan</em></li>
            <li><strong>Prefiksom „a-/anti-":</strong> <em>moralan × amoralan, fašizam × antifašizam</em></li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">HOMONIMI</div>
            <div class="scene-sub">Isti oblik, RAZLIČITA značenja</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi koje se isto pišu i izgovaraju, ali imaju POTPUNO RAZLIČITA značenja (nepovezane etimologije).</p>
          <p><strong>🔑 Tipovi:</strong></p>
          <ul>
            <li><strong>Pravi homonimi (homofoni i homografi):</strong> isti zapis I izgovor — <em>kosa</em> (vlasi) / <em>kosa</em> (oruđe za košnju)</li>
            <li><strong>Homofoni:</strong> isti izgovor, različit zapis — rjeđe u hrvatskom</li>
            <li><strong>Homografi:</strong> isti zapis, različit naglasak — <em>luk</em> (povrće, dugi naglasak) / <em>luk</em> (oružje, kratki naglasak)</li>
          </ul>
          <p><strong>⚠ Pažnja!</strong> Homonimi ≠ polisemija! Polisemija = ista riječ s POVEZANIM značenjima (vrijeme = trajanje + atmosfera). Homonimi = RAZLIČITE riječi koje slučajno imaju isti oblik (kosa = vlasi / kosa = oruđe — nemaju veze).</p>
          <p><strong>📝 Primjeri homonima:</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li><em>graditi</em> (= bauen / iznositi mišljenje)</li>
            <li><em>list</em> (papir / biljka / novine / dio tijela)</li>
            <li><em>jagoda</em> (voće / vrh prsta)</li>
            <li><em>skok</em> (radnja / zdjela)</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">PARONIMI</div>
            <div class="scene-sub">Slični oblici, RAZLIČITA značenja · top NCVVO zamka</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi sličnog oblika ali RAZLIČITOG značenja. Često zamjenjivane u govoru i pismu — najčešća stilska greška.</p>
          <p><strong>📝 NAJČEŠĆI PARONIMSKI PAROVI (uče se napamet):</strong></p>
          <div class="table-wrap">
            <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12px">
              <thead><tr style="background:var(--bg)"><th style="padding:7px;text-align:left;color:var(--gold)">Paronim 1</th><th style="padding:7px;text-align:left;color:var(--gold)">Paronim 2</th><th style="padding:7px;text-align:left;color:var(--gold)">Razlika</th></tr></thead>
              <tbody>
                <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 7px"><strong>efektan</strong></td><td style="padding:6px 7px"><strong>efektivan</strong></td><td style="padding:6px 7px;font-style:italic">dojmljiv / djelotvoran</td></tr>
                <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 7px"><strong>verbalan</strong></td><td style="padding:6px 7px"><strong>vjerski</strong></td><td style="padding:6px 7px;font-style:italic">govorni / religijski</td></tr>
                <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 7px"><strong>adekvatan</strong></td><td style="padding:6px 7px"><strong>ekvivalentan</strong></td><td style="padding:6px 7px;font-style:italic">primjeren / istovrijedan</td></tr>
                <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 7px"><strong>moralan</strong></td><td style="padding:6px 7px"><strong>moralan (= moralnu pouku)</strong></td><td style="padding:6px 7px;font-style:italic">etični / pridjev sa značenjem morala</td></tr>
                <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 7px"><strong>oprost</strong></td><td style="padding:6px 7px"><strong>oprost (= praštanje)</strong></td><td style="padding:6px 7px;font-style:italic">ispričavati / ne ljutiti se</td></tr>
                <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 7px"><strong>ekonomski</strong></td><td style="padding:6px 7px"><strong>ekonomičan</strong></td><td style="padding:6px 7px;font-style:italic">vezan uz gospodarstvo / štedljiv</td></tr>
                <tr><td style="padding:6px 7px"><strong>industrijski</strong></td><td style="padding:6px 7px"><strong>industrijalni</strong></td><td style="padding:6px 7px;font-style:italic">koji pripada industriji / tip glazbe</td></tr>
              </tbody>
            </table>
          </div>
          <p style="margin-top:12px"><strong>💡 Trik:</strong> kad nisi siguran — provjeri u rječniku. Paronimi su <strong>najčešća pravopisna greška na maturi!</strong></p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">HIPERONIM ↔ HIPONIM ↔ KOHIPONIM</div>
            <div class="scene-sub">Hijerarhijski značenjski odnos</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> značenjski odnos nadređenosti i podređenosti pojmova.</p>
          <ul>
            <li><strong>Hiperonim</strong> = nadređen pojam (širok)</li>
            <li><strong>Hiponim</strong> = podređen pojam (uži, vrsta hiperonima)</li>
            <li><strong>Kohiponimi</strong> = pojmovi na istoj razini (međusobno na istoj hijerarhiji)</li>
          </ul>
          <p><strong>📝 Primjeri:</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li><em>cvijet</em> (hiperonim) → <em>ruža, ljiljan, tulipan</em> (hiponimi)</li>
            <li><em>ruža i ljiljan</em> = kohiponimi (oboje su cvijeće)</li>
            <li><em>životinja</em> (hiperonim) → <em>pas, mačka, papagaj</em> (hiponimi)</li>
            <li><em>vozilo</em> (hiperonim) → <em>auto, kamion, bicikl</em> (hiponimi)</li>
            <li><em>znanost</em> (hiperonim) → <em>fizika, kemija, biologija</em> (hiponimi)</li>
          </ul>
          <p><strong>💡 Trik:</strong> hiperonim dolazi od grč. <em>hyper</em> = iznad. Hiponim dolazi od <em>hypo</em> = ispod.</p>
        </div>
      </div>

      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge" style="background:var(--gold);color:#0F0605">6</div>
          <div class="scene-ttl">
            <div class="scene-name">DENOTACIJA ↔ KONOTACIJA</div>
            <div class="scene-sub">Doslovno značenje vs. emocionalno · NCVVO ⭐</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> svaka riječ ima dva sloja značenja.</p>
          <ul>
            <li><strong>Denotacija</strong> = osnovno, doslovno, neutralno značenje</li>
            <li><strong>Konotacija</strong> = dodatno emocionalno, vrednovano, asocijativno značenje</li>
          </ul>
          <p><strong>📝 Primjeri (denotacija → konotacija):</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li><em>zmija</em>: reptil bez nogu → lukav, podmukao čovjek</li>
            <li><em>lisica</em>: divlja životinja → prepredena osoba</li>
            <li><em>pile</em>: mlada kokoš → nježno dijete (deminutiv)</li>
            <li><em>gnoj</em>: prirodno gnojivo → nešto odvratno, gadno</li>
            <li><em>med</em>: prirodno sladilo → nešto slatko/draga osoba</li>
            <li><em>kuća</em>: građevina → toplina, sigurnost (dom)</li>
          </ul>
          <p><strong>⚠ NCVVO test:</strong> često traže „koja je konotacija ove riječi u kontekstu?". Odgovor: razmisli što riječ <em>asocira</em> uz doslovno značenje.</p>
        </div>
      </div>
    ...
    <!-- ─────────────── DRAG-DROP VJEŽBA ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">🎮 Vježba · Identifikacija odnosa (15 parova)</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🎯 Kako vježba radi</div>
      <div class="box-int-txt">
        Pokazujemo ti par riječi (ili rečenicu). <strong>Odredi koji je leksički odnos</strong>: sinonimi, antonimi, homonimi ili paronimi. Klikni odgovor — instant feedback s objašnjenjem.
      </div>
    </div>
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=leksikologija+sinonimi+antonimi+homonimi+frazemi+matura" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Leksikologija — sinonimi, antonimi, frazemi</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=arhaizmi+historizmi+neologizmi+posuđenice+tuđice+jezik" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Arhaizmi, neologizmi, posuđenice</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Croatian+lexicology+vocabulary+synonyms+etymology" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Croatian lexicology — synonyms &amp; etymology</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=semantics+lexical+relations+hypernyms+hyponyms+linguistics" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🎬</span> EN</div>
          <div class="yt-title">Semantics — lexical relations explained</div>
        </div>
      </a>
    </div>
...
<div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      ...
      <button class="nb-btn primary" onclick="sw(2)">Slojevi leksika →</button>
    </div>
  </div><!-- /l1 -->
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-pa hchip">🌐 Slojevi leksika</span>
      <span class="pill p-br hchip">⏳ Vremenski</span>
      <span class="pill p-pa hchip">🗺️ Prostorni</span>
      <span class="pill p-br hchip">🎯 Funkcionalni · Stručni</span>
    </div>

    <!-- ─────────────── PREGLED ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📋 Pregled · 4 sloja leksika</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🔑 Što ćeš naučiti</div>
      <div class="box-int-txt">
        Riječi se ne pojavljuju nasumično — svaka pripada jednom (ili više) <strong>slojeva leksika</strong>. Razlikujemo slojeve po vremenu (arhaizam/neologizam), prostoru (dijalektizam/regionalizam), funkciji (stilski neutralno/razgovorno/knjiški) i struci (termini). <strong>NCVVO ⭐ TOP tema.</strong>
      </div>
    </div>
    ...
    <div class="table-wrap">
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12.5px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th style="padding:10px;text-align:left;color:var(--gold);font-size:10.5px;letter-spacing:1px">SLOJ</th>
            <th style="padding:10px;text-align:left;color:var(--gold);font-size:10.5px;letter-spacing:1px">PODVRSTE</th>
            <th style="padding:10px;text-align:left;color:var(--gold);font-size:10.5px;letter-spacing:1px">PRIMJERI</th>
          </tr>
        </thead>
        <tbody>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--blue);font-weight:700">Vremenski</td><td style="padding:8px 10px">arhaizam, historizam, neologizam</td><td style="padding:8px 10px;font-style:italic">jur, kmet, selfie</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--green);font-weight:700">Prostorni</td><td style="padding:8px 10px">dijalektizam, regionalizam, lokalizam</td><td style="padding:8px 10px;font-style:italic">kaj, gemišt, paška sirana</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--bronze);font-weight:700">Funkcionalni</td><td style="padding:8px 10px">stilski neutralno, razgovorno, knjiški</td><td style="padding:8px 10px;font-style:italic">otići / kupiti se / udaljiti se</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--red);font-weight:700">Stručni</td><td style="padding:8px 10px">termini, žargon, argo</td><td style="padding:8px 10px;font-style:italic">integral, anestezija, faca</td></tr>
          <tr><td style="padding:8px 10px;color:#9b59b6;font-weight:700">Strane riječi</td><td style="padding:8px 10px">posuđenice, tuđice, internacionalizmi</td><td style="padding:8px 10px;font-style:italic">škola, computer, telefon</td></tr>
        </tbody>
      </table>
    </div>

    <!-- ─────────────── DETALJI ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">🔍 Detalji svakog sloja · klikni karticu</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">VREMENSKI SLOJ</div>
            <div class="scene-sub">Arhaizmi · Historizmi · Neologizmi</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi koje se razlikuju po vremenu uporabe — stare, suvremene ili nove.</p>
          <p><strong>🔑 Tipovi:</strong></p>
          <ul>
            <li><strong>Arhaizam</strong> — stara riječ za pojam koji JOŠ POSTOJI: <em>jur (= već), zamak (= dvorac), uzeti (= oženiti)</em></li>
            <li><strong>Historizam</strong> — riječ za pojam koji više NE POSTOJI: <em>kmet, latifundija, jato (= vojnička skupina)</em></li>
            <li><strong>Neologizam</strong> — nova riječ ili novo značenje: <em>selfie, lockdown, miš (računalni)</em></li>
          </ul>
          <p><strong>⚠ KLJUČNA RAZLIKA:</strong> arhaizam vs. historizam — postoji li pojam u suvremenom svijetu? Pojam postoji → arhaizam. Pojam ne postoji → historizam.</p>
          <p><strong>📝 Više primjera:</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li>Arhaizmi: <em>oroz</em> (= pijetao), <em>zaman</em> (= uzalud), <em>dika</em> (= ponos)</li>
            <li>Historizmi: <em>knez</em> (titula), <em>strijela</em> (oružje), <em>cehmajstor</em></li>
            <li>Neologizmi: <em>upload, hashtag, bezglutenski, kovid</em></li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">PROSTORNI SLOJ</div>
            <div class="scene-sub">Dijalektizmi · Regionalizmi · Lokalizmi</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi koje pripadaju određenom geografskom području, narječju ili regiji.</p>
          <p><strong>🔑 Tipovi:</strong></p>
          <ul>
            <li><strong>Dijalektizmi</strong> — riječi iz pojedinog narječja:
              <ul>
                <li>Kajkavski: <em>kaj, dober, gor (= gore), ne (= nije)</em></li>
                <li>Čakavski: <em>ča, divojka, more (= može)</em></li>
                <li>Štokavski: <em>što, žena, on</em></li>
              </ul>
            </li>
            <li><strong>Regionalizmi</strong> — vezani uz širu regiju, ali ne nužno iz narječja: <em>gemišt, šank, špajza</em> (slavonski razgovorni)</li>
            <li><strong>Lokalizmi</strong> — vrlo uska geografska distribucija: <em>paška sirana, virovitička štruca</em></li>
          </ul>
          <p><strong>💡 Trik:</strong> ako riječ nedvosmisleno pripada narječju (kaj, ča, što) → dijalektizam. Ako je iz regije ali ne narječja → regionalizam.</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">FUNKCIONALNI SLOJ</div>
            <div class="scene-sub">Stilski neutralno · Razgovorno · Knjiški</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi se razlikuju po stilskoj/funkcionalnoj uporabi.</p>
          <p><strong>🔑 Tipovi:</strong></p>
          <ul>
            <li><strong>Stilski neutralne</strong> — moguće u svakom stilu: <em>kuća, jesti, raditi, lijep</em></li>
            <li><strong>Razgovorne</strong> — svakodnevni govor: <em>baka (= baba), tata, mama, super, faca</em></li>
            <li><strong>Knjiške/uzvišene</strong> — književni i službeni stil: <em>stradati, počinuti, ushićen, vrlina</em></li>
            <li><strong>Vulgarne/prostačke</strong> — ne preporučuje se u službenoj komunikaciji</li>
          </ul>
          <p><strong>📝 Primjer hijerarhije:</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li><em>preminuti</em> (uzvišeno) → <em>umrijeti</em> (neutralno) → <em>krepati</em> (vulgarno)</li>
            <li><em>obratiti se</em> (knjiški) → <em>kazati</em> (neutralno) → <em>reći</em> (razgovorno)</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">STRUČNI SLOJ</div>
            <div class="scene-sub">Termini · Žargon · Argo</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi specifične za određenu struku, profesiju ili grupu.</p>
          <p><strong>🔑 Tipovi:</strong></p>
          <ul>
            <li><strong>Termini (stručni nazivi)</strong> — jednoznačni unutar struke:
              <ul>
                <li>Matematika: <em>integral, derivacija, koordinate</em></li>
                <li>Medicina: <em>anestezija, dijagnoza, sindrom</em></li>
                <li>Pravo: <em>tužba, presuda, parnica</em></li>
              </ul>
            </li>
            <li><strong>Žargon (profesionalni)</strong> — neformalni jezik struke: <em>medicinski žargon (operacija = "opa"), novinarski žargon</em></li>
            <li><strong>Argo (tajni jezik)</strong> — zatvorenički, lopovski: poseban skup pojmova za uže grupe</li>
            <li><strong>Sleng (mladenački)</strong> — razgovorni jezik mladih: <em>faca, kupac, biti u fazonu</em></li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge" style="background:#9b59b6;color:#fff">5</div>
          <div class="scene-ttl">
            <div class="scene-name">STRANE RIJEČI</div>
            <div class="scene-sub">Posuđenice · Tuđice · Internacionalizmi</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p><strong>📜 Definicija:</strong> riječi preuzete iz drugih jezika.</p>
          <p><strong>🔑 Tipovi:</strong></p>
          <ul>
            <li><strong>Posuđenica</strong> — preuzeta riječ koja se PRILAGODILA hrvatskoj fonetici/morfologiji: <em>škola</em> (lat. schola), <em>banka</em> (tal.), <em>pita</em> (tur.)</li>
            <li><strong>Tuđica</strong> — riječ koja zadržava strani oblik i izgovor: <em>computer, jazz, foyer, weekend</em>. U tisku se piše KURZIVOM.</li>
            <li><strong>Internacionalizam</strong> — riječ prisutna u više jezika (često znanstvena/tehnička): <em>telefon, atom, demokracija, automobil</em></li>
            <li><strong>Prevedenica (kalk)</strong> — doslovni prijevod stranog izraza: <em>nebodder ← skyscraper, vatromet ← Feuerwerk</em></li>
          </ul>
          <p><strong>⚠ NCVVO test:</strong> često traže razliku posuđenica vs. tuđica. Pravilo: ako se piše po hrvatskom pravopisu (škola) → posuđenica. Ako zadržava strani oblik (jazz) → tuđica.</p>
        </div>
      </div>
    ...
    <!-- ─────────────── KVIZ ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">🎮 Vježba · „Koji je ovo sloj?" (20 riječi)</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🎯 Kako vježba radi</div>
      <div class="box-int-txt">
        Pokazujemo ti riječ. <strong>Odredi kojem sloju leksika pripada</strong>: vremenskom (arhaizam/historizam/neologizam), prostornom (dijalektizam/regionalizam), funkcionalnom (knjiški/razgovorni) ili stručnom (termin/žargon). Klikni odgovor — instant feedback.
      </div>
    </div>
    ...
    <!-- NAV ROW -->
    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button class="nb-btn" onclick="sw(1)">← Značenje</button>
      <button class="nb-btn primary" onclick="sw(3)">Frazemi →</button>
    </div>
  </div><!-- /l2 -->
     <div class="layer" id="l3" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-pa hchip">💬 Frazemi</span>
      <span class="pill p-br hchip">🎯 Idiomski izrazi</span>
      <span class="pill p-pa hchip">⭐ NCVVO TOP-tema</span>
      <span class="pill p-br hchip">📖 100+ primjera</span>
    </div>

    <!-- ─────────────── DEFINICIJA ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">📖 Što je frazem?</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">⭐ Najvažnija leksikološka tema na maturi</div>
      <div class="box-int-txt">
        <strong>Frazem (idiom)</strong> je ustaljen izraz čije značenje <strong>NIJE zbroj značenja pojedinih riječi</strong>. „Pao mi je kamen sa srca" doslovno je apsurdno (kamen ne može biti na srcu), ali frazem znači <em>„olakšalo mi je"</em>. Frazemi su jezgra hrvatske ekspresivnosti i pojavljuju se na svakoj NCVVO maturi.
      </div>
    </div>

    <!-- ─────────────── KARAKTERISTIKE ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">🔍 4 karakteristike frazema</div><div class="sec-line"></div></div>
    ...
    <div class="scene-grid">
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">USTALJENOST</div>
            <div class="scene-sub">Sastav riječi je fiksiran · ne mijenja se</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Frazem ima <strong>fiksiran sastav</strong>. Ne možeš zamijeniti riječi sinonimima bez gubitka frazemskog značenja.</p>
          <p><strong>Primjer:</strong></p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li>✅ „Pao mi je <strong>kamen</strong> sa <strong>srca</strong>" — frazem (= olakšalo mi je)</li>
            <li>❌ „Pao mi je <em>stijena</em> sa <em>duše</em>" — nije frazem (samo doslovno)</li>
          </ul>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          ...
          <div class="scene-ttl">
            <div class="scene-name">NEKOMPOZICIONALNOST</div>
            <div class="scene-sub">Značenje cjeline ≠ zbroj značenja riječi</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Značenje frazema <strong>nije isto kao zbroj doslovnih značenja</strong> pojedinih riječi.</p>
          <ul>
            <li><strong>Doslovno:</strong> „pasti na pamet" = pasti, kretanje gore-dolje, na mozak</li>
            <li><strong>Frazemski:</strong> „pasti na pamet" = sjetiti se, sinuti</li>
          </ul>
          <p><strong>Trik prepoznavanja:</strong> ako rečenica zvuči apsurdno doslovno, vjerojatno je frazem!</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge" style="background:var(--bronze);color:#fff">3</div>
          <div class="scene-ttl">
            <div class="scene-name">REPRODUKTIVNOST</div>
            <div class="scene-sub">Govornici ih „izvlače gotove" · ne grade ih</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Frazemi su <strong>jezične zalihe</strong> — govornici ih ne stvaraju iz pravila, nego pamte i reproduciraju.</p>
          <p>Kao što ne gradimo riječ „kuća" iz prefiksa i sufiksa svaki put, tako ni frazem „pao mi je kamen sa srca".</p>
        </div>
      </div>
      ...
      <div class="scene-card" onclick="togScene(this)">
        <div class="scene-head">
          <div class="scene-badge" style="background:var(--red);color:#fff">4</div>
          <div class="scene-ttl">
            <div class="scene-name">SLIKOVITOST</div>
            <div class="scene-sub">Često metaforički · prenose sliku</div>
          </div>
          <div class="scene-arrow">▾</div>
        </div>
        <div class="scene-body">
          <p>Mnogi frazemi su <strong>metafore</strong> — prenose sliku iz konkretnog područja u apstraktno.</p>
          <ul style="font-family:var(--mono);font-size:13px">
            <li><em>biti na konju</em> — slika jahača (uspjeha) → uspjeti, biti u dobroj poziciji</li>
            <li><em>pasti u oči</em> — slika fizičkog pada → biti zamijećen</li>
            <li><em>nositi srce u ruci</em> — slika držanja srca → biti otvoren, izravan</li>
          </ul>
        </div>
      </div>
    ...
    <!-- ─────────────── 30 NAJČEŠĆIH FRAZEMA ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">📚 30 najčešćih hrvatskih frazema</div><div class="sec-line"></div></div>

    <div class="table-wrap">
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:11.5px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th style="padding:8px 10px;text-align:left;color:var(--gold);font-size:10px">FRAZEM</th>
            <th style="padding:8px 10px;text-align:left;color:var(--gold);font-size:10px">ZNAČENJE</th>
            <th style="padding:8px 10px;text-align:left;color:var(--gold);font-size:10px">PRIMJER UPORABE</th>
          </tr>
        </thead>
        <tbody>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">pasti s kruške</td><td style="padding:6px 9px">biti zbunjen, naivan</td><td style="padding:6px 9px;font-style:italic">„Da nisi pao s kruške? To je očito!"</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">pao mi je kamen sa srca</td><td style="padding:6px 9px">olakšalo mi je</td><td style="padding:6px 9px;font-style:italic">„Kad sam saznala da je sve OK, pao mi je kamen sa srca."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">biti na konju</td><td style="padding:6px 9px">uspjeti, biti u dobroj poziciji</td><td style="padding:6px 9px;font-style:italic">„Položio sam maturu — sad sam na konju!"</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">baciti pogled</td><td style="padding:6px 9px">brzo pogledati</td><td style="padding:6px 9px;font-style:italic">„Bacim pogled na zadatak i odgovorim."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">imati zlatne ruke</td><td style="padding:6px 9px">biti vješt rukom, talentiran</td><td style="padding:6px 9px;font-style:italic">„Moja baka ima zlatne ruke za kuhanje."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">izgubiti glavu</td><td style="padding:6px 9px">izgubiti razum, zaljubiti se preko mjere</td><td style="padding:6px 9px;font-style:italic">„Izgubila je glavu za njim."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">popiti čašu</td><td style="padding:6px 9px">prihvatiti neugodnu situaciju</td><td style="padding:6px 9px;font-style:italic">„Morao je popiti gorku čašu."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">vidjeti na vlastite oči</td><td style="padding:6px 9px">osobno se uvjeriti</td><td style="padding:6px 9px;font-style:italic">„Moraš to vidjeti na vlastite oči."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">tražiti dlaku u jajetu</td><td style="padding:6px 9px">pronalaziti sitne mane</td><td style="padding:6px 9px;font-style:italic">„Ne traži dlaku u jajetu, sve je OK."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">imati duge prste</td><td style="padding:6px 9px">krasti</td><td style="padding:6px 9px;font-style:italic">„Pazi na novac — neki imaju duge prste."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">spavati kao top</td><td style="padding:6px 9px">spavati duboko</td><td style="padding:6px 9px;font-style:italic">„Nakon mature sam spavala kao top."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">živjeti od ruke do usta</td><td style="padding:6px 9px">jedva preživljavati</td><td style="padding:6px 9px;font-style:italic">„Studenti često žive od ruke do usta."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">dati zeleno svjetlo</td><td style="padding:6px 9px">odobriti, dopustiti</td><td style="padding:6px 9px;font-style:italic">„Ravnatelj je dao zeleno svjetlo za projekt."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">imati maslac na glavi</td><td style="padding:6px 9px">biti kriv, imati grijeha</td><td style="padding:6px 9px;font-style:italic">„Tko god to optužuje, sigurno ima maslac na glavi."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">izaći na kraj</td><td style="padding:6px 9px">savladati situaciju</td><td style="padding:6px 9px;font-style:italic">„Nisam mogao izaći na kraj s gradivom."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">gnjaviti dušu</td><td style="padding:6px 9px">smetati, dosađivati</td><td style="padding:6px 9px;font-style:italic">„Ne gnjavi mi dušu s tim glupostima."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">staviti na stol</td><td style="padding:6px 9px">otvoreno reći, predstaviti</td><td style="padding:6px 9px;font-style:italic">„Stavio je sve karte na stol."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">vrtjeti se u krug</td><td style="padding:6px 9px">ne napredovati</td><td style="padding:6px 9px;font-style:italic">„Vrtim se u krug s ovim zadatkom."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">imati krzno na koži</td><td style="padding:6px 9px">biti debelokožan, ne osjećati uvrede</td><td style="padding:6px 9px;font-style:italic">„Ima krzno na koži — kritike ga ne diraju."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">leđa i trbuh</td><td style="padding:6px 9px">poznavati napamet</td><td style="padding:6px 9px;font-style:italic">„Znam to leđa i trbuh."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">na vagi</td><td style="padding:6px 9px">u ravnoteži, neodlučno</td><td style="padding:6px 9px;font-style:italic">„Sve je na vagi — moglo bi i jedno i drugo."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">dolijati</td><td style="padding:6px 9px">biti uhvaćen u prijestupu</td><td style="padding:6px 9px;font-style:italic">„Dolijao je s prepisivanjem."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">igrati se vatrom</td><td style="padding:6px 9px">raditi opasnu stvar</td><td style="padding:6px 9px;font-style:italic">„Ne igraj se vatrom — može gore."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">staviti pod tepih</td><td style="padding:6px 9px">sakriti problem</td><td style="padding:6px 9px;font-style:italic">„Ne stavljaj problem pod tepih."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">progutati knedlu</td><td style="padding:6px 9px">prikriti emociju</td><td style="padding:6px 9px;font-style:italic">„Progutao sam knedlu i nastavio."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">vagati riječi</td><td style="padding:6px 9px">biti pažljiv u govoru</td><td style="padding:6px 9px;font-style:italic">„Vagaj riječi pred njim."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">visjeti o koncu</td><td style="padding:6px 9px">biti u opasnosti</td><td style="padding:6px 9px;font-style:italic">„Posao mu visi o koncu."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">vidjeti zvjezdice</td><td style="padding:6px 9px">biti udaren, šokiran</td><td style="padding:6px 9px;font-style:italic">„Pao sam i vidio zvjezdice."</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:6px 9px;font-weight:700">pred očima imati cilj</td><td style="padding:6px 9px">biti fokusiran</td><td style="padding:6px 9px;font-style:italic">„Pred očima imam samo maturu."</td></tr>
          <tr><td style="padding:6px 9px;font-weight:700">otići u zaborav</td><td style="padding:6px 9px">biti zaboravljen</td><td style="padding:6px 9px;font-style:italic">„To je davno otišlo u zaborav."</td></tr>
        </tbody>
      </table>
    </div>

    <!-- ─────────────── FRAZEM TIPOLOGIJA ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">🧬 Tipologija frazema</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">📝 3 osnovna tipa po strukturi</div>
      <div class="box-int-txt">
        Frazemi se mogu klasificirati po strukturi (koliko su čvrsto vezani) ili po značenju (kako daleko od doslovnog).
      </div>
    </div>
    ...
    <div class="table-wrap">
      <table style="width:100%;border-collapse:collapse;font-family:var(--mono);font-size:12px">
        <thead>
          <tr style="background:var(--ele);border-bottom:2px solid var(--gold)">
            <th style="padding:8px 10px;text-align:left;color:var(--gold);font-size:10.5px">TIP</th>
            <th style="padding:8px 10px;text-align:left;color:var(--gold);font-size:10.5px">DEFINICIJA</th>
            <th style="padding:8px 10px;text-align:left;color:var(--gold);font-size:10.5px">PRIMJER</th>
          </tr>
        </thead>
        <tbody>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--blue);font-weight:700">Idiom</td><td style="padding:8px 10px">potpuno frazemsko značenje, ne može se rekonstruirati iz riječi</td><td style="padding:8px 10px;font-style:italic">pasti s kruške, biti na konju</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--green);font-weight:700">Frazemska sveza</td><td style="padding:8px 10px">djelomično frazemsko, jedna riječ je doslovna</td><td style="padding:8px 10px;font-style:italic">izaći na kraj (= savladati)</td></tr>
          <tr style="border-bottom:1px solid var(--bd)"><td style="padding:8px 10px;color:var(--bronze);font-weight:700">Kolokacija</td><td style="padding:8px 10px">ustaljena sveza riječi, gotovo doslovno značenje</td><td style="padding:8px 10px;font-style:italic">jaka kava, gusta magla</td></tr>
          <tr><td style="padding:8px 10px;color:var(--red);font-weight:700">Poslovica</td><td style="padding:8px 10px">cjelovita rečenica s poukom (NIJE frazem strogo!)</td><td style="padding:8px 10px;font-style:italic">Tko rano rani, dvije sreće grabi</td></tr>
        </tbody>
      </table>
    </div>
    ...
    <!-- NAV ROW -->
    <div class="nav-row" style="margin-top:32px;display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap">
      <button class="nb-btn" onclick="sw(2)">← Slojevi</button>
      <button class="nb-btn primary" onclick="sw(5)">Frazem Scanner →</button>
    </div>
  </div><!-- /l3 -->
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    ...
    <div class="pojm-controls">
      ...
      <button class="pojm-filter" onclick="pojmFilter('odnosi', this)">Odnosi</button>
      <button class="pojm-filter" onclick="pojmFilter('znacenje', this)">Značenje</button>
      <button class="pojm-filter" onclick="pojmFilter('frazemi', this)">Frazemi</button>
      <button class="pojm-filter" onclick="pojmFilter('slojevi', this)">Slojevi</button>
      <button class="pojm-filter" onclick="pojmFilter('tropi', this)">Tropi</button>
      <button class="pojm-filter" onclick="pojmFilter('onomastika', this)">Onomastika</button>
      <button class="pojm-filter" onclick="pojmFilter('leksikografija', this)">Rječnici</button>
    ...
    <div class="nav-row">
      ...
      <span class="nb-btn primary" onclick="sw(5)">🔬 Frazem Scanner →</span>
    </div>
  ...
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    <div class="tags">
      <span class="pill p-pa hchip">🔬 Frazem Scanner</span>
      <span class="pill p-br hchip">🤖 Auto-detekcija</span>
      <span class="pill p-pa hchip">📚 100+ frazema</span>
    </div>

    <!-- ─────────────── INTRO ─────────────── -->
    <div class="sec-hdr"><div class="sec-line"></div><div class="sec-badge">🔬 Frazem Scanner · interaktivno</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🎯 Kako radi</div>
      <div class="box-int-txt">
        Unesi rečenicu — Frazem Scanner će <strong>prepoznati frazeme</strong> u njoj i objasniti njihovo značenje. Baza ima 100+ najčešćih hrvatskih frazema. Idealno za vježbu prije mature.
      </div>
    </div>
    ...
    <div class="parser-card">
      <div class="parser-input-wrap">
        <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:10px">
          <input type="text" id="fs-input" placeholder="Npr. Pao mi je kamen sa srca kad sam saznao..." 
                 onkeydown="if(event.key==='Enter') fsAnalyze()"
          ...
          <button class="nb-btn primary" onclick="fsAnalyze()" style="padding:12px 18px;font-size:13px">🔬 Skeniraj</button>
        </div>
        
        <!-- Quick examples -->
        <div style="display:flex;gap:6px;flex-wrap:wrap;align-items:center">
          <span style="font-family:var(--mono);font-size:10px;color:var(--t3);letter-spacing:1px">PRIMJERI →</span>
          <button class="nb-btn" style="padding:4px 10px;font-size:10.5px" onclick="fsExample('Pao mi je kamen sa srca kad sam saznao da si dobro.')">olakšanje</button>
          <button class="nb-btn" style="padding:4px 10px;font-size:10.5px" onclick="fsExample('Položio sam maturu — sad sam na konju!')">uspjeh</button>
          <button class="nb-btn" style="padding:4px 10px;font-size:10.5px" onclick="fsExample('Moj brat ima zlatne ruke za sve popravke.')">talent</button>
          <button class="nb-btn" style="padding:4px 10px;font-size:10.5px" onclick="fsExample('Ne traži dlaku u jajetu, sve je OK.')">sitnice</button>
          <button class="nb-btn" style="padding:4px 10px;font-size:10.5px" onclick="fsExample('Spavala sam kao top nakon ispita.')">spavanje</button>
          <button class="nb-btn" style="padding:4px 10px;font-size:10.5px;border-color:var(--blue);color:var(--blue);font-weight:700" onclick="fsRandom()">🎲 Random</button>
        </div>
      </div>

      <div class="parser-output" id="fs-output">
        <div style="font-style:italic">Unesi rečenicu i klikni „Skeniraj" za analizu frazema.</div>
      </div>
    </div>

    <!-- ─────────────── HOW IT WORKS ─────────────── -->
    <div class="sec-hdr" style="margin-top:32px"><div class="sec-line"></div><div class="sec-badge">📖 Kako Scanner detektira frazeme</div><div class="sec-line"></div></div>
    
    <div class="box-int">
      <div class="box-int-lbl">🔧 Tehnička pozadina (za radoznale)</div>
      <div class="box-int-txt">
        Scanner koristi <strong>predefiniranu bazu od 100+ najčešćih hrvatskih frazema</strong>. Svaka rečenica se tokenizira (razdvaja na riječi) i sustav traži ključne fraze (npr. „kamen sa srca", „na konju", „dlaku u jajetu"). Lemmatizacija nije savršena — vjerojatno će promaći neke varijacije, ali pokriva 90% standardnih oblika.
      </div>
    </div>
  ...
  <div class="layer" id="l7" role="tabpanel" tabindex="0">
    ...
    <!-- ════════════════════
         A4 REFERENCE SHEET — LEKSIKOLOGIJA
    ════════════════════ -->
    <div class="ref-sheet" id="ref-sheet">
      
      <!-- HEADER -->
      <div class="ref-header">
        <div class="ref-title">LEKSIKOLOGIJA · A4 REFERENCA</div>
        <div class="ref-subtitle">MATURIRAJ.HR · H22 · MATURA HRVATSKI 2026</div>
      </div>

      <!-- ZNAČENJSKI ODNOSI -->
      <div class="ref-section">
        <div class="ref-section-ttl">5 značenjskih odnosa</div>
        <table class="ref-tbl">
          <thead><tr><th>Odnos</th><th>Definicija</th><th>Primjer</th></tr></thead>
          <tbody>
            <tr><td><strong>Sinonimi</strong></td><td>isto/slično značenje (bliskoznačnice)</td><td><em>kuća = dom · brz = hitar</em></td></tr>
            <tr><td><strong>Antonimi</strong></td><td>suprotno značenje (3 tipa)</td><td><em>dobar × loš · živ × mrtav · učitelj × učenik</em></td></tr>
            <tr><td><strong>Homonimi</strong></td><td>isti oblik, RAZLIČITA nepovezana značenja</td><td><em>kosa (vlas / oruđe)</em></td></tr>
            <tr><td><strong>Paronimi</strong></td><td>sličan oblik, različito značenje</td><td><em>efektan ≠ efektivan</em></td></tr>
            <tr><td><strong>Hiperonim/Hiponim</strong></td><td>nadređen / podređen pojam</td><td><em>cvijet → ruža (hiponim) · kohiponimi: ruža + ljiljan</em></td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="ref-section">
        <div class="ref-section-ttl">Polisemija vs. homonimija</div>
        <div class="ref-grid-2">
          <div class="ref-mini">
            <div class="ref-mini-ttl">Polisemija</div>
            <ul>
              <li>ISTA riječ, više POVEZANIH značenja</li>
              <li><em>vrijeme</em>: trajanje + atmosfera</li>
              <li><em>list</em>: papir + biljka + dio tijela</li>
            </ul>
            <div class="ref-mini-note">U rječniku 1 odrednica</div>
          </div>
          <div class="ref-mini">
            <div class="ref-mini-ttl">Homonimi</div>
            <ul>
              <li>RAZLIČITE riječi sa istim oblikom</li>
              <li><em>kosa</em>: vlasi / oruđe</li>
              <li><em>graditi</em>: bauen / iznositi</li>
            </ul>
            <div class="ref-mini-note">U rječniku 2+ odrednice</div>
          </div>
        </div>
      </div>
      ...
      <!-- ZNAČENJE -->
      <div class="ref-section">
        <div class="ref-section-ttl">Denotacija ↔ konotacija</div>
        <table class="ref-tbl">
          <thead><tr><th>Pojam</th><th>Definicija</th><th>Primjer (zmija)</th></tr></thead>
          <tbody>
            <tr><td><strong>Denotacija</strong></td><td>osnovno, doslovno značenje</td><td><em>reptil bez nogu</em></td></tr>
            <tr><td><strong>Konotacija</strong></td><td>dodatno emocionalno/asocijativno</td><td><em>lukav, podmukao čovjek</em></td></tr>
          </tbody>
        </table>
      </div>
      ...
      <!-- SLOJEVI LEKSIKA -->
      <div class="ref-section">
        <div class="ref-section-ttl">5 slojeva leksika</div>
        <div class="ref-grid-2">
          <div class="ref-mini">
            <div class="ref-mini-ttl">Vremenski</div>
            <ul>
              <li><strong>Arhaizam</strong> — pojam postoji (jur)</li>
              <li><strong>Historizam</strong> — pojam ne postoji (kmet)</li>
              <li><strong>Neologizam</strong> — nova riječ (selfie)</li>
            </ul>
          </div>
          <div class="ref-mini">
            <div class="ref-mini-ttl">Prostorni</div>
            <ul>
              <li><strong>Dijalektizam</strong> — iz narječja (kaj, ča)</li>
              <li><strong>Regionalizam</strong> — regija (gemišt)</li>
              <li><strong>Lokalizam</strong> — uska regija</li>
            </ul>
          </div>
          <div class="ref-mini">
            <div class="ref-mini-ttl">Funkcionalni</div>
            <ul>
              <li><strong>Neutralno</strong> — kuća, jesti</li>
              <li><strong>Razgovorno</strong> — baka, faca</li>
              <li><strong>Knjiški</strong> — preminuti, ushićen</li>
            </ul>
          </div>
          <div class="ref-mini">
            <div class="ref-mini-ttl">Stručni / Strane</div>
            <ul>
              <li><strong>Termin</strong> — integral, anestezija</li>
              <li><strong>Posuđenica</strong> — škola (lat.)</li>
              <li><strong>Tuđica</strong> — jazz, computer</li>
              <li><strong>Internacionalizam</strong> — telefon</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <!-- FRAZEMI -->
      <div class="ref-section">
        <div class="ref-section-ttl">Frazemi · NCVVO ⭐ TOP-tema</div>
        <div class="ref-mini" style="margin-bottom:6px">
          <div class="ref-mini-ttl">Definicija</div>
          <p style="margin:0;font-size:9.5px"><strong>Frazem</strong> = ustaljen izraz čije značenje NIJE zbroj značenja pojedinih riječi. <em>Kamen sa srca</em> = olakšanje (doslovno apsurd). 4 karakteristike: ustaljenost, nekompozicionalnost, reproduktivnost, slikovitost.</p>
        </div>
        <table class="ref-tbl">
          <thead><tr><th>Frazem</th><th>Značenje</th></tr></thead>
          <tbody>
            <tr><td><em>pasti s kruške</em></td><td>biti zbunjen, naivan</td></tr>
            <tr><td><em>kamen sa srca</em></td><td>olakšanje</td></tr>
            <tr><td><em>biti na konju</em></td><td>uspjeti</td></tr>
            <tr><td><em>baciti pogled</em></td><td>brzo pogledati</td></tr>
            <tr><td><em>zlatne ruke</em></td><td>vješt rukom</td></tr>
            <tr><td><em>izgubiti glavu</em></td><td>izgubiti razum</td></tr>
            <tr><td><em>dlaku u jajetu</em></td><td>tražiti sitne mane</td></tr>
            <tr><td><em>spavati kao top</em></td><td>spavati duboko</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <!-- TROPI -->
      <div class="ref-section">
        <div class="ref-section-ttl">Tropi · figure značenja</div>
        <table class="ref-tbl">
          <thead><tr><th>Trop</th><th>Princip</th><th>Primjer</th></tr></thead>
          <tbody>
            <tr><td><strong>Metafora</strong></td><td>SLIČNOST</td><td><em>glava obitelji</em> (kao glava tijela)</td></tr>
            <tr><td><strong>Metonimija</strong></td><td>BLIZINA</td><td><em>popiti čašu</em> (= sadržaj)</td></tr>
            <tr><td><strong>Sinegdoha</strong></td><td>DIO ↔ CJELINA</td><td><em>krov</em> (= cijela kuća)</td></tr>
            <tr><td><strong>Personifikacija</strong></td><td>oživljavanje</td><td><em>vrijeme leti</em></td></tr>
          </tbody>
        </table>
      </div>
      ...
      <!-- ONOMASTIKA -->
      <div class="ref-section">
        <div class="ref-section-ttl">Onomastika · vlastita imena</div>
        <div class="ref-grid-3">
          <div class="ref-mini">
            <div class="ref-mini-ttl">Antroponim</div>
            <ul><li>Ivan, Marija</li><li>Horvat (prezime)</li></ul>
          </div>
          <div class="ref-mini">
            <div class="ref-mini-ttl">Toponim</div>
            <ul><li>Zagreb (mjesto)</li><li>Sava (hidronim)</li><li>Velebit (oronim)</li></ul>
          </div>
          <div class="ref-mini">
            <div class="ref-mini-ttl">Etnonim</div>
            <ul><li>Hrvati, Srbi</li><li>Slovenci</li></ul>
          </div>
        </div>
      </div>
      ...
      <div class="ref-section">
        ...
        <div class="ref-zamke">
          <div><strong>Sinonim ≠ ista riječ:</strong> postoji nijansa (kuća/dom — bliskoznačnice).</div>
          <div><strong>Polisemija ≠ homonimija:</strong> polisemija = povezana značenja, homonimija = nepovezana.</div>
          <div><strong>Arhaizam ≠ historizam:</strong> arhaizam = pojam postoji (jur). Historizam = pojam ne postoji (kmet).</div>
          <div><strong>Posuđenica ≠ tuđica:</strong> posuđenica se prilagodila (škola). Tuđica zadržava strani oblik (jazz).</div>
          <div><strong>Frazem ≠ poslovica:</strong> poslovica = cjelovita rečenica s poukom. Frazem = izraz unutar rečenice.</div>
          <div><strong>Paronimi:</strong> efektan ≠ efektivan. Adekvatan ≠ ekvivalentan. Verbalan ≠ vjerski.</div>
          <div><strong>Hiperonim ≠ vrsta:</strong> cvijet je hiperonim (nadređen), ne kategorija u svakodnevnom smislu.</div>
          <div><strong>Konotacija:</strong> doslovno značenje + emocionalna asocijacija. Zmija → lukav.</div>
        </div>
      </div>

      <!-- FOOTER -->
      <div class="ref-footer">
        <span>maturiraj.hr · H22 leksikologija · v1.0</span>
  ...
  <div class="chapter-nav-wrap">
    ...
    <div class="chapter-nav-grid">
      <a class="chapter-nav-card chapter-nav-prev" href="/skripte/hrv/h21">
      ...
      <a class="chapter-nav-card chapter-nav-next" href="/skripte/hrv/h23">
        <div class="chapter-nav-meta">
          <div class="chapter-nav-pill chapter-nav-pill-next">SLJEDEĆE</div>
          <div class="chapter-nav-name">H23 · Povijest hrv. jezika</div>
          <div class="chapter-nav-desc">Razdoblja, pisma, najstariji spomenici</div>
        </div>
        <div class="chapter-nav-arrow">→</div>
      </a>
</div>
  ...
  <footer class="mod-foot" role="contentinfo">
    <div class="foot-line"><b>Maturiraj.hr</b> · Hrvatski · H22 Sintaksa I — rečenični članovi</div>
...
function submitFeedback(ev){
  ...
  var payload = {
    ...
    p_tab_index: (function(){ try{ return JSON.parse(localStorage.getItem('mt.hrv.h22.tab') || '0') }catch(e){return 0} })(),
...
const KVIZ_Q = [
  // 30 leksikoloških pitanja — distribucija po težini
  {q:'„Kuća" i „dom" su:',o:['homonimi','sinonimi (bliskoznačnice)','antonimi','paronimi'],t:1,e:'Sinonimi/bliskoznačnice — različite riječi sa istim/sličnim značenjem.'},
  {q:'Što je leksem?',o:['svaka riječ u tekstu','jedinica značenja koja obuhvaća sve oblike','prefiks','samo nominativ'],t:1,e:'Leksem = riječ kao apstraktna jedinica značenja, sve oblike (pisati, pišem, pisao = isti leksem).'},
  {q:'„Pao mi je kamen sa srca" je:',o:['poslovica','frazem','metafora','sinegdoha'],t:1,e:'Frazem (idiom) — ustaljen izraz čije značenje nije zbroj značenja riječi.'},
  {q:'Riječ „kmet" je:',o:['arhaizam','historizam','dijalektizam','neologizam'],t:1,e:'Historizam — pojam (feudalna kategorija seljaka) više ne postoji u suvremenom svijetu.'},
  {q:'Riječ „jur" (= već) je:',o:['arhaizam','historizam','dijalektizam','neologizam'],t:0,e:'Arhaizam — stara riječ za pojam (ono što izražava „već") koji JOŠ postoji.'},
  {q:'„Vrijeme" u „vrijeme leti" / „lošo vrijeme" — to je:',o:['homonimija','polisemija','sinonimija','metafora'],t:1,e:'Polisemija — ista riječ, više povezanih značenja (trajanje + atmosferska pojava).'},
  {q:'„Kosa" (vlasi) i „kosa" (oruđe) su:',o:['polisemija','sinonimi','homonimi','paronimi'],t:2,e:'Homonimi — isti oblik, RAZLIČITO značenje, NEPOVEZANE etimologije.'},
  {q:'„Efektan" i „efektivan" su:',o:['sinonimi','antonimi','paronimi','homonimi'],t:2,e:'Paronimi — sličan oblik, različito značenje. Top NCVVO zamka!'},
  {q:'Hiperonim za „pas, mačka, papagaj":',o:['kućni ljubimac','životinja','sisavac','biće'],t:1,e:'Životinja je nadređen pojam (hiperonim) za sve nabrojano.'},
  {q:'Metafora se temelji na:',o:['vremenskoj sličnosti','prostornoj blizini','sličnosti pojmova','dijelu i cjelini'],t:2,e:'Metafora = prijenos po SLIČNOSTI. „Glava obitelji" = vodilac (kao glava tijela).'},
  {q:'„Popiti čašu" (= pijuckati sadržaj) — figura:',o:['metafora','metonimija','sinegdoha','personifikacija'],t:1,e:'Metonimija — prijenos po BLIZINI. Čaša ≠ sadržaj, ali su povezani.'},
  {q:'„Krov" (= cijela kuća) — figura:',o:['metafora','metonimija','sinegdoha','antonomazija'],t:2,e:'Sinegdoha — DIO za CJELINU. Krov je dio kuće, koristi se za cijelu.'},
  {q:'„Zmija" za „lukav čovjek" je:',o:['denotacija','konotacija','sinonimija','metonimija'],t:1,e:'Konotacija — dodatno emocionalno/vrednovano značenje. Doslovno je reptil, asocijativno = lukav.'},
  {q:'Riječ „selfie" je:',o:['arhaizam','historizam','neologizam','dijalektizam'],t:2,e:'Neologizam — nova riječ (~2010+), strukturni neologizam posuđen iz engleskog.'},
  {q:'Riječ „kaj" je:',o:['arhaizam','historizam','dijalektizam','sleng'],t:2,e:'Dijalektizam — kajkavski upitno-odnosni izraz „što". Iz kajkavskog narječja.'},
  {q:'„Anestezija" je:',o:['neologizam','termin','arhaizam','dijalektizam'],t:1,e:'Termin — stručni naziv u medicini, jednoznačan unutar struke.'},
  {q:'„Računalo" (od „compute") je:',o:['posuđenica','tuđica','prevedenica (kalk)','dijalektizam'],t:2,e:'Prevedenica/kalk — doslovni prijevod stranog izraza (compute → računati → računalo).'},
  {q:'„Computer" u hrvatskom je:',o:['posuđenica','tuđica','prevedenica','arhaizam'],t:1,e:'Tuđica — zadržava strani oblik i izgovor, ne prilagođava se hrvatskom pravopisu.'},
  {q:'„Škola" (od lat. schola) je:',o:['posuđenica','tuđica','prevedenica','arhaizam'],t:0,e:'Posuđenica — preuzeta riječ koja se prilagodila hrvatskoj fonetici/pravopisu.'},
  {q:'„Telefon" je u svim europskim jezicima — što je to?',o:['arhaizam','tuđica','internacionalizam','dijalektizam'],t:2,e:'Internacionalizam — riječ prisutna u više jezika sa istim oblikom i značenjem.'},
  {q:'„Ako bismo gradili kuću" — figura?',o:['metafora','frazem','poslovica','nije figura'],t:3,e:'Doslovno značenje, nema prijenosa. „Kuća" = građevina, ne metaforički.'},
  {q:'„Nikad nisam ništa rekao" je:',o:['gramatička greška','dvostruka negacija (gramatički ispravno u hrvatskom)','sinonimija','homonimija'],t:1,e:'U hrvatskom je više negacija gramatički ispravno i pojačava nijek.'},
  {q:'„Ivan, Marija, Tomislav" — to su:',o:['toponimi','antroponimi','etnonimi','hidronimi'],t:1,e:'Antroponimi — osobna imena, dio onomastike.'},
  {q:'„Zagreb, Sava, Velebit" — to su:',o:['antroponimi','toponimi','etnonimi','oronimi'],t:1,e:'Toponimi — imena mjesta. Sava je posebno hidronim, Velebit oronim, ali svi su toponimi u širem smislu.'},
  {q:'„Hrvati, Srbi" — to su:',o:['antroponimi','toponimi','etnonimi','sinonimi'],t:2,e:'Etnonimi — imena naroda. Iz onomastike.'},
  {q:'„Skok" (radnja) i „skok" (zdjela) su:',o:['polisemija','homonimi','sinonimi','antonimi'],t:1,e:'Homonimi — isti oblik, nepovezana značenja (sport vs. posuda).'},
  {q:'„Ekvivalentan" i „adekvatan" su:',o:['sinonimi','paronimi','antonimi','homonimi'],t:1,e:'Paronimi — sličan oblik, različito značenje. Ekvivalentan = istovrijedan. Adekvatan = primjeren.'},
  {q:'„Pile" za „dijete" je:',o:['denotacija','konotacija (deminutiv s emocijom)','sinonimija','metonimija'],t:1,e:'Konotacija — doslovno mlada kokoš, asocijativno = nježno dijete.'},
  {q:'„Jato vojnika" — to je primjer:',o:['arhaizma','historizma','sleng','dijalektizam'],t:1,e:'Historizam — „jato" u značenju vojničke skupine više ne postoji u suvremenoj uporabi.'},
  {q:'„Faca" za „cool osoba" je:',o:['termin','sleng','arhaizam','frazem'],t:1,e:'Sleng — razgovorni mladenački jezik.'},
];const CP_ITEMS=[
...
const DIAG0_Q=[
  {q:'Što je leksem?',o:['svaka pojava riječi u tekstu','riječ kao jedinica značenja (svi oblici jedne riječi)','samo nominativ riječi','rječnik','prefix'],t:1,e:'Leksem = riječ kao jedinica značenja, obuhvaća sve oblike (pisati, pišem, pisao = isti leksem). Riječ u tekstu je njegov pojavni oblik.'},
  {q:'„Kuća" i „dom" su:',o:['homonimi','antonimi','sinonimi','paronimi'],t:2,e:'Sinonimi — različite riječi sa istim ili sličnim značenjem. „Kuća" i „dom" oboje označavaju mjesto stanovanja (s blagom razlikom: dom ima emocionalnu konotaciju).'},
  {q:'„Pao je kao kruška" je:',o:['poslovica','frazem','metafora','sinegdoha'],t:1,e:'Frazem (idiom) — ustaljen izraz čije značenje nije zbroj značenja riječi. „Pasti kao kruška" = pasti naglo, glavinom, na jaki način.'},
  {q:'Riječ „kompjuter" je u hrvatskom:',o:['arhaizam','tuđica','dijalektizam','sinonim'],t:1,e:'Tuđica — nepristopljena strana riječ koja zadržava strani oblik i izgovor. „Računalo" je hrvatski izvor. „Kompjuter" se piše kao u izvornom jeziku.'},
  {q:'„Vrijeme" u rečenicama: „Vrijeme leti" / „Sutra je lošo vrijeme" — kakva je to pojava?',o:['homonimija','sinonimija','polisemija','antonomazija'],t:2,e:'Polisemija — ista riječ ima više povezanih značenja. „Vrijeme" kao trajanje i atmosferska pojava su povezana značenja iste riječi.'},
  {q:'Hiperonim od „pas, mačka, papagaj" je:',o:['kućni ljubimac','životinja','sisavac','biće'],t:1,e:'Hiperonim = nadređen pojam koji obuhvaća sve podpojmove. „Životinja" obuhvaća sve nabrojano. „Kućni ljubimac" je preusko (papagaj nije svuda ljubimac).'},
  {q:'Metafora se temelji na:',o:['vremenskoj sličnosti','prostornoj blizini','sličnosti pojmova','dijelu i cjelini'],t:2,e:'Metafora = prijenos značenja po SLIČNOSTI. „Glava obitelji" — slično glavi tijela (vodilac). Metonimija je po blizini, sinegdoha po dijelu/cjelini.'},
  {q:'„Pile mu je palo s kruške" — što je tu „pile"?',o:['hiperonim','frazem','denotacija','konotacija (= dijete)'],t:3,e:'Konotacija — dodatno emocionalno značenje. „Pile" doslovno = mlada kokoš, ali u kontekstu znači „dijete" (deminutiv s emocionalnom konotacijom nježnosti).'},
  {q:'„Efektan" i „efektivan" su:',o:['sinonimi','paronimi (slični oblici, različita značenja)','antonimi','homonimi'],t:1,e:'Paronimi — riječi slične po obliku ali različitog značenja. „Efektan" = upadljiv, dojmljiv. „Efektivan" = djelotvoran, koji daje rezultat. Često zamjenjivani!'},
  {q:'„Knjiga" u rečenici „Pročitao sam tri knjige" — je:',o:['hiperonim','sinegdoha','polisemija','denotacija (osnovno značenje)'],t:3,e:'Denotacija = osnovno, doslovno značenje riječi. „Knjiga" tu označava fizički predmet, materijalni objekt. Konotacija bi bila „znanje" ili „pamet".'},
];
...
const POJM_DATA2 = [
  // ZNAČENJSKI ODNOSI (15)
  {kat:'odnosi', term:'Sinonimi', def:'Riječi različitog oblika ali istog ili sličnog značenja. Pravi sinonimi su rijetki — najčešće su bliskoznačnice s nijansama. Primjer: kuća = dom.', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Bliskoznačnice', def:'Riječi sa sličnim ali ne identičnim značenjem. Razlikuju se po stilu, nijansi ili kontekstu. NCVVO traži bliskoznačnice češće od pravih sinonima.', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Antonimi', def:'Riječi sa suprotnim značenjem. 3 tipa: komplementarni (živ × mrtav), graduelni (dobar × loš), relativni (učitelj × učenik).', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Komplementarni antonimi', def:'Antonimi bez sredine — apsolutna suprotnost. Primjer: živ × mrtav, paran × neparan, prisutan × odsutan.', tag:''},
  {kat:'odnosi', term:'Graduelni antonimi', def:'Antonimi s međustanjem. Primjer: vruć × hladan (postoji „mlak"), dobar × loš (postoji „prosječan").', tag:''},
  {kat:'odnosi', term:'Relativni antonimi', def:'Antonimi po odnosu uloga. Primjer: učitelj × učenik, prodavač × kupac, roditelj × dijete.', tag:''},
  {kat:'odnosi', term:'Homonimi', def:'Riječi istog oblika ali različitog (nepovezanog) značenja. Primjer: kosa (vlas) i kosa (oruđe).', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Homofoni', def:'Vrsta homonima — isti izgovor, različit zapis. U hrvatskom rjeđe nego u engleskom.', tag:''},
  {kat:'odnosi', term:'Homografi', def:'Vrsta homonima — isti zapis, različit naglasak. Primjer: lùk (povrće) / lȗk (oružje).', tag:''},
  {kat:'odnosi', term:'Paronimi', def:'Riječi sličnog oblika ali različitog značenja. Najčešće zamjenjuju u govoru. Primjer: efektan (dojmljiv) ≠ efektivan (djelotvoran).', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Hiperonim', def:'Nadređen pojam koji obuhvaća skupinu. Primjer: cvijet je hiperonim za ružu, ljiljan, tulipan. Od grč. hyper = iznad.', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Hiponim', def:'Podređen pojam, vrsta hiperonima. Primjer: ruža je hiponim cvijeta. Od grč. hypo = ispod.', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Kohiponim', def:'Pojmovi na istoj hijerarhijskoj razini, dijele isti hiperonim. Primjer: ruža i ljiljan su međusobno kohiponimi.', tag:''},
  {kat:'odnosi', term:'Polisemija', def:'Ista riječ ima više povezanih značenja. Razlika od homonimije: značenja su povezana etimologijom. Primjer: vrijeme (trajanje + atmosferska pojava).', star:true, tag:'NCVVO'},
  {kat:'odnosi', term:'Monosemija', def:'Riječ ima samo jedno značenje. Tipično za stručne termine. Primjer: integral (matematika) — samo jedno značenje.', tag:''},

  // ZNAČENJE (10)
  {kat:'znacenje', term:'Denotacija', def:'Osnovno, doslovno, neutralno značenje riječi. Bez emocionalnog tona. Primjer: zmija = reptil bez nogu.', star:true, tag:'NCVVO'},
  {kat:'znacenje', term:'Konotacija', def:'Dodatno emocionalno, vrednovano, asocijativno značenje. Primjer: zmija → lukav, podmukao čovjek (negativna konotacija).', star:true, tag:'NCVVO'},
  {kat:'znacenje', term:'Leksem', def:'Riječ kao apstraktna jedinica značenja. Obuhvaća sve oblike (pisati, pišem, pisao = isti leksem). U rječniku.', star:true, tag:'NCVVO'},
  {kat:'znacenje', term:'Riječ', def:'Pojavni oblik leksema u tekstu. Konkretno ostvarenje u govoru/pismu.', tag:''},
  {kat:'znacenje', term:'Leksikon', def:'Ukupni rječnički sastav nekog jezika. Skup svih leksema.', tag:''},
  {kat:'znacenje', term:'Semem', def:'Najmanja jedinica značenja. Pojedinačno značenje polisemne riječi.', tag:''},
  {kat:'znacenje', term:'Semantika', def:'Znanost o značenju riječi i jezičnih jedinica.', tag:''},
  {kat:'znacenje', term:'Semantičko polje', def:'Skup riječi povezanih značenjem (boje: crven, zelen, plav... su jedno semantičko polje).', tag:''},
  {kat:'znacenje', term:'Eufemizam', def:'Ublažen izraz za neugodan pojam. Primjer: preminuti < umrijeti, otići u drugi svijet.', star:true, tag:'NCVVO'},
  {kat:'znacenje', term:'Hiperbola', def:'Pretjerivanje u izrazu radi naglašavanja. Primjer: umirem od gladi, milijun puta sam ti rekao.', tag:''},

  // FRAZEMI (10)
  {kat:'frazemi', term:'Frazem', def:'Ustaljen izraz čije značenje nije zbroj značenja pojedinih riječi. Primjer: pasti s kruške (= biti zbunjen).', star:true, tag:'NCVVO ⭐'},
  {kat:'frazemi', term:'Idiom', def:'Sinonim za frazem (međunarodni naziv). Potpuno frazemsko značenje.', tag:''},
  {kat:'frazemi', term:'Frazeologija', def:'Znanost o frazemima. Također skup svih frazema jezika.', tag:''},
  {kat:'frazemi', term:'Kolokacija', def:'Ustaljena sveza riječi sa skoro doslovnim značenjem. Primjer: jaka kava, gusta magla.', tag:''},
  {kat:'frazemi', term:'Frazemska sveza', def:'Djelomično frazemski izraz — jedna riječ ima doslovno značenje. Primjer: izaći na kraj.', tag:''},
  {kat:'frazemi', term:'Poslovica', def:'Cjelovita rečenica s poukom. Razlika od frazema: ima sintaktičku strukturu rečenice. Primjer: Tko rano rani, dvije sreće grabi.', star:true, tag:'NCVVO'},
  {kat:'frazemi', term:'Izreka', def:'Slično poslovici, ali bez stroge metričke forme. Često s narodnom mudrošću.', tag:''},
  {kat:'frazemi', term:'Sentencija', def:'Sažeta misao izražena u kratkoj formi, najčešće književnog ili filozofskog porijekla.', tag:''},
  {kat:'frazemi', term:'Aforizam', def:'Kratak duhoviti izraz s mudrom porukom. Primjer: „Misao je zatvor stvarnosti."', tag:''},
  {kat:'frazemi', term:'Krilatica', def:'Poznata izreka koja se često citira, najčešće iz književnosti ili politike.', tag:''},

  // SLOJEVI LEKSIKA (15)
  {kat:'slojevi', term:'Arhaizam', def:'Stara riječ za pojam koji JOŠ POSTOJI. Primjer: jur (= već), zamak (= dvorac).', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Historizam', def:'Riječ za pojam koji više NE POSTOJI. Primjer: kmet, latifundija. Razlika od arhaizma: pojam ne postoji u suvremenom svijetu.', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Neologizam', def:'Nova riječ ili novo značenje postojeće riječi. Primjer: selfie (strukturni), miš (semantički — računalna naprava).', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Dijalektizam', def:'Riječ iz pojedinog narječja. Primjer: kaj (kajkavski), ča (čakavski).', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Regionalizam', def:'Riječ vezana uz širu regiju, ali ne nužno iz narječja. Primjer: gemišt, šank, špajza (slavonski razgovorni).', tag:''},
  {kat:'slojevi', term:'Lokalizam', def:'Riječ ograničena na vrlo usku geografsku regiju (jedan grad, otok).', tag:''},
  {kat:'slojevi', term:'Termin', def:'Stručni naziv specifičan za određeno područje. Jednoznačan unutar struke. Primjer: integral, anestezija.', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Terminologija', def:'Skup termina jedne struke. Sustav stručnih naziva.', tag:''},
  {kat:'slojevi', term:'Žargon', def:'Stručni/profesionalni neformalan jezik. Primjer: medicinski žargon, novinarski žargon.', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Argo', def:'Tajni jezik određene grupe (zatvorenici, lopovi). Ima funkciju izolacije od ostalih.', tag:''},
  {kat:'slojevi', term:'Sleng', def:'Razgovorni mladenački jezik. Primjer: faca, kupac, biti u fazonu.', tag:''},
  {kat:'slojevi', term:'Posuđenica', def:'Preuzeta riječ koja se prilagodila hrvatskoj fonetici i morfologiji. Primjer: škola < lat. schola.', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Tuđica', def:'Riječ koja zadržava strani oblik i izgovor. Piše se kurzivom u tisku. Primjer: computer, jazz, foyer.', star:true, tag:'NCVVO'},
  {kat:'slojevi', term:'Internacionalizam', def:'Riječ prisutna u više jezika sa istim značenjem. Tipično znanstvena ili tehnička. Primjer: telefon, demokracija, atom.', tag:''},
  {kat:'slojevi', term:'Prevedenica (kalk)', def:'Doslovni prijevod stranog izraza. Primjer: nebodder ← skyscraper, vatromet ← Feuerwerk.', tag:''},

  // TROPI / TVORBA ZNAČENJA (8)
  {kat:'tropi', term:'Metafora', def:'Prijenos značenja po SLIČNOSTI. Primjer: glava obitelji = vodilac (kao glava tijela).', star:true, tag:'NCVVO'},
  {kat:'tropi', term:'Metonimija', def:'Prijenos značenja po BLIZINI/POVEZANOSTI. Primjer: popiti čašu = popiti sadržaj čaše.', star:true, tag:'NCVVO'},
  {kat:'tropi', term:'Sinegdoha', def:'Prijenos značenja po DIJELU/CJELINI. Primjer: krov = kuća, oko = pažnja.', star:true, tag:'NCVVO'},
  {kat:'tropi', term:'Personifikacija', def:'Pridavanje ljudskih svojstava neživim stvarima ili apstraktnim pojmovima. Primjer: vrijeme leti.', tag:''},
  {kat:'tropi', term:'Antonomazija', def:'Zamjena vlastitog imena općim ili obratno. Primjer: Don Juan = zavodnik.', tag:''},
  {kat:'tropi', term:'Litota', def:'Ublažavanje izricanjem suprotnog s negacijom. Primjer: nije baš pametan (= glup).', tag:''},
  {kat:'tropi', term:'Ironija', def:'Govor s suprotnim značenjem od doslovnog. Primjer: „Bravo!" za nešto loše.', tag:''},
  {kat:'tropi', term:'Sarkazam', def:'Oštra, gorka ironija s namjerom uvrede ili kritike.', tag:''},

  // ONOMASTIKA (6)
  {kat:'onomastika', term:'Onomastika', def:'Znanost o vlastitim imenima. Bavi se imenima ljudi, mjesta, naroda.', tag:''},
  {kat:'onomastika', term:'Antroponim', def:'Osobno ime (ime, prezime, nadimak). Primjer: Ivan, Marija, Horvat.', star:true, tag:'NCVVO'},
  {kat:'onomastika', term:'Toponim', def:'Ime mjesta. Primjer: Zagreb, Sava, Velebit.', star:true, tag:'NCVVO'},
  {kat:'onomastika', term:'Etnonim', def:'Ime naroda. Primjer: Hrvati, Srbi, Slovenci.', tag:''},
  {kat:'onomastika', term:'Hidronim', def:'Ime vode (rijeke, mora, jezera). Primjer: Jadran, Drava, Plitvička jezera.', tag:''},
  {kat:'onomastika', term:'Oronim', def:'Ime gore, planine. Primjer: Velebit, Učka, Medvednica.', tag:''},

  // LEKSIKOGRAFIJA (6)
  {kat:'leksikografija', term:'Rječnik', def:'Knjiga koja sadrži skup riječi jezika s njihovim definicijama, prijevodima ili objašnjenjima.', star:true, tag:''},
  {kat:'leksikografija', term:'Jednojezični rječnik', def:'Rječnik s definicijama unutar istog jezika. Primjer: Anićev, HJP (Hrvatski jezični portal).', tag:''},
  {kat:'leksikografija', term:'Dvojezični rječnik', def:'Rječnik s prijevodima između dva jezika. Primjer: hr-en, hr-de.', tag:''},
  {kat:'leksikografija', term:'Etimološki rječnik', def:'Rječnik koji prikazuje porijeklo riječi. Primjer: Skokov etimološki rječnik.', tag:''},
  {kat:'leksikografija', term:'Frazeološki rječnik', def:'Rječnik frazema s definicijama i primjerima uporabe.', tag:''},
  {kat:'leksikografija', term:'Pravopisni rječnik', def:'Rječnik koji prikazuje pravilan zapis riječi. Primjer: Hrvatski pravopis (IHJJ).', tag:''},
];let pojm2Active = 'all';
let pojm2Mode = 'grid';
let pj2Data = [];
let pj2Idx = 0;
...
function renderPojm2(){
  ...
  const KAT_LABELS = {
  odnosi: 'Značenjski odnosi',
  znacenje: 'Značenje',
  frazemi: 'Frazemi',
  slojevi: 'Slojevi leksika',
  tropi: 'Tropi',
...
function declineNoun(){
  ...
  \`;
    ...
    // Save to history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.decl_hist')||'[]');
    if(!hist.some(h => h.word === word)){
      hist.push({word, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h22.decl_hist', JSON.stringify(hist.slice(-15)));
    }
  } catch(e){}
...
function morfoAnalyze(){
  ...
  // Save to history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.scanner_hist')||'[]');
    // Only save valid words (no special chars)
    if(/^[a-zčćđšžA-ZČĆĐŠŽ\\s]+$/.test(word) && word.length < 50){
      hist.push({word, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h22.scanner_hist', JSON.stringify(hist.slice(-20)));
    }
  } catch(e){}
}
...
function rcResult(){
  ...
  // Save history
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.rc_hist') || '[]');
    hist.push({score:rcScore, total, pct, date: new Date().toISOString()});
    localStorage.setItem('mt.hrv.h22.rc_hist', JSON.stringify(hist.slice(-10)));
  } catch(e){}
...
function vrResult(){
  ...
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.vr_hist') || '[]');
    hist.push({score:vrScore, total, pct, date: new Date().toISOString()});
    localStorage.setItem('mt.hrv.h22.vr_hist', JSON.stringify(hist.slice(-10)));
  } catch(e){}
  ...
  res.innerHTML = \`
    <div class="rc-result-card" style="border-left:3px solid \${color}">
      ...
      <div style="margin-top:18px;display:flex;gap:8px;justify-content:center;flex-wrap:wrap">
        ...
        <button class="nb-btn" onclick="sw(3)">💬 Frazemi →</button>
      </div>
    </div>
  \`;
}
...
function ssResult(){
  ...
  try {
    const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.ss_hist') || '[]');
    hist.push({score:ssScore, total, pct, date: new Date().toISOString()});
    localStorage.setItem('mt.hrv.h22.ss_hist', JSON.stringify(hist.slice(-10)));
  } catch(e){}
...
function parserAnalyze(){
  ...
  if(/^[a-zA-ZčćđšžČĆĐŠŽ0-9\\s.,!?;:'-]+$/.test(text) && text.length < 200){
    try {
      const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.parser_hist') || '[]');
      hist.push({text, date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h22.parser_hist', JSON.stringify(hist.slice(-15)));
    } catch(e){}
  }
...
async function aiAsk(){
  ...
  try {
    ...
    // Save history
    try {
      const hist = JSON.parse(localStorage.getItem('mt.hrv.h22.ai_hist') || '[]');
      hist.push({q: question, a: text.slice(0, 500), date: new Date().toISOString()});
      localStorage.setItem('mt.hrv.h22.ai_hist', JSON.stringify(hist.slice(-10)));
    } catch(e){}
...
try { pojmStars = JSON.parse(localStorage.getItem('mt.hrv.h22.cit_stars') || '{}'); } catch(e){ pojmStars = {}; }
...
function pojmToggleStar(term, btn){
  ...
  try { localStorage.setItem('mt.hrv.h22.cit_stars', JSON.stringify(pojmStars)); } catch(e){}
}
...
function parserShowHistory(){
  let hist = [];
  try { hist = JSON.parse(localStorage.getItem('mt.hrv.h22.parser_hist') || '[]'); } catch(e){}
...
function parserClearHistory(){
  if(confirm('Obrisati svu povijest analiza?')){
    try { localStorage.removeItem('mt.hrv.h22.parser_hist'); } catch(e){}
    parserShowHistory();
  }
}
...
function diag0End(){
  ...
  if(pct>=80){
    msg='🌟 Odličan rezultat! Solidno znaš leksikologiju. Idi na <strong>Frazem Scanner</strong> da uvježbaš detekciju frazema.';
    btnTxt='🔬 Frazem Scanner →'; btnTab=5;
  } else if(pct>=60){
    msg='👍 Dobro znaš osnovu. Pojača Tab <strong>Slojevi leksika</strong> i <strong>Frazemi</strong> za sigurnu peticu.';
    btnTxt='🌐 Slojevi →'; btnTab=2;
  } else if(pct>=40){
    msg='📚 Imaš osnovu, ali ima rupa. Krećemo s <strong>Tab Značenje</strong> — sin/ant/hom/par odnosi su ključni.';
    btnTxt='🔤 Značenje →'; btnTab=1;
  } else {
    msg='💪 Nije panika — leksikologija ima logiku. Krećemo s <strong>Teorijom (Tab 0)</strong>. Najbitniji su frazemi i slojevi leksika — sigurno se traže na maturi.';
...
let citStars={};
try{citStars=JSON.parse(localStorage.getItem('mt.hrv.h22.cit_stars')||'{}')}catch(e){}
let citActive='sve';

function togStar(i,el){
  citStars[i]=!citStars[i];
  el.classList.toggle('starred',!!citStars[i]);
  try{localStorage.setItem('mt.hrv.h22.cit_stars',JSON.stringify(citStars))}catch(e){}
}
...
function scannerUpdate(){
  ...
  try{localStorage.setItem('mt.hrv.h22.wc_text',txt);}catch(e){}
}
(function(){
  const ta=document.getElementById('scanner-in');
  if(!ta)return;
  try{const sv=localStorage.getItem('mt.hrv.h22.wc_text');if(sv){ta.value=sv;scannerUpdate();}}catch(e){}
})();
...
═══════════════════════════════════ */
let CP_STATE={done:{}};
try{const s=localStorage.getItem('mt.hrv.h22.cp');if(s)CP_STATE=JSON.parse(s);}catch(e){}
...
function cpToggle(i){
  ...
  try{localStorage.setItem('mt.hrv.h22.cp',JSON.stringify(CP_STATE));}catch(e){}
  cpRender();
...
function cpReset(){
  CP_STATE={done:{}};
  try{localStorage.removeItem('mt.hrv.h22.cp');}catch(e){}
  cpRender();
}
cpRender();
...
═══════════════════════════════════ */
let TAB_DONE={};
try{TAB_DONE=JSON.parse(localStorage.getItem('mt.hrv.h22.tab_done')||'{}')}catch(e){}

function markTab(n){
  TAB_DONE[n]=true;
  try{localStorage.setItem('mt.hrv.h22.tab_done',JSON.stringify(TAB_DONE))}catch(e){}
...
const TIPS=[
  ...
  '💡 <strong>Tab 7 tip:</strong> Referentna tablica s leksičkim odnosima, slojevima leksika i frazemima — isprintaj i drži uz sebe.',
];
let tipShown={};
function showTip(n){
...
function loadScoreHistory(){
  try{
    const hist=JSON.parse(localStorage.getItem('mt.hrv.h22.kviz_hist')||'[]');
...
function saveScoreHistory(score,total){
  try{
    ...
    localStorage.setItem('mt.hrv.h22.kviz_hist',JSON.stringify(hist.slice(-10)));
    loadScoreHistory();
  }catch(e){}
}
...
function fsAddToHistory(text, count){
  try{
    let hist = JSON.parse(localStorage.getItem('mt.hrv.h22.fs_hist') || '[]');
    hist.push({text, count, date: Date.now()});
    if(hist.length > 20) hist = hist.slice(-20);
    localStorage.setItem('mt.hrv.h22.fs_hist', JSON.stringify(hist));
  } catch(e){}
}
...
function updateProgress(pct){
  ...
  try { localStorage.setItem('mt.hrv.h22.prog', p); } catch(e){}
}
/* ══ SIDEBAR ACTIVATION ══ */
...
export default function H22Chapter() {
  return (
    <ChapterWrapper
      chapterId="H22"
      bodyHtml={BODY_HTML}
...
export const HRV_POGAVLJE_22 = null
