 ...
 */
'use client';
import H06ReactLayers from './H06_Components';
...
<div class="content-wrap">
  ...
  <div class="layer on" id="l0" role="tabpanel" tabindex="0">
    ...
    <div id="h06-react-compare-romanti-prosvjet"></div>
    ...
    <div class="box-signal">
      ...
      <div class="box-signal-txt">
        ...
        <div id="h06-react-timeline-romantizam"></div>
    ...
    <div id="h06-react-author-puskin"></div>
    ...
    <div id="h06-react-author-byron"></div>
    <div id="h06-react-author-engleski-rom"></div>
    <div id="h06-react-author-faust-mini"></div>
    ...
    <div class="cheat-card">
      <div class="cheat-hdr">
        <div class="cheat-hdr-l">
          ...
          <div class="cheat-ttl">Sve što moraš pamtiti — H06</div>
        </div>
    ...
    <div id="h06-react-pop-kultura"></div>
  ...
  <div class="layer" id="l1" role="tabpanel" tabindex="0">
    ...
    <div class="box-int">
      ...
      <div class="box-int-txt">
        ...
        <div id="h06-react-hero-quote-tatjanino"></div>
    ...
    <div id="h06-react-stat-cards-onjegin"></div>
    ...
    <div class="puskin-timeline">
      ...
      <div class="pt-event">
        ...
        <div class="pt-body">
          ...
          <div class="pt-desc">Francuski časnik Georges d'Anthes zavodi Nataliju. Puškin izaziva na dvoboj. 27. 1. 1837. — pogođen u trbuh. Umire 29. 1. Pogreb u noći, tajno, bez javne procesije — car strah od nemira. <em>Tragička ironija:</em> Puškin napisao Lenskov duel 14 godina prije svoje smrti.</div>
        </div>
      </div>
    </div>
    ...
    <div class="box-tip">
      ...
      <div class="bt-txt">
        ...
        <div id="h06-react-usporedba-tatjana-lotte"></div>
    ...
    <div id="h06-react-svg-onjegin-obrat"></div>
    <div id="h06-react-accordion-sukobi"></div>
    ...
    <div id="h06-react-accordion-kljucne"></div>
    ...
    <div id="h06-react-usporedba-onjegin-werther"></div>
    <div id="h06-react-onjegin-opera"></div>
    ...
    <div class="yt-grid">
      <a class="yt-card" href="https://www.youtube.com/results?search_query=Evgenij+Onjegin+Puškin+analiza+lektira+hrvatski" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Evgenij Onjegin — analiza na hrvatskom</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=romantizam+europski+književnost+lektira+analiza" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇭🇷</span> HR</div>
          <div class="yt-title">Europski romantizam — kontekst i obilježja</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Eugene+Onegin+Pushkin+analysis+summary" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Eugene Onegin — analysis &amp; themes</div>
        </div>
      </a>

      <a class="yt-card" href="https://www.youtube.com/results?search_query=Pushkin+Romanticism+Russian+literature+lecture" target="_blank" rel="noopener noreferrer">
        <div class="yt-thumb">
          <div class="yt-play">▶</div>
        </div>
        <div class="yt-body">
          <div class="yt-lang"><span class="yt-flag">🇬🇧</span> EN</div>
          <div class="yt-title">Pushkin &amp; Russian Romanticism — lecture</div>
        </div>
      </a>
    </div>
...
<div class="nav-row">
  ...
  <div class="layer" id="l2" role="tabpanel" tabindex="0">
    ...
    <div id="h06-react-accordion-esej-teze"></div>
  ...
  <div class="layer" id="l4" role="tabpanel" tabindex="0">
    <div id="h06-react-pojmovnik"></div>
  </div>
  <!-- ========================
       TAB 5 · DRILL
       ======================== -->
  <div class="layer" id="l5" role="tabpanel" tabindex="0">
    ...
    <style>
      ...
      /* ¦¦ Paywall komponente (JS-injected via fcShowPaywall/qzShowPaywall) ¦¦ */
      .drill-paywall,.qz-paywall{max-width:520px;margin:24px auto;padding:28px 24px;background:linear-gradient(135deg,rgba(232,201,122,.08),rgba(220,50,47,.04));border:1px solid var(--bd-go);border-left:3px solid var(--gold);border-radius:var(--r4);text-align:center;display:flex;flex-direction:column;align-items:center;gap:10px}
      .drill-paywall-ico,.qz-paywall-ico{font-size:34px;line-height:1}
      .drill-paywall-title,.qz-paywall-label{font-family:var(--display);font-size:16px;font-weight:700;color:var(--gold);letter-spacing:.8px;line-height:1.4}
      .drill-paywall-sub,.qz-paywall-sub{font-family:var(--serif);font-size:14px;color:var(--t2);line-height:1.55;max-width:440px;margin-bottom:6px}
      .drill-paywall-sub b,.qz-paywall-sub b{color:var(--gold);font-weight:600}
      .pro-gate{position:relative;overflow:hidden;--gate-preview-height:360px}
      body[data-tier="free"] .pro-gate,.pro-gate.force-gated{max-height:var(--gate-preview-height)}
      body[data-tier="standard"] .pro-gate,body[data-tier="pro"] .pro-gate{max-height:none}
      .pro-gate-overlay{display:none;position:absolute;inset:0;flex-direction:column;justify-content:flex-end;pointer-events:none}
      .pro-gate-overlay[data-gate-state="visible"]{display:flex}
      body[data-tier="free"] .pro-gate-overlay,.pro-gate.force-gated .pro-gate-overlay{display:flex}
      body[data-tier="standard"] .pro-gate-overlay,body[data-tier="pro"] .pro-gate-overlay{display:none!important}
      .pro-gate-fade{height:180px;background:linear-gradient(to bottom,rgba(15,6,5,0) 0%,rgba(15,6,5,.85) 55%,rgba(15,6,5,.98) 100%)}
      .pro-gate-cta{background:rgba(15,6,5,.98);padding:18px 22px 22px;text-align:center;pointer-events:auto;border-top:1px solid var(--bd-go);display:flex;flex-direction:column;align-items:center;gap:10px}
      .pro-gate-label{font-family:var(--serif);font-size:14px;color:var(--t1);line-height:1.5;max-width:460px}
      .pro-gate-label b{color:var(--gold);font-weight:600}
      .pro-gate-btn{display:inline-flex;align-items:center;justify-content:center;gap:7px;font-family:var(--mono);font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:#0F0605;background:linear-gradient(135deg,var(--gold),#d4b980);border:1px solid var(--gold);border-radius:var(--r2);padding:11px 22px;text-decoration:none;cursor:pointer;transition:transform .18s,box-shadow .18s;box-shadow:0 4px 16px rgba(232,201,122,.18)}
      .pro-gate-btn::before{content:'🔒';font-size:13px}
      .pro-gate-meta{font-family:var(--mono);font-size:9.5px;color:var(--t3);letter-spacing:.8px;text-transform:uppercase}
    </style>
...
.wc-hint{margin-top:12px;padding:10px 12px;background:var(--inp,#0F0605);border-radius:8px;font-size:12px;color:var(--t2,#c5b8aa);line-height:1.5}
    ...
    <div class="minirev">
      ...
      <div class="minirev-body">
        <div class="minirev-grid">
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Djelo i korpus</div><div class="minirev-card-val"><b>Puškin: Evgenij Onjegin</b>, Byron i europska romantičarska lirika kao temelj epohe.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Kontekst</div><div class="minirev-card-val"><b>Romantizam</b> ističe subjekt, slobodu i imaginaciju; sukob pojedinca i društva postaje središnji motiv.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Likovi</div><div class="minirev-card-val"><b>Onjegin, Tatjana, Lenski, Olga</b> — različiti odgovori na ljubav, dužnost i društveni kod.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Središnji sukob</div><div class="minirev-card-val"><b>Ideal vs stvarnost</b>; romantičarski individualizam sudara se s posljedicama konkretnih odluka.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Pojmovi</div><div class="minirev-card-val"><b>romantičarski junak, byronizam, suvišan čovjek, weltschmerz, ironija</b>.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Forma i simboli</div><div class="minirev-card-val"><b>oneginski stih, roman u stihovima, pismo, duel, put</b> — elementi koji nose poetiku djela.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Most</div><div class="minirev-card-val">› <b>H07 Realizam</b> — od romantičarske iznimke prema psihološkoj i društvenoj analizi stvarnosti.</div></div>
          <div class="minirev-card"><div class="minirev-card-lbl">📌 Najveća greška</div><div class="minirev-card-val">Romantizam svesti na patetiku i „velike osjećaje”. Bitan je <b>sukob ideala i odgovornosti</b>.</div></div>
        </div>
        <div class="minirev-quotes"><b style="display:block;font-family:var(--mono);font-size:9.5px;color:var(--bronze-l);letter-spacing:1.5px;font-weight:700;text-transform:uppercase;margin-bottom:8px">3 citata napamet</b><ol><li>„Ja vas ljubim, ali drugomu sam dana.” <b>(Tatjana)</b></li><li>„Tatjana, voljena Tatjana.” <b>(Puškin)</b></li><li>„Ruska dušom, iako nije znala zašto.” <b>(Puškin)</b></li></ol></div>
      </div>
    </div>

    <div class="exam-prompt"><div class="exam-prompt-ttl">📌 Kako se romantizam može pojaviti na ispitu</div><div class="exam-prompt-task">Prikaži glavne odlike romantizma i analiziraj kako se romantičarski junak oblikuje u <em>Evgeniju Onjeginu</em>. U argumentaciji usporedi ga s predromantičarskim junakom iz H05 i pokaži kako taj model vodi prema realizmu.</div><div class="exam-prompt-tips"><div class="exam-tip"><b>📌 Struktura eseja</b>Uvod (50-60 r.) · 3 razradna odlomka (~120 r. svaki: kontekst epohe, analiza lika, most prema realizmu) · zaključak (60-70 r.) = ~470 r.</div><div class="exam-tip"><b>📌 Citati</b>Koristi 2-3 citata: Tatjanino pismo/finale, jedan byronovski motiv i jednu opću romantičarsku formulaciju.</div><div class="exam-tip"><b>📌 Povezivanje</b>Jasno postavi liniju H05→H06→H07: Wertherova kriza subjekta, Onjeginov suvišan čovjek, realistički psihološki roman.</div><div class="exam-tip"><b>📚 Pojmovi</b>Romantičarski junak · byronizam · suvišan čovjek · onjeginski stih · subjektivnost · ironija.</div></div></div>
    ...
    <div class="cp-final" id="cp-final">
      ...
      <div class="cp-actions">
        <button class="fcb primary" onclick="/* signup uklonjen */">H07 · Realizam ›</button>
...
/* === CHAPTER_CSS_DELTA — h06-specifično (Citatnik v9, oneginski-viz, puškin-timeline,
   feature-callout, back-to-top, stat-badge, reading-time, scroll-progress, svg-tooltip).
   Sve zajedničko (tokeni, chrome, sidebar, tabovi, hero, boxovi, diag, cheat) dolazi iz
   SHARED_LIT_CSS — h06 je vraćen u zajednički sloj (Faza: audit h06). === */
...
.cit-txt{font-family:var(--serif);font-size:16px;font-weight:400;font-style:italic;color:var(--t1);line-height:1.55;margin:12px 0 14px;padding:0;letter-spacing:.15px;position:relative}
...
function qzShare(pct,score){
  var url='https://maturiraj.hr/skripte/hrv/h06';
