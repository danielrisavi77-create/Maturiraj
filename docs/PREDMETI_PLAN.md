...
| C3 soc | **GOTOVO** (PR #17, 2026-09-23, ADR-001 Faza 2): `scripts/soc-split-solutions.mjs`, `lib/exam-secrets/subjects/soc.js` + `lib/sociologija/scoring.js`, iframe most `DISCERE_NEED_EXAM/DISCERE_EXAMS/DISCERE_SUBMIT/DISCERE_GRADE`, nacrti `disc_soc_exam_<key>_<mode>`, `SOC_FREE_DEMO` u `free-policy.js`. Val A merge mora zadržati pravi soc adapter u `registry.js` (A2 je granala prije PR-a). |
