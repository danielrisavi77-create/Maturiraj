...
export const exam = {
  meta: {
    schemaVersion: 1,
    version: 'source-review-v6-tables',
    subject: 'bio',
    key: '2026_ljeto',
    year: 2026,
    season: 'ljeto',
    ...
    qa: {
      ...
      verifiedAt: null,
      notes: [
        '2026-09-10: obnovljene i dekodirane sve slike; potvrđeni izvorni hashovi i 35 MC ključeva. Cjelovita provjera teksta, otvorenih odgovora, prava uporabe i korisničkog toka još nije dovršena. Stariji nalazi slijede radi sljedivosti.',
