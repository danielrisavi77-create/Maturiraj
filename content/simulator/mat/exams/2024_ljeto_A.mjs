...
export const qs = [
  ...
  {id:14,img:true,type:"mc",warn:"Pazi: f′ mijenja predznak u lokalnim ekstremima (−5 i 2); odredi gdje funkcija raste/pada.",topic:"der",points:1,
  ...
  {id:30.1,type:"sa",topic:"mat",points:1,
  ...
  {id:36.2,type:"sa",topic:"stat",points:1,
